import{y as p,s as g,b$ as x,o as d,j as n}from"./vendor-561dac3a.js";import{ar as m,a6 as P,W as j,P as v,as as y}from"./index-9d4b4175.js";import{c as $,L as F}from"./index-d89ae84e.js";import"./index-6a3ce409.js";const L=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,s=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",s,o,c);return{results:r.items}}),h=$({getFx:L,limit:50}),b=g.div`
    width: 100%;
    display: flex;
