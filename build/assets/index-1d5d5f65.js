import{y as l,s as p,o as d,b$ as g,j as e}from"./vendor-4355a046.js";import{b6 as x,a6 as m,W as P,P as j,x as v,w as y}from"./index-15c11f6c.js";import{c as $,L as k}from"./index-f1d4fcaf.js";import"./index-ec40a62a.js";const w=l(async n=>{const{search:o="",page:c,limit:r,filter:s}=n,{data:a}=await x(o,(s==null?void 0:s.id.toString())??"",c,r);return{results:a.items}}),u=$({getFx:w,limit:50}),F=p.div`
    width: 100%;
    display: flex;
