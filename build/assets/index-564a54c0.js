...
`;function va({size:e,color:i}){return t.jsx(mg,{size:e,color:i?_[i].main:void 0,children:t.jsxs("div",{className:"wrapper",children:[t.jsx("div",{className:"circle-blue",children:t.jsx("div",{className:"circle-white"})}),t.jsx("div",{className:"circle-blue-shadow"}),t.jsx("svg",{className:"check-svg",width:e,height:e,viewBox:`0 0 ${e} ${e}`,children:t.jsx("polyline",{className:"check-poly",points:"26 37 34 43 47 27",strokeLinecap:"round"})})]})})}const bg=p.div`
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    position: relative;
...
`,Og=({icon:e,text:i,onClick:n,width:s,background:o,textColor:a,align:r,href:c,height:d,minHeight:u,padding:h,isActive:g=!0,isChosen:x=!1})=>t.jsxs(Pg,{text:!!i,onClick:m=>g&&n&&n(m),isChosen:x,width:s,background:o,textColor:a,href:c,align:r,isActive:g,height:d,padding:h,minHeight:u,children:[!!e&&e,i&&t.jsx("span",{children:i})]}),ji=l.memo(Og),ja=p.div`
    width: 100%;
    height: fit-content;
...
`,Na=({amount:e,current:i,color:n,direction:s="horizontal"})=>e<=1?null:t.jsxs(Se,{direction:s,gap:2,width:"fit-content",minWidth:"fit-content",verticalAlign:"center",horizontalAlign:"center",children:[Array(e).fill(0).map((o,a)=>t.jsx(nx,{},a)),t.jsx(sx,{color:n,current:i})]}),ox=p.label`
    transition: 0.1s;
...
`,Ke=({text:e,checked:i,setChecked:n,fontSize:s,visible:o=!0,isActive:a=!0,invisibleOnFalse:r=!1})=>{if(!o)return null;const c=()=>{a&&n(!i)};return t.jsxs(ox,{checked:i,invisibleOnFalse:r,fontSize:s,isActive:a,className:"checkbox",children:[t.jsx("input",{className:"checkbox",type:"checkbox",checked:i,onChange:c}),t.jsx(ax,{tabIndex:0,className:"checkbox-square",children:i&&t.jsx(Xi,{})}),e&&t.jsx("div",{className:"checkbox-text",children:e})]})},Ia=e=>e.split("/")[1],rx=e=>e*1024*1024,lx=(e,i)=>(i??yu).indexOf(e.type)!==-1,Ps=(e,i,n,s,o=vu)=>{if(n&&i.length+e.length>n)return W.evokePopUpMessage({message:`Нельзя загрузить больше ${n} файлов`,type:"failure"}),i;for(let a=0;a<e.length;a++)return lx(e[a],s)?e[a].size>rx(o)?(W.evokePopUpMessage({message:`Размер файла слишком большой. Максимальный размер файла: ${o} MB`,type:"failure",time:1e4}),i):[...i,e[a]]:(console.log(e[a]),W.evokePopUpMessage({message:`Неверный формат файла. Доступные форматы: ${s==null?void 0:s.map(r=>Ia(r))}`,type:"failure",time:5e3}),i)},cx=p.label`
    width: 100%;
    min-height: 150px;
    border-radius: var(--brLight);
...
`,gx=({file:e,files:i,setFiles:n})=>{const{open:s}=ie(),o=(r,c)=>{r.preventDefault(),r.stopPropagation();const d=new FileReader;d.onloadend=()=>{s(t.jsx(Vn,{src:d.result,loading:!1,width:"500px",height:""}))},c&&d.readAsDataURL(c)},a=r=>Je.evokeConfirm({message:"Вы уверены, что хотите удалить файл?",onConfirm:()=>n(ux(r,e.name,i))});return t.jsxs(hx,{onClick:r=>r.preventDefault(),children:[t.jsxs("div",{className:"file-body",onClick:r=>e.type.includes("image")&&o(r,e),children:[t.jsx("div",{className:"image-container",children:e.type.includes("image")?t.jsx(Nd,{}):t.jsx(Id,{})}),t.jsxs("div",{className:"name-and-size",children:[t.jsx("b",{className:"file-name",children:e.name}),t.jsx(se,{fontSize:"0.7em",children:px(e.size)})]})]}),t.jsx(v,{icon:t.jsx(Qe,{}),height:"30px",width:"30px",background:"transparent",onClick:a})]})},xx=({files:e,setFiles:i})=>t.jsx(Se,{title:"Список файлов",visible:!!e.length,onDelete:()=>Je.evokeConfirm({message:"Вы уверены, что хотите удалить все файлы?",onConfirm:()=>i([])}),children:e.map(n=>t.jsx(gx,{file:n,files:e,setFiles:i},n.name))}),Ra=e=>t.jsxs(Se,{gap:12,children:[t.jsx(dx,{...e}),t.jsx(xx,{files:e.files,setFiles:e.setFiles})]}),fx=p.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
`,mx=({checkbox:e,loadfile:i,docVisible:n})=>t.jsxs(fx,{children:[t.jsx(Ke,{...e}),n&&t.jsx(Ra,{...i})]}),bx=p.div`
    width: 100%;
    display: flex;
    align-items: center;
    gap: 5px;
...
`,$x=()=>t.jsx(Ex,{children:t.jsx(Tx,{})}),je=({oldVersionUrl:e,errorText:i="Страница еще находится в разработке. Если вам она нужна, вернитесь к старому дизайну",buttonText:n="Перейти к старому дизайну",forceForward:s=!1,isRedirectButtonVisible:o=!0})=>(l.useEffect(()=>{s&&(window.location.href=`/old/?p=${e==null?void 0:e.slice(1,e.length)}`)},[]),t.jsx(pe,{text:i,children:o&&t.jsx("a",{href:`${D}/?p=${e==null?void 0:e.slice(1,e.length)}`,children:t.jsx(v,{text:n,icon:t.jsx(zn,{}),width:"100%",background:"var(--reallyBlue)",textColor:"#fff",align:"left",padding:"10px"})})})),Cx="modulepreload",Px=function(e){return"/"+e},Os={},w=function(i,n,s){if(!n||n.length===0)return i();const o=document.getElementsByTagName("link");return Promise.all(n.map(a=>{if(a=Px(a),a in Os)return;Os[a]=!0;const r=a.endsWith(".css"),c=r?'[rel="stylesheet"]':"";if(!!s)for(let h=o.length-1;h>=0;h--){const g=o[h];if(g.href===a&&(!r||g.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${c}`))return;const u=document.createElement("link");if(u.rel=r?"stylesheet":Cx,r||(u.as="script",u.crossOrigin=""),u.href=a,document.head.appendChild(u),r)return new Promise((h,g)=>{u.addEventListener("load",h),u.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>i())},Ox=l.lazy(()=>w(()=>import("./index-a41ab8cc.js"),["assets/index-a41ab8cc.js","assets/vendor-831b4923.js","assets/get-default-subdivision-06d85157.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js"])),Ax=l.lazy(()=>w(()=>import("./index-21642d4b.js"),["assets/index-21642d4b.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-teacher-subdivisions-500dfe3f.js"])),Dx=l.lazy(()=>w(()=>import("./index-83955dfd.js"),["assets/index-83955dfd.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js"])),Nx=l.lazy(()=>w(()=>import("./index-49d53da8.js"),["assets/index-49d53da8.js","assets/vendor-831b4923.js","assets/find-current-in-select-ba4611d5.js"]));l.lazy(()=>w(()=>Promise.resolve().then(()=>Eb),void 0));const Ix=l.lazy(()=>w(()=>import("./index-1ebec311.js"),["assets/index-1ebec311.js","assets/vendor-831b4923.js","assets/index-b5850819.js"])),Rx=l.lazy(()=>w(()=>import("./index-f6fd23ce.js"),["assets/index-f6fd23ce.js","assets/vendor-831b4923.js","assets/index-56f76af1.js"])),Lx=l.lazy(()=>w(()=>import("./index-078edf00.js"),["assets/index-078edf00.js","assets/vendor-831b4923.js","assets/get-default-subdivision-06d85157.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js"])),zx=l.lazy(()=>w(()=>import("./index-b15790bc.js"),["assets/index-b15790bc.js","assets/vendor-831b4923.js","assets/get-default-subdivision-06d85157.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-teacher-subdivisions-500dfe3f.js"])),Mx=l.lazy(()=>w(()=>import("./index-9258b679.js"),["assets/index-9258b679.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-teacher-subdivisions-500dfe3f.js"])),Fx=l.lazy(()=>w(()=>import("./index-1059ff00.js"),["assets/index-1059ff00.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js"])),Bx=l.lazy(()=>w(()=>import("./index-ed72fa51.js"),["assets/index-ed72fa51.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-teacher-subdivisions-500dfe3f.js"])),Hx=l.lazy(()=>w(()=>import("./index-e2603529.js"),["assets/index-e2603529.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js"])),Ux=l.lazy(()=>w(()=>import("./index-1f4c9cca.js"),["assets/index-1f4c9cca.js","assets/vendor-831b4923.js","assets/ui-9fc0b79b.js","assets/index-dac9fd28.js"])),Wx=l.lazy(()=>w(()=>import("./index-76b9c33b.js"),["assets/index-76b9c33b.js","assets/vendor-831b4923.js","assets/ui-9fc0b79b.js"])),Vx=l.lazy(()=>w(()=>import("./index-81d58e75.js"),["assets/index-81d58e75.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js"])),Gx=l.lazy(()=>w(()=>import("./index-a9f2d677.js"),["assets/index-a9f2d677.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-teacher-subdivisions-500dfe3f.js"])),qx=l.lazy(()=>w(()=>import("./index-35929961.js"),["assets/index-35929961.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-06d85157.js"])),Yx=l.lazy(()=>w(()=>import("./index-4da969a9.js"),["assets/index-4da969a9.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js"])),Jx=l.lazy(()=>w(()=>import("./index-8689a6d3.js"),["assets/index-8689a6d3.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-teacher-subdivisions-500dfe3f.js","assets/get-last-year-for-period-e1de6b16.js"])),Xx=l.lazy(()=>w(()=>import("./index-c6c3a3a7.js"),["assets/index-c6c3a3a7.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-teacher-subdivisions-500dfe3f.js"])),Kx=l.lazy(()=>w(()=>import("./index-48d8a83a.js"),["assets/index-48d8a83a.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-teacher-subdivisions-500dfe3f.js","assets/get-last-year-for-period-e1de6b16.js"])),Qx=l.lazy(()=>w(()=>import("./index-29ec84e2.js"),["assets/index-29ec84e2.js","assets/vendor-831b4923.js","assets/get-default-subdivision-06d85157.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js"])),Zx=l.lazy(()=>w(()=>import("./index-6dc13b14.js"),["assets/index-6dc13b14.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js"])),ef=l.lazy(()=>w(()=>import("./index-58c236a1.js"),["assets/index-58c236a1.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js"])),tf=l.lazy(()=>w(()=>import("./index-f6cd95d8.js"),["assets/index-f6cd95d8.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-06d85157.js"])),nf=l.lazy(()=>w(()=>import("./index-57f068bb.js"),["assets/index-57f068bb.js","assets/vendor-831b4923.js","assets/index-ffb11f66.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b7010400.js","assets/get-default-subdivision-06d85157.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-teacher-subdivisions-500dfe3f.js"])),sf=l.lazy(()=>w(()=>import("./index-463d370b.js"),["assets/index-463d370b.js","assets/vendor-831b4923.js"]));l.lazy(()=>w(()=>import("./index-6eec3eae.js"),["assets/index-6eec3eae.js","assets/vendor-831b4923.js","assets/index-357feaa4.js","assets/index-dac9fd28.js"]));const qn=l.lazy(()=>w(()=>import("./index-40aee499.js"),["assets/index-40aee499.js","assets/vendor-831b4923.js"])),of=l.lazy(()=>w(()=>import("./index-ecd87a5a.js"),["assets/index-ecd87a5a.js","assets/vendor-831b4923.js"])),af=l.lazy(()=>w(()=>import("./index-fee2b712.js"),["assets/index-fee2b712.js","assets/vendor-831b4923.js","assets/send-hr-form-holiday-work-2a997f3d.js"])),rf=l.lazy(()=>w(()=>import("./index-b9a9de80.js"),["assets/index-b9a9de80.js","assets/vendor-831b4923.js"])),lf=l.lazy(()=>w(()=>import("./index-eeabfb9d.js"),["assets/index-eeabfb9d.js","assets/vendor-831b4923.js"])),cf=l.lazy(()=>w(()=>import("./index-e72fe362.js"),["assets/index-e72fe362.js","assets/vendor-831b4923.js","assets/send-hr-form-holiday-work-2a997f3d.js"])),df=l.lazy(()=>w(()=>import("./index-ed9efc63.js"),["assets/index-ed9efc63.js","assets/vendor-831b4923.js"])),pf=l.lazy(()=>w(()=>import("./index-376826e1.js"),["assets/index-376826e1.js","assets/vendor-831b4923.js"])),uf=l.lazy(()=>w(()=>import("./index-a0e22fc1.js"),["assets/index-a0e22fc1.js","assets/vendor-831b4923.js"])),hf=l.lazy(()=>w(()=>import("./index-599fcf62.js"),["assets/index-599fcf62.js","assets/vendor-831b4923.js","assets/send-hr-form-work-transfer-a39070b3.js"])),gf=l.lazy(()=>w(()=>import("./index-cd7cefb8.js"),["assets/index-cd7cefb8.js","assets/vendor-831b4923.js","assets/send-hr-form-work-transfer-a39070b3.js"]));l.lazy(()=>w(()=>Promise.resolve().then(()=>Zm),void 0));l.lazy(()=>w(()=>import("./index-0163a5b8.js"),["assets/index-0163a5b8.js","assets/vendor-831b4923.js","assets/help-links-5c7fb395.js"]));const xf=l.lazy(()=>w(()=>import("./index-15d8fecf.js"),["assets/index-15d8fecf.js","assets/vendor-831b4923.js"])),za=l.lazy(()=>w(()=>import("./index-de66f7fa.js"),["assets/index-de66f7fa.js","assets/vendor-831b4923.js","assets/index-357feaa4.js","assets/index-dac9fd28.js"])),Ma=l.lazy(()=>w(()=>import("./index-6eec3eae.js"),["assets/index-6eec3eae.js","assets/vendor-831b4923.js","assets/index-357feaa4.js","assets/index-dac9fd28.js"])),ff=l.lazy(()=>w(()=>import("./index-f2464fb2.js"),["assets/index-f2464fb2.js","assets/vendor-831b4923.js"]));l.lazy(()=>w(()=>import("./index-7fe5fa24.js"),["assets/index-7fe5fa24.js","assets/vendor-831b4923.js","assets/index.esm-29d01972.js"]));const mf=l.lazy(()=>w(()=>import("./index-f7c5b66a.js"),["assets/index-f7c5b66a.js","assets/vendor-831b4923.js"])),Fa=l.lazy(()=>w(()=>import("./index-69f4025b.js"),["assets/index-69f4025b.js","assets/vendor-831b4923.js","assets/help-links-5c7fb395.js"])),bf=l.lazy(()=>w(()=>import("./index-f7e9f67a.js"),["assets/index-f7e9f67a.js","assets/vendor-831b4923.js"])),yf=l.lazy(()=>w(()=>import("./index-8ad24014.js"),["assets/index-8ad24014.js","assets/vendor-831b4923.js","assets/alert-item-4aa33331.js","assets/is-valid-url-08a91344.js"])),vf=l.lazy(()=>w(()=>import("./index-bef2aeb6.js"),["assets/index-bef2aeb6.js","assets/vendor-831b4923.js","assets/index-3737aa4a.js","assets/alert-item-4aa33331.js","assets/is-valid-url-08a91344.js"])),jf=l.lazy(()=>w(()=>import("./index-f11e27cf.js"),["assets/index-f11e27cf.js","assets/vendor-831b4923.js"]));l.lazy(()=>w(()=>Promise.resolve().then(()=>uy),void 0));const wf=l.lazy(()=>w(()=>import("./index-a47f8ceb.js"),["assets/index-a47f8ceb.js","assets/vendor-831b4923.js"])),Ba=l.lazy(()=>w(()=>import("./index-5e8371ca.js"),["assets/index-5e8371ca.js","assets/vendor-831b4923.js","assets/index-3737aa4a.js","assets/index-dac9fd28.js"])),_f=l.lazy(()=>w(()=>import("./index-914367c5.js"),["assets/index-914367c5.js","assets/vendor-831b4923.js","assets/index-a1d309ce.js"])),kf=l.lazy(()=>w(()=>import("./index-25a9a44f.js"),["assets/index-25a9a44f.js","assets/vendor-831b4923.js","assets/index-a1d309ce.js"])),Sf=l.lazy(()=>w(()=>import("./index-3ce61ae4.js"),["assets/index-3ce61ae4.js","assets/vendor-831b4923.js","assets/index-a1d309ce.js"])),Tf=l.lazy(()=>w(()=>import("./index-12045534.js"),["assets/index-12045534.js","assets/vendor-831b4923.js"])),Ef=l.lazy(()=>w(()=>import("./index-bc7bf06e.js"),["assets/index-bc7bf06e.js","assets/vendor-831b4923.js","assets/index.esm-29d01972.js"])),$f=l.lazy(()=>w(()=>import("./index-17b3df3c.js"),["assets/index-17b3df3c.js","assets/vendor-831b4923.js"])),Cf=l.lazy(()=>w(()=>import("./index-52d7304c.js"),["assets/index-52d7304c.js","assets/vendor-831b4923.js"])),Pf=l.lazy(()=>w(()=>import("./index-62f290a5.js"),["assets/index-62f290a5.js","assets/vendor-831b4923.js"])),Of=l.lazy(()=>w(()=>import("./index-73939f46.js"),["assets/index-73939f46.js","assets/vendor-831b4923.js","assets/index-b5850819.js"])),Af=l.lazy(()=>w(()=>import("./index-d51ee63e.js"),["assets/index-d51ee63e.js","assets/vendor-831b4923.js"])),Df=l.lazy(()=>w(()=>import("./index-3405f13d.js"),["assets/index-3405f13d.js","assets/vendor-831b4923.js","assets/help-links-5c7fb395.js"])),Nf=l.lazy(()=>w(()=>import("./index-cc24ff89.js"),["assets/index-cc24ff89.js","assets/vendor-831b4923.js","assets/help-links-5c7fb395.js"])),If=l.lazy(()=>w(()=>import("./index-5aed4245.js"),["assets/index-5aed4245.js","assets/vendor-831b4923.js"])),Rf=l.lazy(()=>w(()=>import("./index-0163a5b8.js"),["assets/index-0163a5b8.js","assets/vendor-831b4923.js","assets/help-links-5c7fb395.js"])),mn=(e,i)=>{const n=e.split("/");return i[e.slice(1,e.length)]??Object.values(i).find(s=>{var a;const o=s.path.split("/");for(let r=0;r<n.length;r++)if(o[r]!==n[r]&&((a=o[r])==null?void 0:a[0])!==":")return!1;return!0})},Ha=()=>{const e=mi(),{allRoutes:i}=We.useMenu(),n=i??{},[s,o]=l.useState(mn(e.location.pathname,n));return l.useEffect(()=>{n!==null&&o(mn(e.location.pathname,n))},[n]),l.useEffect(()=>e.listen(a=>{a&&o(mn(a.pathname,n))}),[e,n]),s},Lf={small:"600px",middle:"700px",big:"963px",large:"100%"},Ua=e=>Lf[(e==null?void 0:e.pageSize)??"middle"],zf=p(Ze)`
    position: relative;
...
`,Wa=({title:e,children:i,bottomMargin:n,forceState:s=!1})=>{const[o,a]=l.useState(s);l.useEffect(()=>{a(s)},[s]);const r=()=>a(c=>!c);return t.jsxs(Hf,{isOpen:o,bottomMargin:n,onClick:r,children:[e&&t.jsx(Uf,{children:e}),t.jsx(Wf,{isOpen:o,children:i})]})},Va=S(),Ga=S(),Vf=X(!1).on(Ga,()=>!0).on(Va,()=>!1),As={close:Va,open:Ga},Gf={$isModalOpen:Vf},Yn=l.createContext({isOpen:!1,component:void 0,back:()=>{},close:()=>{},open:()=>{},title:void 0,canBack:!1}),qf=({children:e})=>{const[i,n]=l.useState(!1),[s,o]=l.useState([]),[a,r]=l.useState([]),c=bi(Gf.$isModalOpen),d=a.length>1,u=l.useCallback(()=>{d&&(a.pop(),s.pop(),r([...a]),o([...s]))},[a,r]),h=l.useCallback((b,y)=>{b&&(i?(r(()=>[...a,b]),o(()=>[...s,y??""])):(r(()=>[b]),o(y?[y]:[])),n(()=>!0),As.open())},[r,n,a,i]),g=l.useCallback(()=>{n(()=>!1),As.close()},[r,n]),x=l.useMemo(()=>a[a.length-1],[a]),m=l.useMemo(()=>s[s.length-1],[s]),f=l.useCallback(b=>{b&&r([...a,b])},[]);return l.useEffect(()=>{c!==i&&n(c)},[c]),t.jsx(Yn.Provider,{value:{back:u,open:h,close:g,isOpen:i,canBack:d,component:x,title:m,setComponent:f},children:e})},ie=()=>{const{open:e,isOpen:i,...n}=l.useContext(Yn);return{open:e,isOpen:i,...n}},Yf="2.3.0",qa=()=>t.jsx(J,{icon:null,type:"info",title:Yf,width:"38px",fontSize:"0.65rem",padding:"7px 0px",align:"center"}),Ie=({color:e,children:i})=>t.jsx(xt,{color:e,children:i}),Jf=()=>({info:t.jsx(Ie,{color:"grey",children:t.jsx(Ce,{})}),message:t.jsx(Ie,{color:"red",children:t.jsx(Mn,{})}),alert:t.jsx(Ie,{color:"purple",children:t.jsx(wo,{})}),"payment-dorm":t.jsx(Ie,{color:"green",children:t.jsx(ot,{})}),"payment-ed":t.jsx(Ie,{color:"green",children:t.jsx(ot,{})}),"digital-services":t.jsx(Ie,{color:"red",children:t.jsx(I,{})}),"doc-for-review":t.jsx(Ie,{color:"blue",children:t.jsx(I,{})}),"hr-applications":t.jsx(Ie,{color:"green",children:t.jsx(I,{})}),"kpi-pps":t.jsx(Ie,{color:"pink",children:t.jsx(_o,{})}),schedule:t.jsx(Ie,{color:"pink",children:t.jsx(Et,{})}),"version-update":t.jsx(qa,{}),"electronic-interaction":t.jsx(Ie,{color:"blue",children:t.jsx(ko,{})})}),Xf=p(Z)`
    width: 100%;
    display: flex;
    align-items: center;
    padding: 4px;
...
`,Kf=p.div`
    ...
    font-weight: 500;
`,Qf={small:"0.8rem",middle:"0.83rem",large:"0.85rem",big:"0.86rem"},Zf={small:"0.75rem",middle:"0.78rem",large:"0.79rem",big:"0.80rem"},em={small:"0px",middle:"1px",large:"2px",big:"3px"},Ya=({id:e,title:i,text:n,time:s,date:o,onClick:a,type:r,pageId:c,goTo:d,onClose:u,bottomMargin:h,closeAnimation:g=!0,loadingRemove:x=!1,canClose:m=!0,fullText:f=!0,maxLetters:b=200,size:y="middle"})=>{const C=re(o,"short"),{close:j}=ie(),[T,k]=l.useState(!1),U=A=>{A.stopPropagation(),A.preventDefault(),g?(k(!0),setTimeout(()=>{u==null||u()},300)):u==null||u()},N=()=>{a==null||a(),m&&ct.clearById({id:e,pageId:c}),j()};return t.jsx(Wa,{forceState:!T,bottomMargin:h,children:t.jsxs(Xf,{to:d??"",onClick:N,children:[t.jsx("span",{className:"left-icon",children:Jf()[r]}),t.jsxs("div",{className:"content",children:[t.jsx(se,{fontSize:"0.7rem",children:t.jsx(Ue,{words:[C??"",s??""]})}),t.jsxs(P,{d:"column",gap:em[y],ai:"flex-start",children:[t.jsx(Kf,{fontSize:Qf[y],children:f?i:Hi(i,b)}),t.jsx(se,{fontSize:Zf[y],children:f?n:Hi(n,b)})]})]}),u&&t.jsx(v,{isActive:!(x&&T),icon:t.jsx(Qe,{}),background:"var(--theme-2)",onClick:U,style:{borderRadius:"20px"}})]})})},Ja=({notifications:e,loadingRemove:i})=>{if(!e||e.length===0)return null;const n=(o,a,r)=>()=>{ct.clearById({id:o,pageId:a}),r==null||r()},s=o=>o.canClose!==!1?n(o.id,o.pageId,o.onClose):void 0;return t.jsx(P,{d:"column",children:e.map((o,a)=>l.createElement(Ya,{size:"big",loadingRemove:i,bottomMargin:a!==e.length-1,...o,key:o.id,onClose:s(o)}))})},tm=p.div`
    display: flex;
    flex-direction: column;
    gap: 8px;
    width: 100%;
...
`,Tm=({obj:e,columns:i})=>t.jsx(Sm,{children:i.map(n=>t.jsx(yt,{keyStr:n.title,value:n.render?n.render(e[n.field],e):zt(e[n.field],n.type)},n.title))}),Za=({columns:e,el:i,index:n,onRowClick:s})=>{const{open:o}=ie(),a=()=>o(t.jsx(Tm,{obj:i,columns:e}),"Информация");return t.jsx(ym,{even:n%2===0,onClick:()=>s?s(i):a(),children:e.map(r=>{var c;return t.jsx(t.Fragment,{children:t.jsx(Qa,{showFull:r.showFull,width:r.width,className:((c=r.priority)==null?void 0:c.toString())??"one",align:r.align,children:r.render?r.render(zt(i[r.field],r.type),i):zt(i[r.field],r.type)},r.field)})})})},Em=p.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`,Cm=p.div`
    ...
    justify-content: center;
    align-items: center;
`,Pm=({data:e,loading:i,columns:n,maxOnPage:s,onRowClick:o,filter:a})=>{const[r,c]=l.useState(0),d=Math.ceil(((e==null?void 0:e.length)??0)/(s??1))-1,u=s?e==null?void 0:e.slice(r*s,(r+1)*s):e;return l.useEffect(()=>{c(0)},[a]),i?t.jsx($m,{children:t.jsx(ht,{})}):t.jsxs(Em,{children:[u==null?void 0:u.map((h,g)=>t.jsx(Za,{onRowClick:o,columns:n,el:h,index:g},g)),!(u!=null&&u.length)&&t.jsx(pe,{text:"Нет данных"}),d>0&&t.jsx(ue,{margin:"0",width:"100%"}),t.jsx(Cm,{children:t.jsx(_m,{pages:d,condition:!!s&&!!(u!=null&&u.length),currentPage:r,setCurrentPage:c})})]})},Om=p.div`
    display: flex;
    align-items: center;
    gap: 5px;
    transition: 0.2s;
...
`,g0=p.div`
    ...
    padding-bottom: 40px;
    margin-bottom: 10px;
`,or=S(),ar=S(),Kn=L(async()=>{const{data:e}=await he.get(`Vacation.GetAllHistory?personalGuid=${$t(pt()??"").IndividualGuid}`);return e});$({clock:or,target:Kn});const Ut=L(async e=>(await he.post("Vacation.AddVacation",e)).data);$({clock:ar,target:Ut});const Ui=X([]),x0=Ut.pending;$({clock:Kn.doneData,fn:({employeeVacations:e})=>e,target:Ui});$({clock:Ut.doneData,fn:e=>e.isError?{message:e.error,type:"hrFailure",time:3e5}:{message:"Форма отправлена успешно",type:"success",time:0},target:Oe.evokePopUpMessage});$({clock:Ut.doneData,source:Ui,fn:(e,{employeeVacations:i})=>[...e,...i],target:Ui});$({clock:Kn.failData,fn:e=>{var n;return{message:Zi(e)?((n=e.response)==null?void 0:n.data).error:"Не удалось загрузить данные",type:"failure",time:3e5}},target:W.evokePopUpMessage});$({clock:Ut.failData,fn:e=>{var n;return{message:Zi(e)?((n=e.response)==null?void 0:n.data).error:"Не удалось отправить данные",type:"hrFailure",time:3e5}},target:Oe.evokePopUpMessage});const Ns={loadBufferHolidayPlanning:or,sendBufferHolidayPlanning:ar},BS={sendBufferHolidayPlanningFx:Ut},Qn={useBufferHolidayPlanning:()=>({data:$e(Ui),loading:$e(x0)})},f0=()=>{const[e,i]=l.useState(!1),{data:n}=Qn.useBufferHolidayPlanning(),s=!!n.every(o=>!o);return t.jsxs(Ae,{orientation:"vertical",alignItems:"flex-start",justifyContent:"flex-start",gap:"10px",width:"100%",maxWidth:"100%",height:"fit-content",children:[t.jsxs(m0,{children:["История заявлений на отпуск:",t.jsx(v,{icon:e?t.jsx(Pe,{}):t.jsx(we,{}),onClick:()=>!s&&i(o=>!o),background:"transparent"})]}),e&&n.map((o,a)=>t.jsx(b0,{columns:Xn(),data:[],maxOnPage:10},a)),t.jsx(v,{onClick:()=>{!s&&i(o=>!o)},text:s?"История пуста":e?"Скрыть":"Подробнее",background:"transparent"})]})},m0=p.div`
    display: flex;
    flex-direction: row;
    gap: 10px;
    align-items: center;
...
`,U0=p.div`
    ...
    padding-bottom: 40px;
    margin-bottom: 10px;
`,dr=()=>[{title:"Статус заявления",field:"medicalExamination",width:"200px",render:e=>t.jsx(J,{type:e.status.orderStatus==="Согласовано"?"success":e.status.orderStatus==="На регистрации"?"info":e.status.orderStatus==="Не утвержден"||e.status.orderStatus==="Не создано"?"failure":"alert",title:e.status.orderStatus,align:"center",width:"100%",icon:null,maxWidth:"150px"})},{title:"Период",field:"medicalExamination",align:"center",render:e=>{var i,n;return`${re((i=e==null?void 0:e.period)==null?void 0:i.startDate,"numeric")} - ${re((n=e==null?void 0:e.period)==null?void 0:n.endDate,"numeric")}`}}],W0=e=>localStorage.setItem("age",e.toString()),US=e=>localStorage.getItem(e),V0=e=>e.map(i=>{localStorage.setItem(i.employeeGuid,i.tutor.toString())}),pr=S(),ur=S(),hr=L(async()=>{const{data:e}=await he.get(`MedicalExamination.GetAllHistory?PersonalGuid=${$t(pt()??"").IndividualGuid}`);return W0(e.age),V0(e.employeeMedicalExaminations.map(({employeeGuid:i,tutor:n})=>({employeeGuid:i,tutor:n}))),e.employeeMedicalExaminations});$({clock:pr,target:hr});const ki=L(async e=>(await he.post("MedicalExamination.AddMedicalExamination",e)).data);$({clock:ur,target:ki});const gr=X([]),G0=ki.pending;$({clock:hr.doneData,target:gr});$({clock:ki.doneData,fn:e=>{const i=e;return i.isError?{message:i.error,type:"hrFailure",time:3e5}:{message:"Форма отправлена успешно",type:"success",time:0}},target:Oe.evokePopUpMessage});$({clock:ki.fail,fn:()=>({message:"Не удалось отправить форму.",type:"hrFailure",time:3e5}),target:Oe.evokePopUpMessage});const q0={loadBufferMedicalExamination:pr,sendBufferMedicalExamination:ur},WS={sendBufferMedicalExaminationFx:ki},ts={useBufferMedicalExamination:()=>({data:$e(gr),loading:$e(G0)})},Y0=()=>{const[e,i]=l.useState(!1);l.useEffect(q0.loadBufferMedicalExamination,[]);const{data:n}=ts.useBufferMedicalExamination(),s=!!n.every(o=>!o);return t.jsxs(Ae,{orientation:"vertical",alignItems:"flex-start",justifyContent:"flex-start",gap:"10px",width:"100%",maxWidth:"100%",height:"fit-content",children:[t.jsxs(J0,{children:["История заявлений на диспансеризацию:",t.jsx(v,{icon:e?t.jsx(Pe,{}):t.jsx(we,{}),onClick:()=>!s&&i(o=>!o),background:"transparent"})]}),e&&t.jsx(X0,{columns:dr(),data:n.map(o=>({...o})),maxOnPage:5}),t.jsx(v,{onClick:()=>{!s&&i(o=>!o)},text:s?"История пуста":e?"Скрыть":"Подробнее",background:"transparent"})]})},J0=p.div`
    display: flex;
    flex-direction: row;
    gap: 10px;
    align-items: center;
...
`,ab=p.div`
    ...
    padding-bottom: 40px;
    margin-bottom: 10px;
`,xr=S(),fr=S(),mr=L(async()=>{const{data:e}=await he.get(`AnotherPlaceWork.GetAllHistory?PersonalGuid=${$t(pt()??"").IndividualGuid}`);return e.employeeHistories});$({clock:xr,target:mr});const Si=L(async e=>(await he.post("AnotherPlaceWork.AddAnotherPlaceOfWork",e)).data);$({clock:fr,target:Si});const br=X([]),rb=Si.pending;$({clock:mr.doneData,target:br});$({clock:Si.doneData,fn:e=>{const i=e;return i.isError?{message:i.error,type:"hrFailure",time:3e5}:{message:"Форма отправлена успешно",type:"success",time:0}},target:Oe.evokePopUpMessage});$({clock:Si.fail,fn:()=>({message:"Не удалось отправить форму.",type:"hrFailure",time:3e5}),target:Oe.evokePopUpMessage});const lb={loadBufferWorkTransfer:xr,sendBufferWorkTransfer:fr},VS={sendBufferWorkTransferFx:Si},cb={useBufferWorkTransfer:()=>({data:$e(br),loading:$e(rb)})},db=()=>{const[e,i]=l.useState(!1);l.useEffect(lb.loadBufferWorkTransfer,[]);const{data:n}=cb.useBufferWorkTransfer(),s=!!n.every(o=>!o);return t.jsxs(Ae,{orientation:"vertical",alignItems:"flex-start",justifyContent:"flex-start",gap:"10px",width:"100%",maxWidth:"100%",height:"fit-content",children:[t.jsxs(pb,{children:["История заявлений на перевод:",t.jsx(v,{icon:e?t.jsx(Pe,{}):t.jsx(we,{}),onClick:()=>!s&&i(o=>!o),background:"transparent"})]}),e&&t.jsx(ub,{columns:Xn(),data:n.map(o=>({...o})),maxOnPage:5}),t.jsx(v,{onClick:()=>{!s&&i(o=>!o)},text:s?"История пуста":e?"Скрыть":"Подробнее",background:"transparent"})]})},pb=p.div`
    display: flex;
    flex-direction: row;
    gap: 10px;
    align-items: center;
...
`,Sr=({children:e,size:i,color:n,fontWeight:s})=>{const o=i==="small"?"1rem":i==="big"?"1.5rem":"1.2rem",a=i==="small"?"17px":i==="big"?"22px":"18px";return t.jsxs(zb,{color:n,fontSize:o,iconSize:a,fontWeight:s,children:[e,t.jsx(ot,{})]})},Mb=e=>Number(e.replace(/,/g,".").replace(/\s/g,"")),Fb=p.div`
    width: 100%;
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`,Gb=({title:e,confirmed:i,setOpenArea:n})=>t.jsxs(Vb,{onClick:()=>n(s=>!s),children:[t.jsxs("div",{className:"title-and-icon",children:[i?t.jsx(Eo,{style:{color:"var(--green)"}}):t.jsx($o,{style:{color:"var(--red)"}}),t.jsx("b",{children:e})]}),t.jsx(v,{icon:t.jsx(we,{}),onClick:()=>null,background:"transparent"})]}),qb=p.div`
    display: flex;
    flex-direction: column;
    transition: 0.2s;
    width: 100%;
...
`,rv=e=>{const{close:i}=ie(),{menuPath:n,path:s,orientation:o="vertical",mode:a="use"}=e,r=o==="vertical"?17:50,c=1;if(a==="add")return t.jsx(av,{width:o==="vertical"?c:"100%",children:t.jsx(Vs,{...e,mode:a,maxWordLength:r})});const d=()=>{i(),et.changeOpen({isOpen:!1,currentPage:s.slice(1,s.length)})};return t.jsx(ov,{to:n??s,onClick:d,width:o==="vertical"?c:"100%",children:t.jsx(Vs,{...e,maxWordLength:r,mode:a})})},lv=p.div`
    width: 100%;
    display: flex;
    flex-direction: column;
    gap: 5px;
`,cv=({pages:e,showNotFound:i=!0})=>!e||!i&&Object.keys(e).length===0?null:!Object.keys(e).length&&i?t.jsx(pe,{text:"Ничего не было найдено"}):t.jsx(lv,{children:Object.values(e).map(n=>(n==null?void 0:n.show)!==!1&&l.createElement(rv,{...n,orientation:"horizontal",shadow:!1,key:n.id}))}),dv=(e,i)=>Object.values(i).reduce((n,s)=>{var o;return(me(s.title).includes(me(e))||(o=s==null?void 0:s.keywords)!=null&&o.find(a=>me(a).includes(me(e))))&&(n[s.id]=s),n},{}),pv=p.div`
    display: flex;
    flex-direction: column;
    height: 300px;
...
`,uv=p(Z)`
    width: 100%;
`,hv=({division:e})=>{const{close:i}=ie();return t.jsxs(pv,{children:[t.jsxs(P,{d:"column",gap:"12px",jc:"center",h:"100%",children:[t.jsx(xt,{size:120,color:"purple",children:t.jsx(Fi,{})}),t.jsx(se,{fontSize:"1.2rem",align:"center",children:e})]}),t.jsx(uv,{to:`${rl}/${e}`,onClick:i,children:t.jsx(v,{icon:t.jsx(Io,{}),width:"100%",text:"Список"})})]})},gv=p.div`
    width: 100%;
    color: var(--text);
    padding: 0px 16px;
    background: var(--theme-1t);
...
`,xv=({division:e})=>{const{open:i}=ie(),n=()=>{i(t.jsx(hv,{division:e}),"Подразделение")};return t.jsx(gv,{onClick:n,children:t.jsxs(P,{gap:"8px",h:"50px",jc:"space-between",w:"100%",children:[t.jsxs(P,{gap:"8px",children:[t.jsx(Fi,{}),t.jsx(se,{fontSize:"1rem",children:e})]}),t.jsx(dt,{})]})})},fv=({divisions:e})=>!e||e.length===0?null:t.jsx(P,{d:"column",gap:"4px",ai:"flex-start",children:e.map(i=>t.jsx(xv,{division:i},i))}),rn=(e,i)=>e.split("/").reduce((o,a)=>{if(a[0]===":"){const r=i[a.slice(1,a.length)];r&&o.push(r)}else o.push(a);return o},[]).join("/"),mv=p.div`
    display: flex;
    flex-direction: column;
    height: 300px;
...
`,Gs=p(Z)`
    width: 100%;
`,Sl=({group:e})=>{const{close:i}=ie();return t.jsxs(mv,{children:[t.jsxs(P,{d:"column",gap:"12px",jc:"center",h:"100%",children:[t.jsx(xt,{size:120,color:"lightBlue",children:t.jsx(Ro,{})}),t.jsx(se,{fontSize:"1.2rem",children:e})]}),t.jsxs(P,{gap:"8px",onClick:i,children:[t.jsx(Gs,{to:rn($i,{page:"current",filter:e}),children:t.jsx(v,{icon:t.jsx(Et,{}),width:"100%",text:"Расписание",background:"var(--theme-4)"})}),t.jsx(Gs,{to:`${al}/${e}`,children:t.jsx(v,{icon:t.jsx(Io,{}),width:"100%",text:"Список",background:"var(--theme-4)"})})]})]})},bv=p.div`
    width: 100%;
    color: var(--text);
    padding: 0px 16px;
    background: var(--theme-1t);
...
`,kv=({blocks:e,isStaff:i})=>e?t.jsx(t.Fragment,{children:e.map(({title:n,links:s},o)=>t.jsxs(_v,{children:[t.jsx(M,{size:4,align:"left",bottomGap:"16px",children:n}),t.jsx(Se,{gap:16,children:s.map(({title:a,href:r,visible:c},d)=>c==="staff"&&!i||c==="student"&&i?null:t.jsx("a",{href:r,target:"_blank",rel:"noreferrer",children:a},a+d))})]},n+o))}):null,Gi=e=>Array.isArray(e)?e==null?void 0:e.length:Object.keys(e??{}).length,qs=({people:e,type:i})=>!e||e.length===0?null:t.jsx(P,{d:"column",children:e.map(n=>l.createElement(us,{name:n.fio,type:i,...n,key:n.id}))}),Sv=()=>{const{allRoutes:e}=We.useMenu(),{notifications:i,removeNotificationLoading:n}=Ge.useLkNotifications(),{data:{user:s}}=be.useUser(),o=(s==null?void 0:s.user_status)==="staff",a=l.useMemo(()=>jv.flatMap(({visible:N,content:A})=>N==="staff"&&o||N==="student"&&!o||N==="all"?A:[]),[o]),[r,c]=l.useState(null),[d,u]=l.useState(null),[h,g]=l.useState(null),[x,m]=l.useState(null),[f,b]=l.useState(null),[y,C]=l.useState(null),[j,T]=l.useState(null),k=[{title:"Разделы",content:t.jsx(cv,{pages:f,showNotFound:!1}),clear:()=>{b(null)},search:N=>{if(e){const A=dv(N,e);b(A)}},data:f},{title:"Студенты",content:t.jsx(qs,{people:x,type:"stud"}),data:x,clear:()=>{m(null)},search:async N=>{const{data:A}=await lh(N,"",1,20);m(A.items)}},{title:"Сотрудники",content:t.jsx(qs,{people:h,type:"staff"}),data:h,clear:()=>{g(null)},search:async N=>{const{data:A}=await sh(N,"",1,20);g(A.items)}},{title:"Группы",content:t.jsx(vv,{groups:r}),data:r,clear:()=>{c(null)},search:async N=>{const{data:A}=await ch(N);c(A.items)}},{title:"Подразделения",content:t.jsx(fv,{divisions:d}),data:d,clear:()=>{u(null)},search:async N=>{const{data:A}=await oh(N);u(A.items)}},{title:"Уведомления",content:t.jsx(Ja,{notifications:y,loadingRemove:n}),clear:()=>{C(null)},search:N=>{const A=i.filter(Q=>me(Q.title).includes(N));C(A)},data:y},{title:"Полезная информация",content:t.jsx(kv,{blocks:j,isStaff:o}),clear:()=>{T(null)},search:N=>{const A=wv(N,a);T(A)},data:j}];return[(()=>{const{content:N,clear:A,data:Q}=k.reduce((O,te)=>(Gi(te.data)&&(O.data.push(te.data),O.content.push(t.jsxs(t.Fragment,{children:[t.jsx(M,{size:4,align:"left",children:te.title}),te.content,t.jsx(ue,{})]}))),O.clear.push(te.clear),O),{content:[],clear:[],data:[]});return{title:"Все",content:N,clear:()=>A.map(O=>O()),search:async O=>{O.length<=8&&/\d|[-]/g.test(O)?await k[3].search(O):(k[0].search(O),k[5].search(O),k[6].search(O),Gi(k[0].data)===0&&(await k[1].search(O),await k[2].search(O),await k[4].search(O)))},data:Q}})(),...k]},Tv=()=>JSON.parse(localStorage.getItem(Y.SearchHistory)??"[]"),Ev=()=>{const e=Sv(),[i,n]=l.useState(0),[s,o]=l.useState(""),a=l.useMemo(()=>Tv(),[]),r=async x=>{e[i].clear();const m=Ea(x)?Ta(x):x;await e[i].search(m),m.length>0&&!a.includes(m)&&(a.unshift(m),a.length>8&&a.pop(),localStorage.setItem(Y.SearchHistory,JSON.stringify(a)))},[c,d,u]=Oa({onDebounce:r,delay:400,defaultValue:"",deps:[i.toString()],triggerDelay:200,triggerOn:x=>(o(x),x.length>0&&(s!==x||!e[i].data))}),h=!u&&!c.length,g=!!c.length&&!u&&!!Gi(e[i].data);return{showMessage:h,showSearchResult:g,searchValue:c,setSearchValue:d,currentPage:i,setCurrentPage:n,config:e,loading:u,searchHistory:a}},$v=(e,i,n)=>i.length===0?n.map(s=>({id:s,title:s,value:s,icon:t.jsx(ys,{})})):e?n.filter(s=>me(s).includes(me(i))).map(s=>({id:s,title:s,value:s,icon:t.jsx(ys,{})})):[],Cv=()=>t.jsxs(P,{gap:"8px",ai:"flex-start",children:[t.jsx(q,{shape:"circle",size:{width:"40px",height:"40px"},margin:"0"}),t.jsxs(P,{gap:"6px",d:"column",ai:"flex-start",jc:"center",h:"100%",children:[t.jsx(q,{shape:"rect",size:{width:"300px",height:"13px"},margin:"0"}),t.jsx(q,{shape:"rect",size:{width:"220px",height:"10px"},margin:"0"})]})]}),Pv=p.div`
    @media (max-width: 1000px) {
        height: 600px;
    }
...
`,Ov=()=>{const{showMessage:e,showSearchResult:i,searchValue:n,setSearchValue:s,currentPage:o,setCurrentPage:a,loading:r,config:c,searchHistory:d}=Ev(),u=$v(r,n,d),{isOpen:h}=ie();return t.jsx(Pv,{children:t.jsxs(P,{d:"column",gap:"8px",h:"100%",children:[t.jsx(Ca,{value:n,setValue:s,loading:r,focusOn:h,hints:u}),t.jsx(Gn,{pages:c.map(({title:g})=>({title:g})),currentPage:o,setCurrentPage:a}),t.jsx($a,{value:n,setValue:s}),e&&t.jsx(P,{h:"100%",children:t.jsx(pe,{size:"60px",text:'Введите что-нибудь. Например, "Цифровые сервисы"',image:t.jsx(It,{})})}),!r&&n.length!==0&&!e&&!Gi(c[o].data)&&t.jsx(P,{h:"100%",children:t.jsx(pe,{size:"60px",text:"Ничего не было найдено",image:t.jsx(jo,{})})}),r&&Array(10).fill(0).map((g,x)=>t.jsx(Cv,{},x)),i&&t.jsx(t.Fragment,{children:c[o].content})]})})},Av=p(Ze)`
    cursor: pointer;
...
`,Iv=()=>{const e=Mg();return{Windows:[{title:"CTRL",key:"Control"},{key:"k"}],Linux:[{title:"CTRL",key:"Control"},{key:"k"}],UNIX:[{title:"CTRL",key:"Control"},{key:"k"}],MacOS:[{title:"CMD",key:"Meta",icon:t.jsx(Lo,{})},{key:"k"}]}[e]},Tl=({size:e="large"})=>{const i=Iv(),{open:n}=ie(),s=e==="large"?"16px":"8px",o=e==="large"?"100%":"92%",a=()=>n(t.jsx(Ov,{}),"Глобальный поиск");return Sa(i.map(({key:r})=>r),a),e==="icon"?t.jsx(v,{direction:"vertical",icon:t.jsx(It,{}),width:"40px",minWidth:"40px",shrinkTextInMobile:!0,background:"transparent",onClick:a}):t.jsxs(Av,{tabIndex:0,maxWidth:"750px",width:o,size:e,height:"fit-content",padding:s,justifyContent:"space-between",onClick:a,children:[t.jsx(se,{align:"left",fontSize:"0.9rem",children:t.jsxs(P,{gap:"8px",children:[t.jsx(It,{}),"Поиск"]})}),t.jsx(Nv,{w:"fit-content",gap:"4px",children:i.map(r=>t.jsx(Dv,{children:(r==null?void 0:r.icon)??(r.title??r.key).toUpperCase()},r.key))})]})},Pn=e=>e.split(" ").map(i=>i[0]),ze=(e,i)=>{const n=Pn(e),s=_[bu[n[0]]];return s==null?void 0:s[i??"main"]},Rv=p.div`
...
`;function Ci({selected:e,name:i,avatar:n,width:s,height:o,marginRight:a,notifications:r,checked:c,boxShadow:d,border:u,icon:h,avatarModal:g,onClick:x,borderRadius:m,background:f}){const[b,y]=l.useState(!0),C=Pn(i)[0]+(Pn(i)[1]??""),{open:j}=ie(),T=k=>{g?j(t.jsx(Ci,{name:i,width:"400px",height:"400px",marginRight:"0",avatar:n})):x==null||x(k)};return t.jsxs(Rv,{selected:e,width:s,height:o,marginRight:a,background:f??ze(i),boxShadow:d,border:u,onClick:T,borderRadius:m,children:[n&&b?t.jsx(Lv,{loading:"lazy",round:!0,onLoadedData:()=>y(!0),onError:()=>y(!1),src:n}):t.jsx("div",{className:"name",children:C}),h&&t.jsx("span",{className:"icon",children:h}),t.jsx(Ke,{invisibleOnFalse:!0,checked:c??!1,visible:c!==void 0,setChecked:()=>null}),t.jsx(kt,{left:"80%",top:"90%",outline:"4px solid var(--block)",visible:!!r,children:r})]})}const JS=p.header`
    width: 100%;
    /* max-width: 750px; */
    padding-top: 100px;
    position: relative;
...
`,Fv=({title:e,state:i,action:n,icon:s,disabled:o})=>{const a=()=>{n(!i)};return t.jsxs(Mv,{disabled:o,children:[s&&t.jsx("div",{className:"icon",children:s}),t.jsxs("label",{children:[t.jsx("b",{children:e}),t.jsx(ix,{id:e,isToggled:i,setIsToggled:a},e)]})]},e)},Bv=p.div`
    width: 100%;
    h2 {
        margin-top: 10px;
    }
`,Hv=({title:e,toggles:i,setToggles:n,disabled:s})=>{const o=l.useCallback((a,r)=>{i[a].state=!i[a].state,n([...i]),r&&(r==null||r(i[a].state))},[i,n]);return t.jsxs(Bv,{children:[!!e.length&&t.jsx("h2",{children:e}),i.map(({title:a,state:r,action:c},d)=>t.jsx(Fv,{disabled:s,title:a,state:r,action:()=>o(d,c)},a))]})},El=({type:e,onClick:i})=>{const{theme:n,switchTheme:s}=ut(),{settings:o}=Ft.useSettings(),a=o==null?void 0:o["settings-appearance"].property,[r,c]=l.useState(n==="light"),d=r?t.jsx(cp,{}):t.jsx(dp,{}),h=`Тема: ${r?"Светлая":"Темная"}`,[g,x]=l.useState([{title:"Темная тема",state:n!=="light",action:f=>s(f)}]);l.useEffect(()=>{x([{title:"Темная тема",state:n!=="light",action:f=>s(f)}])},[n]),l.useEffect(()=>{c(n==="light")},[n]);const m=()=>{s(r),c(f=>!f),i==null||i()};return e==="toggle"?t.jsx(Hv,{disabled:!!(a!=null&&a.scheduledLightTheme),title:"",toggles:g,setToggles:x}):e==="h-button"?t.jsx(v,{notActiveClickMessage:"У вас включена тема по расписанию. Если хотите управлять темой вручную, перейдите в настройки -> внешний вид",isActive:!a.scheduledLightTheme,text:h,background:"var(--block)",icon:d,width:"100%",align:"left",onClick:m}):t.jsx(v,{notActiveClickMessage:"У вас включена тема по расписанию. Если хотите управлять темой вручную, перейдите в настройки -> внешний вид",isActive:!a.scheduledLightTheme,padding:"0",background:_.white.transparent2,icon:t.jsx(zv,{width:"30px",background:_.green.main,children:d}),onClick:m,text:h,width:"calc(50% - 5px)",height:"73px",direction:"vertical",shrinkTextInMobile:!0})},Uv=p.div`
    position: relative;
    min-width: 40px;
    height: 40px;
    display: flex;
...
`,qv=({showSearch:e=!1})=>{const{data:{user:i}}=be.useUser();if(!i)return null;const n=s=>{s.preventDefault(),s.stopPropagation(),Me.open({e:s,height:143,content:t.jsx(Cl,{})})};return t.jsxs(Gv,{children:[e&&t.jsx(Tl,{size:"icon"}),t.jsx(Wv,{}),t.jsx(Ci,{onClick:n,width:"30px",height:"30px",avatar:i.avatar,name:i.fullName,marginRight:"0"})]})},Yv=p.header`
    width: calc(100% - 15px);
...
`,Jv=({maxWidth:e})=>e==="100%"||e==="963px"?"calc(100% - 55px)":`calc(${e} - 40px)`,Xv=({maxWidth:e})=>e==="100%"||e==="963px"?"calc(100% - 44px)":`calc(${e} - 40px)`,Kv=p.div`
...
`,Qv=()=>{const{pathname:e}=fi(),[i,n]=l.useState([e]),{action:s}=mi();return l.useEffect(()=>{switch(s){case"POP":n(i.length>1?i.slice(0,i.length-1):i);break;case"PUSH":n([...i,e]);break;case"REPLACE":n([...i.slice(0,i.length-1),e])}},[e,s]),i},Zv=({visible:e=!0,text:i="Назад",fullWidth:n=!0})=>{if(!e)return null;const s=mi();return t.jsx(v,{text:i,onClick:()=>s.goBack(),icon:t.jsx(Li,{}),textColor:"var(--blue)",background:"transparent",width:n?"100%":void 0,padding:"0",height:"20px",align:"left"})},e1=({headerVisible:e,currentPage:i})=>{const n=mi(),s=Qv(),o=e||!!(i!=null&&i.planeHeader),a=Ua(i),r=(u=si)=>()=>{et.changeOpen({isOpen:!1,currentPage:u.slice(1,u.length)}),n.push(u)},c=ce.useMemo(()=>i?i.isSubPage&&i.subPageHeaderTitle||i.title:"Не известная страница",[i]);return{backButton:ce.useMemo(()=>i!=null&&i.withoutBackButton?null:i!=null&&i.isSubPage?s.length>1?t.jsx(Zv,{text:o?"":i==null?void 0:i.backButtonText,fullWidth:!1}):i.fallbackPrevPage?t.jsx(v,{direction:"vertical",icon:t.jsx(Li,{}),onClick:r(i.fallbackPrevPage),background:"transparent"}):t.jsx(v,{direction:"vertical",icon:t.jsx(Li,{}),onClick:r(),background:"transparent"}):t.jsx(v,{icon:t.jsx(Li,{}),onClick:r(),background:"transparent",text:o?void 0:"Все разделы",padding:"0",textColor:"var(--blue)"}),[i,s,r]),headerTitle:c,maxWidth:a,currentPage:i,isHeaderVisible:o}},t1=({currentPage:e,headerVisible:i=!1})=>{var d;const{isMobile:n,isTablet:s}=Ei(),{headerTitle:o,backButton:a,isHeaderVisible:r,maxWidth:c}=e1({currentPage:e,headerVisible:i});return e!=null&&e.withoutHeader?null:t.jsxs(Yv,{headerVisible:r,hidden:(d=e??e)==null?void 0:d.withoutHeader,children:[t.jsx(Kv,{maxWidth:c,noButton:e==null?void 0:e.withoutBackButton,headerVisible:r,children:o}),t.jsxs(P,{jc:"space-between",mw:c,children:[t.jsx("div",{className:"back-button-wrapper",children:a??t.jsx("div",{})}),(n||s)&&t.jsx(qv,{showSearch:!0})]})]})},i1=ce.memo(t1),n1=p(Z)`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: 10px;
...
`,s1=({name:e,avatar:i,loading:n,size:s,notifications:o,selected:a})=>{if(n)return t.jsx(q,{shape:"circle",size:{width:"40px",height:"40px"}});const r=c=>{c.preventDefault(),c.stopPropagation(),Me.open({e:c,height:143,content:t.jsx(Cl,{})})};return t.jsxs(n1,{to:ls,children:[t.jsx(v,{icon:t.jsx(No,{}),className:"more-button",background:"transparent",onClick:r}),t.jsx(Ci,{notifications:o,width:s??"70px",height:s??"70px",avatar:i,name:e,marginRight:"0",selected:a}),t.jsx(M,{size:5,children:e})]})},o1=ce.memo(s1),a1=["isCurrent","color"],r1=p(Z).withConfig({shouldForwardProp:e=>!a1.includes(e)})`
    position: relative;
    display: flex;
    align-items: center;
    font-weight: 600;
...
`,p1=e=>{const{menuPath:i,path:n,icon:s,title:o,isCurrent:a,isAdmin:r,color:c,notifications:d}=e;return t.jsxs(r1,{to:i??n,className:"leftside-bar-item",color:c,isCurrent:a,title:o,children:[t.jsx(kt,{className:"notification",top:"50%",visible:r,right:"-20px",color:"pink",children:"A"}),t.jsx(kt,{className:"notification",top:"50%",visible:!!d,right:r?"0px":"-20px",color:"red",children:d}),s,t.jsx("span",{className:"title",children:o}),t.jsx(wl,{route:e})]})},Pl=ce.memo(p1),u1=()=>{const{isOpen:e}=We.useMenu();return t.jsx(t.Fragment,{children:t.jsx(v,{icon:t.jsx(Qe,{}),onClick:()=>et.changeOpen({isOpen:!e}),text:"Закрыть меню",width:"100%"})})},h1=({icon:e,title:i})=>{const n=()=>{const s=e;return t.jsx(s,{})};return t.jsxs(d1,{className:"leftside-bar-item",children:[n(),t.jsx("strong",{children:i})]})};ce.memo(h1);p.section`
    width: 100%;
    max-width: 270px;
    color: #383634;
...
`;const g1=()=>{const{leftsideBarRoutes:e}=We.useMenu(),i=fi();return e?t.jsx(c1,{children:Object.values(e).filter(n=>n!==void 0).map(n=>l.createElement(Pl,{...n,key:n==null?void 0:n.id,isCurrent:i.pathname.includes(n.path)}))}):t.jsxs(P,{d:"column",children:[t.jsxs(P,{gap:"8px",children:[t.jsx(q,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(q,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs(P,{gap:"8px",children:[t.jsx(q,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(q,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs(P,{gap:"8px",children:[t.jsx(q,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(q,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs(P,{gap:"8px",children:[t.jsx(q,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(q,{shape:"rect",size:{width:"160px",height:"18px"}})]})]})},x1=ce.memo(g1),f1=()=>{const{isOpen:e}=We.useMenu(),{width:i,height:n}=on(),{data:{user:s}}=be.useUser(),{visibleRoutes:o}=We.useMenu(),a=fi();return t.jsxs(l1,{isOpen:e,height:n,children:[t.jsxs("div",{className:"top-wrapper",children:[t.jsx(Z,{to:rs,children:t.jsx(sn,{width:"165px"})}),t.jsx(o1,{notifications:o==null?void 0:o.profile.notifications,avatar:s==null?void 0:s.avatar,name:(s==null?void 0:s.fullName)??"",loading:!s,selected:a.pathname==="/profile"}),t.jsx(Tl,{size:"small"}),t.jsx(x1,{})]}),t.jsx(El,{type:"toggle"}),i<1e3&&t.jsx(u1,{})]})},m1=p.div`
    width: 300px;
    position: absolute;
...
`,b1=()=>{const{isOpen:e,message:i,type:n,time:s,onClick:o}=na.usePopUpMessage();l.useEffect(()=>{e&&setTimeout(()=>{W.openPopUpMessage({isOpen:!e})},s)},[e]);const a=l.useCallback(()=>{o&&(o(),W.openPopUpMessage({isOpen:!e}))},[o]);return t.jsx(m1,{isOpen:e,isClickable:!!o,color:_t[n].color,onClick:a,children:t.jsx(J,{type:n,fontSize:"1em",lineHeight:"1.4rem",onClose:()=>W.openPopUpMessage({isOpen:!1}),children:i})})},ln=p.div`
    display: flex;
    justify-content: center;
    align-items: center;
    position: absolute;
...
`;const y1=()=>{const{isOpen:e,component:i,canBack:n,back:s,close:o,title:a}=l.useContext(Yn);return{back:s,close:o,isOpen:e,canBack:n,component:i,title:a}},v1=p.div`
    background: var(--block);
    color: var(--text);
    padding: 20px;
    min-height: 150px;
...
`,S1=()=>{const{isOpen:e,message:i,onConfirm:n,onReject:s}=la.useConfirm(),o=l.useRef(null);Ht(o,()=>Je.closeConfirm());const a=()=>{n(),Je.closeConfirm()},r=()=>{Je.closeConfirm()};return t.jsx(ln,{isOpen:e,children:t.jsxs(k1,{isOpen:e,ref:o,children:[t.jsx(M,{size:3,align:"left",children:i??"Хотите продолжить?"}),t.jsxs(Se,{width:"100%",scroll:!1,direction:"horizontal",gap:5,padding:"10px 0 0 0",horizontalAlign:"right",children:[t.jsx(v,{text:"Да",onClick:a,width:"90px",textColor:_.red.main,background:"transparent",hoverBackground:_.red.transparent3}),t.jsx(v,{text:"Нет",onClick:s??r,width:"90px",textColor:_.blue.main,background:"transparent",hoverBackground:_.blue.transparent3})]})]})})},T1=p.div`
    display: flex;
...
`,E1=({pages:e,currentPage:i=0,width:n,className:s,maxWidth:o,sliderWidth:a,onChangePage:r,align:c="center",appearance:d=!0})=>{const[u,h]=l.useState(i),{width:g}=on(),x=l.useRef(null),m=()=>{var b;x!=null&&x.current&&h(Math.round(((b=x.current)==null?void 0:b.scrollLeft)/g))},f=b=>{var y;h(b),r==null||r((y=e[b])==null?void 0:y.id),x!=null&&x.current&&(x.current.scrollLeft=x.current.clientWidth*b)};return l.useEffect(()=>{f(u)},[i,g]),t.jsxs(T1,{width:n,align:c,maxWidth:o,children:[t.jsx(Gn,{pages:e.map(({title:b,condition:y})=>({title:b,condition:y})),currentPage:u,setCurrentPage:f,sliderWidth:a,appearance:d}),t.jsx("div",{className:s??"slider-content",ref:x,onScroll:m,children:e.map(b=>b.condition!==void 0&&b.condition||b.condition===void 0?t.jsx("div",{className:"slider-page",children:b.content},b.title):t.jsx("div",{className:"slider-page",children:t.jsx(pe,{text:"Нет данных"})},b.title))})]})},ps=E1,Ys=e=>{switch(e){case"small":return"0.65em";case"middle":return"0.77em";default:return"1em"}},Js=(e,i)=>e==="horizontal"?i==="small"?"15px":i==="middle"?"30px":"45px":i==="small"?"30px":i==="middle"?"35px":"45px",Ol=(e,i,n,s)=>{const o=[e?"Я":i==="staff"?"Сотрудник":"Студент"];return e||(n&&o.push(n),s&&o.push(`${s}`)),o},$1=e=>{switch(e){case"small":return"82px";case"middle":return"90px";default:return"100px"}},C1=p.div`
    width: ${({width:e})=>e??"100%"};
...
`,Al=e=>{const{children:i}=e;return t.jsxs(D1,{children:[t.jsx(A1,{...e}),t.jsx("div",{className:"buttons",children:i})]})},N1=p.div`
    display: flex;
    align-items: center;
    .name-and-status {
        display: flex;
...
`,I1=()=>t.jsxs(N1,{children:[t.jsx(q,{shape:"circle",size:{width:"30px",height:""},margin:"8px 0px 8px 0 "}),t.jsxs("div",{className:"name-and-status",children:[t.jsx(q,{shape:"rect",size:{width:"130px",height:"10px"},margin:"1px 10px"}),t.jsx(q,{shape:"rect",size:{width:"70px",height:"8px"},margin:"0px 10px"})]})]}),Dl=e=>{if(e)return()=>{Je.evokeConfirm({message:"Вы уверены, что хотите сменить аккаунт?",onConfirm:()=>{localStorage.setItem(Y.Token,e),location.reload()}})}},R1=e=>{const{close:i}=ie(),{token:n,name:s,group:o}=e,a=`linear-gradient(45deg, ${ze(s,"main")}, ${ze(s,"dark1")})`;return t.jsxs(Al,{...e,type:"stud",children:[!n&&t.jsxs(t.Fragment,{children:[o&&t.jsx(Z,{to:rn($i,{page:"current",filter:o}),children:t.jsx(v,{icon:t.jsx(Et,{}),text:"Расписание",onClick:()=>i(),width:"100%",background:"var(--theme-4)"})}),t.jsx(v,{icon:t.jsx(Mn,{}),text:"Написать",onClick:()=>i(),width:"100%",background:"var(--theme-4)",isActive:!1})]}),n&&t.jsx(v,{text:"Войти в аккаунт",width:"100%",textColor:"#fff",background:a,onClick:Dl(n)})]})},L1=e=>{const{close:i}=ie(),{token:n,name:s}=e,o=`linear-gradient(45deg, ${ze(s,"dark1")}, ${ze(s,"main")})`;return t.jsxs(Al,{type:"staff",...e,children:[!n&&t.jsxs(t.Fragment,{children:[t.jsx(Z,{to:rn($i,{page:"current",filter:s}),children:t.jsx(v,{icon:t.jsx(Et,{}),text:"Расписание",onClick:()=>{i()},background:"var(--theme-4)",width:"100%"})}),t.jsx(v,{icon:t.jsx(Mn,{}),text:"Написать",onClick:()=>i(),width:"100%",background:"var(--theme-4)",isActive:!1})]}),n&&t.jsx(v,{text:"Войти в аккаунт",width:"100%",textColor:"#fff",background:o,onClick:Dl(n)})]})},z1=p.div`
    display: flex;
    align-items: center;
    ...
    color: var(--text);
    cursor: pointer;
    width: ${({orientation:e,size:i})=>e==="vertical"?$1(i):"100%"};
...
`,us=e=>{const{open:i}=ie(),{type:n,avatar:s,name:o,checked:a,onClick:r,indexNumber:c,division:d,group:u,isMe:h=!1,loading:g=!1,orientation:x="horizontal",size:m="middle"}=e,f=Ol(h,n,d,u);if(g)return t.jsx(I1,{});const b=y=>{r?r(y):h||(Me.close(),i(n==="staff"?t.jsx(L1,{...e}):t.jsx(R1,{...e})))};return t.jsxs(z1,{orientation:x,size:m,onClick:b,children:[c&&t.jsx("div",{className:"index",children:c}),t.jsx(Ci,{name:o,avatar:s,width:Js(x,m),height:Js(x,m),marginRight:x==="horizontal"?"7px":"0px",checked:a}),t.jsxs("div",{className:"name-and-status",children:[t.jsx("span",{className:"name",children:o}),t.jsx("span",{className:"status",children:t.jsx(Ue,{words:f})})]})]})},qi=e=>{const i=me(e),s=[{keys:["распознаван"],icon:t.jsx(hp,{})},{keys:["принт"],icon:t.jsx(gp,{})},{keys:["химич"],icon:t.jsx(xp,{})},{keys:["сервер"],icon:t.jsx(fp,{})},{keys:["игр"],icon:t.jsx(mp,{})},{keys:["жизнед"],icon:t.jsx(bp,{})},{keys:["web","веб"],icon:t.jsx(yp,{})},{keys:["истор"],icon:t.jsx(vp,{})},{keys:["информат"],icon:t.jsx(jp,{})},{keys:["информации"],icon:t.jsx(Ce,{})},{keys:["мобильн"],icon:t.jsx(wp,{})},{keys:["безопасн"],icon:t.jsx(_p,{})},{keys:["автоматиз"],icon:t.jsx(kp,{})},{keys:["линейн"],icon:t.jsx(Sp,{})},{keys:["обработ"],icon:t.jsx(Tp,{})},{keys:["презентац"],icon:t.jsx(Ep,{})},{keys:["операционн"],icon:t.jsx(Lo,{})},{keys:["эконом"],icon:t.jsx(ot,{})},{keys:["информацион","программир","сайт"],icon:t.jsx($p,{})},{keys:["анализ"],icon:t.jsx(Cp,{})},{keys:["компьют","алгоритм","электрон"],icon:t.jsx(Pp,{})},{keys:["сети","сетей"],icon:t.jsx(Op,{})},{keys:["матем"],icon:t.jsx(Ap,{})},{keys:["вероятн"],icon:t.jsx(Dp,{})},{keys:["философ"],icon:t.jsx(zo,{})},{keys:["данны"],icon:t.jsx(Np,{})},{keys:["язык"],icon:t.jsx(Ip,{})},{keys:["спорт","физичес"],icon:t.jsx(Rp,{})},{keys:["проектная"],icon:t.jsx(wn,{})},{keys:["интеллект"],icon:t.jsx(Lp,{})},{keys:["научн"],icon:t.jsx(zp,{})},{keys:["предприним"],icon:t.jsx(Mp,{})},{keys:["коммуникац"],icon:t.jsx(Fp,{})},{keys:["управлени"],icon:t.jsx(Mo,{})},{keys:["вкр","итоговая","аттестация"],icon:t.jsx(Oo,{})},{keys:["переработ"],icon:t.jsx(Bp,{})},{keys:["машин","инжен"],icon:t.jsx(Hp,{})},{keys:["проектир","расчет"],icon:t.jsx(Up,{})},{keys:["производ"],icon:t.jsx(To,{})},{keys:["эколог"],icon:t.jsx(Wp,{})},{keys:["защит"],icon:t.jsx(Vp,{})},{keys:["патент"],icon:t.jsx(Gp,{})},{keys:["материал"],icon:t.jsx(qp,{})},{keys:["физик"],icon:t.jsx(Yp,{})},{keys:["тайм"],icon:t.jsx(Jp,{})},{keys:["практика"],icon:t.jsx(Fo,{})}].find(o=>o.keys.find(a=>i.includes(a)));return s?s.icon:t.jsx(up,{})},On={"9:00 - 10:30":_.green,"10:40 - 12:10":_.lightGreen,"12:20 - 13:50":_.blue,"14:30 - 16:00":_.purple,"16:10 - 17:40":_.pink,"17:50 - 19:20":_.red,"18:20 - 19:40":_.orange,"19:30 - 21:00":_.orange,"19:50 - 21:10":_.orange},Nl=({deps:e,getScrollTopValue:i,condition:n=!0})=>{const s=l.useRef(null);return l.useLayoutEffect(()=>{if(s.current&&n){const o=i(s.current);s.current.scrollTop=o}},[s,...e??[]]),s},M1=p.div`
...
`,cn=(e,i="minutes")=>{switch(i){case"minutes":const n=new Date,[s,o]=e.split(":");return+s*60+ +o-(n.getHours()*60+n.getMinutes());case"days":const a=new Date(e);return Math.ceil(Math.floor((a.getTime()-new Date().getTime())/1e3/60/60)/24)}},F1=e=>{if(!e)return 1/0;const i=e.reduce((n,s)=>{const o=cn(s.startTime);return o>0&&n.push(o),n},[]);return Math.min(...i)},Il=(e,i,n)=>F1(e)===cn(i.startTime)&&n,ui=e=>e<=9?"0"+e:e,B1=e=>`${ui(Math.floor(e/60))}:${ui(e%60)}`,Xs=(e=new Date,i,n)=>{const s=e.getHours()*60+e.getMinutes();return i&&s<i?i:n&&s>n?n:s},H1=p.div`
...
`,Y1=({isVisible:e=!0,shift:i,scale:n,interval:s,showTime:o=!0})=>{const[a,r]=l.useState(Xs(new Date,s[0]*60,s[1]*60)),c=l.useRef(null);return l.useEffect(()=>(c.current=setInterval(()=>{r(Xs(new Date,s[0]*60,s[1]*60))},Un.minute),()=>clearInterval(c.current)),[e]),t.jsx(G1,{currentTime:(a-i)*n,children:o&&t.jsx(q1,{children:B1(a)})})},Rl=e=>{if(e.includes("https://")){const i=e.split(" "),n=i.findIndex(o=>o.includes("https")),s=i.splice(n,n+1)[0];return{name:i.join(" "),link:s}}return{name:e}},Re=({icon:e,text:i,onClick:n,rightIcon:s,shortInfo:o=!1})=>t.jsxs(W1,{onClick:n,shortInfo:o,gap:"7px",mw:"100%",w:"fit-content",children:[t.jsx(Ks,{shortInfo:o,children:e}),t.jsx(V1,{width:"100%",className:"text",children:i}),t.jsx(Ks,{shortInfo:o,children:s})]}),J1=p.div`
    display: flex;
    flex-direction: column;
    gap: 8px;
...
`,K1=({groups:e})=>{const{close:i}=ie();return t.jsx(J1,{children:e.map(n=>t.jsxs(X1,{to:rn($i,{page:"current",filter:n.trim()}),onClick:i,children:[t.jsxs("div",{className:"start",children:[t.jsx(Rt,{}),n]}),t.jsx(dt,{})]},n))})},Q1=({icon:e,background:i,noPadding:n=!1})=>t.jsx(H1,{background:i,noPadding:n,children:t.jsxs(U1,{children:[t.jsx("div",{children:e}),t.jsx("div",{children:e}),t.jsx("div",{children:e}),t.jsx("div",{children:e})]})}),Z1=p.div`
    width: 100%;
    height: 110px;
    position: relative;
    color: var(--text);
...
`,ej=({subjectName:e,color:i,noPadding:n})=>{const s=qi(e),{theme:o}=ut(),a=o==="light"?i.dark3:i.light3,r=o==="light"?i.light3:i.dark3,c=o==="light"?i.light3:i.dark3;return t.jsxs(Z1,{noPadding:n,textColor:a,iconBackground:c,children:[t.jsx(Q1,{noPadding:n,icon:s,background:r}),t.jsx(xt,{color:i.main,size:70,borderRadius:"19px",children:s})]})},tj=Xp`
	* {
		margin: 0;
		padding: 0;
		box-sizing: border-box;
...
`,Ll=({timeInterval:e,color:i,isCurrentEvent:n})=>{const{theme:s}=ut(),o=s==="light"?i.main:i.light2;return t.jsxs(sj,{children:[t.jsx(nj,{start:n,color:o}),e&&t.jsx(oj,{children:e})]})},aj=p.div`
    position: relative;
    height: 100%;
    max-width: 400px;
...
`,Ri=({title:e,link:i,image:n})=>i?t.jsxs(cj,{href:i,children:[t.jsx("img",{src:n,alt:"",loading:"lazy"}),t.jsx(M,{size:3,children:e})]}):null,Qs=p.div`
    ${ee.isNotMobile} {
        width: 500px;
    }
...
`,dj=({place:e,link:i,name:n})=>{const[s,o]=l.useState(!1);return l.useEffect(()=>{o(!0),setTimeout(()=>o(!1),500)},[n]),s?t.jsx(Qs,{children:t.jsx(P,{jc:"center",children:t.jsx(ht,{})})}):t.jsx(Qs,{children:e==="Webex"?t.jsx(Ri,{title:e,link:i,image:"https://lh3.googleusercontent.com/-IR3NTxu_EJY/YMB7bMtdDOI/AAAAAAAAAmA/57OhYSNULo0ICfc3Q4TWAoRM7ohUFLJmwCLcBGAsYHQ/s220-w220-h140-nd/220x140%2BCisco%2BWebex%25281%2529.png"}):e==="Zoom"?t.jsx(Ri,{title:e,link:i,image:"https://yogaworks.ru/wp-content/uploads/2020/04/zoom-banner-600x300-600x300.jpg"}):e==="Обучение LMS"?t.jsx(Ri,{title:e,link:i,image:"https://online.mospolytech.ru/pluginfile.php/1/theme_opentechnology/settings_setpolytech_header_backgroundimage/1638781183/01.jpg"}):e==="Webinar"?t.jsx(Ri,{title:e,link:i,image:"https://apix-drive.com/ru/img/webinar_ru.png"}):e==="Прянишникова"?t.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[t.jsx("a",{href:"https://yandex.ru/maps/213/moscow/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"0px"},children:"Москва"}),t.jsx("a",{href:"https://yandex.ru/maps/213/moscow/house/ulitsa_pryanishnikova_2a/Z04YcwNjTkAPQFtvfXRycntjbA==/?ll=37.545032%2C55.833931&utm_medium=mapframe&utm_source=maps&z=17",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"14px"},children:"Улица Прянишникова, 2А на карте Москвы, ближайшее метро Коптево — Яндекс Карты"}),t.jsx("iframe",{src:"https://yandex.ru/map-widget/v1/-/CCUBAPA0PC",width:"560",height:"400",frameBorder:"1",allowFullScreen:!0,style:{position:"relative"}})]}):e==="Автозаводская"?t.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[t.jsx("a",{href:"https://yandex.ru/maps/213/moscow/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"0px"},children:"Москва"}),t.jsx("a",{href:"https://yandex.ru/maps/213/moscow/house/avtozavodskaya_ulitsa_16/Z04YcANlSEwBQFtvfXtxdX5hZA==/?ll=37.646696%2C55.704260&utm_medium=mapframe&utm_source=maps&z=18.17",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"14px"},children:"Автозаводская улица, 16 — Яндекс Карты"}),t.jsx("iframe",{src:"https://yandex.ru/map-widget/v1/-/CCUBAPsXDC",width:"560",height:"400",frameBorder:"1",allowFullScreen:!0,style:{position:"relative"}})]}):e==="Павла Корчагина"?t.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[t.jsx("a",{href:"https://yandex.ru/maps/org/moskovskiy_politekhnicheskiy_universitet/1743307891/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"0px"},children:"Московский Политехнический университет"}),t.jsx("a",{href:"https://yandex.ru/maps/213/moscow/category/university_college/184106140/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"14px"},children:"ВУЗ в Москве"}),t.jsx("iframe",{src:"https://yandex.ru/map-widget/v1/-/CCUBAPtC9A",width:"560",height:"400",frameBorder:"1",allowFullScreen:!0,style:{position:"relative"}})]}):e==="Большая Семеновская"?t.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[t.jsx("a",{href:"https://yandex.ru/maps/org/moskovskiy_politekhnicheskiy_universitet/1113152789/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"0px"},children:"Московский политехнический университет"}),t.jsx("iframe",{src:"https://yandex.ru/map-widget/v1/-/CCUBATAEkC",width:"560",height:"400",frameBorder:"1",allowFullScreen:!0,style:{position:"relative"}})]}):e==="Михалковская "&&t.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[t.jsx("a",{href:"https://yandex.ru/maps/org/sportivny_klub_sektsiya/1699871922/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"0px"},children:"Спортивный клуб, секция"}),t.jsx("iframe",{src:"https://yandex.ru/map-widget/v1/-/CCUBA-FspD",width:"560",height:"400",frameBorder:"1",allowFullScreen:!0,style:{position:"relative"}})]})})},Zs=p.div`
    ...
    font-size: 0.65rem;
    font-weight: 500;
`,zl=({timeLeft:e,isNext:i,color:n,isCurrentEvent:s})=>{const o=Math.floor(e/60),{theme:a}=ut(),r=a==="light"?n.dark3:n.light3,c=a==="light"?n.transparent1:n.transparent3;return!i&&!s?null:s?t.jsx(Zs,{background:c,color:r,children:"Сейчас"}):t.jsxs(Zs,{background:c,color:r,children:["через ",!!o&&o+"ч."," ",e%60,"мин."]})},pj=p.div`
    width: 100%;
    background: var(--block);
    padding: 20px 15px;
    border-radius: 9px;
...
`,iT=()=>t.jsxs(pj,{children:[t.jsxs("div",{className:"horizontal",children:[t.jsx(q,{shape:"rect",size:{width:"86px",height:"20px"},margin:"0"}),t.jsx(q,{shape:"rect",size:{width:"60px",height:"14px"},margin:"0 5px"})]}),t.jsx(q,{shape:"rect",size:{width:"200px",height:"17px"},margin:"16px 0"}),t.jsxs("div",{className:"horizontal",children:[t.jsx(q,{shape:"rect",size:{width:"120px",height:"13px"},margin:"0"}),t.jsx(q,{shape:"rect",size:{width:"120px",height:"13px"},margin:"0 10px"})]}),t.jsx(q,{shape:"rect",size:{width:"80px",height:"12px"},margin:"5px 0"})]}),Ml="/assets/sleep-54d590c1.gif";var Fl=(e=>(e[e.day=0]="day",e[e.week=1]="week",e[e.month=2]="month",e))(Fl||{});const uj=[{title:"День",condition:!0},{title:"Неделя",condition:!0}],nT=[...uj,{title:"Месяц",condition:!0}],wt=Object.keys(At).reduce((e,i)=>(e[i]=[],e),{}),hj={schedule:{today:[],week:{...wt},semestr:{data:{...wt},startDate:new Date,endDate:new Date},session:{data:{...wt},startDate:new Date,endDate:new Date}},teachers:[]},gj=e=>{const i=new Date(e),n=i.getDay(),s=i.getDate()-n+(n==0?-6:1);return new Date(i.setDate(s))},hi=e=>{const[i,n]=e.split(":");return+i*60+ +n};var Yi=(e=>(e[e.Янв=1]="Янв",e[e.Фев=2]="Фев",e[e.Мар=3]="Мар",e[e.Апр=4]="Апр",e[e.Май=5]="Май",e[e.Июн=6]="Июн",e[e.Июл=7]="Июл",e[e.Авг=8]="Авг",e[e.Сен=9]="Сен",e[e.Окт=10]="Окт",e[e.Ноя=11]="Ноя",e[e.Дек=12]="Дек",e))(Yi||{});const Bl=e=>{const[i,n]=e.split(" "),s=Yi[n],o=new Date().getMonth()>s?new Date().getFullYear()+1:new Date().getFullYear();return new Date(`${s}/${i}/${o}`)},Hl=(e,i)=>{const[n,s]=(e==null?void 0:e.split(" "))??[null,null],o=i.split(" ")[1],a=Yi[o],r=Yi[s]||a;return n&&r?new Date(`${r}/${n}/${r>=a?new Date().getFullYear():new Date().getFullYear()+1}`):null},Zt=(e,i)=>e?e==null?void 0:e.map(({place:s,name:o,teachers:a,timeInterval:r,link:c,dateInterval:d,rooms:u,groups:h})=>{const[g,x]=r.split(" - "),m=hi(x)-hi(g),[f,b]=d.split("-").map(j=>j.trim()),y=Bl(f),C=Hl(b,f);return{title:o,people:a,startTime:g,duration:m,startDate:y,endDate:C,placeIcon:t.jsx(Kp,{}),dateInterval:d,color:On[r],place:s,link:c,groups:h,weekday:i,rooms:u,icon:qi(o)}}):[],xj=e=>new Date(e.setHours(0,0,0,0)),eo=(e,i)=>(e??[]).filter(n=>{const s=xj(i),[o,a]=n.dateInterval.split("-").map(d=>d.trim()),r=Bl(o),c=Hl(a,o);return s>=r&&s<=(c??r)}),Ul=e=>e.toLocaleDateString("en-US",{weekday:"long"}).toLocaleLowerCase(),An=e=>e instanceof Date&&isFinite(+e),fj=e=>{const i={...wt},n=new Date(Object.keys(e)[0]),s=new Date(Object.keys(e)[Object.keys(e).length-1]);if(!An(n)||!An(s))return{schedule:i,startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1),endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0)};for(const o in e)if(Object.prototype.hasOwnProperty.call(e,o)){const a=new Date(o),r=Ul(a);if(r==="sunday")continue;i[r]=Zt(e[o].lessons,At[r].short)}return{schedule:i,startDate:n,endDate:s}},Wl=(e,i)=>new Date(e.getFullYear(),e.getMonth(),e.getDate()+i),Vl=(e,i)=>{let n=new Date(new Date().getFullYear(),new Date().getMonth(),1),s=new Date(new Date().getFullYear(),new Date().getMonth()+1,0);if(typeof e=="object"&&"status"in e){const g=`Не удалось загрузить расписание. Причина: ${e.message??"-"}`;return W.evokePopUpMessage({message:g,type:"failure",time:Un.ten_seconds}),{schedule:hj.schedule,errorInData:g}}const o=new Date;let a=gj(o);o.getDay()===0&&(a=Wl(o,1));const r={...wt},c={...wt};for(const g in e)if(g!=="Sunday"){const x=g.toLocaleLowerCase(),f=e[g];"lessons"in f?(r[x]=Zt(eo(f.lessons,a),At[x].short),c[x]=Zt(f.lessons,At[x].short)):(r[x]=Zt(eo(f,a),At[x].short),c[x]=Zt(f,At[x].short)),n=new Date(Math.min(...c[x].map(b=>b.startDate.getTime()),n.getTime())),s=new Date(Math.max(...c[x].map(b=>(b.endDate??b.startDate).getTime()),s.getTime())),a.setDate(a.getDate()+1)}const d=new Date().toLocaleDateString("en-EN",{weekday:"long"}).toLocaleLowerCase(),u=r[d],h=fj(i);return{schedule:{today:u,week:r,semestr:{data:c,startDate:n,endDate:s},session:{data:h.schedule,startDate:h.startDate,endDate:h.endDate}}}},Gl=async e=>{const i=await Pu(e),n=await Au();return Vl(i.data,n.data)},ql=async e=>{const i=await Ou(e),n=await Du(e);return Vl(i.data,n.data)},to={data:{schedule:null,externalSchedule:null,view:Fl.day,filter:"",searchValue:"",hasNoSchedule:!1},loading:!1,error:null},mj=()=>V(le),St=L(async e=>{try{if(!e)throw new Error("Невозможно получить расписание, так как не указан пользователь");const{group:i,fullName:n,user_status:s}=e;if(n&&s==="staff")return await ql(n);if(i&&s==="stud")return await Gl(i);throw new Error("Невозможно получить расписание, так как не указан ни один из параметров")}catch(i){throw new Error(i.message)}}),Vt=L(async({group:e})=>{try{if(!e)throw new Error("Невозможно получить расписание, так как не указана группа");return await Gl(e)}catch(i){throw new Error(i.message)}}),Gt=L(async({fullName:e})=>{try{if(!e)throw new Error("Невозможно получить расписание, так как не указано имя сотрудника");return await ql(e)}catch(i){throw new Error(i.message)}}),bj=S(),Yl=S(),Jl=S(),Xl=S(),Kl=S(),Ql=S(),Zl=S(),le=X(to).on(St,e=>({...e,data:{...e.data,schedule:null,hasNoSchedule:!1},error:null})).on(St.failData,(e,i)=>({...e,error:`${i.cause}, ${i.message}, ${i.stack}, ${i.name}`})).on(Yl,(e,i)=>({...e,data:{...e.data,view:i}})).on(Jl,(e,i)=>({...e,currentChosenDay:i.day})).on(Xl,()=>({...to}));$({clock:St.doneData,source:le,fn:(e,i)=>({...e,data:{...e.data,...i,hasNoSchedule:i.errorInData?!1:JSON.stringify(i.schedule.semestr.data)===JSON.stringify(wt)}}),target:le});$({clock:Kl,source:le,fn:(e,i)=>({...e,data:{...e.data,filter:i}}),target:le});$({clock:Ql,source:le,fn:(e,i)=>({...e,data:{...e.data,searchValue:i}}),target:le});$({clock:Gt.doneData,source:le,fn:(e,i)=>({...e,data:{...e.data,externalSchedule:i.schedule,errorInData:i.errorInData}}),target:le});$({clock:Vt.doneData,source:le,fn:(e,i)=>({...e,data:{...e.data,externalSchedule:i.schedule,errorInData:i.errorInData}}),target:le});$({clock:[Vt,Gt,St],source:le,fn:e=>({...e,loading:!0}),target:le});$({clock:[Vt,Gt],source:le,fn:e=>({...e,data:{...e.data,externalSchedule:null}}),target:le});$({clock:[Vt.doneData,Gt.doneData,St.doneData],source:le,fn:e=>({error:null,loading:!1,data:{...e.data}}),target:le});$({clock:[Vt.failData,Gt.failData,St.failData],source:le,fn:(e,i)=>({...e,error:i.message,loading:!1}),target:le});$({clock:Zl,source:le,fn:e=>({...e,data:{...e.data,externalSchedule:null,externalStartDate:null,externalEndDate:null}}),target:le});const hs={useSchedule:mj},yj={changeCurrentModule:bj,changeView:Yl,changeCurrentChosenDay:Jl,clearStore:Xl,resetExternalSchedule:Zl,setSearchValue:Ql,setFilter:Kl},vj={getScheduleFx:St,getGroupScheduleFx:Vt,getTeacherScheduleFx:Gt},jj=Object.freeze(Object.defineProperty({__proto__:null,effects:vj,events:yj,selectors:hs},Symbol.toStringTag,{value:"Module"})),wj=(e,i)=>{const[n,s]=e.split(":"),o=+n*60+ +s+i;return`${ui(Math.floor(o/60))}:${ui(o%60)}`},ec=(e,i)=>e?`${e} - ${wj(e,i)}`:"9:00",Dn=e=>!e||!An(e)?0:e.getHours()*60+e.getMinutes(),gs=(e,i)=>hi(e.startTime)<=Dn(new Date)&&Dn(new Date)<=hi(e.startTime)+e.duration&&i,tc=()=>{const{open:e}=ie();return n=>{const s=ec(n.startTime,n.duration);e(t.jsx(lj,{link:n.link,isNextEvent:!1,timeInterval:s,name:n.title,teachers:n.people,rooms:n.rooms??[],groups:n.groups,isCurrentEvent:gs(n,!0),noPadding:!0,...n}))}},io={isMiddleDesktop:1.35,isSmallDesktop:1.35,isTablet:1.5,isMobile:1.2},_j=()=>{const{currentDevice:e}=Ei(),[i,n]=l.useState(io[e]);return l.useEffect(()=>{n(io[e])},[e]),i},kj=p.div`
    --time-width: 55px;
...
`,Sj=({dayEvents:e,day:i})=>{const n=_j(),s=tc(),o=[9,22];return e!=null&&e.length?t.jsx(kj,{children:t.jsx(sc,{events:e,interval:o,scale:n,weekday:0,currentDay:0,shift:o[0]*60,onEventClick:s})},i):t.jsx(pe,{text:"В этот день пар нет",image:Ml})},ic=()=>{const{data:{schedule:e}}=hs.useSchedule(),{open:i}=ie(),n=Wl(new Date,1),s=Er(n.toLocaleDateString("ru-RU",{weekday:"long",day:"2-digit",month:"long"})),o=Ul(n),a=o==="sunday"?[]:e==null?void 0:e.week[o];if(!(e!=null&&e.week))return null;const r=()=>i(t.jsx(Sj,{dayEvents:a,day:s}),s);return t.jsx(v,{text:"Посмотреть следующий",onClick:r,textColor:"var(--blue)",background:"transparent"})},Tj=p.div`
    width: 100%;
    background: var(--block);
    padding: 20px 15px;
    border-radius: 9px;
...
`,sT=({errorInData:e})=>t.jsxs(Tj,{children:[t.jsx("img",{src:Ml,alt:"дед наелся и спит"}),t.jsx("span",{children:"В этот день пар нет"}),!e&&t.jsx(ic,{})]});p.div`
    border-radius: 15px;
    overflow: hidden;
    padding: 6px;
    background: var(--theme-2);
...
`;const Ej=(e,i,n)=>i?e?1:.8:n?1:0,$j=e=>e?1:.9;p.div`
    display: flex;
    flex-direction: column;
    ...
    transition: 0.2s;
    color: var(--text);
    opacity: ${({isCurrent:e,isFull:i,isVisible:n})=>Ej(e,i,n)};
    transform: scale(${({isVisible:e})=>$j(e)});
    overflow-y: auto;
...
`;const Cj=p.div`
    ...
    border-radius: var(--brLight);
    row-gap: 10px;
`,oT=()=>t.jsxs(Cj,{children:[t.jsx(va,{size:"38px"}),t.jsx(M,{size:4,children:"Учебный день завершился"}),t.jsx(ic,{})]});p.div`
    display: flex;
    align-items: center;
    column-gap: 5px;
...
`;const Pj=e=>{const[i,n]=e.split(":");return+i*60+ +n},nc=(e,i,n)=>e?(Pj(e)-i)*n:0,Oj=p.div`
    background: ${({background:e})=>e};
...
`,Ij=p(P)`
    ...
    margin-left: 0px;
    margin-right: 0px;
`,Rj=e=>{const{title:i,duration:n,icon:s,startTime:o,place:a,people:r,shift:c,color:d,scale:u,onClick:h,link:g,rooms:x,dateInterval:m,leftShift:f,quantity:b,isCurrentEvent:y=!1,nameInOneRow:C=!0,isNextEvent:j=!1,listView:T=!1,shortInfo:k=!1}=e,{theme:U}=ut(),{isMobile:N}=Ei(),A=U==="light"?d.dark3:d.light3,Q=U==="light"?d.transparent1:d.transparent2,O=()=>h(e),te=(N||b>1)&&k,Te=N&&b>=2&&k,ye=r==null?void 0:r.map(Ne=>{var Pi,Oi;const qt=Ne.split(" ");return`${qt[0]??""} ${((Pi=qt[1])==null?void 0:Pi[0])??""}.${((Oi=qt[2])==null?void 0:Oi[0])??""}.`}),qe=nc(o,c,u),De=Rl(i),ge=Te?i.split(" ").map(Ne=>Ne[0].toUpperCase()):Hi(De.name,k?te?43:35:C?300:64);return t.jsxs(Oj,{background:Q,textColor:A,listView:T,leftShift:100*f,quantity:100/b,duration:n,scale:u,top:qe,onClick:O,shortInfo:k,children:[t.jsx(Nj,{children:s}),t.jsx(P,{className:"event-body",gap:"0px",ai:"flex-start",children:t.jsxs(Aj,{scale:u,d:"column",ai:"flex-start",shortInfo:k,children:[t.jsxs(P,{d:"column",gap:"2px",children:[!k&&t.jsxs(P,{gap:"8px",children:[t.jsx(Ll,{timeInterval:ec(o,n),color:d,isCurrentEvent:y}),t.jsx(zl,{timeLeft:cn(o,"minutes"),isNext:j,color:d,isCurrentEvent:y}),!!(x!=null&&x.length)&&t.jsx(Re,{shortInfo:k,icon:N&&b>1?void 0:t.jsx(kn,{}),text:t.jsx(Ue,{words:x})}),(!!g||De.link)&&t.jsx("a",{href:g??De.link,target:"_blank",rel:"noreferrer",children:t.jsx(Re,{shortInfo:k,icon:t.jsx(_n,{}),text:g?a:"Cсылка"})})]}),t.jsx(Dj,{listView:T,nameInOneRow:C,scale:u,shortInfo:k,children:ge})]}),!!r.length&&!te&&t.jsx(Re,{shortInfo:k,text:t.jsx(Ue,{words:k?[ye[0]]:ye}),icon:t.jsx(Qp,{})}),!!(x!=null&&x.length)&&k&&!te&&t.jsx(Re,{shortInfo:k,icon:t.jsx(kn,{}),text:t.jsx(Ue,{words:x})}),!!g&&k&&!te&&t.jsx("a",{href:g,target:"_blank",rel:"noreferrer",children:t.jsx(Re,{shortInfo:k,icon:t.jsx(_n,{}),text:a})}),!!m&&!te&&t.jsx(P,{gap:"5px",d:"column",ai:"flex-start",children:t.jsx(Re,{shortInfo:k,icon:t.jsx(Hn,{}),text:m})})]})})]})},Lj=e=>{const i={};if(!e)return i;for(let n=0;n<e.length;n++){const s=e[n];i[s.startTime]||(i[s.startTime]=[]),s.startTime==="18:20"?(i["17:50"]||(i["17:50"]=[]),i["17:50"].push(s)):s.startTime==="19:50"&&i["19:30"]?(i["19:30"]||(i["19:30"]=[]),i["19:30"].push(s)):i[s.startTime].push(s)}return i},zj=({events:e,shift:i,scale:n,shortInfo:s,weekDay:o,interval:a,showTime:r,onClick:c,currentDay:d})=>{const u=Lj(e),h=new Date().getDay()===o,g=d!==void 0?d+1===o:void 0;return t.jsxs(Ij,{h:"100%",d:"column",children:[h&&t.jsx(Y1,{isVisible:g,showTime:r,scale:n,shift:i,interval:a}),Object.keys(u).map((x,m)=>u[x].map((f,b)=>l.createElement(Rj,{leftShift:b,quantity:u[x].length,scale:n,isCurrentEvent:gs(f,h),isNextEvent:Il(e,f,h),...f,onClick:c,shift:i,key:f.startTime+f.title+m+b,shortInfo:s})))]})},Mj=p(P)`
    position: absolute;
    left: 0;
    z-index: 0;
...
`,Uj=Array(24).fill(0).map((e,i)=>`${ui(i)}:00`),Wj=({interval:e,scale:i,shortTimes:n=!1})=>{const s=n?Array(24).fill(0).map((o,a)=>`${a}`).slice(e[0],e[1]+1):Uj.slice(e[0],e[1]+1);return t.jsx(Mj,{timesLen:s.length-1,scale:i,d:"column",w:"100%",h:"100%",jc:"space-between",ai:"flex-end",children:s.map(o=>t.jsxs(Fj,{children:[t.jsx(Hj,{children:o}),t.jsx(Bj,{})]},o))})},sc=({interval:e,events:i,scale:n,weekday:s,shift:o,onEventClick:a,currentDay:r})=>{const c=Nl({deps:[i==null?void 0:i.length],getScrollTopValue:()=>{var d;return nc((d=i==null?void 0:i[0])==null?void 0:d.startTime,o,n)}});return t.jsxs(M1,{className:"calendar-wrapper",ref:c,children:[t.jsx(Wj,{interval:e,scale:n}),t.jsx(zj,{currentDay:r,weekDay:s,events:i??[],shift:o,currentEvent:null,scale:n,onClick:a,interval:e})]})},Vj=p.div`
    display: flex;
    align-items: center;
    flex-direction: column;
    padding: 15px 20px;
...
`,Gj=({icon:e,title:i,color:n,goTo:s,visible:o=!0})=>{const{close:a}=ie();return o?t.jsxs(Vj,{color:n,children:[t.jsx("div",{className:"icon",children:e}),t.jsx("span",{className:"title",children:i}),!!s&&t.jsx(Z,{to:s,children:t.jsx(v,{text:"Перейти",onClick:a,background:"var(--almostTransparent)",width:"100%"})})]}):null},qj=p.div`
    width: 100%;
    height: 100%;
    display: flex;
    align-items: center;
...
`,Jj=p(se)`
    margin-bottom: 20px;
`,Xj=({image:e,list:i,text:n})=>{const{isMobile:s}=Ei();return t.jsxs(qj,{children:[!!e&&t.jsxs(t.Fragment,{children:[t.jsx(M,{size:3,align:"center",bottomGap:!0,children:e.title}),t.jsx("div",{className:"image",children:e.component??t.jsx("img",{src:s&&e.mobile?e.mobile:e.desktop,alt:""})})]}),t.jsx(Jj,{lineHeight:"1.6rem",width:"100%",align:"center",fontSize:"1rem",visible:!!n,children:n}),!!i&&t.jsx(Yj,{children:i==null?void 0:i.map(o=>l.createElement(Gj,{...o,key:o.title}))})]})},Kj=p.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: center;
...
`,Qj=p.div`
    ...
    height: 300px;
    width: 100%;
`,Zj=()=>t.jsx(Qj,{children:t.jsx(sc,{scale:1.35,weekday:1,events:[{title:"Нечеткое моделирование",duration:90,startTime:"16:10",startDate:new Date("September 1, 2023"),endDate:null,color:On["16:10 - 17:40"],icon:qi("Нечеткое моделирование"),place:"Прянишникова",rooms:["Пр2202"],weekday:"Ср",people:["Норин Владимир Павлович"],dateInterval:"1 сен - 30 окт"},{title:"Математика",duration:90,startTime:"17:50",startDate:new Date("September 1, 2023"),endDate:null,color:On["17:50 - 19:20"],icon:qi("Математика"),place:"Прянишникова",rooms:["Пр2202"],weekday:"Ср",people:["Норин Владимир Павлович"],dateInterval:"1 сен - 30 окт"}],interval:[16,19],currentDay:0,shift:16*60,onEventClick:()=>null})}),oc=()=>{const[e,i]=l.useState(0),{close:n}=ie(),s=[t.jsx(Xj,{text:"Стало проще видеть свое расписание целиком",image:{title:"Новое расписание! В виде календаря",component:t.jsx(Zj,{})}},"schedule")];return t.jsxs(Kj,{children:[t.jsx("div",{className:"content",children:s[e]}),t.jsx(Na,{amount:s.length,current:e}),t.jsxs("div",{className:"buttons",children:[t.jsx(v,{onClick:()=>i(o=>lt(o-1,s.length-1)),text:"Назад",width:"100%",isActive:e!==0}),e===s.length-1?t.jsx(v,{onClick:n,text:"Готово",width:"100%",background:_.blue.light1,textColor:"#fff"}):t.jsx(v,{onClick:()=>i(o=>lt(o+1,s.length-1)),text:"Далее",width:"100%"})]})]})},ew=e=>{if(e&&e[e.length-1]){const i=e[e.length-1];return hi(i.startTime)+i.duration<Dn(new Date)}},tw=()=>{var u,h;const{data:{schedule:e,hasNoSchedule:i,errorInData:n},loading:s}=hs.useSchedule(),o=tc(),a=((u=e==null?void 0:e.today)==null?void 0:u.length)===0||!(e!=null&&e.today),r=ew(e==null?void 0:e.today),c=Nl({deps:[e==null?void 0:e.today],condition:(((h=e==null?void 0:e.today)==null?void 0:h.length)??0)>1,getScrollTopValue:g=>{var x,m;return g.clientHeight*(r?((x=e==null?void 0:e.today)==null?void 0:x.length)??0:((m=e==null?void 0:e.today)==null?void 0:m.findIndex(f=>gs(f,!0)||Il(e.today,f,!0)))??0)}}),d=()=>W.evokePopUpMessage({message:n??"",type:"failure",time:Un.ten_seconds});return{listRef:c,noSchedule:a,loading:s,schedule:e==null?void 0:e.today,isEnded:r,hasNoSchedule:i,errorInData:n,handleOpenModal:o,handleErrorClick:d}},no=p(nn)`
    position: absolute;
    bottom: 0;
    left: 0;
...
`,Xt=()=>t.jsxs(P,{d:"column",gap:"8px",children:[t.jsx(q,{shape:"circle",size:{width:"20px",height:"20px"},margin:"0"}),t.jsx(q,{shape:"rect",size:{width:"35px",height:"10px"},margin:"0"})]}),iw=()=>{const{allRoutes:e}=We.useMenu(),{data:{user:i}}=be.useUser(),{hasNoSchedule:n,loading:s}=tw(),o=fi();if(!e||!i||s)return t.jsxs(no,{direction:"horizontal",horizontalAlign:"evenly",verticalAlign:"center",children:[t.jsx(Xt,{}),t.jsx(Xt,{}),t.jsx(Xt,{}),t.jsx(Xt,{}),t.jsx(Xt,{})]});const a=(i==null?void 0:i.user_status)==="stud"?ak:n?lk:rk;return t.jsx(no,{direction:"horizontal",horizontalAlign:"evenly",children:a.map(r=>{const c=e[r]?o.pathname.includes(e[r].path):!1;return t.jsx(Pl,{...e[r],isCurrent:c},r)})})},nw=(e,i,n)=>({isOpen:i,message:e,position:n}),so={hints:[]},sw=()=>V(ow),ac=S(),rc=S(),lc=S(),ow=X(so).on(ac,(e,{message:i,position:n})=>({hints:[...e.hints,nw(i,e.hints.length===0,n)]})).on(rc,e=>({hints:e.hints.splice(1,e.hints.length)})).on(lc,()=>({...so})),aw={useHint:sw},rw={evoke:ac,close:rc,clearStore:lc},lw=p.div`
    left: ${({left:e})=>e+"px"};
    top: ${({top:e})=>e+"px"};
    /* padding: 10px; */
    background: var(--reallyBlue);
...
`,cw=()=>{const{hints:e}=aw.useHint(),i=e[0];return i?t.jsx(lw,{open:i.isOpen,left:i.position.x,top:i.position.y,children:t.jsx(J,{type:"hint",title:i.message,onClose:()=>rw.close(),width:"100%",icon:null})}):null},dw=p.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    overflow: auto;
...
`,rT=({isTeachers:e=!1,currentFormEducation:i})=>{const{close:n}=ie(),s=e?gw():hw(),[o,a]=l.useState(""),[r,c]=l.useState(s);return t.jsxs(mw,{children:[t.jsx(Aa,{whereToSearch:s,searchEngine:cc,setResult:c,placeholder:"Поиск заявок",setExternalValue:a}),t.jsx("div",{className:"list",children:t.jsxs("div",{className:"links-wrapper",children:[(r??s).map(d=>t.jsxs("div",{className:"link-list",children:[t.jsx(M,{size:4,align:"left",bottomGap:!0,children:d.title}),!d.disabled&&t.jsx("div",{className:"links",children:d.links.map((u,h)=>{if(!(u.disabled||!fw(i,u.exceptionalFormEducationList)))return u.isExternalLink?t.jsx("a",{href:u.link,target:u.isOpenInNewWindow?"_blank":"_self",rel:"noreferrer",children:u.title},u.link+h):t.jsx(Z,{to:u.link,onClick:n,children:u.title},u.link+h)})})]},d.title)),!(r!=null&&r.length)&&!!o.length&&t.jsx(pe,{text:`По запросу ${o} ничего не найдено`})]})})]})},bw=p.div`
    display: flex;
    flex-direction: column;
    height: 100%;
    width: 100%;
...
`,lT=({})=>{const{data:{listApplication:e},error:i}=_e.useApplications(),{close:n}=ie(),s=xw(),[o,a]=l.useState(""),[r,c]=l.useState(s);return t.jsx(gt,{load:()=>Xe.getApplicationsFx(),loading:!e,error:i,data:e,children:t.jsxs(wi,{children:[t.jsx(J,{type:"info",title:"Информация",icon:t.jsx(Ce,{}),children:"Данный сервис создан для упрощения оборота кадровых документов внутри Университета."}),t.jsxs(bw,{children:[t.jsx(M,{size:3,align:"left",bottomGap:!0,children:"Создать заявление"}),t.jsx(Aa,{whereToSearch:s,searchEngine:cc,setResult:c,placeholder:"Поиск заявления",setExternalValue:a}),t.jsxs(yw,{children:[(r??s).map(d=>t.jsx("div",{className:"link-list",children:!d.disabled&&t.jsx("div",{className:"links",children:d.links.map(u=>u.isExternalLink?t.jsx("a",{href:u.link,target:u.isOpenInNewWindow?"_blank":"_self",rel:"noreferrer",children:u.title},u.title):t.jsx(Z,{to:u.link,onClick:n,children:u.title},u.link))})},d.title)),!(r!=null&&r.length)&&!!o.length&&t.jsx(pe,{text:`По запросу ${o} ничего не найдено`})]})]})]})})},vw=e=>({...e.data.reduce((s,o)=>{var a;if(!o.value)return s;if(o.type==="checkbox-docs"){const r=(a=o.items)==null?void 0:a.reduce((c,d)=>{for(let u=0;u<d.files.length;u++)c[(d==null?void 0:d.fieldName)+`[${u}]`]=d.files[u];return c},{});s=Object.assign({},s,r)}else if(o.type==="select")s[o.fieldName]=o.isSpecificSelect?o.value.id:o.value.title||null;else{const r=!o.value||typeof o.value!="object";s[o.fieldName]=r?o==null?void 0:o.value:o.value.title}return s},{}),...(()=>{var o,a;const s={};if((o=e.documents)!=null&&o.fieldName)for(let r=0;r<e.documents.files.length;r++)s[((a=e.documents)==null?void 0:a.fieldName)+`[${r}]`]=e.documents.files[r];return s})()}),oo={isOpen:!1,pages:[],currentPage:0},jw=()=>V(ww),dc=S(),pc=S(),uc=S(),hc=S(),ww=X(oo).on(dc,(e,{pages:i})=>({isOpen:!0,pages:i,currentPage:0})).on(pc,e=>({pages:e.pages,currentPage:e.currentPage,isOpen:!1})).on(uc,(e,{value:i})=>({...e,currentPage:i})).on(hc,()=>({...oo})),xs={useStory:jw},vt={open:dc,close:pc,clearStore:hc,changeCurrentPage:uc};p(Ze)`
    overflow: hidden;
    position: relative;
    background: ${({background:e})=>e??"var(--block)"};
    cursor: pointer;
...
`,Pw=({title:e,value:i,visible:n})=>n?t.jsxs(Cw,{children:[t.jsxs("span",{className:"title",children:[e,":"]})," ",t.jsx("span",{className:"value",children:i})]}):null,Ow=p.div`
    transition: 0.1s;
    opacity: ${({invisibleOnFalse:e,checked:i})=>e?i?1:0:1};
    transform: scale(${({invisibleOnFalse:e,checked:i})=>e?i?1:.8:1});
    display: flex;
...
`,Aw=({text:e,checked:i,setChecked:n,visible:s=!0,isActive:o=!0,invisibleOnFalse:a=!1})=>s?t.jsxs(Ow,{checked:i,invisibleOnFalse:a,onClick:()=>{o&&n(!i)},isActive:o,className:"checkbox",children:[t.jsx(v,{width:"25px",height:"25px",onClick:()=>null,icon:i||a?t.jsx(Zp,{style:{maxWidth:"20px",width:"20px",height:"20px",maxHeight:"20px"}}):t.jsx(zo,{style:{maxWidth:"20px",width:"20px",height:"20px",maxHeight:"20px"}}),background:"transparent"}),e&&t.jsx("div",{className:"hr-checkbox-text",children:e})]}):null,Dw=p.div`
    width: 100%;
    text-align: start;
    margin-top: 5px;
    margin-bottom: 15px;
...
`,Nw=({title:e,visible:i})=>i?t.jsx(Dw,{children:t.jsx("span",{className:"title",children:e})}):null,Iw=p.div`
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    position: relative;
...
`,zw=({value:e,setValue:i,leftIcon:n,title:s,required:o,width:a,minWidth:r,placeholder:c="Начните ввод...",danger:d,isActive:u=!0,inputAppearance:h=!0,suggestions:g})=>{const[x,m]=l.useState([]),[f,b]=l.useState(!0);return l.useEffect(()=>{if(e){const y=g.filter(C=>C.toLowerCase().includes(e.toLowerCase()));m(y)}else m([])},[e,g]),t.jsxs(Iw,{leftIcon:!!n,isActive:u,inputAppearance:h,width:a,danger:d,minWidth:r,children:[t.jsx(M,{size:5,align:"left",visible:!!s,bottomGap:"5px",required:o,children:s}),t.jsxs("div",{children:[t.jsx("input",{type:"text",value:e,onChange:y=>{i(y.target.value),b(!0)},placeholder:c}),x.length>0&&t.jsx(Rw,{width:"100%",isOpen:f,className:f?"open":"close",itemsAmount:x.length,title:s,children:x.map((y,C)=>t.jsx(Lw,{isSelected:!1,onClick:()=>{i(y),m([]),b(!1)},children:y},C))})]})]})},Mw=p.div`
    width: 100%;
    text-align: start;
    margin-top: -20px;
    margin-bottom: -10px;
...
`,Fw=({title:e,visible:i})=>i?t.jsx(Mw,{children:t.jsx("span",{className:"title",children:e})}):null,ao=e=>{const{value:i,required:n,width:s,indexI:o,indexJ:a,type:r,suggestions:c,items:d,title:u,documents:h,changeInputArea:g,setData:x,mask:m,editable:f,placeholder:b,autocomplete:y,isSpecificRadio:C,specialType:j,specialFieldsNameConfig:T,minValueInput:k,maxValueInput:U,maxValueLength:N,diff:A,visible:Q=!0,onChange:O,onKeyPress:te,onBlur:Te,onKeyDown:ye,onKeyUp:qe,onFocus:De}=e,ge=f??(g&&!h),[Ne,qt]=l.useState(!0),ft=(H,de,Pt)=>{O==null||O(H),x(ve=>(Array.isArray(ve.data[0])?ve.data[de][Pt??0].value=H:ve.data[de].type==="checkbox-docs"?ve.data[de].items[Pt??0].value=!!H:ve.data[de].value=H,{...ve}))},Pi=(H,de,Pt)=>{O==null||O(H),x(ve=>(Array.isArray(ve.data[0])?ve.data[de][Pt??0].value=H:ve.data[de].value=H,{...ve}))},Oi=(H,de,Pt)=>{x(ve=>(ve.data[de].items[Pt??0].files=H,{...ve}))},$d=H=>{O==null||O(H),x(de=>(de.data[o].value=H,{...de}))},Cd=H=>{O==null||O(H),te==null||te(H),Te==null||Te(H),ye==null||ye(H),qe==null||qe(H),De==null||De(H),x(de=>(de.data[o].value=H,{...de}))};return T&&j&&!Object.values(T).includes(j)?null:r!=="select"&&r!=="multiselect"||!d?r==="checkbox"?t.jsx(Ke,{text:u,isActive:ge,checked:i,setChecked:H=>ft(H,o,a)}):r==="hr-checkbox"?t.jsx(Aw,{text:u,isActive:ge,checked:i,setChecked:H=>ft(H,o,a)}):r==="auto-complete-input"?t.jsx(zw,{title:u,suggestions:c??[],required:n,value:i,placeholder:b??u,setValue:H=>ft(H,o,a)}):r==="textarea"?t.jsx(yg,{value:i,title:u,setValue:H=>ft(H,o,a),isActive:ge,textAreaAppearance:ge,placeholder:b??u,required:n,width:s}):r==="checkbox-docs"?t.jsx(Ew,{title:u,items:d,setChecked:(H,de)=>ft(!H,o,de),setFiles:(H,de)=>Oi(H,o,de)}):r==="date-interval"?Q?t.jsx(La,{title:u,required:n,dates:i,setDates:H=>Cd(H),valid:Ne,setValid:qt,minValue:k,diff:A}):null:r==="simple-text"?t.jsx(Pw,{title:u,value:i,visible:Q}):r==="text-warning"?t.jsx(Fw,{title:u,visible:Q}):r==="text-header"?t.jsx(Nw,{title:u,visible:Q}):r==="radio"?t.jsx($w,{buttons:d,title:u,required:n,current:i,setCurrent:$d,isSpecificRadio:C}):Q?t.jsx(rt,{value:i,title:u,minValue:k,maxValue:U,maxLength:N,setValue:H=>ft(H,o,a),type:r,isActive:ge,inputAppearance:ge,placeholder:b??u,required:n,mask:m,width:s,autocomplete:y}):null:Q?t.jsx(Ka,{items:d,setSelected:H=>Pi(H,o,a),selected:i,isActive:ge,title:u,width:s,multiple:r==="multiselect",required:n}):null},Bw=p.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    user-select: none;
...
`,Yw=p.div`
    ...
    display: flex;
    align-items: center;
`,gc=({stagesConfig:e})=>{const[i,n]=l.useState(0),[s,o]=l.useState({});l.useEffect(()=>{a(0)},[]);const a=r=>{o(c=>({...c,[i]:Ee(e[i][0].dataForm)})),n(r)};return t.jsxs(t.Fragment,{children:[t.jsx(qw,{children:e.map((r,c)=>t.jsxs(Yw,{lastElement:c===e.length-1,children:[t.jsx(Gw,{current:c===i,onClick:()=>a(c),reached:s[c],children:c+1}),c!==e.length-1&&t.jsx(lg,{direction:"horizontal",reached:s[c],filled:100,distance:40})]},c))}),t.jsx(t.Fragment,{children:e[i].map((r,c)=>l.createElement(Vw,{...r.dataForm,setData:r.setDataForm,key:c}))})]})},Jw=()=>({title:"Дополнительно",data:[{title:"Комментарий",type:"textarea",fieldName:"comment",value:"",editable:!0}]}),Xw=()=>({title:"Период предоставления льготы",hint:"Период предоставления льготы по плате за пользование жилым помещением соответствует дате подачи заявки и дате окончания действия документа",data:[{title:"Начало периода соответствия льготной категории",type:"date",value:"",fieldName:"beginning_of_benefit_period",editable:!0,required:!0},{title:"Окончание периода соответствия льготной категории",type:"date",value:"",fieldName:"end_of_benefit_period",editable:!0,required:!0},{title:"Отсутствует срок действия документа (бессрочный)",type:"checkbox",value:"",fieldName:"is_indefinite",editable:!0,required:!1}],documents:{files:[],required:!0,checkboxCondition:"reverse",fieldName:"invalidFiles",maxFiles:1,allowedTypes:["application/pdf"]}}),Kw=()=>({title:"Адрес регистрации",data:[],hint:"Необходимо приложить скан-копию 2-3 страниц паспорта, а также страниц с регистрацией. Для иностранных студентов обязательно приложить перевод паспорта.",documents:{files:[],required:!0,fieldName:"registrationFiles",maxFiles:1,allowedTypes:["application/pdf"]}}),xc=async(e,i,n,s,o=!1)=>{n(!0);const a=i.map(u=>{if(o)return vw(u);if(Array.isArray(u.data[0])){const h=u.data.map(x=>Object.assign({},...x==null?void 0:x.map(m=>ro(m)))),g={};return g[e]=JSON.stringify(h),g}else return u.data.map(h=>ro(h))}).flat(),r=i.map(u=>{var g,x;const h={};if((g=u.documents)!=null&&g.fieldName)for(let m=0;m<u.documents.files.length;m++)h[((x=u.documents)==null?void 0:x.fieldName)+`[${m}]`]=u.documents.files[m];return h}),c=i.map(u=>{var g,x;const h={};return(g=u.optionalCheckbox)!=null&&g.fieldName&&(h[(x=u.optionalCheckbox)==null?void 0:x.fieldName]=u.optionalCheckbox.value),h}),d=Object.assign({},...a,...r,...c);try{await Xe.postApplicationFx({formId:e,args:d}),n(!1),s(!0)}catch{n(!1)}},ro=e=>{var n;const i={};return i[(e==null?void 0:e.fieldName)??""]=Qw(e),e.type==="multiselect"&&(i[(e==null?void 0:e.fieldName)??""]=JSON.stringify((e==null?void 0:e.value).map(s=>s.title))),e.type==="checkbox-docs"?(n=e.items)==null?void 0:n.reduce((s,o)=>{for(let a=0;a<o.files.length;a++)s[(o==null?void 0:o.fieldName)+`[${a}]`]=o.files[a];return s},{}):i},Qw=e=>!e.value||typeof e.value!="object"?e==null?void 0:e.value:e.value.title,fc=p.div`
    display: flex;
...
`;var fs=(e=>(e.USG_GETHOSTEL_O="usg_gethostel_o",e.USG_GETHOSTEL_OOZ="usg_gethostel_ooz",e.USG_GETHOSTEL_Z="usg_gethostel_z",e.USG_GETHOSTEL_AO="usg_gethostel_ao",e.USG_GETHOSTEL_BENEFIT="usg_gethostel_benefit",e.USG_GETHOSTEL_FAMILY="usg_gethostel_family",e.USG_CONTR_TERMINATION="usg_contr_termination",e.USG_RELOCATION_INNER="usg_relocation_inner",e.USG_RELOCATION="usg_relocation",e.ACCOMMODATION_FOR_GRADUATES="accommodation_for_graduates",e.OBUCH="obuch",e.STATUS_SOBES="status_sobes",e.SPRVIZOV="sprvizov",e.PERS_DATA="pers_data",e.PROPUSK_RESTORE="propusk_restore",e.PASSPORT_DATA="passport_data",e.DIPL_OTL="dipl_otl",e.STATUS_REGULAR="status_regular",e.OKID_LICAKKRED="okid_licakkred",e.MILDOCS="mildocs",e.MIL_REG="mil_reg",e.VOEN_UCH="voen_uch",e.PR_DONATE="pr_donate",e.PR_MATPOM="pr_matpom",e.PR_SOCSTIP="pr_socstip",e.HIGH_SCHOLARSHIP="high_scholarship",e.DOP_SOGL="dop_sogl",e.SEND_PAYMENT_EDU="send_payment_edu",e.FREE_REQUEST="free_request",e.CRS_VACATIONS="crs_vacations",e.CRS_ACADEMVAC="crs_academvac",e.CRS_EXPULSION="crs_expulsion",e.CRS_ATTESTAT="crs_attestat",e.MEDICAL_CERT="postRequestMedicalCertificate",e.WORK_TRANSFER="",e.EXTRA_HOLIDAY_COLL="",e.HOLIDAY_PLANNING="",e.HOLIDAY_WORK="",e.DISMISSAL="",e.HOLIDAY_POSTPONED="",e.PART_TIME_EMPLOYMENT="",e))(fs||{}),Zw=(e=>(e.CONTACT_INFO_ACTUALIZATION="contact-info-actualization",e.DATA_VERIFICATION_ROUTE="data-verification",e.ISSUANCE_OF_LICENSES="issuance-of-licenses",e.GETTING_COMPUTER_EQUIPMENT="getting-computer-equipment",e.CONNECTING_COMPUTER="connecting-computer",e.PRINTER_MAINTENANCE="printer-maintenance",e.QUESTION_SED="question-sed",e.QUESTION_PERSONAL_ACCOUNT="question-personal-account",e.OTHER_IT_SERVICES="other-it-services",e.CERTIFICATE_FROM_PLACE_OF_WORK="certificate-from-the-place-of-work",e.VISA_CERTIFICATE="visa-certificate",e.CERTIFICATE_OF_WORK_EXPERIENCE="certificate-of-work-experience",e.NUMBER_OF_UNUSED_VACATION_DAYS="number-of-unused-vacation-days",e.COPY_OF_EMPLOYMENT_RECORD="copy-of-the-employment-record",e.COPIES_OF_DOCUMENTS_FROM_PERSONAL_FILE="copies-of-documents-from-the-personal-file",e.WORK_ON_TERMS_OF_EXTERNAL_CONCURRENCY="work-on-the-terms-of-external-concurrency",e.CERTIFICATE_TIME_PARENTAL_LEAVE="certificate-time-parental-leave",e.COURIER="courier",e.PERSONA_INCOME_TAX_REFERENCE="persona-income-tax-reference",e.PAYMENT_OF_CHILD_BIRTH_ALLOWANCE="payment-of-child-birth-allowance",e.PAYMENT_FOR_CHILD_CARE="payment-for-child-care",e))(Zw||{});const e_=[{id:0,title:"1 общежитие"},{id:1,title:"2 общежитие"},{id:2,title:"3 общежитие"},{id:3,title:"4 общежитие"},{id:4,title:"5 общежитие"},{id:5,title:"6 общежитие"},{id:6,title:"7 общежитие"},{id:7,title:"8 общежитие"},{id:8,title:"9 общежитие"},{id:9,title:"10 общежитие"}],t_=[{id:0,title:"имею постоянную регистрацию за пределами А-107 или не имею постоянную регистрацию"},{id:1,title:"имею постоянную регистрацию в пределах А-107"}],i_=e=>{const{surname:i,name:n,patronymic:s,group:o,email:a,phone:r}=e;return{title:"Контактная информация",data:[{title:"ФИО",fieldName:"fio",value:i+" "+n+" "+s,editable:!1},{title:"Учебная группа",fieldName:"group",type:"tel",value:o,editable:!1},{title:"Электронная почта",fieldName:"email",type:"email",value:a,editable:!0,required:!0},{title:"Телефон",fieldName:"phone",type:"tel",value:r,editable:!0,required:!0},{title:"Причина предоставления (в связи с)",type:"select",width:"100%",value:null,fieldName:"reason",placeholder:"укажите причину",editable:!0,required:!0,items:t_},{title:"Приоритетное общежитие",fieldName:"priority_hostel",value:null,type:"select",width:"100%",editable:!0,required:!0,items:e_}]}},n_=()=>{var O;const[e,i]=l.useState(null),[n,s]=l.useState(Di.kvdCert),[o,a]=l.useState(Di.fluorographyCert),[r,c]=l.useState(Di.vichRwCert),[d,u]=l.useState(Di.graftCert),{data:{dataUserApplication:h}}=_e.useApplications(),{data:{user:g}}=be.useUser(),[x,m]=l.useState(!1),[f,b]=l.useState(!1),[y,C]=l.useState(null),[j,T]=l.useState(null),[k,U]=l.useState(null),N=x??!1;if((g==null?void 0:g.educationForm)!=="Недоступен")return t.jsx(pe,{text:"Сервис временно недоступен в связи с отсутствием свободных мест"});const A=!!e&&!!j&&!!y&&!!k;if(l.useEffect(()=>{h&&(i(i_(h)),C(Xw()),T(Kw()),U(Jw()))},[h]),!A)return null;const Q=[[{dataForm:e,setDataForm:i}],[{dataForm:j,setDataForm:T}],[{dataForm:n,setDataForm:s}],[{dataForm:o,setDataForm:a}],[{dataForm:r,setDataForm:c}],[{dataForm:d,setDataForm:u}]];return t.jsx(fc,{isDone:N,children:t.jsxs(ja,{children:[t.jsx(M,{size:4,align:"left",children:"Предоставление права проживания (очно-заочная форма)"}),t.jsx(gc,{stagesConfig:Q}),t.jsx(Lt,{text:"Отправить",action:()=>xc(fs.USG_GETHOSTEL_OOZ,[e,j,y,k,n,o,r,d],b,m),isLoading:f,completed:x,setCompleted:m,repeatable:!1,buttonSuccessText:"Отправлено",isDone:N,isActive:(((O=e.optionalCheckbox)==null?void 0:O.value)??!0)&&Ee(e)&&Ee(o)&&Ee(r)&&Ee(d)&&Ee(n),popUpFailureMessage:"Для отправки формы необходимо, чтобы все поля были заполнены",popUpSuccessMessage:"Данные формы успешно отправлены"})]})})},s_=l.lazy(()=>w(()=>import("./index-84010847.js"),["assets/index-84010847.js","assets/vendor-831b4923.js"])),o_=l.lazy(()=>w(()=>import("./index-e9800038.js"),["assets/index-e9800038.js","assets/vendor-831b4923.js"])),a_=l.lazy(()=>w(()=>import("./index-581322d5.js"),["assets/index-581322d5.js","assets/vendor-831b4923.js"])),r_=l.lazy(()=>w(()=>import("./index-7939ad51.js"),["assets/index-7939ad51.js","assets/vendor-831b4923.js"])),l_=l.lazy(()=>w(()=>import("./index-6f1351b1.js"),["assets/index-6f1351b1.js","assets/vendor-831b4923.js"])),c_=l.lazy(()=>w(()=>import("./index-1615f1b1.js"),["assets/index-1615f1b1.js","assets/vendor-831b4923.js","assets/get-method-obtaining-fields-a2cef234.js","assets/find-current-in-select-ba4611d5.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),d_=l.lazy(()=>w(()=>import("./index-25a96c6b.js"),["assets/index-25a96c6b.js","assets/vendor-831b4923.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),p_=l.lazy(()=>w(()=>import("./index-0b477e26.js"),["assets/index-0b477e26.js","assets/vendor-831b4923.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),u_=l.lazy(()=>w(()=>import("./index-cee08ed5.js"),["assets/index-cee08ed5.js","assets/vendor-831b4923.js"])),h_=l.lazy(()=>w(()=>import("./index-257b52be.js"),["assets/index-257b52be.js","assets/vendor-831b4923.js","assets/index-56f76af1.js"])),g_=l.lazy(()=>w(()=>import("./index-54299e1e.js"),["assets/index-54299e1e.js","assets/vendor-831b4923.js","assets/is-valid-url-08a91344.js"])),x_=l.lazy(()=>w(()=>import("./index-62bcb25c.js"),["assets/index-62bcb25c.js","assets/vendor-831b4923.js"])),f_=l.lazy(()=>w(()=>import("./index-4b243efc.js"),["assets/index-4b243efc.js","assets/vendor-831b4923.js"])),m_=l.lazy(()=>w(()=>import("./index-b16de571.js"),["assets/index-b16de571.js","assets/vendor-831b4923.js"])),b_=l.lazy(()=>w(()=>import("./index-a56bf9db.js"),["assets/index-a56bf9db.js","assets/vendor-831b4923.js"])),y_=l.lazy(()=>w(()=>import("./index-7c0e0f56.js"),["assets/index-7c0e0f56.js","assets/vendor-831b4923.js"])),v_=l.lazy(()=>w(()=>import("./index-f350eb0d.js"),["assets/index-f350eb0d.js","assets/vendor-831b4923.js"])),j_=l.lazy(()=>w(()=>import("./index-49df8359.js"),["assets/index-49df8359.js","assets/vendor-831b4923.js"])),w_=l.lazy(()=>w(()=>import("./index-f39b0ebf.js"),["assets/index-f39b0ebf.js","assets/vendor-831b4923.js"])),__=l.lazy(()=>w(()=>import("./index-9f69db11.js"),["assets/index-9f69db11.js","assets/vendor-831b4923.js"])),k_=l.lazy(()=>w(()=>import("./index-92da0911.js"),["assets/index-92da0911.js","assets/vendor-831b4923.js"])),S_=l.lazy(()=>w(()=>import("./index-2301782e.js"),["assets/index-2301782e.js","assets/vendor-831b4923.js"]));l.lazy(()=>w(()=>Promise.resolve().then(()=>ek),void 0));const T_=l.lazy(()=>w(()=>import("./index-2f5bf54d.js"),["assets/index-2f5bf54d.js","assets/vendor-831b4923.js"])),E_=l.lazy(()=>w(()=>import("./index-3d1199a4.js"),["assets/index-3d1199a4.js","assets/vendor-831b4923.js"])),$_=l.lazy(()=>w(()=>import("./index-185bdfd3.js"),["assets/index-185bdfd3.js","assets/vendor-831b4923.js"])),C_=l.lazy(()=>w(()=>import("./index-45a27415.js"),["assets/index-45a27415.js","assets/vendor-831b4923.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),P_=l.lazy(()=>w(()=>import("./index-e06919b9.js"),["assets/index-e06919b9.js","assets/vendor-831b4923.js","assets/get-method-obtaining-fields-a2cef234.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),O_=l.lazy(()=>w(()=>import("./index-ecf0b9b0.js"),["assets/index-ecf0b9b0.js","assets/vendor-831b4923.js"])),A_=l.lazy(()=>w(()=>import("./index-499f3ce4.js"),["assets/index-499f3ce4.js","assets/vendor-831b4923.js"])),D_=l.lazy(()=>w(()=>import("./index-676f78dc.js"),["assets/index-676f78dc.js","assets/vendor-831b4923.js"])),N_=l.lazy(()=>w(()=>import("./index-f6f91257.js"),["assets/index-f6f91257.js","assets/vendor-831b4923.js"])),I_=l.lazy(()=>w(()=>import("./index-dc94444a.js"),["assets/index-dc94444a.js","assets/vendor-831b4923.js"])),R_=l.lazy(()=>w(()=>import("./index-bcf91390.js"),["assets/index-bcf91390.js","assets/vendor-831b4923.js"])),L_=l.lazy(()=>w(()=>import("./index-5532d8f2.js"),["assets/index-5532d8f2.js","assets/vendor-831b4923.js"])),z_=l.lazy(()=>w(()=>import("./index-e2a9cc9b.js"),["assets/index-e2a9cc9b.js","assets/vendor-831b4923.js","assets/get-divisions-96cfa1b1.js"])),M_="Sep 07 2023 12:00:00 GMT+0300",mc="Sep 08 2023 12:00:00 GMT+0300",cT=e=>{const i=new Date;return i<new Date(M_)?"Подача заявок открыта с 12:00 7 сентября до 12:00 8 сентября!":i>new Date(mc)?"Подача заявок закрыта":""},F_=[{id:0,title:"Холост"},{id:1,title:"Женат"},{id:2,title:"Замужем"},{id:3,title:"Не замужем"}],B_=[{id:0,title:"Мать"},{id:1,title:"Отец"},{id:2,title:"Жена"},{id:3,title:"Муж"},{id:2,title:"Ребенок"}],H_=[{id:0,title:"Военнослужащий"},{id:1,title:"Военнообязанный"},{id:2,title:"Невоеннообязанный"},{id:3,title:"Призывник"}],U_=[{id:0,title:"Адмирал"},{id:1,title:"Адмирал флота"},{id:2,title:"Вице-адмирал"},{id:3,title:"Генерал армии"},{id:4,title:"Генерал-лейтенант"},{id:5,title:"Генерал-майор"},{id:6,title:"Генерал-полковник"},{id:7,title:"Главный корабельный старшина"},{id:8,title:"Главный старшина"},{id:9,title:"Ефрейтор"},{id:10,title:"Капитан"},{id:11,title:"Капитан 1 ранга"},{id:12,title:"Капитан 2 ранга"},{id:13,title:"Капитан 3 ранга"},{id:14,title:"Капитан юстиции"},{id:15,title:"Капитан-лейтенант"},{id:16,title:"Контр-адмирал"},{id:17,title:"Лейтенант"},{id:18,title:"Майор"},{id:19,title:"Маршал Российской Федерации"},{id:20,title:"Матрос"},{id:21,title:"Мичман"},{id:22,title:"Младший лейтенант"},{id:23,title:"Младший сержант"},{id:24,title:"Подполковник"},{id:25,title:"Полковник"},{id:26,title:"Прапорщик"},{id:27,title:"Рядовой"},{id:28,title:"Сержант"},{id:29,title:"Старший лейтенант"},{id:30,title:"Старший матрос"},{id:31,title:"Старший мичман"},{id:32,title:"Старший прапорщик"},{id:33,title:"Старший сержант"},{id:34,title:"Старшина"},{id:35,title:"Старшина 1 статьи"},{id:36,title:"Старшина 2 статьи"}],W_=[{id:0,title:"Ветеринарный"},{id:1,title:"Военно-гуманитарный"},{id:2,title:"Высшие офицеры"},{id:3,title:"Инженерно-технический"},{id:4,title:"Командный"},{id:5,title:"Медицинский"},{id:6,title:"Младшие офицеры"},{id:7,title:"Педагогический"},{id:8,title:"Прапорщики и мичманы"},{id:9,title:"Сержанты"},{id:10,title:"Солдаты"},{id:11,title:"Солдаты, матросы, сержанты, старшины"},{id:12,title:"Старшие офицеры"},{id:13,title:"Юридический"}],V_=[{id:0,title:"1"},{id:1,title:"2"}],G_=[{id:0,title:"А - годен к военной службе"},{id:1,title:"Б - годен к военной службе с незначительными ограничениями"},{id:2,title:"В - ограниченно годен к военной службе"},{id:3,title:"Г - временно не годен к военной службе"},{id:4,title:"Д - не годен к военной службе"}],q_=[{id:0,title:"Военный билет офицера запаса"},{id:1,title:"Военный билет солдата (матроса, сержанта, старшины)"},{id:2,title:"Временное удостоверение, выданное взамен военного билета"},{id:3,title:"Временное удостоверение, выданное взамен военного билета офицера запасам"},{id:4,title:"Персональная электронная карта"},{id:5,title:"Справка взамен военного билета"},{id:6,title:"Удостоверение гражданина, подлежащего призыву на военную службу"},{id:7,title:"Удостоверение личности военнослужащего Российской Федерации"},{id:8,title:"Удостоверение личности офицера"}],Y_=[{id:0,title:"A (мотоциклы)"},{id:1,title:"B (легковые автомобили)"},{id:2,title:"C (грузовые автомобили)"},{id:3,title:"D (автобусы)"},{id:4,title:"M (мопеды)"},{id:5,title:"Tb (троллейбусы)"},{id:6,title:"Tm (трамваи)"}],J_=e=>({title:"Персональные данные",data:[{title:"Телефон",type:"tel",mask:!0,fieldName:"phone",value:e.phone,required:!0},{title:"Email",type:"email",fieldName:"email",value:e.email,editable:!0,required:!0},{title:"Фамилия",type:"text",fieldName:"surname",value:e.surname,editable:!0,required:!0},{title:"Имя",type:"text",fieldName:"name",value:e.name,editable:!0,required:!0},{title:"Отчество",type:"text",fieldName:"patronimyc",value:e.patronymic,editable:!0,required:!0}]}),X_=()=>({title:"Семейное положение",data:[{title:"Состояние в браке",value:null,fieldName:"maritalStatus",type:"select",items:F_,width:"100%",editable:!0,required:!0}]}),K_=()=>({title:"Состав семьи",data:[],default:[[{fieldName:"relation",title:"Степень родства",value:null,type:"select",items:B_,width:"100%"},{fieldName:"fio",title:"ФИО",value:"",required:!0,width:"40%"},{fieldName:"bdate",title:"Дата рождения",value:"",type:"date",required:!0,width:"30%"}]],addNew:!0,optionalCheckbox:{fieldName:"family_none",title:"Близкие родственники отсутствуют",value:!1,required:!0}}),Q_=()=>({title:"Сведения воинского учета",data:[{fieldName:"militaryObligationCategory",title:"Отношение к воинской обязанности",value:null,type:"select",items:H_,width:"100%",required:!0},{fieldName:"military id details",title:"Данные военного билета",type:"text-header",visible:!0,value:"Данные военного билета"},{fieldName:"militaryRank",title:"Воинское звание",value:null,type:"select",items:U_,width:"100%",required:!0},{fieldName:"specialization",title:"Состав (профиль)",value:null,type:"select",items:W_,width:"100%",required:!0},{fieldName:"reserveCategory",title:"Категория запаса",value:null,type:"select",items:V_,width:"100%",required:!0},{fieldName:"moc",title:"ВУС",value:"",required:!0,width:"40%"},{fieldName:"militaryServiceFitness",title:"Годность к воинской службе",value:null,type:"select",items:G_,width:"100%",required:!0},{fieldName:"militaryEnlistmentOffice",title:"Военкомат",value:"",width:"40%",required:!0}]}),Z_=()=>({title:"Документ воинского учета",data:[{fieldName:"documentType",title:"Вид документа",value:null,type:"select",items:q_,width:"100%",required:!0,editable:!0},{fieldName:"series",title:"Серия",value:"",required:!0,editable:!0,width:"40%"},{fieldName:"number",title:"Номер",value:"",required:!0,editable:!0,width:"40%"},{fieldName:"issuedBy",title:"Кем выдан",value:"",width:"100%",required:!0,editable:!0},{fieldName:"dateOfIssue",title:"Дата выдачи",value:"",type:"date",required:!0,editable:!0,width:"30%"}],documents:{files:[],fieldName:"Документ воинского учета",required:!0,maxFiles:1,allowedTypes:["application/pdf"]}}),lo=e=>{var n,s,o,a,r,c,d;const i=e&&((s=(n=e[0])==null?void 0:n.value)==null?void 0:s.id)!==0||!1;return{title:"Данные водительского удостоверения",data:[{fieldName:"driversDocumentType",title:"Вид документа",value:(e&&((o=e[0])==null?void 0:o.value))??{id:0,title:"Не выбрано"},type:"select",items:[{id:0,title:"Не выбрано"},{id:1,title:"Водительское удостоверение"}],width:"100%",required:!1,editable:!0},{fieldName:"driversSeries",title:"Серия",value:(e&&((a=e[1])==null?void 0:a.value))??"",required:i,visible:i,editable:!0,width:"40%"},{fieldName:"driversSumber",title:"Номер",value:(e&&((r=e[2])==null?void 0:r.value))??"",required:i,visible:i,editable:!0,width:"40%"},{fieldName:"vehicleCategory",title:"Категория ТС",value:(e&&((c=e[3])==null?void 0:c.value))??null,type:"select",items:Y_,width:"100%",required:i,visible:i,editable:!0},{fieldName:"driversDateOfIssue",title:"Дата выдачи",value:(e&&((d=e[4])==null?void 0:d.value))??"",type:"date",required:i,visible:i,editable:!0,width:"30%"}],documents:{files:[],fieldName:"Водительское удостоверение",required:i,visible:i,maxFiles:1,allowedTypes:["application/pdf"]}}},bc=()=>{var U;const[e,i]=l.useState(null),[n,s]=l.useState(X_()),[o,a]=l.useState(K_()),[r,c]=l.useState(Q_()),[d,u]=l.useState(Z_()),[h,g]=l.useState(lo(null)),[x,m]=l.useState(!1),[f,b]=l.useState(!1),[y,C]=l.useState(!1),{data:{dataUserApplication:j}}=_e.useApplications();l.useEffect(()=>{j&&i(J_(j))},[j]);const T=l.useMemo(()=>{var N,A;return((A=(N=h==null?void 0:h.data[0])==null?void 0:N.value)==null?void 0:A.id)!==0},[(U=h==null?void 0:h.data[0])==null?void 0:U.value]);if(l.useEffect(()=>{h&&g(lo(h.data))},[T]),!e)return null;const k=[[{dataForm:e,setDataForm:i}],[{dataForm:n,setDataForm:s}],[{dataForm:o,setDataForm:a}],[{dataForm:r,setDataForm:c}],[{dataForm:d,setDataForm:u}],[{dataForm:h,setDataForm:g}]];return t.jsx(fc,{isDone:!1,children:t.jsxs(ja,{children:[t.jsx(M,{size:3,align:"left",children:"Воинский учет"}),t.jsx(gc,{stagesConfig:k}),t.jsx(Ke,{checked:x,setChecked:m,text:"Я подтверждаю подлинность предоставленных документов"}),t.jsx(Lt,{text:f?"Отправлено":"Отправить",action:()=>xc(fs.MIL_REG,[e,n,o,r,d,h],C,b),isLoading:y,completed:f,setCompleted:b,repeatable:!1,buttonSuccessText:"Отправлено",isDone:f,isActive:!!x&&!!e&&!!n&&!!r&&!!d&&!!h&&!!o&&Ee(e)&&Ee(n)&&Ee(r)&&Ee(d)&&Ee(h)&&Ee(o),popUpFailureMessage:"Для отправки формы необходимо, чтобы все поля были заполнены",popUpSuccessMessage:"Данные формы успешно отправлены"})]})})},ek=Object.freeze(Object.defineProperty({__proto__:null,default:bc},Symbol.toStringTag,{value:"Module"})),E="/applications",tk="/application-for-superior-room",ik="/acad-performance",nk="/dormitory",yc=E+"/clarification-of-passport-data",vc=E+"/arbitrary-request",jc=E+"/social-scollarship",wc=E+"/certificate-of-attendance",_c=E+"/social-agencies",kc=E+"/paper-call",Sc=E+"/regular-accommodation",Tc=E+"/full-time-part-time-form",Ec=E+"/accommodation-correspondence-form",$c=E+"/academic-leave-accommodation",Cc=E+"/preferential-accommodation",Pc=E+"/family-room",Oc=E+"/termination-of-employment-contract",Ac=E+"/relocation-inside-hostel",Dc=E+"/relocation-to-another-hostel",Nc=E+"/accommodation-for-graduates",Nn=E+"/payment-recipient",Ic=E+"/restoring-the-magnetic-pass",Rc=E+"/retake-for-diploma",Lc=E+"/military-registration-documents",zc=E+"/military-registration",Mc=E+"/financial-support",Fc=E+"/financial-assistance",Bc=E+"/increased-state-academic-scholarship",Hc=E+"/changing-personal-data",Uc=E+"/student-status",Wc=E+"/state-accreditation",sk=E+"/military-registration-card",Vc=E+"/holidays-after-training",Gc=E+"/provision-academic-leave",qc=E+"/independently-deducted",Yc=E+"/extension-attestation",bt=()=>je({oldVersionUrl:"/sprav"}),Kt=()=>({applications:{id:"applications",title:"Цифровые сервисы",icon:t.jsx(I,{}),path:E,Component:h_,color:"red",isTemplate:!1,group:"FINANCES_DOCS",pageSize:"big",keywords:["справки","справка","заявления","заявление"]},...bl,payments:{id:"payments",title:"Договоры и оплаты",icon:t.jsx(ot,{}),path:Vi,Component:os,color:"green",isTemplate:!1,group:"FINANCES_DOCS",keywords:["оплата"]},dormitory:{id:"dormitory",title:"Список ожидания на заселение в общежитие",icon:t.jsx(vs,{}),path:nk,Component:a_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",show:!0},"acad-performance":{id:"acad-performance",title:"Успеваемость",icon:t.jsx(ou,{}),path:ik,Component:o_,color:"green",isTemplate:!1,group:"LEARNING_ACTIVITIES",keywords:["оценки","экзамены","зачеты"]},"project-activity":{id:"project-activity",title:"Проектная деятельность",icon:t.jsx(Co,{}),path:hl,Component:g_,color:"orange",isTemplate:!1,group:"LEARNING_ACTIVITIES",keywords:["пд"]},"helpful-information":{id:"helpful-information",title:"Полезная информация",icon:t.jsx(au,{}),path:fl,Component:qn,color:"blue",isTemplate:!0,group:"GENERAL"},"application-for-superior-room":{id:"application-for-superior-room",title:"Заявка на комнату повышенной комфортности",icon:t.jsx(vs,{}),path:tk,Component:s_,color:"blue",isTemplate:!1,group:"GENERAL",show:!(new Date>new Date(mc))}}),co=e=>{var i,n,s;return{...yl,"clarification-of-passport-data":{id:"clarification-of-passport-data",title:"Уточнение паспортных данных",icon:t.jsx(Fi,{}),path:yc,Component:r_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"arbitrary-request":{id:"arbitrary-request",title:"Произвольный запрос",icon:t.jsx(Fi,{}),path:vc,Component:z_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"social-scollarship":{id:"social-scollarship",title:"Социальная стипендия",icon:t.jsx(K,{}),path:jc,Component:R?bt:l_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"certificate-of-attendance":{id:"certificate-of-attendance",title:"Сертификат об обучении",icon:t.jsx(K,{}),path:wc,Component:c_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"social-agencies":{id:"social-agencies",title:"Справка в социальные учреждения",icon:t.jsx(K,{}),path:_c,Component:d_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"paper-call":{id:"paper-call",title:"Справка-вызов",icon:t.jsx(K,{}),path:kc,Component:p_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"regular-accommodation":{id:"regular-accommodation",title:"Предоставление права проживания (очная форма)",icon:t.jsx(K,{}),path:Sc,Component:u_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"full-time-part-time-form":{id:"full-time-part-time-form",title:"Предоставление права проживания (очно-заочная форма)",icon:t.jsx(K,{}),path:Tc,Component:n_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"accommodation-correspondence-form":{id:"accommodation-correspondence-form",title:"Предоставление права проживания (заочная форма)",icon:t.jsx(K,{}),path:Ec,Component:R_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"academic-leave-accommodation":{id:"academic-leave-accommodation",title:"Предоставление права проживания в период академического отпуска",icon:t.jsx(K,{}),path:$c,Component:x_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"preferential-accommodation":{id:"preferential-accommodation",title:"Предоставление права проживания льготной категории граждан",icon:t.jsx(K,{}),path:Cc,Component:f_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"family-room":{id:"family-room",title:"Предоставление права проживания в семейной комнате",icon:t.jsx(K,{}),path:Pc,Component:L_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"termination-of-employment-contract":{id:"termination-of-employment-contract",title:"Расторжение договора найма",icon:t.jsx(K,{}),path:Oc,Component:m_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"relocation-inside-hostel":{id:"relocation-inside-hostel",title:"Переселение внутри общежития",icon:t.jsx(K,{}),path:Ac,Component:R?()=>t.jsx(je,{isRedirectButtonVisible:!1,errorText:"Прием заявок на переселение внутри общежития будет осуществляться с 01.10.2023"}):b_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"relocation-to-another-hostel":{id:"relocation-to-another-hostel",title:"Переселение в другое общежитие",icon:t.jsx(K,{}),path:Dc,Component:R?()=>t.jsx(je,{isRedirectButtonVisible:!1,errorText:"Прием заявок на переселение в другое общежитие завершен 15.06.2023"}):v_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"accommodation-for-graduates":{id:"accommodation-for-graduates",title:"Предоставление права проживания в каникулярный период",icon:K,path:Nc,Component:["4","5","6"].includes((e==null?void 0:e.course)??"")||(n=(i=e==null?void 0:e.status)==null?void 0:i.toLocaleLowerCase())!=null&&n.includes("окончил")||((s=e==null?void 0:e.degreeLevel)==null?void 0:s.toLocaleLowerCase())==="магистратура"&&(e==null?void 0:e.course)==="2"?y_:()=>t.jsx(je,{isRedirectButtonVisible:!1,errorText:"Сервис доступен только выпускникам университета, проживающих в общежитии"}),color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"payment-recipient":{id:"payment-recipient",title:"Отправка квитанции об оплате",icon:t.jsx(K,{}),path:Nn,Component:j_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"restoring-the-magnetic-pass":{id:"restoring-the-magnetic-pass",title:"Запрос на восстановление магнитного пропуска",icon:t.jsx(K,{}),path:Ic,Component:w_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"military-registration-documents":{id:"military-registration-documents",title:"Отправить документы воинского учета",icon:t.jsx(K,{}),path:Lc,Component:R?bt:S_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"military-registration":{id:"military-registration",title:"Воинский учет",icon:t.jsx(ru,{}),path:zc,Component:R?bt:bc,color:"red",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"Воинский учет",fallbackPrevPage:E},"retake-for-diploma":{id:"retake-for-diploma",title:"Заявление на пересдачу для получения диплома с отличием",icon:t.jsx(K,{}),path:Rc,Component:k_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"increased-state-academic-scholarship":{id:"increased-state-academic-scholarship",title:"Получение повышенной государственной академической стипендии",icon:t.jsx(K,{}),path:Bc,Component:R?bt:__,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"financial-support":{id:"financial-support",title:"Оформить материальную поддержку остронуждающимся студентам (Дотацию)",icon:t.jsx(K,{}),path:Mc,Component:R?bt:T_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"financial-assistance":{id:"financial-assistance",title:"Финансовая поддержка",icon:t.jsx(K,{}),path:Fc,Component:R?bt:E_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"changing-personal-data":{id:"changing-personal-data",title:"Запрос на изменение персональных данных",icon:t.jsx(K,{}),path:Hc,Component:$_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"student-status":{id:"student-status",title:"Справка о прохождении обучения в университете (о статусе обучающегося) по месту требования",icon:t.jsx(K,{}),path:Uc,Component:C_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"state-accreditation":{id:"state-accreditation",title:"Выдача лицензий и свидетельств о государственной аккредитации",icon:t.jsx(K,{}),path:Wc,Component:P_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"holidays-after-training":{id:"holidays-after-training",title:"Предоставление каникул",icon:t.jsx(K,{}),path:Vc,Component:O_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"provision-academic-leave":{id:"provision-academic-leave",title:"Предоставление академического отпуска",icon:t.jsx(K,{}),path:Gc,Component:A_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"independently-deducted":{id:"independently-deducted",title:"Отчисление по инициативе обучающегося",icon:t.jsx(K,{}),path:qc,Component:D_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"extension-attestation":{id:"extension-attestation",title:"Продление промежуточной аттестации ",icon:t.jsx(K,{}),path:Yc,Component:N_,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"military-registration-card":{id:"military-registration-card",title:"Заполнить личную карточку обучающегося по воинскому учету для получения отсрочки от призыва на военную службу",icon:t.jsx(K,{}),path:sk,Component:R?bt:I_,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E}}},po=(e,i)=>e.reduce((n,s)=>(n[s]=i[s],n),{}),ok=["settings","profile","chat","schedule","payments","project-activity","all-students"],ak=["home","schedule","acad-performance","all","profile"],rk=["home","schedule","alerts","all","profile"],lk=["home","doclist","alerts","all","profile"],ck=e=>{var a,r;if(!e)return[];const n=((r=(a=JSON.parse(localStorage.getItem(Y.NewSettings)||"{}")[e.id])==null?void 0:a["settings-customize-menu"])==null?void 0:r.property.pages)??Qi,s=Uo.filter(c=>!n.includes(c));return(e==null?void 0:e.user_status)==="staff"&&n.some(c=>!s.includes(c))?[...n,...s]:n},uo={allRoutes:null,visibleRoutes:null,leftsideBarRoutes:null,homeRoutes:null,currentPage:null,isOpen:!1},dk=()=>V(uk),Jc=S(),Xc=S(),Kc=S(),Qc=S(),pk=(e,i,n)=>{const s={...n};if(s[e])s[e].notifications=i;else return null;return s},Qt=e=>{if(!e)return Us();const{accepts:i,agreements:n,checkdata:s,studLogins:o}=e,a=!!i.length||!!n.length||!!s.length||!!(o!=null&&o.length),r="download-agreements",c=Object.entries(Us()).filter(([d])=>d!==r||d===r&&a);return Object.fromEntries(c)},uk=X(uo).on(Jc,(e,{isOpen:i,currentPage:n})=>{var s;return{...e,currentPage:e.allRoutes&&n?(s=e.allRoutes)==null?void 0:s[n]:e.currentPage,isOpen:i}}).on(Xc,()=>({...uo})).on(Kc,(e,{user:i,adminLinks:n,homeRoutes:s})=>({...e,currentPage:(i==null?void 0:i.user_status)==="staff"?Qt(n)[window.location.hash.slice(2,window.location.hash.length)]:Kt()[window.location.hash.slice(2,window.location.hash.length)],allRoutes:(i==null?void 0:i.user_status)==="staff"?{...Qt(n),...Ws()}:{...Kt(),...co(i)},visibleRoutes:(i==null?void 0:i.user_status)==="staff"?Qt(n):Kt(),leftsideBarRoutes:po(ck(i),(i==null?void 0:i.user_status)==="staff"?Qt(n):Kt()),homeRoutes:po(s??JSON.parse(localStorage.getItem(Y.HomeRoutes)??JSON.stringify(ok)),(i==null?void 0:i.user_status)==="staff"?{...Qt(n),...Ws()}:{...Kt(),...co(i)})})).on(Qc,(e,{page:i,notifications:n})=>{var s;return{...e,visibleRoutes:pk(i,typeof n=="number"?n:n(((s=e.visibleRoutes)==null?void 0:s[i].notifications)??0),e.visibleRoutes)}}),We={useMenu:dk},et={changeOpen:Jc,clearStore:Xc,defineMenu:Kc,changeNotifications:Qc},Zc=(e,i,n,s)=>{const o={alert:{id:i,title:n??"Новости",text:"Вам пришло оповещение!",type:"alert",goTo:gl,duration:1e4,pageId:"alerts"},schedule:{id:i,type:"schedule",title:n??"Скоро начнется пара",text:s??"",goTo:Ct,pageId:"schedule"},info:{id:i,title:n??"Важная информация!",text:s??"",type:"info"},"payment-dorm":{id:i,title:n??"Долг по общежитию",text:s??"Вам необходимо внести платеж ",type:"payment-dorm",goTo:Vi,canClose:!1,pageId:"payments"},"payment-ed":{id:i,title:n??"Долг по образованию",text:s??"Вам необходимо внести платеж",type:"payment-ed",goTo:Vi,canClose:!1,pageId:"payments"},message:{id:i,title:n??"Сообщения",text:s??"Посмотрите сообщения",type:"message",goTo:cs,pageId:"chat",canClose:!1},"hr-applications":{id:i,title:n??"",text:s??"У вашей заявки изменился статус",type:"hr-applications",goTo:ae,pageId:"hr-applications"},"kpi-pps":{id:i,title:n??"",text:s??"У вашей заявки изменился статус",type:"kpi-pps",goTo:$r,pageId:"kpi-pps"},"doc-for-review":{id:i,title:n??"Документ для ознакомления",text:s??"",type:"doc-for-review",goTo:as,pageId:"doclist"},"digital-services":{id:i,title:n??"Статус заявки изменен",text:s??"",type:"digital-services",goTo:E,pageId:"applications"},"version-update":{id:i,title:n??"Вышла новая версия",text:"Посмотрите изменения",type:"version-update"},"electronic-interaction":{id:i,title:n??"Документ для подписания",text:"Об электронном взаимодействии",type:"electronic-interaction",goTo:ol,pageId:"electronic-interaction-agreement"}};return o[e]??o.info},hk={message:"messages","doc-for-review":"doclist","version-update":"newVersion","digital-services":"applications",alert:"news",schedule:"schedule"},ed=(e,i)=>i.filter(({type:n})=>e[hk[n]]),gk={notifications:[],visibleNotifications:[],loading:!1,error:null,removeNotificationError:null,removeNotificationLoading:!1,clearAllLoading:!1,clearAllError:null,loaded:!1},pn=L(async({settings:e})=>{try{const{data:i}=await ph();return ed(e,i).map(({id:n,type:s,title:o,text:a})=>Zc(s,n,o,a))}catch(i){throw new Error(`Не удалось загрузить уведомления. Ошибка: ${i}`)}}),xk=L(({notifications:e})=>{e.forEach(({pageId:i})=>{i&&et.changeNotifications({page:i,notifications:1})})}),fk=L(({notifications:e})=>{const{pageId:i}=e[0];i&&et.changeNotifications({page:i,notifications:1})}),un=L(async({id:e,pageId:i})=>{try{return await uh(e),{id:e,pageId:i}}catch{throw new Error("Не удалось скрыть уведомление")}}),hn=L(async()=>{try{await hh()}catch{throw new Error("Не удалось скрыть все уведомления")}}),mk=e=>{e&&et.changeNotifications({page:e,notifications:0})},td=S(),id=S(),nd=S(),sd=S(),od=S(),ad=S(),rd=S(),oe=X(gk).reset(rd);Ve({from:id,to:pn});$({clock:pn.pending,source:oe,fn:(e,i)=>({...e,loading:i}),target:oe});$({clock:pn.failData,source:oe,fn:(e,i)=>({...e,error:i.message}),target:oe});$({clock:pn.doneData,source:oe,fn:(e,i)=>({...e,notifications:[...i,...e.notifications],visibleNotifications:[...e.visibleNotifications,...i].slice(0,2),error:null,loaded:!0}),target:[oe,xk]});$({clock:td,source:oe,fn:(e,i)=>({notifications:[...e.notifications,i],visibleNotifications:[...e.visibleNotifications,i]}),target:[oe,fk]});Ve({from:sd,to:un});$({clock:un.doneData,source:oe,fn:({notifications:e,visibleNotifications:i,...n},{id:s,pageId:o})=>(mk(o),{...n,notifications:e.filter(a=>a.id!==s),visibleNotifications:i.filter(a=>a.id!==s)}),target:oe});$({clock:un.failData,source:oe,fn:(e,i)=>({...e,removeNotificationError:i.message}),target:oe});$({clock:un.pending,source:oe,fn:(e,i)=>({...e,removeNotificationLoading:i}),target:oe});Ve({from:od,to:hn});$({clock:hn.pending,source:oe,fn:(e,i)=>({...e,clearAllLoading:i,clearAllError:null}),target:oe});$({clock:hn.failData,source:oe,fn:(e,i)=>({...e,clearAllError:i.message}),target:oe});$({clock:hn.doneData,source:oe,fn:e=>({...e,notifications:[],visibleNotifications:[]}),target:oe});$({clock:nd,source:oe,fn:({notifications:e,visibleNotifications:i,...n},s)=>({...n,notifications:e,visibleNotifications:i.filter(o=>o.id!==s)}),target:oe});$({clock:ad,source:oe,fn:({notifications:e,...i})=>({...i,notifications:e,visibleNotifications:[]}),target:oe});const bk=()=>$e(oe),ct={initialize:id,add:td,clearById:sd,clearVisibleById:nd,clearAll:od,clearAllVisible:ad,clearStore:rd},Ge={useLkNotifications:bk},yk=Object.freeze(Object.defineProperty({__proto__:null,events:ct,selectors:Ge},Symbol.toStringTag,{value:"Module"})),ho={messages:null,error:null},vk=()=>({data:V(go).messages,loading:V(oi.pending),error:V(go).error}),oi=L(async()=>{try{return(await zu("1")).data}catch(e){throw new Error(e)}}),ld=S(),go=X(ho).on(oi,e=>({...e,error:null})).on(oi.doneData,(e,i)=>({...e,messages:i})).on(oi.failData,(e,i)=>({...e,error:i.message})).on(ld,()=>({...ho})),jk={useMessages:vk},wk={getMessagesFx:oi},_k={clearStore:ld},kk=Object.freeze(Object.defineProperty({__proto__:null,effects:wk,events:_k,selectors:jk},Symbol.toStringTag,{value:"Module"})),xo={type:null,personalNotifications:null,error:null,completed:!1},Sk=()=>({data:V(Nt).personalNotifications,loading:V(Dt.pending),error:V(Nt).error,completed:V(Nt).completed}),Tk=()=>V(Nt).type,cd=S(),dd=L(e=>e),Dt=L(async()=>{const{type:e}=Nt.getState();if(e==="notifications")try{return(await Jo()).data}catch(i){throw new Error(i)}try{return{docs:(await Xo()).data}}catch(i){throw new Error(i)}}),Ji=L(async e=>{const{type:i}=Nt.getState(),n=i==="notifications"?th:nh;try{return await n.view(e),"ok"}catch{throw new Error("Ошибка загрузки данных")}}),pd=S(),Nt=X(xo).on(dd,(e,i)=>({...e,type:i})).on(Dt,e=>({...e,error:null})).on(Dt.doneData,(e,i)=>({...e,personalNotifications:i})).on(Dt.failData,(e,i)=>({...e,error:i.message})).on(Ji.doneData,e=>({...e})).on(Ji.failData,(e,i)=>({...e,error:i.message})).on(cd,(e,i)=>({...e,completed:i.completed})).on(pd,()=>({...xo}));Ji.doneData.watch(()=>Dt());const Ek={usePersonalNotifications:Sk,useType:Tk},$k={setNotificationsType:dd,getPersonalNotificationsFx:Dt,viewPersonalNotificationsFx:Ji},Ck={changeCompleted:cd,clearStore:pd},Pk=Object.freeze(Object.defineProperty({__proto__:null,effects:$k,events:Ck,selectors:Ek},Symbol.toStringTag,{value:"Module"})),Ok=en({api:{get:Zu}}),fo={superiorRoom:null,error:null},Ak=()=>({data:V(mo).superiorRoom,loading:V(ai.pending),error:V(mo).error}),ud=S(),Dk=L(async e=>{});Ve({from:ud,to:Dk});const ai=L(async()=>{try{return(await Uu()).data}catch{throw new Error("Не удалось загрузить раздел")}}),hd=S(),mo=X(fo).on(ai,e=>({...e,error:null})).on(ai.doneData,(e,i)=>({...e,superiorRoom:i})).on(ai.failData,(e,i)=>({...e,error:i.message})).on(hd,()=>({...fo})),Nk={useSuperiorRoom:Ak},Ik={getSuperiorRoomFx:ai},Rk={postSuperiorRoom:ud,clearStore:hd},Lk=Object.freeze(Object.defineProperty({__proto__:null,effects:Ik,events:Rk,selectors:Nk},Symbol.toStringTag,{value:"Module"})),bo={teacherDataVerification:null,error:null,completed:!1},zk=()=>({data:V(jn).teacherDataVerification,loading:V(ri.pending),error:V(jn).error,completed:V(jn).completed}),gd=S(),xd=S(),Mk=L(async e=>{try{return(await rh(e)).data}catch{throw new Error("Не удалось загрузить раздел")}});Ve({from:gd,to:Mk});const ri=L(async()=>{try{return(await ah()).data}catch{throw new Error("Не удалось войти")}}),fd=S(),jn=X(bo).on(ri,e=>({...e,error:null})).on(ri.doneData,(e,i)=>({...e,teacherDataVerification:i})).on(ri.failData,(e,i)=>({...e,error:i.message})).on(xd,(e,i)=>({...e,completed:i.completed})).on(fd,()=>({...bo})),Fk={useTeacherDataVerification:zk},Bk={getTeacherDataVerificationFx:ri},Hk={postTeacherDataVerification:gd,changeCompleted:xd,clearStore:fd},Uk=Object.freeze(Object.defineProperty({__proto__:null,effects:Bk,events:Hk,selectors:Fk},Symbol.toStringTag,{value:"Module"})),Wk=[fh,at,Eh,Ph,Hh,kk,Pk,Nb,_h,Ok,jj,Lk,Uk,Ih,bh,yk],Vk=()=>{Wk.forEach(e=>{e.events.clearStore()})},it=localStorage.getItem(Y.Token)??"",nt=()=>JSON.parse(localStorage.getItem(Y.SavePassword)??"true"),gn=L(async e=>{try{const{data:i}=await Tu(e),n=new FormData;n.set("ulogin",e.login),n.set("upassword",e.password),n.set("auth_action","userlogin");try{await gi.post("/old",n)}catch{}return nt()?(localStorage.setItem(Y.Token,i.token),localStorage.setItem(Y.JWT,(i==null?void 0:i.jwt)??""),localStorage.setItem(Y.JWTRefresh,i.jwt_refresh??"")):(sessionStorage.setItem(Y.Token,i.token),sessionStorage.setItem(Y.JWT,(i==null?void 0:i.jwt)??"")),i}catch{throw new Error(navigator.onLine?"Неверный логин или пароль":"Потеряно соединение с интернетом")}}),jt=L(async e=>{try{const n=(await Eu(e.token)).data.user,{name:s,surname:o,patronymic:a}=n;return{currentUser:{...n,guid:e.jwt?$t(e.jwt).IndividualGuid:"",fullName:gh({name:s,surname:o,patronymic:a})},isAuthenticated:!!e,error:null,savePassword:nt()}}catch(i){throw console.log(i),new Error(`Возникла какая-то ошибка: ${i.message}`)}}),In=L(async e=>{try{return(await $u(e)).data}catch(i){throw console.log(i),new Error("Возникла какая-то ошибка")}}),md=L(()=>{nt()?(localStorage.removeItem(Y.Token),localStorage.removeItem(Y.JWT),localStorage.removeItem(Y.JWTRefresh)):(sessionStorage.removeItem(Y.Token),sessionStorage.removeItem(Y.JWT),sessionStorage.removeItem(Y.JWTRefresh)),Vk()}),bd=e=>{const i=localStorage.getItem(Y.SavePassword),n=e??JSON.parse(i??"true");return localStorage.setItem(Y.SavePassword,n.toString()),n},yd=S(),ms=S(),vd=S(),jd=S(),wd=S();Ve({from:yd,to:gn});$({clock:gn.doneData,target:jt});Ve({from:ms,to:md});it&&nt()?jt({token:it,jwt:localStorage.getItem(Y.JWT)}):md();const Gk={currentUser:null,error:null,isAuthenticated:!!(it!=null&&it.length),savePassword:nt(),loginEuz:""};bd();const qk=X(Gk).on(jt,e=>({...e,error:null})).on(jt.doneData,(e,i)=>i).on(jt.failData,(e,i)=>({error:i.message,currentUser:null,isAuthenticated:!!(it!=null&&it.length),savePassword:nt()})).on(gn.failData,(e,i)=>({error:i.message,isAuthenticated:null,currentUser:null,savePassword:nt()})).on(ms,()=>({error:"",isAuthenticated:null,currentUser:null,savePassword:nt()})).on(wd,(e,{savePassword:i})=>({...e,savePassword:bd(i)})).on(In,e=>({...e,error:null})).on(In.doneData,(e,i)=>({...e,loginEuz:i})).on(jt.failData,(e,i)=>({...e,error:i.message})).on(jd,(e,{key:i,value:n})=>({...e,currentUser:e.currentUser?{...e.currentUser,[i]:n}:null})).on(vd,e=>({...e,currentUser:null})),be={useUser:()=>{const{currentUser:e,error:i,isAuthenticated:n,savePassword:s,loginEuz:o}=V(qk);return{data:{user:e,isAuthenticated:n,savePassword:s,loginEuz:o},loading:V(gn.pending),error:i}}},Tt={login:yd,logout:ms,changeSavePassword:wd,clear:vd,update:jd},Yk={getUserFx:jt,getLoginEuzFx:In},Jk=()=>{const e="0.0.1";localStorage.getItem(Y.Version)!==e&&(localStorage.clear(),localStorage.setItem(Y.Version,e),Tt.logout())},_d=S(),kd=L(qu);$({clock:_d,target:kd});const Sd=X([]),dT=Rn(Sd,e=>e.map(i=>i.divisionName));$({clock:kd.doneData,target:Sd});const Xk=()=>{const{allRoutes:e}=We.useMenu();return e?t.jsxs(Bo,{children:[Object.values(e).map(({path:i,Component:n,isTemplate:s})=>t.jsx(Ho,{path:i,component:n,exact:!s},i)),t.jsx(Ye,{exact:!0,to:rs})]}):null},Kk=ce.memo(Xk),Qk=p.div`
    height: fit-content;
    opacity: ${({isVisible:e})=>e?1:0};
...
`,Zk=()=>{const{open:e,content:i,position:n}=zg.useContextMenu(),s=l.useRef(null);return Ht(s,()=>Me.close()),t.jsx(ln,{isOpen:e,children:t.jsx(Qk,{isVisible:e,ref:s,left:n.x,top:n.y,onClick:o=>{o.stopPropagation()},children:i})})},Td=200,eS=5e3,tS=()=>{const{visibleNotifications:e}=Ge.useLkNotifications(),[i,n]=l.useState(null),s=l.useRef(),o=a=>(s.current=void 0,()=>{n(a),setTimeout(()=>{ct.clearVisibleById(a)},Td)});return l.useEffect(()=>{var a,r;e.length&&s.current===void 0&&(s.current=setTimeout(o((a=e[0])==null?void 0:a.id),((r=e[0])==null?void 0:r.duration)??eS))},[e]),{handleClose:o,closing:i}},iS=p.div`
    position: absolute;
    width: 320px;
    max-width: 500px;
    bottom: 10px;
...
`;const sS=()=>{const{visibleNotifications:e}=Ge.useLkNotifications(),{closing:i,handleClose:n}=tS();return t.jsx(iS,{children:e.map(s=>t.jsx(nS,{onClick:n(s.id),open:i!==s.id,children:t.jsx(Ya,{...s,fullText:!1,maxLetters:19,closeAnimation:!1,onClose:n(s.id)})},s.id))})},yo=p.div`
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
`,oS=({loading:e})=>{const{data:{user:i},error:n}=be.useUser(),s=i?ze(i==null?void 0:i.fullName):_.blue.main,o=()=>Yk.getUserFx(JSON.parse(localStorage.getItem(Y.Token)??"")),a=()=>Tt.logout();return n?t.jsx(yo,{$loading:!0,color:s,children:t.jsx(pe,{text:n,children:t.jsxs(P,{d:"column",gap:"8px",children:[t.jsx(v,{onClick:o,text:"Попробовать снова",icon:t.jsx(Ln,{}),width:"200px"}),t.jsx(v,{onClick:a,textColor:"var(--theme-mild-opposite)",text:"Выйти",width:"200px",background:"var(--theme)"})]})})}):t.jsxs(yo,{color:s,$loading:e,children:[t.jsx(sn,{short:!0,width:"100px"}),e&&t.jsx(ht,{})]})},aS=p.div`
    width: 100%;
    height: 5px;
    background: var(--almostTransparentOpposite);
    border-radius: 10px;
...
`,rS=({filled:e,playing:i,isLast:n,onClose:s})=>{const{currentPage:o}=xs.useStory();return t.jsx(aS,{filled:e,playing:i,children:t.jsx("div",{className:"inner-line",onAnimationEnd:()=>n?s():vt.changeCurrentPage({value:o+1})})})},lS=p(nn)`
    position: absolute;
    top: 30px;
    left: 0;
    padding: 0px 30px;
...
`,cS=({playing:e,pages:i,onClose:n})=>{const{currentPage:s}=xs.useStory();return t.jsxs(lS,{height:"10px",verticalAlign:"center",direction:"horizontal",width:"100%",children:[Array(i).fill(0).map((o,a)=>t.jsx(rS,{onClose:n,isLast:a+1===i,playing:s===a?e:null,filled:s>a?100:s===a?void 0:0},a)),e?t.jsx(cu,{}):t.jsx(lu,{}),t.jsx(v,{minWidth:"25px",width:"25px",height:"25px",icon:t.jsx(Qe,{}),onClick:n})]})},dS=e=>`translate(${e.horizontal==="center"?"-50%":"0px"}, ${e.vertical==="center"?"-50%":"0px"})})`,pS=p(Ze)`
    overflow: hidden;
    position: relative;
    background: ${({background:e})=>e};
    display: flex;
...
`,uS=p.div`
    ...
    gap: 7px;
    color: ${({color:e})=>e??"var(--text)"};
    transform: ${({align:e})=>dS(e)};
    text-align: ${({textAlign:e})=>e??"left"};
`,hS=({background:e,align:i,image:n,color:s,title:o,text:a,children:r,setPlaying:c,link:d,imageAlign:u,imageSize:h={width:"auto",height:"100%"},textAlign:g="left"})=>{const x=mi();return t.jsxs(pS,{imageAlign:u,onClick:()=>c(m=>!m),background:e,align:i,padding:"0",height:"100%",color:s,children:[n&&t.jsx(Vn,{src:n,loading:!1,width:h.width,height:h.height}),t.jsxs(uS,{imageAlign:u,onClick:()=>c(m=>!m),background:e,align:i,color:s,children:[t.jsx(M,{size:2,align:g,children:o}),t.jsx(se,{fontSize:"1.1em",align:g,children:a}),!!(d!=null&&d.text)&&t.jsx(v,{onClick:()=>{x.push(d.to),vt.close()},text:d.text}),r&&t.jsx("div",{className:"content-children",children:r})]})]})},gS=p.div`
    padding: 15px;
    width: 100%;
    max-width: 400px;
    height: 100%;
...
`,xS=()=>{const{pages:e,isOpen:i,currentPage:n}=xs.useStory(),s=l.useRef(null);Ht(s,()=>vt.close());const[o,a]=l.useState(!0),r=e[n];return t.jsx(ln,{isOpen:i,children:t.jsx(gS,{isOpen:i,ref:s,children:e.length!==0&&t.jsxs(t.Fragment,{children:[t.jsx(cS,{pages:e.length,onClose:()=>vt.close(),playing:o}),t.jsx(vo,{left:"15px",onClick:()=>{n!==0&&vt.changeCurrentPage({value:n-1}),a(!0)},children:t.jsx(xi,{})}),t.jsx(hS,{setPlaying:a,currentPage:n,...r}),t.jsx(vo,{right:"15px",onClick:()=>{n!==e.length-1?vt.changeCurrentPage({value:n+1}):vt.close(),a(!0)},children:t.jsx(dt,{})})]})})})},fS=()=>{const{data:{user:e}}=be.useUser(),{notifications:i,loading:n,loaded:s}=Ge.useLkNotifications(),{settings:o}=Ft.useSettings(),[a]=bi([ga.$electronicInteractionStore]),r=l.useMemo(()=>o==null?void 0:o["settings-notifications"].property,[o==null?void 0:o["settings-notifications"]]);l.useEffect(()=>{Sn.getElectronicInteraction(),a&&!a.status&&ct.add(Zc("electronic-interaction","electronic-interaction"))},[a==null?void 0:a.status]),l.useEffect(()=>{a||Sn.getElectronicInteraction()},[a]),l.useEffect(()=>{e&&r&&r.all!==!1&&!s&&!n&&(ed(r,[{id:"schedule",type:"schedule",title:"Скоро пара!",text:"Осталось меньше 15 мин."}]).length,ct.initialize({settings:r}))},[e,r,n,s]),l.useEffect(()=>{et.changeNotifications({page:"lk-notifications",notifications:i.length})},[i])},mS=()=>{const{data:{user:e}}=be.useUser(),[i,n]=l.useState(!1),s=o=>{const a=localStorage.getItem("lastLocalAccess")||o,r=new Date(mu);new Date(o)<r&&new Date(a)<r&&(localStorage.setItem("lastLocalAccess",new Date().toISOString()),n(!0))};return l.useEffect(()=>{e&&s(e.lastaccess)},[e]),i},bS=()=>{const e=Ha(),{open:i}=ie(),n=mS();return fS(),ut(),l.useEffect(()=>{n&&n&&i(t.jsx(oc,{}),"Что нового")},[n]),{currentPage:e}},yS=p.div`
    display: flex;
    background: var(--theme);
    height: 100vh;
...
`,wS=p.div`
    max-height: 400px;
    overflow-y: auto;
`,_S=({error:e})=>t.jsx(t.Fragment,{children:t.jsx(pe,{text:e.message,image:t.jsx(du,{}),children:t.jsxs(P,{mw:"500px",d:"column",gap:"16px",children:[t.jsx(ue,{}),t.jsx(Wa,{title:t.jsx(J,{type:"failure",fontSize:"0.95rem",title:t.jsxs(P,{children:[t.jsx("span",{children:"Суть ошибки"}),t.jsx(pu,{})]})}),children:t.jsx(J,{type:"failure",fontSize:"0.95rem",title:"",icon:"",children:t.jsx(wS,{children:e.stack})})})]})})});class Ed extends l.Component{constructor(){super(...arguments),this.state={hasError:!1,error:null}}static getDerivedStateFromError(i){return{hasError:!0,error:i}}componentDidCatch(i,n){console.error("Uncaught error:",i,n)}render(){return this.state.hasError?t.jsx(_S,{error:this.state.error}):this.props.children}}const kS=()=>{const{data:{user:e}}=be.useUser(),{allRoutes:i}=We.useMenu(),{currentPage:n}=bS(),[s,o]=l.useState(!1),a=l.useRef(null),r=c=>{o(c.currentTarget.scrollTop>0)};return t.jsxs(yS,{children:[t.jsx(oS,{loading:!e||!i}),t.jsx(xS,{}),t.jsx(f1,{}),t.jsxs(vS,{children:[t.jsx(i1,{headerVisible:s,currentPage:n}),t.jsx(jS,{ref:a,onScroll:r,withHeader:!(n!=null&&n.withoutHeader),children:t.jsx(Ed,{children:t.jsx(l.Suspense,{fallback:null,children:t.jsx(Kk,{})})})}),t.jsx(iw,{})]}),t.jsx(_1,{}),t.jsx(b1,{}),t.jsx(S1,{}),t.jsx(Zk,{}),t.jsx(cw,{}),t.jsx(sS,{})]})},SS=()=>{const{data:{isAuthenticated:e,user:i}}=be.useUser(),{data:n}=at.selectors.useData(),{settings:s}=Ft.useSettings();return l.useEffect(()=>{e&&(Xe.getUserDataApplicationsFx(),(i==null?void 0:i.user_status)==="staff"&&(at.effects.getFx(),Xe.getWorkerPosts(),_d()))},[e,i]),l.useEffect(()=>{i&&(s?et.defineMenu({user:i,adminLinks:n,homeRoutes:s["settings-home-page"].property.pages}):qh.getLocalSettingsFx(i.id))},[i,n,s]),e?t.jsx(kS,{}):t.jsx(l.Suspense,{fallback:null,children:t.jsxs(Bo,{children:[Ky.map(({path:o,Component:a},r)=>t.jsx(Ho,{path:o,component:a,exact:!0},r)),t.jsx(Ye,{exact:!0,to:sl})]})})},TS=p.div`
    background: var(--theme);
    overflow-y: auto;
    height: 100vh;
`;Jk();const ES=()=>(ut(),t.jsx(qf,{children:t.jsx(uu,{basename:"/",children:t.jsx(TS,{children:t.jsx(Ed,{children:t.jsx(SS,{})})})})}));hu.render(t.jsxs(ce.StrictMode,{children:[t.jsx(tj,{}),t.jsx(ES,{})]}),document.getElementById("root"));export{qk as $,Zw as A,v as B,Ke as C,ue as D,F as E,ja as F,B as G,Oh as H,Vw as I,vw as J,yt as K,ht as L,J as M,Ee as N,pe as O,Sy as P,Zv as Q,en as R,Lt as S,M as T,Ze as U,se as V,gt as W,Hi as X,Se as Y,_l as Z,be as _,W as a,Ht as a$,ji as a0,sh as a1,oh as a2,Aa as a3,wv as a4,kv as a5,We as a6,jv as a7,fl as a8,ps as a9,US as aA,ts as aB,BS as aC,Qn as aD,HS as aE,es as aF,cb as aG,Sd as aH,VS as aI,rv as aJ,Sw as aK,Hw as aL,vc as aM,Vi as aN,Xy as aO,YS as aP,dv as aQ,cv as aR,lh as aS,Ae as aT,me as aU,GS as aV,cs as aW,Ci as aX,q as aY,Me as aZ,on as a_,Jy as aa,lT as ab,MS as ac,$k as ad,ct as ae,Ek as af,LS as ag,_e as ah,Xe as ai,rT as aj,Oa as ak,aT as al,us as am,Oe as an,he as ao,$t as ap,pt as aq,fc as ar,dT as as,FS as at,vh as au,Es as av,ae as aw,xc as ax,i0 as ay,WS as az,Bk as b,M1 as b$,ga as b0,Sn as b1,bh as b2,Ue as b3,xt as b4,tt as b5,iy as b6,ty as b7,tw as b8,sT as b9,zv as bA,El as bB,By as bC,Je as bD,Tt as bE,uw as bF,Qy as bG,Yy as bH,qy as bI,Gy as bJ,Fl as bK,yj as bL,rn as bM,$i as bN,Un as bO,nT as bP,uj as bQ,ml as bR,hj as bS,gj as bT,Wl as bU,At as bV,_j as bW,tc as bX,wj as bY,sc as bZ,lj as b_,iT as ba,Rj as bb,Il as bc,gs as bd,oT as be,Ft as bf,Ei as bg,gl as bh,Bf as bi,ze as bj,hs as bk,Cn as bl,vj as bm,Tl as bn,qv as bo,D as bp,vn as bq,JS as br,P1 as bs,ZS as bt,eT as bu,tT as bv,QS as bw,KS as bx,XS as by,fe as bz,Ih as c,Wj as c0,zj as c1,ut as c2,Ll as c3,Ul as c4,Er as c5,ui as c6,Sj as c7,kl as c8,Vs as c9,CS as cA,qi as cB,ej as cC,Vn as cD,fh as cE,Dg as cF,zS as cG,e_ as cH,Di as cI,Xw as cJ,Kw as cK,Jw as cL,gc as cM,Ok as cN,Uo as ca,Qi as cb,ev as cc,Zy as cd,IS as ce,NS as cf,jl as cg,vl as ch,vi as ci,A1 as cj,Ra as ck,AS as cl,rm as cm,va as cn,DS as co,qS as cp,nn as cq,Hv as cr,Yk as cs,Ai as ct,RS as cu,Nk as cv,Ik as cw,cT as cx,xh as cy,PS as cz,fs as d,Hk as e,As as f,rt as g,Ca as h,Ka as i,Fe as j,_g as k,re as l,ch as m,Fv as n,ee as o,P as p,_m as q,dn as r,Fk as s,wi as t,ie as u,Gn as v,yg as w,_ as x,_u as y,OS as z};
