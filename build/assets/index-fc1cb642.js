import{s as d,L as K,c0 as u,j as e,c1 as S,r as m,T as L,f as I,aA as $,q as W,c2 as k,bK as E,B as O,C as _,bM as N,bN as A}from"./vendor-35c3991b.js";import{bk as b,O as z,bl as x,bm as C,bd as j,bn as T,bo as h,l as p,t as c,i as F,bp as H,T as f,w as R,bq as U,aB as q,aC as J,W as B,L as Q,r as G}from"./index-46a096a9.js";import{I as V}from"./index.esm-e824fb2f.js";const X=(s,t)=>t.filter(a=>b(a.name).includes(b(s))),Y=d(K)`
...
`,Z=({avatar:s,name:t,lastMessage:a,chatId:n,loading:i,amountOfUnreadMessages:o,isOpen:r})=>{var g;const l=(g=u(x))==null?void 0:g.params;return i?e.jsx(se,{}):e.jsx(Y,{to:C+`/${n}`,isChosen:(l==null?void 0:l.chatId)===n,isOpen:r,children:e.jsxs("div",{className:"chat-item-content",children:[r?e.jsx(j,{name:t,avatar:s,width:"40px",height:"40px",marginRight:"7px",notifications:o}):e.jsx(j,{name:t,avatar:s,width:"45px",height:"45px",marginRight:"0",notifications:o}),r&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"name-and-message",children:[e.jsx("b",{children:t}),e.jsx("div",{className:"last-message",children:a.message})]}),e.jsx("div",{className:"sent-time",children:a.sentTime})]})]})})},ee=d.div`
    display: flex;
    align-items: center;
    padding: 10px;
...
`,ue=({messages:s})=>e.jsxs(ge,{children:[Object.values(w(s)).length===0&&e.jsx(M,{message:"Нет сообщений"}),Object.values(w(s)).map((t,a)=>e.jsxs(e.Fragment,{children:[e.jsx(xe,{date:t.date}),e.jsxs("div",{className:"messages-section",children:[e.jsx("div",{className:"message-avatar",children:e.jsx(j,{name:t.messages[0].sender,avatar:t.avatar,width:"32px",height:"32px",marginRight:"0"})}),e.jsx("div",{className:"messages",children:t.messages.map((n,i)=>e.jsx(ae,{name:n.sender,message:n,isLast:i===t.messages.length-1},i))})]},a)]}))]}),fe=d.div`
...
`,je=()=>{var r;const[s,t]=m.useState(null),[a,n]=m.useState(!0),i=(r=u(x))==null?void 0:r.params,o=[{avatar:void 0,name:"Стелла",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"1",amountOfUnreadMessages:10},{avatar:"https://upload.wikimedia.org/wikipedia/ru/thumb/d/df/Andrew_Garfield_as_Spider-Man.jpg/280px-Andrew_Garfield_as_Spider-Man.jpg",name:"Питер Паркер",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"2",amountOfUnreadMessages:0},{avatar:void 0,name:"Рафаэль",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"3",amountOfUnreadMessages:0},{avatar:void 0,name:"Леонардо",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"4",amountOfUnreadMessages:0},{avatar:void 0,name:"Бред Питт",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"5",amountOfUnreadMessages:0}];return e.jsxs(Te,{isOpen:a,chatId:i==null?void 0:i.chatId,children:[e.jsxs("div",{className:"chat-list-top-section",children:[e.jsx(f,{size:3,align:"left",children:"Чаты"}),e.jsx(c,{onClick:()=>n(l=>!l),icon:a?e.jsx(O,{}):e.jsx(_,{})})]}),e.jsx(J,{whereToSearch:o,searchEngine:X,setResult:t,placeholder:"Поиск чатов"}),e.jsx(Q,{margin:"10px auto"}),e.jsx(re,{chats:s??o,isOpen:a})]})},be=d.div`
    display: flex;
    align-items: center;
    background: var(--block);
    padding: 5px 10px;
...
`,ve=()=>{const[s,t]=m.useState("");return e.jsxs(be,{children:[e.jsx(c,{icon:e.jsx(k,{}),onClick:()=>null,background:"transparent"}),e.jsx(G,{value:s,setValue:t,placeholder:"Введите сообщение..."}),e.jsx(c,{icon:e.jsx(V,{}),onClick:()=>null,background:"transparent"})]})},we=d.div`
    width: 100%;
    height: 100%;
    display: flex;
    flex-direction: column;
...
`,ke=()=>{var n;const s=(n=u(x))==null?void 0:n.params,[t,a]=m.useState(!0);return m.useEffect(()=>{a(!0),setTimeout(()=>{a(!1)},1e3)},[s.chatId]),e.jsxs(we,{children:[e.jsx(de,{name:"Леонаро ДиК априо",loading:t}),e.jsx(me,{loading:t}),e.jsx(ve,{})]})},ze=d.div`
    ...
    width: 100%;
    height: 100%;
`,De=()=>{var t;const s=(t=u(x))==null?void 0:t.params;return e.jsxs(ze,{children:[e.jsx(je,{}),!(s!=null&&s.chatId)&&e.jsx(M,{}),e.jsx(N,{children:e.jsx(A,{path:x,children:e.jsx(ke,{})})})]})};export{De as default};
