import{s as a,j as t,co as _,cp as E,r as h,R as G,cq as L}from"./vendor-cbee1f3c.js";import{cP as R,bb as l,l as $,cQ as z,cR as f,w as W,K as c,bo as M,cS as q,V as u,bn as H,cT as U,T as y,L as x,bj as V,N as K,bf as S,bB as F,Q as p,cU as C,cV as D,a4 as Q,W as J,P as X,v as Y,a1 as O,ay as Z}from"./index-9128e944.js";const w=(e,i)=>{const n=new Date(e).getMonth();return n>1&&n<8?+i*2:+i*2-1},ee=e=>{const i=w(new Date().toISOString(),e),n=[];for(let r=1;r<=i;r++)n.push({id:r,title:`${r} семестр`});return n.push({id:-1,title:"Все семестры"}),n},te=(e,i)=>R(i.filter(n=>l(n.name).includes(l(e))||l(n.teacher).includes(l(e))||l($(n.exam_date)).includes(l(e))||l(n.bill_num).includes(l(e))));function ne(e){const i={5:0,4:0,3:0,2:0},n=e.filter(r=>!!r.grade&&r.exam_type!=="Зачет").length;return e.forEach(({grade:r,exam_type:s})=>{s!=="Зачет"&&r!==void 0&&i[z[r]]++}),n===0?i:Object.keys(i).reduce((r,s)=>(r[+s]=i[+s]/n,r),{})}const ie=2.7;a.div`
    display: flex;
