import{y as p,s as g,bZ as x,o as d,j as n}from"./vendor-f1fdae2f.js";import{ad as m,V as P,W as j,w as v,ae as y}from"./index-751fe807.js";import{c as w,L as F}from"./index-1aec97b7.js";import"./index-f86aa414.js";const L=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,e=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",e,o,c);return{results:r.items}}),h=w({getFx:L,limit:50}),$=g.div`
    width: 100%;
    display: flex;
