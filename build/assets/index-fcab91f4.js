import{y as l,s as p,o as d,c0 as g,j as e}from"./vendor-35c3991b.js";import{bb as m,a1 as x,W as P,P as j,z as y,y as v}from"./index-46a096a9.js";import{c as k,L as F}from"./index-ccdbdbae.js";import"./index-4ee90ac4.js";const L=l(async n=>{const{search:o="",page:c,limit:r,filter:s}=n,{data:a}=await m(o,(s==null?void 0:s.id.toString())??"",c,r);return{results:a.items}}),u=k({getFx:L,limit:50}),M=p.div`
    width: 100%;
    display: flex;
