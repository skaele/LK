import{y as l,s as p,n as d,b6 as g,j as e}from"./vendor-e9654bfa.js";import{aO as m,O as x,W as P,Q as j,aP as v,aQ as y}from"./index-d7ba1400.js";import{c as k,L as F}from"./index-edccbc1f.js";import"./index-ce7d98dc.js";const L=l(async n=>{const{search:o="",page:c,limit:r,filter:s}=n,{data:a}=await m(o,(s==null?void 0:s.id.toString())??"",c,r);return{results:a.items}}),u=k({getFx:L,limit:50}),M=p.div`
    width: 100%;
    display: flex;
