import{s as a,j as t,ck as T,cl as G,r as h,R as P,cm as L}from"./vendor-4af360a6.js";import{cB as M,aU as l,l as z,cC as $,cD as f,u as R,p as c,b4 as W,cE as q,V as u,b3 as H,cF as U,T as y,K as x,ae as K,D as V,aY as S,bi as B,x as p,cG as D,cH as C,U as J,W as X,t as Y,i as Q,O,af as Z}from"./index-9e567fbd.js";const w=(e,i)=>{const n=new Date(e).getMonth();return n>1&&n<8?+i*2:+i*2-1},ee=e=>{const i=w(new Date().toISOString(),e),n=[];for(let s=1;s<=i;s++)n.push({id:s,title:`${s} семестр`});return n.push({id:-1,title:"Все семестры"}),n},te=(e,i)=>M(i.filter(n=>l(n.name).includes(l(e))||l(n.teacher).includes(l(e))||l(z(n.exam_date)).includes(l(e))||l(n.bill_num).includes(l(e))));function ne(e){const i={5:0,4:0,3:0,2:0},n=e.filter(s=>!!s.grade&&s.exam_type!=="Зачет").length;return e.forEach(({grade:s,exam_type:r})=>{r!=="Зачет"&&s!==void 0&&i[$[s]]++}),n===0?i:Object.keys(i).reduce((s,r)=>(s[+r]=i[+r]/n,s),{})}const ie=2.7;a.div`
    display: flex;
