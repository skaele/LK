        ...
        settings: {
            ...
            steps: [
                ...
                },
                {
                    title: 'Внешний вид',
                    description:
                        'Пока что в этом разделе можно изменить визуальную тему Личного кабинета, но скоро появится больше возможностей для персонализации',
                },
                {
                    title: 'Главная страница',
                    description:
                        'В этом разделе можно настроить разделы быстрого доступа домашней страницы и отображение виджетов',
                },
                {
                    title: 'Уведомления',
