        ...
        <CenterPage padding="10px">
            <PageBlock>
                <Message title="Уважаемые студенты!" type="info">
                    <p>
                        Уважаемые студенты! В данном разделе представлены списки обучающихся, нуждающихся в общежитии.
                        Заселение проводится в порядке очереди. Здесь вы можете узнать свой номер в списке.
                    </p>
                </Message>
                <FileLink
                    type="document"
