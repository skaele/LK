...
`,be=({exams:e,tests:s,cp:i})=>t.jsxs(ye,{children:[t.jsxs("span",{children:[e," ",m(e,{zero:"Экзаменов",one:"Экзамен",twoToFour:"Экзамена",fiveToNine:"Экзаменов"})]}),t.jsxs("span",{children:[s," ",m(s,{zero:"Зачетов",one:"Зачет",twoToFour:"Зачета",fiveToNine:"Зачетов"})]}),t.jsxs("span",{children:[i," ",m(i,{zero:"Курсовых",one:"Курсовая",twoToFour:"Курсовые",fiveToNine:"Курсовых"})]})]}),v=({title:e,icon:s,color:i})=>t.jsx(Y,{padding:"0",width:"100%",maxWidth:"100%",height:"135px",justifyContent:"center",color:i.length?i:"blue",isVertical:!0,hasNotifications:!1,children:t.jsxs("div",{className:"outside",children:[t.jsx(Z,{color:i.length?i:"blue",children:s}),t.jsx("b",{children:e})]})}),z=c.a`
...
`,Te=e=>{const{path:s,Component:i}=e,{open:r}=X(),a=!!i({});return t.jsxs(t.Fragment,{children:[!a&&t.jsx(z,{href:s,width:1,children:t.jsx(v,{...e})}),a&&t.jsx(z,{onClick:()=>r(t.jsx(i,{})),width:1,children:t.jsx(v,{...e})})]})},we=c.div`
    width: 745px;
...
`,Se=({links:e})=>t.jsx(we,{children:t.jsx(ee,{direction:"horizontal",gap:10,horizontalAlign:"left",scroll:!1,wrap:!0,wrapOnMobile:!0,children:Object.values(e).map(s=>t.jsx(Te,{...s},s.id))})}),ve=x.memo(Se),ze=e=>{const s=F(e,"days");return s<0?"Прошло":s===0?"Сегодня":s===1?"Завтра":`${s} ${m(s,{zero:"дней",one:"день",twoToFour:"дня",fiveToNine:"дней"})}`},Fe=e=>{const s=F(e,"days");return s<0?f.blue.main:s<1?f.pink.main:s<2?f.red.main:s<5?f.orange.main:f.green.main},_e=c.div`
    color: ${({day:e})=>Fe(e)};
    font-weight: 600;
    white-space: nowrap;
`,Ie=({day:e})=>t.jsx(_e,{day:e,children:ze(e)}),Ce=c(le)`
    display: flex;
    column-gap: 10px;
    overflow-x: auto;
    width: 100%;
...
`,Le=({weekSchedule:e,view:s,wrapperRef:i})=>{const{data:{schedule:r,currentDay:a}}=te.useSchedule(),o=r&&r[0]?-1:a,{width:l}=se();x.useEffect(()=>{setTimeout(()=>{i!=null&&i.current&&s==="big"&&(i.current.scrollLeft=o*400-360)},200)},[s]);const d=()=>{i!=null&&i.current&&l<=1e3&&j.changeCurrentChosenDay({day:Math.floor(i.current.scrollLeft*1.1/l)+1})};return e&&t.jsx(Ce,{isFull:s==="full",innerRef:i,onScroll:d,children:Object.keys(e).map((n,u)=>t.jsx(ne,{isCurrent:T(new Date,"weird")===n,weekDay:T(n,"short"),lessons:e[n].lessons,view:s,topInfo:t.jsx(Ie,{day:n})},u))})},Ee=x.memo(Le),De=(e,s,i)=>{const{schedule:r,view:a}=e,{data:{user:o}}=_.useUser(),l=x.useRef(null),d=(o==null?void 0:o.user_status)==="stud"&&!s&&!i,n=p=>{k.getScheduleFx({user:o,group:(p==null?void 0:p.value)??""})},u=()=>k.getScheduleFx({user:o,group:(o==null?void 0:o.group)??""}),g=()=>{k.getScheduleFx({user:o,group:""})},h=p=>{j.changeCurrentModule({currentModule:p})};return{pages:r?[{title:"Текущая неделя",condition:!!(r!=null&&r["0"]),content:t.jsx(w,{view:a,wrapperRef:l,weekSchedule:r[0]},0)},{title:"Весь семестр",condition:!!(r!=null&&r["1"]),content:t.jsx(w,{view:a,wrapperRef:l,weekSchedule:r[1]},1)},{title:"Сессия",condition:!!(r!=null&&r["2"]),content:t.jsxs(q.Fragment,{children:[t.jsx(be,{...je(r[2])}),t.jsx(Ee,{view:a,wrapperRef:l,weekSchedule:r[2]})]},2)},{title:"Пересдачи",condition:!0,content:t.jsx(ve,{links:ke},3)}]:[],showGroupSearch:d,wrapperRef:l,setCurrentPage:h,onValueEmpty:g,handleLoad:u,onHintClick:n}},Me=c.div`
    display: flex;
...
`,Ne=({teacherName:e,group:s,data:i,loading:r,error:a})=>{var b;const{schedule:o,currentModule:l,view:d}=i,{data:{user:n}}=_.useUser(),[u,g]=x.useState((n==null?void 0:n.group)??""),{pages:h,wrapperRef:y,showGroupSearch:p,setCurrentPage:I,onValueEmpty:C,handleLoad:L,onHintClick:E}=De(i,e,s);return t.jsx(ie,{loading:r,load:L,error:a,data:o,children:t.jsxs(Me,{children:[t.jsx("div",{className:"slider-wrapper",children:t.jsx(re,{appearance:!1,pages:h,currentPage:parseInt(l),setCurrentPage:I})}),l!=="3"&&t.jsxs("div",{className:"buttons-and-search",children:[t.jsx(ce,{view:d,setView:D=>j.changeView({view:D})}),p&&t.jsx(ue,{value:u,setValue:g,onHintClick:E,placeholder:"Группа",customMask:oe.groupMask,request:ae,leftIcon:t.jsx(J,{}),onValueEmpty:(n==null?void 0:n.user_status)==="staff"?C:void 0})]}),t.jsx(de,{visible:!!e||!!s,filter:e??s??"",isGroup:!!s}),l!=="3"&&t.jsx(pe,{wrapperRef:y,data:i}),!!h&&((b=h[l])==null?void 0:b.content)]})})};export{Ne as T};
