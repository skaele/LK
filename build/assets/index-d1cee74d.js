import{s as c,L as g,j as e,R as w,F as z,c as M,r as b}from"./vendor-e9654bfa.js";import{a6 as l,b2 as L,D as v,H as N,U as $,l as T,b3 as y,aW as x,E as D,b4 as E,aJ as B,B as C,b5 as F,M as A,b6 as k,b7 as S,J as I,b1 as f,O as m,b8 as W,aa as d,T as P,b9 as H,ba as h,b0 as U,bb as p,a0 as Y,W as _,bc as O,x as Z,aR as X,bd as q,be as G,bf as J}from"./index-c2d11f9e.js";import{D as K}from"./week-schedule-04de9f21.js";const Q=c(g)`
    width: 100%;
    height: 100%;
...
`,V=({item:t,amount:s})=>{const{icon:n,color:a,path:i,title:r,notifications:o}=t;return e.jsxs(Q,{amount:s,to:i,color:l[a].transparent3,children:[e.jsx(L,{badge:o==null?void 0:o.toString(),color:a,children:n}),e.jsx(v,{className:"subtext",align:"center",children:N(r,10)})]})},ee=c.div`
    width: 100%;
    display: flex;
    align-items: center;
    max-width: 750px;
...
`,me=()=>{const{data:{user:t},error:s}=m.useUser(),{data:n}=y.usePayments(),{data:a}=k.useSchedule(),{homeRoutes:i}=Y.useMenu();if(!t||!i)return null;const r=()=>{G.getScheduleFx({user:t}),J.getPaymentsFx()},{news:o}=S.useSettings().settings["settings-home-page"].property;return e.jsxs(_,{loading:!t,load:r,error:s,data:n&&a,children:[e.jsx(de,{}),e.jsxs(xe,{children:[e.jsx(O,{}),e.jsx(te,{links:i}),e.jsx(Z,{children:e.jsxs(X,{maxWidth:"750px",minHeight:"100%",height:"100%",orientation:"vertical",gap:"20px",children:[e.jsxs(d,{children:[e.jsx(P,{size:2,align:"left",width:"100%",children:"Главная"}),e.jsx(q,{})]}),e.jsx(re,{}),!!o&&e.jsx(oe,{})]})})]})]})};export{me as default};
