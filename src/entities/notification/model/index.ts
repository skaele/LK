...
import { docsApi, notificationApi } from '@shared/api'
import { Notifications } from '@shared/api/model/notification'
...
const setNotificationsType = createEffect((type: NotificationType) => type)
