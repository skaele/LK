...
export const hiddenRoutes: (user: User | null) => IRoutes = (user) => ({
    ...
    'military-form-4': {
        ...
        Component: isProduction ? ApplicationRedirect : MilitaryForm4,
        color: 'red',
        isTemplate: false,
        isSubPage: true,
        backButtonText: 'Назад к заявлениям',
    ...
    'military-form-5': {
        ...
        Component: isProduction ? ApplicationRedirect : MilitaryForm5,
        color: 'red',
        isTemplate: false,
        isSubPage: true,
        backButtonText: 'Назад к заявлениям',
    ...
    'military-copies': {
        ...
        Component: isProduction ? ApplicationRedirect : MilitaryCopies,
        color: 'red',
        isTemplate: false,
        isSubPage: true,
        backButtonText: 'Назад к заявлениям',
