import{s as c,j as n,r as w,c8 as P,R as A}from"./vendor-35c3991b.js";import{H as p,J as y,cf as _,cg as J,ch as E,O as Q,ci as X,cj as Z,aw as z,bE as F,ck as ee,cl as te,a0 as B,cm as ne,bD as re,cn as ae,co as se,cp as oe,cq as ie,cr as le,U as H,cs as ce,w as de,ct as he,l as pe,ai as ue,cu as ge,c9 as xe,c8 as me}from"./index-46a096a9.js";const I=({isCurrent:e,isCurrentChosenDay:t})=>{if(t&&!e)return"var(--text)";if(e&&t)return"var(--reallyBlue)"},O=({isCurrent:e,isCurrentChosenDay:t})=>e&&t?"#fff":t?"var(--invert-text)":e?"var(--blue)":"var(--text)",fe=c(y)`
...
`,Y=({subjects:e})=>e?n.jsx(je,{children:e.map(t=>n.jsx(U,{background:t.color.main},t.startTime))}):null,ke=()=>{const e=new Date;let t=_(e);e.getDay()===0&&(t=J(e,1));const a=Object.keys(E).reduce((s,i)=>(s[E[i].short]="",s),{});for(let s=0;s<6;s++){const i=t.toLocaleDateString("ru-RU",{day:"2-digit"});t.setDate(t.getDate()+1),a[Object.keys(a)[s]]=i}return a},W=({showDates:e,showColumns:t,currentChosenDay:a,onDayClick:s,events:i})=>{const l=ke();return n.jsx(fe,{jc:"space-between",children:Object.keys(l).map((r,o)=>{const d=l[r],h=o===a;return n.jsxs(De,{showDates:e,showColumns:t,onClick:s&&(()=>s==null?void 0:s(o)),children:[n.jsxs(ye,{children:[n.jsx(be,{isCurrent:+d===new Date().getDate(),isCurrentChosenDay:!e&&h,showDates:e,children:r}),e&&n.jsx(we,{isCurrentChosenDay:h,isCurrent:+d===new Date().getDate(),children:d})]}),i&&e&&n.jsx(Y,{subjects:i[Object.keys(i)[o]]}),i&&!e&&i[Object.keys(i)[o]].length>0&&n.jsx(y,{jc:"center",children:n.jsx(U,{background:Q.grey.main})})]},r)})})},G=({interval:e,showDates:t,events:a,onDayClick:s})=>{const i=e[0]*60,l=X();return{handleOpenModal:Z(),onDayClick:s,shift:i,showDates:t,interval:e,events:a,scale:l}},N=e=>e!==void 0?e:new Date().getDay()===0?0:new Date().getDay()-1,ve=({events:e,currentChosenDay:t,showDates:a=!0,interval:s=[0,23]})=>{const{isSmallDesktop:i}=z(),{scale:l,shift:r,events:o,handleOpenModal:d}=G({interval:s,events:e}),[h,f]=w.useState(null),[x,u]=w.useState(N(t)),g=w.useRef(null);w.useEffect(()=>{if(e){const m=Object.keys(e??{})[x],v=e[m].find(K=>F(K,!0))??null;f(v)}else f(null)},[e]);const b=h?`${h.startTime} - ${ee(h.startTime,h.duration)}`:"9:00",j=m=>{i?d(m):f(m)},k=m=>{const v=Math.floor(m.currentTarget.scrollLeft/m.currentTarget.clientWidth);u(v)},D=m=>{g.current&&(g.current.scrollLeft=g.current.clientWidth*m)};return w.useLayoutEffect(()=>{D(N(t))},[g,t]),{currentDay:x,events:o,carouselRef:g,interval:s,scale:l,shift:r,showDates:a,chosenEvent:h,timeInterval:b,currentChosenDay:t,handleDayClick:D,handleCarouselScroll:k,onEventClick:j}},R="calc(100vh - var(--header-height) - 110px)",L="calc(100vh - var(--header-height) - 185px)",V="calc(100vh - var(--header-height) - 170px);",q=c(y)`
    --time-width: 55px;
