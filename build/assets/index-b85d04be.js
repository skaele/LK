...
`,be=({exams:e,tests:s,cp:i})=>t.jsxs(ye,{children:[t.jsxs("span",{children:[e," ",m(e,{zero:"Экзаменов",one:"Экзамен",twoToFour:"Экзамена",fiveToNine:"Экзаменов"})]}),t.jsxs("span",{children:[s," ",m(s,{zero:"Зачетов",one:"Зачет",twoToFour:"Зачета",fiveToNine:"Зачетов"})]}),t.jsxs("span",{children:[i," ",m(i,{zero:"Курсовых",one:"Курсовая",twoToFour:"Курсовые",fiveToNine:"Курсовых"})]})]}),v=({title:e,icon:s,color:i})=>t.jsx(Q,{padding:"0",width:"100%",maxWidth:"100%",height:"135px",justifyContent:"center",color:i.length?i:"blue",isVertical:!0,hasNotifications:!1,children:t.jsxs("div",{className:"outside",children:[t.jsx(X,{color:i.length?i:"blue",children:s}),t.jsx("b",{children:e})]})}),z=c.a`
...
`,Te=e=>{const{path:s,Component:i}=e,{open:r}=Y(),a=!!i({});return t.jsxs(t.Fragment,{children:[!a&&t.jsx(z,{href:s,width:1,children:t.jsx(v,{...e})}),a&&t.jsx(z,{onClick:()=>r(t.jsx(i,{})),width:1,children:t.jsx(v,{...e})})]})},we=c.div`
    width: 745px;
...
`,Oe=({teacherName:e,group:s,data:i,loading:r,error:a})=>{var b;const{schedule:o,currentModule:l,view:d}=i,{data:{user:n}}=_.useUser(),[u,g]=x.useState((n==null?void 0:n.group)??""),{pages:h,wrapperRef:y,showGroupSearch:p,setCurrentPage:I,onValueEmpty:C,handleLoad:L,onHintClick:E}=De(i,e,s);return t.jsx(ie,{loading:r,load:L,error:a,data:o,children:t.jsxs(Me,{children:[t.jsx("div",{className:"slider-wrapper",children:t.jsx(re,{appearance:!1,pages:h,currentPage:parseInt(l),setCurrentPage:I})}),l!=="3"&&t.jsxs("div",{className:"buttons-and-search",children:[t.jsx(ce,{view:d,setView:D=>j.changeView({view:D})}),p&&t.jsx(ue,{value:u,setValue:g,onHintClick:E,placeholder:"Группа",customMask:oe.groupMask,request:ae,leftIcon:t.jsx(J,{}),onValueEmpty:(n==null?void 0:n.user_status)==="staff"?C:void 0})]}),t.jsx(de,{visible:!!e||!!s,filter:e??s??"",isGroup:!!s}),l!=="3"&&t.jsx(pe,{wrapperRef:y,data:i}),!!h&&((b=h[l])==null?void 0:b.content)]})})};export{Oe as T};
