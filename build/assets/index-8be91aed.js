import{y as l,s as p,o as d,b_ as g,j as e}from"./vendor-2324f29b.js";import{aW as m,Y as x,W as P,z as j,m as k,k as v}from"./index-386db3e9.js";import{c as y,L as F}from"./index-71a9dcae.js";import"./index-081ba2d7.js";const L=l(async n=>{const{search:o="",page:c,limit:r,filter:s}=n,{data:a}=await m(o,(s==null?void 0:s.id.toString())??"",c,r);return{results:a.items}}),u=y({getFx:L,limit:50}),M=p.div`
    width: 100%;
    display: flex;
