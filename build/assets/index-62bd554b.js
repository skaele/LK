...
`,Z=r.div`
    ...
    font-size: 15px;
    line-height: 18px;
`,K=({data:t})=>{const{data:{user:e}}=C.useUser(),[n,s]=a.useState(!1),[c,o]=a.useState(!1);return i.jsxs(H,{children:[i.jsxs(q,{children:[i.jsx(Z,{children:t.event||t.post}),t.startDate&&t.endDate!=="0000-00-00"?i.jsxs(b,{children:["Период: ",v(t.startDate,"numeric")," - ",v(t.endDate,"numeric")]}):i.jsxs(b,{children:["Дата: ",v(t.startDate,"numeric")]})]}),i.jsxs(Q,{children:[t.file&&i.jsx(F,{href:t.file,onClick:()=>null,text:"Скачать",width:"150px",icon:i.jsx(E,{}),height:"35px",minHeight:"30px",background:L.grey.transparent2}),i.jsx(I,{text:t.viewed?j(e==null?void 0:e.sex,"Ознакомлен","Ознакомлена"):"Ознакомиться",action:()=>{s(!0),h.viewPersonalNotificationsFx(t.id),s(!1),o(!0)},height:"35px",width:"150px",buttonSuccessText:j(e==null?void 0:e.sex,"Ознакомлен","Ознакомлена"),isLoading:n,completed:c,setCompleted:o,isActive:!0,isDone:t.viewed,repeatable:!1,popUpFailureMessage:"Вы уже ознакомились"})]})]})},X=r.div`
    width: 100%;
    padding: 20px;
    border-radius: var(--brLight);
    background: var(--block-content);
...
`,te=r.div`
    ...
    font-size: 15px;
    line-height: 18px;
`,ie=({data:t})=>{const{data:{user:e}}=C.useUser(),[n,s]=a.useState(!1),[c,o]=a.useState(!1),l=()=>{try{s(!0),h.viewPersonalNotificationsFx(t.id),W.clearById({id:`studdoc-${t.id}`,pageId:"doclist"}),s(!1),o(!0)}catch{A.evokePopUpMessage({message:"Не удалось отправить данные",type:"failure"})}};return i.jsxs(X,{children:[i.jsxs(Y,{children:[i.jsx(te,{children:t.name}),t.date&&i.jsxs(b,{children:["Дата: ",v(t.date,"numeric")]})]}),i.jsxs(ee,{children:[t.link&&i.jsx(F,{href:t.link,onClick:()=>null,text:"Подробнее",width:"100%",icon:i.jsx(O,{}),height:"35px",minHeight:"30px",background:L.grey.transparent2}),i.jsx(I,{text:t.viewed?j(e==null?void 0:e.sex,"Ознакомлен","Ознакомлена"):"Ознакомиться",action:l,height:"35px",width:"100%",buttonSuccessText:j(e==null?void 0:e.sex,"Ознакомлен","Ознакомлена"),isLoading:n,completed:c,setCompleted:o,isActive:!0,isDone:t.viewed,repeatable:!1,popUpFailureMessage:"Вы уже ознакомились"})]})]})},S=({listNotification:t})=>{const e=B.useType();return i.jsx(U,{d:"column",gap:"8px",children:t.length?t.map(n=>e==="notifications"?i.jsx(K,{data:n},n.id):i.jsx(ie,{data:n},n.id)):i.jsx(V,{text:"У вас нет приказов, с которыми вы еще не ознакомились"})})},se=r.div`
    display: flex;
