import{y as p,s as g,c0 as x,o as d,j as n}from"./vendor-3b6459b9.js";import{as as m,a8 as P,W as j,P as v,at as y}from"./index-b517f30d.js";import{c as F,L}from"./index-4fca8c0c.js";import"./index-4617b6d0.js";const $=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,s=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",s,o,c);return{results:r.items}}),h=F({getFx:$,limit:50}),w=g.div`
    width: 100%;
    display: flex;
