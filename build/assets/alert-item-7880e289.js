import{s as r,j as e,au as x}from"./vendor-561dac3a.js";import{U as s,bk as c,m as d,L as h,O as p,w as g,aq as m}from"./index-da3e5de5.js";import{i as v}from"./is-valid-url-08a91344.js";const f=({alert:t})=>{const{content:i,time:a,date:o}=t;return e.jsxs(u,{children:[e.jsx(s,{fontSize:"0.9rem",children:e.jsx(c,{words:[d(o),a]})}),e.jsx(h,{width:"100%",margin:"12px 0"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:i}})]})},u=r.div`
    display: flex;
