import{s as a,j as t,cf as T,cg as P,r as h,R as G,ch as L}from"./vendor-2bd70a0f.js";import{cz as M,aU as l,l as z,cA as $,cB as f,u as R,p as c,b4 as W,cC as q,U as u,by as U,cD as H,T as y,K as x,am as K,D as J,aY as S,bi as B,ac as p,cE as D,cF as C,Z as V,W as X,t as Y,i as Z,N as O,a2 as Q}from"./index-bc77f324.js";const w=(e,i)=>{const n=new Date(e).getMonth();return n>1&&n<8?+i*2:+i*2-1},ee=e=>{const i=w(new Date().toISOString(),e),n=[];for(let s=1;s<=i;s++)n.push({id:s,title:`${s} семестр`});return n.push({id:-1,title:"Все семестры"}),n},te=(e,i)=>M(i.filter(n=>l(n.name).includes(l(e))||l(n.teacher).includes(l(e))||l(z(n.exam_date)).includes(l(e))||l(n.bill_num).includes(l(e))));function ne(e){const i={5:0,4:0,3:0,2:0},n=e.filter(s=>!!s.grade&&s.exam_type!=="Зачет").length;return e.forEach(({grade:s,exam_type:r})=>{r!=="Зачет"&&s!==void 0&&i[$[s]]++}),n===0?i:Object.keys(i).reduce((s,r)=>(s[+r]=i[+r]/n,s),{})}const ie=2.7;a.div`
    display: flex;
...
`,ae=({grade:e})=>t.jsx(re,{grade:e,children:e&&($[e]>2?t.jsx(T,{}):t.jsx(P,{}))}),oe=a.div`
    width: 100%;
    display: flex;
    min-height: 60px;
    align-items: center;
