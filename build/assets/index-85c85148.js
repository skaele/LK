import{j as s,q as P,aJ as N,by as W,s as b,L as z,K as F,aR as G,r as j,T as q,at as B,c7 as K,bN as A,bO as J,a8 as Q}from"./vendor-cbee1f3c.js";import{a4 as _,y as Z,z as X,D as Y,c0 as ee,Q as se,V as D,K as M,bD as I,t as $,N as te,c1 as w,bz as ae,c2 as ne,c3 as re,c4 as ie,w as le,c5 as V,c6 as x,bF as O,c7 as T,c8 as U,i as ce,c9 as oe,J as de,aB as ue,W as he,P as pe,Z as xe,ca as fe,cb as Se,cc as ge}from"./index-9128e944.js";import{E as Ee}from"./index-1a871023.js";const me=({value:e,setValue:o,onHintClick:c,onValueEmpty:d})=>{const t=/\d/.test(e),{data:{user:a}}=_.useUser(),u=async r=>t?await Y(r):await ee(r,"",1,20);return s.jsx(Z,{value:e,width:"100%",setValue:o,onHintClick:c(t),placeholder:"Поиск",customMask:t?X.groupMask:void 0,transformRequest:t?void 0:r=>r.fio,request:u,leftIcon:e.length===0?s.jsx(P,{}):t?s.jsx(N,{}):s.jsx(W,{}),onValueEmpty:(a==null?void 0:a.user_status)==="staff"?d:void 0})},je=b(z)`
    color: var(--text);
    padding: 15px 15px;
    max-width: 140px;
    width: 100%;
