import{y as p,s as g,b7 as x,n as d,j as n}from"./vendor-1f18e8c3.js";import{X as m,Q as P,W as j,R as v,Y as y}from"./index-8228fcb5.js";import{c as F,L}from"./index-a22f8c52.js";import"./index-0eae065a.js";const R=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,s=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",s,o,c);return{results:r.items}}),h=F({getFx:R,limit:50}),$=g.div`
    width: 100%;
    display: flex;
