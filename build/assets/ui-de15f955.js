import{y as we,z as W,$ as Re,f as M,a as c,p as Fe,g as Ce,B as Te,l as J,x as X}from"./index-3edf5efe.js";import{d as Ve,u as a,bS as D,bV as be,x as s,y as l,p as i,bO as q,bR as Ie,bQ as Ne,m as U,r as K,X as qe,bW as _e,bX as Me,j as N}from"./vendor-4af360a6.js";const Ue="https://api.mospolytech.ru/physedjournal/graphql/",$=Ve.create({baseURL:Ue}),je={headers:{"Content-Type":"application/json"}};$.interceptors.request.use(we);$.interceptors.response.use(async e=>{var t,o,n,r;return((r=(n=(o=(t=e==null?void 0:e.data)==null?void 0:t.errors)==null?void 0:o[0])==null?void 0:n.extensions)==null?void 0:r.code)==="AUTH_NOT_AUTHENTICATED"?await W($)(e):e},W($));const d=async e=>{var o;const t=await $.post("",{query:e},je);if(te(t.data))throw new Error("Request error");return(o=t==null?void 0:t.data)==null?void 0:o.data};function te(e){if(typeof e=="object"&&e){if(e.hasOwnProperty("errors")&&e.errors)return!0;for(const t in e)if(te(e[t]))return!0}return!1}const Oe=e=>`query {
        teacher(guid: "${e}") {
          permissions
          fullName
        }
