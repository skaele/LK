...
`,Pe=h.div`
    padding: 12px;
    width: 100%;
`,De=({list:i})=>{const{allRoutes:s}=f.useMenu();return s?t.jsx(D,{children:t.jsxs(N,{children:[(i==null?void 0:i.length)===0&&t.jsx(k,{text:"Не удалось ничего найти"}),i==null?void 0:i.map((e,a)=>t.jsx(Pe,{children:t.jsx(je,{fontSize:"0.85rem",children:e.map((l,c)=>t.jsxs(t.Fragment,{children:[l,c!==e.length-1&&" > "]}))})},a))]})}):null},Ve=h.div`
    width: 100%;
    height: 100%;
    overflow: hidden;
    flex-direction: column;
...
`,Ue=({searchValue:i,searchResult:s,settingsConfig:e})=>{var c,o;const{allRoutes:a}=f.useMenu(),l=(c=L($))==null?void 0:c.params;return!a||e===void 0?null:t.jsx(Ve,{open:!!(l!=null&&l.id),children:t.jsx(We,{children:t.jsxs(te,{children:[i&&t.jsx(De,{list:s}),(o=Object.keys(e??{}))==null?void 0:o.map(u=>{const g=e[u],{path:d}=a[u];return t.jsx(T,{path:d,children:t.jsx(N,{direction:"vertical",gap:12,children:!i&&g.map(({title:p,fields:r})=>t.jsxs(D,{children:[t.jsx(He,{children:t.jsx(we,{size:4,align:"left",children:p})}),t.jsx(Ce,{fields:r,settingsName:u})]},p))})},d)}),t.jsx(T,{path:"/",children:t.jsx(P,{height:"100%",children:t.jsx(k,{text:"Ничего не выбрано",image:t.jsx(ye,{color:"grey",size:50,children:t.jsx(ie,{})})})})})]})})})},Ge=(i,s,e)=>{const a=[];if(!e)return a;let l=0,c=!1;for(const o in s){c=!1,a.push([]);const u=e[o].title.split(". ")[1];a[l].push(u);const g=s[o];for(const d of g)for(const p of d.fields)O(p.title).includes(O(i))&&(c?(a.push([...a[l].slice(0,a[l].length-1),p.title]),l++):(a[l].push(d.title),a[l].push(p.title)),c=!0);c?l++:a.pop()}return a},Qe=h(be)`
    height: 100%;
    z-index: 1;
    padding-top: 0;
    padding: 8px;
