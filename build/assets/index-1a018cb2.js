import{y as p,s as g,aR as m,m as d,j as n}from"./vendor-9cc634b6.js";import{J as x,z as P,W as j,P as v,N as y}from"./index-3fee83b2.js";import{c as F,L}from"./index-c12761ac.js";import"./index-71955de0.js";const R=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,s=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await x(i??"",s,o,c);return{results:r.items}}),h=F({getFx:R,limit:50}),$=g.div`
    width: 100%;
    display: flex;
