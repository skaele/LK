...
const ApplicationExtensionAttestation = () => {
            ...
            {!!form && !!setForm && (
                <FormBlock>
                    ...
                    <SubmitButton
                        ...
                        action={() =>
                            globalAppSendForm(ApplicationFormCodes.CRS_ATTESTAT, [form], setLoading, setCompleted)
                        }
                        isLoading={loading}
                        completed={completed}
...
export default ApplicationExtensionAttestation
