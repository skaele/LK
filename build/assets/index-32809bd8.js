...
`,Q=r.div`
    ...
    font-size: 15px;
    line-height: 18px;
`,X=({data:t})=>{const{data:{user:e}}=C.useUser(),[n,s]=a.useState(!1),[c,o]=a.useState(!1);return i.jsxs(q,{children:[i.jsxs(G,{children:[i.jsx(Q,{children:t.event||t.post}),t.startDate&&t.endDate!=="0000-00-00"?i.jsxs(b,{children:["Период: ",v(t.startDate,"numeric")," - ",v(t.endDate,"numeric")]}):i.jsxs(b,{children:["Дата: ",v(t.startDate,"numeric")]})]}),i.jsxs(K,{children:[t.file&&i.jsx(F,{href:t.file,onClick:()=>null,text:"Скачать",width:"150px",icon:i.jsx(E,{}),height:"35px",minHeight:"30px",background:I.grey.transparent2}),i.jsx(L,{text:t.viewed?j(e==null?void 0:e.sex,"Ознакомлен","Ознакомлена"):"Ознакомиться",action:()=>{s(!0),h.viewPersonalNotificationsFx(t.id),s(!1),o(!0)},height:"35px",width:"150px",buttonSuccessText:j(e==null?void 0:e.sex,"Ознакомлен","Ознакомлена"),isLoading:n,completed:c,setCompleted:o,isActive:!0,isDone:t.viewed,repeatable:!1,popUpFailureMessage:"Вы уже ознакомились"})]})]})},Y=r.div`
    width: 100%;
    padding: 20px;
    border-radius: var(--brLight);
    background: var(--block-content);
...
`,te=r.div`
    ...
    font-size: 15px;
    line-height: 18px;
`,ie=({data:t})=>{const{data:{user:e}}=C.useUser(),[n,s]=a.useState(!1),[c,o]=a.useState(!1),l=()=>{try{s(!0),h.viewPersonalNotificationsFx(t.id),V.clearById({id:`studdoc-${t.id}`,pageId:"doclist"}),s(!1),o(!0)}catch{W.evokePopUpMessage({message:"Не удалось отправить данные",type:"failure"})}};return i.jsxs(Y,{children:[i.jsxs(Z,{children:[i.jsx(te,{children:t.name}),t.date&&i.jsxs(b,{children:["Дата: ",v(t.date,"numeric")]})]}),i.jsxs(ee,{children:[t.link&&i.jsx(F,{href:t.link,onClick:()=>null,text:"Подробнее",width:"100%",icon:i.jsx(O,{}),height:"35px",minHeight:"30px",background:I.grey.transparent2}),i.jsx(L,{text:t.viewed?j(e==null?void 0:e.sex,"Ознакомлен","Ознакомлена"):"Ознакомиться",action:l,height:"35px",width:"100%",buttonSuccessText:j(e==null?void 0:e.sex,"Ознакомлен","Ознакомлена"),isLoading:n,completed:c,setCompleted:o,isActive:!0,isDone:t.viewed,repeatable:!1,popUpFailureMessage:"Вы уже ознакомились"})]})]})},S=({listNotification:t})=>{const e=B.useType();return i.jsx(A,{d:"column",gap:"8px",children:t.length?t.map(n=>e==="notifications"?i.jsx(X,{data:n},n.id):i.jsx(ie,{data:n},n.id)):i.jsx(U,{text:"У вас нет приказов, с которыми вы еще не ознакомились"})})},se=r.div`
    display: flex;
