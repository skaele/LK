...
export function OtherContacts() {
    return (
        <Message lineHeight="1.5rem" title="Уважаемые коллеги!" type="info" gap="0.5rem" fontSize="0.9rem">
            ...
            <p>
                Линия консультаций Техподдержки ИТ доступна по номеру <Telephone tel="+79857702196" /> – добавьте его
                себе в контакты и пишите вопросы нам в самом распространённом мессенджере.
            </p>
            <p>
                Также мы запустили функцию автоматической фиксации всех заявок, поступающих через Личный кабинет{' '}
                <a href="e.mospolytech.ru">e.mospolytech.ru</a> и на почту <Email email="help@mospolytech.ru" />.
                Просьба направлять сложные заявки на обслуживание и решение вопросов по ИТ с помощью этих способов – это
                позволит более точно описать проблему.
            </p>
            <p>
                Напомню, что с 1 апреля 2020 года заявки по вопросам технической поддержки компьютеров и программного
                обеспечения, кроме внутреннего номера 1111, принимаются по телефонам: <Telephone tel="+79853504173" />,
