import{u as r,y as x,p,n as d,s as i,j as e,r as F,cf as D,aL as S}from"./vendor-52b5ac7c.js";import{E as v,ck as b,S as m,_ as $,u as T,T as k,aX as L,g as u,M as _,B as M,bD as R,x as P,bE as O}from"./index-d0879ffc.js";const z=async a=>{const t=new FormData;return t.set("avatar",a[0]),await v.post("?changeAvatar=1",t,{headers:{"Content-Type":"multipart/form-data"}})},B=async a=>{const t=new FormData;return t.set("email",a),await v.post("?changeEmail=1",t)},g={loading:!1,completed:!1,error:null},I={data:[],...g},U={data:"",...g},V={data:"",...g},w=r(),j=r(),n=x(async a=>{try{await z(a)}catch{throw new Error("Не удалось загрузить фотографию")}}),W=p(I).on(w,(a,t)=>({...a,data:t})).on(n,a=>({...a,error:null,loading:!0,completed:!1})).on(n.doneData,a=>({...a,error:null,loading:!1,completed:!0})).on(n.fail,(a,{error:t})=>({...a,error:t.message,loading:!1,completed:!1})).on(j,(a,t)=>({...a,completed:t})),A=r(),s=x(async a=>{try{await B(a)}catch{throw new Error("Не удалось изменить email")}}),N=p(V).on(A,(a,t)=>({...a,data:t})).on(s,a=>({...a,loading:!0})).on(s.doneData,a=>({...a,loading:!1,completed:!0,error:null})).on(s.failData,(a,t)=>({...a,loading:!1,completed:!1,error:t.message})),X=r(),q=p(U).on(X,(a,t)=>({...a,data:t})),G=()=>({avatar:d(W),adPass:d(q),email:d(N)}),E={useData:G},o={avatar:{changeAvatar:w,changeCompleted:j},email:{changeEmail:A}},H={avatar:{postAvatarFx:n},email:{postNewEmail:s}},J=i.div`
    min-width: 500px;
    display: flex;
