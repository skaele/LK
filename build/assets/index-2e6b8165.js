import{y as p,s as g,bZ as x,o as d,j as n}from"./vendor-f1fdae2f.js";import{ab as m,V as P,W as j,w as v,ac as y}from"./index-6982b600.js";import{c as b,L as w}from"./index-c7e2e820.js";import"./index-e691e9da.js";const F=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,s=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",s,o,c);return{results:r.items}}),h=b({getFx:F,limit:50}),L=g.div`
    width: 100%;
    display: flex;
