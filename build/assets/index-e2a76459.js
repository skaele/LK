...
`,Wt=()=>{const[e,n]=x.useState(""),[s,i]=x.useState(""),[a,o]=x.useState(""),[l,r]=x.useState(null),[c,d]=x.useState(!1),[u,m]=x.useState(!1),{isActive:g,validationError:j}=le(Y,[s,a,e]),v=_t(s),{close:h}=C(),b=()=>{const f=Pt(12);i(f),o(f)},y=async()=>{try{d(!0);const f=await qe(e,s);if(f.data.result!=="ok")throw new Error(f.data.errors);m(!0),d(!1),i(""),o(""),n("")}catch(f){const w=f.message??f;r("Возникла ошибка: "+w),d(!1)}};return t.jsxs(Ot,{children:[t.jsxs(Dt,{children:[t.jsxs(Bt,{children:[t.jsx(z,{size:3,align:"left",children:"Смена пароля"}),t.jsx(O,{width:"100%",align:"left",fontSize:"0.9rem",children:"Обязательные требования"}),t.jsx(R,{gap:8,direction:"vertical",children:Y.map(f=>t.jsx(W,{fontSize:"0.85rem",setChecked:()=>null,text:f.text,checked:f.test(s,a,e)},f.text))}),t.jsx(O,{width:"100%",align:"left",fontSize:"0.9rem",children:"Необязательные требования"}),t.jsx(R,{gap:8,direction:"vertical",children:It.map(f=>t.jsx(W,{fontSize:"0.85rem",setChecked:()=>null,text:f.text,checked:f.test(s,a,e)},f.text))})]}),!g&&t.jsx(M,{width:"100%",text:"Сгенерировать пароль",onClick:b,background:"var(--theme-2)"}),g&&t.jsxs(Nt,{children:[t.jsx(Ge,{size:"40px"}),t.jsx(z,{size:5,children:"Отличный пароль!"})]})]}),t.jsxs($t,{children:[t.jsxs(Ut,{children:[t.jsx(_,{title:"Ошибка",type:"failure",visible:!!l,children:l}),t.jsx(P,{type:"password",title:"Введите старый пароль",placeholder:"Введите пароль",value:e,setValue:n,required:!0}),t.jsx(P,{type:"password",title:"Придумайте пароль",placeholder:"Введите пароль",value:s,setValue:i,required:!0}),t.jsx(P,{type:"password",title:"Повторите пароль",placeholder:"Введите тот же пароль",value:a,setValue:o,required:!0}),t.jsx(Tt,{value:v.value,size:"small",title:`Сложность пароля: ${v.title}`})]}),t.jsxs(Vt,{children:[t.jsx(M,{text:"Отменить",width:"100%",onClick:h}),t.jsx(T,{isLoading:c,completed:u,text:"Обновить",popUpFailureMessage:`Требование к паролю: ${j==null?void 0:j.text}`,action:y,setCompleted:m,height:"38px",isActive:g})]})]})]})},Gt=e=>{const{open:n}=C(),s=()=>n(t.jsx(Wt,{}));return t.jsx(L,{...e,onClick:s})},qt=p.div`
    display: flex;
    flex-direction: column;
    gap: 4px;
    position: relative;
...
`,Zt=e=>({toggle:t.jsx(vt,{...e},e.title),photo:t.jsx(bt,{...e},e.title),choices:t.jsx(kt,{...e},e.title),text:t.jsx(Z,{...e},e.title),display:t.jsx(St,{...e},e.title),interval:t.jsx(Lt,{...e},e.title),tel:t.jsx(Z,{...e},e.title),password:t.jsx(Gt,{...e},e.title),link:t.jsx(jt,{...e},e.title)}),he=({fields:e,settingsName:n,asChild:s=!1})=>{const i=a=>!a||!n?()=>null:o=>{console.log(o),I.updateSetting({nameSettings:n,nameParam:a,value:o})};return t.jsx(qt,{asChild:s,children:e.map(a=>{const o=a.action??i(a.id),{type:l,visible:r=!0}=a;if(r)return Zt({...a,action:o,settingsName:n})[l]})})},Ht=p.div`
    width: 100%;
    height: 100%;
    overflow: hidden;
    flex-direction: column;
...
`,Jt=({searchValue:e,searchResult:n,settingsConfig:s})=>{var o,l;const{allRoutes:i}=F.useMenu(),a=(o=X(ie))==null?void 0:o.params;return!i||s===void 0?null:t.jsx(Ht,{open:!!(a!=null&&a.id),children:t.jsx(Qt,{children:t.jsxs(Ee,{children:[e&&t.jsx(ut,{list:n}),(l=Object.keys(s??{}))==null?void 0:l.map(r=>{const c=s[r],{path:d}=i[r];return t.jsx(D,{path:d,children:t.jsx(R,{direction:"vertical",gap:12,children:!e&&c.map(({title:u,fields:m})=>t.jsxs(oe,{children:[t.jsx(Yt,{children:t.jsx(z,{size:4,align:"left",children:u})}),t.jsx(he,{fields:m,settingsName:r})]},u))})},d)}),t.jsx(D,{path:"/",children:t.jsx(ae,{height:"100%",children:t.jsx(ne,{text:"Ничего не выбрано",image:t.jsx(Ze,{color:"grey",size:50,children:t.jsx(Le,{})})})})})]})})})},Xt=(e,n,s)=>{const i=[];if(!s)return i;let a=0,o=!1;for(const l in n){o=!1,i.push([]);const r=s[l].title.split(". ")[1];i[a].push(r);const c=n[l];for(const d of c)for(const u of d.fields)G(u.title).includes(G(e))&&(o?(i.push([...i[a].slice(0,i[a].length-1),u.title]),a++):(i[a].push(d.title),i[a].push(u.title)),o=!0);o?a++:i.pop()}return i},Kt=p(Qe)`
    height: 100%;
    z-index: 1;
    padding-top: 0;
    padding: 8px;
