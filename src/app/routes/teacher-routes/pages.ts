...
export const SalarySupplements = lazy(() => import('@pages/salary-supplements/pages/salary-supplements'))
export const CreateSalarySupplement = lazy(() => import('@pages/salary-supplements/pages/create-salary-supplement'))
