import{y as p,s as g,b$ as x,o as d,j as n}from"./vendor-561dac3a.js";import{ar as m,a7 as P,W as j,P as v,as as y}from"./index-7cc4f467.js";import{c as $,L as F}from"./index-473b593a.js";import"./index-462fa016.js";const L=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,s=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",s,o,c);return{results:r.items}}),h=$({getFx:L,limit:50}),b=g.div`
    width: 100%;
    display: flex;
