import{s as c,L as g,j as e,R as w,F as R,c as M,r as b}from"./vendor-198a3a64.js";import{a7 as l,b3 as N,J as v,N as L,V as $,l as T,b4 as y,aX as x,E,b5 as B,aK as D,B as C,b6 as F,M as A,b7 as k,b8 as S,O as I,b2 as f,R as m,b9 as W,ab as d,T as P,ba as H,bb as h,b1 as U,bc as p,a1 as Y,W as _,bd as O,z as X,aS as Z,be as q,bf as G,bg as K}from"./index-7ac35755.js";import{D as J}from"./week-schedule-17e38314.js";const V=c(g)`
    width: 100%;
    height: 100%;
...
`,Q=({item:t,amount:s})=>{const{icon:n,color:a,path:i,title:r,notifications:o}=t;return e.jsxs(V,{amount:s,to:i,color:l[a].transparent3,children:[e.jsx(N,{badge:o==null?void 0:o.toString(),color:a,children:n}),e.jsx(v,{className:"subtext",align:"center",children:L(r,10)})]})},ee=c.div`
    width: 100%;
    display: flex;
    align-items: center;
    max-width: 750px;
...
`,te=({links:t})=>{const s=Object.keys(t),n=s.length<8?8:Object.keys(t).length;return e.jsx(ee,{children:s.map((a,i)=>e.jsxs(w.Fragment,{children:[e.jsx(Q,{item:t[a],amount:n}),i!==s.length-1&&e.jsx($,{direction:"vertical",margin:"10px 0",width:"70%"})]},a))})},se=(t,s)=>{var a,i,r,o;const n=t?t[0]?"0":t[1]?"1":t[2]?"2":"0":"0";return n!=="2"?t?((i=(a=t==null?void 0:t[n])==null?void 0:a[s])==null?void 0:i.lessons)||[]:null:((o=(r=t==null?void 0:t[n])==null?void 0:r[T(new Date,"weird")])==null?void 0:o.lessons)||[]},u=c.div`
    max-width: 400px;
...
`,me=()=>{const{data:{user:t},error:s}=m.useUser(),{data:n}=y.usePayments(),{data:a}=k.useSchedule(),{homeRoutes:i}=Y.useMenu();if(!t||!i)return null;const r=()=>{G.getScheduleFx({user:t}),K.getPaymentsFx()},{news:o}=S.useSettings().settings["settings-home-page"].property;return e.jsxs(_,{loading:!t,load:r,error:s,data:n&&a,children:[e.jsx(de,{}),e.jsxs(xe,{children:[e.jsx(O,{}),e.jsx(te,{links:i}),e.jsx(X,{children:e.jsxs(Z,{maxWidth:"750px",minHeight:"100%",height:"100%",orientation:"vertical",gap:"20px",children:[e.jsxs(d,{children:[e.jsx(P,{size:2,align:"left",width:"100%",children:"Главная"}),e.jsx(q,{})]}),e.jsx(re,{}),!!o&&e.jsx(oe,{})]})})]})]})};export{me as default};
