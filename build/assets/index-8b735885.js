import{u as c,bR as pe,bS as Ze,p as f,x as a,bT as Je,bU as Xe,y as v,s as l,r as u,j as s,d as Ye,Z as k,aG as ve,bJ as Z,T as et,m as tt,bV as st,c as rt}from"./vendor-2324f29b.js";import{a as m,f as C,p as h,g as F,B as p,T as M,h as J,i as V,u as _,j as I,k as ye,m as ke,n as nt,o as at,$ as ot,q as it,r as j,K as T,D as ct,P as lt,t as P,v as ut,L as dt,w as pt,M as mt,x as gt,y as xt,z as ft,E as ht,G as jt}from"./index-e592482b.js";import{j as U,e as X,d as $e,P as A,s as St,a as vt,b as we,c as $,f as yt,g as Y,h as w,A as kt,i as O,k as $t,l as wt,S as Ct,m as Et,n as Pt,o as me}from"./ui-0616012a.js";import{S as Ce}from"./index-1c03349a.js";function ge(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(o){return Object.getOwnPropertyDescriptor(e,o).enumerable})),r.push.apply(r,n)}return r}function bt(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]!=null?arguments[t]:{};t%2?ge(Object(r),!0).forEach(function(n){Nt(e,n,r[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):ge(Object(r)).forEach(function(n){Object.defineProperty(e,n,Object.getOwnPropertyDescriptor(r,n))})}return e}function Nt(e,t,r){return t=Dt(t),t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function Dt(e){var t=Gt(e,"string");return typeof t=="symbol"?t:String(t)}function Gt(e,t){if(typeof e!="object"||e===null)return e;var r=e[Symbol.toPrimitive];if(r!==void 0){var n=r.call(e,t||"default");if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}function Ee(e){var{events:t,reset:r,target:n=c({name:"target",sid:"aip3nf"},{name:"target",sid:"aip3nf"})}=e;return pe.unit(n)||xe("target should be a unit"),r&&!pe.unit(r)&&xe("reset should be a unit"),Ze(n,()=>{var o=Object.keys(t),i=Array.isArray(t)?[...o].fill(""):{},d=f(o.length,{and:{serialize:"ignore"},name:"$counter",sid:"-dby0v3"}),g=f(i,{and:{serialize:"ignore"},name:"$results",sid:"c60qbe"});d.reset(a({and:[{source:n}],or:{sid:"-8hxq8z"}})),g.reset(n),r&&(d.reset(a({and:[{source:r}],or:{sid:"3c6u5p"}})),g.reset(r));var q=function(B){var ue=f(!1,{and:{serialize:"ignore"},name:"$isDone",sid:"uttu1j"}).on(t[B],()=>!0).reset(n);r&&ue.reset(r),d.on(ue,E=>E-1),g.on(t[B],(E,Qe)=>{var de=Array.isArray(E)?[...E]:bt({},E);return de[B]=Qe,de})};for(var Ke of o)q(Ke);Je({and:[{source:a({and:[{source:g,clock:Xe(Object.values(t),{name:"clock",sid:"-531esq"})}],or:{name:"source",sid:"uwap9g"}}),filter:d.map(le=>le===0),target:n}],or:{sid:"ciyd7d"}})}),n}function xe(e){throw new Error(e)}const Tt=e=>`mutation addNewComp{
    ...
    }`,Pe=c(),b=v(async e=>await h(Tt(e)));a({clock:Pe,target:b});a({clock:b.failData,fn:()=>({message:"Не удалось добавить соревнование",type:"failure",time:3e3}),target:m.evokePopUpMessage});a({clock:b.doneData,fn:()=>({message:"Соревнование добавлено",type:"success",time:3e3}),target:m.evokePopUpMessage});a({clock:b.doneData,target:X.load});a({clock:b.doneData,target:C.close});const At=l.div`
    display: flex;
...
`,Ut={[A.AdminAccess]:"Админ",[A.OnlineCourseAccess]:"Доступ к ЛМС",[A.SecretaryAccess]:"Секретарь",[A.DefaultAccess]:"Преподаватель"},Rt=Object.entries(Ut).map(([e,t])=>({title:t,id:e})),Lt=()=>{const[e,t]=u.useState(""),[r,n]=u.useState(""),[o,i]=u.useState(null),d=()=>{Ge({fullName:e,teacherGuid:r,permission:o==null?void 0:o.id})};return s.jsxs(It,{children:[s.jsx(Mt,{onChange:n,onSearchChange:t}),s.jsx(V,{title:"Доступ",items:Rt,setSelected:i,selected:o}),s.jsx(p,{text:"Добавить",onClick:d})]})},Q=c(),Te=c(),Ae=v(async e=>{const{teachers:{items:t}}=await h(`
    query teachers {
      ...
      }`);return t}),ee=f("").on(Q,(e,t)=>t);$e({source:a({source:ee,filter:e=>e!==null}),timeout:200,target:Ae});const Wt=f([]).on(Ae.doneData,(e,t)=>t);a({clock:Te,target:ee.reinit});const zt=({onChange:e})=>{const[t,r]=k([Wt,ee]),n=o=>{o!=null&&o.id&&e(o.id)};return u.useEffect(()=>(Q(""),Te),[]),s.jsxs(s.Fragment,{children:[s.jsx(M,{size:5,align:"left",visible:!0,children:"Преподаватель"}),s.jsx(J,{value:r,setValue:Q,hints:t.map(o=>({id:o.teacherGuid,title:o.fullName,value:o.teacherGuid})),onHintClick:n})]})},Ht=e=>`mutation assignCuratorToGroup{
...
`,Jt=[{id:"",title:"Не выбрано"},{id:"2",title:"2"},{id:"2.5",title:"2.5"},{id:"3",title:"3"},{id:"3.5",title:"3.5"},{id:"4",title:"4"}],Xt=()=>{const[e,t]=u.useState(null),[r,n]=u.useState(""),o=()=>{te({newVisitValue:(e==null?void 0:e.id.toString())??"",groupName:r})};return s.jsxs(Zt,{children:[s.jsx(F,{title:"Группа",setValue:n,value:r}),s.jsx(V,{title:"Стоимость",items:Jt,selected:e,setSelected:t}),s.jsx(p,{text:"Добавить",onClick:o})]})},Yt=e=>`mutation addSemester {
...
`,ss=()=>{const[e,t]=u.useState(""),r=()=>{es.startNewSemester(e)};return s.jsxs(ts,{children:[s.jsx(F,{title:"Новый семестр",setValue:t,value:e}),s.jsx(p,{text:"Начать новый семестр",onClick:r})]})},rs=()=>`mutation {
     ...
     }`,Fe=c(),G=v(async()=>await h(rs()));a({clock:Fe,target:G});a({clock:G.doneData,target:C.close});a({clock:G.failData,fn:()=>({message:"Не удалось обновить список студентов",type:"failure",time:3e3}),target:m.evokePopUpMessage});a({clock:G.doneData,fn:()=>({message:"Список студентов обновлен",type:"success",time:3e3}),target:m.evokePopUpMessage});G.pending;const ns=[{field:"name",title:"Название"},{field:"name",title:"",render:e=>s.jsx(p,{onClick:()=>X.remove(e),text:"Удалить"})}],as=l.div`
    width: 100%;
    display: flex;
    flex-direction: column;
    gap: 10px;
