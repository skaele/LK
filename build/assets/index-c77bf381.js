import{s as c,L as v,j as e,r as h,R as N,Z as I,F as T,c as A}from"./vendor-f4aa581a.js";import{L as g,U as d,bt as W,Y as M,aG as R,Q as C,bu as j,bk as m,a3 as _,bv as D,b7 as F,v as L,bw as B,M as U,bx as Y,by as O,bz as Z,bA as G,bB as q,bC as H,bD as K,aj as P,ad as Q,br as k,a8 as w,bE as X,N as u,T as z,bF as J,bG as f,bH as b,bI as V,bJ as ee,bK as te,W as se,bL as ie,_ as ae,bf as re,bM as ne}from"./index-01363656.js";import{E as le}from"./index-0dfbbebb.js";import{A as oe}from"./alert-item-2587bf0c.js";import"./is-valid-url-08a91344.js";const ce=c(v)`
    width: 100%;
    height: 100%;
    max-width: ${({amount:t})=>t>6&&"93.25px"};
...
`,S=({item:t,amount:s})=>{const{icon:i,color:a,path:r,title:l,notifications:n,menuPath:o}=t;return e.jsxs(ce,{to:o??r,color:d[a].transparent3,amount:s,children:[e.jsx(W,{badge:n==null?void 0:n.toString(),color:a,size:35,children:i}),e.jsx(M,{width:"95px",maxWidth:"95px",className:"subtext",align:"center",children:l})]})},de=c.div`
    width: 100%;
    display: flex;
    align-items: center;
    max-width: 750px;
...
`,xe=({links:t})=>{const s=Object.keys(t),{allRoutes:i}=R.useMenu(),[a,r]=h.useState(0);if(!i)return null;h.useEffect(()=>{const n=s.reduce((o,p)=>t[o].title.length>t[p].title.length?o:p);r(t[n].title.length)},[s]);const l=Object.keys(t).length;return e.jsxs(de,{componentHeight:a,children:[s.map((n,o)=>e.jsxs(N.Fragment,{children:[e.jsx(S,{amount:l,item:t[n]}),o!==s.length-1&&e.jsx(C,{direction:"vertical",margin:"10px 0",width:"70%"})]},n)),e.jsx(C,{direction:"vertical",margin:"10px 0",width:"70%"}),e.jsx(S,{amount:l,item:i.all})]})},y=c.div`
    max-width: 400px;
...
`,Ie=()=>{const{data:{user:t},error:s}=w.useUser(),i=I(j.$paymentsStore),{data:{schedule:a}}=V.useSchedule(),{homeRoutes:r}=R.useMenu();if(!t||!r)return null;h.useEffect(()=>{i||ee.getPayments()},[i]),h.useEffect(()=>{a||te.getScheduleFx(t)},[a]);const{news:l}=P.useSettings().settings["settings-home-page"].property;return e.jsxs(se,{loading:!t,load:()=>null,error:s,data:t,children:[e.jsx(ye,{}),e.jsxs(Ce,{children:[e.jsx(ie,{}),e.jsx(xe,{links:r}),e.jsx(ae,{children:e.jsxs(re,{noAppearanceInMobile:!0,maxWidth:"750px",minHeight:"100%",height:"100%",orientation:"vertical",gap:"20px",children:[e.jsxs(u,{children:[e.jsx(z,{size:2,align:"left",width:"100%",children:"Главная"}),e.jsx(ne,{})]}),e.jsx(be,{}),!!l&&e.jsx(je,{})]})})]})]})};export{Ie as default};
