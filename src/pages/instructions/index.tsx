        ...
        <CenterPage alignItems="flex-start" padding="10px">
            <CustomBlock orientation="vertical" gap="10px" maxWidth="650px" height="fit-content">
                ...
                <Message title="Уважаемые коллеги!" type="info">
                    ...
                    <p>
                        Линия консультаций Техподдержки ИТ доступна по номеру <Telephone tel="+7 985 770 21 96" /> –
                        добавьте его себе в контакты и пишите вопросы нам в самом распространённом мессенджере.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        программного обеспечения, кроме внутреннего номера 1111, принимаются по телефонам:{' '}
                        <Telephone tel="+79853504173" />,
                        <Telephone tel="+79853503944" />, <Telephone tel="+79853523122" />
                    </p>
                    <p>
