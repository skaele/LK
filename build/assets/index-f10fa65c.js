import{u as r,y as x,p,n as d,s as i,j as e,r as F,bx as b,aM as D}from"./vendor-1d6bafc4.js";import{$ as v,bU as S,S as m,Q as $,u as T,T as M,aV as k,f as u,M as L,B as R,bE as _,a7 as P,bF as O}from"./index-0f16aa88.js";const U=async a=>{const t=new FormData;return t.set("avatar",a[0]),await v.post("?changeAvatar=1",t,{headers:{"Content-Type":"multipart/form-data"}})},V=async a=>{const t=new FormData;return t.set("email",a),await v.post("?changeEmail=1",t)},g={loading:!1,completed:!1,error:null},z={data:[],...g},B={data:"",...g},I={data:"",...g},w=r(),j=r(),n=x(async a=>{try{await U(a)}catch{throw new Error("Не удалось загрузить фотографию")}}),W=p(z).on(w,(a,t)=>({...a,data:t})).on(n,a=>({...a,error:null,loading:!0,completed:!1})).on(n.doneData,a=>({...a,error:null,loading:!1,completed:!0})).on(n.fail,(a,{error:t})=>({...a,error:t.message,loading:!1,completed:!1})).on(j,(a,t)=>({...a,completed:t})),A=r(),s=x(async a=>{try{await V(a)}catch{throw new Error("Не удалось изменить email")}}),N=p(I).on(A,(a,t)=>({...a,data:t})).on(s,a=>({...a,loading:!0})).on(s.doneData,a=>({...a,loading:!1,completed:!0,error:null})).on(s.failData,(a,t)=>({...a,loading:!1,completed:!1,error:t.message})),Q=r(),q=p(B).on(Q,(a,t)=>({...a,data:t})),G=()=>({avatar:d(W),adPass:d(q),email:d(N)}),E={useData:G},o={avatar:{changeAvatar:w,changeCompleted:j},email:{changeEmail:A}},H={avatar:{postAvatarFx:n},email:{postNewEmail:s}},J=i.div`
    min-width: 500px;
    display: flex;
