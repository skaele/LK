...
`,q=({enabledList:e,requiredList:n,add:s,remove:i})=>{const{settings:a}=ee.useSettings(),o=F.useMenu(),{visibleRoutes:l}=F.useMenu(),[r,c]=x.useState(null),d=o[e];if(!d||!l)return null;const u=m=>{d[m]?i(m,a,n):s(m,a,Object.keys(d).length,n)};return t.jsxs(lt,{children:[t.jsx(te,{placeholder:"Поиск",whereToSearch:l,searchEngine:Me,setResult:c}),Object.values(r??l).map((m,g)=>x.createElement(ot,{...m,key:g,chosen:!!d[m.id],switchMenuItem:u}))]})},rt=e=>!e||e.length===0?"Не указан":e,ct=()=>{const{theme:e,switchTheme:n}=Te(),{data:{user:s}}=se.useUser(),{open:i}=C(),{leftsideBarRoutes:a,homeRoutes:o}=F.useMenu(),{settings:l}=ee.useSettings(),[r,c]=x.useState(null),{property:d}=l["settings-notifications"],{property:u}=l["settings-appearance"],{widgetPayment:m,widgetSchedule:g,news:j}=l["settings-home-page"].property,v=(s==null?void 0:s.user_status)==="staff"?ze:Pe;return x.useEffect(()=>{c({...st({scheduledLightTheme:u.scheduledLightTheme,lightThemeRange:u.lightThemeRange,settings:d,isStudent:(s==null?void 0:s.user_status)==="stud",menu:{value:a,additionalActions:{onAdd:()=>i(t.jsx(q,{enabledList:"leftsideBarRoutes",requiredList:v,remove:B,add:Ie}),"Настройка меню"),onRemoveOne:h=>B(h,l,v)}},theme:{value:e==="dark",action:h=>n(h)},phone:{value:(s==null?void 0:s.phone)??"",description:s==null?void 0:s.phone,action:h=>_e(h??""),additionalActions:{onSuccess:h=>{A.update({key:"phone",value:h})}}},email:{value:(s==null?void 0:s.email)??"",description:rt(s==null?void 0:s.email),action:h=>Oe(h??""),additionalActions:{onSuccess:h=>{A.update({key:"email",value:h})}}},avatar:{value:s==null?void 0:s.avatar,description:"Смена аватара",icon:t.jsx(De,{avatar:s==null?void 0:s.avatar,name:(s==null?void 0:s.fullName)??"",width:"22px",height:"22px",marginRight:"0"})},homepage:{sections:{value:o,additionalActions:{onRemoveOne:h=>N(h,l),onAdd:()=>i(t.jsx(q,{enabledList:"homeRoutes",requiredList:[],remove:N,add:$e}),"Добавить страницы")}},widgets:{schedule:{value:g,action:h=>P.updateSetting({nameSettings:"settings-home-page",nameParam:"widgetSchedule",value:!!h})},payments:{value:m,action:h=>P.updateSetting({nameSettings:"settings-home-page",nameParam:"widgetPayment",value:!!h})}},news:{value:j,action:h=>P.updateSetting({nameSettings:"settings-home-page",nameParam:"news",value:!!h})}}})})},[e,o,g,m,j,Object.keys(a??{}).length,Object.keys(o??{}).length]),r},oe=p.section`
    width: 100%;
...
`,Wt=()=>{const[e,n]=x.useState(""),[s,i]=x.useState(""),[a,o]=x.useState(""),[l,r]=x.useState(null),[c,d]=x.useState(!1),[u,m]=x.useState(!1),{isActive:g,validationError:j}=le(Y,[s,a,e]),v=_t(s),{close:h}=C(),b=()=>{const f=It(12);i(f),o(f)},w=async()=>{try{d(!0);const f=await qe(e,s);if(f.data.result!=="ok")throw new Error(f.data.errors);m(!0),d(!1),i(""),o(""),n("")}catch(f){const y=f.message??f;r("Возникла ошибка: "+y),d(!1)}};return t.jsxs(Ot,{children:[t.jsxs($t,{children:[t.jsxs(Bt,{children:[t.jsx(T,{size:3,align:"left",children:"Смена пароля"}),t.jsx(O,{width:"100%",align:"left",fontSize:"0.9rem",children:"Обязательные требования"}),t.jsx(R,{gap:8,direction:"vertical",children:Y.map(f=>t.jsx(W,{fontSize:"0.85rem",setChecked:()=>null,text:f.text,checked:f.test(s,a,e)},f.text))}),t.jsx(O,{width:"100%",align:"left",fontSize:"0.9rem",children:"Необязательные требования"}),t.jsx(R,{gap:8,direction:"vertical",children:Pt.map(f=>t.jsx(W,{fontSize:"0.85rem",setChecked:()=>null,text:f.text,checked:f.test(s,a,e)},f.text))})]}),!g&&t.jsx(M,{width:"100%",text:"Сгенерировать пароль",onClick:b,background:"var(--theme-2)"}),g&&t.jsxs(Vt,{children:[t.jsx(Ge,{size:"40px"}),t.jsx(T,{size:5,children:"Отличный пароль!"})]})]}),t.jsxs(Dt,{children:[t.jsxs(Ut,{children:[t.jsx(_,{title:"Ошибка",type:"failure",visible:!!l,children:l}),t.jsx(I,{type:"password",title:"Введите старый пароль",placeholder:"Введите пароль",value:e,setValue:n,required:!0}),t.jsx(I,{type:"password",title:"Придумайте пароль",placeholder:"Введите пароль",value:s,setValue:i,required:!0}),t.jsx(I,{type:"password",title:"Повторите пароль",placeholder:"Введите тот же пароль",value:a,setValue:o,required:!0}),t.jsx(zt,{value:v.value,size:"small",title:`Сложность пароля: ${v.title}`})]}),t.jsxs(Nt,{children:[t.jsx(M,{text:"Отменить",width:"100%",onClick:h}),t.jsx(z,{isLoading:c,completed:u,text:"Обновить",popUpFailureMessage:`Требование к паролю: ${j==null?void 0:j.text}`,action:w,setCompleted:m,height:"38px",isActive:g})]})]})]})},Gt=e=>{const{open:n}=C(),s=()=>n(t.jsx(Wt,{}));return t.jsx(L,{...e,onClick:s})},qt=p.div`
    display: flex;
    flex-direction: column;
    gap: 4px;
    position: relative;
...
`,Ht=e=>({toggle:t.jsx(vt,{...e},e.title),photo:t.jsx(bt,{...e},e.title),choices:t.jsx(kt,{...e},e.title),text:t.jsx(H,{...e},e.title),display:t.jsx(St,{...e},e.title),interval:t.jsx(Lt,{...e},e.title),tel:t.jsx(H,{...e},e.title),password:t.jsx(Gt,{...e},e.title),link:t.jsx(jt,{...e},e.title)}),he=({fields:e,settingsName:n,asChild:s=!1})=>{const i=a=>!a||!n?()=>null:o=>{console.log(o),P.updateSetting({nameSettings:n,nameParam:a,value:o})};return t.jsx(qt,{asChild:s,children:e.map(a=>{const o=a.action??i(a.id),{type:l,visible:r=!0}=a;if(r)return Ht({...a,action:o,settingsName:n})[l]})})},Zt=p.div`
    width: 100%;
    height: 100%;
    overflow: hidden;
    flex-direction: column;
