...
`;function ln({width:e,className:i,short:n=!1}){return t.jsx(Lg,{width:e,className:i??"logo",children:t.jsx("img",{src:n?Rg:Ig,alt:"Logo"})})}const zg=p.img``;function ns({loading:e,src:i,height:n,width:s,alt:o=""}){return e?t.jsx(Y,{shape:"rect",size:{width:s,height:n},margin:"0"}):t.jsx(zg,{src:i,alt:o,height:n,width:s})}const Mg=p.div`
    .wrapper {
        position: relative;
        width: ${({size:e})=>e};
        height: ${({size:e})=>e};
...
`,dt=l.forwardRef(function(i,n){const{value:s,setValue:o,leftIcon:a,title:r,required:c,width:d,minWidth:u,customMask:h,placeholder:f="Введите сюда",type:g="text",danger:m,alertMessage:x,loading:b=!1,isActive:y=!0,inputAppearance:$=!0,mask:w=!1,autocomplete:S=!1,minValue:T=void 0,maxValue:R=void 0,maxLength:I=void 0,hideCross:N=!1,stepSize:J=.1,size:L="middle"}=i,{inputType:ne,buttonOnClick:ge,danger:ke,handleOnChange:Re,phoneMaskKeyDown:Ge}=Gg(s,o,g,m,T,R,h,w),ue=s&&g==="date"?Xd(new Date(s),"yyyy-MM-dd"):s??"";return t.jsxs(qg,{leftIcon:!!a,isActive:y,inputAppearance:$,width:d,danger:ke,minWidth:u,size:L,children:[t.jsx(H,{size:5,align:"left",visible:!!r,bottomGap:"5px",required:c,children:r}),t.jsx(Q,{type:"alert",visible:!!x,icon:t.jsx(Kd,{}),title:x??""}),a&&t.jsx("span",{className:"left-icon",children:a}),t.jsx("input",{id:f,min:T,max:R,maxLength:I,step:J??void 0,type:ne,placeholder:f,value:ue,autoComplete:S?"on":"off",onKeyDown:Pe=>g==="tel"&&Ge(Pe),onChange:Re,required:c,readOnly:!y,ref:n}),g!=="password"?!!(s!=null&&s.length)&&$&&(b?t.jsx(Ke,{}):!N&&t.jsx(_,{icon:t.jsx(Xe,{}),onClick:()=>o(""),tabIndex:-1})):t.jsx(_,{icon:ne==="password"?t.jsx(Qd,{}):t.jsx(No,{}),tabIndex:-1,onClick:ge})]})}),Yg=p.div`
    user-select: none;
    min-width: 56px;
    height: 30px;
...
`,Ga=({value:e,width:i,placeholder:n,inputAppearance:s,loading:o,hints:a,leftIcon:r,focusOn:c,setValue:d,customMask:u,onHintClick:h,validationCheck:f=!1,size:g="middle"})=>{const[m,x]=l.useState(0),[b,y]=l.useState(!1),$=l.useRef(null),w=l.useRef(null),S=l.useRef(null);Gt($,()=>y(!1)),l.useEffect(()=>{c&&setTimeout(()=>{var N;return(N=S.current)==null?void 0:N.focus()},50)},[c]);const T=N=>{var J,L;(((a==null?void 0:a.length)??0)>0||o)&&y(!0),N.key==="ArrowDown"?((J=w.current)==null||J.scrollIntoView({block:"start",behavior:"smooth"}),typeof m=="number"&&x(pt(m+1,((a==null?void 0:a.length)??1)-1,0))):N.key==="ArrowUp"?((L=w.current)==null||L.scrollIntoView({block:"end",behavior:"smooth"}),typeof m=="number"&&x(pt(m-1,((a==null?void 0:a.length)??1)-1,0))):N.key==="Enter"?(a!=null&&a[m??0].title&&d(a==null?void 0:a[m??0].title),y(!1),h==null||h(a==null?void 0:a[m??0])):x(0)},R=N=>()=>{x(N),d((a==null?void 0:a[N].title)??""),y(!1),h==null||h(a==null?void 0:a[N])},I=()=>{a!=null&&a.length&&y(!0)};return t.jsxs(df,{width:i,onKeyDown:T,onMouseDown:I,ref:$,children:[t.jsx(dt,{size:g,value:e,placeholder:n,leftIcon:r??t.jsx(zt,{}),inputAppearance:s,setValue:d,loading:o,width:i,mask:!0,customMask:u,ref:S}),t.jsx(Va,{setValue:d,value:e,visible:f}),b&&t.jsx(pf,{height:"fit-content",maxWidth:"100%",maxHeight:"250px",width:"100%",onKeyDown:T,padding:"0",orientation:"vertical",children:a==null?void 0:a.map(({title:N,icon:J},L)=>{const ne=m===L;return t.jsxs(uf,{onClick:R(L),ref:ne?w:null,selected:ne,children:[J&&t.jsx("div",{className:"icon",children:J}),t.jsx("span",{children:N})]},N+L)})})]})},cn=()=>{const[e,i]=l.useState({width:0,height:0}),n=()=>{i({width:window.innerWidth,height:window.innerHeight})};return l.useEffect(()=>(n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}),[]),e},Us={small:"30px",middle:"44px",big:"68px"},qa={small:"8px",middle:"10px",big:"16px"},hf={small:"0.8rem",middle:"0.9rem",big:"1rem"},gf={small:"0.65rem",middle:"0.75rem",big:"0.85rem"},ff=p.div`
...
`,Ye=({text:e,checked:i,setChecked:n,fontSize:s,visible:o=!0,isActive:a=!0,invisibleOnFalse:r=!1})=>{if(!o)return null;const c=()=>{a&&n(!i)};return t.jsxs($f,{checked:i,invisibleOnFalse:r,fontSize:s,isActive:a,className:"checkbox",children:[t.jsx("input",{className:"checkbox",type:"checkbox",checked:i,onChange:c}),t.jsx(Pf,{tabIndex:0,className:"checkbox-square",children:i&&t.jsx(en,{})}),e&&t.jsx("div",{className:"checkbox-text",children:e})]})},Qa=e=>e.split("/")[1],Cf=e=>e*1024*1024,Of=(e,i)=>(i??Bu).indexOf(e.type)!==-1,Ws=(e,i,n,s,o=Hu)=>{if(n&&i.length+e.length>n)return W.evokePopUpMessage({message:`Нельзя загрузить больше ${n} файлов`,type:"failure"}),i;for(let a=0;a<e.length;a++)return Of(e[a],s)?e[a].size>Cf(o)?(W.evokePopUpMessage({message:`Размер файла слишком большой. Максимальный размер файла: ${o} MB`,type:"failure",time:1e4}),i):[...i,e[a]]:(console.log(e[a]),W.evokePopUpMessage({message:`Неверный формат файла. Доступные форматы: ${s==null?void 0:s.map(r=>Qa(r))}`,type:"failure",time:5e3}),i)},Af=p.label`
    width: 100%;
    min-height: 150px;
    border-radius: var(--brLight);
...
`,Kf=()=>t.jsx(Xf,{children:t.jsx(Jf,{})}),we=({oldVersionUrl:e,errorText:i="Страница еще находится в разработке. Если вам она нужна, вернитесь к старому дизайну",buttonText:n="Перейти к старому дизайну",forceForward:s=!1,isRedirectButtonVisible:o=!0})=>(l.useEffect(()=>{s&&(window.location.href=`/old/?p=${e==null?void 0:e.slice(1,e.length)}`)},[]),t.jsx(he,{text:i,children:o&&t.jsx("a",{href:`${z}/?p=${e==null?void 0:e.slice(1,e.length)}`,children:t.jsx(_,{text:n,icon:t.jsx(tn,{}),width:"100%",background:"var(--reallyBlue)",textColor:"#fff",align:"left",padding:"10px"})})})),Qf="modulepreload",Zf=function(e){return"/"+e},Vs={},v=function(i,n,s){if(!n||n.length===0)return i();const o=document.getElementsByTagName("link");return Promise.all(n.map(a=>{if(a=Zf(a),a in Vs)return;Vs[a]=!0;const r=a.endsWith(".css"),c=r?'[rel="stylesheet"]':"";if(!!s)for(let h=o.length-1;h>=0;h--){const f=o[h];if(f.href===a&&(!r||f.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${c}`))return;const u=document.createElement("link");if(u.rel=r?"stylesheet":Qf,r||(u.as="script",u.crossOrigin=""),u.href=a,document.head.appendChild(u),r)return new Promise((h,f)=>{u.addEventListener("load",h),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>i())},ex=l.lazy(()=>v(()=>import("./index-9ec0c651.js"),["assets/index-9ec0c651.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js"])),tx=l.lazy(()=>v(()=>import("./index-aa0d2c86.js"),["assets/index-aa0d2c86.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-e3125ff2.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-ed7a0377.js"])),ix=l.lazy(()=>v(()=>import("./index-a4715370.js"),["assets/index-a4715370.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js"])),nx=l.lazy(()=>v(()=>import("./index-4934a84b.js"),["assets/index-4934a84b.js","assets/vendor-f1fdae2f.js","assets/find-current-in-select-ba4611d5.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>Ob),void 0));const sx=l.lazy(()=>v(()=>import("./index-476abe73.js"),["assets/index-476abe73.js","assets/vendor-f1fdae2f.js","assets/index-5b8f0c27.js"])),ox=l.lazy(()=>v(()=>import("./index-f85020a0.js"),["assets/index-f85020a0.js","assets/vendor-f1fdae2f.js","assets/index-0a8c51cb.js"])),ax=l.lazy(()=>v(()=>import("./index-a1c5b4a6.js"),["assets/index-a1c5b4a6.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),rx=l.lazy(()=>v(()=>import("./index-55cead07.js"),["assets/index-55cead07.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-e3125ff2.js","assets/get-teacher-subdivisions-1b4fd80d.js"])),lx=l.lazy(()=>v(()=>import("./index-d2716663.js"),["assets/index-d2716663.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-e3125ff2.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-ed7a0377.js"])),cx=l.lazy(()=>v(()=>import("./index-febfa18b.js"),["assets/index-febfa18b.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-ed7a0377.js"])),dx=l.lazy(()=>v(()=>import("./index-a587e3c7.js"),["assets/index-a587e3c7.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-e3125ff2.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-ed7a0377.js"])),px=l.lazy(()=>v(()=>import("./index-57d4117c.js"),["assets/index-57d4117c.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/index-ed7a0377.js"])),ux=l.lazy(()=>v(()=>import("./index-51700657.js"),["assets/index-51700657.js","assets/vendor-f1fdae2f.js","assets/ui-603c46ea.js","assets/index-f0b2e6bd.js"])),hx=l.lazy(()=>v(()=>import("./index-d23eeaa8.js"),["assets/index-d23eeaa8.js","assets/vendor-f1fdae2f.js","assets/ui-603c46ea.js"])),gx=l.lazy(()=>v(()=>import("./index-3925d9e9.js"),["assets/index-3925d9e9.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-ed7a0377.js"])),fx=l.lazy(()=>v(()=>import("./index-7a14fda4.js"),["assets/index-7a14fda4.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-e3125ff2.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-ed7a0377.js"])),xx=l.lazy(()=>v(()=>import("./index-fa16b081.js"),["assets/index-fa16b081.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js","assets/index-ed7a0377.js"])),mx=l.lazy(()=>v(()=>import("./index-ae5c2195.js"),["assets/index-ae5c2195.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-ed7a0377.js"])),bx=l.lazy(()=>v(()=>import("./index-58f6f36b.js"),["assets/index-58f6f36b.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-e3125ff2.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/get-last-year-for-period-e1de6b16.js","assets/index-ed7a0377.js"])),yx=l.lazy(()=>v(()=>import("./index-b9954bb9.js"),["assets/index-b9954bb9.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-e3125ff2.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-ed7a0377.js"])),vx=l.lazy(()=>v(()=>import("./index-71c29428.js"),["assets/index-71c29428.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-e3125ff2.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/get-last-year-for-period-e1de6b16.js","assets/index-ed7a0377.js"])),_x=l.lazy(()=>v(()=>import("./index-b5a7cb20.js"),["assets/index-b5a7cb20.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js"])),wx=l.lazy(()=>v(()=>import("./index-d854d273.js"),["assets/index-d854d273.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-ed7a0377.js"])),jx=l.lazy(()=>v(()=>import("./index-3a5b6eae.js"),["assets/index-3a5b6eae.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-ed7a0377.js"])),kx=l.lazy(()=>v(()=>import("./index-360546b1.js"),["assets/index-360546b1.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js","assets/index-ed7a0377.js"])),Sx=l.lazy(()=>v(()=>import("./index-f5477591.js"),["assets/index-f5477591.js","assets/vendor-f1fdae2f.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-e3125ff2.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-ed7a0377.js"])),Tx=l.lazy(()=>v(()=>import("./index-f2890145.js"),["assets/index-f2890145.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ex=l.lazy(()=>v(()=>import("./index-1013e6d0.js"),["assets/index-1013e6d0.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),$x=l.lazy(()=>v(()=>import("./index-4aa9155a.js"),["assets/index-4aa9155a.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Px=l.lazy(()=>v(()=>import("./index-5c40716f.js"),["assets/index-5c40716f.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Cx=l.lazy(()=>v(()=>import("./index-a7791765.js"),["assets/index-a7791765.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ox=l.lazy(()=>v(()=>import("./index-20f61599.js"),["assets/index-20f61599.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ax=l.lazy(()=>v(()=>import("./index-307ea3ff.js"),["assets/index-307ea3ff.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Dx=l.lazy(()=>v(()=>import("./index-5795b1a3.js"),["assets/index-5795b1a3.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Nx=l.lazy(()=>v(()=>import("./index-f95f0383.js"),["assets/index-f95f0383.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ix=l.lazy(()=>v(()=>import("./index-f4001e1b.js"),["assets/index-f4001e1b.js","assets/vendor-f1fdae2f.js","assets/index-ed7a0377.js","assets/index-83fb279b.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-teacher-subdivisions-1b4fd80d.js"])),Rx=l.lazy(()=>v(()=>import("./index-b362e289.js"),["assets/index-b362e289.js","assets/vendor-f1fdae2f.js"]));l.lazy(()=>v(()=>import("./index-955bc1d1.js"),["assets/index-955bc1d1.js","assets/vendor-f1fdae2f.js","assets/index-372f8b25.js","assets/index-f0b2e6bd.js"]));const as=l.lazy(()=>v(()=>import("./index-51891fe3.js"),["assets/index-51891fe3.js","assets/vendor-f1fdae2f.js"])),Lx=l.lazy(()=>v(()=>import("./index-88ed337c.js"),["assets/index-88ed337c.js","assets/vendor-f1fdae2f.js"])),zx=l.lazy(()=>v(()=>import("./index-b90a3789.js"),["assets/index-b90a3789.js","assets/vendor-f1fdae2f.js"])),Mx=l.lazy(()=>v(()=>import("./index-432b702b.js"),["assets/index-432b702b.js","assets/vendor-f1fdae2f.js"])),Fx=l.lazy(()=>v(()=>import("./index-c2026f78.js"),["assets/index-c2026f78.js","assets/vendor-f1fdae2f.js"])),Bx=l.lazy(()=>v(()=>import("./index-38d206a3.js"),["assets/index-38d206a3.js","assets/vendor-f1fdae2f.js"])),Hx=l.lazy(()=>v(()=>import("./index-4cd00c2f.js"),["assets/index-4cd00c2f.js","assets/vendor-f1fdae2f.js","assets/get-default-subdivision-17957fb0.js"])),Ux=l.lazy(()=>v(()=>import("./index-64c3e5a2.js"),["assets/index-64c3e5a2.js","assets/vendor-f1fdae2f.js","assets/get-default-subdivision-17957fb0.js"])),Wx=l.lazy(()=>v(()=>import("./index-4625b001.js"),["assets/index-4625b001.js","assets/vendor-f1fdae2f.js"])),Vx=l.lazy(()=>v(()=>import("./index-f62e58a9.js"),["assets/index-f62e58a9.js","assets/vendor-f1fdae2f.js","assets/send-hr-form-work-transfer-77162d76.js"])),Gx=l.lazy(()=>v(()=>import("./index-c9485377.js"),["assets/index-c9485377.js","assets/vendor-f1fdae2f.js","assets/send-hr-form-work-transfer-77162d76.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>u0),void 0));l.lazy(()=>v(()=>import("./index-64cf30cb.js"),["assets/index-64cf30cb.js","assets/vendor-f1fdae2f.js","assets/BoldText-f34d4292.js","assets/help-links-126b194d.js"]));const qx=l.lazy(()=>v(()=>import("./index-0b8c3961.js"),["assets/index-0b8c3961.js","assets/vendor-f1fdae2f.js"])),tr=l.lazy(()=>v(()=>import("./index-b8a1bbec.js"),["assets/index-b8a1bbec.js","assets/vendor-f1fdae2f.js","assets/index-372f8b25.js","assets/index-f0b2e6bd.js"])),ir=l.lazy(()=>v(()=>import("./index-955bc1d1.js"),["assets/index-955bc1d1.js","assets/vendor-f1fdae2f.js","assets/index-372f8b25.js","assets/index-f0b2e6bd.js"])),Yx=l.lazy(()=>v(()=>import("./index-3b57354e.js"),["assets/index-3b57354e.js","assets/vendor-f1fdae2f.js"]));l.lazy(()=>v(()=>import("./index-b4d0661f.js"),["assets/index-b4d0661f.js","assets/vendor-f1fdae2f.js","assets/index.esm-8a5217b6.js"]));const Jx=l.lazy(()=>v(()=>import("./index-b8124725.js"),["assets/index-b8124725.js","assets/vendor-f1fdae2f.js"])),nr=l.lazy(()=>v(()=>import("./index-5342e9ff.js"),["assets/index-5342e9ff.js","assets/vendor-f1fdae2f.js","assets/help-links-126b194d.js"])),Xx=l.lazy(()=>v(()=>import("./index-f55527b3.js"),["assets/index-f55527b3.js","assets/vendor-f1fdae2f.js"])),Kx=l.lazy(()=>v(()=>import("./index-ced77251.js"),["assets/index-ced77251.js","assets/vendor-f1fdae2f.js","assets/alert-item-c206d771.js","assets/is-valid-url-08a91344.js"])),Qx=l.lazy(()=>v(()=>import("./index-bd2f0457.js"),["assets/index-bd2f0457.js","assets/vendor-f1fdae2f.js","assets/index-1f6d2a25.js","assets/alert-item-c206d771.js","assets/is-valid-url-08a91344.js"])),Zx=l.lazy(()=>v(()=>import("./index-3d652a85.js"),["assets/index-3d652a85.js","assets/vendor-f1fdae2f.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>xy),void 0));const em=l.lazy(()=>v(()=>import("./index-732355cf.js"),["assets/index-732355cf.js","assets/vendor-f1fdae2f.js"])),sr=l.lazy(()=>v(()=>import("./index-a43cfca9.js"),["assets/index-a43cfca9.js","assets/vendor-f1fdae2f.js","assets/index-1f6d2a25.js","assets/index-f0b2e6bd.js"])),tm=l.lazy(()=>v(()=>import("./index-66d1a699.js"),["assets/index-66d1a699.js","assets/vendor-f1fdae2f.js","assets/index-0f59adb8.js"])),im=l.lazy(()=>v(()=>import("./index-a9ed7e17.js"),["assets/index-a9ed7e17.js","assets/vendor-f1fdae2f.js","assets/index-0f59adb8.js"])),nm=l.lazy(()=>v(()=>import("./index-ece20ea9.js"),["assets/index-ece20ea9.js","assets/vendor-f1fdae2f.js","assets/index-0f59adb8.js"])),sm=l.lazy(()=>v(()=>import("./index-6262b6ab.js"),["assets/index-6262b6ab.js","assets/vendor-f1fdae2f.js"])),om=l.lazy(()=>v(()=>import("./index-feda11bc.js"),["assets/index-feda11bc.js","assets/vendor-f1fdae2f.js","assets/index.esm-8a5217b6.js"])),am=l.lazy(()=>v(()=>import("./index-dc60b130.js"),["assets/index-dc60b130.js","assets/vendor-f1fdae2f.js"])),rm=l.lazy(()=>v(()=>import("./index-8e7533a4.js"),["assets/index-8e7533a4.js","assets/vendor-f1fdae2f.js"])),lm=l.lazy(()=>v(()=>import("./index-11d9d7d0.js"),["assets/index-11d9d7d0.js","assets/vendor-f1fdae2f.js"])),cm=l.lazy(()=>v(()=>import("./index-4be9627a.js"),["assets/index-4be9627a.js","assets/vendor-f1fdae2f.js","assets/index-5b8f0c27.js"])),dm=l.lazy(()=>v(()=>import("./index-98360238.js"),["assets/index-98360238.js","assets/vendor-f1fdae2f.js"])),pm=l.lazy(()=>v(()=>import("./index-515745e8.js"),["assets/index-515745e8.js","assets/vendor-f1fdae2f.js","assets/help-links-126b194d.js"])),um=l.lazy(()=>v(()=>import("./index-3a5afc65.js"),["assets/index-3a5afc65.js","assets/vendor-f1fdae2f.js","assets/help-links-126b194d.js"])),hm=l.lazy(()=>v(()=>import("./index-60bdb536.js"),["assets/index-60bdb536.js","assets/vendor-f1fdae2f.js"])),gm=l.lazy(()=>v(()=>import("./index-64cf30cb.js"),["assets/index-64cf30cb.js","assets/vendor-f1fdae2f.js","assets/BoldText-f34d4292.js","assets/help-links-126b194d.js"])),fm=l.lazy(()=>v(()=>import("./index-8dabf84a.js"),["assets/index-8dabf84a.js","assets/vendor-f1fdae2f.js"])),xm=p.div`
    width: 100%;
...
`,un=()=>t.jsx(Q,{type:"info",title:"Информация",icon:t.jsx(Je,{}),children:"Данный сервис позволяет заказать необходимую справку, подать заявление, запрос. Статус (информация о степени готовности) заказанных справок меняется согласно действиям оператора. В колонке «Подразделение, адрес» указывается название подразделения и адрес, куда необходимо приехать за готовым документом."}),lr=()=>{const{data:{listApplication:e},error:i}=ye.useApplications();return t.jsx(We,{load:()=>Fe.getApplicationsFx(),loading:!e,error:i,data:e,children:t.jsx(d0,{children:t.jsxs(pn,{maxWidth:"1500px",children:[t.jsxs(p0,{children:[t.jsx(H,{size:2,align:"left",children:"Заявление на увольнение"}),t.jsx(un,{})]}),t.jsx(l0,{})]})})})},d0=p.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,j0=()=>{const{data:{dataWorkerApplication:e}}=ye.useApplications(),[i,n]=l.useState(!0);return e?t.jsxs(k0,{children:[e.map((s,o)=>s.isDismissal?(i&&n(!1),null):t.jsx(y0,{info:s,index:o})),t.jsx(x0,{})]}):null},k0=p.div`
    ...
    flex-direction: column;
    gap: 30px;
`,S0=()=>{const{data:{listApplication:e},error:i}=ye.useApplications();return t.jsx(We,{load:()=>Fe.getApplicationsFx(),loading:!e,error:i,data:e,children:t.jsx(T0,{children:t.jsxs(pn,{maxWidth:"1500px",children:[t.jsxs(E0,{children:[t.jsx(H,{size:2,align:"left",children:"Заявление на выход в выходной день"}),t.jsx(un,{})]}),t.jsx(j0,{})]})})})},T0=p.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,Y0=()=>{const{data:{dataWorkerApplication:e}}=ye.useApplications(),{data:i}=ds.useBufferHolidayTransfer(),[n,s]=l.useState(!0);return!i||!e?null:t.jsxs(J0,{children:[e.map((o,a)=>o.isDismissal?(n&&s(!1),null):t.jsx(U0,{info:o,index:a,data:i})),t.jsx(F0,{})]})},J0=p.div`
    ...
    flex-direction: column;
    gap: 30px;
`,X0=()=>{const{data:e,loading:i}=ds.useBufferHolidayTransfer();return l.useEffect(()=>{qs.loadBufferHolidayTransfer()},[]),t.jsx(We,{load:qs.loadBufferHolidayTransfer,loading:i,error:null,data:e,children:t.jsx(K0,{children:t.jsxs(pn,{maxWidth:"1500px",children:[t.jsxs(Q0,{children:[t.jsx(H,{size:2,align:"left",children:"Заявление на перенос отпуска"}),t.jsx(un,{}),t.jsxs("p",{children:["График отпусков вы можете посмотреть по"," ",t.jsx("a",{target:"_blank",href:"#/vacation",rel:"noreferrer",children:"ссылке"}),"."]})]}),t.jsx(Y0,{})]})})})},K0=p.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,_b=()=>{const{data:{dataWorkerApplication:e}}=ye.useApplications(),[i,n]=l.useState(!0);return e?t.jsxs(wb,{children:[e.map((s,o)=>s.isDismissal?(i&&n(!1),null):t.jsx(mb,{info:s,index:o})),t.jsx(gb,{})]}):null},wb=p.div`
    ...
    flex-direction: column;
    gap: 30px;
`,jb=()=>{const{data:{listApplication:e},error:i}=ye.useApplications();return t.jsx(We,{load:()=>Fe.getApplicationsFx(),loading:!e,error:i,data:e,children:t.jsx(kb,{children:t.jsxs(pn,{maxWidth:"1500px",children:[t.jsxs(Sb,{children:[t.jsx(H,{size:2,align:"left",children:"Заявление на перевод"}),t.jsx(un,{})]}),t.jsx(_b,{})]})})})},kb=p.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,Bb=({date:e,value:i})=>t.jsxs(Fb,{children:[t.jsxs(P,{gap:"16px",children:[t.jsx(mt,{color:"grey",size:33,children:t.jsx(lt,{})}),t.jsxs(P,{d:"column",ai:"flex-start",children:[t.jsx("span",{className:"payment-item-date",children:"Платеж"}),t.jsx(se,{children:re(e)})]})]}),t.jsxs("span",{className:"payment-item-money",children:["+",i," ",t.jsx(lt,{})," "]})]}),Hb=p.div`
    display: flex;
    align-items: center;
    font-size: ${({fontSize:e})=>e};
...
`,ey=({data:e,isContractSigned:i})=>{const{id:n,signed_user:s,name:o,can_sign:a,date:r}=e,[c,d,u]=wi([st.$done,st.$completed,st.$loading]),h=s||c?140:100,f=()=>Rn.signAgreement(n),g=Rn.setCompleted;return t.jsxs(Qb,{height:h,title:o,confirmed:s||c,children:[t.jsxs(Zb,{children:[t.jsxs(P,{d:"column",ai:"flex-start",gap:"4px",children:[t.jsx(H,{size:5,align:"left",children:o}),t.jsx(se,{children:re(r)})]}),t.jsxs(P,{gap:"8px",w:"100%",jc:"flex-end",children:[t.jsx(Si,{href:e.file,onClick:()=>null,width:"40px",icon:t.jsx(Xn,{}),isActive:!!e.file}),!(s||c)&&t.jsx(St,{text:s||c?"Подписано":"Подписать",action:f,isLoading:u,completed:d,isDone:s||c,width:"160px",setCompleted:g,isActive:!(s||c)&&a,popUpFailureMessage:a?"Согласие уже подписано":i?"Необходимо сначала подписать соглашение об электронном взаимодейтсвии":"Необходимо сначала подписать договор",popUpSuccessMessage:"Согласие успешно подписано"}),t.jsx(Q,{type:"success",title:"Подписано",icon:t.jsx(en,{}),align:"center",width:"130px",visible:s||c})]})]}),(c||s)&&t.jsxs(se,{children:["Дата подписания: ",re(e.signed_user_date||new Date),","," ",e.signed_user_time||`${new Date().getHours()}:${new Date().getMinutes()}`]})]})},ty=({isDormitory:e,electronicAgreements:i=[],isContractSigned:n})=>t.jsxs(Ee,{width:"100%",children:[t.jsx(H,{size:4,align:"left",icon:t.jsx(ap,{}),bottomGap:!0,children:"Доп. соглашения"}),t.jsx(Dr,{}),t.jsx(Q,{type:"info",title:"Информация",visible:!e,children:"Подписание дополнительных соглашений к 3-сторонним договорам в Личном кабинете не предусмотрено"}),i.map((s,o)=>t.jsx(ey,{data:s,isContractSigned:n},o))]}),iy=p.div`
    display: flex;
    justify-content: center;
    align-items: center;
...
`,lv=p.span`
    ...
    font-size: 0.8em;
    font-weight: 500;
`,cv=e=>{var m,x,b;const{id:i,icon:n,title:s,color:o}=e,{settings:a}=Vt.useSettings(),{data:r}=ve.useUser(),c=Be.useMenu(),d=(m=a["settings-home-page"].property.pages)==null?void 0:m.find(y=>y===i),u=(x=a["settings-customize-menu"].property.pages)==null?void 0:x.find(y=>y===i),h=((b=r.user)==null?void 0:b.user_status)==="staff"?sa:sn,f=()=>{Cl(i,a),Ne.close()},g=()=>{ov(i,a,Object.keys(c.leftsideBarRoutes??{}).length??0,h),Ne.close()};return t.jsxs(rv,{children:[t.jsxs("div",{className:"top",children:[t.jsx(mt,{color:o,size:22,children:n}),t.jsx(lv,{children:s})]}),t.jsx(fe,{}),d?t.jsx(_,{text:"Убрать с главной",icon:t.jsx(rt,{}),width:"100%",align:"left",background:"var(--block)",onClick:()=>{Ol(i,a),Ne.close()}}):t.jsx(_,{text:"Добавить на главную",icon:t.jsx(jt,{}),width:"100%",align:"left",background:"var(--block)",onClick:f}),u?t.jsx(_,{text:"Убрать из меню",icon:t.jsx(rt,{}),width:"100%",align:"left",background:"var(--block)",onClick:()=>av(i,a,h)}):t.jsx(_,{text:"Добавить в меню",icon:t.jsx(jt,{}),width:"100%",align:"left",background:"var(--block)",onClick:g})]})},Al=({route:e})=>{var s;const i=j[(s=e==null?void 0:e.color)!=null&&s.length?e.color:"blue"].main,n=o=>{o.preventDefault(),o.stopPropagation(),Ne.open({e:o,height:105,content:t.jsx(cv,{...e})})};return t.jsx(_,{icon:t.jsx(Xo,{}),textColor:i,className:"more-button",background:"transparent",onClick:n})},Dl=(e,i)=>{if(e>=10&&e<=19)return i.fiveToNine;const n=e%10;return n===0?i.zero:n===1?i.one:n>=2&&n<=4?i.twoToFour:i.fiveToNine};function Ji(e,i){return e.length>i?`${e.substr(0,i)}...`:e}const Nl=p(Qe)`
    position: relative;
    cursor: pointer;
    text-decoration: none;
    border-radius: var(--brLight);
...
`,wv=({division:e})=>{const{open:i}=te(),n=()=>{i(t.jsx(vv,{division:e}),"Подразделение")};return t.jsx(_v,{onClick:n,children:t.jsxs(P,{gap:"8px",h:"50px",jc:"space-between",w:"100%",children:[t.jsxs(P,{gap:"8px",children:[t.jsx(ai,{}),t.jsx(se,{fontSize:"1rem",children:e})]}),t.jsx(ht,{})]})})},jv=({divisions:e})=>!e||e.length===0?null:t.jsx(P,{d:"column",gap:"4px",ai:"flex-start",children:e.map(i=>t.jsx(wv,{division:i},i))}),gn=(e,i)=>e.split("/").reduce((o,a)=>{if(a[0]===":"){const r=i[a.slice(1,a.length)];r&&o.push(r)}else o.push(a);return o},[]).join("/"),kv=p.div`
    display: flex;
    flex-direction: column;
    height: 300px;
...
`,so=p(Z)`
    width: 100%;
`,Il=({group:e})=>{const{close:i}=te();return t.jsxs(kv,{children:[t.jsxs(P,{d:"column",gap:"12px",jc:"center",h:"100%",children:[t.jsx(mt,{size:120,color:"lightBlue",children:t.jsx(Qo,{})}),t.jsx(se,{fontSize:"1.2rem",children:e})]}),t.jsxs(P,{gap:"8px",onClick:i,children:[t.jsx(so,{to:gn(Ci,{page:"current",filter:e}),children:t.jsx(_,{icon:t.jsx(Ct,{}),width:"100%",text:"Расписание",background:"var(--theme-4)"})}),t.jsx(so,{to:`${ml}/${e}`,children:t.jsx(_,{icon:t.jsx(Ko,{}),width:"100%",text:"Список",background:"var(--theme-4)"})})]})]})},Sv=p.div`
    width: 100%;
    color: var(--text);
    padding: 0px 16px;
    background: var(--theme-1t);
...
`,Rl=({title:e,children:i,bottomMargin:n,forceState:s=!1})=>{const[o,a]=l.useState(s);l.useEffect(()=>{a(s)},[s]);const r=()=>a(c=>!c);return t.jsxs(Av,{isOpen:o,bottomMargin:n,onClick:r,children:[e&&t.jsx(Dv,{children:e}),t.jsx(Nv,{isOpen:o,children:i})]})},Ll=k(),zl=k(),Iv=X(!1).on(zl,()=>!0).on(Ll,()=>!1),oo={close:Ll,open:zl},Rv={$isModalOpen:Iv},vs=l.createContext({isOpen:!1,component:void 0,back:()=>{},close:()=>{},open:()=>{},title:void 0,canBack:!1}),Lv=({children:e})=>{const[i,n]=l.useState(!1),[s,o]=l.useState([]),[a,r]=l.useState([]),c=wi(Rv.$isModalOpen),d=a.length>1,u=l.useCallback(()=>{d&&(a.pop(),s.pop(),r([...a]),o([...s]))},[a,r]),h=l.useCallback((b,y)=>{b&&(i?(r(()=>[...a,b]),o(()=>[...s,y??""])):(r(()=>[b]),o(y?[y]:[])),n(()=>!0),oo.open())},[r,n,a,i]),f=l.useCallback(()=>{n(()=>!1),oo.close()},[r,n]),g=l.useMemo(()=>a[a.length-1],[a]),m=l.useMemo(()=>s[s.length-1],[s]),x=l.useCallback(b=>{b&&r([...a,b])},[]);return l.useEffect(()=>{c!==i&&n(c)},[c]),t.jsx(vs.Provider,{value:{back:u,open:h,close:f,isOpen:i,canBack:d,component:g,title:m,setComponent:x},children:e})},te=()=>{const{open:e,isOpen:i,...n}=l.useContext(vs);return{open:e,isOpen:i,...n}},zv="2.3.0",Ml=()=>t.jsx(Q,{icon:null,type:"info",title:zv,width:"38px",fontSize:"0.65rem",padding:"7px 0px",align:"center"}),Ce=({color:e,children:i})=>t.jsx(mt,{color:e,children:i}),Mv=()=>({info:t.jsx(Ce,{color:"grey",children:t.jsx(Je,{})}),message:t.jsx(Ce,{color:"red",children:t.jsx(Qn,{})}),alert:t.jsx(Ce,{color:"purple",children:t.jsx(qo,{})}),"payment-dorm":t.jsx(Ce,{color:"green",children:t.jsx(lt,{})}),"payment-ed":t.jsx(Ce,{color:"green",children:t.jsx(lt,{})}),"digital-services":t.jsx(Ce,{color:"red",children:t.jsx(D,{})}),"doc-for-review":t.jsx(Ce,{color:"blue",children:t.jsx(D,{})}),"hr-applications":t.jsx(Ce,{color:"green",children:t.jsx(D,{})}),"kpi-pps":t.jsx(Ce,{color:"pink",children:t.jsx(Ho,{})}),schedule:t.jsx(Ce,{color:"pink",children:t.jsx(Ct,{})}),"version-update":t.jsx(Ml,{}),"electronic-interaction":t.jsx(Ce,{color:"blue",children:t.jsx(Jo,{})})}),Fv=p(Z)`
    width: 100%;
    display: flex;
    align-items: center;
    padding: 4px;
...
`,Bv=p.div`
    font-size: ${({fontSize:e})=>e};
    font-weight: 500;
`,Hv={small:"0.8rem",middle:"0.83rem",large:"0.85rem",big:"0.86rem"},Uv={small:"0.75rem",middle:"0.78rem",large:"0.79rem",big:"0.80rem"},Wv={small:"0px",middle:"1px",large:"2px",big:"3px"},Fl=({id:e,title:i,text:n,time:s,date:o,onClick:a,type:r,pageId:c,goTo:d,onClose:u,bottomMargin:h,closeAnimation:f=!0,loadingRemove:g=!1,canClose:m=!0,fullText:x=!0,maxLetters:b=200,size:y="middle"})=>{const $=re(o,"short"),{close:w}=te(),[S,T]=l.useState(!1),R=N=>{N.stopPropagation(),N.preventDefault(),f?(T(!0),setTimeout(()=>{u==null||u()},300)):u==null||u()},I=()=>{a==null||a(),m&&$t.clearById({id:e,pageId:c}),w()};return t.jsx(Rl,{forceState:!S,bottomMargin:h,children:t.jsxs(Fv,{to:d??"",onClick:I,children:[t.jsx("span",{className:"left-icon",children:Mv()[r]}),t.jsxs("div",{className:"content",children:[t.jsx(se,{fontSize:"0.7rem",children:t.jsx(De,{words:[$??"",s??""]})}),t.jsxs(P,{d:"column",gap:Wv[y],ai:"flex-start",children:[t.jsx(Bv,{fontSize:Hv[y],children:x?i:Ji(i,b)}),t.jsx(se,{fontSize:Uv[y],children:x?n:Ji(n,b)})]})]}),u&&t.jsx(_,{isActive:!(g&&S),icon:t.jsx(Xe,{}),background:"var(--theme-2)",onClick:R,style:{borderRadius:"20px"}})]})})},Bl=({notifications:e,loadingRemove:i})=>{if(!e||e.length===0)return null;const n=(o,a,r)=>()=>{$t.clearById({id:o,pageId:a}),r==null||r()},s=o=>o.canClose!==!1?n(o.id,o.pageId,o.onClose):void 0;return t.jsx(P,{d:"column",children:e.map((o,a)=>l.createElement(Fl,{size:"big",loadingRemove:i,bottomMargin:a!==e.length-1,...o,key:o.id,onClose:s(o)}))})},Xi=e=>Array.isArray(e)?e==null?void 0:e.length:Object.keys(e??{}).length,ao=({people:e,type:i})=>!e||e.length===0?null:t.jsx(P,{d:"column",children:e.map(n=>l.createElement(ws,{name:n.fio,type:i,...n,key:n.id}))}),Vv=()=>{const{allRoutes:e}=Be.useMenu(),{notifications:i,removeNotificationLoading:n}=tt.useLkNotifications(),{data:{user:s}}=ve.useUser(),o=(s==null?void 0:s.user_status)==="staff",a=l.useMemo(()=>$v.flatMap(({visible:I,content:N})=>I==="staff"&&o||I==="student"&&!o||I==="all"?N:[]),[o]),[r,c]=l.useState(null),[d,u]=l.useState(null),[h,f]=l.useState(null),[g,m]=l.useState(null),[x,b]=l.useState(null),[y,$]=l.useState(null),[w,S]=l.useState(null),T=[{title:"Разделы",content:t.jsx(xv,{pages:x,showNotFound:!1}),clear:()=>{b(null)},search:I=>{if(e){const N=mv(I,e);b(N)}},data:x},{title:"Студенты",content:t.jsx(ao,{people:g,type:"stud"}),data:g,clear:()=>{m(null)},search:async I=>{const{data:N}=await Ph(I,"",1,20);m(N.items)}},{title:"Сотрудники",content:t.jsx(ao,{people:h,type:"staff"}),data:h,clear:()=>{f(null)},search:async I=>{const{data:N}=await Sh(I,"",1,20);f(N.items)}},{title:"Группы",content:t.jsx(Ev,{groups:r}),data:r,clear:()=>{c(null)},search:async I=>{const{data:N}=await Ch(I);c(N.items)}},{title:"Подразделения",content:t.jsx(jv,{divisions:d}),data:d,clear:()=>{u(null)},search:async I=>{const{data:N}=await Th(I);u(N.items)}},{title:"Уведомления",content:t.jsx(Bl,{notifications:y,loadingRemove:n}),clear:()=>{$(null)},search:I=>{const N=i.filter(J=>be(J.title).includes(I));$(N)},data:y},{title:"Полезная информация",content:t.jsx(Ov,{blocks:w,isStaff:o}),clear:()=>{S(null)},search:I=>{const N=Pv(I,a);S(N)},data:w}];return[(()=>{const{content:I,clear:N,data:J}=T.reduce((L,ne)=>(Xi(ne.data)&&(L.data.push(ne.data),L.content.push(t.jsxs(t.Fragment,{children:[t.jsx(H,{size:4,align:"left",children:ne.title}),ne.content,t.jsx(fe,{})]}))),L.clear.push(ne.clear),L),{content:[],clear:[],data:[]});return{title:"Все",content:I,clear:()=>N.map(L=>L()),search:async L=>{L.length<=8&&/\d|[-]/g.test(L)?await T[3].search(L):(T[0].search(L),T[5].search(L),T[6].search(L),Xi(T[0].data)===0&&(await T[1].search(L),await T[2].search(L),await T[4].search(L)))},data:J}})(),...T]},Gv=()=>JSON.parse(localStorage.getItem(B.SearchHistory)??"[]"),qv=()=>{const e=Vv(),[i,n]=l.useState(0),[s,o]=l.useState(""),a=l.useMemo(()=>Gv(),[]),r=async g=>{e[i].clear();const m=Wa(g)?Ua(g):g;await e[i].search(m),m.length>0&&!a.includes(m)&&(a.unshift(m),a.length>8&&a.pop(),localStorage.setItem(B.SearchHistory,JSON.stringify(a)))},[c,d,u]=Ya({onDebounce:r,delay:400,defaultValue:"",deps:[i.toString()],triggerDelay:200,triggerOn:g=>(o(g),g.length>0&&(s!==g||!e[i].data))}),h=!u&&!c.length,f=!!c.length&&!u&&!!Xi(e[i].data);return{showMessage:h,showSearchResult:f,searchValue:c,setSearchValue:d,currentPage:i,setCurrentPage:n,config:e,loading:u,searchHistory:a}},Yv=(e,i,n)=>i.length===0?n.map(s=>({id:s,title:s,value:s,icon:t.jsx(Ds,{})})):e?n.filter(s=>be(s).includes(be(i))).map(s=>({id:s,title:s,value:s,icon:t.jsx(Ds,{})})):[],Jv=()=>t.jsxs(P,{gap:"8px",ai:"flex-start",children:[t.jsx(Y,{shape:"circle",size:{width:"40px",height:"40px"},margin:"0"}),t.jsxs(P,{gap:"6px",d:"column",ai:"flex-start",jc:"center",h:"100%",children:[t.jsx(Y,{shape:"rect",size:{width:"300px",height:"13px"},margin:"0"}),t.jsx(Y,{shape:"rect",size:{width:"220px",height:"10px"},margin:"0"})]})]}),Xv=p.div`
    @media (max-width: 1000px) {
        height: 600px;
    }
...
`;function Oi({selected:e,name:i,avatar:n,width:s,height:o,marginRight:a,notifications:r,checked:c,boxShadow:d,border:u,icon:h,avatarModal:f,onClick:g,borderRadius:m,background:x}){const[b,y]=l.useState(!0),$=Hn(i)[0]+(Hn(i)[1]??""),{open:w}=te(),S=T=>{f?w(t.jsx(Oi,{name:i,width:"400px",height:"400px",marginRight:"0",avatar:n})):g==null||g(T)};return t.jsxs(i1,{selected:e,width:s,height:o,marginRight:a,background:x??Ae(i),boxShadow:d,border:u,onClick:S,borderRadius:m,children:[n&&b?t.jsx(n1,{loading:"lazy",round:!0,onLoadedData:()=>y(!0),onError:()=>y(!1),src:n}):t.jsx("div",{className:"name",children:$}),h&&t.jsx("span",{className:"icon",children:h}),t.jsx(Ye,{invisibleOnFalse:!0,checked:c??!1,visible:c!==void 0,setChecked:()=>null}),t.jsx(Tt,{left:"80%",top:"90%",outline:"4px solid var(--block)",visible:!!r,children:r})]})}const OT=p.header`
    width: 100%;
    /* max-width: 750px; */
    padding-top: 100px;
    position: relative;
...
`,p1=({maxNotificationsVisible:e})=>{const{error:i,loading:n,notifications:s,removeNotificationError:o,removeNotificationLoading:a}=tt.useLkNotifications();return l.useEffect(()=>{o&&W.evokePopUpMessage({type:"failure",message:o,time:1e4})},[o]),l.useEffect(()=>{$t.clearAllVisible()},[]),t.jsxs(d1,{children:[s.length===0&&!n&&t.jsx(Ts,{height:"100%",children:t.jsx(he,{text:i??"Нет новых уведомлений",image:i?t.jsx(rt,{}):t.jsx(Cp,{}),size:"70px"})}),t.jsxs(P,{d:"column",gap:"16px",children:[t.jsx(Q,{lineHeight:"1.2rem",type:"tip",visible:s.length!==0,children:"Вы можете отключить получение каких-либо уведомлений в настройках"}),t.jsx(Bl,{notifications:e?s.slice(0,e):s,loadingRemove:a})]}),n&&t.jsx(c1,{quantity:10})]})},u1=p.div`
    position: relative;
    min-width: 40px;
    height: 40px;
    display: flex;
...
`,Wl=()=>{const{close:e}=te(),{notifications:i}=tt.useLkNotifications(),n=3;return t.jsxs(P,{d:"column",gap:"30px",w:"100%",mw:"400px",children:[t.jsxs(P,{d:"column",gap:"16px",children:[t.jsx(p1,{maxNotificationsVisible:n}),t.jsxs(se,{width:"100%",visible:i.length>n,children:["Еще ",i.length-n," ",Dl(i.length-n,{one:"уведомление",twoToFour:"уведомления",fiveToNine:"уведомлений",zero:"уведомлений"}),"..."]})]}),i.length>0&&t.jsx(Z,{to:Sl,style:{width:"100%"},children:t.jsx(_,{width:"100%",text:"Показать все",onClick:e})})]})},h1=()=>{const{notifications:e}=tt.useLkNotifications(),{open:i}=te(),n=()=>{i(t.jsx(Wl,{}),"Уведомления")};return t.jsxs(u1,{onClick:n,children:[t.jsx(Tt,{outline:"none","box-shadow":"0px 0px 0px 3px var(--block)",color:"red",top:"14px",left:"30px",visible:e.length>0,pulsing:!0,className:"notification-circle",shadow:!0,children:e.length>10?"10+":e.length}),t.jsx(nn,{})]})},g1=p.div`
    position: relative;
`,Vl=()=>{const{open:e}=te(),{notifications:i}=tt.useLkNotifications(),n=()=>Ne.close(),s=()=>{nt.evokeConfirm({message:"Вы точно хотите выйти из аккаунта?",onConfirm:Pt.logout}),n()},o=()=>{Ne.close(),e(t.jsx(_c,{}),"Что нового")},a=()=>{e(t.jsx(Wl,{}),"Уведомления"),Ne.close()};return t.jsxs(t.Fragment,{children:[t.jsx(Iw,{padding:"8px",size:"small"}),t.jsx(fe,{}),t.jsx(Ul,{type:"h-button"}),t.jsx(fe,{}),t.jsx(Z,{to:ms,children:t.jsx(_,{text:"Профиль",background:"var(--block)",icon:t.jsx(Yo,{}),width:"100%",align:"left",onClick:n,padding:"10px"})}),t.jsxs(g1,{children:[t.jsx(_,{onClick:a,icon:t.jsx(nn,{}),text:"Уведомления",width:"100%",background:"var(--block)",align:"left",padding:"10px"}),t.jsx(Tt,{visible:i.length>0,top:"50%",right:"0px",pulsing:!0,shadow:!0,children:i.length})]}),t.jsx(Z,{to:me,children:t.jsx(_,{text:"Настройки",background:"var(--block)",icon:t.jsx(Go,{}),width:"100%",align:"left",onClick:n,padding:"10px"})}),t.jsx("a",{href:`${z}/index.php`,children:t.jsx(_,{text:"Старый дизайн",icon:t.jsx(tn,{}),width:"100%",background:"var(--block)",align:"left",padding:"10px"})}),t.jsx(fe,{}),t.jsx(_,{align:"left",icon:t.jsx(Op,{}),onClick:s,text:"Выйти",width:"100%",background:"var(--block)",padding:"10px"}),t.jsx(fe,{}),t.jsx(_,{align:"left",icon:t.jsx(Ml,{}),onClick:o,text:"Что нового",width:"100%",background:"var(--block)",padding:"10px"})]})},f1=p.div`
    padding: 4px;
    border-radius: var(--brLight);
    display: flex;
    align-items: center;
...
`;const L1=()=>{const{leftsideBarRoutes:e}=Be.useMenu(),i=Ht();return e?t.jsx(A1,{children:Object.values(e).filter(n=>n!==void 0).map(n=>l.createElement(Gl,{...n,key:n==null?void 0:n.id,isCurrent:i.pathname.includes(n.path)}))}):t.jsxs(P,{d:"column",children:[t.jsxs(P,{gap:"8px",children:[t.jsx(Y,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(Y,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs(P,{gap:"8px",children:[t.jsx(Y,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(Y,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs(P,{gap:"8px",children:[t.jsx(Y,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(Y,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs(P,{gap:"8px",children:[t.jsx(Y,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(Y,{shape:"rect",size:{width:"160px",height:"18px"}})]})]})},z1=le.memo(L1),M1=()=>{const{isOpen:e}=Be.useMenu(),{width:i,height:n}=cn(),{data:{user:s}}=ve.useUser(),{visibleRoutes:o}=Be.useMenu(),a=Ht();return t.jsxs(O1,{isOpen:e,height:n,children:[t.jsxs("div",{className:"top-wrapper",children:[t.jsx(Z,{to:xs,children:t.jsx(ln,{width:"165px"})}),t.jsx($1,{notifications:o==null?void 0:o.profile.notifications,avatar:s==null?void 0:s.avatar,name:(s==null?void 0:s.fullName)??"",loading:!s,selected:a.pathname==="/profile"}),t.jsx(Hl,{size:"small"}),t.jsx(z1,{})]}),t.jsx(Ul,{type:"toggle"}),i<1e3&&t.jsx(I1,{})]})},F1=p.div`
    width: 300px;
    position: absolute;
...
`,Y1=()=>{const{isOpen:e,message:i,onConfirm:n,onReject:s}=Sa.useConfirm(),o=l.useRef(null);Gt(o,()=>nt.closeConfirm());const a=()=>{n(),nt.closeConfirm()},r=()=>{nt.closeConfirm()};return t.jsx(fn,{isOpen:e,children:t.jsxs(q1,{isOpen:e,ref:o,children:[t.jsx(H,{size:3,align:"left",children:i??"Хотите продолжить?"}),t.jsxs(Ee,{width:"100%",scroll:!1,direction:"horizontal",gap:5,padding:"10px 0 0 0",horizontalAlign:"right",children:[t.jsx(_,{text:"Да",onClick:a,width:"90px",textColor:j.red.main,background:"transparent",hoverBackground:j.red.transparent3}),t.jsx(_,{text:"Нет",onClick:s??r,width:"90px",textColor:j.blue.main,background:"transparent",hoverBackground:j.blue.transparent3})]})]})})},J1=p.div`
    display: flex;
...
`,ws=e=>{const{open:i}=te(),{type:n,avatar:s,name:o,checked:a,onClick:r,indexNumber:c,division:d,group:u,isMe:h=!1,loading:f=!1,orientation:g="horizontal",size:m="middle"}=e,x=ql(h,n,d,u);if(f)return t.jsx(s_,{});const b=y=>{r?r(y):h||(Ne.close(),i(n==="staff"?t.jsx(a_,{...e}):t.jsx(o_,{...e})))};return t.jsxs(r_,{orientation:g,size:m,onClick:b,children:[c&&t.jsx("div",{className:"index",children:c}),t.jsx(Oi,{name:o,avatar:s,width:lo(g,m),height:lo(g,m),marginRight:g==="horizontal"?"7px":"0px",checked:a}),t.jsxs("div",{className:"name-and-status",children:[t.jsx("span",{className:"name",children:o}),t.jsx("span",{className:"status",children:t.jsx(De,{words:x})})]})]})},Ki=e=>{const i=be(e),s=[{keys:["распознаван"],icon:t.jsx(Dp,{})},{keys:["принт"],icon:t.jsx(Np,{})},{keys:["химич"],icon:t.jsx(Ip,{})},{keys:["сервер"],icon:t.jsx(Rp,{})},{keys:["игр"],icon:t.jsx(Lp,{})},{keys:["жизнед"],icon:t.jsx(zp,{})},{keys:["web","веб"],icon:t.jsx(Mp,{})},{keys:["истор"],icon:t.jsx(Fp,{})},{keys:["информат"],icon:t.jsx(Bp,{})},{keys:["информации"],icon:t.jsx(Je,{})},{keys:["мобильн"],icon:t.jsx(Hp,{})},{keys:["безопасн"],icon:t.jsx(Up,{})},{keys:["автоматиз"],icon:t.jsx(Wp,{})},{keys:["линейн"],icon:t.jsx(Vp,{})},{keys:["обработ"],icon:t.jsx(Gp,{})},{keys:["презентац"],icon:t.jsx(qp,{})},{keys:["операционн"],icon:t.jsx(Zo,{})},{keys:["эконом"],icon:t.jsx(lt,{})},{keys:["информацион","программир","сайт"],icon:t.jsx(Yp,{})},{keys:["анализ"],icon:t.jsx(Jp,{})},{keys:["компьют","алгоритм","электрон"],icon:t.jsx(Xp,{})},{keys:["сети","сетей"],icon:t.jsx(Kp,{})},{keys:["матем"],icon:t.jsx(Qp,{})},{keys:["вероятн"],icon:t.jsx(Zp,{})},{keys:["философ"],icon:t.jsx(ea,{})},{keys:["данны"],icon:t.jsx(eu,{})},{keys:["язык"],icon:t.jsx(tu,{})},{keys:["спорт","физичес"],icon:t.jsx(iu,{})},{keys:["проектная"],icon:t.jsx(Pn,{})},{keys:["интеллект"],icon:t.jsx(nu,{})},{keys:["научн"],icon:t.jsx(su,{})},{keys:["предприним"],icon:t.jsx(ou,{})},{keys:["коммуникац"],icon:t.jsx(au,{})},{keys:["управлени"],icon:t.jsx(Zn,{})},{keys:["вкр","итоговая","аттестация"],icon:t.jsx(Wo,{})},{keys:["переработ"],icon:t.jsx(ru,{})},{keys:["машин","инжен"],icon:t.jsx(lu,{})},{keys:["проектир","расчет"],icon:t.jsx(cu,{})},{keys:["производ"],icon:t.jsx(zo,{})},{keys:["эколог"],icon:t.jsx(du,{})},{keys:["защит"],icon:t.jsx(pu,{})},{keys:["патент"],icon:t.jsx(uu,{})},{keys:["материал"],icon:t.jsx(hu,{})},{keys:["физик"],icon:t.jsx(gu,{})},{keys:["тайм"],icon:t.jsx(fu,{})},{keys:["практика"],icon:t.jsx(ta,{})}].find(o=>o.keys.find(a=>i.includes(a)));return s?s.icon:t.jsx(Ap,{})},Un={"9:00 - 10:30":j.green,"10:40 - 12:10":j.lightGreen,"12:20 - 13:50":j.blue,"14:30 - 16:00":j.purple,"16:10 - 17:40":j.pink,"17:50 - 19:20":j.red,"18:20 - 19:40":j.orange,"19:30 - 21:00":j.orange,"19:50 - 21:10":j.orange},Xl=({deps:e,getScrollTopValue:i,condition:n=!0})=>{const s=l.useRef(null);return l.useLayoutEffect(()=>{if(s.current&&n){const o=i(s.current);s.current.scrollTop=o}},[s,...e??[]]),s},l_=p.div`
...
`,j_=({subjectName:e,color:i,noPadding:n})=>{const s=Ki(e),{theme:o}=xt(),a=o==="light"?i.dark3:i.light3,r=o==="light"?i.light3:i.dark3,c=o==="light"?i.light3:i.dark3;return t.jsxs(w_,{noPadding:n,textColor:a,iconBackground:c,children:[t.jsx(__,{noPadding:n,icon:s,background:r}),t.jsx(mt,{color:i.main,size:70,borderRadius:"19px",children:s})]})},k_=xu`
	* {
		margin: 0;
		padding: 0;
		box-sizing: border-box;
...
`,sw=p(P)`
    ...
    margin-left: 0px;
    margin-right: 0px;
`,ow=e=>{const{title:i,duration:n,icon:s,startTime:o,place:a,people:r,shift:c,color:d,scale:u,onClick:h,link:f,rooms:g,dateInterval:m,leftShift:x,quantity:b,groups:y,isCurrentEvent:$=!1,nameInOneRow:w=!0,isNextEvent:S=!1,listView:T=!1,shortInfo:R=!1}=e,{theme:I}=xt(),{isMobile:N}=Xt(),J=I==="light"?d.dark3:d.light3,L=I==="light"?d.transparent1:d.transparent2,ne=()=>h(e),ge=(N||b>1)&&R,ke=N&&b>=2&&R,Re=r==null?void 0:r.map(Le=>{var Di,Ni;const Zt=Le.split(" ");return`${Zt[0]??""} ${((Di=Zt[1])==null?void 0:Di[0])??""}.${((Ni=Zt[2])==null?void 0:Ni[0])??""}.`}),Ge=yc(o,c,u),ue=Ql(i),Pe=ke?i.split(" ").map(Le=>Le[0].toUpperCase()):Ji(ue.name,R?ge?43:35:w?300:64),Ai=(y==null?void 0:y.split(","))??[];return t.jsxs(ew,{background:L,textColor:J,listView:T,leftShift:100*x,quantity:100/b,duration:n,scale:u,top:Ge,onClick:ne,shortInfo:R,children:[t.jsx(nw,{children:s}),t.jsx(P,{className:"event-body",gap:"0px",ai:"flex-start",children:t.jsxs(tw,{scale:u,d:"column",ai:"flex-start",shortInfo:R,children:[t.jsxs(P,{d:"column",gap:"2px",children:[!R&&t.jsxs(P,{gap:"8px",children:[t.jsx(Zl,{timeInterval:xc(o,n),color:d,isCurrentEvent:$}),t.jsx(ec,{timeLeft:xn(o,"minutes"),isNext:S,color:d,isCurrentEvent:$}),!!(g!=null&&g.length)&&t.jsx($e,{shortInfo:R,icon:N&&b>1?void 0:t.jsx(Cn,{}),text:t.jsx(De,{words:g})}),(!!f||ue.link)&&t.jsx("a",{href:f??ue.link,target:"_blank",rel:"noreferrer",children:t.jsx($e,{shortInfo:R,icon:t.jsx(Wi,{}),text:f?a:"Cсылка"})}),!!Ai.length&&t.jsx($e,{icon:t.jsx(Zn,{}),text:t.jsx(De,{words:Ai})})]}),t.jsx(iw,{listView:T,nameInOneRow:w,scale:u,shortInfo:R,children:Pe})]}),!!r.length&&!ge&&t.jsx($e,{shortInfo:R,text:t.jsx(De,{words:R?[Re[0]]:Re}),icon:t.jsx(bu,{})}),!!(g!=null&&g.length)&&R&&!ge&&t.jsx($e,{shortInfo:R,icon:t.jsx(Cn,{}),text:t.jsx(De,{words:g})}),!!f&&R&&!ge&&t.jsx("a",{href:f,target:"_blank",rel:"noreferrer",children:t.jsx($e,{shortInfo:R,icon:t.jsx(Wi,{}),text:a})}),!!m&&!ge&&t.jsx(P,{gap:"5px",children:t.jsx($e,{shortInfo:R,icon:t.jsx(Kn,{}),text:m})})]})})]})},aw=e=>{const i={};if(!e)return i;for(let n=0;n<e.length;n++){const s=e[n];i[s.startTime]||(i[s.startTime]=[]),s.startTime==="18:20"?(i["17:50"]||(i["17:50"]=[]),i["17:50"].push(s)):s.startTime==="19:50"&&i["19:30"]?(i["19:30"]||(i["19:30"]=[]),i["19:30"].push(s)):s.startTime==="19:30"&&i["19:50"]?(i["19:50"]||(i["19:50"]=[]),i["19:50"].push(s)):i[s.startTime].push(s)}return i},rw=({events:e,shift:i,scale:n,shortInfo:s,weekDay:o,interval:a,showTime:r,onClick:c,currentDay:d,isCurrentDay:u})=>{const h=aw(e),f=u??new Date().getDay()===o,g=d!==void 0?d+1===o:void 0;return t.jsxs(sw,{h:"100%",d:"column",children:[f&&t.jsx(m_,{isVisible:g,showTime:r,scale:n,shift:i,interval:a}),Object.keys(h).map((m,x)=>h[m].map((b,y)=>l.createElement(ow,{leftShift:y,quantity:h[m].length,scale:n,isCurrentEvent:ks(b,f),isNextEvent:Kl(e,b,f),...b,onClick:c,shift:i,key:b.startTime+b.title+x+y,shortInfo:s})))]})},lw=p(P)`
    position: absolute;
    left: 0;
    z-index: 0;
...
`,dj=({title:e,visible:i})=>i?t.jsx(cj,{children:t.jsx("span",{className:"title",children:e})}):null,vo=e=>{const{value:i,required:n,width:s,indexI:o,indexJ:a,type:r,suggestions:c,items:d,title:u,documents:h,changeInputArea:f,setData:g,mask:m,editable:x,placeholder:b,autocomplete:y,isSpecificRadio:$,specialType:w,specialFieldsNameConfig:S,minValueInput:T,maxValueInput:R,maxValueLength:I,diff:N,visible:J=!0,onChange:L,onKeyPress:ne,onBlur:ge,onKeyDown:ke,onKeyUp:Re,onFocus:Ge}=e,ue=x??(f&&!h),[Pe,Ai]=l.useState(!0),Le=(G,de,At)=>{L==null||L(G),g(_e=>(Array.isArray(_e.data[0])?_e.data[de][At??0].value=G:_e.data[de].type==="checkbox-docs"?_e.data[de].items[At??0].value=!!G:_e.data[de].value=G,{..._e}))},Zt=(G,de,At)=>{L==null||L(G),g(_e=>(Array.isArray(_e.data[0])?_e.data[de][At??0].value=G:_e.data[de].value=G,{..._e}))},Os=(G,de,At)=>{g(_e=>(_e.data[de].items[At??0].files=G,{..._e}))},Di=G=>{L==null||L(G),g(de=>(de.data[o].value=G,{...de}))},Ni=G=>{L==null||L(G),ne==null||ne(G),ge==null||ge(G),ke==null||ke(G),Re==null||Re(G),Ge==null||Ge(G),g(de=>(de.data[o].value=G,{...de}))};return S&&w&&!Object.values(S).includes(w)?null:r!=="select"&&r!=="multiselect"||!d?r==="checkbox"?t.jsx(Ye,{text:u,isActive:ue,checked:i,setChecked:G=>Le(G,o,a)}):r==="hr-checkbox"?t.jsx(ij,{text:u,isActive:ue,checked:i,setChecked:G=>Le(G,o,a)}):r==="auto-complete-input"?t.jsx(lj,{title:u,suggestions:c??[],required:n,value:i,placeholder:b??u,setValue:G=>Le(G,o,a)}):r==="textarea"?t.jsx(Bg,{value:i,title:u,setValue:G=>Le(G,o,a),isActive:ue,textAreaAppearance:ue,placeholder:b??u,required:n,width:s}):r==="checkbox-docs"?t.jsx(Kw,{title:u,items:d,setChecked:(G,de)=>Le(!G,o,de),setFiles:(G,de)=>Os(G,o,de)}):r==="date-interval"?J?t.jsx(er,{title:u,required:n,dates:i,setDates:G=>Ni(G),valid:Pe,setValid:Ai,minValue:T,diff:N}):null:r==="simple-text"?t.jsx(ej,{title:u,value:i,visible:J}):r==="text-warning"?t.jsx(dj,{title:u,visible:J}):r==="text-header"?t.jsx(sj,{title:u,visible:J}):r==="radio"?t.jsx(Qw,{buttons:d,title:u,required:n,current:i,setCurrent:Di,isSpecificRadio:$}):J?t.jsx(dt,{value:i,title:u,minValue:T,maxValue:R,maxLength:I,setValue:G=>Le(G,o,a),type:r,isActive:ue,inputAppearance:ue,placeholder:b??u,required:n,mask:m,width:s,autocomplete:y}):null:J?t.jsx(or,{items:d,setSelected:G=>Zt(G,o,a),selected:i,isActive:ue,title:u,width:s,multiple:r==="multiselect",required:n}):null},pj=p.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    user-select: none;
...
`,LS=()=>{const{open:e,content:i,position:n}=rf.useContextMenu(),s=l.useRef(null);return Gt(s,()=>Ne.close()),t.jsx(fn,{isOpen:e,children:t.jsx(RS,{isVisible:e,ref:s,left:n.x,top:n.y,onClick:o=>{o.stopPropagation()},children:i})})},Yd=200,zS=5e3,MS=()=>{const{visibleNotifications:e}=tt.useLkNotifications(),[i,n]=l.useState(null),s=l.useRef(),o=a=>(s.current=void 0,()=>{n(a),setTimeout(()=>{$t.clearVisibleById(a)},Yd)});return l.useEffect(()=>{var a,r;e.length&&s.current===void 0&&(s.current=setTimeout(o((a=e[0])==null?void 0:a.id),((r=e[0])==null?void 0:r.duration)??zS))},[e]),{handleClose:o,closing:i}},FS=p.div`
    position: absolute;
    width: 320px;
    max-width: 500px;
    bottom: 10px;
...
`,US=({loading:e})=>{const{data:{user:i},error:n}=ve.useUser(),s=i?Ae(i==null?void 0:i.fullName):j.blue.main,o=()=>jS.getUserFx(JSON.parse(localStorage.getItem(B.Token)??"")),a=()=>Pt.logout();return n?t.jsx(Ao,{$loading:!0,color:s,children:t.jsx(he,{text:n,children:t.jsxs(P,{d:"column",gap:"8px",children:[t.jsx(_,{onClick:o,text:"Попробовать снова",icon:t.jsx(Jn,{}),width:"200px"}),t.jsx(_,{onClick:a,textColor:"var(--theme-mild-opposite)",text:"Выйти",width:"200px",background:"var(--theme)"})]})})}):t.jsxs(Ao,{color:s,$loading:e,children:[t.jsx(ln,{short:!0,width:"100px"}),e&&t.jsx(Ke,{})]})},WS=p.div`
    width: 100%;
    height: 5px;
    background: var(--almostTransparentOpposite);
    border-radius: 10px;
...
`,VS=({filled:e,playing:i,isLast:n,onClose:s})=>{const{currentPage:o}=Ss.useStory();return t.jsx(WS,{filled:e,playing:i,children:t.jsx("div",{className:"inner-line",onAnimationEnd:()=>n?s():vt.changeCurrentPage({value:o+1})})})},GS=p(rn)`
    position: absolute;
    top: 30px;
    left: 0;
    padding: 0px 30px;
...
`,aT=()=>{const{data:{user:e}}=ve.useUser(),i=l.useRef(null),{allRoutes:n}=Be.useMenu(),{currentPage:s}=iT(),[o,a]=l.useState(!1),r=c=>{a(c.currentTarget.scrollTop>0)};return qd(i.current),t.jsxs(nT,{children:[t.jsx(US,{loading:!e||!n}),t.jsx(ZS,{}),t.jsx(M1,{}),t.jsxs(sT,{children:[t.jsx(S1,{headerVisible:o,currentPage:s}),t.jsx(oT,{ref:i,onScroll:r,withHeader:!(s!=null&&s.withoutHeader),children:t.jsx(Bd,{children:t.jsx(l.Suspense,{fallback:null,children:t.jsx(IS,{})})})}),t.jsx(Sw,{})]}),t.jsx(G1,{}),t.jsx(B1,{}),t.jsx(Y1,{}),t.jsx(LS,{}),t.jsx(Aw,{}),t.jsx(HS,{})]})},rT=le.memo(aT),lT=()=>{const{data:{isAuthenticated:e,user:i}}=ve.useUser(),{data:n}=ct.selectors.useData(),{settings:s}=Vt.useSettings();return qd(window),l.useEffect(()=>{window.location.href==="https://e.mospolytech.ru/?p=children#/home"&&window.location.replace("https://e.mospolytech.ru/old/index.php?p=children")},[window.location.href]),l.useEffect(()=>{e&&(Fe.getUserDataApplicationsFx(),(i==null?void 0:i.user_status)==="staff"&&(ct.effects.getFx(),Fe.getWorkerPosts(),Wd()),DS.load())},[e,i]),l.useEffect(()=>{i&&(s?et.defineMenu({user:i,adminLinks:n,homeRoutes:s["settings-home-page"].property.pages}):fg.getLocalSettingsFx(i.id))},[i,n,s]),e?t.jsx(rT,{}):t.jsx(l.Suspense,{fallback:null,children:t.jsxs(ia,{children:[nv.map(({path:o,Component:a},r)=>t.jsx(na,{path:o,component:a,exact:!0},r)),t.jsx(qe,{exact:!0,to:fl})]})})},cT=p.div`
    ...
    display: flex;
    width: 100%;
`;kS();const dT=()=>(xt(),t.jsx(Lv,{children:t.jsx(Nu,{basename:"/",children:t.jsx(cT,{children:t.jsx(Bd,{children:t.jsx(lT,{})})})})}));Iu.render(t.jsxs(le.StrictMode,{children:[t.jsx(k_,{}),t.jsx(dT,{})]}),document.getElementById("root"));export{Fd as $,wj as A,_ as B,Ye as C,fe as D,j as E,ss as F,he as G,U as H,Cc as I,V as J,yt as K,Qh as L,Q as M,Ww as N,Ke as O,Cy as P,Te as Q,w1 as R,St as S,H as T,wT as U,ve as V,We as W,se as X,Si as Y,nS as Z,$t as _,W as a,Y as a$,iS as a0,_s as a1,UT as a2,WT as a3,vT as a4,ye as a5,Fe as a6,VT as a7,on as a8,Qe as a9,f0 as aA,sb as aB,TT as aC,ob as aD,kT as aE,P0 as aF,ST as aG,ds as aH,hb as aI,Gd as aJ,ET as aK,gv as aL,Jw as aM,uj as aN,ae as aO,Ic as aP,Yi as aQ,iv as aR,CT as aS,mv as aT,xv as aU,Ph as aV,Ve as aW,be as aX,$T as aY,bs as aZ,Oi as a_,Ji as aa,Ee as ab,Dl as ac,Sh as ad,Th as ae,Ya as af,HT as ag,ws as ah,Ja as ai,Pv as aj,Ov as ak,Be as al,$v as am,Tl as an,tv as ao,GT as ap,ft as aq,pe as ar,Wt as as,Ue as at,jT as au,$s as av,YT as aw,Bh as ax,Bs as ay,Es as az,xS as b,V_ as b$,Ne as b0,cn as b1,Gt as b2,Oa as b3,An as b4,Mh as b5,De as b6,mt as b7,st as b8,ay as b9,DT as bA,AT as bB,me as bC,s1 as bD,Ul as bE,Gy as bF,nt as bG,Pt as bH,Iw as bI,sv as bJ,ev as bK,Zy as bL,Qy as bM,ic as bN,H_ as bO,gn as bP,Ci as bQ,es as bR,MT as bS,I_ as bT,El as bU,R_ as bV,L_ as bW,ac as bX,Nt as bY,G_ as bZ,mc as b_,oy as ba,kw as bb,FT as bc,zT as bd,ow as be,Kl as bf,ks as bg,BT as bh,Vt as bi,Xt as bj,kl as bk,c1 as bl,Ae as bm,js as bn,Rn as bo,U_ as bp,Hl as bq,x1 as br,z as bs,En as bt,OT as bu,Z1 as bv,IT as bw,RT as bx,LT as by,NT as bz,ig as c,vc as c0,O_ as c1,l_ as c2,hw as c3,rw as c4,xt as c5,Zl as c6,oc as c7,Nr as c8,yi as c9,bT as cA,cS as cB,dS as cC,yT as cD,Rh as cE,hT as cF,uT as cG,Ki as cH,j_ as cI,ns as cJ,Lh as cK,tf as cL,_T as cM,jj as cN,Ri as cO,yj as cP,vj as cQ,bj as cR,Oc as cS,aS as cT,Y_ as ca,Nl as cb,no as cc,sa as cd,sn as ce,av as cf,ov as cg,mT as ch,xT as ci,Ol as cj,Cl as ck,ki as cl,t_ as cm,Za as cn,gT as co,vm as cp,za as cq,fT as cr,PT as cs,rn as ct,l1 as cu,jS as cv,Ii as cw,tt as cx,Xy as cy,p1 as cz,mn as d,mS as e,oo as f,dt as g,Ga as h,or as i,Ze as j,Vg as k,re as l,Ch as m,a1 as n,DS as o,PS as p,ee as q,P as r,fS as s,Rm as t,te as u,Ts as v,Yt as w,os as x,qT as y,Bg as z};
