import{s as p,m as $,bW as D,j as e,Z as A,r as x,bX as F}from"./vendor-2324f29b.js";import{o as v,p as H,q as W,r as S,A as B,t as _,u as X,s as q,e as K,v as L,w as Q,h as z,x as k}from"./ui-5e47f4cf.js";import{j as T,B as g,G as j,i as w,g as P,H as Z,t as f,l as G,u as R,M as Y,T as M,o as tt,J as et,y as it,z as st,E as nt,$ as lt}from"./index-96298632.js";var u=(t=>(t.Activist="ACTIVIST",t.Competition="COMPETITION",t.ExternalFitness="EXTERNAL_FITNESS",t.GTO="GTO",t.InternalTeam="INTERNAL_TEAM",t.OnlineWork="ONLINE_WORK",t.Science="SCIENCE",t))(u||{});const ot=p(T)`
    flex: 1;
`,dt=p.div`
    display: flex;
...
`,E=({label:t,value:o})=>e.jsxs(Et,{children:[e.jsx(M,{size:3,children:t}),e.jsx(wt,{children:o})]}),Et=p.div`
    ...
    flex: 1;
`,wt=p.span``,Tt=()=>{const{studentId:t}=F(),[o,{currentUser:l},n,d]=A([S.$selectedStudent,lt,j.isLoading,S.$loading]),s=(l==null?void 0:l.user_status)==="staff"?t:(l==null?void 0:l.guid)??"",[i,c]=x.useState(0);return x.useEffect(()=>(k.setCurrentStudentId(s),tt.load(),()=>k.resetStudentId()),[s]),!o&&s&&!n&&!d?e.jsx(et,{text:"Нет данных"}):o?e.jsx(it,{padding:"10px",children:e.jsxs(st,{children:[e.jsx(M,{size:3,align:"left",children:o.fullName}),e.jsxs(Pt,{children:[e.jsx(E,{label:"Группа",value:o.groupNumber}),e.jsx(E,{label:"Баллы",value:z(o).toString()}),e.jsx(E,{label:"Курс",value:o.course.toString()}),e.jsx(E,{label:"ЛМС",value:o.pointsHistory.filter(r=>r.workType===u.OnlineWork).reduce((r,a)=>r+a.points,0).toString()})]}),e.jsx(nt,{appearance:!1,pages:V,currentPage:i,setCurrentPage:c}),e.jsx(bt,{children:V[i].content})]})}):null};export{Tt as default};
