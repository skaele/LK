import{s as a,j as t,co as E,cp as P,r as h,R as W,cq as G}from"./vendor-35c3991b.js";import{cQ as L,bk as l,l as $,cR as z,cS as f,w as R,J as c,bv as M,cT as q,U as u,bu as H,cU as U,T as y,K as x,aB as J,L as K,bn as S,bH as F,O as p,cV as C,cW as O,a1 as V,W as Q,P as X,v as Y,a0 as D,aC as Z}from"./index-46a096a9.js";const w=(e,i)=>{const n=new Date(e).getMonth();return n>1&&n<8?+i*2:+i*2-1},ee=e=>{const i=w(new Date().toISOString(),e),n=[];for(let r=1;r<=i;r++)n.push({id:r,title:`${r} семестр`});return n.push({id:-1,title:"Все семестры"}),n},te=(e,i)=>L(i.filter(n=>l(n.name).includes(l(e))||l(n.teacher).includes(l(e))||l($(n.exam_date)).includes(l(e))||l(n.bill_num).includes(l(e))));function ne(e){const i={5:0,4:0,3:0,2:0},n=e.filter(r=>!!r.grade&&r.exam_type!=="Зачет").length;return e.forEach(({grade:r,exam_type:s})=>{s!=="Зачет"&&r!==void 0&&i[z[r]]++}),n===0?i:Object.keys(i).reduce((r,s)=>(r[+s]=i[+s]/n,r),{})}const ie=2.7;a.div`
    display: flex;
...
`,ae=({grade:e})=>t.jsx(re,{grade:e,superWide:e==="Не явился",children:e==="Не явился"?e:e&&(z[e]>2?t.jsx(E,{}):t.jsx(P,{}))}),oe=a.div`
    width: 100%;
    display: flex;
    min-height: 60px;
    align-items: center;
...
`,le=({item:e,type:i})=>{const{open:n}=R(),{name:r,grade:s}=e,g=v(s),d=()=>e.grade&&n(t.jsx(ue,{item:e,color:v(s,!0)}));return t.jsxs(oe,{onClick:d,isGraded:!!e.grade,children:[t.jsxs(c,{gap:"16px",children:[t.jsx(M,{color:g,borderRadius:"9px",children:q(r)}),t.jsxs(c,{d:"column",ai:"flex-start",gap:"4px",children:[t.jsx(ce,{children:r}),t.jsx(u,{children:t.jsx(H,{words:[se(e.teacher),$(e.exam_date)]})})]})]}),t.jsx(de,{color:g,superWide:s==="Не явился",children:i==="Зачет"?t.jsx(ae,{grade:s}):s==="Не явился"?"Не явился":s&&z[s]})]})},xe=a.div`
    width: 400px;
