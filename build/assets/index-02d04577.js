import{y as p,s as g,bY as x,o as d,j as n}from"./vendor-4af360a6.js";import{aa as m,U as P,W as j,t as v,ab as y}from"./index-2ef5f28f.js";import{c as b,L as F}from"./index-f87926bd.js";import"./index-d35d2ae9.js";const L=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,s=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",s,o,c);return{results:r.items}}),h=b({getFx:L,limit:50}),$=g.div`
    width: 100%;
    display: flex;
