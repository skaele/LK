import{s as d,L as K,a7 as u,j as e,c1 as S,r as m,T as L,f as I,aD as $,q as W,c2 as k,a4 as E,B as O,C as N,bN as _,bO as F}from"./vendor-cbee1f3c.js";import{bb as b,Q as z,bc as x,bd as J,be as j,bf as T,bg as h,l as p,t as c,i as A,bh as H,T as f,w as R,bi as U,bj as q,ay as C,W as Q,N as B,r as G}from"./index-f356c1dd.js";import{I as V}from"./index.esm-d8961b68.js";const X=(s,t)=>t.filter(a=>b(a.name).includes(b(s))),Y=d(K)`
...
`,je=()=>{var r;const[s,t]=m.useState(null),[a,n]=m.useState(!0),i=(r=u(x))==null?void 0:r.params,o=[{avatar:void 0,name:"Стелла",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"1",amountOfUnreadMessages:10},{avatar:"https://upload.wikimedia.org/wikipedia/ru/thumb/d/df/Andrew_Garfield_as_Spider-Man.jpg/280px-Andrew_Garfield_as_Spider-Man.jpg",name:"Питер Паркер",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"2",amountOfUnreadMessages:0},{avatar:void 0,name:"Рафаэль",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"3",amountOfUnreadMessages:0},{avatar:void 0,name:"Леонардо",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"4",amountOfUnreadMessages:0},{avatar:void 0,name:"Бред Питт",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"5",amountOfUnreadMessages:0}];return e.jsxs(Te,{isOpen:a,chatId:i==null?void 0:i.chatId,children:[e.jsxs("div",{className:"chat-list-top-section",children:[e.jsx(f,{size:3,align:"left",children:"Чаты"}),e.jsx(c,{onClick:()=>n(l=>!l),icon:a?e.jsx(O,{}):e.jsx(N,{})})]}),e.jsx(C,{whereToSearch:o,searchEngine:X,setResult:t,placeholder:"Поиск чатов"}),e.jsx(B,{margin:"10px auto"}),e.jsx(re,{chats:s??o,isOpen:a})]})},be=d.div`
    display: flex;
    align-items: center;
    background: var(--block);
    padding: 5px 10px;
...
`,ke=()=>{var n;const s=(n=u(x))==null?void 0:n.params,[t,a]=m.useState(!0);return m.useEffect(()=>{a(!0),setTimeout(()=>{a(!1)},1e3)},[s.chatId]),e.jsxs(we,{children:[e.jsx(de,{name:"Леонаро ДиК априо",loading:t}),e.jsx(me,{loading:t}),e.jsx(ve,{})]})},ze=d.div`
    ...
    width: 100%;
    height: 100%;
`,De=()=>{var t;const s=(t=u(x))==null?void 0:t.params;return e.jsxs(ze,{children:[e.jsx(je,{}),!(s!=null&&s.chatId)&&e.jsx(M,{}),e.jsx(_,{children:e.jsx(F,{path:x,children:e.jsx(ke,{})})})]})};export{De as default};
