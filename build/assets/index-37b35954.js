import{y as p,s as g,bT as x,n as d,j as n}from"./vendor-831b4923.js";import{a1 as m,_ as P,W as j,t as v,a2 as y}from"./index-774d803f.js";import{c as F,L}from"./index-f9d33da5.js";import"./index-580abb32.js";const T=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,s=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",s,o,c);return{results:r.items}}),h=F({getFx:T,limit:50}),$=g.div`
    width: 100%;
    display: flex;
