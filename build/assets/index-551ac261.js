import{s as d,L as K,bZ as u,j as e,b_ as S,r as m,T as L,f as I,aA as $,q as W,b$ as k,bI as E,B as _,C as O,bL as A,bM as F}from"./vendor-f1fdae2f.js";import{aV as v,E as z,aW as x,aX as J,aY as j,aZ as T,a_ as h,l as p,B as c,a as N,a$ as H,T as f,u as R,b0 as U,af as q,ag as C,W as B,D as Q,g as V}from"./index-6982b600.js";import{I as G}from"./index.esm-8a5217b6.js";const X=(s,t)=>t.filter(a=>v(a.name).includes(v(s))),Y=d(K)`
...
`,je=()=>{var r;const[s,t]=m.useState(null),[a,n]=m.useState(!0),i=(r=u(x))==null?void 0:r.params,o=[{avatar:void 0,name:"Стелла",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"1",amountOfUnreadMessages:10},{avatar:"https://upload.wikimedia.org/wikipedia/ru/thumb/d/df/Andrew_Garfield_as_Spider-Man.jpg/280px-Andrew_Garfield_as_Spider-Man.jpg",name:"Питер Паркер",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"2",amountOfUnreadMessages:0},{avatar:void 0,name:"Рафаэль",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"3",amountOfUnreadMessages:0},{avatar:void 0,name:"Леонардо",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"4",amountOfUnreadMessages:0},{avatar:void 0,name:"Бред Питт",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"5",amountOfUnreadMessages:0}];return e.jsxs(Te,{isOpen:a,chatId:i==null?void 0:i.chatId,children:[e.jsxs("div",{className:"chat-list-top-section",children:[e.jsx(f,{size:3,align:"left",children:"Чаты"}),e.jsx(c,{onClick:()=>n(l=>!l),icon:a?e.jsx(_,{}):e.jsx(O,{})})]}),e.jsx(C,{whereToSearch:o,searchEngine:X,setResult:t,placeholder:"Поиск чатов"}),e.jsx(Q,{margin:"10px auto"}),e.jsx(re,{chats:s??o,isOpen:a})]})},ve=d.div`
    display: flex;
    align-items: center;
    background: var(--block);
    padding: 5px 10px;
