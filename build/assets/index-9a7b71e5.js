...
`,W=({title:e,enabledList:n,requiredList:s,add:i,remove:a})=>{const{settings:l}=ee.useSettings(),r=F.useMenu(),{visibleRoutes:o}=F.useMenu(),[d,u]=h.useState(null),c=r[n];if(!c||!o)return null;const f=p=>{c[p]?a(p,l,s):i(p,l,Object.keys(c).length,s)};return t.jsxs(Ke,{children:[t.jsx(E,{size:2,align:"left",bottomGap:!0,children:e}),t.jsx(te,{placeholder:"Поиск",whereToSearch:o,searchEngine:Ae,setResult:u}),Object.values(d??o).map((p,v)=>h.createElement(Je,{...p,key:v,chosen:!!c[p.id],switchMenuItem:f}))]})},et=e=>!e||e.length===0?"Не указан":e,tt=()=>{const{theme:e,switchTheme:n}=Le(),{data:{user:s}}=se.useUser(),{open:i}=C(),{leftsideBarRoutes:a,homeRoutes:l}=F.useMenu(),{settings:r}=ee.useSettings(),[o,d]=h.useState(null),{property:u}=r["settings-notifications"],{property:c}=r["settings-appearance"],{widgetPayment:f,widgetSchedule:p}=r["settings-home-page"].property,v=(s==null?void 0:s.user_status)==="staff"?Me:Te;return h.useEffect(()=>{d({...Xe({scheduledLightTheme:c.scheduledLightTheme,lightThemeRange:c.lightThemeRange,settings:u,isStudent:(s==null?void 0:s.user_status)==="stud",menu:{value:a,additionalActions:{onAdd:()=>i(t.jsx(W,{title:"Настройка меню",enabledList:"leftsideBarRoutes",requiredList:v,remove:V,add:ze})),onRemoveOne:x=>V(x,r,v)}},theme:{value:e==="dark",action:x=>n(x)},phone:{value:(s==null?void 0:s.phone)??"",description:s==null?void 0:s.phone,action:x=>Pe(x??""),additionalActions:{onSuccess:x=>{M.update({key:"phone",value:x})}}},email:{value:(s==null?void 0:s.email)??"",description:et(s==null?void 0:s.email),action:x=>Ie(x??""),additionalActions:{onSuccess:x=>{M.update({key:"email",value:x})}}},avatar:{value:s==null?void 0:s.avatar,description:"Смена аватара",icon:t.jsx(Oe,{avatar:s==null?void 0:s.avatar,name:(s==null?void 0:s.fullName)??"",width:"22px",height:"22px",marginRight:"0"})},homepage:{sections:{value:l,additionalActions:{onRemoveOne:x=>B(x,r),onAdd:()=>i(t.jsx(W,{title:"Добавить страницы",enabledList:"homeRoutes",requiredList:[],remove:B,add:_e}))}},widgets:{schedule:{value:p,action:x=>O.updateSetting({nameSettings:"settings-home-page",nameParam:"widgetSchedule",value:!x})},payments:{value:f,action:x=>O.updateSetting({nameSettings:"settings-home-page",nameParam:"widgetPayment",value:!x})}}}})})},[e,l,p,f,Object.keys(a??{}).length,Object.keys(l??{}).length]),o},le=m.section`
    width: 100%;
...
`,vt=({range:e,step:n,initialValues:s,onSave:i,onChange:a,valueTransform:l})=>{const[r,o]=s,[d,u]=e,[c,f]=h.useState(r),[p,v]=h.useState(o),x=l?l(c):c,j=l?l(p):p,y=()=>{i([c,p])},g=k=>k===1?S=>{const w=Math.min(+S.target.value,p-n);f(w),S.target.value=w.toString()}:S=>{const w=Math.max(+S.target.value,c+n);v(w),S.target.value=w.toString()};return h.useEffect(()=>{a==null||a([c,p])},[c,p]),t.jsxs(ft,{left:Q(c,u-d),width:Q(p-c,u-d),children:[t.jsxs("div",{className:"inputs",children:[t.jsx("input",{type:"range",className:"thumb thumb--zindex-3",min:d,max:u,step:n,value:c,onChange:g(1),onMouseUp:y}),t.jsx("input",{type:"range",className:"thumb thumb--zindex-4",min:d,max:u,step:n,value:p,onChange:g(2),onMouseUp:y})]}),t.jsxs("div",{className:"slider",children:[t.jsx("div",{className:"slider__track"}),t.jsx("div",{className:"slider__range"})]}),t.jsxs("div",{className:"values",children:[t.jsx("span",{children:x}),t.jsx("span",{children:j})]})]})},jt=m.div`
    ...
    flex-direction: column;
    gap: 8px;
`,bt=e=>{const{value:n,action:s}=e,{close:i}=C(),[a,l]=n,[r,o]=h.useState(a),[d,u]=h.useState(l),[c,f]=h.useState(!1),p=()=>{s==null||s([r,d]),i()},v=j=>Z(Math.floor(j/60))+":"+Z(j%60),x=j=>{o(j[0]),u(j[1])};return t.jsxs(jt,{children:[t.jsx(vt,{range:[0,1440],step:60,valueTransform:v,initialValues:[a,l],onSave:()=>null,onChange:x}),t.jsxs(R,{gap:8,direction:"horizontal",horizontalAlign:"right",children:[t.jsx(I,{text:"Отменить",width:"120px",onClick:i}),t.jsx(T,{width:"120px",isLoading:!1,completed:c,text:"Сохранить",action:p,setCompleted:f})]})]})},St=e=>{const{open:n}=C(),s=()=>{n(t.jsx(bt,{...e}))};return t.jsx(L,{...e,editable:!1,onClick:s,icon:t.jsx(J,{})})},re=e=>e===0?"grey":e<=40?"red":e<=60?"orange":e<=80?"blue":"green",ce={small:4,middle:9,big:14},yt=m.div`
    width: 100%;
    h5 {
...
`,$t=e=>({toggle:t.jsx(dt,{...e},e.title),photo:t.jsx(gt,{...e},e.title),choices:t.jsx(mt,{...e},e.title),text:t.jsx(q,{...e},e.title),display:t.jsx(ht,{...e},e.title),interval:t.jsx(St,{...e},e.title),tel:t.jsx(q,{...e},e.title),password:t.jsx(_t,{...e},e.title),link:t.jsx(ut,{...e},e.title)}),he=({fields:e,settingsName:n,asChild:s=!1})=>{const i=a=>!a||!n?()=>null:l=>{console.log(l),O.updateSetting({nameSettings:n,nameParam:a,value:l})};return t.jsx(Dt,{asChild:s,children:e.map(a=>{const l=a.action??i(a.id),{type:r,visible:o=!0}=a;if(o)return $t({...a,action:l,settingsName:n})[r]})})},Vt=m.div`
    width: 100%;
    height: 100%;
    overflow: hidden;
    flex-direction: column;
