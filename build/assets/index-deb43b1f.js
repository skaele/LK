import{y as p,s as g,b_ as x,o as d,j as n}from"./vendor-2324f29b.js";import{ae as m,Y as P,W as j,z as v,af as y}from"./index-386db3e9.js";import{c as F,L}from"./index-71a9dcae.js";import"./index-081ba2d7.js";const $=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,e=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",e,o,c);return{results:r.items}}),h=F({getFx:$,limit:50}),b=g.div`
    width: 100%;
    display: flex;
