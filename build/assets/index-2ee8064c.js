import{u as c,bS as pe,bT as Xe,p as f,x as a,bU as Ze,bV as Je,y as v,s as l,r as u,j as s,d as Ye,Z as k,aG as ve,bK as X,T as et,m as tt,bW as st,c as rt}from"./vendor-561dac3a.js";import{i as m,n as C,p as h,o as F,q as p,T as M,r as Z,t as V,u as _,v as I,w as ye,x as ke,y as nt,z as at,D as ot,E as it,G as j,K as T,H as ct,J as lt,L as P,N as ut,O as dt,Q as pt,M as mt,R as gt,U as xt,P as ft,V as ht,X as jt}from"./index-9d4b4175.js";import{j as U,e as J,d as $e,P as A,s as St,a as vt,b as we,c as $,f as yt,g as Y,h as w,A as kt,i as O,k as $t,l as wt,S as Ct,m as Et,n as Pt,o as me}from"./ui-0fd3a678.js";import{S as Ce}from"./index-6a3ce409.js";function ge(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(o){return Object.getOwnPropertyDescriptor(e,o).enumerable})),r.push.apply(r,n)}return r}function bt(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]!=null?arguments[t]:{};t%2?ge(Object(r),!0).forEach(function(n){Nt(e,n,r[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):ge(Object(r)).forEach(function(n){Object.defineProperty(e,n,Object.getOwnPropertyDescriptor(r,n))})}return e}function Nt(e,t,r){return t=Dt(t),t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function Dt(e){var t=Gt(e,"string");return typeof t=="symbol"?t:String(t)}function Gt(e,t){if(typeof e!="object"||e===null)return e;var r=e[Symbol.toPrimitive];if(r!==void 0){var n=r.call(e,t||"default");if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}function Ee(e){var{events:t,reset:r,target:n=c({name:"target",sid:"aip3nf"},{name:"target",sid:"aip3nf"})}=e;return pe.unit(n)||xe("target should be a unit"),r&&!pe.unit(r)&&xe("reset should be a unit"),Xe(n,()=>{var o=Object.keys(t),i=Array.isArray(t)?[...o].fill(""):{},d=f(o.length,{and:{serialize:"ignore"},name:"$counter",sid:"-dby0v3"}),g=f(i,{and:{serialize:"ignore"},name:"$results",sid:"c60qbe"});d.reset(a({and:[{source:n}],or:{sid:"-8hxq8z"}})),g.reset(n),r&&(d.reset(a({and:[{source:r}],or:{sid:"3c6u5p"}})),g.reset(r));var q=function(B){var ue=f(!1,{and:{serialize:"ignore"},name:"$isDone",sid:"uttu1j"}).on(t[B],()=>!0).reset(n);r&&ue.reset(r),d.on(ue,E=>E-1),g.on(t[B],(E,Qe)=>{var de=Array.isArray(E)?[...E]:bt({},E);return de[B]=Qe,de})};for(var Ke of o)q(Ke);Ze({and:[{source:a({and:[{source:g,clock:Je(Object.values(t),{name:"clock",sid:"-531esq"})}],or:{name:"source",sid:"uwap9g"}}),filter:d.map(le=>le===0),target:n}],or:{sid:"ciyd7d"}})}),n}function xe(e){throw new Error(e)}const Tt=e=>`mutation addNewComp{
    ...
    }`,Pe=c(),b=v(async e=>await h(Tt(e)));a({clock:Pe,target:b});a({clock:b.failData,fn:()=>({message:"Не удалось добавить соревнование",type:"failure",time:3e3}),target:m.evokePopUpMessage});a({clock:b.doneData,fn:()=>({message:"Соревнование добавлено",type:"success",time:3e3}),target:m.evokePopUpMessage});a({clock:b.doneData,target:J.load});a({clock:b.doneData,target:C.close});const At=l.div`
    display: flex;
...
`,ss=()=>{const[e,t]=u.useState(""),r=()=>{es.startNewSemester(e)};return s.jsxs(ts,{children:[s.jsx(F,{title:"Новый семестр",setValue:t,value:e}),s.jsx(p,{text:"Начать новый семестр",onClick:r})]})},rs=()=>`mutation {
     ...
     }`,Fe=c(),G=v(async()=>await h(rs()));a({clock:Fe,target:G});a({clock:G.doneData,target:C.close});a({clock:G.failData,fn:()=>({message:"Не удалось обновить список студентов",type:"failure",time:3e3}),target:m.evokePopUpMessage});a({clock:G.doneData,fn:()=>({message:"Список студентов обновлен",type:"success",time:3e3}),target:m.evokePopUpMessage});G.pending;const ns=[{field:"name",title:"Название"},{field:"name",title:"",render:e=>s.jsx(p,{onClick:()=>J.remove(e),text:"Удалить"})}],as=l.div`
    width: 100%;
    display: flex;
    flex-direction: column;
    gap: 10px;
