import{s as d,L as K,bT as u,j as e,bU as S,r as m,K as L,f as I,az as $,o as W,bV as k,bJ as E,z as _,B as O,bE as F,bF as N}from"./vendor-831b4923.js";import{aU as v,x as z,aV as x,aW as J,aX as j,aY as T,aZ as h,l as p,B as c,a as A,a_ as H,T as f,u as R,a$ as U,am as V,a3 as C,W as q,D as B,g as Q}from"./index-564a54c0.js";import{I as G}from"./index.esm-29d01972.js";const X=(s,t)=>t.filter(a=>v(a.name).includes(v(s))),Y=d(K)`
...
`,be=()=>{const[s,t]=m.useState("");return e.jsxs(ve,{children:[e.jsx(c,{icon:e.jsx(k,{}),onClick:()=>null,background:"transparent"}),e.jsx(Q,{value:s,setValue:t,placeholder:"Введите сообщение..."}),e.jsx(c,{icon:e.jsx(G,{}),onClick:()=>null,background:"transparent"})]})},we=d.div`
    width: 100%;
    height: 100%;
    display: flex;
    flex-direction: column;
