...
export const StructuralSubdivisionOptions = [
    {
        id: 0,
        title: 'Отделение «На Большой Семеновской» центра по работе со студентами Ул.Большая Семеновская, 38; ауд. В-207. Тел. (495) 223-05-23, доб. 1105, 1175; crs-bs@mospolytech.ru',
    },
    {
        id: 1,
