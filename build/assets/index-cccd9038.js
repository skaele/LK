import{s as a,j as t,cm as G,cn as T,r as h,R as P,co as L}from"./vendor-2324f29b.js";import{cE as M,aY as l,l as z,cF as $,cG as f,u as R,r as c,b8 as W,cH as q,w as u,b7 as H,cI as J,T as y,K as x,ai as K,D as U,b0 as S,bm as B,t as p,cJ as D,cK as C,Y,W as V,z as X,i as Q,J as O,aj as Z}from"./index-386db3e9.js";const w=(e,i)=>{const n=new Date(e).getMonth();return n>1&&n<8?+i*2:+i*2-1},ee=e=>{const i=w(new Date().toISOString(),e),n=[];for(let s=1;s<=i;s++)n.push({id:s,title:`${s} семестр`});return n.push({id:-1,title:"Все семестры"}),n},te=(e,i)=>M(i.filter(n=>l(n.name).includes(l(e))||l(n.teacher).includes(l(e))||l(z(n.exam_date)).includes(l(e))||l(n.bill_num).includes(l(e))));function ne(e){const i={5:0,4:0,3:0,2:0},n=e.filter(s=>!!s.grade&&s.exam_type!=="Зачет").length;return e.forEach(({grade:s,exam_type:r})=>{r!=="Зачет"&&s!==void 0&&i[$[s]]++}),n===0?i:Object.keys(i).reduce((s,r)=>(s[+r]=i[+r]/n,s),{})}const ie=2.7;a.div`
    display: flex;
...
`,ae=({grade:e})=>t.jsx(re,{grade:e,children:e&&($[e]>2?t.jsx(G,{}):t.jsx(T,{}))}),oe=a.div`
    width: 100%;
    display: flex;
    min-height: 60px;
    align-items: center;
