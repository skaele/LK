...
import TrainingPic from '@shared/ui/images/tutorial-picture.jpg'
...
export const TutorialHero = () => {
    ...
    const [heroVisited, tutorialState, tutorialEnabled, setHeroVisited] = useUnit([
        model.stores.heroVisited,
        model.stores.tutorialState,
        model.events.tutorialEnabled,
        model.events.setHeroVisited,
    ])
    const {
        data: { user },
