import{s as p,m as $,bX as D,j as e,Z as A,r as x,bR as J}from"./vendor-561dac3a.js";import{o as v,p as H,q as W,r as S,A as X,t as _,u as q,s as B,e as Z,v as L,w as K,h as G,x as k}from"./ui-eec08563.js";import{x as T,t as g,Z as j,v as w,r as P,_ as Q,O as f,m as R,w as z,M as Y,T as M,E as tt,a0 as et,X as it,P as st,Y as nt,G as lt}from"./index-d124093a.js";var u=(t=>(t.Activist="ACTIVIST",t.Competition="COMPETITION",t.ExternalFitness="EXTERNAL_FITNESS",t.GTO="GTO",t.InternalTeam="INTERNAL_TEAM",t.OnlineWork="ONLINE_WORK",t.Science="SCIENCE",t))(u||{});const ot=p(T)`
    flex: 1;
`,dt=p.div`
    display: flex;
...
`,vt=p.div`
    ...
    justify-content: center;
    gap: 10px;
`,At=$(j.peTeacher,K.pendingRemoveRegulationPoints,(t,o)=>{var l;return[{title:"Дата",field:"date",type:"date",sort:!0},{title:"Норматив",field:"standardType",render:(n,d)=>{var s;return n===m.Other?d.comment:(s=U.find(({id:i})=>i===n))==null?void 0:s.title}},{title:"Количество баллов",field:"points"},{title:"Преподаватель",field:"teacher",render:n=>n.fullName},{title:"Комментарий",field:"comment",priority:"five"},...(l=t==null?void 0:t.permissions)!=null&&l.length?[{title:"Действия",field:"actions",onClick:()=>null,render:(n,d)=>{const s=d,i=D(new Date(s.date),new Date)<-30,c=[v.AdminAccess,v.SuperUser].some(r=>{var a;return(a=t==null?void 0:t.permissions)==null?void 0:a.includes(r)});return s.teacherGuid===(t==null?void 0:t.id)&&!i||c?e.jsx(g,{width:"100%",text:"Удалить",isActive:!o,onClick:()=>L.removeRegulationPoints({id:s.id.toString()})}):null}}]:[]]}),Ct=()=>{var c;const[t,o,l]=A([S.$selectedStudent,At,j.peTeacher]),{open:n}=z(),d=!!t&&G(t),s=()=>{n(e.jsx(gt,{}),"Добавить норматив")},i=Number(d)<20;return t?e.jsxs(vt,{children:[!t&&i&&e.jsx(Y,{type:"alert",children:"Чтобы добавить норматив, у студента должно быть хотя бы 20 баллов"}),!!((c=l==null?void 0:l.permissions)!=null&&c.length)&&e.jsx(g,{text:"Добавить норматив",onClick:s,background:f.blue.main,textColor:f.white.main,isActive:!i}),e.jsx(jt,{data:t.standardsHistory,columns:o})]}):null},V=[{title:"Посещения",content:e.jsx(at,{})},{title:"Нормативы ",content:e.jsx(Ct,{})},{title:"Дополнительные баллы ",content:e.jsx(ft,{})}];p.div`
    display: flex;
    flex-direction: column;
    gap: 24px;
    padding: 12px;
...
`,E=({label:t,value:o})=>e.jsxs(Et,{children:[e.jsx(M,{size:3,children:t}),e.jsx(wt,{children:o})]}),Et=p.div`
    ...
    flex: 1;
`,wt=p.span``,Tt=()=>{const{studentId:t}=J(),[o,{currentUser:l},n,d]=A([S.$selectedStudent,lt,j.isLoading,S.$loading]),s=(l==null?void 0:l.user_status)==="staff"?t:(l==null?void 0:l.guid)??"",[i,c]=x.useState(0);return x.useEffect(()=>(k.setCurrentStudentId(s),tt.load(),()=>k.resetStudentId()),[s]),!o&&s&&!n&&!d?e.jsx(et,{text:"Нет данных"}):o?e.jsx(it,{padding:"10px",children:e.jsxs(st,{children:[e.jsx(M,{size:3,align:"left",children:o.fullName}),e.jsxs(Pt,{children:[e.jsx(E,{label:"Группа",value:o.groupNumber}),e.jsx(E,{label:"Баллы",value:G(o).toString()}),e.jsx(E,{label:"Курс",value:o.course.toString()}),e.jsx(E,{label:"ЛМС",value:o.pointsHistory.filter(r=>r.workType===u.OnlineWork).reduce((r,a)=>r+a.points,0).toString()})]}),e.jsx(nt,{appearance:!1,pages:V,currentPage:i,setCurrentPage:c}),e.jsx(bt,{children:V[i].content})]})}):null};export{Tt as default};
