import{s as l,L as j,j as e,R as E,Z as $,F as L,c as T,r as p}from"./vendor-f1fdae2f.js";import{q as g,E as c,b7 as A,X as R,aa as W,al as I,D as y,b8 as b,a$ as u,G as D,b9 as B,aQ as F,B as M,ba as H,M as U,bb as _,bc as O,bd as Y,be as q,bf as Z,bg as G,bh as X,bi as P,ab as Q,b5 as k,V as v,bj as V,r as h,T as N,bk as K,bl as m,bm as f,bn as J,bo as ee,bp as te,W as se,bq as ie,v as ae,aW as ne,br as re}from"./index-9d5e42c4.js";import{E as oe}from"./index-f424f69c.js";import{A as le}from"./alert-item-9d5881d0.js";import"./is-valid-url-08a91344.js";const ce=l(j)`
    width: 100%;
    height: 100%;
...
`,Ie=()=>{const{data:{user:t},error:s}=v.useUser(),a=$(b.$paymentsStore),{data:{schedule:i}}=J.useSchedule(),{homeRoutes:n}=I.useMenu();if(!t||!n)return null;p.useEffect(()=>{a||ee.getPayments()},[a]),p.useEffect(()=>{i||te.getScheduleFx(t)},[i]);const{news:r}=P.useSettings().settings["settings-home-page"].property;return e.jsxs(se,{loading:!t,load:()=>null,error:s,data:t,children:[e.jsx(ye,{}),e.jsxs(ke,{children:[e.jsx(ie,{}),e.jsx(xe,{links:n}),e.jsx(ae,{children:e.jsxs(ne,{noAppearanceInMobile:!0,maxWidth:"750px",minHeight:"100%",height:"100%",orientation:"vertical",gap:"20px",children:[e.jsxs(h,{children:[e.jsx(N,{size:2,align:"left",width:"100%",children:"Главная"}),e.jsx(re,{})]}),e.jsx(be,{}),!!r&&e.jsx(je,{})]})})]})]})};export{Ie as default};
