import{y as p,s as g,b6 as x,n as d,j as n}from"./vendor-e9654bfa.js";import{V as m,O as P,W as j,Q as v,X as y}from"./index-5ad0a555.js";import{c as F,L}from"./index-3075abf3.js";import"./index-11402b8c.js";const $=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,s=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",s,o,c);return{results:r.items}}),h=F({getFx:$,limit:50}),b=g.div`
    width: 100%;
    display: flex;
