...
`;function _(e){const{icon:i,text:n,onClick:s,width:o,minWidth:a,background:r,textColor:c,hoverBackground:d,align:u,isChosen:h,padding:f,shrinkTextInMobile:g,fixedInMobile:m,direction:x="horizontal",isActive:b=!0,height:y,notActiveClickMessage:P,flipped:I,...j}=e,S=C=>{b?s==null||s(C):P&&H.evokePopUpMessage({type:"failure",message:P,time:1e4})};return t.jsxs(xg,{text:!!n,onClick:S,isChosen:h,width:o,minWidth:a,background:r,padding:f,textColor:c,shrinkTextInMobile:g,hoverBackground:d,align:u,direction:x,isActive:b,fixedInMobile:m,height:y,flipped:I,...j,children:[!!i&&t.jsx("div",{className:"icon",children:i}),t.jsx("span",{className:"text",children:n})]})}const Nn=e=>{switch(e){case"center":return"center";case"right":return"flex-end";case"evenly":return"space-evenly"}return"flex-start"},Ws=e=>{switch(e){case"center":return"center";case"bottom":return"flex-end";case"space-between":return"space-between"}return"flex-start"},mg=p.div`
...
`;function Y({shape:e,size:i,margin:n="10px 0",pulse:s=!0}){return t.jsx(yg,{pulse:s,size:i,shape:e,margin:n})}const vg=p(rn)`
    height: 100%;
`,_g=({direction:e,shapes:i,horizontalAlign:n,verticalAlign:s})=>t.jsx(vg,{direction:e,horizontalAlign:n,verticalAlign:s,children:i.map((o,a)=>l.createElement(Y,{...o,key:a}))}),xt=e=>({display:"flex",alignItems:"center",justifyContent:"center",width:e});function wg({size:e,children:i,width:n}){switch(e){case 1:return t.jsx("h1",{className:"title",style:xt(n),children:i});case 2:return t.jsx("h2",{className:"title",style:xt(n),children:i});case 3:return t.jsx("h3",{className:"title",style:xt(n),children:i});case 4:return t.jsx("h4",{className:"title",style:xt(n),children:i});case 5:return t.jsx("h5",{className:"title",style:xt(n),children:i});case 6:return t.jsx("h6",{className:"title",style:xt(n),children:i});default:return t.jsx("h1",{className:"title",style:xt(n),children:i})}}const jg=p.div`
    width: 100%;
...
`,ct=l.forwardRef(function(i,n){const{value:s,setValue:o,leftIcon:a,title:r,required:c,width:d,minWidth:u,customMask:h,placeholder:f="Введите сюда",type:g="text",danger:m,alertMessage:x,loading:b=!1,isActive:y=!0,inputAppearance:P=!0,mask:I=!1,autocomplete:j=!1,minValue:S=void 0,maxValue:C=void 0,maxLength:L=void 0,hideCross:N=!1,stepSize:K=.1,size:z="middle"}=i,{inputType:ie,buttonOnClick:ce,danger:$e,handleOnChange:je,phoneMaskKeyDown:Ve}=Gg(s,o,g,m,S,C,h,I),he=s&&g==="date"?Kd(new Date(s),"yyyy-MM-dd"):s??"";return t.jsxs(qg,{leftIcon:!!a,isActive:y,inputAppearance:P,width:d,danger:$e,minWidth:u,size:z,children:[t.jsx(U,{size:5,align:"left",visible:!!r,bottomGap:"5px",required:c,children:r}),t.jsx(Q,{type:"alert",visible:!!x,icon:t.jsx(Qd,{}),title:x??""}),a&&t.jsx("span",{className:"left-icon",children:a}),t.jsx("input",{id:f,min:S,max:C,maxLength:L,step:K??void 0,type:ie,placeholder:f,value:he,autoComplete:j?"on":"off",onKeyDown:Ce=>g==="tel"&&Ve(Ce),onChange:je,required:c,readOnly:!y,ref:n}),g!=="password"?!!(s!=null&&s.length)&&P&&(b?t.jsx(Ke,{}):!N&&t.jsx(_,{icon:t.jsx(Je,{}),onClick:()=>o(""),tabIndex:-1})):t.jsx(_,{icon:ie==="password"?t.jsx(Zd,{}):t.jsx(Ro,{}),tabIndex:-1,onClick:ce})]})}),Yg=p.div`
    user-select: none;
    min-width: 56px;
    height: 30px;
...
`,Zg=({icon:e,text:i,onClick:n,width:s,background:o,textColor:a,align:r,href:c,height:d,minHeight:u,padding:h,isActive:f=!0,isChosen:g=!1})=>t.jsxs(Qg,{text:!!i,onClick:m=>f&&n&&n(m),isChosen:g,width:s,background:o,textColor:a,href:c,align:r,isActive:f,height:d,padding:h,minHeight:u,children:[!!e&&e,i&&t.jsx("span",{children:i})]}),ki=l.memo(Zg),os=p.div`
    width: 100%;
    height: fit-content;
...
`,tf=({title:e,link:i,type:n})=>t.jsxs(ef,{href:i,target:"_blank",children:[t.jsx("div",{className:"icon",children:n==="document"?t.jsx(D,{}):t.jsx(ep,{})}),t.jsx("div",{className:"title",children:e})]}),nf=(e,i=265,n=200)=>(e.preventDefault(),{x:e.clientX<window.innerWidth/2?e.clientX:e.clientX-i,y:e.clientY<window.innerHeight/2?e.clientY:e.clientY-n}),sf={open:!1,content:null,type:"left-click",position:{x:0,y:0}},of=()=>we(af),Ba=k(),Ha=k(),Ua=k(),af=J(sf).on(Ba,(e,{content:i,e:n,height:s,type:o="left-click"})=>({position:nf(n,220,s),open:!0,content:i,type:o})).on(Ha,e=>({...e,open:!1})).on(Ua,(e,{position:i})=>({...e,position:i})),Ie={open:Ba,close:Ha,changePosition:Ua},rf={useContextMenu:of},lf=()=>{const e=navigator.userAgent;return/iPad|iPhone|iPod/.test(e)?"iOS":e.search("Mac")!==-1?"MacOS":e.search("X11")!==-1&&e.search("Linux")===-1?"UNIX":e.search("Linux")!==-1&&e.search("X11")!==-1?"Linux":/android/i.test(e)?"Android":"Windows"},jn=new Set,Wa=(e,i)=>{l.useEffect(()=>{const n=o=>{jn.add(o.which),!e.slice(0,e.length-1).find(r=>!jn.has(r))&&e[e.length-1]===o.which&&(o.preventDefault(),i())},s=o=>{jn.delete(o.which)};return window.addEventListener("keydown",n),window.addEventListener("keyup",s),()=>{window.removeEventListener("keydown",n),window.removeEventListener("keyup",s)}},[])},Qe=p.div`
    display: flex;
...
`,qa=({value:e,setValue:i,visible:n=!0})=>{if(e.length===0||!n||!Ga(e))return null;const s=Va(e),o=()=>i(s);return t.jsxs(oe,{width:"100%",maxWidth:"100%",onClick:o,children:["Возможно, вы имели в виду ",t.jsx(cf,{tabIndex:10,children:s})]})};function qt(e,i){l.useEffect(()=>{const n=s=>{const o=e==null?void 0:e.current;!o||o.contains(s.target)||i(s)};return document.addEventListener("mousedown",n),document.addEventListener("touchstart",n),()=>{document.removeEventListener("mousedown",n),document.removeEventListener("touchstart",n)}},[e,i])}function dt(e,i,n=0){return e>i?n:e<n?i:e}const df=p.div`
    display: flex;
    flex-direction: column;
    row-gap: 8px;
    width: ${({width:e})=>e??"100%"};
...
`,Ya=({value:e,width:i,placeholder:n,inputAppearance:s,loading:o,hints:a,leftIcon:r,focusOn:c,setValue:d,customMask:u,onHintClick:h,validationCheck:f=!1,size:g="middle"})=>{const[m,x]=l.useState(0),[b,y]=l.useState(!1),P=l.useRef(null),I=l.useRef(null),j=l.useRef(null);qt(P,()=>y(!1)),l.useEffect(()=>{c&&setTimeout(()=>{var N;return(N=j.current)==null?void 0:N.focus()},50)},[c]);const S=N=>{var K,z;(((a==null?void 0:a.length)??0)>0||o)&&y(!0),N.key==="ArrowDown"?((K=I.current)==null||K.scrollIntoView({block:"start",behavior:"smooth"}),typeof m=="number"&&x(dt(m+1,((a==null?void 0:a.length)??1)-1,0))):N.key==="ArrowUp"?((z=I.current)==null||z.scrollIntoView({block:"end",behavior:"smooth"}),typeof m=="number"&&x(dt(m-1,((a==null?void 0:a.length)??1)-1,0))):N.key==="Enter"?(a!=null&&a[m??0].title&&d(a==null?void 0:a[m??0].title),y(!1),h==null||h(a==null?void 0:a[m??0])):x(0)},C=N=>()=>{x(N),d((a==null?void 0:a[N].title)??""),y(!1),h==null||h(a==null?void 0:a[N])},L=()=>{a!=null&&a.length&&y(!0)};return t.jsxs(df,{width:i,onKeyDown:S,onMouseDown:L,ref:P,children:[t.jsx(ct,{size:g,value:e,placeholder:n,leftIcon:r??t.jsx(Mt,{}),inputAppearance:s,setValue:d,loading:o,width:i,mask:!0,customMask:u,ref:j}),t.jsx(qa,{setValue:d,value:e,visible:f}),b&&t.jsx(pf,{height:"fit-content",maxWidth:"100%",maxHeight:"250px",width:"100%",onKeyDown:S,padding:"0",orientation:"vertical",children:a==null?void 0:a.map(({title:N,icon:K},z)=>{const ie=m===z;return t.jsxs(uf,{onClick:C(z),ref:ie?I:null,selected:ie,children:[K&&t.jsx("div",{className:"icon",children:K}),t.jsx("span",{children:N})]},N+z)})})]})},cn=()=>{const[e,i]=l.useState({width:0,height:0}),n=()=>{i({width:window.innerWidth,height:window.innerHeight})};return l.useEffect(()=>(n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}),[]),e},Vs={small:"30px",middle:"44px",big:"68px"},Ja={small:"8px",middle:"10px",big:"16px"},hf={small:"0.8rem",middle:"0.9rem",big:"1rem"},gf={small:"0.65rem",middle:"0.75rem",big:"0.85rem"},ff=p.div`
...
`,ft=({children:e,color:i,borderRadius:n,badge:s,size:o=38})=>{const a=s?isNaN(+s)?!0:+s>0:!1;return t.jsxs(kf,{borderRadius:n,backgroud:i,size:o,className:"icon",children:[t.jsx(St,{outline:"4px solid var(--block)",color:"red",top:"93%",left:"93%",visible:a,className:"notification-circle",children:s}),e]})},Ka=({whereToSearch:e,searchEngine:i,setResult:n,inputAppearance:s,setExternalValue:o,hints:a,width:r,loadingOnType:c=!1,placeholder:d="Поиск по меню",validationCheck:u=!1})=>{const h=y=>{n(i(y,e))},f=()=>{n(null)},[g,m,x]=Xa({onDebounce:h,onClear:f}),b=y=>{m(y),o&&o(y)};return t.jsx(Ya,{value:g??"",setValue:b,inputAppearance:s,placeholder:d,validationCheck:u,loading:c?x:!1,hints:a,width:r})},Sf=({id:e,isToggled:i,setIsToggled:n})=>t.jsxs(Yg,{children:[t.jsx("input",{type:"checkbox",name:e,id:e,className:"checkbox",checked:i,onChange:n}),t.jsx("label",{className:"toggle-body",htmlFor:e,children:t.jsx("span",{className:"toggle-circle"})})]}),Qa=p.div`
    width: 8px;
    height: 8px;
    border-radius: 100%;
    margin: 3px;
...
`,Za=({amount:e,current:i,color:n,direction:s="horizontal"})=>e<=1?null:t.jsxs(Ee,{direction:s,gap:2,width:"fit-content",minWidth:"fit-content",verticalAlign:"center",horizontalAlign:"center",children:[Array(e).fill(0).map((o,a)=>t.jsx(Tf,{},a)),t.jsx(Ef,{color:n,current:i})]}),$f=p.label`
    transition: 0.1s;
...
`,qe=({text:e,checked:i,setChecked:n,fontSize:s,visible:o=!0,isActive:a=!0,invisibleOnFalse:r=!1})=>{if(!o)return null;const c=()=>{a&&n(!i)};return t.jsxs($f,{checked:i,invisibleOnFalse:r,fontSize:s,isActive:a,className:"checkbox",children:[t.jsx("input",{className:"checkbox",type:"checkbox",checked:i,onChange:c}),t.jsx(Pf,{tabIndex:0,className:"checkbox-square",children:i&&t.jsx(en,{})}),e&&t.jsx("div",{className:"checkbox-text",children:e})]})},er=e=>e.split("/")[1],Cf=e=>e*1024*1024,Of=(e,i)=>(i??Bu).indexOf(e.type)!==-1,Gs=(e,i,n,s,o=Hu)=>{if(n&&i.length+e.length>n)return H.evokePopUpMessage({message:`Нельзя загрузить больше ${n} файлов`,type:"failure"}),i;for(let a=0;a<e.length;a++)return Of(e[a],s)?e[a].size>Cf(o)?(H.evokePopUpMessage({message:`Размер файла слишком большой. Максимальный размер файла: ${o} MB`,type:"failure",time:1e4}),i):[...i,e[a]]:(console.log(e[a]),H.evokePopUpMessage({message:`Неверный формат файла. Доступные форматы: ${s==null?void 0:s.map(r=>er(r))}`,type:"failure",time:5e3}),i)},Af=p.label`
    width: 100%;
    min-height: 150px;
    border-radius: var(--brLight);
...
`,Lf=({file:e,files:i,setFiles:n})=>{const{open:s}=te(),o=(r,c)=>{r.preventDefault(),r.stopPropagation();const d=new FileReader;d.onloadend=()=>{s(t.jsx(ss,{src:d.result,loading:!1,width:"500px",height:""}))},c&&d.readAsDataURL(c)},a=r=>nt.evokeConfirm({message:"Вы уверены, что хотите удалить файл?",onConfirm:()=>n(If(r,e.name,i))});return t.jsxs(Rf,{onClick:r=>r.preventDefault(),children:[t.jsxs("div",{className:"file-body",onClick:r=>e.type.includes("image")&&o(r,e),children:[t.jsx("div",{className:"image-container",children:e.type.includes("image")?t.jsx(tp,{}):t.jsx(ip,{})}),t.jsxs("div",{className:"name-and-size",children:[t.jsx("b",{className:"file-name",children:e.name}),t.jsx(oe,{fontSize:"0.7em",children:Nf(e.size)})]})]}),t.jsx(_,{icon:t.jsx(Je,{}),height:"30px",width:"30px",background:"transparent",onClick:a})]})},zf=({files:e,setFiles:i})=>t.jsx(Ee,{title:"Список файлов",visible:!!e.length,onDelete:()=>nt.evokeConfirm({message:"Вы уверены, что хотите удалить все файлы?",onConfirm:()=>i([])}),children:e.map(n=>t.jsx(Lf,{file:n,files:e,setFiles:i},n.name))}),tr=e=>t.jsxs(Ee,{gap:12,children:[t.jsx(Df,{...e}),t.jsx(zf,{files:e.files,setFiles:e.setFiles})]}),Mf=p.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
`,Ff=({checkbox:e,loadfile:i,docVisible:n})=>t.jsxs(Mf,{children:[t.jsx(qe,{...e}),n&&t.jsx(tr,{...i})]}),Bf=p.div`
    width: 100%;
    display: flex;
    align-items: center;
    gap: 5px;
...
`,Kf=()=>t.jsx(Xf,{children:t.jsx(Jf,{})}),Se=({oldVersionUrl:e,errorText:i="Страница еще находится в разработке. Если вам она нужна, вернитесь к старому дизайну",buttonText:n="Перейти к старому дизайну",forceForward:s=!1,isRedirectButtonVisible:o=!0})=>(l.useEffect(()=>{s&&(window.location.href=`/old/?p=${e==null?void 0:e.slice(1,e.length)}`)},[]),t.jsx(ge,{text:i,children:o&&t.jsx("a",{href:`${R}/?p=${e==null?void 0:e.slice(1,e.length)}`,children:t.jsx(_,{text:n,icon:t.jsx(tn,{}),width:"100%",background:"var(--reallyBlue)",textColor:"#fff",align:"left",padding:"10px"})})})),Qf="modulepreload",Zf=function(e){return"/"+e},qs={},v=function(i,n,s){if(!n||n.length===0)return i();const o=document.getElementsByTagName("link");return Promise.all(n.map(a=>{if(a=Zf(a),a in qs)return;qs[a]=!0;const r=a.endsWith(".css"),c=r?'[rel="stylesheet"]':"";if(!!s)for(let h=o.length-1;h>=0;h--){const f=o[h];if(f.href===a&&(!r||f.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${c}`))return;const u=document.createElement("link");if(u.rel=r?"stylesheet":Qf,r||(u.as="script",u.crossOrigin=""),u.href=a,document.head.appendChild(u),r)return new Promise((h,f)=>{u.addEventListener("load",h),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>i())},ex=l.lazy(()=>v(()=>import("./index-ecbe9c3e.js"),["assets/index-ecbe9c3e.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js"])),tx=l.lazy(()=>v(()=>import("./index-9436c4ef.js"),["assets/index-9436c4ef.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-fe8260f5.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-0f7b9244.js"])),ix=l.lazy(()=>v(()=>import("./index-b99c92c5.js"),["assets/index-b99c92c5.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js"])),nx=l.lazy(()=>v(()=>import("./index-a9845b64.js"),["assets/index-a9845b64.js","assets/vendor-2324f29b.js","assets/find-current-in-select-ba4611d5.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>Pb),void 0));const sx=l.lazy(()=>v(()=>import("./index-84493171.js"),["assets/index-84493171.js","assets/vendor-2324f29b.js","assets/index-1f0bfda8.js"])),ox=l.lazy(()=>v(()=>import("./index-fc185bcf.js"),["assets/index-fc185bcf.js","assets/vendor-2324f29b.js","assets/index-7516635f.js"])),ax=l.lazy(()=>v(()=>import("./index-91a0f1fd.js"),["assets/index-91a0f1fd.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),rx=l.lazy(()=>v(()=>import("./index-c45e2e74.js"),["assets/index-c45e2e74.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-fe8260f5.js","assets/get-teacher-subdivisions-5cd556a9.js"])),lx=l.lazy(()=>v(()=>import("./index-7514018d.js"),["assets/index-7514018d.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-fe8260f5.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-0f7b9244.js"])),cx=l.lazy(()=>v(()=>import("./index-1d7d2508.js"),["assets/index-1d7d2508.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-0f7b9244.js"])),dx=l.lazy(()=>v(()=>import("./index-c769fa45.js"),["assets/index-c769fa45.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-fe8260f5.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-0f7b9244.js"])),px=l.lazy(()=>v(()=>import("./index-a7906569.js"),["assets/index-a7906569.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/index-0f7b9244.js"])),ux=l.lazy(()=>v(()=>import("./index-8b735885.js"),["assets/index-8b735885.js","assets/vendor-2324f29b.js","assets/ui-0616012a.js","assets/index-1c03349a.js"])),hx=l.lazy(()=>v(()=>import("./index-fa4a2d11.js"),["assets/index-fa4a2d11.js","assets/vendor-2324f29b.js","assets/ui-0616012a.js"])),gx=l.lazy(()=>v(()=>import("./index-79171cf2.js"),["assets/index-79171cf2.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-0f7b9244.js"])),fx=l.lazy(()=>v(()=>import("./index-8c6acdb1.js"),["assets/index-8c6acdb1.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-fe8260f5.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-0f7b9244.js"])),xx=l.lazy(()=>v(()=>import("./index-0558e9e8.js"),["assets/index-0558e9e8.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js","assets/index-0f7b9244.js"])),mx=l.lazy(()=>v(()=>import("./index-5e9f0aee.js"),["assets/index-5e9f0aee.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-0f7b9244.js"])),bx=l.lazy(()=>v(()=>import("./index-a6460a1a.js"),["assets/index-a6460a1a.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-fe8260f5.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/get-last-year-for-period-e1de6b16.js","assets/index-0f7b9244.js"])),yx=l.lazy(()=>v(()=>import("./index-7e2bc68a.js"),["assets/index-7e2bc68a.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-fe8260f5.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-0f7b9244.js"])),vx=l.lazy(()=>v(()=>import("./index-c248200a.js"),["assets/index-c248200a.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-fe8260f5.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/get-last-year-for-period-e1de6b16.js","assets/index-0f7b9244.js"])),_x=l.lazy(()=>v(()=>import("./index-259010ce.js"),["assets/index-259010ce.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js"])),wx=l.lazy(()=>v(()=>import("./index-2bee9d4f.js"),["assets/index-2bee9d4f.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-0f7b9244.js"])),jx=l.lazy(()=>v(()=>import("./index-4fc038ef.js"),["assets/index-4fc038ef.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-0f7b9244.js"])),kx=l.lazy(()=>v(()=>import("./index-20dbb3db.js"),["assets/index-20dbb3db.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js","assets/index-0f7b9244.js"])),Sx=l.lazy(()=>v(()=>import("./index-7ff1ffdc.js"),["assets/index-7ff1ffdc.js","assets/vendor-2324f29b.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-fe8260f5.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-0f7b9244.js"])),Tx=l.lazy(()=>v(()=>import("./index-e9cafc6d.js"),["assets/index-e9cafc6d.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ex=l.lazy(()=>v(()=>import("./index-40564d1b.js"),["assets/index-40564d1b.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),$x=l.lazy(()=>v(()=>import("./index-bd76aef2.js"),["assets/index-bd76aef2.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Px=l.lazy(()=>v(()=>import("./index-6afd09fa.js"),["assets/index-6afd09fa.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Cx=l.lazy(()=>v(()=>import("./index-ebc61277.js"),["assets/index-ebc61277.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ox=l.lazy(()=>v(()=>import("./index-1bdcf125.js"),["assets/index-1bdcf125.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ax=l.lazy(()=>v(()=>import("./index-2768a79f.js"),["assets/index-2768a79f.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Dx=l.lazy(()=>v(()=>import("./index-9d239834.js"),["assets/index-9d239834.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Nx=l.lazy(()=>v(()=>import("./index-d7ccab8c.js"),["assets/index-d7ccab8c.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ix=l.lazy(()=>v(()=>import("./index-325abadd.js"),["assets/index-325abadd.js","assets/vendor-2324f29b.js","assets/index-0f7b9244.js","assets/index-fe8aff91.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-teacher-subdivisions-5cd556a9.js"])),Rx=l.lazy(()=>v(()=>import("./index-6e21cf79.js"),["assets/index-6e21cf79.js","assets/vendor-2324f29b.js"]));l.lazy(()=>v(()=>import("./index-0892189d.js"),["assets/index-0892189d.js","assets/vendor-2324f29b.js","assets/index-9ab3a060.js","assets/index-1c03349a.js"]));const rs=l.lazy(()=>v(()=>import("./index-71872935.js"),["assets/index-71872935.js","assets/vendor-2324f29b.js"])),Lx=l.lazy(()=>v(()=>import("./index-8e6c1e06.js"),["assets/index-8e6c1e06.js","assets/vendor-2324f29b.js"])),zx=l.lazy(()=>v(()=>import("./index-15798aef.js"),["assets/index-15798aef.js","assets/vendor-2324f29b.js"])),Mx=l.lazy(()=>v(()=>import("./index-838f12c0.js"),["assets/index-838f12c0.js","assets/vendor-2324f29b.js"])),Fx=l.lazy(()=>v(()=>import("./index-e5de020a.js"),["assets/index-e5de020a.js","assets/vendor-2324f29b.js"])),Bx=l.lazy(()=>v(()=>import("./index-1a95a17a.js"),["assets/index-1a95a17a.js","assets/vendor-2324f29b.js"])),Hx=l.lazy(()=>v(()=>import("./index-19638c23.js"),["assets/index-19638c23.js","assets/vendor-2324f29b.js","assets/get-default-subdivision-17957fb0.js"])),Ux=l.lazy(()=>v(()=>import("./index-f9ee687b.js"),["assets/index-f9ee687b.js","assets/vendor-2324f29b.js","assets/get-default-subdivision-17957fb0.js"])),Wx=l.lazy(()=>v(()=>import("./index-ec3085e9.js"),["assets/index-ec3085e9.js","assets/vendor-2324f29b.js"])),Vx=l.lazy(()=>v(()=>import("./index-740fa74c.js"),["assets/index-740fa74c.js","assets/vendor-2324f29b.js","assets/send-hr-form-work-transfer-a676217c.js"])),Gx=l.lazy(()=>v(()=>import("./index-80cf1bb7.js"),["assets/index-80cf1bb7.js","assets/vendor-2324f29b.js","assets/send-hr-form-work-transfer-a676217c.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>u0),void 0));l.lazy(()=>v(()=>import("./index-cb4bb678.js"),["assets/index-cb4bb678.js","assets/vendor-2324f29b.js","assets/BoldText-34495506.js","assets/help-links-985eb0a1.js"]));const qx=l.lazy(()=>v(()=>import("./index-2293dc07.js"),["assets/index-2293dc07.js","assets/vendor-2324f29b.js"])),nr=l.lazy(()=>v(()=>import("./index-a6638310.js"),["assets/index-a6638310.js","assets/vendor-2324f29b.js","assets/index-9ab3a060.js","assets/index-1c03349a.js"])),sr=l.lazy(()=>v(()=>import("./index-0892189d.js"),["assets/index-0892189d.js","assets/vendor-2324f29b.js","assets/index-9ab3a060.js","assets/index-1c03349a.js"])),Yx=l.lazy(()=>v(()=>import("./index-55a07a85.js"),["assets/index-55a07a85.js","assets/vendor-2324f29b.js"]));l.lazy(()=>v(()=>import("./index-e438cdf2.js"),["assets/index-e438cdf2.js","assets/vendor-2324f29b.js","assets/index.esm-d8bc35f4.js"]));const Jx=l.lazy(()=>v(()=>import("./index-1d175ad4.js"),["assets/index-1d175ad4.js","assets/vendor-2324f29b.js"])),or=l.lazy(()=>v(()=>import("./index-d0edebcd.js"),["assets/index-d0edebcd.js","assets/vendor-2324f29b.js","assets/help-links-985eb0a1.js"])),Xx=l.lazy(()=>v(()=>import("./index-86fcf997.js"),["assets/index-86fcf997.js","assets/vendor-2324f29b.js"])),Kx=l.lazy(()=>v(()=>import("./index-64ea7d82.js"),["assets/index-64ea7d82.js","assets/vendor-2324f29b.js","assets/alert-item-e6947a50.js","assets/is-valid-url-08a91344.js"])),Qx=l.lazy(()=>v(()=>import("./index-03e0e9f2.js"),["assets/index-03e0e9f2.js","assets/vendor-2324f29b.js","assets/index-a1c689e0.js","assets/alert-item-e6947a50.js","assets/is-valid-url-08a91344.js"])),Zx=l.lazy(()=>v(()=>import("./index-5bff7aa1.js"),["assets/index-5bff7aa1.js","assets/vendor-2324f29b.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>gy),void 0));const em=l.lazy(()=>v(()=>import("./index-cc213630.js"),["assets/index-cc213630.js","assets/vendor-2324f29b.js"])),ar=l.lazy(()=>v(()=>import("./index-30fbac94.js"),["assets/index-30fbac94.js","assets/vendor-2324f29b.js","assets/index-a1c689e0.js","assets/index-1c03349a.js"])),tm=l.lazy(()=>v(()=>import("./index-4aa3caba.js"),["assets/index-4aa3caba.js","assets/vendor-2324f29b.js","assets/index-eab3c4c6.js"])),im=l.lazy(()=>v(()=>import("./index-97f07677.js"),["assets/index-97f07677.js","assets/vendor-2324f29b.js","assets/index-eab3c4c6.js"])),nm=l.lazy(()=>v(()=>import("./index-43253ffd.js"),["assets/index-43253ffd.js","assets/vendor-2324f29b.js","assets/index-eab3c4c6.js"])),sm=l.lazy(()=>v(()=>import("./index-71ac6c03.js"),["assets/index-71ac6c03.js","assets/vendor-2324f29b.js"])),om=l.lazy(()=>v(()=>import("./index-8ba482fb.js"),["assets/index-8ba482fb.js","assets/vendor-2324f29b.js","assets/index.esm-d8bc35f4.js"])),am=l.lazy(()=>v(()=>import("./index-696310a8.js"),["assets/index-696310a8.js","assets/vendor-2324f29b.js"])),rm=l.lazy(()=>v(()=>import("./index-9bcb08b0.js"),["assets/index-9bcb08b0.js","assets/vendor-2324f29b.js"])),lm=l.lazy(()=>v(()=>import("./index-00c9bdd8.js"),["assets/index-00c9bdd8.js","assets/vendor-2324f29b.js"])),cm=l.lazy(()=>v(()=>import("./index-a3f48cba.js"),["assets/index-a3f48cba.js","assets/vendor-2324f29b.js","assets/index-1f0bfda8.js"])),dm=l.lazy(()=>v(()=>import("./index-6ac860a0.js"),["assets/index-6ac860a0.js","assets/vendor-2324f29b.js"])),pm=l.lazy(()=>v(()=>import("./index-772eeb2e.js"),["assets/index-772eeb2e.js","assets/vendor-2324f29b.js","assets/help-links-985eb0a1.js"])),um=l.lazy(()=>v(()=>import("./index-532db3fa.js"),["assets/index-532db3fa.js","assets/vendor-2324f29b.js","assets/help-links-985eb0a1.js"])),hm=l.lazy(()=>v(()=>import("./index-56c7f270.js"),["assets/index-56c7f270.js","assets/vendor-2324f29b.js"])),gm=l.lazy(()=>v(()=>import("./index-cb4bb678.js"),["assets/index-cb4bb678.js","assets/vendor-2324f29b.js","assets/BoldText-34495506.js","assets/help-links-985eb0a1.js"])),fm=l.lazy(()=>v(()=>import("./index-e75583d6.js"),["assets/index-e75583d6.js","assets/vendor-2324f29b.js"])),xm=p.div`
    width: 100%;
...
`,Hm=p.div`
    ...
    justify-content: center;
    align-items: center;
`,Um=({data:e,loading:i,columns:n,columnsExtended:s,maxOnPage:o,onRowClick:a,filter:r})=>{const[c,d]=l.useState(0),u=Math.ceil(((e==null?void 0:e.length)??0)/(o??1))-1,h=o?e==null?void 0:e.slice(c*o,(c+1)*o):e;return l.useEffect(()=>{d(0)},[r]),i?t.jsx(Bm,{children:t.jsx(Ke,{})}):t.jsxs(Fm,{children:[h==null?void 0:h.map((f,g)=>t.jsx(cr,{onRowClick:a,columns:n,columnsExtended:s,el:f,index:g},g)),!(h!=null&&h.length)&&t.jsx(ge,{text:"Нет данных"}),u>0&&t.jsx(fe,{margin:"0",width:"100%"}),t.jsx(Hm,{children:t.jsx(Rm,{pages:u,condition:!!o&&!!(h!=null&&h.length),currentPage:c,setCurrentPage:d})})]})},Wm=p.div`
    display: flex;
    align-items: center;
    gap: 5px;
    transition: 0.2s;
...
`,bb=p.div`
    ...
    justify-content: center;
    width: 100%;
`,yb=()=>{const{data:{dataWorkerApplication:e}}=ye.useApplications(),[i,n]=l.useState(!0);return e?t.jsxs(vb,{children:[e.map((s,o)=>s.isDismissal?(i&&n(!1),null):t.jsx(fb,{info:s,index:o})),t.jsx(ub,{})]}):null},vb=p.div`
    display: flex;
    flex-direction: column;
    gap: 30px;
...
`,Mb=({date:e,value:i})=>t.jsxs(zb,{children:[t.jsxs($,{gap:"16px",children:[t.jsx(ft,{color:"grey",size:33,children:t.jsx(rt,{})}),t.jsxs($,{d:"column",ai:"flex-start",children:[t.jsx("span",{className:"payment-item-date",children:"Платеж"}),t.jsx(oe,{children:se(e)})]})]}),t.jsxs("span",{className:"payment-item-money",children:["+",i," ",t.jsx(rt,{})," "]})]}),Fb=p.div`
    display: flex;
    align-items: center;
    font-size: ${({fontSize:e})=>e};
...
`,Gb=({contract:e})=>{if(!e)return null;const{number:i,startDate:n,endDatePlan:s,contragent:o,sum:a,can_sign:r,file:c,student:d,signed_user_date:u}=e,{open:h}=te(),[f,g]=l.useState(!1),[m,x]=l.useState(!1),[b,y]=l.useState(!1),P=_i(st.$error),I=[{text:"Номер договора",info:i??""},{text:"Начало действия",info:se(n)},{text:"Действует до",info:se(s)},{text:"Подписан",info:se(u)},{text:"Заказчик",info:o||"Московский политех"},{text:"Обучающийся",info:d??""},{text:"Сумма к оплате",info:Wb(a)??""},{text:"Статус",info:""}],j=()=>{navigator.clipboard.writeText((e==null?void 0:e.number)??""),g(!0)},S=()=>{e&&(x(!0),gs.signContractFx(e.id),x(!1),y(!0))},C=()=>{h(t.jsx(Ir,{}),"Не получается подписать")};return t.jsxs(Vb,{children:[t.jsx("div",{className:"contract-info",children:I.map(({info:L,text:N})=>t.jsx(mt,{keyStr:N,value:L},L))}),r&&t.jsxs($,{d:"column",gap:"8px",children:[t.jsx(kt,{text:"Подписать договор",buttonSuccessText:"Подписан",action:S,isLoading:m,completed:b,repeatable:!1,popUpFailureMessage:P??"Не удалось подписать договор",setCompleted:y,popUpSuccessMessage:"Договор подписан",isActive:!0,pulsing:!0}),t.jsx(_,{onClick:C,text:"Не получается подписать?",background:"transparent",textColor:w.grey.main})]}),!r&&t.jsxs($,{gap:"8px",children:[t.jsx(kt,{text:"Скопировать номер договора",action:j,isLoading:!1,completed:f,setCompleted:g,popUpSuccessMessage:"Номер договора скопирован в буфер",isActive:!0}),c&&t.jsx(ki,{onClick:()=>null,href:c??"",icon:t.jsx(Kn,{}),width:"45px"})]})]})},qb=p.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    user-select: none;
...
`,cv=p.div`
    ...
    left: 12px;
    opacity: 0.7;
`,oo=e=>{var y;const{color:i,shadow:n,notifications:s,title:o,isNew:a,icon:r,isExternalPage:c,isOldLkPage:d,mode:u,id:h,background:f,orientation:g="vertical"}=e,m=g==="vertical",{settings:x}=Gt.useSettings(),b=!!((y=x["settings-home-page"].property.pages)!=null&&y.find(P=>P===h));return t.jsxs(Il,{padding:"0",width:"100%",maxWidth:"100%",height:m?"135px":"60px",isVertical:m,justifyContent:"center",shadow:n,color:i.length?i:"blue",hasNotifications:!!s,background:f,children:[(d||c)&&m&&t.jsxs(cv,{children:[d&&t.jsx(tn,{title:"Раздел в старом ЛК"}),c&&t.jsx(Vi,{title:"Раздел на внешнем ресурсе"})]}),t.jsxs("div",{className:"outside",children:[t.jsx(ft,{badge:s==null?void 0:s.toString(),color:i.length?i:"blue",children:r??t.jsx(Ep,{})}),t.jsx("b",{title:o,children:o}),!!s&&t.jsxs("span",{className:"notifications-title",children:[s," ",Nl(s,{one:"уведомление",zero:"уведомлений",twoToFour:"уведомления",fiveToNine:"уведомлений"})]})]}),u==="use"&&t.jsx(Dl,{route:e}),u==="add"?b?t.jsx(_,{icon:t.jsx(Je,{}),width:"80px",align:"center",textColor:"var(--red)",background:"var(--block)",onClick:()=>Al(h,x)}):t.jsx(_,{icon:t.jsx(wt,{}),width:"80px",textColor:"var(--green)",align:"center",background:"var(--block)",onClick:()=>Ol(h,x)}):null,a&&t.jsx("span",{className:"new",children:"New"})]})},dv=p(Il)`
    box-shadow: none;
    color: var(--blue);
    background: transparent;
...
`,hv=e=>{const{close:i}=te(),{menuPath:n,path:s,orientation:o="vertical",mode:a="use"}=e,r=o==="vertical"?17:50,c=1;if(a==="add")return t.jsx(uv,{width:o==="vertical"?c:"100%",children:t.jsx(oo,{...e,mode:a,maxWordLength:r})});const d=()=>{i(),et.changeOpen({isOpen:!1,currentPage:s.slice(1,s.length)})};return t.jsx(pv,{to:n??s,onClick:d,width:o==="vertical"?c:"100%",children:t.jsx(oo,{...e,maxWordLength:r,mode:a})})},gv=p.div`
    ...
    flex-direction: column;
    gap: 5px;
`,fv=({pages:e,showNotFound:i=!0})=>!e||!i&&Object.keys(e).length===0?null:!Object.keys(e).length&&i?t.jsx(ge,{text:"Ничего не было найдено"}):t.jsx(gv,{children:Object.values(e).map(n=>(n==null?void 0:n.show)!==!1&&l.createElement(hv,{...n,orientation:"horizontal",shadow:!1,key:n.id}))}),xv=(e,i)=>Object.values(i).reduce((n,s)=>{var o;return(be(s.title).includes(be(e))||(o=s==null?void 0:s.keywords)!=null&&o.find(a=>be(a).includes(be(e))))&&(n[s.id]=s),n},{}),mv=p.div`
    display: flex;
    flex-direction: column;
    height: 300px;
...
`,bv=p(Z)`
    width: 100%;
`,yv=({division:e})=>{const{close:i}=te();return t.jsxs(mv,{children:[t.jsxs($,{d:"column",gap:"12px",jc:"center",h:"100%",children:[t.jsx(ft,{size:120,color:"purple",children:t.jsx(oi,{})}),t.jsx(oe,{fontSize:"1.2rem",align:"center",children:e})]}),t.jsx(bv,{to:`${yl}/${e}`,onClick:i,children:t.jsx(_,{icon:t.jsx(Zo,{}),width:"100%",text:"Список"})})]})},vv=p.div`
    width: 100%;
    color: var(--text);
    padding: 0px 16px;
...
`,Ll=({title:e,children:i,bottomMargin:n,forceState:s=!1})=>{const[o,a]=l.useState(s);l.useEffect(()=>{a(s)},[s]);const r=()=>a(c=>!c);return t.jsxs(Ov,{isOpen:o,bottomMargin:n,onClick:r,children:[e&&t.jsx(Av,{children:e}),t.jsx(Dv,{isOpen:o,children:i})]})},zl=k(),Ml=k(),Nv=J(!1).on(Ml,()=>!0).on(zl,()=>!1),ro={close:zl,open:Ml},Iv={$isModalOpen:Nv},_s=l.createContext({isOpen:!1,component:void 0,back:()=>{},close:()=>{},open:()=>{},title:void 0,canBack:!1}),Rv=({children:e})=>{const[i,n]=l.useState(!1),[s,o]=l.useState([]),[a,r]=l.useState([]),c=_i(Iv.$isModalOpen),d=a.length>1,u=l.useCallback(()=>{d&&(a.pop(),s.pop(),r([...a]),o([...s]))},[a,r]),h=l.useCallback((b,y)=>{b&&(i?(r(()=>[...a,b]),o(()=>[...s,y??""])):(r(()=>[b]),o(y?[y]:[])),n(()=>!0),ro.open())},[r,n,a,i]),f=l.useCallback(()=>{n(()=>!1),ro.close()},[r,n]),g=l.useMemo(()=>a[a.length-1],[a]),m=l.useMemo(()=>s[s.length-1],[s]),x=l.useCallback(b=>{b&&r([...a,b])},[]);return l.useEffect(()=>{c!==i&&n(c)},[c]),t.jsx(_s.Provider,{value:{back:u,open:h,close:f,isOpen:i,canBack:d,component:g,title:m,setComponent:x},children:e})},te=()=>{const{open:e,isOpen:i,...n}=l.useContext(_s);return{open:e,isOpen:i,...n}},Lv="2.3.0",Fl=()=>t.jsx(Q,{icon:null,type:"info",title:Lv,width:"38px",fontSize:"0.65rem",padding:"7px 0px",align:"center"}),Oe=({color:e,children:i})=>t.jsx(ft,{color:e,children:i}),zv=()=>({info:t.jsx(Oe,{color:"grey",children:t.jsx(Ye,{})}),message:t.jsx(Oe,{color:"red",children:t.jsx(Zn,{})}),alert:t.jsx(Oe,{color:"purple",children:t.jsx(Jo,{})}),"payment-dorm":t.jsx(Oe,{color:"green",children:t.jsx(rt,{})}),"payment-ed":t.jsx(Oe,{color:"green",children:t.jsx(rt,{})}),"digital-services":t.jsx(Oe,{color:"red",children:t.jsx(D,{})}),"doc-for-review":t.jsx(Oe,{color:"blue",children:t.jsx(D,{})}),"hr-applications":t.jsx(Oe,{color:"green",children:t.jsx(D,{})}),"kpi-pps":t.jsx(Oe,{color:"pink",children:t.jsx(Wo,{})}),schedule:t.jsx(Oe,{color:"pink",children:t.jsx(Ct,{})}),"version-update":t.jsx(Fl,{}),"electronic-interaction":t.jsx(Oe,{color:"blue",children:t.jsx(Ko,{})})}),Mv=p(Z)`
    width: 100%;
    display: flex;
    align-items: center;
    padding: 4px;
...
`,Xv=()=>{const{showMessage:e,showSearchResult:i,searchValue:n,setSearchValue:s,currentPage:o,setCurrentPage:a,loading:r,config:c,searchHistory:d}=Gv(),u=qv(r,n,d),{isOpen:h}=te();return t.jsx(Jv,{children:t.jsxs($,{d:"column",gap:"8px",h:"100%",children:[t.jsx(Ya,{value:n,setValue:s,loading:r,focusOn:h,hints:u}),t.jsx(as,{pages:c.map(({title:f})=>({title:f})),currentPage:o,setCurrentPage:a}),t.jsx(qa,{value:n,setValue:s}),e&&t.jsx($,{h:"100%",children:t.jsx(ge,{size:"60px",text:'Введите что-нибудь. Например, "Цифровые сервисы"',image:t.jsx(Mt,{})})}),!r&&n.length!==0&&!e&&!Xi(c[o].data)&&t.jsx($,{h:"100%",children:t.jsx(ge,{size:"60px",text:"Ничего не было найдено",image:t.jsx(Ro,{})})}),r&&Array(10).fill(0).map((f,g)=>t.jsx(Yv,{},g)),i&&t.jsx(t.Fragment,{children:c[o].content})]})})},Kv=p(Qe)`
    cursor: pointer;
...
`;function Ai({selected:e,name:i,avatar:n,width:s,height:o,marginRight:a,notifications:r,checked:c,boxShadow:d,border:u,icon:h,avatarModal:f,onClick:g,borderRadius:m,background:x}){const[b,y]=l.useState(!0),P=Un(i)[0]+(Un(i)[1]??""),{open:I}=te(),j=S=>{f?I(t.jsx(Ai,{name:i,width:"400px",height:"400px",marginRight:"0",avatar:n})):g==null||g(S)};return t.jsxs(t1,{selected:e,width:s,height:o,marginRight:a,background:x??De(i),boxShadow:d,border:u,onClick:j,borderRadius:m,children:[n&&b?t.jsx(i1,{loading:"lazy",round:!0,onLoadedData:()=>y(!0),onError:()=>y(!1),src:n}):t.jsx("div",{className:"name",children:P}),h&&t.jsx("span",{className:"icon",children:h}),t.jsx(qe,{invisibleOnFalse:!0,checked:c??!1,visible:c!==void 0,setChecked:()=>null}),t.jsx(St,{left:"80%",top:"90%",outline:"4px solid var(--block)",visible:!!r,children:r})]})}const CT=p.header`
    width: 100%;
    /* max-width: 750px; */
    padding-top: 100px;
    position: relative;
...
`,Vl=()=>{const{close:e}=te(),{notifications:i}=tt.useLkNotifications(),n=3;return t.jsxs($,{d:"column",gap:"30px",w:"100%",mw:"400px",children:[t.jsxs($,{d:"column",gap:"16px",children:[t.jsx(d1,{maxNotificationsVisible:n}),t.jsxs(oe,{width:"100%",visible:i.length>n,children:["Еще ",i.length-n," ",Nl(i.length-n,{one:"уведомление",twoToFour:"уведомления",fiveToNine:"уведомлений",zero:"уведомлений"}),"..."]})]}),i.length>0&&t.jsx(Z,{to:Tl,style:{width:"100%"},children:t.jsx(_,{width:"100%",text:"Показать все",onClick:e})})]})},u1=()=>{const{notifications:e}=tt.useLkNotifications(),{open:i}=te(),n=()=>{i(t.jsx(Vl,{}),"Уведомления")};return t.jsxs(p1,{onClick:n,children:[t.jsx(St,{outline:"none","box-shadow":"0px 0px 0px 3px var(--block)",color:"red",top:"14px",left:"30px",visible:e.length>0,pulsing:!0,className:"notification-circle",shadow:!0,children:e.length>10?"10+":e.length}),t.jsx(nn,{})]})},h1=p.div`
    position: relative;
`,Gl=()=>{const{open:e}=te(),{notifications:i}=tt.useLkNotifications(),n=()=>Ie.close(),s=()=>{nt.evokeConfirm({message:"Вы точно хотите выйти из аккаунта?",onConfirm:$t.logout}),n()},o=()=>{Ie.close(),e(t.jsx(wc,{}),"Что нового")},a=()=>{e(t.jsx(Vl,{}),"Уведомления"),Ie.close()};return t.jsxs(t.Fragment,{children:[t.jsx(Nw,{padding:"8px",size:"small"}),t.jsx(fe,{}),t.jsx(Wl,{type:"h-button"}),t.jsx(fe,{}),t.jsx(Z,{to:bs,children:t.jsx(_,{text:"Профиль",background:"var(--block)",icon:t.jsx(Xo,{}),width:"100%",align:"left",onClick:n,padding:"10px"})}),t.jsxs(h1,{children:[t.jsx(_,{onClick:a,icon:t.jsx(nn,{}),text:"Уведомления",width:"100%",background:"var(--block)",align:"left",padding:"10px"}),t.jsx(St,{visible:i.length>0,top:"50%",right:"0px",pulsing:!0,shadow:!0,children:i.length})]}),t.jsx(Z,{to:me,children:t.jsx(_,{text:"Настройки",background:"var(--block)",icon:t.jsx(Yo,{}),width:"100%",align:"left",onClick:n,padding:"10px"})}),t.jsx("a",{href:`${R}/index.php`,children:t.jsx(_,{text:"Старый дизайн",icon:t.jsx(tn,{}),width:"100%",background:"var(--block)",align:"left",padding:"10px"})}),t.jsx(fe,{}),t.jsx(_,{align:"left",icon:t.jsx(Ap,{}),onClick:s,text:"Выйти",width:"100%",background:"var(--block)",padding:"10px"}),t.jsx(fe,{}),t.jsx(_,{align:"left",icon:t.jsx(Fl,{}),onClick:o,text:"Что нового",width:"100%",background:"var(--block)",padding:"10px"})]})},g1=p.div`
    padding: 4px;
    border-radius: var(--brLight);
    display: flex;
    align-items: center;
...
`,f1=({showSearch:e=!1})=>{const{data:{user:i}}=ve.useUser();if(!i)return null;const n=s=>{s.preventDefault(),s.stopPropagation(),Ie.open({e:s,height:143,content:t.jsx(Gl,{})})};return t.jsxs(g1,{children:[e&&t.jsx(Ul,{size:"icon"}),t.jsx(u1,{}),t.jsx(Ai,{onClick:n,width:"30px",height:"30px",avatar:i.avatar,name:i.fullName,marginRight:"0"})]})},x1=p.header`
    width: calc(100% - 15px);
...
`,q1=()=>{const{isOpen:e,message:i,onConfirm:n,onReject:s}=Ea.useConfirm(),o=l.useRef(null);qt(o,()=>nt.closeConfirm());const a=()=>{n(),nt.closeConfirm()},r=()=>{nt.closeConfirm()};return t.jsx(fn,{isOpen:e,children:t.jsxs(G1,{isOpen:e,ref:o,children:[t.jsx(U,{size:3,align:"left",children:i??"Хотите продолжить?"}),t.jsxs(Ee,{width:"100%",scroll:!1,direction:"horizontal",gap:5,padding:"10px 0 0 0",horizontalAlign:"right",children:[t.jsx(_,{text:"Да",onClick:a,width:"90px",textColor:w.red.main,background:"transparent",hoverBackground:w.red.transparent3}),t.jsx(_,{text:"Нет",onClick:s??r,width:"90px",textColor:w.blue.main,background:"transparent",hoverBackground:w.blue.transparent3})]})]})})},Y1=p.div`
    display: flex;
...
`,x_=({isVisible:e=!0,shift:i,scale:n,interval:s,showTime:o=!0})=>{const[a,r]=l.useState(uo(new Date,s[0]*60,s[1]*60)),c=l.useRef(null);return l.useEffect(()=>(c.current=setInterval(()=>{r(uo(new Date,s[0]*60,s[1]*60))},ts.minute),()=>clearInterval(c.current)),[e]),t.jsx(g_,{currentTime:(a-i)*n,children:o&&t.jsx(f_,{children:c_(a)})})},Zl=e=>{if(e.includes("https://")){const i=e.split(" "),n=i.findIndex(o=>o.includes("https")),s=i.splice(n,n+1)[0];return{name:i.join(" "),link:s}}return{name:e}},Pe=({icon:e,text:i,onClick:n,rightIcon:s,shortInfo:o=!1})=>t.jsxs(u_,{onClick:n,shortInfo:o,gap:"7px",mw:"100%",w:"fit-content",children:[t.jsx(ho,{shortInfo:o,children:e}),t.jsx(h_,{width:"100%",className:"text",children:i}),t.jsx(ho,{shortInfo:o,children:s})]}),m_=p.div`
    display: flex;
    flex-direction: column;
    gap: 8px;
...
`,C_=e=>{const{timeInterval:i,name:n,place:s,teachers:o,dateInterval:a,link:r,rooms:c,groups:d,color:u,weekday:h,isNextEvent:f,isCurrentEvent:g,noPadding:m=!1}=e,x=(d==null?void 0:d.split(","))??[],{open:b}=te(),y=()=>{x.length===1?b(t.jsx(Rl,{group:x[0]})):b(t.jsx(y_,{groups:x}),"Группы")},P=()=>{b(t.jsx(A_,{place:s,link:r,name:n}))},I=Zl(n);return t.jsxs($_,{children:[t.jsx(w_,{subjectName:n,color:u,noPadding:m}),t.jsxs(P_,{noPadding:m,d:"column",gap:"20px",ai:"flex-start",children:[t.jsxs($,{jc:"space-between",ai:"flex-start",d:"column",gap:"6px",children:[t.jsxs($,{gap:"8px",children:[t.jsx(ec,{isCurrentEvent:g,color:u,timeInterval:i}),t.jsx(tc,{timeLeft:xn(i.split(" - ")[0],"minutes"),isNext:f,color:u,isCurrentEvent:g})]}),t.jsx(U,{size:3,align:"left",width:"fit-content",children:I.name})]}),t.jsx(fe,{margin:"0",width:"100%"}),t.jsx(Pe,{icon:t.jsx(Qn,{}),text:t.jsx(Ne,{words:[h??"",a]})}),((r==null?void 0:r.length)||I.link)&&t.jsx("a",{href:r??I.link,target:"_blank",rel:"noreferrer",children:t.jsx(Pe,{icon:t.jsx(Vi,{}),text:r?s:"Ссылка"})}),!(r!=null&&r.length)&&t.jsx(Pe,{icon:t.jsx(na,{}),text:s}),!!c.length&&t.jsx(Pe,{icon:t.jsx(Cn,{}),text:t.jsx(Ne,{words:c})}),!!x.length&&t.jsx(Pe,{onClick:y,icon:t.jsx(es,{}),text:t.jsx(Ne,{words:x}),rightIcon:t.jsx(pt,{})}),t.jsx($,{d:"column",ai:"flex-start",children:!!o[0].length&&t.jsxs(t.Fragment,{children:[t.jsx(U,{size:4,align:"left",bottomGap:!0,children:"Преподаватели"}),o.map(j=>t.jsx(js,{type:"staff",name:j},j))]})}),!r&&t.jsx(fe,{margin:"0",width:"100%"}),!r&&t.jsx(_,{text:"Посмотреть на карте",width:"100%",onClick:P})]})]})};p.span`
    padding: 3px 10px;
    height: 21px;
    display: flex;
    align-items: center;
...
`,A_=({place:e,link:i,name:n})=>{const[s,o]=l.useState(!1);return l.useEffect(()=>{o(!0),setTimeout(()=>o(!1),500)},[n]),s?t.jsx(go,{children:t.jsx($,{jc:"center",children:t.jsx(Ke,{})})}):t.jsx(go,{children:e==="Webex"?t.jsx(Fi,{title:e,link:i,image:"https://lh3.googleusercontent.com/-IR3NTxu_EJY/YMB7bMtdDOI/AAAAAAAAAmA/57OhYSNULo0ICfc3Q4TWAoRM7ohUFLJmwCLcBGAsYHQ/s220-w220-h140-nd/220x140%2BCisco%2BWebex%25281%2529.png"}):e==="Zoom"?t.jsx(Fi,{title:e,link:i,image:"https://yogaworks.ru/wp-content/uploads/2020/04/zoom-banner-600x300-600x300.jpg"}):e==="Обучение LMS"?t.jsx(Fi,{title:e,link:i,image:"https://online.mospolytech.ru/pluginfile.php/1/theme_opentechnology/settings_setpolytech_header_backgroundimage/1638781183/01.jpg"}):e==="Webinar"?t.jsx(Fi,{title:e,link:i,image:"https://apix-drive.com/ru/img/webinar_ru.png"}):e==="Прянишникова"?t.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[t.jsx("a",{href:"https://yandex.ru/maps/213/moscow/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"0px"},children:"Москва"}),t.jsx("a",{href:"https://yandex.ru/maps/213/moscow/house/ulitsa_pryanishnikova_2a/Z04YcwNjTkAPQFtvfXRycntjbA==/?ll=37.545032%2C55.833931&utm_medium=mapframe&utm_source=maps&z=17",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"14px"},children:"Улица Прянишникова, 2А на карте Москвы, ближайшее метро Коптево — Яндекс Карты"}),t.jsx("iframe",{src:"https://yandex.ru/map-widget/v1/-/CCUBAPA0PC",width:"560",height:"400",frameBorder:"1",allowFullScreen:!0,style:{position:"relative"}})]}):e==="Автозаводская"?t.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[t.jsx("a",{href:"https://yandex.ru/maps/213/moscow/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"0px"},children:"Москва"}),t.jsx("a",{href:"https://yandex.ru/maps/213/moscow/house/avtozavodskaya_ulitsa_16/Z04YcANlSEwBQFtvfXtxdX5hZA==/?ll=37.646696%2C55.704260&utm_medium=mapframe&utm_source=maps&z=18.17",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"14px"},children:"Автозаводская улица, 16 — Яндекс Карты"}),t.jsx("iframe",{src:"https://yandex.ru/map-widget/v1/-/CCUBAPsXDC",width:"560",height:"400",frameBorder:"1",allowFullScreen:!0,style:{position:"relative"}})]}):e==="Павла Корчагина"?t.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[t.jsx("a",{href:"https://yandex.ru/maps/org/moskovskiy_politekhnicheskiy_universitet/1743307891/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"0px"},children:"Московский Политехнический университет"}),t.jsx("a",{href:"https://yandex.ru/maps/213/moscow/category/university_college/184106140/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"14px"},children:"ВУЗ в Москве"}),t.jsx("iframe",{src:"https://yandex.ru/map-widget/v1/-/CCUBAPtC9A",width:"560",height:"400",frameBorder:"1",allowFullScreen:!0,style:{position:"relative"}})]}):e==="Большая Семеновская"?t.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[t.jsx("a",{href:"https://yandex.ru/maps/org/moskovskiy_politekhnicheskiy_universitet/1113152789/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"0px"},children:"Московский политехнический университет"}),t.jsx("iframe",{src:"https://yandex.ru/map-widget/v1/-/CCUBATAEkC",width:"560",height:"400",frameBorder:"1",allowFullScreen:!0,style:{position:"relative"}})]}):e==="Михалковская "&&t.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[t.jsx("a",{href:"https://yandex.ru/maps/org/sportivny_klub_sektsiya/1699871922/?utm_medium=mapframe&utm_source=maps",style:{color:"#eee",fontSize:"12px",position:"absolute",top:"0px"},children:"Спортивный клуб, секция"}),t.jsx("iframe",{src:"https://yandex.ru/map-widget/v1/-/CCUBA-FspD",width:"560",height:"400",frameBorder:"1",allowFullScreen:!0,style:{position:"relative"}})]})})},fo=p.div`
    ...
    font-size: 0.65rem;
    font-weight: 500;
`,tc=({timeLeft:e,isNext:i,color:n,isCurrentEvent:s})=>{const o=Math.floor(e/60),{theme:a}=gt(),r=a==="light"?n.dark3:n.light3,c=a==="light"?n.transparent1:n.transparent3;return!i&&!s?null:s?t.jsx(fo,{background:c,color:r,children:"Сейчас"}):t.jsxs(fo,{background:c,color:r,children:["через ",!!o&&o+"ч."," ",e%60,"мин."]})},D_=p.div`
    width: 100%;
    background: var(--block);
    padding: 20px 15px;
    border-radius: 9px;
...
`,nw=p($)`
    ...
    margin-left: 0px;
    margin-right: 0px;
`,sw=e=>{const{title:i,duration:n,icon:s,startTime:o,place:a,people:r,shift:c,color:d,scale:u,onClick:h,link:f,rooms:g,dateInterval:m,leftShift:x,quantity:b,groups:y,isCurrentEvent:P=!1,nameInOneRow:I=!0,isNextEvent:j=!1,listView:S=!1,shortInfo:C=!1}=e,{theme:L}=gt(),{isMobile:N}=Ci(),K=L==="light"?d.dark3:d.light3,z=L==="light"?d.transparent1:d.transparent2,ie=()=>h(e),ce=(N||b>1)&&C,$e=N&&b>=2&&C,je=r==null?void 0:r.map(ze=>{var Ni,Ii;const Qt=ze.split(" ");return`${Qt[0]??""} ${((Ni=Qt[1])==null?void 0:Ni[0])??""}.${((Ii=Qt[2])==null?void 0:Ii[0])??""}.`}),Ve=vc(o,c,u),he=Zl(i),Ce=$e?i.split(" ").map(ze=>ze[0].toUpperCase()):Hn(he.name,C?ce?43:35:I?300:64),Di=(y==null?void 0:y.split(","))??[];return t.jsxs(Z_,{background:z,textColor:K,listView:S,leftShift:100*x,quantity:100/b,duration:n,scale:u,top:Ve,onClick:ie,shortInfo:C,children:[t.jsx(iw,{children:s}),t.jsx($,{className:"event-body",gap:"0px",ai:"flex-start",children:t.jsxs(ew,{scale:u,d:"column",ai:"flex-start",shortInfo:C,children:[t.jsxs($,{d:"column",gap:"2px",children:[!C&&t.jsxs($,{gap:"8px",children:[t.jsx(ec,{timeInterval:mc(o,n),color:d,isCurrentEvent:P}),t.jsx(tc,{timeLeft:xn(o,"minutes"),isNext:j,color:d,isCurrentEvent:P}),!!(g!=null&&g.length)&&t.jsx(Pe,{shortInfo:C,icon:N&&b>1?void 0:t.jsx(Cn,{}),text:t.jsx(Ne,{words:g})}),(!!f||he.link)&&t.jsx("a",{href:f??he.link,target:"_blank",rel:"noreferrer",children:t.jsx(Pe,{shortInfo:C,icon:t.jsx(Vi,{}),text:f?a:"Cсылка"})}),!!Di.length&&t.jsx(Pe,{icon:t.jsx(es,{}),text:t.jsx(Ne,{words:Di})})]}),t.jsx(tw,{listView:S,nameInOneRow:I,scale:u,shortInfo:C,children:Ce})]}),!!r.length&&!ce&&t.jsx(Pe,{shortInfo:C,text:t.jsx(Ne,{words:C?[je[0]]:je}),icon:t.jsx(yu,{})}),!!(g!=null&&g.length)&&C&&!ce&&t.jsx(Pe,{shortInfo:C,icon:t.jsx(Cn,{}),text:t.jsx(Ne,{words:g})}),!!f&&C&&!ce&&t.jsx("a",{href:f,target:"_blank",rel:"noreferrer",children:t.jsx(Pe,{shortInfo:C,icon:t.jsx(Vi,{}),text:a})}),!!m&&!ce&&t.jsx($,{gap:"5px",children:t.jsx(Pe,{shortInfo:C,icon:t.jsx(Qn,{}),text:m})})]})})]})},ow=e=>{const i={};if(!e)return i;for(let n=0;n<e.length;n++){const s=e[n];i[s.startTime]||(i[s.startTime]=[]),s.startTime==="18:20"?(i["17:50"]||(i["17:50"]=[]),i["17:50"].push(s)):s.startTime==="19:50"&&i["19:30"]?(i["19:30"]||(i["19:30"]=[]),i["19:30"].push(s)):s.startTime==="19:30"&&i["19:50"]?(i["19:50"]||(i["19:50"]=[]),i["19:50"].push(s)):i[s.startTime].push(s)}return i},aw=({events:e,shift:i,scale:n,shortInfo:s,weekDay:o,interval:a,showTime:r,onClick:c,currentDay:d,isCurrentDay:u})=>{const h=ow(e),f=u??new Date().getDay()===o,g=d!==void 0?d+1===o:void 0;return t.jsxs(nw,{h:"100%",d:"column",children:[f&&t.jsx(x_,{isVisible:g,showTime:r,scale:n,shift:i,interval:a}),Object.keys(h).map((m,x)=>h[m].map((b,y)=>l.createElement(sw,{leftShift:y,quantity:h[m].length,scale:n,isCurrentEvent:Ss(b,f),isNextEvent:Ql(e,b,f),...b,onClick:c,shift:i,key:b.startTime+b.title+x+y,shortInfo:s})))]})},rw=p($)`
    position: absolute;
    left: 0;
    z-index: 0;
...
`,gw=({icon:e,title:i,color:n,goTo:s,visible:o=!0})=>{const{close:a}=te();return o?t.jsxs(hw,{color:n,children:[t.jsx("div",{className:"icon",children:e}),t.jsx("span",{className:"title",children:i}),!!s&&t.jsx(Z,{to:s,children:t.jsx(_,{text:"Перейти",onClick:a,background:"var(--almostTransparent)",width:"100%"})})]}):null},fw=p.div`
    width: 100%;
    height: 100%;
    display: flex;
    align-items: center;
...
`,mw=p(oe)`
    margin-bottom: 20px;
`,bw=({image:e,list:i,text:n})=>{const{isMobile:s}=Ci();return t.jsxs(fw,{children:[!!e&&t.jsxs(t.Fragment,{children:[t.jsx(U,{size:3,align:"center",bottomGap:!0,children:e.title}),t.jsx("div",{className:"image",children:e.component??t.jsx("img",{src:s&&e.mobile?e.mobile:e.desktop,alt:""})})]}),t.jsx(mw,{lineHeight:"1.6rem",width:"100%",align:"center",fontSize:"1rem",visible:!!n,children:n}),!!i&&t.jsx(xw,{children:i==null?void 0:i.map(o=>l.createElement(gw,{...o,key:o.title}))})]})},yw=p.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: center;
...
`,rj=({value:e,setValue:i,leftIcon:n,title:s,required:o,width:a,minWidth:r,placeholder:c="Начните ввод...",danger:d,isActive:u=!0,inputAppearance:h=!0,suggestions:f})=>{const[g,m]=l.useState([]),[x,b]=l.useState(!0);return l.useEffect(()=>{if(e){const y=f.filter(P=>P.toLowerCase().includes(e.toLowerCase()));m(y)}else m([])},[e,f]),t.jsxs(sj,{leftIcon:!!n,isActive:u,inputAppearance:h,width:a,danger:d,minWidth:r,children:[t.jsx(U,{size:5,align:"left",visible:!!s,bottomGap:"5px",required:o,children:s}),t.jsxs("div",{children:[t.jsx("input",{type:"text",value:e,onChange:y=>{i(y.target.value),b(!0)},placeholder:c}),g.length>0&&t.jsx(oj,{width:"100%",isOpen:x,className:x?"open":"close",itemsAmount:g.length,title:s,children:g.map((y,P)=>t.jsx(aj,{isSelected:!1,onClick:()=>{i(y),m([]),b(!1)},children:y},P))})]})]})},lj=p.div`
    width: 100%;
    text-align: start;
    margin-top: -20px;
    margin-bottom: -10px;
...
`,RS=()=>{const{open:e,content:i,position:n}=rf.useContextMenu(),s=l.useRef(null);return qt(s,()=>Ie.close()),t.jsx(fn,{isOpen:e,children:t.jsx(IS,{isVisible:e,ref:s,left:n.x,top:n.y,onClick:o=>{o.stopPropagation()},children:i})})},Jd=200,LS=5e3,zS=()=>{const{visibleNotifications:e}=tt.useLkNotifications(),[i,n]=l.useState(null),s=l.useRef(),o=a=>(s.current=void 0,()=>{n(a),setTimeout(()=>{Et.clearVisibleById(a)},Jd)});return l.useEffect(()=>{var a,r;e.length&&s.current===void 0&&(s.current=setTimeout(o((a=e[0])==null?void 0:a.id),((r=e[0])==null?void 0:r.duration)??LS))},[e]),{handleClose:o,closing:i}},MS=p.div`
    position: absolute;
    width: 320px;
    max-width: 500px;
    bottom: 10px;
...
`,oT=()=>{const{data:{user:e}}=ve.useUser(),i=l.useRef(null),{allRoutes:n}=Be.useMenu(),{currentPage:s}=tT(),[o,a]=l.useState(!1),r=c=>{a(c.currentTarget.scrollTop>0)};return Yd(i.current),t.jsxs(iT,{children:[t.jsx(HS,{loading:!e||!n}),t.jsx(QS,{}),t.jsx(z1,{}),t.jsxs(nT,{children:[t.jsx(k1,{headerVisible:o,currentPage:s}),t.jsx(sT,{ref:i,onScroll:r,withHeader:!(s!=null&&s.withoutHeader),children:t.jsx(Hd,{children:t.jsx(l.Suspense,{fallback:null,children:t.jsx(NS,{})})})}),t.jsx(kw,{})]}),t.jsx(V1,{}),t.jsx(F1,{}),t.jsx(q1,{}),t.jsx(RS,{}),t.jsx(Ow,{}),t.jsx(BS,{})]})},aT=le.memo(oT),rT=()=>{const{data:{isAuthenticated:e,user:i}}=ve.useUser(),{data:n}=lt.selectors.useData(),{settings:s}=Gt.useSettings();return Yd(window),l.useEffect(()=>{window.location.href==="https://e.mospolytech.ru/?p=children#/home"&&window.location.replace("https://e.mospolytech.ru/old/index.php?p=children")},[window.location.href]),l.useEffect(()=>{e&&(Re.getUserDataApplicationsFx(),(i==null?void 0:i.user_status)==="staff"&&(lt.effects.getFx(),Re.getWorkerPosts(),Vd()),AS.load())},[e,i]),l.useEffect(()=>{i&&(s?et.defineMenu({user:i,adminLinks:n,homeRoutes:s["settings-home-page"].property.pages}):fg.getLocalSettingsFx(i.id))},[i,n,s]),e?t.jsx(aT,{}):t.jsx(l.Suspense,{fallback:null,children:t.jsxs(sa,{children:[iv.map(({path:o,Component:a},r)=>t.jsx(oa,{path:o,component:a,exact:!0},r)),t.jsx(Ge,{exact:!0,to:xl})]})})},lT=p.div`
    background: var(--theme);
    overflow-y: auto;
    flex: 1;
    display: flex;
    width: 100%;
`;jS();const cT=()=>(gt(),t.jsx(Rv,{children:t.jsx(Nu,{basename:"/",children:t.jsx(lT,{children:t.jsx(Hd,{children:t.jsx(rT,{})})})})}));Iu.render(t.jsxs(le.StrictMode,{children:[t.jsx(j_,{}),t.jsx(cT,{})]}),document.getElementById("root"));export{Bd as $,_j as A,_ as B,qe as C,fe as D,as as E,os as F,GT as G,Bg as H,Oc as I,ge as J,mt as K,Ke as L,Q as M,W as N,V as O,$y as P,Qh as Q,Uw as R,kt as S,U as T,Te as U,_1 as V,Ue as W,_T as X,ve as Y,ki as Z,iS as _,H as a,Ai as a$,Et as a0,tS as a1,ws as a2,HT as a3,UT as a4,yT as a5,ye as a6,Re as a7,WT as a8,on as a9,$s as aA,f0 as aB,nb as aC,ST as aD,sb as aE,jT as aF,P0 as aG,kT as aH,ps as aI,pb as aJ,qd as aK,TT as aL,hv as aM,Yw as aN,pj as aO,re as aP,Rc as aQ,Ji as aR,tv as aS,PT as aT,xv as aU,fv as aV,Ph as aW,We as aX,be as aY,ET as aZ,ys as a_,Qe as aa,Hn as ab,Ee as ac,Nl as ad,Sh as ae,Th as af,Xa as ag,BT as ah,js as ai,Ka as aj,$v as ak,Cv as al,Be as am,Ev as an,El as ao,ev as ap,VT as aq,ht as ar,ue as as,Vt as at,Xe as au,wT as av,Ps as aw,qT as ax,Bh as ay,Us as az,fS as b,W_ as b$,Y as b0,Ie as b1,cn as b2,qt as b3,Da as b4,An as b5,Mh as b6,Ne as b7,ft as b8,st as b9,DT as bA,AT as bB,OT as bC,me as bD,n1 as bE,Wl as bF,Vy as bG,$t as bH,Nw as bI,nv as bJ,Zy as bK,Qy as bL,Ky as bM,nc as bN,B_ as bO,gn as bP,Oi as bQ,ts as bR,zT as bS,N_ as bT,$l as bU,I_ as bV,R_ as bW,rc as bX,It as bY,V_ as bZ,bc as b_,sy as ba,ny as bb,jw as bc,MT as bd,LT as be,sw as bf,Ql as bg,Ss as bh,FT as bi,Gt as bj,Ci as bk,Sl as bl,l1 as bm,De as bn,ks as bo,Rn as bp,H_ as bq,Ul as br,f1 as bs,R as bt,En as bu,CT as bv,Q1 as bw,NT as bx,IT as by,RT as bz,ig as c,_c as c0,C_ as c1,r_ as c2,uw as c3,aw as c4,gt as c5,ec as c6,ac as c7,Rr as c8,bi as c9,mT as cA,lS as cB,cS as cC,bT as cD,Rh as cE,uT as cF,pT as cG,Ki as cH,w_ as cI,ss as cJ,Lh as cK,tf as cL,vT as cM,wj as cN,Li as cO,bj as cP,yj as cQ,mj as cR,Ac as cS,oS as cT,q_ as ca,Il as cb,oo as cc,aa as cd,sn as ce,ov as cf,sv as cg,xT as ch,fT as ci,Al as cj,Ol as ck,ji as cl,e_ as cm,tr as cn,hT as co,vm as cp,Fa as cq,gT as cr,$T as cs,rn as ct,r1 as cu,wS as cv,Ri as cw,tt as cx,Jy as cy,d1 as cz,mn as d,xS as e,ro as f,ct as g,Ya as h,rr as i,Ze as j,Vg as k,se as l,Ch as m,o1 as n,AS as o,$S as p,ee as q,$ as r,gS as s,w as t,te as u,Rm as v,oe as w,nt as x,Es as y,Yt as z};
