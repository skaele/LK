import{u as r,y as x,p,o as d,s as i,j as e,r as F,cl as D,aO as S}from"./vendor-2324f29b.js";import{N as v,cn as b,S as m,Y as $,u as T,T as k,a$ as L,g as u,M,B as R,x as _,t as O,bH as P}from"./index-e592482b.js";const z=async a=>{const t=new FormData;return t.set("avatar",a[0]),await v.post("?changeAvatar=1",t,{headers:{"Content-Type":"multipart/form-data"}})},B=async a=>{const t=new FormData;return t.set("email",a),await v.post("?changeEmail=1",t)},g={loading:!1,completed:!1,error:null},I={data:[],...g},N={data:"",...g},U={data:"",...g},w=r(),j=r(),n=x(async a=>{try{await z(a)}catch{throw new Error("Не удалось загрузить фотографию")}}),V=p(I).on(w,(a,t)=>({...a,data:t})).on(n,a=>({...a,error:null,loading:!0,completed:!1})).on(n.doneData,a=>({...a,error:null,loading:!1,completed:!0})).on(n.fail,(a,{error:t})=>({...a,error:t.message,loading:!1,completed:!1})).on(j,(a,t)=>({...a,completed:t})),A=r(),s=x(async a=>{try{await B(a)}catch{throw new Error("Не удалось изменить email")}}),W=p(U).on(A,(a,t)=>({...a,data:t})).on(s,a=>({...a,loading:!0})).on(s.doneData,a=>({...a,loading:!1,completed:!0,error:null})).on(s.failData,(a,t)=>({...a,loading:!1,completed:!1,error:t.message})),H=r(),Y=p(N).on(H,(a,t)=>({...a,data:t})),q=()=>({avatar:d(V),adPass:d(Y),email:d(W)}),E={useData:q},o={avatar:{changeAvatar:w,changeCompleted:j},email:{changeEmail:A}},G={avatar:{postAvatarFx:n},email:{postNewEmail:s}},J=i.div`
    min-width: 500px;
    display: flex;
