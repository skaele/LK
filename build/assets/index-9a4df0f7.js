import{y as l,s as p,o as d,b$ as g,j as e}from"./vendor-561dac3a.js";import{b7 as m,a8 as x,W as P,P as j,z as y,y as v}from"./index-d124093a.js";import{c as $,L as k}from"./index-2da65ff7.js";import"./index-ade1c0ef.js";const F=l(async n=>{const{search:o="",page:c,limit:r,filter:s}=n,{data:a}=await m(o,(s==null?void 0:s.id.toString())??"",c,r);return{results:a.items}}),u=$({getFx:F,limit:50}),L=p.div`
    width: 100%;
    display: flex;
