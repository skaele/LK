import{s as d,L as K,bY as u,j as e,bZ as S,r as m,Q as L,f as I,az as $,q as W,b_ as k,bH as _,B as E,C as O,bI as F,bJ as N}from"./vendor-4af360a6.js";import{aU as v,x as z,aV as x,aW as J,aX as j,aY as T,aZ as h,l as p,B as c,a as A,a_ as H,T as f,u as R,a$ as U,ae as q,af as C,W as Q,D as B,g as V}from"./index-3edf5efe.js";import{I as G}from"./index.esm-871e6fff.js";const Y=(s,t)=>t.filter(a=>v(a.name).includes(v(s))),X=d(K)`
...
`,je=()=>{var r;const[s,t]=m.useState(null),[a,n]=m.useState(!0),i=(r=u(x))==null?void 0:r.params,o=[{avatar:void 0,name:"Стелла",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"1",amountOfUnreadMessages:10},{avatar:"https://upload.wikimedia.org/wikipedia/ru/thumb/d/df/Andrew_Garfield_as_Spider-Man.jpg/280px-Andrew_Garfield_as_Spider-Man.jpg",name:"Питер Паркер",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"2",amountOfUnreadMessages:0},{avatar:void 0,name:"Рафаэль",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"3",amountOfUnreadMessages:0},{avatar:void 0,name:"Леонардо",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"4",amountOfUnreadMessages:0},{avatar:void 0,name:"Бред Питт",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"5",amountOfUnreadMessages:0}];return e.jsxs(Te,{isOpen:a,chatId:i==null?void 0:i.chatId,children:[e.jsxs("div",{className:"chat-list-top-section",children:[e.jsx(f,{size:3,align:"left",children:"Чаты"}),e.jsx(c,{onClick:()=>n(l=>!l),icon:a?e.jsx(E,{}):e.jsx(O,{})})]}),e.jsx(C,{whereToSearch:o,searchEngine:Y,setResult:t,placeholder:"Поиск чатов"}),e.jsx(B,{margin:"10px auto"}),e.jsx(re,{chats:s??o,isOpen:a})]})},ve=d.div`
    display: flex;
    align-items: center;
    background: var(--block);
    padding: 5px 10px;
...
`,be=()=>{const[s,t]=m.useState("");return e.jsxs(ve,{children:[e.jsx(c,{icon:e.jsx(k,{}),onClick:()=>null,background:"transparent"}),e.jsx(V,{value:s,setValue:t,placeholder:"Введите сообщение..."}),e.jsx(c,{icon:e.jsx(G,{}),onClick:()=>null,background:"transparent"})]})},we=d.div`
    width: 100%;
    height: 100%;
    display: flex;
    flex-direction: column;
...
`,ke=()=>{var n;const s=(n=u(x))==null?void 0:n.params,[t,a]=m.useState(!0);return m.useEffect(()=>{a(!0),setTimeout(()=>{a(!1)},1e3)},[s.chatId]),e.jsxs(we,{children:[e.jsx(de,{name:"Леонаро ДиК априо",loading:t}),e.jsx(me,{loading:t}),e.jsx(be,{})]})},ze=d.div`
    display: flex;
    width: 100%;
    height: 100%;
`,De=()=>{var t;const s=(t=u(x))==null?void 0:t.params;return e.jsxs(ze,{children:[e.jsx(je,{}),!(s!=null&&s.chatId)&&e.jsx(M,{}),e.jsx(F,{children:e.jsx(N,{path:x,children:e.jsx(ke,{})})})]})};export{De as default};
