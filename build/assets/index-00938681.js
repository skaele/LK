import{y as l,s as p,o as d,bZ as g,j as e}from"./vendor-f1fdae2f.js";import{aV as m,V as x,W as P,w as j,m as k,k as v}from"./index-415ac6e5.js";import{c as y,L as w}from"./index-19b82201.js";import"./index-195edc1e.js";const F=l(async n=>{const{search:o="",page:c,limit:r,filter:s}=n,{data:a}=await m(o,(s==null?void 0:s.id.toString())??"",c,r);return{results:a.items}}),u=y({getFx:F,limit:50}),L=p.div`
    width: 100%;
    display: flex;
