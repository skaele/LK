import{j as s,q as P,aJ as N,by as W,s as b,L as G,K as F,aR as z,r as j,T as q,au as K,c7 as A,bN as B,bO as Q,a9 as J}from"./vendor-f4aa581a.js";import{a8 as _,D as Y,E as X,G as Z,c5 as ee,U as se,Y as $,N as M,bI as I,v as D,Q as te,c6 as v,bE as ae,c7 as ne,c8 as re,c9 as ie,y as le,ca as V,cb as x,bK as O,cc as T,cd as U,k as ce,ce as oe,L as de,aG as ue,W as he,P as pe,a0 as xe,cf as fe,cg as Se,ch as ge}from"./index-01363656.js";import{E as Ee}from"./index-0dfbbebb.js";const me=({value:e,setValue:o,onHintClick:c,onValueEmpty:d})=>{const t=/\d/.test(e),{data:{user:a}}=_.useUser(),u=async r=>t?await Z(r):await ee(r,"",1,20);return s.jsx(Y,{value:e,width:"100%",setValue:o,onHintClick:c(t),placeholder:"Поиск",customMask:t?X.groupMask:void 0,transformRequest:t?void 0:r=>r.fio,request:u,leftIcon:e.length===0?s.jsx(P,{}):t?s.jsx(N,{}):s.jsx(W,{}),onValueEmpty:(a==null?void 0:a.user_status)==="staff"?d:void 0})},je=b(G)`
    color: var(--text);
    padding: 15px 15px;
    max-width: 140px;
    width: 100%;
