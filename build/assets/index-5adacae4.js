...
`,Ve=({searchValue:i,searchResult:s,settingsConfig:e})=>{var c,o;const{allRoutes:a}=f.useMenu(),l=(c=L($))==null?void 0:c.params;return!a||e===void 0?null:t.jsx(We,{open:!!(l!=null&&l.id),children:t.jsx(Ge,{children:t.jsxs(te,{children:[i&&t.jsx(Pe,{list:s}),(o=Object.keys(e??{}))==null?void 0:o.map(u=>{const p=e[u],{path:d}=a[u];return t.jsx(T,{path:d,children:t.jsx(N,{direction:"vertical",gap:12,children:!i&&p.map(({title:g,fields:r})=>t.jsxs(P,{children:[t.jsx(He,{children:t.jsx(we,{size:4,align:"left",children:g})}),t.jsx(Ce,{fields:r,settingsName:u})]},g))})},d)}),t.jsx(T,{path:"/",children:t.jsx(D,{height:"100%",children:t.jsx(k,{text:"Ничего не выбрано",image:t.jsx(ye,{color:"grey",size:50,children:t.jsx(ie,{})})})})})]})})})},Ue=(i,s,e)=>{const a=[];if(!e)return a;let l=0,c=!1;for(const o in s){c=!1,a.push([]);const u=e[o].title.split(". ")[1];a[l].push(u);const p=s[o];for(const d of p)for(const g of d.fields)I(g.title).includes(I(i))&&(c?(a.push([...a[l].slice(0,a[l].length-1),g.title]),l++):(a[l].push(d.title),a[l].push(g.title)),c=!0);c?l++:a.pop()}return a},Qe=h(be)`
    height: 100%;
    z-index: 1;
    padding-top: 0;
    padding: 8px;
