import{s as a,j as t,co as G,cp as P,r as h,R as T,cq as W}from"./vendor-f4aa581a.js";import{cU as L,bg as l,n as $,cV as z,cW as f,y as M,N as c,bt as R,cX as q,Y as u,bs as U,cY as H,T as y,O as x,bo as V,Q as X,bk as S,bG as B,U as p,cZ as D,c_ as O,a8 as Y,W as J,P as K,x as Q,a3 as C,aD as Z}from"./index-2cf64e21.js";const w=(e,i)=>{const n=new Date(e).getMonth();return n>1&&n<8?+i*2:+i*2-1},ee=e=>{const i=w(new Date().toISOString(),e),n=[];for(let r=1;r<=i;r++)n.push({id:r,title:`${r} семестр`});return n.push({id:-1,title:"Все семестры"}),n},te=(e,i)=>L(i.filter(n=>l(n.name).includes(l(e))||l(n.teacher).includes(l(e))||l($(n.exam_date)).includes(l(e))||l(n.bill_num).includes(l(e))));function ne(e){const i={5:0,4:0,3:0,2:0},n=e.filter(r=>!!r.grade&&r.exam_type!=="Зачет").length;return e.forEach(({grade:r,exam_type:s})=>{s!=="Зачет"&&r!==void 0&&i[z[r]]++}),n===0?i:Object.keys(i).reduce((r,s)=>(r[+s]=i[+s]/n,r),{})}const ie=2.7;a.div`
    display: flex;
