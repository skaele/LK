import{s as d,a7 as S,aF as u,j as e,cb as K,r as m,a2 as L,q as I,a4 as $,G as W,cc as k,w as E,L as _,M as O,cd as F,bS as N,bT as A}from"./vendor-ab783af7.js";import{aY as b,J as z,aZ as x,a_ as J,a$ as j,b0 as T,b1 as h,l as p,o as c,d as H,b2 as R,h as f,u as U,b3 as q,b4 as G,aj as M,W as Q,G as V,n as B}from"./index-07cca455.js";const Y=(s,t)=>t.filter(a=>b(a.name).includes(b(s))),X=d(S)`
    ...
    .chat-item-content {
        ...
        background: ${({isChosen:s})=>s?z.blue.main:"var(--block)"};
        overflow: hidden;
        position: relative;
...
`,Z=({avatar:s,name:t,lastMessage:a,chatId:n,loading:i,amountOfUnreadMessages:o,isOpen:r})=>{var g;const l=(g=u(x))==null?void 0:g.params;return i?e.jsx(se,{}):e.jsx(X,{to:J+`/${n}`,isChosen:(l==null?void 0:l.chatId)===n,isOpen:r,children:e.jsxs("div",{className:"chat-item-content",children:[r?e.jsx(j,{name:t,avatar:s,width:"40px",height:"40px",marginRight:"7px",notifications:o}):e.jsx(j,{name:t,avatar:s,width:"45px",height:"45px",marginRight:"0",notifications:o}),r&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"name-and-message",children:[e.jsx("b",{children:t}),e.jsx("div",{className:"last-message",children:a.message})]}),e.jsx("div",{className:"sent-time",children:a.sentTime})]})]})})},ee=d.div`
    display: flex;
    align-items: center;
    padding: 10px;
...
`,se=()=>e.jsxs(ee,{children:[e.jsx(T,{shape:"circle",size:{width:"40px",height:"40px"},margin:"0 7px 0 0"}),e.jsxs("div",{className:"name-and-message",children:[e.jsx(T,{shape:"rect",size:{width:"150px",height:"12px"},margin:"2px 0"}),e.jsx(T,{shape:"rect",size:{width:"70px",height:"10px"},margin:"0"})]})]}),te=d.div`
    ...
    .name-and-message {
        display: flex;
        flex-direction: column;
        background: ${({isYourMessage:s})=>s?z.blue.main:"var(--block)"};
...
`,ae=({name:s,message:t,isLast:a})=>e.jsx(te,{isYourMessage:s==="Kostya Doloz",isLast:a,onContextMenu:n=>{h.open({e:n,content:e.jsx(ne,{message:t}),height:70})},children:e.jsxs("div",{className:"name-and-message",children:[e.jsxs("div",{className:"name-and-time",children:[e.jsx("b",{children:s}),e.jsx("span",{children:p(t.sentTime)})]}),e.jsx("span",{className:"message",children:t.message})]})}),ne=({message:s})=>e.jsx(e.Fragment,{children:e.jsx(c,{text:"Копировать",icon:e.jsx(K,{}),width:"100%",align:"left",background:"transparent",onClick:()=>{navigator.clipboard.writeText(s.message??""),h.close(),H.evokePopUpMessage({message:"Сообщение скопировано",type:"info"})}})}),ie=d.div`
    overflow-y: auto;
    max-height: ${({height:s})=>s-170+"px"};
`,re=({chats:s,isOpen:t})=>{const{height:a}=R();return e.jsxs(ie,{height:a,children:[!s.length&&e.jsx(f,{size:3,children:"Нет чатов"}),s.map(n=>m.createElement(Z,{...n,key:n.name,loading:!1,isOpen:t}))]})},oe=d.div`
    width: 100%;
    height: 50px;
    display: flex;
    align-items: center;
...
`,C=({message:s="Выберите чат"})=>e.jsx(pe,{children:e.jsx("span",{children:s})}),he=d.div`
    margin: 5px 0 10px 0;
    color: var(--text);
    position: sticky;
    top: 10px;
...
`,ue=({messages:s})=>e.jsxs(ge,{children:[Object.values(w(s)).length===0&&e.jsx(C,{message:"Нет сообщений"}),Object.values(w(s)).map((t,a)=>e.jsxs(e.Fragment,{children:[e.jsx(xe,{date:t.date}),e.jsxs("div",{className:"messages-section",children:[e.jsx("div",{className:"message-avatar",children:e.jsx(j,{name:t.messages[0].sender,avatar:t.avatar,width:"32px",height:"32px",marginRight:"0"})}),e.jsx("div",{className:"messages",children:t.messages.map((n,i)=>e.jsx(ae,{name:n.sender,message:n,isLast:i===t.messages.length-1},i))})]},a)]}))]}),fe=d.div`
...
`,je=()=>{var r;const[s,t]=m.useState(null),[a,n]=m.useState(!0),i=(r=u(x))==null?void 0:r.params,o=[{avatar:void 0,name:"Стелла",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"1",amountOfUnreadMessages:10},{avatar:"https://upload.wikimedia.org/wikipedia/ru/thumb/d/df/Andrew_Garfield_as_Spider-Man.jpg/280px-Andrew_Garfield_as_Spider-Man.jpg",name:"Питер Паркер",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"2",amountOfUnreadMessages:0},{avatar:void 0,name:"Рафаэль",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"3",amountOfUnreadMessages:0},{avatar:void 0,name:"Леонардо",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"4",amountOfUnreadMessages:0},{avatar:void 0,name:"Бред Питт",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"5",amountOfUnreadMessages:0}];return e.jsxs(Te,{isOpen:a,chatId:i==null?void 0:i.chatId,children:[e.jsxs("div",{className:"chat-list-top-section",children:[e.jsx(f,{size:3,align:"left",children:"Чаты"}),e.jsx(c,{onClick:()=>n(l=>!l),icon:a?e.jsx(_,{}):e.jsx(O,{})})]}),e.jsx(M,{whereToSearch:o,searchEngine:Y,setResult:t,placeholder:"Поиск чатов"}),e.jsx(V,{margin:"10px auto"}),e.jsx(re,{chats:s??o,isOpen:a})]})},be=d.div`
    display: flex;
    align-items: center;
    background: var(--block);
    padding: 5px 10px;
...
`,ve=()=>{const[s,t]=m.useState("");return e.jsxs(be,{children:[e.jsx(c,{icon:e.jsx(k,{}),onClick:()=>null,background:"transparent"}),e.jsx(B,{value:s,setValue:t,placeholder:"Введите сообщение..."}),e.jsx(c,{icon:e.jsx(F,{}),onClick:()=>null,background:"transparent"})]})},we=d.div`
    width: 100%;
    height: 100%;
    display: flex;
    flex-direction: column;
...
`,ke=()=>{var n;const s=(n=u(x))==null?void 0:n.params,[t,a]=m.useState(!0);return m.useEffect(()=>{a(!0),setTimeout(()=>{a(!1)},1e3)},[s.chatId]),e.jsxs(we,{children:[e.jsx(de,{name:"Леонаро ДиК априо",loading:t}),e.jsx(me,{loading:t}),e.jsx(ve,{})]})},ze=d.div`
    display: flex;
    width: 100%;
    height: 100%;
`,Ce=()=>{var t;const s=(t=u(x))==null?void 0:t.params;return e.jsxs(ze,{children:[e.jsx(je,{}),!(s!=null&&s.chatId)&&e.jsx(C,{}),e.jsx(N,{children:e.jsx(A,{path:x,children:e.jsx(ke,{})})})]})};export{Ce as default};
