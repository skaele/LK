export enum ApplicationFormCodes {
    ...
    MILDOCS = 'mildocs',
    MILITARY_REG = 'military_form_10',
    MILITARY_FORM_4 = 'military_form_4',
    MILITARY_FORM_5 = 'military_form_5',
    MILITARY_COPIES = 'military_copies',
    VOEN_UCH = 'voen_uch',
    PR_DONATE = 'pr_donate',
    PR_MATPOM = 'pr_matpom',
...
export enum ApplicationTeachersFormCodes {
    ...
    GUESTS_ACCOMMODATION_ON_CAMPUS = 'guests-accommodation-on-campus',
