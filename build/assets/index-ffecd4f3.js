import{y as p,s as l,n as d,b8 as g,j as e}from"./vendor-198a3a64.js";import{aP as m,R as x,W as P,p as j,aQ as v,aR as y}from"./index-e5639c5e.js";import{c as R,L as k}from"./index-98f9a6ab.js";import"./index-1d90b3de.js";const F=p(async n=>{const{search:o="",page:c,limit:r,filter:s}=n,{data:a}=await m(o,(s==null?void 0:s.id.toString())??"",c,r);return{results:a.items}}),u=R({getFx:F,limit:50}),L=l.div`
    width: 100%;
    display: flex;
