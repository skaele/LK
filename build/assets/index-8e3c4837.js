import{y as l,s as p,n as d,b6 as g,j as e}from"./vendor-e9654bfa.js";import{aO as m,O as x,W as P,Q as j,aP as v,aQ as y}from"./index-c2d11f9e.js";import{c as k,L as F}from"./index-f01cf6a7.js";import"./index-0b301f2f.js";const L=l(async n=>{const{search:o="",page:c,limit:r,filter:s}=n,{data:a}=await m(o,(s==null?void 0:s.id.toString())??"",c,r);return{results:a.items}}),u=k({getFx:L,limit:50}),M=p.div`
    width: 100%;
    display: flex;
