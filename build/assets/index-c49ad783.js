import{s as a,j as t,cl as T,cm as G,r as h,R as P,cn as L}from"./vendor-f1fdae2f.js";import{cC as M,aV as l,l as z,cD as $,cE as f,u as R,r as c,b5 as W,cF as q,X as u,b4 as H,cG as V,T as y,K as x,af as K,D as U,aZ as S,bj as D,E as p,cH as B,cI as C,V as X,W as J,w as Q,i as Z,Q as O,ag as Y}from"./index-4e411d46.js";const w=(e,i)=>{const n=new Date(e).getMonth();return n>1&&n<8?+i*2:+i*2-1},ee=e=>{const i=w(new Date().toISOString(),e),n=[];for(let s=1;s<=i;s++)n.push({id:s,title:`${s} семестр`});return n.push({id:-1,title:"Все семестры"}),n},te=(e,i)=>M(i.filter(n=>l(n.name).includes(l(e))||l(n.teacher).includes(l(e))||l(z(n.exam_date)).includes(l(e))||l(n.bill_num).includes(l(e))));function ne(e){const i={5:0,4:0,3:0,2:0},n=e.filter(s=>!!s.grade&&s.exam_type!=="Зачет").length;return e.forEach(({grade:s,exam_type:r})=>{r!=="Зачет"&&s!==void 0&&i[$[s]]++}),n===0?i:Object.keys(i).reduce((s,r)=>(s[+r]=i[+r]/n,s),{})}const ie=2.7;a.div`
    display: flex;
...
`,ae=({grade:e})=>t.jsx(re,{grade:e,children:e&&($[e]>2?t.jsx(T,{}):t.jsx(G,{}))}),oe=a.div`
    width: 100%;
    display: flex;
    min-height: 60px;
    align-items: center;
...
`,pe=a.div`
    margin: 20px 0;
`,ue=({item:e,color:i})=>t.jsxs(xe,{children:[t.jsx(V,{subjectName:e.name,color:i,noPadding:!0}),t.jsx(pe,{children:t.jsx(y,{size:3,align:"left",children:e.name})}),t.jsx(x,{keyStr:"Курс",value:e.course}),t.jsx(x,{keyStr:"Форма аттестации",value:e.exam_type}),t.jsx(x,{keyStr:"Дата проведения",value:z(e.exam_date)}),t.jsx(x,{keyStr:"Оценка",value:e.grade}),t.jsx(x,{keyStr:"Номер ведомости",value:e.bill_num}),t.jsx(x,{keyStr:"Семестр",value:w(e.exam_date,+e.course)}),t.jsx(x,{keyStr:"Кафедра",value:e.chair}),t.jsx(x,{keyStr:"Преподаватель",value:t.jsx(K,{type:"staff",name:e.teacher}),direction:"vertical"})]}),he=({items:e,type:i})=>t.jsx(t.Fragment,{children:e.map((n,s)=>t.jsxs(P.Fragment,{children:[t.jsx(le,{item:n,type:i}),s!==e.length-1&&t.jsx(U,{margin:"0",width:"100%"})]},n.id))}),ge=h.memo(he),me=({items:e,loading:i})=>{var n;return e?i?t.jsxs(c,{d:"column",ai:"flex-start",gap:"12px",children:[t.jsx(S,{shape:"rect",size:{width:"100px",height:"30px"}}),t.jsx(D,{quantity:5,avatarShape:"rect"}),t.jsx(S,{shape:"rect",size:{width:"100px",height:"30px"}}),t.jsx(D,{quantity:10,avatarShape:"rect"})]}):t.jsx(c,{d:"column",gap:"20px",children:(n=Object.keys(e))==null?void 0:n.map(s=>t.jsxs(c,{d:"column",children:[t.jsxs(y,{size:3,align:"left",width:"fit-content",children:[s,t.jsx(u,{children:e[s].length})]}),t.jsx(ge,{items:e[s]||[],type:s,loading:i})]},s))}):null},fe=h.memo(me),je=a.div`
    overflow: hidden;
    width: 100%;
    display: flex;
    gap: 2px;
