...
`,pt=l.forwardRef(function(i,n){const{value:s,setValue:o,leftIcon:a,title:r,required:c,width:d,minWidth:u,customMask:h,placeholder:f="Введите сюда",type:g="text",danger:m,alertMessage:x,loading:b=!1,isActive:y=!0,inputAppearance:P=!0,mask:j=!1,autocomplete:T=!1,minValue:S=void 0,maxValue:N=void 0,maxLength:z=void 0,hideCross:I=!1,stepSize:K=.1,size:R="middle"}=i,{inputType:ne,buttonOnClick:ge,danger:je,handleOnChange:Re,phoneMaskKeyDown:qe}=Gg(s,o,g,m,S,N,h,j),ue=s&&g==="date"?Xd(new Date(s),"yyyy-MM-dd"):s??"";return t.jsxs(qg,{leftIcon:!!a,isActive:y,inputAppearance:P,width:d,danger:je,minWidth:u,size:R,children:[t.jsx(H,{size:5,align:"left",visible:!!r,bottomGap:"5px",required:c,children:r}),t.jsx(Q,{type:"alert",visible:!!x,icon:t.jsx(Kd,{}),title:x??""}),a&&t.jsx("span",{className:"left-icon",children:a}),t.jsx("input",{id:f,min:S,max:N,maxLength:z,step:K??void 0,type:ne,placeholder:f,value:ue,autoComplete:T?"on":"off",onKeyDown:Pe=>g==="tel"&&qe(Pe),onChange:Re,required:c,readOnly:!y,ref:n}),g!=="password"?!!(s!=null&&s.length)&&P&&(b?t.jsx(Qe,{}):!I&&t.jsx(_,{icon:t.jsx(Ke,{}),onClick:()=>o(""),tabIndex:-1})):t.jsx(_,{icon:ne==="password"?t.jsx(Qd,{}):t.jsx(No,{}),tabIndex:-1,onClick:ge})]})}),Yg=p.div`
    user-select: none;
    min-width: 56px;
    height: 30px;
...
`,tf=({title:e,link:i,type:n})=>t.jsxs(ef,{href:i,target:"_blank",children:[t.jsx("div",{className:"icon",children:n==="document"?t.jsx(D,{}):t.jsx(Zd,{})}),t.jsx("div",{className:"title",children:e})]}),nf=(e,i=265,n=200)=>(e.preventDefault(),{x:e.clientX<window.innerWidth/2?e.clientX:e.clientX-i,y:e.clientY<window.innerHeight/2?e.clientY:e.clientY-n}),sf={open:!1,content:null,type:"left-click",position:{x:0,y:0}},of=()=>Te(af),Ma=k(),Fa=k(),Ba=k(),af=J(sf).on(Ma,(e,{content:i,e:n,height:s,type:o="left-click"})=>({position:nf(n,220,s),open:!0,content:i,type:o})).on(Fa,e=>({...e,open:!1})).on(Ba,(e,{position:i})=>({...e,position:i})),Ne={open:Ma,close:Fa,changePosition:Ba},rf={useContextMenu:of},lf=()=>{const e=navigator.userAgent;return/iPad|iPhone|iPod/.test(e)?"iOS":e.search("Mac")!==-1?"MacOS":e.search("X11")!==-1&&e.search("Linux")===-1?"UNIX":e.search("Linux")!==-1&&e.search("X11")!==-1?"Linux":/android/i.test(e)?"Android":"Windows"},jn=new Set,Ha=(e,i)=>{l.useEffect(()=>{const n=o=>{jn.add(o.key),!e.slice(0,e.length-1).find(r=>!jn.has(r))&&e[e.length-1]===o.key&&(o.preventDefault(),i())},s=o=>{jn.delete(o.key)};return window.addEventListener("keydown",n),window.addEventListener("keyup",s),()=>{window.removeEventListener("keydown",n),window.removeEventListener("keyup",s)}},[])},Ze=p.div`
    display: flex;
...
`,Ga=({value:e,width:i,placeholder:n,inputAppearance:s,loading:o,hints:a,leftIcon:r,focusOn:c,setValue:d,customMask:u,onHintClick:h,validationCheck:f=!1,size:g="middle"})=>{const[m,x]=l.useState(0),[b,y]=l.useState(!1),P=l.useRef(null),j=l.useRef(null),T=l.useRef(null);Gt(P,()=>y(!1)),l.useEffect(()=>{c&&setTimeout(()=>{var I;return(I=T.current)==null?void 0:I.focus()},50)},[c]);const S=I=>{var K,R;(((a==null?void 0:a.length)??0)>0||o)&&y(!0),I.key==="ArrowDown"?((K=j.current)==null||K.scrollIntoView({block:"start",behavior:"smooth"}),typeof m=="number"&&x(ut(m+1,((a==null?void 0:a.length)??1)-1,0))):I.key==="ArrowUp"?((R=j.current)==null||R.scrollIntoView({block:"end",behavior:"smooth"}),typeof m=="number"&&x(ut(m-1,((a==null?void 0:a.length)??1)-1,0))):I.key==="Enter"?(a!=null&&a[m??0].title&&d(a==null?void 0:a[m??0].title),y(!1),h==null||h(a==null?void 0:a[m??0])):x(0)},N=I=>()=>{x(I),d((a==null?void 0:a[I].title)??""),y(!1),h==null||h(a==null?void 0:a[I])},z=()=>{a!=null&&a.length&&y(!0)};return t.jsxs(df,{width:i,onKeyDown:S,onMouseDown:z,ref:P,children:[t.jsx(pt,{size:g,value:e,placeholder:n,leftIcon:r??t.jsx(zt,{}),inputAppearance:s,setValue:d,loading:o,width:i,mask:!0,customMask:u,ref:T}),t.jsx(Va,{setValue:d,value:e,visible:f}),b&&t.jsx(pf,{height:"fit-content",maxWidth:"100%",maxHeight:"250px",width:"100%",onKeyDown:S,padding:"0",orientation:"vertical",children:a==null?void 0:a.map(({title:I,icon:K},R)=>{const ne=m===R;return t.jsxs(uf,{onClick:N(R),ref:ne?j:null,selected:ne,children:[K&&t.jsx("div",{className:"icon",children:K}),t.jsx("span",{children:I})]},I+R)})})]})},ln=()=>{const[e,i]=l.useState({width:0,height:0}),n=()=>{i({width:window.innerWidth,height:window.innerHeight})};return l.useEffect(()=>(n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}),[]),e},Us={small:"30px",middle:"44px",big:"68px"},qa={small:"8px",middle:"10px",big:"16px"},hf={small:"0.8rem",middle:"0.9rem",big:"1rem"},gf={small:"0.65rem",middle:"0.75rem",big:"0.85rem"},ff=p.div`
...
`,Kf=()=>t.jsx(Xf,{children:t.jsx(Jf,{})}),we=({oldVersionUrl:e,errorText:i="Страница еще находится в разработке. Если вам она нужна, вернитесь к старому дизайну",buttonText:n="Перейти к старому дизайну",forceForward:s=!1,isRedirectButtonVisible:o=!0})=>(l.useEffect(()=>{s&&(window.location.href=`/old/?p=${e==null?void 0:e.slice(1,e.length)}`)},[]),t.jsx(he,{text:i,children:o&&t.jsx("a",{href:`${L}/?p=${e==null?void 0:e.slice(1,e.length)}`,children:t.jsx(_,{text:n,icon:t.jsx(en,{}),width:"100%",background:"var(--reallyBlue)",textColor:"#fff",align:"left",padding:"10px"})})})),Qf="modulepreload",Zf=function(e){return"/"+e},Vs={},v=function(i,n,s){if(!n||n.length===0)return i();const o=document.getElementsByTagName("link");return Promise.all(n.map(a=>{if(a=Zf(a),a in Vs)return;Vs[a]=!0;const r=a.endsWith(".css"),c=r?'[rel="stylesheet"]':"";if(!!s)for(let h=o.length-1;h>=0;h--){const f=o[h];if(f.href===a&&(!r||f.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${c}`))return;const u=document.createElement("link");if(u.rel=r?"stylesheet":Qf,r||(u.as="script",u.crossOrigin=""),u.href=a,document.head.appendChild(u),r)return new Promise((h,f)=>{u.addEventListener("load",h),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>i())},ex=l.lazy(()=>v(()=>import("./index-759e3f70.js"),["assets/index-759e3f70.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js"])),tx=l.lazy(()=>v(()=>import("./index-20f06164.js"),["assets/index-20f06164.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-1a20b605.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-6d48d51b.js"])),ix=l.lazy(()=>v(()=>import("./index-e83de0c6.js"),["assets/index-e83de0c6.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js"])),nx=l.lazy(()=>v(()=>import("./index-6b6a8563.js"),["assets/index-6b6a8563.js","assets/vendor-f1fdae2f.js","assets/find-current-in-select-ba4611d5.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>Ob),void 0));const sx=l.lazy(()=>v(()=>import("./index-acfe113b.js"),["assets/index-acfe113b.js","assets/vendor-f1fdae2f.js","assets/index-3d098025.js"])),ox=l.lazy(()=>v(()=>import("./index-cc01c3b7.js"),["assets/index-cc01c3b7.js","assets/vendor-f1fdae2f.js","assets/index-584929d0.js"])),ax=l.lazy(()=>v(()=>import("./index-4407a3e1.js"),["assets/index-4407a3e1.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),rx=l.lazy(()=>v(()=>import("./index-1f719754.js"),["assets/index-1f719754.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-1a20b605.js","assets/get-teacher-subdivisions-1b4fd80d.js"])),lx=l.lazy(()=>v(()=>import("./index-db249936.js"),["assets/index-db249936.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-1a20b605.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-6d48d51b.js"])),cx=l.lazy(()=>v(()=>import("./index-c5c66870.js"),["assets/index-c5c66870.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-6d48d51b.js"])),dx=l.lazy(()=>v(()=>import("./index-fa2f8749.js"),["assets/index-fa2f8749.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-1a20b605.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-6d48d51b.js"])),px=l.lazy(()=>v(()=>import("./index-a694e4cc.js"),["assets/index-a694e4cc.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/index-6d48d51b.js"])),ux=l.lazy(()=>v(()=>import("./index-d9d8d1e1.js"),["assets/index-d9d8d1e1.js","assets/vendor-f1fdae2f.js","assets/ui-e0f2b0c8.js","assets/index-e691e9da.js"])),hx=l.lazy(()=>v(()=>import("./index-e18b4492.js"),["assets/index-e18b4492.js","assets/vendor-f1fdae2f.js","assets/ui-e0f2b0c8.js"])),gx=l.lazy(()=>v(()=>import("./index-abae9441.js"),["assets/index-abae9441.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-6d48d51b.js"])),fx=l.lazy(()=>v(()=>import("./index-17fab42c.js"),["assets/index-17fab42c.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-1a20b605.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-6d48d51b.js"])),xx=l.lazy(()=>v(()=>import("./index-f54c0665.js"),["assets/index-f54c0665.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js","assets/index-6d48d51b.js"])),mx=l.lazy(()=>v(()=>import("./index-76027a6f.js"),["assets/index-76027a6f.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-6d48d51b.js"])),bx=l.lazy(()=>v(()=>import("./index-02ebe5cf.js"),["assets/index-02ebe5cf.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-1a20b605.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/get-last-year-for-period-e1de6b16.js","assets/index-6d48d51b.js"])),yx=l.lazy(()=>v(()=>import("./index-19a33edf.js"),["assets/index-19a33edf.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-1a20b605.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-6d48d51b.js"])),vx=l.lazy(()=>v(()=>import("./index-064511e1.js"),["assets/index-064511e1.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-1a20b605.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/get-last-year-for-period-e1de6b16.js","assets/index-6d48d51b.js"])),_x=l.lazy(()=>v(()=>import("./index-6717cccd.js"),["assets/index-6717cccd.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js"])),wx=l.lazy(()=>v(()=>import("./index-f4b23232.js"),["assets/index-f4b23232.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-6d48d51b.js"])),jx=l.lazy(()=>v(()=>import("./index-c3da4bd0.js"),["assets/index-c3da4bd0.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-6d48d51b.js"])),kx=l.lazy(()=>v(()=>import("./index-fb50301f.js"),["assets/index-fb50301f.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js","assets/index-6d48d51b.js"])),Sx=l.lazy(()=>v(()=>import("./index-37d4dfb4.js"),["assets/index-37d4dfb4.js","assets/vendor-f1fdae2f.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-1a20b605.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-6d48d51b.js"])),Tx=l.lazy(()=>v(()=>import("./index-e4f230ec.js"),["assets/index-e4f230ec.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ex=l.lazy(()=>v(()=>import("./index-294cec8d.js"),["assets/index-294cec8d.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),$x=l.lazy(()=>v(()=>import("./index-9a161a89.js"),["assets/index-9a161a89.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Px=l.lazy(()=>v(()=>import("./index-d3386ca2.js"),["assets/index-d3386ca2.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Cx=l.lazy(()=>v(()=>import("./index-868bc670.js"),["assets/index-868bc670.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ox=l.lazy(()=>v(()=>import("./index-e477128c.js"),["assets/index-e477128c.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ax=l.lazy(()=>v(()=>import("./index-b326c4e0.js"),["assets/index-b326c4e0.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Dx=l.lazy(()=>v(()=>import("./index-0c53b5f5.js"),["assets/index-0c53b5f5.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Nx=l.lazy(()=>v(()=>import("./index-1497b779.js"),["assets/index-1497b779.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ix=l.lazy(()=>v(()=>import("./index-870e5278.js"),["assets/index-870e5278.js","assets/vendor-f1fdae2f.js","assets/index-6d48d51b.js","assets/index-fc7c02d5.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-teacher-subdivisions-1b4fd80d.js"])),Rx=l.lazy(()=>v(()=>import("./index-cb9f964f.js"),["assets/index-cb9f964f.js","assets/vendor-f1fdae2f.js"]));l.lazy(()=>v(()=>import("./index-2e6b8165.js"),["assets/index-2e6b8165.js","assets/vendor-f1fdae2f.js","assets/index-c7e2e820.js","assets/index-e691e9da.js"]));const as=l.lazy(()=>v(()=>import("./index-6739d47c.js"),["assets/index-6739d47c.js","assets/vendor-f1fdae2f.js"])),Lx=l.lazy(()=>v(()=>import("./index-5fefd0a1.js"),["assets/index-5fefd0a1.js","assets/vendor-f1fdae2f.js"])),zx=l.lazy(()=>v(()=>import("./index-2a1d1dee.js"),["assets/index-2a1d1dee.js","assets/vendor-f1fdae2f.js"])),Mx=l.lazy(()=>v(()=>import("./index-d6d2e146.js"),["assets/index-d6d2e146.js","assets/vendor-f1fdae2f.js"])),Fx=l.lazy(()=>v(()=>import("./index-e284cb0a.js"),["assets/index-e284cb0a.js","assets/vendor-f1fdae2f.js"])),Bx=l.lazy(()=>v(()=>import("./index-24e1d5ff.js"),["assets/index-24e1d5ff.js","assets/vendor-f1fdae2f.js"])),Hx=l.lazy(()=>v(()=>import("./index-a6ab91df.js"),["assets/index-a6ab91df.js","assets/vendor-f1fdae2f.js","assets/get-default-subdivision-17957fb0.js"])),Ux=l.lazy(()=>v(()=>import("./index-8fdd5ed4.js"),["assets/index-8fdd5ed4.js","assets/vendor-f1fdae2f.js","assets/get-default-subdivision-17957fb0.js"])),Wx=l.lazy(()=>v(()=>import("./index-5009429b.js"),["assets/index-5009429b.js","assets/vendor-f1fdae2f.js"])),Vx=l.lazy(()=>v(()=>import("./index-fd49ca7c.js"),["assets/index-fd49ca7c.js","assets/vendor-f1fdae2f.js","assets/send-hr-form-work-transfer-77112527.js"])),Gx=l.lazy(()=>v(()=>import("./index-197e1910.js"),["assets/index-197e1910.js","assets/vendor-f1fdae2f.js","assets/send-hr-form-work-transfer-77112527.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>u0),void 0));l.lazy(()=>v(()=>import("./index-67e0e5f6.js"),["assets/index-67e0e5f6.js","assets/vendor-f1fdae2f.js","assets/BoldText-f34d4292.js","assets/help-links-ca329b44.js"]));const qx=l.lazy(()=>v(()=>import("./index-32b7a3bc.js"),["assets/index-32b7a3bc.js","assets/vendor-f1fdae2f.js"])),tr=l.lazy(()=>v(()=>import("./index-109f2812.js"),["assets/index-109f2812.js","assets/vendor-f1fdae2f.js","assets/index-c7e2e820.js","assets/index-e691e9da.js"])),ir=l.lazy(()=>v(()=>import("./index-2e6b8165.js"),["assets/index-2e6b8165.js","assets/vendor-f1fdae2f.js","assets/index-c7e2e820.js","assets/index-e691e9da.js"])),Yx=l.lazy(()=>v(()=>import("./index-fb95ce7f.js"),["assets/index-fb95ce7f.js","assets/vendor-f1fdae2f.js"]));l.lazy(()=>v(()=>import("./index-551ac261.js"),["assets/index-551ac261.js","assets/vendor-f1fdae2f.js","assets/index.esm-8a5217b6.js"]));const Jx=l.lazy(()=>v(()=>import("./index-d06c3dc4.js"),["assets/index-d06c3dc4.js","assets/vendor-f1fdae2f.js"])),nr=l.lazy(()=>v(()=>import("./index-f361835d.js"),["assets/index-f361835d.js","assets/vendor-f1fdae2f.js","assets/help-links-ca329b44.js"])),Xx=l.lazy(()=>v(()=>import("./index-f10c27cc.js"),["assets/index-f10c27cc.js","assets/vendor-f1fdae2f.js"])),Kx=l.lazy(()=>v(()=>import("./index-0762db34.js"),["assets/index-0762db34.js","assets/vendor-f1fdae2f.js","assets/alert-item-5172c49d.js","assets/is-valid-url-08a91344.js"])),Qx=l.lazy(()=>v(()=>import("./index-3babb45e.js"),["assets/index-3babb45e.js","assets/vendor-f1fdae2f.js","assets/index-e384d98b.js","assets/alert-item-5172c49d.js","assets/is-valid-url-08a91344.js"])),Zx=l.lazy(()=>v(()=>import("./index-4eb2a84f.js"),["assets/index-4eb2a84f.js","assets/vendor-f1fdae2f.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>xy),void 0));const em=l.lazy(()=>v(()=>import("./index-2f6d35b4.js"),["assets/index-2f6d35b4.js","assets/vendor-f1fdae2f.js"])),sr=l.lazy(()=>v(()=>import("./index-77cb583e.js"),["assets/index-77cb583e.js","assets/vendor-f1fdae2f.js","assets/index-e384d98b.js","assets/index-e691e9da.js"])),tm=l.lazy(()=>v(()=>import("./index-d0d02e71.js"),["assets/index-d0d02e71.js","assets/vendor-f1fdae2f.js","assets/index-29fa00c6.js"])),im=l.lazy(()=>v(()=>import("./index-1ed2fc27.js"),["assets/index-1ed2fc27.js","assets/vendor-f1fdae2f.js","assets/index-29fa00c6.js"])),nm=l.lazy(()=>v(()=>import("./index-d05a4b5b.js"),["assets/index-d05a4b5b.js","assets/vendor-f1fdae2f.js","assets/index-29fa00c6.js"])),sm=l.lazy(()=>v(()=>import("./index-f019fea1.js"),["assets/index-f019fea1.js","assets/vendor-f1fdae2f.js"])),om=l.lazy(()=>v(()=>import("./index-e2a76459.js"),["assets/index-e2a76459.js","assets/vendor-f1fdae2f.js","assets/index.esm-8a5217b6.js"])),am=l.lazy(()=>v(()=>import("./index-6418fbe2.js"),["assets/index-6418fbe2.js","assets/vendor-f1fdae2f.js"])),rm=l.lazy(()=>v(()=>import("./index-086a6cfe.js"),["assets/index-086a6cfe.js","assets/vendor-f1fdae2f.js"])),lm=l.lazy(()=>v(()=>import("./index-11d9d7d0.js"),["assets/index-11d9d7d0.js","assets/vendor-f1fdae2f.js"])),cm=l.lazy(()=>v(()=>import("./index-47baee43.js"),["assets/index-47baee43.js","assets/vendor-f1fdae2f.js","assets/index-3d098025.js"])),dm=l.lazy(()=>v(()=>import("./index-a001d96c.js"),["assets/index-a001d96c.js","assets/vendor-f1fdae2f.js"])),pm=l.lazy(()=>v(()=>import("./index-169b190c.js"),["assets/index-169b190c.js","assets/vendor-f1fdae2f.js","assets/help-links-ca329b44.js"])),um=l.lazy(()=>v(()=>import("./index-e7b94f89.js"),["assets/index-e7b94f89.js","assets/vendor-f1fdae2f.js","assets/help-links-ca329b44.js"])),hm=l.lazy(()=>v(()=>import("./index-a13ca008.js"),["assets/index-a13ca008.js","assets/vendor-f1fdae2f.js"])),gm=l.lazy(()=>v(()=>import("./index-67e0e5f6.js"),["assets/index-67e0e5f6.js","assets/vendor-f1fdae2f.js","assets/BoldText-f34d4292.js","assets/help-links-ca329b44.js"])),fm=l.lazy(()=>v(()=>import("./index-a6a3bd37.js"),["assets/index-a6a3bd37.js","assets/vendor-f1fdae2f.js"])),xm=p.div`
    width: 100%;
...
`,Z0=e=>localStorage.setItem("age",e.toString()),ST=e=>localStorage.getItem(e),eb=e=>e.map(i=>{localStorage.setItem(i.employeeGuid,i.tutor.toString())}),tb={listMedicalExamination:null,error:null},It=M(async()=>{const e=await pe.get(`MedicalExamination.GetAllHistory?PersonalGuid=${Wt(Ue()??"").IndividualGuid}`);try{return Z0(e.data.age),eb(e.data.employeeMedicalExaminations.map(({employeeGuid:i,tutor:n})=>({employeeGuid:i,tutor:n}))),e.data.employeeMedicalExaminations}catch{throw new Error("Не удалось загрузить информацию. Попробуйте позже")}}),hn=M(async e=>{try{const i=await pe.post("MedicalExamination.AddMedicalExamination",e);if(i.data.isError)throw new Error;return i.data}catch(i){throw new Error(i)}}),ib=()=>{const{listMedicalExamination:e,error:i}=Te(nb);return{data:e,loading:Te(It.pending),error:i}};k();Ie({from:hn.doneData,to:It});O({clock:hn.doneData,fn:()=>({message:"Форма отправлена успешно",type:"success",time:0}),target:We.evokePopUpMessage});O({clock:hn.failData,fn:()=>({message:"Не удалось отправить форму.",type:"hrFailure",time:3e3}),target:We.evokePopUpMessage});const nb=J(tb).on(It,e=>({...e,error:null})).on(It.doneData,(e,i)=>({...e,listMedicalExamination:i})).on(It.failData,(e,i)=>({...e,error:i.message})),sb={loadBufferMedicalExaminationFx:It,sendBufferMedicalExaminationFx:hn},ob={useBufferMedicalExamination:ib},ab=async e=>{const i=`https://api.mospolytech.ru/serviceforfrontpersonnelorders/MedicalExamination.DownloadFile?DocumentGuid=${e}&Type=0`,n={Authorization:`Bearer ${Ue()}`},s=await ht({url:i,method:"GET",responseType:"blob",headers:n}),o=window.URL.createObjectURL(new Blob([s.data])),a=document.createElement("a");a.href=o,a.setAttribute("download","order.pdf"),document.body.appendChild(a),a.click()},_r=()=>[{title:"Дата",field:"creationDate",width:"100px",sort:!0,type:"date"},{title:"Статус",field:"orderStatus",width:"150px",render:e=>t.jsx(Q,{type:e==="Согласовано"?"success":e==="На регистрации"?"info":e==="Не утвержден"||e==="Не создано"?"failure":"alert",title:e,align:"center",width:"100%",icon:null,maxWidth:"150px"})},{title:"Должность",field:"jobTitle",sort:!0},{title:"Период",field:"medicalExamination",align:"center",width:"200px",render:(e,i)=>`${oe(i==null?void 0:i.startDate,"numeric")} - ${oe(i==null?void 0:i.endDate,"numeric")}`},{title:"Файл заявления",priority:"one",field:"downloadable",type:"file",width:"200px",align:"center",render:(e,i)=>i!=null&&i.downloadApplication?t.jsx(_,{text:"Скачать файл",background:"rgb(60,210,136)",textColor:"#fff",id:"downloadButton",width:"150px",align:"center",minWidth:"150px",height:"30px",onClick:n=>{n.stopPropagation(),ab(i==null?void 0:i.documentGuid)}}):"-"}],rb=()=>[..._r(),{title:"Статус приказа",field:"orderApprovalStatus",align:"center",render:e=>e||"-"},{title:"Статус заявления",field:"applicationApporvalStatus",align:"center",render:e=>e||"-"}],lb=()=>{const{data:e,loading:i}=ob.useBufferMedicalExamination(),{data:{dataWorkerApplication:n}}=ye.useApplications(),s=e&&e.map(o=>{const a=n&&n.find(r=>r.jobGuid===o.employeeGuid);return[...o.notTaken.map(r=>({...r,jobTitle:a==null?void 0:a.jobTitle}))]}).flat().filter(o=>{if(o.orderStatus!="false"&&o.orderStatus!="")return!0}).sort((o,a)=>Io(new Date(o.creationDate),new Date(a.creationDate)));return t.jsxs(Ve,{load:sb.loadBufferMedicalExaminationFx,error:null,data:e,children:[t.jsxs($,{jc:"space-between",m:"10px 0",children:[t.jsx(cb,{children:"История заявлений на диспансеризацию:"}),t.jsx(Z,{to:"/hr-applications/medical-examination",children:t.jsx(_,{text:"Диспансеризация",background:"var(--reallyBlue)",textColor:"#fff",icon:t.jsx(jt,{}),minWidth:"35px",height:"36px",shrinkTextInMobile:!0})})]}),i?t.jsx($,{w:"100%",jc:"center",ai:"center",children:t.jsx(Qe,{})}):t.jsx(Ge,{orientation:"vertical",alignItems:"flex-start",justifyContent:"flex-start",gap:"10px",width:"100%",maxWidth:"100%",height:"fit-content",children:t.jsx(et,{columns:_r(),columnsExtended:rb(),data:s,maxOnPage:10})})]})},cb=p.div`
    ...
    gap: 10px;
    align-items: center;
`,db=()=>{const{data:{dataWorkerApplication:e},error:i}=ye.useApplications();return t.jsx(Ve,{load:Fe.getWorkerPosts,error:i,data:e,children:t.jsxs(Yt,{children:[t.jsx(Q,{type:"info",title:"Информация",icon:t.jsx(Xe,{}),lineHeight:"1.4rem",fontSize:"0.85rem",children:"Тут можно посмотреть свои заявления на диспансеризацию и согласовать их."}),t.jsx(lb,{})]})})},wr=k(),jr=k(),kr=M(async()=>{const{data:e}=await pe.get(`AnotherPlaceWork.GetAllHistory?PersonalGuid=${Wt(Ue()??"").IndividualGuid}`);return e.employeeHistories});O({clock:wr,target:kr});const Ti=M(async e=>(await pe.post("AnotherPlaceWork.AddAnotherPlaceOfWork",e)).data);O({clock:jr,target:Ti});const Sr=J([]),pb=Ti.pending;O({clock:kr.doneData,target:Sr});O({clock:Ti.doneData,fn:e=>{const i=e;return i.isError?{message:i.error,type:"hrFailure",time:3e5}:{message:"Форма отправлена успешно",type:"success",time:0}},target:We.evokePopUpMessage});O({clock:Ti.fail,fn:()=>({message:"Не удалось отправить форму.",type:"hrFailure",time:3e5}),target:We.evokePopUpMessage});const ub={loadBufferWorkTransfer:wr,sendBufferWorkTransfer:jr},TT={sendBufferWorkTransferFx:Ti},hb={useBufferWorkTransfer:()=>({data:Te(Sr),loading:Te(pb)})},gb=()=>{const[e,i]=l.useState(!1);l.useEffect(ub.loadBufferWorkTransfer,[]);const{data:n}=hb.useBufferWorkTransfer(),s=!!n.every(o=>!o);return t.jsxs(Ge,{orientation:"vertical",alignItems:"flex-start",justifyContent:"flex-start",gap:"10px",width:"100%",maxWidth:"100%",height:"fit-content",children:[t.jsxs(fb,{children:["История заявлений на перевод:",t.jsx(_,{icon:e?t.jsx(ft,{}):t.jsx(He,{}),onClick:()=>!s&&i(o=>!o),background:"transparent"})]}),e&&t.jsx(xb,{columns:cr(),data:n.map(o=>({...o})),maxOnPage:5}),t.jsx(_,{onClick:()=>{!s&&i(o=>!o)},text:s?"История пуста":e?"Скрыть":"Подробнее",background:"transparent"})]})},fb=p.div`
    display: flex;
    flex-direction: row;
    gap: 10px;
    align-items: center;
...
`,sy=({qr_current:e,qr_total:i,currentPage:n})=>n===0?t.jsx(Ri,{qrCode:e}):n===1?t.jsx(Ri,{qrCode:i}):t.jsx(ny,{children:t.jsx(_s,{pages:[{title:"Текущая залолженность",content:t.jsx(Ri,{qrCode:e})},{title:"Общая залолженность",content:t.jsx(Ri,{qrCode:i})}],appearance:!1,currentPage:n})}),oy=({type:e="horizontal",...i})=>{const{open:n}=te(),s="Оплатить через QR-code",o=`linear-gradient(45deg, ${w.green.main}, ${w.green.dark1})`,a=()=>{n(t.jsx(sy,{...i}),s)};return e==="vertical"?t.jsx(_,{onClick:a,width:"68px",height:"60px",direction:"vertical",text:"QR",icon:t.jsx(rp,{}),textColor:"#fff",background:o}):t.jsx(_,{text:s,onClick:a,width:"100%",textColor:"#fff",background:o})},ay=({debt:e,size:i="big"})=>{const n=e>0?w.red.main:w.green.main;return t.jsx(Ar,{size:i,color:n,fontWeight:"600",children:e>=0?e:`+${-e}`})},Tn=e=>e.reduce((i,n)=>(i[n.title]=n.mql.matches,i),{}),$i=()=>{const e=Wu.map(({query:s,title:o})=>({mql:matchMedia(s),title:o})),[i,n]=l.useState(Tn(e));return l.useLayoutEffect(()=>(e.forEach(({mql:s})=>s.addEventListener("change",()=>{n(Tn(e))})),()=>e.forEach(({mql:s})=>s.removeEventListener("change",()=>{n(Tn(e))}))),[]),{...i,currentDevice:Object.keys(i).find(s=>i[s]===!0)??"desktop"}},ry=p.div`
    width: 100%;
`,ly=p.div`
    width: 100%;
    padding: 16px;
...
`,so=p(Z)`
    width: 100%;
`,Il=({group:e})=>{const{close:i}=te();return t.jsxs(kv,{children:[t.jsxs($,{d:"column",gap:"12px",jc:"center",h:"100%",children:[t.jsx(mt,{size:120,color:"lightBlue",children:t.jsx(Qo,{})}),t.jsx(se,{fontSize:"1.2rem",children:e})]}),t.jsxs($,{gap:"8px",onClick:i,children:[t.jsx(so,{to:gn(Pi,{page:"current",filter:e}),children:t.jsx(_,{icon:t.jsx(Ct,{}),width:"100%",text:"Расписание",background:"var(--theme-4)"})}),t.jsx(so,{to:`${ml}/${e}`,children:t.jsx(_,{icon:t.jsx(Ko,{}),width:"100%",text:"Список",background:"var(--theme-4)"})})]})]})},Sv=p.div`
    width: 100%;
    color: var(--text);
    padding: 0px 16px;
    background: var(--theme-1t);
...
`,Rl=({title:e,children:i,bottomMargin:n,forceState:s=!1})=>{const[o,a]=l.useState(s);l.useEffect(()=>{a(s)},[s]);const r=()=>a(c=>!c);return t.jsxs(Av,{isOpen:o,bottomMargin:n,onClick:r,children:[e&&t.jsx(Dv,{children:e}),t.jsx(Nv,{isOpen:o,children:i})]})},Ll=k(),zl=k(),Iv=J(!1).on(zl,()=>!0).on(Ll,()=>!1),oo={close:Ll,open:zl},Rv={$isModalOpen:Iv},vs=l.createContext({isOpen:!1,component:void 0,back:()=>{},close:()=>{},open:()=>{},title:void 0,canBack:!1}),Lv=({children:e})=>{const[i,n]=l.useState(!1),[s,o]=l.useState([]),[a,r]=l.useState([]),c=_i(Rv.$isModalOpen),d=a.length>1,u=l.useCallback(()=>{d&&(a.pop(),s.pop(),r([...a]),o([...s]))},[a,r]),h=l.useCallback((b,y)=>{b&&(i?(r(()=>[...a,b]),o(()=>[...s,y??""])):(r(()=>[b]),o(y?[y]:[])),n(()=>!0),oo.open())},[r,n,a,i]),f=l.useCallback(()=>{n(()=>!1),oo.close()},[r,n]),g=l.useMemo(()=>a[a.length-1],[a]),m=l.useMemo(()=>s[s.length-1],[s]),x=l.useCallback(b=>{b&&r([...a,b])},[]);return l.useEffect(()=>{c!==i&&n(c)},[c]),t.jsx(vs.Provider,{value:{back:u,open:h,close:f,isOpen:i,canBack:d,component:g,title:m,setComponent:x},children:e})},te=()=>{const{open:e,isOpen:i,...n}=l.useContext(vs);return{open:e,isOpen:i,...n}},zv="2.3.0",Ml=()=>t.jsx(Q,{icon:null,type:"info",title:zv,width:"38px",fontSize:"0.65rem",padding:"7px 0px",align:"center"}),Ce=({color:e,children:i})=>t.jsx(mt,{color:e,children:i}),Mv=()=>({info:t.jsx(Ce,{color:"grey",children:t.jsx(Xe,{})}),message:t.jsx(Ce,{color:"red",children:t.jsx(Qn,{})}),alert:t.jsx(Ce,{color:"purple",children:t.jsx(qo,{})}),"payment-dorm":t.jsx(Ce,{color:"green",children:t.jsx(ct,{})}),"payment-ed":t.jsx(Ce,{color:"green",children:t.jsx(ct,{})}),"digital-services":t.jsx(Ce,{color:"red",children:t.jsx(D,{})}),"doc-for-review":t.jsx(Ce,{color:"blue",children:t.jsx(D,{})}),"hr-applications":t.jsx(Ce,{color:"green",children:t.jsx(D,{})}),"kpi-pps":t.jsx(Ce,{color:"pink",children:t.jsx(Ho,{})}),schedule:t.jsx(Ce,{color:"pink",children:t.jsx(Ct,{})}),"version-update":t.jsx(Ml,{}),"electronic-interaction":t.jsx(Ce,{color:"blue",children:t.jsx(Jo,{})})}),Fv=p(Z)`
    width: 100%;
    display: flex;
    align-items: center;
    padding: 4px;
...
`,t1=()=>{const e=lf();return{Windows:[{title:"CTRL",key:"Control"},{key:"k"}],Linux:[{title:"CTRL",key:"Control"},{key:"k"}],UNIX:[{title:"CTRL",key:"Control"},{key:"k"}],MacOS:[{title:"CMD",key:"Meta",icon:t.jsx(Zo,{})},{key:"k"}],iOS:[],Android:[]}[e]},Hl=({size:e="large"})=>{const i=t1(),{open:n}=te(),s=e==="large"?"16px":"8px",o=e==="large"?"100%":"92%",a=()=>n(t.jsx(Kv,{}),"Глобальный поиск");return Ha(i.map(({key:r})=>r),a),e==="icon"?t.jsx(_,{direction:"vertical",icon:t.jsx(zt,{}),width:"40px",minWidth:"40px",shrinkTextInMobile:!0,background:"transparent",onClick:a}):t.jsxs(Qv,{tabIndex:0,maxWidth:"750px",width:o,size:e,height:"fit-content",padding:s,justifyContent:"space-between",onClick:a,children:[t.jsx(se,{align:"left",fontSize:"0.9rem",children:t.jsxs($,{gap:"8px",children:[t.jsx(zt,{}),"Поиск"]})}),t.jsx(e1,{w:"fit-content",gap:"4px",children:i.map(r=>t.jsx(Zv,{children:(r==null?void 0:r.icon)??(r.title??r.key).toUpperCase()},r.key))})]})},Hn=e=>e.split(" ").map(i=>i[0]),Ae=(e,i)=>{const n=Hn(e),s=w[Fu[n[0]]];return s==null?void 0:s[i??"main"]},i1=p.div`
...
`,p1=({maxNotificationsVisible:e})=>{const{error:i,loading:n,notifications:s,removeNotificationError:o,removeNotificationLoading:a}=it.useLkNotifications();return l.useEffect(()=>{o&&G.evokePopUpMessage({type:"failure",message:o,time:1e4})},[o]),l.useEffect(()=>{$t.clearAllVisible()},[]),t.jsxs(d1,{children:[s.length===0&&!n&&t.jsx(Ts,{height:"100%",children:t.jsx(he,{text:i??"Нет новых уведомлений",image:i?t.jsx(lt,{}):t.jsx(Cp,{}),size:"70px"})}),t.jsxs($,{d:"column",gap:"16px",children:[t.jsx(Q,{lineHeight:"1.2rem",type:"tip",visible:s.length!==0,children:"Вы можете отключить получение каких-либо уведомлений в настройках"}),t.jsx(Bl,{notifications:e?s.slice(0,e):s,loadingRemove:a})]}),n&&t.jsx(c1,{quantity:10})]})},u1=p.div`
    position: relative;
    min-width: 40px;
    height: 40px;
    display: flex;
...
`,MT=({errorInData:e})=>t.jsxs(J_,{children:[t.jsx("img",{src:tc,alt:"дед наелся и спит"}),t.jsx("span",{children:"В этот день пар нет"}),!e&&t.jsx(bc,{})]});p.div`
    border-radius: 15px;
    overflow: hidden;
    padding: 6px;
    background: var(--theme-2);
...
`;const Q_=p.div`
    ...
    border-radius: var(--brLight);
    row-gap: 10px;
`,FT=()=>t.jsxs(Q_,{children:[t.jsx(za,{size:"38px"}),t.jsx(H,{size:4,children:"Учебный день завершился"}),t.jsx(bc,{})]});p.div`
    display: flex;
    align-items: center;
    column-gap: 5px;
...
`,cj=({title:e,visible:i})=>i?t.jsx(lj,{children:t.jsx("span",{className:"title",children:e})}):null,vo=e=>{const{value:i,required:n,width:s,indexI:o,indexJ:a,type:r,suggestions:c,items:d,title:u,documents:h,changeInputArea:f,setData:g,mask:m,editable:x,placeholder:b,autocomplete:y,isSpecificRadio:P,specialType:j,specialFieldsNameConfig:T,minValueInput:S,maxValueInput:N,maxValueLength:z,diff:I,visible:K=!0,onChange:R,onKeyPress:ne,onBlur:ge,onKeyDown:je,onKeyUp:Re,onFocus:qe}=e,ue=x??(f&&!h),[Pe,Oi]=l.useState(!0),Le=(V,de,At)=>{R==null||R(V),g(_e=>(Array.isArray(_e.data[0])?_e.data[de][At??0].value=V:_e.data[de].type==="checkbox-docs"?_e.data[de].items[At??0].value=!!V:_e.data[de].value=V,{..._e}))},Qt=(V,de,At)=>{R==null||R(V),g(_e=>(Array.isArray(_e.data[0])?_e.data[de][At??0].value=V:_e.data[de].value=V,{..._e}))},Os=(V,de,At)=>{g(_e=>(_e.data[de].items[At??0].files=V,{..._e}))},Ai=V=>{R==null||R(V),g(de=>(de.data[o].value=V,{...de}))},Di=V=>{R==null||R(V),ne==null||ne(V),ge==null||ge(V),je==null||je(V),Re==null||Re(V),qe==null||qe(V),g(de=>(de.data[o].value=V,{...de}))};return T&&j&&!Object.values(T).includes(j)?null:r!=="select"&&r!=="multiselect"||!d?r==="checkbox"?t.jsx(Je,{text:u,isActive:ue,checked:i,setChecked:V=>Le(V,o,a)}):r==="hr-checkbox"?t.jsx(tj,{text:u,isActive:ue,checked:i,setChecked:V=>Le(V,o,a)}):r==="auto-complete-input"?t.jsx(rj,{title:u,suggestions:c??[],required:n,value:i,placeholder:b??u,setValue:V=>Le(V,o,a)}):r==="textarea"?t.jsx(Bg,{value:i,title:u,setValue:V=>Le(V,o,a),isActive:ue,textAreaAppearance:ue,placeholder:b??u,required:n,width:s}):r==="checkbox-docs"?t.jsx(Xw,{title:u,items:d,setChecked:(V,de)=>Le(!V,o,de),setFiles:(V,de)=>Os(V,o,de)}):r==="date-interval"?K?t.jsx(er,{title:u,required:n,dates:i,setDates:V=>Di(V),valid:Pe,setValid:Oi,minValue:S,diff:I}):null:r==="simple-text"?t.jsx(Zw,{title:u,value:i,visible:K}):r==="text-warning"?t.jsx(cj,{title:u,visible:K}):r==="text-header"?t.jsx(nj,{title:u,visible:K}):r==="radio"?t.jsx(Kw,{buttons:d,title:u,required:n,current:i,setCurrent:Ai,isSpecificRadio:P}):K?t.jsx(pt,{value:i,title:u,minValue:S,maxValue:N,maxLength:z,setValue:V=>Le(V,o,a),type:r,isActive:ue,inputAppearance:ue,placeholder:b??u,required:n,mask:m,width:s,autocomplete:y}):null:K?t.jsx(or,{items:d,setSelected:V=>Qt(V,o,a),selected:i,isActive:ue,title:u,width:s,multiple:r==="multiselect",required:n}):null},dj=p.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    user-select: none;
...
`,RS=()=>{const{open:e,content:i,position:n}=rf.useContextMenu(),s=l.useRef(null);return Gt(s,()=>Ne.close()),t.jsx(fn,{isOpen:e,children:t.jsx(IS,{isVisible:e,ref:s,left:n.x,top:n.y,onClick:o=>{o.stopPropagation()},children:i})})},Yd=200,LS=5e3,zS=()=>{const{visibleNotifications:e}=it.useLkNotifications(),[i,n]=l.useState(null),s=l.useRef(),o=a=>(s.current=void 0,()=>{n(a),setTimeout(()=>{$t.clearVisibleById(a)},Yd)});return l.useEffect(()=>{var a,r;e.length&&s.current===void 0&&(s.current=setTimeout(o((a=e[0])==null?void 0:a.id),((r=e[0])==null?void 0:r.duration)??LS))},[e]),{handleClose:o,closing:i}},MS=p.div`
    position: absolute;
    width: 320px;
    max-width: 500px;
    bottom: 10px;
...
`;const BS=()=>{const{visibleNotifications:e}=it.useLkNotifications(),{closing:i,handleClose:n}=zS();return t.jsx(MS,{children:e.map(s=>t.jsx(FS,{onClick:n(s.id),open:i!==s.id,children:t.jsx(Fl,{...s,fullText:!1,maxLetters:19,closeAnimation:!1,onClose:n(s.id)})},s.id))})},Ao=p.div`
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
`,GS=({playing:e,pages:i,onClose:n})=>{const{currentPage:s}=Ss.useStory();return t.jsxs(VS,{height:"10px",verticalAlign:"center",direction:"horizontal",width:"100%",children:[Array(i).fill(0).map((o,a)=>t.jsx(WS,{onClose:n,isLast:a+1===i,playing:s===a?e:null,filled:s>a?100:s===a?void 0:0},a)),e?t.jsx(Du,{}):t.jsx(Au,{}),t.jsx(_,{minWidth:"25px",width:"25px",height:"25px",icon:t.jsx(Ke,{}),onClick:n})]})},qS=e=>`translate(${e.horizontal==="center"?"-50%":"0px"}, ${e.vertical==="center"?"-50%":"0px"})})`,YS=p(Ze)`
    overflow: hidden;
    position: relative;
    background: ${({background:e})=>e};
    display: flex;
...
`,QS=()=>{const{pages:e,isOpen:i,currentPage:n}=Ss.useStory(),s=l.useRef(null);Gt(s,()=>vt.close());const[o,a]=l.useState(!0),r=e[n];return e.length===0?null:t.jsx(fn,{isOpen:i,children:t.jsx(KS,{isOpen:i,ref:s,children:e.length!==0&&t.jsxs(t.Fragment,{children:[t.jsx(GS,{pages:e.length,onClose:()=>vt.close(),playing:o}),t.jsx(Do,{left:"15px",onClick:()=>{n!==0&&vt.changeCurrentPage({value:n-1}),a(!0)},children:t.jsx(vi,{})}),t.jsx(XS,{setPlaying:a,currentPage:n,...r}),t.jsx(Do,{right:"15px",onClick:()=>{n!==e.length-1?vt.changeCurrentPage({value:n+1}):vt.close(),a(!0)},children:t.jsx(gt,{})})]})})})},ZS=()=>{const{data:{user:e}}=ve.useUser(),{notifications:i,loading:n,loaded:s}=it.useLkNotifications(),{settings:o}=Vt.useSettings(),[a]=_i([Oa.$electronicInteractionStore]),r=l.useMemo(()=>o==null?void 0:o["settings-notifications"].property,[o==null?void 0:o["settings-notifications"]]);l.useEffect(()=>{An.getElectronicInteraction(),a&&!a.status&&$t.add(xd("electronic-interaction","electronic-interaction"))},[a==null?void 0:a.status]),l.useEffect(()=>{a||An.getElectronicInteraction()},[a]),l.useEffect(()=>{e&&r&&r.all!==!1&&!s&&!n&&(md(r,[{id:"schedule",type:"schedule",title:"Скоро пара!",text:"Осталось меньше 15 мин."}]).length,$t.initialize({settings:r}))},[e,r,n,s]),l.useEffect(()=>{tt.changeNotifications({page:"lk-notifications",notifications:i.length})},[i])},eT=()=>{const{data:{user:e}}=ve.useUser(),[i,n]=l.useState(!1),s=o=>{const a=localStorage.getItem("lastLocalAccess")||o,r=new Date(Mu);new Date(o)<r&&new Date(a)<r&&(localStorage.setItem("lastLocalAccess",new Date().toISOString()),n(!0))};return l.useEffect(()=>{e&&s(e.lastaccess)},[e]),i},tT=()=>{const e=mr(),{open:i}=te(),n=eT();return ZS(),xt(),l.useEffect(()=>{n&&n&&i(t.jsx(_c,{}),"Что нового")},[n]),{currentPage:e}},iT=p.div`
    display: flex;
    flex: 1;
    background: var(--theme);
    width: 100%;
...
`,oT=()=>{const{data:{user:e}}=ve.useUser(),i=l.useRef(null),{allRoutes:n}=Be.useMenu(),{currentPage:s}=tT(),[o,a]=l.useState(!1),r=c=>{a(c.currentTarget.scrollTop>0)};return qd(i.current),t.jsxs(iT,{children:[t.jsx(HS,{loading:!e||!n}),t.jsx(QS,{}),t.jsx(M1,{}),t.jsxs(nT,{children:[t.jsx(S1,{headerVisible:o,currentPage:s}),t.jsx(sT,{ref:i,onScroll:r,withHeader:!(s!=null&&s.withoutHeader),children:t.jsx(Bd,{children:t.jsx(l.Suspense,{fallback:null,children:t.jsx(NS,{})})})}),t.jsx(Sw,{})]}),t.jsx(G1,{}),t.jsx(B1,{}),t.jsx(Y1,{}),t.jsx(RS,{}),t.jsx(Aw,{}),t.jsx(BS,{})]})},aT=le.memo(oT),rT=()=>{const{data:{isAuthenticated:e,user:i}}=ve.useUser(),{data:n}=dt.selectors.useData(),{settings:s}=Vt.useSettings();return qd(window),l.useEffect(()=>{window.location.href==="https://e.mospolytech.ru/?p=children#/home"&&window.location.replace("https://e.mospolytech.ru/old/index.php?p=children")},[window.location.href]),l.useEffect(()=>{e&&(Fe.getUserDataApplicationsFx(),(i==null?void 0:i.user_status)==="staff"&&(dt.effects.getFx(),Fe.getWorkerPosts(),Wd()),AS.load())},[e,i]),l.useEffect(()=>{i&&(s?tt.defineMenu({user:i,adminLinks:n,homeRoutes:s["settings-home-page"].property.pages}):fg.getLocalSettingsFx(i.id))},[i,n,s]),e?t.jsx(aT,{}):t.jsx(l.Suspense,{fallback:null,children:t.jsxs(ia,{children:[nv.map(({path:o,Component:a},r)=>t.jsx(na,{path:o,component:a,exact:!0},r)),t.jsx(Ye,{exact:!0,to:fl})]})})},lT=p.div`
    background: var(--theme);
    overflow-y: auto;
    flex: 1;
    display: flex;
    width: 100%;
`;jS();const cT=()=>(xt(),t.jsx(Lv,{children:t.jsx(Nu,{basename:"/",children:t.jsx(lT,{children:t.jsx(Bd,{children:t.jsx(rT,{})})})})}));Iu.render(t.jsxs(le.StrictMode,{children:[t.jsx(k_,{}),t.jsx(cT,{})]}),document.getElementById("root"));export{Fd as $,_j as A,_ as B,Je as C,fe as D,w as E,ss as F,he as G,U as H,Cc as I,W as J,yt as K,Qh as L,Q as M,Uw as N,Qe as O,Cy as P,Se as Q,w1 as R,St as S,H as T,_T as U,ve as V,Ve as W,se as X,ki as Y,iS as Z,$t as _,G as a,ln as a$,tS as a0,_s as a1,yT as a2,ye as a3,Fe as a4,HT as a5,sn as a6,Ze as a7,Yi as a8,Ee as a9,ST as aA,ob as aB,jT as aC,P0 as aD,kT as aE,ds as aF,hb as aG,Gd as aH,TT as aI,gv as aJ,Yw as aK,pj as aL,re as aM,Ic as aN,qi as aO,iv as aP,PT as aQ,mv as aR,xv as aS,Ph as aT,Ge as aU,be as aV,ET as aW,bs as aX,Ci as aY,Y as aZ,Ne as a_,Dl as aa,Sh as ab,Th as ac,Ya as ad,BT as ae,ws as af,Ja as ag,Pv as ah,Ov as ai,Be as aj,$v as ak,Tl as al,tv as am,UT as an,We as ao,pe as ap,Wt as aq,Ue as ar,wT as as,$s as at,VT as au,Bh as av,Bs as aw,Es as ax,f0 as ay,sb as az,fS as b,O_ as b$,Gt as b0,Oa as b1,An as b2,Mh as b3,De as b4,mt as b5,ot as b6,ay as b7,oy as b8,kw as b9,me as bA,s1 as bB,Ul as bC,Gy as bD,st as bE,Pt as bF,Iw as bG,sv as bH,ev as bI,Zy as bJ,Qy as bK,ic as bL,H_ as bM,gn as bN,Pi as bO,es as bP,zT as bQ,I_ as bR,El as bS,R_ as bT,L_ as bU,ac as bV,Nt as bW,G_ as bX,mc as bY,V_ as bZ,vc as b_,MT as ba,LT as bb,ow as bc,Kl as bd,ks as be,FT as bf,Vt as bg,$i as bh,kl as bi,c1 as bj,Ae as bk,js as bl,Rn as bm,U_ as bn,Hl as bo,x1 as bp,L as bq,En as br,CT as bs,Z1 as bt,NT as bu,IT as bv,RT as bw,DT as bx,AT as by,OT as bz,ig as c,l_ as c0,hw as c1,rw as c2,xt as c3,Zl as c4,oc as c5,Nr as c6,bi as c7,Y_ as c8,Nl as c9,cS as cA,bT as cB,Rh as cC,uT as cD,pT as cE,Xi as cF,j_ as cG,ns as cH,Lh as cI,tf as cJ,vT as cK,wj as cL,Ii as cM,bj as cN,yj as cO,mj as cP,Oc as cQ,oS as cR,no as ca,sa as cb,nn as cc,av as cd,ov as ce,xT as cf,fT as cg,Ol as ch,Cl as ci,ji as cj,t_ as ck,Za as cl,hT as cm,vm as cn,za as co,gT as cp,$T as cq,an as cr,l1 as cs,wS as ct,Ni as cu,it as cv,Xy as cw,p1 as cx,mT as cy,lS as cz,mn as d,xS as e,oo as f,pt as g,Ga as h,or as i,et as j,Vg as k,oe as l,Ch as m,a1 as n,AS as o,$S as p,ee as q,$ as r,gS as s,Rm as t,te as u,Ts as v,Yt as w,os as x,WT as y,Bg as z};
