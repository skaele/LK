...
`,Se=({links:e})=>t.jsx(we,{children:t.jsx(ee,{direction:"horizontal",gap:10,horizontalAlign:"left",scroll:!1,wrap:!0,wrapOnMobile:!0,children:Object.values(e).map(s=>t.jsx(Te,{...s},s.id))})}),ve=x.memo(Se),ze=e=>{const s=_(e,"days");return s<0?"Прошло":s===0?"Сегодня":s===1?"Завтра":`${s} ${m(s,{zero:"дней",one:"день",twoToFour:"дня",fiveToNine:"дней"})}`},_e=e=>{const s=_(e,"days");return s<0?f.blue.main:s<1?f.pink.main:s<2?f.red.main:s<5?f.orange.main:f.green.main},Fe=c.div`
    color: ${({day:e})=>_e(e)};
    font-weight: 600;
    white-space: nowrap;
`,Ie=({day:e})=>t.jsx(Fe,{day:e,children:ze(e)}),Ce=c(le)`
    display: flex;
    column-gap: 10px;
    overflow-x: auto;
    width: 100%;
...
`,Re=({teacherName:e,group:s,data:i,loading:r,error:a})=>{var b;const{schedule:o,currentModule:l,view:d}=i,{data:{user:n}}=F.useUser(),[u,g]=x.useState((n==null?void 0:n.group)??""),{pages:h,wrapperRef:y,showGroupSearch:p,setCurrentPage:I,onValueEmpty:C,handleLoad:L,onHintClick:E}=De(i,e,s);return t.jsx(ie,{loading:r,load:L,error:a,data:o,children:t.jsxs(Me,{children:[t.jsx("div",{className:"slider-wrapper",children:t.jsx(re,{appearance:!1,pages:h,currentPage:parseInt(l),setCurrentPage:I})}),l!=="3"&&t.jsxs("div",{className:"buttons-and-search",children:[t.jsx(ce,{view:d,setView:D=>j.changeView({view:D})}),p&&t.jsx(ue,{value:u,setValue:g,onHintClick:E,placeholder:"Группа",customMask:oe.groupMask,request:ae,leftIcon:t.jsx(J,{}),onValueEmpty:(n==null?void 0:n.user_status)==="staff"?C:void 0})]}),t.jsx(de,{visible:!!e||!!s,filter:e??s??"",isGroup:!!s}),l!=="3"&&t.jsx(pe,{wrapperRef:y,data:i}),!!h&&((b=h[l])==null?void 0:b.content)]})})};export{Re as T};
