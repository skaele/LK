import{d as at,u as o,y as p,x as r,p as i,b2 as w,b3 as E,b4 as it,b5 as dt,m as b,s as ct,r as ut,j as P}from"./vendor-e9654bfa.js";import{o as lt,p as mt,q as F,f as pt,B as gt,l as O}from"./index-d7ba1400.js";const B=10,ft="http://45.10.42.218:3333/graphql/",D=at.create({baseURL:ft}),$t={headers:{"Content-Type":"application/json"}};D.interceptors.request.use(lt);D.interceptors.response.use(t=>t,mt);const u=async t=>{const e=await D.post("",{query:t},$t);if(e.data.errors)throw new Error("Request error");return e.data.data},St=({studentGuid:t,date:e})=>`mutation IncreaseStudentVisits {
