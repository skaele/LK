import{r as x,s as h,j as i,R as M,L as U,a2 as ee,D as te,ag as Y,b8 as ne,bd as re,be as ie}from"./vendor-198a3a64.js";import{a7 as v,u as L,bh as k,N as oe,b7 as W,T as j,bi as B,V as A,ai as se,B as S,aX as w,Q as ae,bj as le,bk as $,bl as ce,bm as pe,aZ as N,E as X,l as I,bn as H,bo as de}from"./index-7ac35755.js";function he(e){const[n,r]=x.useState(!1),t=new IntersectionObserver(([o])=>r(o.isIntersecting));return x.useEffect(()=>(t.observe(e==null?void 0:e.current),()=>{t.disconnect()}),[]),n}const f={"9:00 - 10:30":v.lightGreen,"10:40 - 12:10":v.blue,"12:20 - 13:50":v.purple,"14:30 - 16:00":v.pink,"16:10 - 17:40":v.red,"17:50 - 19:20":v.red,"18:20 - 19:40":v.orange,"19:30 - 21:00":v.orange,"19:50 - 21:10":v.orange},ue=h.div`
    width: 100%;
...
`,q=(e,n)=>{const r=e==null?void 0:e[n].lessons;return e&&r?`${r==null?void 0:r.length} ${ae((r==null?void 0:r.length)??0,{zero:"пар",one:"пара",twoToFour:"пары",fiveToNine:"пар"})}`:"0 пар"},D=()=>{const e=new Date,n=new Date;n.setDate(e.getDate()+1);const r=n.toLocaleDateString("en-US",{weekday:"long"}).toLowerCase();return r==="sunday"?"monday":r},Ne=h.div`
    ...
    border-radius: var(--brLight);
    row-gap: 10px;
`,Ae=()=>{var r;const{open:e}=L(),{data:n}=W.useSchedule();return i.jsxs(Ne,{children:[i.jsx(le,{size:"38px"}),i.jsx(j,{size:4,children:"Учебный день завершился"}),!!((r=n.schedule)!=null&&r[0])&&i.jsx(S,{text:"Посмотреть следующий",onClick:()=>{var t,o,s;return e(i.jsx(K,{lessons:((o=(t=n.schedule)==null?void 0:t[0])==null?void 0:o[D()].lessons)??[],topInfo:q((s=n.schedule)==null?void 0:s[0],D()),weekDay:$[D()].full}))},textColor:"var(--blue)",background:"transparent"})]})},Ie=h.div`
    display: flex;
    align-items: center;
    column-gap: 5px;
    color: ${({isCurrent:e})=>e?"#fff":"var(--text)"};
...
`,et=({view:e,setView:n})=>i.jsxs(Oe,{children:[i.jsx(S,{icon:i.jsx(re,{}),onClick:()=>n("full"),isChosen:e==="full"}),i.jsx(S,{icon:i.jsx(ie,{}),onClick:()=>n("big"),isChosen:e==="big"})]}),Ue=h.div`
    &::-webkit-scrollbar {
        display: none;
    }
...
`,qe=({weekSchedule:e,view:n,wrapperRef:r})=>{const{data:{currentDay:t}}=W.useSchedule(),{width:o}=N();x.useEffect(()=>{setTimeout(()=>{r!=null&&r.current&&(n==="big"||o<1e3)&&(r.current.scrollLeft=t*400-360)},200)},[n]);const s=()=>{r!=null&&r.current&&o<=1e3&&H.changeCurrentChosenDay({day:Math.floor(r.current.scrollLeft*1.2/o)+1})};return e?i.jsx(Ve,{isFull:n==="full",innerRef:r,onScroll:s,children:Object.keys(e).map((a,p)=>i.jsx(K,{isCurrent:t===p+1,weekDay:$[a].full,lessons:e[a].lessons,view:n,topInfo:q(e,a)},p))}):i.jsx(X,{text:"Пока нет расписания",image:de})},nt=x.memo(qe);export{K as D,Re as F,et as S,nt as W,tt as a,Qe as p};
