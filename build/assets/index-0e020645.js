...
`,be=({chosen:s,onClick:o})=>e.jsx(Z,{minWidth:"35px",background:"transparent",icon:s?e.jsx(fe,{style:{color:"var(--blue)"}}):e.jsx(je,{}),onClick:o}),Re=s=>{const{id:o,chosen:t,switchMenuItem:i}=s;return e.jsxs(Se,{chosen:t,onClick:()=>i(o),children:[e.jsx(J,{background:"transparent",maxWordLength:100,orientation:"horizontal",shadow:!1,...s}),e.jsx("div",{className:"buttons",children:e.jsx(be,{chosen:t,onClick:()=>{i(o)}})})]})},ke=q.memo(Re),Ee=g.div`
    display: flex;
