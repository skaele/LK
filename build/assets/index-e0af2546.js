import{s as d,L as S,b7 as u,j as e,b8 as K,r as m,ag as L,f as I,aA as W,o as $,b9 as k,ba as E,C as O,D as _,aW as A,aX as F}from"./vendor-1f18e8c3.js";import{aS as v,a7 as z,aT as x,aU as J,aV as j,aW as T,aX as h,l as p,B as c,a as N,aY as H,T as f,u as R,aZ as U,ai as V,Z as C,W as q,V as Q,f as B}from"./index-8228fcb5.js";import{I as G}from"./index.esm-687c2b8d.js";const X=(s,t)=>t.filter(a=>v(a.name).includes(v(s))),Y=d(S)`
...
`,je=()=>{var r;const[s,t]=m.useState(null),[a,n]=m.useState(!0),i=(r=u(x))==null?void 0:r.params,o=[{avatar:void 0,name:"Стелла",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"1",amountOfUnreadMessages:10},{avatar:"https://upload.wikimedia.org/wikipedia/ru/thumb/d/df/Andrew_Garfield_as_Spider-Man.jpg/280px-Andrew_Garfield_as_Spider-Man.jpg",name:"Питер Паркер",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"2",amountOfUnreadMessages:0},{avatar:void 0,name:"Рафаэль",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"3",amountOfUnreadMessages:0},{avatar:void 0,name:"Леонардо",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"4",amountOfUnreadMessages:0},{avatar:void 0,name:"Бред Питт",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"5",amountOfUnreadMessages:0}];return e.jsxs(Te,{isOpen:a,chatId:i==null?void 0:i.chatId,children:[e.jsxs("div",{className:"chat-list-top-section",children:[e.jsx(f,{size:3,align:"left",children:"Чаты"}),e.jsx(c,{onClick:()=>n(l=>!l),icon:a?e.jsx(O,{}):e.jsx(_,{})})]}),e.jsx(C,{whereToSearch:o,searchEngine:X,setResult:t,placeholder:"Поиск чатов"}),e.jsx(Q,{margin:"10px auto"}),e.jsx(re,{chats:s??o,isOpen:a})]})},ve=d.div`
    display: flex;
    align-items: center;
    background: var(--schedule);
    padding: 5px 10px;
