import{s as r,j as e,au as x}from"./vendor-f1fdae2f.js";import{X as s,b6 as c,l as d,D as h,E as p,u as g,aa as m}from"./index-9d5e42c4.js";import{i as v}from"./is-valid-url-08a91344.js";const f=({alert:t})=>{const{content:i,time:a,date:o}=t;return e.jsxs(u,{children:[e.jsx(s,{fontSize:"0.9rem",children:e.jsx(c,{words:[d(o),a]})}),e.jsx(h,{width:"100%",margin:"12px 0"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:i}})]})},u=r.div`
    display: flex;
