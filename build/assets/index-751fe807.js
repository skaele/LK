...
`,St=({text:e,action:i,width:n,height:s,setCompleted:o,background:a,buttonSuccessText:r="Готово",popUpSuccessMessage:c="Успешно",popUpFailureMessage:d="Nope",pulsing:u,isDone:h=!1,isActive:f=!0,isLoading:g=!1,completed:m=!1,repeatable:x=!0,alerts:b=!0})=>{l.useEffect(()=>{m&&b&&(W.evokePopUpMessage({message:c,type:"success"}),x&&setTimeout(()=>{o(!1)},2e3))},[m,o]);const y=()=>{if(f&&!h&&!g)return i();b&&W.evokePopUpMessage({message:d,type:"failure"})};return t.jsx(Hg,{isLoading:g,background:a,className:"submit-button",completed:m,isActive:f&&!h&&!m,onClick:y,isDone:h,width:n,height:s,repeatable:x,tabIndex:f&&!h?0:-1,pulsing:u&&!h,children:t.jsx("div",{className:"inner-button",children:m?t.jsxs("div",{className:"inner-button-success",children:[t.jsx(Jd,{})," ",r]}):g?t.jsx(Ke,{}):t.jsx("div",{className:"inner-button-text",children:e})})})},Vi={small:"32px",middle:"36px",big:"44px"},Me=e=>({size:i})=>e[i],Ug=(e,i)=>e.length>8?e.substring(0,8):e.length===3&&(i==null?void 0:i.length)===2?e+"-":e.length===3&&(i==null?void 0:i.length)===4?e.substring(0,2):e,Wg=e=>{const i=["7","8","9"],n=e.target.selectionStart;let s=e.target.value.replace(/\D/g,""),o="";return s.length?e.target.value.length!==n?/\D/g.test(e.nativeEvent.data??"")?s:e.target.value:(i.indexOf(s[0])>-1?(s[0]==="9"&&(s="7"+s),o=(s[0]==="8"?"8":"+7")+" ",s.length&&(o+="("+s.substring(1,4)),s.length>=5&&(o+=") "+s.substring(4,7)),s.length>=8&&(o+="-"+s.substring(7,9)),s.length>=10&&(o+="-"+s.substring(9,11))):o=`+${s.substring(0,16)}`,o):""},Vg={groupMask:Ug,phoneMask:Wg},Gg=(e,i,n,s,o,a,r,c)=>{const[d,u]=l.useState(n),[h,f]=l.useState(s??!1);l.useEffect(()=>{u(n)},[n]);const g=l.useCallback(y=>y.replace(/@\.*/,"@mospolytech.ru").replace(/mospolytech.ru?/,""),[n]);return{inputType:d,danger:h,phoneMaskKeyDown:y=>{y.key==="Backspace"&&(e[1]==="7"&&e.length<=4||e[0]==="8"&&e.length<=3)&&i("")},buttonOnClick:()=>u(y=>y==="password"?"text":"password"),handleOnChange:y=>{if(i(c?r?r(y.target.value,e):n==="tel"?Vg.phoneMask(y):n==="email"?g(y.target.value):y.target.value:y.target.value),n==="date"&&(o||a)){const P=new Date(y.target.value);let j=!1;if(o){const S=new Date(o);j=P<S}if(a&&!j){const S=new Date(a);j=P>S}f(j)}i(y.target.value)}}},qg=p.div`
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    position: relative;
...
`,dt=l.forwardRef(function(i,n){const{value:s,setValue:o,leftIcon:a,title:r,required:c,width:d,minWidth:u,customMask:h,placeholder:f="Введите сюда",type:g="text",danger:m,alertMessage:x,loading:b=!1,isActive:y=!0,inputAppearance:P=!0,mask:j=!1,autocomplete:S=!1,minValue:T=void 0,maxValue:L=void 0,maxLength:z=void 0,hideCross:N=!1,stepSize:K=.1,size:I="middle"}=i,{inputType:ne,buttonOnClick:ge,danger:ke,handleOnChange:Re,phoneMaskKeyDown:Ge}=Gg(s,o,g,m,T,L,h,j),ue=s&&g==="date"?Xd(new Date(s),"yyyy-MM-dd"):s??"";return t.jsxs(qg,{leftIcon:!!a,isActive:y,inputAppearance:P,width:d,danger:ke,minWidth:u,size:I,children:[t.jsx(H,{size:5,align:"left",visible:!!r,bottomGap:"5px",required:c,children:r}),t.jsx(Q,{type:"alert",visible:!!x,icon:t.jsx(Kd,{}),title:x??""}),a&&t.jsx("span",{className:"left-icon",children:a}),t.jsx("input",{id:f,min:T,max:L,maxLength:z,step:K??void 0,type:ne,placeholder:f,value:ue,autoComplete:S?"on":"off",onKeyDown:Pe=>g==="tel"&&Ge(Pe),onChange:Re,required:c,readOnly:!y,ref:n}),g!=="password"?!!(s!=null&&s.length)&&P&&(b?t.jsx(Ke,{}):!N&&t.jsx(_,{icon:t.jsx(Xe,{}),onClick:()=>o(""),tabIndex:-1})):t.jsx(_,{icon:ne==="password"?t.jsx(Qd,{}):t.jsx(No,{}),tabIndex:-1,onClick:ge})]})}),Yg=p.div`
    user-select: none;
    min-width: 56px;
    height: 30px;
...
`,Lf=({file:e,files:i,setFiles:n})=>{const{open:s}=te(),o=(r,c)=>{r.preventDefault(),r.stopPropagation();const d=new FileReader;d.onloadend=()=>{s(t.jsx(ns,{src:d.result,loading:!1,width:"500px",height:""}))},c&&d.readAsDataURL(c)},a=r=>nt.evokeConfirm({message:"Вы уверены, что хотите удалить файл?",onConfirm:()=>n(If(r,e.name,i))});return t.jsxs(Rf,{onClick:r=>r.preventDefault(),children:[t.jsxs("div",{className:"file-body",onClick:r=>e.type.includes("image")&&o(r,e),children:[t.jsx("div",{className:"image-container",children:e.type.includes("image")?t.jsx(ep,{}):t.jsx(tp,{})}),t.jsxs("div",{className:"name-and-size",children:[t.jsx("b",{className:"file-name",children:e.name}),t.jsx(se,{fontSize:"0.7em",children:Nf(e.size)})]})]}),t.jsx(_,{icon:t.jsx(Xe,{}),height:"30px",width:"30px",background:"transparent",onClick:a})]})},zf=({files:e,setFiles:i})=>t.jsx(Ee,{title:"Список файлов",visible:!!e.length,onDelete:()=>nt.evokeConfirm({message:"Вы уверены, что хотите удалить все файлы?",onConfirm:()=>i([])}),children:e.map(n=>t.jsx(Lf,{file:n,files:e,setFiles:i},n.name))}),Za=e=>t.jsxs(Ee,{gap:12,children:[t.jsx(Df,{...e}),t.jsx(zf,{files:e.files,setFiles:e.setFiles})]}),Mf=p.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`,Kf=()=>t.jsx(Xf,{children:t.jsx(Jf,{})}),we=({oldVersionUrl:e,errorText:i="Страница еще находится в разработке. Если вам она нужна, вернитесь к старому дизайну",buttonText:n="Перейти к старому дизайну",forceForward:s=!1,isRedirectButtonVisible:o=!0})=>(l.useEffect(()=>{s&&(window.location.href=`/old/?p=${e==null?void 0:e.slice(1,e.length)}`)},[]),t.jsx(he,{text:i,children:o&&t.jsx("a",{href:`${R}/?p=${e==null?void 0:e.slice(1,e.length)}`,children:t.jsx(_,{text:n,icon:t.jsx(en,{}),width:"100%",background:"var(--reallyBlue)",textColor:"#fff",align:"left",padding:"10px"})})})),Qf="modulepreload",Zf=function(e){return"/"+e},Vs={},v=function(i,n,s){if(!n||n.length===0)return i();const o=document.getElementsByTagName("link");return Promise.all(n.map(a=>{if(a=Zf(a),a in Vs)return;Vs[a]=!0;const r=a.endsWith(".css"),c=r?'[rel="stylesheet"]':"";if(!!s)for(let h=o.length-1;h>=0;h--){const f=o[h];if(f.href===a&&(!r||f.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${c}`))return;const u=document.createElement("link");if(u.rel=r?"stylesheet":Qf,r||(u.as="script",u.crossOrigin=""),u.href=a,document.head.appendChild(u),r)return new Promise((h,f)=>{u.addEventListener("load",h),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>i())},ex=l.lazy(()=>v(()=>import("./index-fd9188a9.js"),["assets/index-fd9188a9.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js"])),tx=l.lazy(()=>v(()=>import("./index-bfe8c312.js"),["assets/index-bfe8c312.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-7ca8561e.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-04ae6a41.js"])),ix=l.lazy(()=>v(()=>import("./index-6c094499.js"),["assets/index-6c094499.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js"])),nx=l.lazy(()=>v(()=>import("./index-a41b0da8.js"),["assets/index-a41b0da8.js","assets/vendor-f1fdae2f.js","assets/find-current-in-select-ba4611d5.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>Ob),void 0));const sx=l.lazy(()=>v(()=>import("./index-cf2508ae.js"),["assets/index-cf2508ae.js","assets/vendor-f1fdae2f.js","assets/index-991b3b41.js"])),ox=l.lazy(()=>v(()=>import("./index-b2732164.js"),["assets/index-b2732164.js","assets/vendor-f1fdae2f.js","assets/index-50a08e31.js"])),ax=l.lazy(()=>v(()=>import("./index-30e5011b.js"),["assets/index-30e5011b.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),rx=l.lazy(()=>v(()=>import("./index-566b2948.js"),["assets/index-566b2948.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-7ca8561e.js","assets/get-teacher-subdivisions-1b4fd80d.js"])),lx=l.lazy(()=>v(()=>import("./index-5d2c984a.js"),["assets/index-5d2c984a.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-7ca8561e.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-04ae6a41.js"])),cx=l.lazy(()=>v(()=>import("./index-10872e97.js"),["assets/index-10872e97.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-04ae6a41.js"])),dx=l.lazy(()=>v(()=>import("./index-60a9bd44.js"),["assets/index-60a9bd44.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-7ca8561e.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-04ae6a41.js"])),px=l.lazy(()=>v(()=>import("./index-bec9c280.js"),["assets/index-bec9c280.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/index-04ae6a41.js"])),ux=l.lazy(()=>v(()=>import("./index-2d5ae8e7.js"),["assets/index-2d5ae8e7.js","assets/vendor-f1fdae2f.js","assets/ui-f3701fc2.js","assets/index-f86aa414.js"])),hx=l.lazy(()=>v(()=>import("./index-b928bbf2.js"),["assets/index-b928bbf2.js","assets/vendor-f1fdae2f.js","assets/ui-f3701fc2.js"])),gx=l.lazy(()=>v(()=>import("./index-94f6220c.js"),["assets/index-94f6220c.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-04ae6a41.js"])),fx=l.lazy(()=>v(()=>import("./index-6e53f302.js"),["assets/index-6e53f302.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-7ca8561e.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-04ae6a41.js"])),xx=l.lazy(()=>v(()=>import("./index-2865da47.js"),["assets/index-2865da47.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js","assets/index-04ae6a41.js"])),mx=l.lazy(()=>v(()=>import("./index-6f57ceeb.js"),["assets/index-6f57ceeb.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-04ae6a41.js"])),bx=l.lazy(()=>v(()=>import("./index-ea3e27a9.js"),["assets/index-ea3e27a9.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-7ca8561e.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/get-last-year-for-period-e1de6b16.js","assets/index-04ae6a41.js"])),yx=l.lazy(()=>v(()=>import("./index-dfd45f18.js"),["assets/index-dfd45f18.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-7ca8561e.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-04ae6a41.js"])),vx=l.lazy(()=>v(()=>import("./index-180f289b.js"),["assets/index-180f289b.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-7ca8561e.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/get-last-year-for-period-e1de6b16.js","assets/index-04ae6a41.js"])),_x=l.lazy(()=>v(()=>import("./index-4427bbbf.js"),["assets/index-4427bbbf.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js"])),wx=l.lazy(()=>v(()=>import("./index-46dda59f.js"),["assets/index-46dda59f.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-04ae6a41.js"])),jx=l.lazy(()=>v(()=>import("./index-6968edd7.js"),["assets/index-6968edd7.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-04ae6a41.js"])),kx=l.lazy(()=>v(()=>import("./index-5deecbcf.js"),["assets/index-5deecbcf.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js","assets/index-04ae6a41.js"])),Sx=l.lazy(()=>v(()=>import("./index-decf2911.js"),["assets/index-decf2911.js","assets/vendor-f1fdae2f.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-7ca8561e.js","assets/get-teacher-subdivisions-1b4fd80d.js","assets/index-04ae6a41.js"])),Tx=l.lazy(()=>v(()=>import("./index-9e2ca840.js"),["assets/index-9e2ca840.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ex=l.lazy(()=>v(()=>import("./index-5a9774af.js"),["assets/index-5a9774af.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),$x=l.lazy(()=>v(()=>import("./index-6eea8be8.js"),["assets/index-6eea8be8.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Px=l.lazy(()=>v(()=>import("./index-d0b0c06a.js"),["assets/index-d0b0c06a.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Cx=l.lazy(()=>v(()=>import("./index-6cd683c9.js"),["assets/index-6cd683c9.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ox=l.lazy(()=>v(()=>import("./index-624d6be6.js"),["assets/index-624d6be6.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ax=l.lazy(()=>v(()=>import("./index-c42aba87.js"),["assets/index-c42aba87.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Dx=l.lazy(()=>v(()=>import("./index-884fe27f.js"),["assets/index-884fe27f.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Nx=l.lazy(()=>v(()=>import("./index-0af29354.js"),["assets/index-0af29354.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ix=l.lazy(()=>v(()=>import("./index-10d76571.js"),["assets/index-10d76571.js","assets/vendor-f1fdae2f.js","assets/index-04ae6a41.js","assets/index-38ce9edb.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-teacher-subdivisions-1b4fd80d.js"])),Rx=l.lazy(()=>v(()=>import("./index-376e34ca.js"),["assets/index-376e34ca.js","assets/vendor-f1fdae2f.js"]));l.lazy(()=>v(()=>import("./index-b6887f9c.js"),["assets/index-b6887f9c.js","assets/vendor-f1fdae2f.js","assets/index-1aec97b7.js","assets/index-f86aa414.js"]));const as=l.lazy(()=>v(()=>import("./index-e6f1707e.js"),["assets/index-e6f1707e.js","assets/vendor-f1fdae2f.js"])),Lx=l.lazy(()=>v(()=>import("./index-816c1e72.js"),["assets/index-816c1e72.js","assets/vendor-f1fdae2f.js"])),zx=l.lazy(()=>v(()=>import("./index-308e5e17.js"),["assets/index-308e5e17.js","assets/vendor-f1fdae2f.js"])),Mx=l.lazy(()=>v(()=>import("./index-a2314f80.js"),["assets/index-a2314f80.js","assets/vendor-f1fdae2f.js"])),Fx=l.lazy(()=>v(()=>import("./index-27221292.js"),["assets/index-27221292.js","assets/vendor-f1fdae2f.js"])),Bx=l.lazy(()=>v(()=>import("./index-dfbe09a5.js"),["assets/index-dfbe09a5.js","assets/vendor-f1fdae2f.js"])),Hx=l.lazy(()=>v(()=>import("./index-f25ca055.js"),["assets/index-f25ca055.js","assets/vendor-f1fdae2f.js","assets/get-default-subdivision-17957fb0.js"])),Ux=l.lazy(()=>v(()=>import("./index-7ca3e1e6.js"),["assets/index-7ca3e1e6.js","assets/vendor-f1fdae2f.js","assets/get-default-subdivision-17957fb0.js"])),Wx=l.lazy(()=>v(()=>import("./index-f96fe0a2.js"),["assets/index-f96fe0a2.js","assets/vendor-f1fdae2f.js"])),Vx=l.lazy(()=>v(()=>import("./index-b0e466f0.js"),["assets/index-b0e466f0.js","assets/vendor-f1fdae2f.js","assets/send-hr-form-work-transfer-c1aa180e.js"])),Gx=l.lazy(()=>v(()=>import("./index-e9b08fd0.js"),["assets/index-e9b08fd0.js","assets/vendor-f1fdae2f.js","assets/send-hr-form-work-transfer-c1aa180e.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>u0),void 0));l.lazy(()=>v(()=>import("./index-d7a4dcad.js"),["assets/index-d7a4dcad.js","assets/vendor-f1fdae2f.js","assets/BoldText-f34d4292.js","assets/help-links-c8155e07.js"]));const qx=l.lazy(()=>v(()=>import("./index-e17012a0.js"),["assets/index-e17012a0.js","assets/vendor-f1fdae2f.js"])),tr=l.lazy(()=>v(()=>import("./index-5d7bdc43.js"),["assets/index-5d7bdc43.js","assets/vendor-f1fdae2f.js","assets/index-1aec97b7.js","assets/index-f86aa414.js"])),ir=l.lazy(()=>v(()=>import("./index-b6887f9c.js"),["assets/index-b6887f9c.js","assets/vendor-f1fdae2f.js","assets/index-1aec97b7.js","assets/index-f86aa414.js"])),Yx=l.lazy(()=>v(()=>import("./index-c89a90a8.js"),["assets/index-c89a90a8.js","assets/vendor-f1fdae2f.js"]));l.lazy(()=>v(()=>import("./index-2d4727ff.js"),["assets/index-2d4727ff.js","assets/vendor-f1fdae2f.js","assets/index.esm-8a5217b6.js"]));const Jx=l.lazy(()=>v(()=>import("./index-e591429d.js"),["assets/index-e591429d.js","assets/vendor-f1fdae2f.js"])),nr=l.lazy(()=>v(()=>import("./index-1b811f3d.js"),["assets/index-1b811f3d.js","assets/vendor-f1fdae2f.js","assets/help-links-c8155e07.js"])),Xx=l.lazy(()=>v(()=>import("./index-66f043b7.js"),["assets/index-66f043b7.js","assets/vendor-f1fdae2f.js"])),Kx=l.lazy(()=>v(()=>import("./index-918bd2c9.js"),["assets/index-918bd2c9.js","assets/vendor-f1fdae2f.js","assets/alert-item-b60ad5bd.js","assets/is-valid-url-08a91344.js"])),Qx=l.lazy(()=>v(()=>import("./index-8f55647f.js"),["assets/index-8f55647f.js","assets/vendor-f1fdae2f.js","assets/index-c36e6c78.js","assets/alert-item-b60ad5bd.js","assets/is-valid-url-08a91344.js"])),Zx=l.lazy(()=>v(()=>import("./index-ab799a30.js"),["assets/index-ab799a30.js","assets/vendor-f1fdae2f.js"]));l.lazy(()=>v(()=>Promise.resolve().then(()=>xy),void 0));const em=l.lazy(()=>v(()=>import("./index-e44775ce.js"),["assets/index-e44775ce.js","assets/vendor-f1fdae2f.js"])),sr=l.lazy(()=>v(()=>import("./index-aaf9c53a.js"),["assets/index-aaf9c53a.js","assets/vendor-f1fdae2f.js","assets/index-c36e6c78.js","assets/index-f86aa414.js"])),tm=l.lazy(()=>v(()=>import("./index-65acd130.js"),["assets/index-65acd130.js","assets/vendor-f1fdae2f.js","assets/index-f032324e.js"])),im=l.lazy(()=>v(()=>import("./index-0596a1c8.js"),["assets/index-0596a1c8.js","assets/vendor-f1fdae2f.js","assets/index-f032324e.js"])),nm=l.lazy(()=>v(()=>import("./index-3ec2504e.js"),["assets/index-3ec2504e.js","assets/vendor-f1fdae2f.js","assets/index-f032324e.js"])),sm=l.lazy(()=>v(()=>import("./index-c2b2e5d2.js"),["assets/index-c2b2e5d2.js","assets/vendor-f1fdae2f.js"])),om=l.lazy(()=>v(()=>import("./index-8025b309.js"),["assets/index-8025b309.js","assets/vendor-f1fdae2f.js","assets/index.esm-8a5217b6.js"])),am=l.lazy(()=>v(()=>import("./index-1cdeea6b.js"),["assets/index-1cdeea6b.js","assets/vendor-f1fdae2f.js"])),rm=l.lazy(()=>v(()=>import("./index-1525c72a.js"),["assets/index-1525c72a.js","assets/vendor-f1fdae2f.js"])),lm=l.lazy(()=>v(()=>import("./index-11d9d7d0.js"),["assets/index-11d9d7d0.js","assets/vendor-f1fdae2f.js"])),cm=l.lazy(()=>v(()=>import("./index-6201c66f.js"),["assets/index-6201c66f.js","assets/vendor-f1fdae2f.js","assets/index-991b3b41.js"])),dm=l.lazy(()=>v(()=>import("./index-aebb2099.js"),["assets/index-aebb2099.js","assets/vendor-f1fdae2f.js"])),pm=l.lazy(()=>v(()=>import("./index-39bad91b.js"),["assets/index-39bad91b.js","assets/vendor-f1fdae2f.js","assets/help-links-c8155e07.js"])),um=l.lazy(()=>v(()=>import("./index-b8e79f37.js"),["assets/index-b8e79f37.js","assets/vendor-f1fdae2f.js","assets/help-links-c8155e07.js"])),hm=l.lazy(()=>v(()=>import("./index-b91f3ebf.js"),["assets/index-b91f3ebf.js","assets/vendor-f1fdae2f.js"])),gm=l.lazy(()=>v(()=>import("./index-d7a4dcad.js"),["assets/index-d7a4dcad.js","assets/vendor-f1fdae2f.js","assets/BoldText-f34d4292.js","assets/help-links-c8155e07.js"])),fm=l.lazy(()=>v(()=>import("./index-dff550bc.js"),["assets/index-dff550bc.js","assets/vendor-f1fdae2f.js"])),xm=p.div`
    width: 100%;
...
`,pn=()=>t.jsx(Q,{type:"info",title:"Информация",icon:t.jsx(Je,{}),children:"Данный сервис позволяет заказать необходимую справку, подать заявление, запрос. Статус (информация о степени готовности) заказанных справок меняется согласно действиям оператора. В колонке «Подразделение, адрес» указывается название подразделения и адрес, куда необходимо приехать за готовым документом."}),lr=()=>{const{data:{listApplication:e},error:i}=ye.useApplications();return t.jsx(We,{load:()=>Fe.getApplicationsFx(),loading:!e,error:i,data:e,children:t.jsx(d0,{children:t.jsxs(dn,{maxWidth:"1500px",children:[t.jsxs(p0,{children:[t.jsx(H,{size:2,align:"left",children:"Заявление на увольнение"}),t.jsx(pn,{})]}),t.jsx(l0,{})]})})})},d0=p.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,j0=()=>{const{data:{dataWorkerApplication:e}}=ye.useApplications(),[i,n]=l.useState(!0);return e?t.jsxs(k0,{children:[e.map((s,o)=>s.isDismissal?(i&&n(!1),null):t.jsx(y0,{info:s,index:o})),t.jsx(x0,{})]}):null},k0=p.div`
    ...
    flex-direction: column;
    gap: 30px;
`,S0=()=>{const{data:{listApplication:e},error:i}=ye.useApplications();return t.jsx(We,{load:()=>Fe.getApplicationsFx(),loading:!e,error:i,data:e,children:t.jsx(T0,{children:t.jsxs(dn,{maxWidth:"1500px",children:[t.jsxs(E0,{children:[t.jsx(H,{size:2,align:"left",children:"Заявление на выход в выходной день"}),t.jsx(pn,{})]}),t.jsx(j0,{})]})})})},T0=p.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,_b=()=>{const{data:{dataWorkerApplication:e}}=ye.useApplications(),[i,n]=l.useState(!0);return e?t.jsxs(wb,{children:[e.map((s,o)=>s.isDismissal?(i&&n(!1),null):t.jsx(mb,{info:s,index:o})),t.jsx(gb,{})]}):null},wb=p.div`
    ...
    flex-direction: column;
    gap: 30px;
`,jb=()=>{const{data:{listApplication:e},error:i}=ye.useApplications();return t.jsx(We,{load:()=>Fe.getApplicationsFx(),loading:!e,error:i,data:e,children:t.jsx(kb,{children:t.jsxs(dn,{maxWidth:"1500px",children:[t.jsxs(Sb,{children:[t.jsx(H,{size:2,align:"left",children:"Заявление на перевод"}),t.jsx(pn,{})]}),t.jsx(_b,{})]})})})},kb=p.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,Sb=p.div`
    ...
    padding-bottom: 40px;
    margin-bottom: 10px;
`,Tb=e=>{if(!e[0].length&&e[1].length)return`За весь период до ${re(e[1])} включительно`;if(e[0].length&&!e[1].length)return`За весь период начиная с ${re(e[0])} включительно`;if(!e[0].length&&!e[1].length)return"За все время";if(e[0].length&&e[1].length)return`За период с ${re(e[0])} по ${re(e[1])}`},Eb=p.div`
    .content {
        display: flex;
        flex-direction: column;
        gap: 20px;
...
`,Bb=({date:e,value:i})=>t.jsxs(Fb,{children:[t.jsxs($,{gap:"16px",children:[t.jsx(mt,{color:"grey",size:33,children:t.jsx(lt,{})}),t.jsxs($,{d:"column",ai:"flex-start",children:[t.jsx("span",{className:"payment-item-date",children:"Платеж"}),t.jsx(se,{children:re(e)})]})]}),t.jsxs("span",{className:"payment-item-money",children:["+",i," ",t.jsx(lt,{})," "]})]}),Hb=p.div`
    display: flex;
    align-items: center;
    font-size: ${({fontSize:e})=>e};
...
`,Yb=({contract:e})=>{if(!e)return null;const{number:i,startDate:n,endDatePlan:s,contragent:o,sum:a,can_sign:r,file:c,student:d}=e,{open:u}=te(),[h,f]=l.useState(!1),[g,m]=l.useState(!1),[x,b]=l.useState(!1),y=_i(st.$error),P=[{text:"Номер договора",info:i??""},{text:"Начало действия",info:re(n)},{text:"Действует до",info:re(s)},{text:"Заказчик",info:o||"Московский политех"},{text:"Обучающийся",info:d??""},{text:"Сумма к оплате",info:Gb(a)??""},{text:"Статус",info:""}],j=()=>{navigator.clipboard.writeText((e==null?void 0:e.number)??""),f(!0)},S=()=>{e&&(m(!0),hs.signContractFx(e.id),m(!1),b(!0))},T=()=>{u(t.jsx(Dr,{}),"Не получается подписать")};return t.jsxs(qb,{children:[t.jsx("div",{className:"contract-info",children:P.map(({info:L,text:z})=>t.jsx(yt,{keyStr:z,value:L},L))}),r&&t.jsxs($,{d:"column",gap:"8px",children:[t.jsx(St,{text:"Подписать договор",buttonSuccessText:"Подписан",action:S,isLoading:g,completed:x,repeatable:!1,popUpFailureMessage:y??"Не удалось подписать договор",setCompleted:b,popUpSuccessMessage:"Договор подписан",isActive:!0,pulsing:!0}),t.jsx(_,{onClick:T,text:"Не получается подписать?",background:"transparent",textColor:w.grey.main})]}),!r&&t.jsxs($,{gap:"8px",children:[t.jsx(St,{text:"Скопировать номер договора",action:j,isLoading:!1,completed:h,setCompleted:f,popUpSuccessMessage:"Номер договора скопирован в буфер",isActive:!0}),c&&t.jsx(ki,{onClick:()=>null,href:c??"",icon:t.jsx(Xn,{}),width:"45px"})]})]})},Jb=p.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    user-select: none;
...
`,ey=({data:e,isContractSigned:i})=>{const{id:n,signed_user:s,name:o,can_sign:a,date:r}=e,[c,d,u]=_i([st.$done,st.$completed,st.$loading]),h=s||c?140:100,f=()=>In.signAgreement(n),g=In.setCompleted;return t.jsxs(Qb,{height:h,title:o,confirmed:s||c,children:[t.jsxs(Zb,{children:[t.jsxs($,{d:"column",ai:"flex-start",gap:"4px",children:[t.jsx(H,{size:5,align:"left",children:o}),t.jsx(se,{children:re(r)})]}),t.jsxs($,{gap:"8px",w:"100%",jc:"flex-end",children:[t.jsx(ki,{href:e.file,onClick:()=>null,width:"40px",icon:t.jsx(Xn,{}),isActive:!!e.file}),!(s||c)&&t.jsx(St,{text:s||c?"Подписано":"Подписать",action:f,isLoading:u,completed:d,isDone:s||c,width:"160px",setCompleted:g,isActive:!(s||c)&&a,popUpFailureMessage:a?"Согласие уже подписано":i?"Необходимо сначала подписать соглашение об электронном взаимодейтсвии":"Необходимо сначала подписать договор",popUpSuccessMessage:"Согласие успешно подписано"}),t.jsx(Q,{type:"success",title:"Подписано",icon:t.jsx(Zi,{}),align:"center",width:"130px",visible:s||c})]})]}),(c||s)&&t.jsxs(se,{children:["Дата подписания: ",re(e.signed_user_date||new Date),","," ",e.signed_user_time||`${new Date().getHours()}:${new Date().getMinutes()}`]})]})},ty=({isDormitory:e,electronicAgreements:i=[],isContractSigned:n})=>t.jsxs(Ee,{width:"100%",children:[t.jsx(H,{size:4,align:"left",icon:t.jsx(ap,{}),bottomGap:!0,children:"Доп. соглашения"}),t.jsx(Dr,{}),t.jsx(Q,{type:"info",title:"Информация",visible:!e,children:"Подписание дополнительных соглашений к 3-сторонним договорам в Личном кабинете не предусмотрено"}),i.map((s,o)=>t.jsx(ey,{data:s,isContractSigned:n},o))]}),iy=p.div`
    display: flex;
    justify-content: center;
    align-items: center;
...
`,yv=p(Z)`
    width: 100%;
`,vv=({division:e})=>{const{close:i}=te();return t.jsxs(bv,{children:[t.jsxs($,{d:"column",gap:"12px",jc:"center",h:"100%",children:[t.jsx(mt,{size:120,color:"purple",children:t.jsx(oi,{})}),t.jsx(se,{fontSize:"1.2rem",align:"center",children:e})]}),t.jsx(yv,{to:`${bl}/${e}`,onClick:i,children:t.jsx(_,{icon:t.jsx(Ko,{}),width:"100%",text:"Список"})})]})},_v=p.div`
    width: 100%;
    color: var(--text);
    padding: 0px 16px;
...
`,so=p(Z)`
    width: 100%;
`,Il=({group:e})=>{const{close:i}=te();return t.jsxs(kv,{children:[t.jsxs($,{d:"column",gap:"12px",jc:"center",h:"100%",children:[t.jsx(mt,{size:120,color:"lightBlue",children:t.jsx(Qo,{})}),t.jsx(se,{fontSize:"1.2rem",children:e})]}),t.jsxs($,{gap:"8px",onClick:i,children:[t.jsx(so,{to:hn(Ci,{page:"current",filter:e}),children:t.jsx(_,{icon:t.jsx(Ct,{}),width:"100%",text:"Расписание",background:"var(--theme-4)"})}),t.jsx(so,{to:`${ml}/${e}`,children:t.jsx(_,{icon:t.jsx(Ko,{}),width:"100%",text:"Список",background:"var(--theme-4)"})})]})]})},Sv=p.div`
    width: 100%;
    color: var(--text);
    padding: 0px 16px;
    background: var(--theme-1t);
...
`,B1=()=>{const{isOpen:e,message:i,type:n,time:s,onClick:o}=va.usePopUpMessage();l.useEffect(()=>{e&&setTimeout(()=>{W.openPopUpMessage({isOpen:!e})},s)},[e]);const a=l.useCallback(()=>{o&&(o(),W.openPopUpMessage({isOpen:!e}))},[o]);return t.jsx(F1,{isOpen:e,isClickable:!!o,color:kt[n].color,onClick:a,children:t.jsx(Q,{type:n,fontSize:"1em",lineHeight:"1.4rem",onClose:()=>W.openPopUpMessage({isOpen:!1}),children:i})})},gn=p.div`
    display: flex;
    justify-content: center;
    align-items: center;
    position: absolute;
...
`,Mi=({title:e,link:i,image:n})=>i?t.jsxs(A_,{href:i,children:[t.jsx("img",{src:n,alt:"",loading:"lazy"}),t.jsx(H,{size:3,children:e})]}):null,uo=p.div`
    ${ee.isNotMobile} {
        width: 500px;
    }
...
`,sw=p($)`
    ...
    margin-left: 0px;
    margin-right: 0px;
`,ow=e=>{const{title:i,duration:n,icon:s,startTime:o,place:a,people:r,shift:c,color:d,scale:u,onClick:h,link:f,rooms:g,dateInterval:m,leftShift:x,quantity:b,groups:y,isCurrentEvent:P=!1,nameInOneRow:j=!0,isNextEvent:S=!1,listView:T=!1,shortInfo:L=!1}=e,{theme:z}=xt(),{isMobile:N}=Pi(),K=z==="light"?d.dark3:d.light3,I=z==="light"?d.transparent1:d.transparent2,ne=()=>h(e),ge=(N||b>1)&&L,ke=N&&b>=2&&L,Re=r==null?void 0:r.map(Le=>{var Di,Ni;const Qt=Le.split(" ");return`${Qt[0]??""} ${((Di=Qt[1])==null?void 0:Di[0])??""}.${((Ni=Qt[2])==null?void 0:Ni[0])??""}.`}),Ge=yc(o,c,u),ue=Ql(i),Pe=ke?i.split(" ").map(Le=>Le[0].toUpperCase()):Bn(ue.name,L?ge?43:35:j?300:64),Ai=(y==null?void 0:y.split(","))??[];return t.jsxs(ew,{background:I,textColor:K,listView:T,leftShift:100*x,quantity:100/b,duration:n,scale:u,top:Ge,onClick:ne,shortInfo:L,children:[t.jsx(nw,{children:s}),t.jsx($,{className:"event-body",gap:"0px",ai:"flex-start",children:t.jsxs(tw,{scale:u,d:"column",ai:"flex-start",shortInfo:L,children:[t.jsxs($,{d:"column",gap:"2px",children:[!L&&t.jsxs($,{gap:"8px",children:[t.jsx(Zl,{timeInterval:xc(o,n),color:d,isCurrentEvent:P}),t.jsx(ec,{timeLeft:fn(o,"minutes"),isNext:S,color:d,isCurrentEvent:P}),!!(g!=null&&g.length)&&t.jsx($e,{shortInfo:L,icon:N&&b>1?void 0:t.jsx(Pn,{}),text:t.jsx(De,{words:g})}),(!!f||ue.link)&&t.jsx("a",{href:f??ue.link,target:"_blank",rel:"noreferrer",children:t.jsx($e,{shortInfo:L,icon:t.jsx(Wi,{}),text:f?a:"Cсылка"})}),!!Ai.length&&t.jsx($e,{icon:t.jsx(Zn,{}),text:t.jsx(De,{words:Ai})})]}),t.jsx(iw,{listView:T,nameInOneRow:j,scale:u,shortInfo:L,children:Pe})]}),!!r.length&&!ge&&t.jsx($e,{shortInfo:L,text:t.jsx(De,{words:L?[Re[0]]:Re}),icon:t.jsx(bu,{})}),!!(g!=null&&g.length)&&L&&!ge&&t.jsx($e,{shortInfo:L,icon:t.jsx(Pn,{}),text:t.jsx(De,{words:g})}),!!f&&L&&!ge&&t.jsx("a",{href:f,target:"_blank",rel:"noreferrer",children:t.jsx($e,{shortInfo:L,icon:t.jsx(Wi,{}),text:a})}),!!m&&!ge&&t.jsx($,{gap:"5px",children:t.jsx($e,{shortInfo:L,icon:t.jsx(Kn,{}),text:m})})]})})]})},aw=e=>{const i={};if(!e)return i;for(let n=0;n<e.length;n++){const s=e[n];i[s.startTime]||(i[s.startTime]=[]),s.startTime==="18:20"?(i["17:50"]||(i["17:50"]=[]),i["17:50"].push(s)):s.startTime==="19:50"&&i["19:30"]?(i["19:30"]||(i["19:30"]=[]),i["19:30"].push(s)):s.startTime==="19:30"&&i["19:50"]?(i["19:50"]||(i["19:50"]=[]),i["19:50"].push(s)):i[s.startTime].push(s)}return i},rw=({events:e,shift:i,scale:n,shortInfo:s,weekDay:o,interval:a,showTime:r,onClick:c,currentDay:d,isCurrentDay:u})=>{const h=aw(e),f=u??new Date().getDay()===o,g=d!==void 0?d+1===o:void 0;return t.jsxs(sw,{h:"100%",d:"column",children:[f&&t.jsx(m_,{isVisible:g,showTime:r,scale:n,shift:i,interval:a}),Object.keys(h).map((m,x)=>h[m].map((b,y)=>l.createElement(ow,{leftShift:y,quantity:h[m].length,scale:n,isCurrentEvent:ks(b,f),isNextEvent:Kl(e,b,f),...b,onClick:c,shift:i,key:b.startTime+b.title+x+y,shortInfo:s})))]})},lw=p($)`
    position: absolute;
    left: 0;
    z-index: 0;
...
`,lj=({value:e,setValue:i,leftIcon:n,title:s,required:o,width:a,minWidth:r,placeholder:c="Начните ввод...",danger:d,isActive:u=!0,inputAppearance:h=!0,suggestions:f})=>{const[g,m]=l.useState([]),[x,b]=l.useState(!0);return l.useEffect(()=>{if(e){const y=f.filter(P=>P.toLowerCase().includes(e.toLowerCase()));m(y)}else m([])},[e,f]),t.jsxs(oj,{leftIcon:!!n,isActive:u,inputAppearance:h,width:a,danger:d,minWidth:r,children:[t.jsx(H,{size:5,align:"left",visible:!!s,bottomGap:"5px",required:o,children:s}),t.jsxs("div",{children:[t.jsx("input",{type:"text",value:e,onChange:y=>{i(y.target.value),b(!0)},placeholder:c}),g.length>0&&t.jsx(aj,{width:"100%",isOpen:x,className:x?"open":"close",itemsAmount:g.length,title:s,children:g.map((y,P)=>t.jsx(rj,{isSelected:!1,onClick:()=>{i(y),m([]),b(!1)},children:y},P))})]})]})},cj=p.div`
    width: 100%;
    text-align: start;
    margin-top: -20px;
    margin-bottom: -10px;
...
`,dj=({title:e,visible:i})=>i?t.jsx(cj,{children:t.jsx("span",{className:"title",children:e})}):null,vo=e=>{const{value:i,required:n,width:s,indexI:o,indexJ:a,type:r,suggestions:c,items:d,title:u,documents:h,changeInputArea:f,setData:g,mask:m,editable:x,placeholder:b,autocomplete:y,isSpecificRadio:P,specialType:j,specialFieldsNameConfig:S,minValueInput:T,maxValueInput:L,maxValueLength:z,diff:N,visible:K=!0,onChange:I,onKeyPress:ne,onBlur:ge,onKeyDown:ke,onKeyUp:Re,onFocus:Ge}=e,ue=x??(f&&!h),[Pe,Ai]=l.useState(!0),Le=(G,de,At)=>{I==null||I(G),g(_e=>(Array.isArray(_e.data[0])?_e.data[de][At??0].value=G:_e.data[de].type==="checkbox-docs"?_e.data[de].items[At??0].value=!!G:_e.data[de].value=G,{..._e}))},Qt=(G,de,At)=>{I==null||I(G),g(_e=>(Array.isArray(_e.data[0])?_e.data[de][At??0].value=G:_e.data[de].value=G,{..._e}))},Os=(G,de,At)=>{g(_e=>(_e.data[de].items[At??0].files=G,{..._e}))},Di=G=>{I==null||I(G),g(de=>(de.data[o].value=G,{...de}))},Ni=G=>{I==null||I(G),ne==null||ne(G),ge==null||ge(G),ke==null||ke(G),Re==null||Re(G),Ge==null||Ge(G),g(de=>(de.data[o].value=G,{...de}))};return S&&j&&!Object.values(S).includes(j)?null:r!=="select"&&r!=="multiselect"||!d?r==="checkbox"?t.jsx(Ye,{text:u,isActive:ue,checked:i,setChecked:G=>Le(G,o,a)}):r==="hr-checkbox"?t.jsx(ij,{text:u,isActive:ue,checked:i,setChecked:G=>Le(G,o,a)}):r==="auto-complete-input"?t.jsx(lj,{title:u,suggestions:c??[],required:n,value:i,placeholder:b??u,setValue:G=>Le(G,o,a)}):r==="textarea"?t.jsx(Bg,{value:i,title:u,setValue:G=>Le(G,o,a),isActive:ue,textAreaAppearance:ue,placeholder:b??u,required:n,width:s}):r==="checkbox-docs"?t.jsx(Kw,{title:u,items:d,setChecked:(G,de)=>Le(!G,o,de),setFiles:(G,de)=>Os(G,o,de)}):r==="date-interval"?K?t.jsx(er,{title:u,required:n,dates:i,setDates:G=>Ni(G),valid:Pe,setValid:Ai,minValue:T,diff:N}):null:r==="simple-text"?t.jsx(ej,{title:u,value:i,visible:K}):r==="text-warning"?t.jsx(dj,{title:u,visible:K}):r==="text-header"?t.jsx(sj,{title:u,visible:K}):r==="radio"?t.jsx(Qw,{buttons:d,title:u,required:n,current:i,setCurrent:Di,isSpecificRadio:P}):K?t.jsx(dt,{value:i,title:u,minValue:T,maxValue:L,maxLength:z,setValue:G=>Le(G,o,a),type:r,isActive:ue,inputAppearance:ue,placeholder:b??u,required:n,mask:m,width:s,autocomplete:y}):null:K?t.jsx(or,{items:d,setSelected:G=>Qt(G,o,a),selected:i,isActive:ue,title:u,width:s,multiple:r==="multiselect",required:n}):null},pj=p.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    user-select: none;
...
`,aT=()=>{const{data:{user:e}}=ve.useUser(),i=l.useRef(null),{allRoutes:n}=Be.useMenu(),{currentPage:s}=iT(),[o,a]=l.useState(!1),r=c=>{a(c.currentTarget.scrollTop>0)};return qd(i.current),t.jsxs(nT,{children:[t.jsx(US,{loading:!e||!n}),t.jsx(ZS,{}),t.jsx(M1,{}),t.jsxs(sT,{children:[t.jsx(S1,{headerVisible:o,currentPage:s}),t.jsx(oT,{ref:i,onScroll:r,withHeader:!(s!=null&&s.withoutHeader),children:t.jsx(Bd,{children:t.jsx(l.Suspense,{fallback:null,children:t.jsx(IS,{})})})}),t.jsx(Sw,{})]}),t.jsx(G1,{}),t.jsx(B1,{}),t.jsx(Y1,{}),t.jsx(LS,{}),t.jsx(Aw,{}),t.jsx(HS,{})]})},rT=le.memo(aT),lT=()=>{const{data:{isAuthenticated:e,user:i}}=ve.useUser(),{data:n}=ct.selectors.useData(),{settings:s}=Vt.useSettings();return qd(window),l.useEffect(()=>{window.location.href==="https://e.mospolytech.ru/?p=children#/home"&&window.location.replace("https://e.mospolytech.ru/old/index.php?p=children")},[window.location.href]),l.useEffect(()=>{e&&(Fe.getUserDataApplicationsFx(),(i==null?void 0:i.user_status)==="staff"&&(ct.effects.getFx(),Fe.getWorkerPosts(),Wd()),DS.load())},[e,i]),l.useEffect(()=>{i&&(s?et.defineMenu({user:i,adminLinks:n,homeRoutes:s["settings-home-page"].property.pages}):fg.getLocalSettingsFx(i.id))},[i,n,s]),e?t.jsx(rT,{}):t.jsx(l.Suspense,{fallback:null,children:t.jsxs(ia,{children:[nv.map(({path:o,Component:a},r)=>t.jsx(na,{path:o,component:a,exact:!0},r)),t.jsx(qe,{exact:!0,to:fl})]})})},cT=p.div`
    background: var(--theme);
    overflow-y: auto;
    flex: 1;
    display: flex;
    width: 100%;
`;kS();const dT=()=>(xt(),t.jsx(Lv,{children:t.jsx(Nu,{basename:"/",children:t.jsx(cT,{children:t.jsx(Bd,{children:t.jsx(lT,{})})})})}));Iu.render(t.jsxs(le.StrictMode,{children:[t.jsx(k_,{}),t.jsx(dT,{})]}),document.getElementById("root"));export{Fd as $,wj as A,_ as B,Ye as C,fe as D,w as E,ss as F,he as G,U as H,Cc as I,V as J,yt as K,Qh as L,Q as M,Ww as N,Ke as O,Cy as P,Te as Q,w1 as R,St as S,H as T,wT as U,ve as V,We as W,se as X,ki as Y,nS as Z,$t as _,W as a,Y as a$,iS as a0,_s as a1,UT as a2,WT as a3,vT as a4,ye as a5,Fe as a6,VT as a7,sn as a8,Qe as a9,f0 as aA,sb as aB,TT as aC,ob as aD,kT as aE,P0 as aF,ST as aG,ds as aH,hb as aI,Gd as aJ,ET as aK,gv as aL,Jw as aM,uj as aN,ae as aO,Ic as aP,Yi as aQ,iv as aR,CT as aS,mv as aT,xv as aU,Ph as aV,Ve as aW,be as aX,$T as aY,bs as aZ,Oi as a_,Bn as aa,Ee as ab,Dl as ac,Sh as ad,Th as ae,Ya as af,HT as ag,ws as ah,Ja as ai,Pv as aj,Ov as ak,Be as al,$v as am,Tl as an,tv as ao,GT as ap,ft as aq,pe as ar,Wt as as,Ue as at,jT as au,$s as av,YT as aw,Bh as ax,Bs as ay,Es as az,xS as b,V_ as b$,Ne as b0,ln as b1,Gt as b2,Oa as b3,On as b4,Mh as b5,De as b6,mt as b7,st as b8,ay as b9,DT as bA,AT as bB,me as bC,s1 as bD,Ul as bE,Gy as bF,nt as bG,Pt as bH,Iw as bI,sv as bJ,ev as bK,Zy as bL,Qy as bM,ic as bN,H_ as bO,hn as bP,Ci as bQ,es as bR,MT as bS,I_ as bT,El as bU,R_ as bV,L_ as bW,ac as bX,Nt as bY,G_ as bZ,mc as b_,oy as ba,kw as bb,FT as bc,zT as bd,ow as be,Kl as bf,ks as bg,BT as bh,Vt as bi,Pi as bj,kl as bk,c1 as bl,Ae as bm,js as bn,In as bo,U_ as bp,Hl as bq,x1 as br,R as bs,Tn as bt,OT as bu,Z1 as bv,IT as bw,RT as bx,LT as by,NT as bz,ig as c,vc as c0,O_ as c1,l_ as c2,hw as c3,rw as c4,xt as c5,Zl as c6,oc as c7,Nr as c8,bi as c9,bT as cA,cS as cB,dS as cC,yT as cD,Rh as cE,hT as cF,uT as cG,Xi as cH,j_ as cI,ns as cJ,Lh as cK,tf as cL,_T as cM,jj as cN,Ri as cO,yj as cP,vj as cQ,bj as cR,Oc as cS,aS as cT,Y_ as ca,Nl as cb,no as cc,sa as cd,nn as ce,av as cf,ov as cg,mT as ch,xT as ci,Ol as cj,Cl as ck,ji as cl,t_ as cm,Za as cn,gT as co,vm as cp,za as cq,fT as cr,PT as cs,an as ct,l1 as cu,jS as cv,Ii as cw,tt as cx,Xy as cy,p1 as cz,xn as d,mS as e,oo as f,dt as g,Ga as h,or as i,Ze as j,Vg as k,re as l,Ch as m,a1 as n,DS as o,PS as p,ee as q,$ as r,fS as s,Rm as t,te as u,Ts as v,Yt as w,os as x,qT as y,Bg as z};
