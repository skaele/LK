import{y as l,s as g,o as d,a7 as p,j as e}from"./vendor-cbee1f3c.js";import{bc as x,bd as m,a8 as P,W as j,P as v,be as y,G as k,E as F}from"./index-036cca87.js";const M=l(async n=>{const{search:o="",page:c,limit:i,filter:s}=n,{data:a}=await m(o,(s==null?void 0:s.id.toString())??"",c,i);return{results:a.items}}),u=x({getFx:M,limit:50}),S=g.div`
    width: 100%;
    display: flex;
