...
export * as applicationApi from './applications/application-api'
...
export * as allowancesApi from './allowances/allowances-api'
export * as lkNotificationApi from './notifications/lk-notification-api'
export * as contactDetailsApi from './contact-details-api'
export * as peApi from './physical-education/pe-api'
