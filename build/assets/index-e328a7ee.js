import{u as r,y as x,p,o as d,s as i,j as e,r as F,cn as D,aQ as S}from"./vendor-cbee1f3c.js";import{$ as v,am as b,S as m,a8 as $,y as T,T as k,bj as L,u,M,v as R,Z as _,U as P,ao as O}from"./index-8dc5684d.js";const U=async a=>{const t=new FormData;return t.set("avatar",a[0]),await v.post("?changeAvatar=1",t,{headers:{"Content-Type":"multipart/form-data"}})},z=async a=>{const t=new FormData;return t.set("email",a),await v.post("?changeEmail=1",t)},g={loading:!1,completed:!1,error:null},I={data:[],...g},V={data:"",...g},W={data:"",...g},w=r(),j=r(),n=x(async a=>{try{await U(a)}catch{throw new Error("Не удалось загрузить фотографию")}}),B=p(I).on(w,(a,t)=>({...a,data:t})).on(n,a=>({...a,error:null,loading:!0,completed:!1})).on(n.doneData,a=>({...a,error:null,loading:!1,completed:!0})).on(n.fail,(a,{error:t})=>({...a,error:t.message,loading:!1,completed:!1})).on(j,(a,t)=>({...a,completed:t})),A=r(),s=x(async a=>{try{await z(a)}catch{throw new Error("Не удалось изменить email")}}),N=p(W).on(A,(a,t)=>({...a,data:t})).on(s,a=>({...a,loading:!0})).on(s.doneData,a=>({...a,loading:!1,completed:!0,error:null})).on(s.failData,(a,t)=>({...a,loading:!1,completed:!1,error:t.message})),Q=r(),Z=p(V).on(Q,(a,t)=>({...a,data:t})),q=()=>({avatar:d(B),adPass:d(Z),email:d(N)}),E={useData:q},o={avatar:{changeAvatar:w,changeCompleted:j},email:{changeEmail:A}},G={avatar:{postAvatarFx:n},email:{postNewEmail:s}},H=i.div`
    min-width: 500px;
    display: flex;
