...
`;function Jg(e){const{value:i,setValue:n,width:s,placeholder:o,required:a,title:r,textAreaAppearance:c=!0,isActive:d=!0}=e;return t.jsxs(Yg,{isActive:d,width:s,textAreaAppearance:c,children:[t.jsx(U,{size:5,required:a,align:"left",bottomGap:"5px",visible:!!r,children:r}),t.jsx("textarea",{onChange:u=>n(u.target.value),placeholder:o,required:a,value:i})]})}const Xg=p.button`
    position: relative;
    width: ${({width:e})=>e??"100%"};
    padding: 10px;
...
`,pt=l.forwardRef(function(i,n){const{value:s,setValue:o,leftIcon:a,title:r,required:c,width:d,minWidth:u,customMask:h,placeholder:f="Введите сюда",type:g="text",danger:m,alertMessage:x,loading:b=!1,isActive:v=!0,inputAppearance:T=!0,mask:I=!1,autocomplete:j=!1,minValue:S=void 0,maxValue:O=void 0,maxLength:L=void 0,hideCross:N=!1,stepSize:K=.1,size:M="middle"}=i,{inputType:ie,buttonOnClick:ce,danger:$e,handleOnChange:ke,phoneMaskKeyDown:Ge}=ef(s,o,g,m,S,O,h,I),ge=s&&g==="date"?ap(new Date(s),"yyyy-MM-dd"):s??"";return t.jsxs(tf,{leftIcon:!!a,isActive:v,inputAppearance:T,width:d,danger:$e,minWidth:u,size:M,children:[t.jsx(U,{size:5,align:"left",visible:!!r,bottomGap:"5px",required:c,children:r}),t.jsx(Q,{type:"alert",visible:!!x,icon:t.jsx(rp,{}),title:x??""}),a&&t.jsx("span",{className:"left-icon",children:a}),t.jsx("input",{id:f,min:S,max:O,maxLength:L,step:K??void 0,type:ie,placeholder:f,value:ge,autoComplete:j?"on":"off",onKeyDown:Ce=>g==="tel"&&Ge(Ce),onChange:ke,required:c,readOnly:!v,ref:n}),g!=="password"?!!(s!=null&&s.length)&&T&&(b?t.jsx(Qe,{}):!N&&t.jsx(_,{icon:t.jsx(Xe,{}),onClick:()=>o(""),tabIndex:-1})):t.jsx(_,{icon:ie==="password"?t.jsx(lp,{}):t.jsx(Lo,{}),tabIndex:-1,onClick:ce})]})}),nf=p.div`
    user-select: none;
    min-width: 56px;
    height: 30px;
...
`,lf=({icon:e,text:i,onClick:n,width:s,background:o,textColor:a,align:r,href:c,height:d,minHeight:u,padding:h,isActive:f=!0,isChosen:g=!1})=>t.jsxs(rf,{text:!!i,onClick:m=>f&&n&&n(m),isChosen:g,width:s,background:o,textColor:a,href:c,align:r,isActive:f,height:d,padding:h,minHeight:u,children:[!!e&&e,i&&t.jsx("span",{children:i})]}),Si=l.memo(lf),pn=p.div`
    width: 100%;
    height: fit-content;
...
`,Ka=({value:e,width:i,placeholder:n,inputAppearance:s,loading:o,hints:a,leftIcon:r,focusOn:c,setValue:d,customMask:u,onHintClick:h,validationCheck:f=!1,size:g="middle"})=>{const[m,x]=l.useState(0),[b,v]=l.useState(!1),T=l.useRef(null),I=l.useRef(null),j=l.useRef(null);Jt(T,()=>v(!1)),l.useEffect(()=>{c&&setTimeout(()=>{var N;return(N=j.current)==null?void 0:N.focus()},50)},[c]);const S=N=>{var K,M;(((a==null?void 0:a.length)??0)>0||o)&&v(!0),N.key==="ArrowDown"?((K=I.current)==null||K.scrollIntoView({block:"start",behavior:"smooth"}),typeof m=="number"&&x(ut(m+1,((a==null?void 0:a.length)??1)-1,0))):N.key==="ArrowUp"?((M=I.current)==null||M.scrollIntoView({block:"end",behavior:"smooth"}),typeof m=="number"&&x(ut(m-1,((a==null?void 0:a.length)??1)-1,0))):N.key==="Enter"?(a!=null&&a[m??0].title&&d(a==null?void 0:a[m??0].title),v(!1),h==null||h(a==null?void 0:a[m??0])):x(0)},O=N=>()=>{x(N),d((a==null?void 0:a[N].title)??""),v(!1),h==null||h(a==null?void 0:a[N])},L=()=>{a!=null&&a.length&&v(!0)};return t.jsxs(bf,{width:i,onKeyDown:S,onMouseDown:L,ref:T,children:[t.jsx(pt,{size:g,value:e,placeholder:n,leftIcon:r??t.jsx(Bt,{}),inputAppearance:s,setValue:d,loading:o,width:i,mask:!0,customMask:u,ref:j}),t.jsx(Xa,{setValue:d,value:e,visible:f}),b&&t.jsx(vf,{height:"fit-content",maxWidth:"100%",maxHeight:"250px",width:"100%",onKeyDown:S,padding:"0",orientation:"vertical",children:a==null?void 0:a.map(({title:N,icon:K},M)=>{const ie=m===M;return t.jsxs(yf,{onClick:O(M),ref:ie?I:null,selected:ie,children:[K&&t.jsx("div",{className:"icon",children:K}),t.jsx("span",{children:N})]},N+M)})})]})},un=()=>{const[e,i]=l.useState({width:0,height:0}),n=()=>{i({width:window.innerWidth,height:window.innerHeight})};return l.useEffect(()=>(n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}),[]),e},Vs={small:"30px",middle:"44px",big:"68px"},Qa={small:"8px",middle:"10px",big:"16px"},_f={small:"0.8rem",middle:"0.9rem",big:"1rem"},wf={small:"0.65rem",middle:"0.75rem",big:"0.85rem"},jf=p.div`
...
`,ox=()=>t.jsx(sx,{children:t.jsx(nx,{})}),Te=({oldVersionUrl:e,errorText:i="Страница еще находится в разработке. Если вам она нужна, вернитесь к старому дизайну",buttonText:n="Перейти к старому дизайну",forceForward:s=!1,isRedirectButtonVisible:o=!0})=>(l.useEffect(()=>{s&&(window.location.href=`/old/?p=${e==null?void 0:e.slice(1,e.length)}`)},[]),t.jsx(fe,{text:i,children:o&&t.jsx("a",{href:`${R}/?p=${e==null?void 0:e.slice(1,e.length)}`,children:t.jsx(_,{text:n,icon:t.jsx(sn,{}),width:"100%",background:"var(--reallyBlue)",textColor:"#fff",align:"left",padding:"10px"})})})),ax="modulepreload",rx=function(e){return"/"+e},qs={},y=function(i,n,s){if(!n||n.length===0)return i();const o=document.getElementsByTagName("link");return Promise.all(n.map(a=>{if(a=rx(a),a in qs)return;qs[a]=!0;const r=a.endsWith(".css"),c=r?'[rel="stylesheet"]':"";if(!!s)for(let h=o.length-1;h>=0;h--){const f=o[h];if(f.href===a&&(!r||f.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${c}`))return;const u=document.createElement("link");if(u.rel=r?"stylesheet":ax,r||(u.as="script",u.crossOrigin=""),u.href=a,document.head.appendChild(u),r)return new Promise((h,f)=>{u.addEventListener("load",h),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>i())},lx=l.lazy(()=>y(()=>import("./index-c465c4c5.js"),["assets/index-c465c4c5.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js"])),cx=l.lazy(()=>y(()=>import("./index-fbacf609.js"),["assets/index-fbacf609.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-8009d17a.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-b364ce0d.js"])),Ys=l.lazy(()=>y(()=>import("./index-28c0dd37.js"),["assets/index-28c0dd37.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js"])),dx=l.lazy(()=>y(()=>import("./index-4fe0c05e.js"),["assets/index-4fe0c05e.js","assets/vendor-561dac3a.js","assets/get-default-subdivision-17957fb0.js"])),px=l.lazy(()=>y(()=>import("./index-3309a168.js"),["assets/index-3309a168.js","assets/vendor-561dac3a.js","assets/index-785e0d2d.js","assets/form-776cafcb.js","assets/find-current-in-select-ba4611d5.js","assets/send-form-f4588200.js"])),ux=l.lazy(()=>y(()=>import("./form-776cafcb.js"),["assets/form-776cafcb.js","assets/vendor-561dac3a.js","assets/find-current-in-select-ba4611d5.js","assets/send-form-f4588200.js"])),ar=l.lazy(()=>y(()=>import("./index-16cb0439.js"),["assets/index-16cb0439.js","assets/vendor-561dac3a.js","assets/find-current-in-select-ba4611d5.js"]));l.lazy(()=>y(()=>Promise.resolve().then(()=>zb),void 0));const hx=l.lazy(()=>y(()=>import("./index-487330bf.js"),["assets/index-487330bf.js","assets/vendor-561dac3a.js","assets/index-333867aa.js"])),gx=l.lazy(()=>y(()=>import("./index-2d87d5cd.js"),["assets/index-2d87d5cd.js","assets/vendor-561dac3a.js","assets/index-438fc480.js"])),fx=l.lazy(()=>y(()=>import("./index-86c7c9ab.js"),["assets/index-86c7c9ab.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),xx=l.lazy(()=>y(()=>import("./index-d35b6b7c.js"),["assets/index-d35b6b7c.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-8009d17a.js","assets/get-teacher-subdivisions-5cd556a9.js"])),mx=l.lazy(()=>y(()=>import("./index-7e1ef5e4.js"),["assets/index-7e1ef5e4.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-8009d17a.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-b364ce0d.js"])),bx=l.lazy(()=>y(()=>import("./index-8f93bb62.js"),["assets/index-8f93bb62.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-b364ce0d.js"])),vx=l.lazy(()=>y(()=>import("./index-440e2298.js"),["assets/index-440e2298.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-8009d17a.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-b364ce0d.js"])),yx=l.lazy(()=>y(()=>import("./index-c5b1cea9.js"),["assets/index-c5b1cea9.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/index-b364ce0d.js"])),_x=l.lazy(()=>y(()=>import("./index-3d56d612.js"),["assets/index-3d56d612.js","assets/vendor-561dac3a.js","assets/ui-eec08563.js","assets/index-ade1c0ef.js"])),wx=l.lazy(()=>y(()=>import("./index-3fd49a98.js"),["assets/index-3fd49a98.js","assets/vendor-561dac3a.js","assets/ui-eec08563.js"])),jx=l.lazy(()=>y(()=>import("./index-c9c4b742.js"),["assets/index-c9c4b742.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-b364ce0d.js"])),kx=l.lazy(()=>y(()=>import("./index-f852ae17.js"),["assets/index-f852ae17.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-8009d17a.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-b364ce0d.js"])),Sx=l.lazy(()=>y(()=>import("./index-e1849c60.js"),["assets/index-e1849c60.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js","assets/index-b364ce0d.js"])),Tx=l.lazy(()=>y(()=>import("./index-f639b60f.js"),["assets/index-f639b60f.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-b364ce0d.js"])),Ex=l.lazy(()=>y(()=>import("./index-5a6c447d.js"),["assets/index-5a6c447d.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-8009d17a.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/get-last-year-for-period-e1de6b16.js","assets/index-b364ce0d.js"])),$x=l.lazy(()=>y(()=>import("./index-bfc4f49e.js"),["assets/index-bfc4f49e.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-8009d17a.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-b364ce0d.js"])),Px=l.lazy(()=>y(()=>import("./index-4a297d6e.js"),["assets/index-4a297d6e.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-8009d17a.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/get-last-year-for-period-e1de6b16.js","assets/index-b364ce0d.js"])),Cx=l.lazy(()=>y(()=>import("./index-c2d52ab6.js"),["assets/index-c2d52ab6.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js"])),Ox=l.lazy(()=>y(()=>import("./index-2aead805.js"),["assets/index-2aead805.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-b364ce0d.js"])),Ax=l.lazy(()=>y(()=>import("./index-be19068d.js"),["assets/index-be19068d.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-site-and-topic-a96b5f53.js","assets/index-b364ce0d.js"])),Dx=l.lazy(()=>y(()=>import("./index-56e206be.js"),["assets/index-56e206be.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-17957fb0.js","assets/index-b364ce0d.js"])),Nx=l.lazy(()=>y(()=>import("./index-ac8151fb.js"),["assets/index-ac8151fb.js","assets/vendor-561dac3a.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-method-obtaining-fields-8009d17a.js","assets/get-teacher-subdivisions-5cd556a9.js","assets/index-b364ce0d.js"])),Ix=l.lazy(()=>y(()=>import("./index-ebe03cef.js"),["assets/index-ebe03cef.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Rx=l.lazy(()=>y(()=>import("./index-281b9bc1.js"),["assets/index-281b9bc1.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Lx=l.lazy(()=>y(()=>import("./index-cdf9aa0a.js"),["assets/index-cdf9aa0a.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),zx=l.lazy(()=>y(()=>import("./index-138deff4.js"),["assets/index-138deff4.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Mx=l.lazy(()=>y(()=>import("./index-d8805642.js"),["assets/index-d8805642.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Fx=l.lazy(()=>y(()=>import("./index-c77dbb6b.js"),["assets/index-c77dbb6b.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Bx=l.lazy(()=>y(()=>import("./index-c38689f8.js"),["assets/index-c38689f8.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Hx=l.lazy(()=>y(()=>import("./index-04e37531.js"),["assets/index-04e37531.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Ux=l.lazy(()=>y(()=>import("./index-0da4631f.js"),["assets/index-0da4631f.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js"])),Wx=l.lazy(()=>y(()=>import("./index-7247a165.js"),["assets/index-7247a165.js","assets/vendor-561dac3a.js","assets/index-b364ce0d.js","assets/index-465e7119.js","assets/send-form-f4588200.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-53f7b63c.js","assets/get-default-subdivision-17957fb0.js","assets/get-teacher-subdivisions-5cd556a9.js"])),Vx=l.lazy(()=>y(()=>import("./index-7360f81c.js"),["assets/index-7360f81c.js","assets/vendor-561dac3a.js"]));l.lazy(()=>y(()=>import("./index-e0c5f6f0.js"),["assets/index-e0c5f6f0.js","assets/vendor-561dac3a.js","assets/index-2da65ff7.js","assets/index-ade1c0ef.js"]));const ps=l.lazy(()=>y(()=>import("./index-21f11a48.js"),["assets/index-21f11a48.js","assets/vendor-561dac3a.js"])),Gx=l.lazy(()=>y(()=>import("./index-6c7fa8c2.js"),["assets/index-6c7fa8c2.js","assets/vendor-561dac3a.js"])),qx=l.lazy(()=>y(()=>import("./index-84145ec7.js"),["assets/index-84145ec7.js","assets/vendor-561dac3a.js"])),Yx=l.lazy(()=>y(()=>import("./index-2053f601.js"),["assets/index-2053f601.js","assets/vendor-561dac3a.js"])),Jx=l.lazy(()=>y(()=>import("./index-48bf361c.js"),["assets/index-48bf361c.js","assets/vendor-561dac3a.js"])),Xx=l.lazy(()=>y(()=>import("./index-633caff1.js"),["assets/index-633caff1.js","assets/vendor-561dac3a.js"])),Kx=l.lazy(()=>y(()=>import("./index-36b22090.js"),["assets/index-36b22090.js","assets/vendor-561dac3a.js","assets/get-default-subdivision-17957fb0.js"])),Qx=l.lazy(()=>y(()=>import("./index-abcb80fb.js"),["assets/index-abcb80fb.js","assets/vendor-561dac3a.js","assets/get-default-subdivision-17957fb0.js"])),Zx=l.lazy(()=>y(()=>import("./index-26a60a28.js"),["assets/index-26a60a28.js","assets/vendor-561dac3a.js"])),em=l.lazy(()=>y(()=>import("./index-d778a7c0.js"),["assets/index-d778a7c0.js","assets/vendor-561dac3a.js","assets/send-hr-form-work-transfer-1daeaaa2.js"])),tm=l.lazy(()=>y(()=>import("./index-dcc16c67.js"),["assets/index-dcc16c67.js","assets/vendor-561dac3a.js","assets/send-hr-form-work-transfer-1daeaaa2.js"]));l.lazy(()=>y(()=>Promise.resolve().then(()=>y0),void 0));l.lazy(()=>y(()=>import("./index-abfe5941.js"),["assets/index-abfe5941.js","assets/vendor-561dac3a.js","assets/BoldText-68a8be97.js","assets/help-links-927ff256.js"]));const im=l.lazy(()=>y(()=>import("./index-d3168d92.js"),["assets/index-d3168d92.js","assets/vendor-561dac3a.js"])),rr=l.lazy(()=>y(()=>import("./index-9a4df0f7.js"),["assets/index-9a4df0f7.js","assets/vendor-561dac3a.js","assets/index-2da65ff7.js","assets/index-ade1c0ef.js"])),lr=l.lazy(()=>y(()=>import("./index-e0c5f6f0.js"),["assets/index-e0c5f6f0.js","assets/vendor-561dac3a.js","assets/index-2da65ff7.js","assets/index-ade1c0ef.js"])),nm=l.lazy(()=>y(()=>import("./index-44c0c91b.js"),["assets/index-44c0c91b.js","assets/vendor-561dac3a.js"]));l.lazy(()=>y(()=>import("./index-0566e8f3.js"),["assets/index-0566e8f3.js","assets/vendor-561dac3a.js","assets/index.esm-7da5ec35.js"]));const sm=l.lazy(()=>y(()=>import("./index-3968709c.js"),["assets/index-3968709c.js","assets/vendor-561dac3a.js"])),cr=l.lazy(()=>y(()=>import("./index-d4a3c3ab.js"),["assets/index-d4a3c3ab.js","assets/vendor-561dac3a.js","assets/help-links-927ff256.js"])),om=l.lazy(()=>y(()=>import("./index-288b2b3d.js"),["assets/index-288b2b3d.js","assets/vendor-561dac3a.js"])),am=l.lazy(()=>y(()=>import("./index-40027479.js"),["assets/index-40027479.js","assets/vendor-561dac3a.js","assets/alert-item-9e73782f.js","assets/is-valid-url-08a91344.js"])),rm=l.lazy(()=>y(()=>import("./index-936d178b.js"),["assets/index-936d178b.js","assets/vendor-561dac3a.js","assets/index-8c20f312.js","assets/alert-item-9e73782f.js","assets/is-valid-url-08a91344.js"])),lm=l.lazy(()=>y(()=>import("./index-29ba3827.js"),["assets/index-29ba3827.js","assets/vendor-561dac3a.js"]));l.lazy(()=>y(()=>Promise.resolve().then(()=>jv),void 0));const cm=l.lazy(()=>y(()=>import("./index-36dc1068.js"),["assets/index-36dc1068.js","assets/vendor-561dac3a.js"])),dr=l.lazy(()=>y(()=>import("./index-7858fe3f.js"),["assets/index-7858fe3f.js","assets/vendor-561dac3a.js","assets/index-8c20f312.js","assets/index-ade1c0ef.js"])),dm=l.lazy(()=>y(()=>import("./index-6f7ca052.js"),["assets/index-6f7ca052.js","assets/vendor-561dac3a.js","assets/index-49d29b9f.js"])),pm=l.lazy(()=>y(()=>import("./index-dcefcb5b.js"),["assets/index-dcefcb5b.js","assets/vendor-561dac3a.js","assets/index-49d29b9f.js"])),um=l.lazy(()=>y(()=>import("./index-1e5131d0.js"),["assets/index-1e5131d0.js","assets/vendor-561dac3a.js","assets/index-49d29b9f.js"])),hm=l.lazy(()=>y(()=>import("./index-ec169e9b.js"),["assets/index-ec169e9b.js","assets/vendor-561dac3a.js"])),gm=l.lazy(()=>y(()=>import("./index-d0aae202.js"),["assets/index-d0aae202.js","assets/vendor-561dac3a.js","assets/index.esm-7da5ec35.js","assets/index-785e0d2d.js"])),fm=l.lazy(()=>y(()=>import("./index-72bbcf2a.js"),["assets/index-72bbcf2a.js","assets/vendor-561dac3a.js"])),xm=l.lazy(()=>y(()=>import("./index-1b19e3f1.js"),["assets/index-1b19e3f1.js","assets/vendor-561dac3a.js"])),mm=l.lazy(()=>y(()=>import("./index-72db377c.js"),["assets/index-72db377c.js","assets/vendor-561dac3a.js"])),bm=l.lazy(()=>y(()=>import("./index-62b53858.js"),["assets/index-62b53858.js","assets/vendor-561dac3a.js","assets/index-333867aa.js"])),vm=l.lazy(()=>y(()=>import("./index-b5e53e85.js"),["assets/index-b5e53e85.js","assets/vendor-561dac3a.js"])),ym=l.lazy(()=>y(()=>import("./index-2a97adac.js"),["assets/index-2a97adac.js","assets/vendor-561dac3a.js","assets/help-links-927ff256.js"])),_m=l.lazy(()=>y(()=>import("./index-49fb6f19.js"),["assets/index-49fb6f19.js","assets/vendor-561dac3a.js","assets/help-links-927ff256.js"]));l.lazy(()=>y(()=>Promise.resolve().then(()=>Hk),void 0));const wm=l.lazy(()=>y(()=>import("./index-abfe5941.js"),["assets/index-abfe5941.js","assets/vendor-561dac3a.js","assets/BoldText-68a8be97.js","assets/help-links-927ff256.js"])),jm=l.lazy(()=>y(()=>import("./index-83c4054f.js"),["assets/index-83c4054f.js","assets/vendor-561dac3a.js"])),km=p.div`
    width: 100%;
...
`,zm=e=>{const{handleOpen:i,refElement:n,isOpen:s,multiple:o,handleSelect:a,selectedRoute:r,currentItems:c,route:d,goBack:u,refItems:h,appearance:f}=Om(e),{isActive:g,width:m,title:x,required:b,selected:v,placeholder:T,size:I="middle"}=e;return t.jsxs(Dm,{onClick:i,appearance:f,ref:n,isOpen:s,isActive:g??!0,width:m,size:I,children:[t.jsx(U,{size:4,align:"left",bottomGap:"5px",visible:!!x,required:b,children:x}),t.jsxs(Am,{multiple:o,appearance:f,size:I,children:[t.jsx(Nm,{appearance:f,children:o?v?v.map(j=>t.jsxs("div",{className:"header-item",children:[!!j.icon&&t.jsx("span",{className:"icon",children:j.icon}),t.jsx("span",{className:"header-title",children:j.title})]},j.id)):t.jsx("span",{className:"not-chosen multi",children:T??"Не выбрано"}):t.jsx("div",{className:"single-header",children:v?t.jsxs(t.Fragment,{children:[!!v.icon&&t.jsx("span",{className:"icon",children:v.icon}),t.jsx("span",{className:"header-title",children:v.title})]}):t.jsx("span",{className:"not-chosen",children:T??"Не выбрано"})})}),t.jsx(Lm,{isOpen:s})]}),t.jsxs(Im,{width:m,ref:h,isOpen:s,className:s?"open":"close",itemsAmount:c.length+(d.length?1:0),title:x,children:[!!d.length&&t.jsx(Js,{isSelected:!1,onClick:j=>{j.stopPropagation(),u()},children:t.jsxs("span",{className:"back-button",children:[t.jsx(_i,{}),"Назад"]})},-1),c.map(({id:j,icon:S,title:O,children:L,data:N})=>t.jsxs(Js,{onClick:K=>{K.stopPropagation(),a({id:j,icon:S,title:O,children:L,data:N})},isSelected:!o&&!!v&&v.title.includes(O),leadingToSelected:r.includes(j.toString()),children:[!!S&&t.jsx("span",{className:"icon",children:S}),t.jsx("span",{className:"select-item-title",children:O}),!!L&&t.jsx("span",{className:"right-icon",children:t.jsx(ht,{})}),o&&!!v&&!!v.find(K=>K.title.includes(O))&&t.jsx("span",{className:"right-icon",children:t.jsx(nn,{})})]},O))]})]})},pr=l.memo(zm),Mm=e=>{switch(e){case"desc":return B.evokePopUpMessage({message:"Таблица отсортирована по убыванию",type:"info",time:5e3});case"asc":return B.evokePopUpMessage({message:"Таблица отсортирована по возрастанию",type:"info",time:5e3});default:return B.evokePopUpMessage({message:"Сортировка отключена",type:"info",time:5e3})}},Fm=p.div`
    display: flex;
    align-items: center;
    width: 100%;
    font-size: 0.9em;
...
`,fn=()=>t.jsx(Q,{type:"info",title:"Информация",icon:t.jsx(Je,{}),children:"Данный сервис позволяет заказать необходимую справку, подать заявление, запрос. Статус (информация о степени готовности) заказанных справок меняется согласно действиям оператора. В колонке «Подразделение, адрес» указывается название подразделения и адрес, куда необходимо приехать за готовым документом."}),gr=()=>{const{data:{listApplication:e},error:i}=me.useApplications();return t.jsx(We,{load:()=>Re.getApplicationsFx(),loading:!e,error:i,data:e,children:t.jsx(b0,{children:t.jsxs(gn,{maxWidth:"1500px",children:[t.jsxs(v0,{children:[t.jsx(U,{size:2,align:"left",children:"Заявление на увольнение"}),t.jsx(fn,{})]}),t.jsx(x0,{})]})})})},b0=p.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,O0=()=>{const{data:{dataWorkerApplication:e}}=me.useApplications(),[i,n]=l.useState(!0);return e?t.jsxs(A0,{children:[e.map((s,o)=>s.isDismissal?(i&&n(!1),null):t.jsx(E0,{info:s,index:o})),t.jsx(k0,{})]}):null},A0=p.div`
    ...
    flex-direction: column;
    gap: 30px;
`,D0=()=>{const{data:{listApplication:e},error:i}=me.useApplications();return t.jsx(We,{load:()=>Re.getApplicationsFx(),loading:!e,error:i,data:e,children:t.jsx(N0,{children:t.jsxs(gn,{maxWidth:"1500px",children:[t.jsxs(I0,{children:[t.jsx(U,{size:2,align:"left",children:"Заявление на выход в выходной день"}),t.jsx(fn,{})]}),t.jsx(O0,{})]})})})},N0=p.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,ob=p.div`
    ...
    padding-bottom: 40px;
    margin-bottom: 10px;
`,ab=e=>localStorage.setItem("age",e.toString()),FT=e=>localStorage.getItem(e),rb=e=>e.map(i=>{localStorage.setItem(i.employeeGuid,i.tutor.toString())}),lb={listMedicalExamination:null,error:null},zt=z(async()=>{const e=await he.get(`MedicalExamination.GetAllHistory?PersonalGuid=${qt(Ke()??"").IndividualGuid}`);try{return ab(e.data.age),rb(e.data.employeeMedicalExaminations.map(({employeeGuid:i,tutor:n})=>({employeeGuid:i,tutor:n}))),e.data.employeeMedicalExaminations}catch{throw new Error("Не удалось загрузить информацию. Попробуйте позже")}}),$i=z(async e=>{try{const i=await he.post("MedicalExamination.AddMedicalExamination",e);if(i.data.isError)throw new Error;return i.data}catch(i){throw new Error(i)}}),cb=()=>{const{listMedicalExamination:e,error:i}=je(db);return{data:e,loading:je($i.pending),getDataLoading:je(zt.pending),error:i}};k();Le({from:$i.doneData,to:zt});$({clock:$i.doneData,fn:()=>({message:"Форма отправлена успешно",type:"success"}),target:B.evokePopUpMessage});$({clock:$i.failData,fn:()=>({message:"Не удалось отправить форму.",type:"hrFailure"}),target:B.evokePopUpMessage});const db=J(lb).on(zt,e=>({...e,error:null})).on(zt.doneData,(e,i)=>({...e,listMedicalExamination:i})).on(zt.failData,(e,i)=>({...e,error:i.message})),pb={loadBufferMedicalExaminationFx:zt,sendBufferMedicalExaminationFx:$i},ub={useBufferMedicalExamination:cb},Er=()=>[{title:"Дата",field:"creationDate",width:"100px",sort:!0,type:"date"},{title:"Статус",field:"orderStatus",width:"150px",render:e=>t.jsx(Q,{type:e==="Согласовано"?"success":e==="На регистрации"?"info":e==="Не утвержден"||e==="Не создано"?"failure":"alert",title:e||"-",align:"center",width:"100%",icon:null,maxWidth:"150px"})},{title:"Должность",field:"jobTitle",sort:!0},{title:"Период",field:"medicalExamination",align:"center",width:"200px",render:(e,i)=>`${se(i==null?void 0:i.startDate,"numeric")} - ${se(i==null?void 0:i.endDate,"numeric")}`},{title:"Файл заявления",priority:"one",field:"downloadable",type:"file",width:"200px",align:"center",render:(e,i)=>i!=null&&i.downloadApplication?t.jsx(_,{text:"Скачать файл",background:"rgb(60,210,136)",textColor:"#fff",id:"downloadButton",width:"150px",align:"center",minWidth:"150px",height:"30px",onClick:n=>{n.stopPropagation(),xn(i==null?void 0:i.documentGuid,"0")}}):"-"}],hb=()=>[...Er(),{title:"Статус приказа",field:"orderApprovalStatus",align:"center",render:e=>e||"-"},{title:"Статус заявления",field:"applicationApporvalStatus",align:"center",render:e=>e||"-"},{title:"Файл заявления",priority:"one",field:"downloadable",type:"file",width:"200px",align:"center",render:(e,i)=>i!=null&&i.downloadApplication?t.jsx(_,{text:"Скачать файл",background:"rgb(60,210,136)",textColor:"#fff",id:"downloadButton",width:"150px",align:"center",minWidth:"150px",height:"30px",onClick:n=>{n.stopPropagation(),xn(i==null?void 0:i.documentGuid,"1")}}):"-"}],gb=()=>{const{data:e,getDataLoading:i}=ub.useBufferMedicalExamination(),{data:{dataWorkerApplication:n}}=me.useApplications(),s=n&&e&&e.map(o=>{const a=n.find(r=>r.jobGuid===o.employeeGuid);return[...o.notTaken.map(r=>({...r,jobTitle:a==null?void 0:a.jobTitle}))]}).flat().sort((o,a)=>zo(new Date(o.startDate),new Date(a.startDate)));return t.jsxs(We,{load:pb.loadBufferMedicalExaminationFx,error:null,data:e,children:[t.jsxs(C,{jc:"space-between",m:"10px 0",children:[t.jsx(fb,{children:"История заявлений на диспансеризацию:"}),t.jsx(Z,{to:"/hr-applications/medical-examination",children:t.jsx(_,{text:"Диспансеризация",background:"var(--reallyBlue)",textColor:"#fff",icon:t.jsx(St,{}),minWidth:"35px",height:"36px",shrinkTextInMobile:!0})})]}),i?t.jsx(C,{w:"100%",jc:"center",ai:"center",children:t.jsx(Qe,{})}):t.jsx(Ve,{orientation:"vertical",alignItems:"flex-start",justifyContent:"flex-start",gap:"10px",width:"100%",maxWidth:"100%",height:"fit-content",children:t.jsx(et,{columns:Er(),columnsExtended:hb(),data:s,maxOnPage:10})})]})},fb=p.div`
    display: flex;
    flex-direction: row;
    gap: 10px;
    align-items: center;
`,xb=()=>{const{data:{dataWorkerApplication:e},error:i}=me.useApplications();return t.jsx(We,{load:Re.getWorkerPosts,error:i,data:e,children:t.jsxs(Xt,{children:[t.jsx(Q,{type:"info",title:"Информация",icon:t.jsx(Je,{}),lineHeight:"1.4rem",fontSize:"0.85rem",children:"Тут можно посмотреть свои заявления на диспансеризацию и согласовать их."}),t.jsx(gb,{})]})})},$r=k(),Pr=k(),Cr=z(async()=>{const{data:e}=await he.get(`AnotherPlaceWork.GetAllHistory?PersonalGuid=${qt(Ke()??"").IndividualGuid}`);return e.employeeHistories});$({clock:$r,target:Cr});const Pi=z(async e=>(await he.post("AnotherPlaceWork.AddAnotherPlaceOfWork",e)).data);$({clock:Pr,target:Pi});const Or=J([]),mb=Pi.pending;$({clock:Cr.doneData,target:Or});$({clock:Pi.doneData,fn:e=>{const i=e;return i.isError?{message:i.error,type:"hrFailure",time:3e5}:{message:"Форма отправлена успешно",type:"success",time:0}},target:ft.evokePopUpMessage});$({clock:Pi.fail,fn:()=>({message:"Не удалось отправить форму.",type:"hrFailure",time:3e5}),target:ft.evokePopUpMessage});const bb={loadBufferWorkTransfer:$r,sendBufferWorkTransfer:Pr},BT={sendBufferWorkTransferFx:Pi},vb={useBufferWorkTransfer:()=>({data:je(Or),loading:je(mb)})},yb=()=>{const[e,i]=l.useState(!1);l.useEffect(bb.loadBufferWorkTransfer,[]);const{data:n}=vb.useBufferWorkTransfer(),s=!!n.every(o=>!o);return t.jsxs(Ve,{orientation:"vertical",alignItems:"flex-start",justifyContent:"flex-start",gap:"10px",width:"100%",maxWidth:"100%",height:"fit-content",children:[t.jsxs(_b,{children:["История заявлений на перевод:",t.jsx(_,{icon:e?t.jsx(gt,{}):t.jsx(Ue,{}),onClick:()=>!s&&i(o=>!o),background:"transparent"})]}),e&&t.jsx(wb,{columns:fr(),data:n.map(o=>({...o})),maxOnPage:5}),t.jsx(_,{onClick:()=>{!s&&i(o=>!o)},text:s?"История пуста":e?"Скрыть":"Подробнее",background:"transparent"})]})},_b=p.div`
    display: flex;
    flex-direction: row;
    gap: 10px;
    align-items: center;
...
`,Eb=()=>{const{data:{dataWorkerApplication:e}}=me.useApplications(),[i,n]=l.useState(!0);return e?t.jsxs($b,{children:[e.map((s,o)=>s.isDismissal?(i&&n(!1),null):t.jsx(jb,{info:s,index:o})),t.jsx(yb,{})]}):null},$b=p.div`
    ...
    flex-direction: column;
    gap: 30px;
`,Pb=()=>{const{data:{listApplication:e},error:i}=me.useApplications();return t.jsx(We,{load:()=>Re.getApplicationsFx(),loading:!e,error:i,data:e,children:t.jsx(Cb,{children:t.jsxs(gn,{maxWidth:"1500px",children:[t.jsxs(Ob,{children:[t.jsx(U,{size:2,align:"left",children:"Заявление на перевод"}),t.jsx(fn,{})]}),t.jsx(Eb,{})]})})})},Cb=p.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,Yb=({date:e,value:i})=>t.jsxs(qb,{children:[t.jsxs(C,{gap:"16px",children:[t.jsx(mt,{color:"grey",size:33,children:t.jsx(ct,{})}),t.jsxs(C,{d:"column",ai:"flex-start",children:[t.jsx("span",{className:"payment-item-date",children:"Платеж"}),t.jsx(oe,{children:se(e)})]})]}),t.jsxs("span",{className:"payment-item-money",children:["+",i," ",t.jsx(ct,{})," "]})]}),Jb=p.div`
    display: flex;
    align-items: center;
    font-size: ${({fontSize:e})=>e};
...
`,tv=({contract:e})=>{if(!e)return null;const{number:i,startDate:n,endDatePlan:s,contragent:o,sum:a,can_sign:r,file:c,student:d,signed_user_date:u}=e,{open:h}=te(),[f,g]=l.useState(!1),[m,x]=l.useState(!1),[b,v]=l.useState(!1),T=wi(at.$error),I=[{text:"Номер договора",info:i??""},{text:"Начало действия",info:se(n)},{text:"Действует до",info:se(s)},{text:"Подписан",info:se(u)},{text:"Заказчик",info:o||"Московский политех"},{text:"Обучающийся",info:d??""},{text:"Сумма к оплате",info:Zb(a)??""},{text:"Статус",info:""}],j=()=>{navigator.clipboard.writeText((e==null?void 0:e.number)??""),g(!0)},S=()=>{e&&(x(!0),ms.signContractFx(e.id),x(!1),v(!0))},O=()=>{h(t.jsx(Mr,{}),"Не получается подписать")};return t.jsxs(ev,{children:[t.jsx("div",{className:"contract-info",children:I.map(({info:L,text:N})=>t.jsx(vt,{keyStr:N,value:L},L))}),r&&t.jsxs(C,{d:"column",gap:"8px",children:[t.jsx(dt,{text:"Подписать договор",buttonSuccessText:"Подписан",action:S,isLoading:m,completed:b,repeatable:!1,popUpFailureMessage:T??"Не удалось подписать договор",setCompleted:v,popUpSuccessMessage:"Договор подписан",isActive:!0,pulsing:!0}),t.jsx(_,{onClick:O,text:"Не получается подписать?",background:"transparent",textColor:w.grey.main})]}),!r&&t.jsxs(C,{gap:"8px",children:[t.jsx(dt,{text:"Скопировать номер договора",action:j,isLoading:!1,completed:f,setCompleted:g,popUpSuccessMessage:"Номер договора скопирован в буфер",isActive:!0}),c&&t.jsx(Si,{onClick:()=>null,href:c??"",icon:t.jsx(is,{}),width:"45px"})]})]})},iv=p.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    user-select: none;
...
`,Mi=({qrCode:e})=>{const[i,n]=l.useState(!0);return l.useEffect(()=>{setTimeout(()=>{n(!1)},500)},[]),t.jsx(cv,{children:t.jsx(cs,{loading:i,width:"300px",height:"300px",src:e??""})})},dv=p.div`
    @media (min-width: 1001px) {
        width: 300px;
    }
`,pv=({qr_current:e,qr_total:i,currentPage:n})=>n===0?t.jsx(Mi,{qrCode:e}):n===1?t.jsx(Mi,{qrCode:i}):t.jsx(dv,{children:t.jsx(Ss,{pages:[{title:"Текущая задолженность",content:t.jsx(Mi,{qrCode:e})},{title:"Общая задолженность",content:t.jsx(Mi,{qrCode:i})}],appearance:!1,currentPage:n})}),uv=({type:e="horizontal",...i})=>{const{open:n}=te(),s="Оплатить через QR-code",o=`linear-gradient(45deg, ${w.green.main}, ${w.green.dark1})`,a=()=>{n(t.jsx(pv,{...i}),s)};return e==="vertical"?t.jsx(_,{onClick:a,width:"68px",height:"60px",direction:"vertical",text:"QR",icon:t.jsx(mp,{}),textColor:"#fff",background:o}):t.jsx(_,{text:s,onClick:a,width:"100%",textColor:"#fff",background:o})},hv=({debt:e,size:i="big"})=>{const n=e>0?w.red.main:w.green.main;return t.jsx(zr,{size:i,color:n,fontWeight:"600",children:e>=0?e:`+${-e}`})},On=e=>e.reduce((i,n)=>(i[n.title]=n.mql.matches,i),{}),Oi=()=>{const e=Qu.map(({query:s,title:o})=>({mql:matchMedia(s),title:o})),[i,n]=l.useState(On(e));return l.useLayoutEffect(()=>(e.forEach(({mql:s})=>s.addEventListener("change",()=>{n(On(e))})),()=>e.forEach(({mql:s})=>s.removeEventListener("change",()=>{n(On(e))}))),[]),{...i,currentDevice:Object.keys(i).find(s=>i[s]===!0)??"desktop"}},gv=p.div`
    width: 100%;
`,fv=p.div`
    width: 100%;
    padding: 16px;
...
`,Ey=p(Z)`
    width: 100%;
`,$y=({division:e})=>{const{close:i}=te();return t.jsxs(Ty,{children:[t.jsxs(C,{d:"column",gap:"12px",jc:"center",h:"100%",children:[t.jsx(mt,{size:120,color:"purple",children:t.jsx(ri,{})}),t.jsx(oe,{fontSize:"1.2rem",align:"center",children:e})]}),t.jsx(Ey,{to:`${Tl}/${e}`,onClick:i,children:t.jsx(_,{icon:t.jsx(ta,{}),width:"100%",text:"Список"})})]})},Py=p.div`
    width: 100%;
    color: var(--text);
    padding: 0px 16px;
...
`,Cy=({division:e})=>{const{open:i}=te(),n=()=>{i(t.jsx($y,{division:e}),"Подразделение")};return t.jsx(Py,{onClick:n,children:t.jsxs(C,{gap:"8px",h:"50px",jc:"space-between",w:"100%",children:[t.jsxs(C,{gap:"8px",children:[t.jsx(ri,{}),t.jsx(oe,{fontSize:"1rem",children:e})]}),t.jsx(ht,{})]})})},Oy=({divisions:e})=>!e||e.length===0?null:t.jsx(C,{d:"column",gap:"4px",ai:"flex-start",children:e.map(i=>t.jsx(Cy,{division:i},i))}),bn=(e,i)=>e.split("/").reduce((o,a)=>{if(a[0]===":"){const r=i[a.slice(1,a.length)];r&&o.push(r)}else o.push(a);return o},[]).join("/"),Ay=p.div`
    display: flex;
    flex-direction: column;
    height: 300px;
...
`,o_=()=>{const{showMessage:e,showSearchResult:i,searchValue:n,setSearchValue:s,currentPage:o,setCurrentPage:a,loading:r,config:c,searchHistory:d}=t_(),u=i_(r,n,d),{isOpen:h}=te();return t.jsx(s_,{children:t.jsxs(C,{d:"column",gap:"8px",h:"100%",children:[t.jsx(Ka,{value:n,setValue:s,loading:r,focusOn:h,hints:u}),t.jsx(ds,{pages:c.map(({title:f})=>({title:f})),currentPage:o,setCurrentPage:a}),t.jsx(Xa,{value:n,setValue:s}),e&&t.jsx(C,{h:"100%",children:t.jsx(fe,{size:"60px",text:'Введите что-нибудь. Например, "Цифровые сервисы"',image:t.jsx(Bt,{})})}),!r&&n.length!==0&&!e&&!Qi(c[o].data)&&t.jsx(C,{h:"100%",children:t.jsx(fe,{size:"60px",text:"Ничего не было найдено",image:t.jsx(Lo,{})})}),r&&Array(10).fill(0).map((f,g)=>t.jsx(n_,{},g)),i&&t.jsx(t.Fragment,{children:c[o].content})]})})},a_=p(Ze)`
    cursor: pointer;
...
`;function Di({selected:e,name:i,avatar:n,width:s,height:o,marginRight:a,notifications:r,checked:c,boxShadow:d,border:u,icon:h,avatarModal:f,onClick:g,borderRadius:m,background:x}){const[b,v]=l.useState(!0),T=Yn(i)[0]+(Yn(i)[1]??""),{open:I}=te(),j=S=>{f?I(t.jsx(Di,{name:i,width:"400px",height:"400px",marginRight:"0",avatar:n})):g==null||g(S)};return t.jsxs(d_,{selected:e,width:s,height:o,marginRight:a,background:x??De(i),boxShadow:d,border:u,onClick:j,borderRadius:m,children:[n&&b?t.jsx(p_,{loading:"lazy",round:!0,onLoadedData:()=>v(!0),onError:()=>v(!1),src:n}):t.jsx("div",{className:"name",children:T}),h&&t.jsx("span",{className:"icon",children:h}),t.jsx(Be,{invisibleOnFalse:!0,checked:c??!1,visible:c!==void 0,setChecked:()=>null}),t.jsx(Et,{left:"80%",top:"90%",outline:"4px solid var(--block)",visible:!!r,children:r})]})}const VT=p.header`
    width: 100%;
    /* max-width: 750px; */
    padding-top: 100px;
    position: relative;
...
`,k_=({showSearch:e=!1})=>{const{data:{user:i}}=_e.useUser();if(!i)return null;const n=s=>{s.preventDefault(),s.stopPropagation(),Ie.open({e:s,height:143,content:t.jsx(Zl,{})})};return t.jsxs(j_,{children:[e&&t.jsx(Xl,{size:"icon"}),t.jsx(__,{}),t.jsx(Di,{onClick:n,width:"30px",height:"30px",avatar:i.avatar,name:i.fullName,marginRight:"0"})]})},S_=p.header`
    width: calc(100% - 15px);
...
`,I_=({name:e,avatar:i,loading:n,size:s,notifications:o,selected:a})=>{if(n)return t.jsx(Y,{shape:"circle",size:{width:"40px",height:"40px"}});const r=c=>{c.preventDefault(),c.stopPropagation(),Ie.open({e:c,height:143,content:t.jsx(Zl,{})})};return t.jsxs(N_,{to:_s,children:[t.jsx(_,{icon:t.jsx(ea,{}),className:"more-button",background:"transparent",onClick:r}),t.jsx(Di,{notifications:o,width:s??"70px",height:s??"70px",avatar:i,name:e,marginRight:"0",selected:a}),t.jsx(U,{size:5,children:e})]})},R_=le.memo(I_),L_=["isCurrent","color"],z_=p(Z).withConfig({shouldForwardProp:e=>!L_.includes(e)})`
    position: relative;
    display: flex;
    align-items: center;
    font-weight: 600;
...
`;const V_=()=>{const{leftsideBarRoutes:e}=He.useMenu(),i=Vt();return e?t.jsx(F_,{children:Object.values(e).filter(n=>n!==void 0).map(n=>l.createElement(ec,{...n,key:n==null?void 0:n.id,isCurrent:i.pathname.includes(n.path)}))}):t.jsxs(C,{d:"column",children:[t.jsxs(C,{gap:"8px",children:[t.jsx(Y,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(Y,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs(C,{gap:"8px",children:[t.jsx(Y,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(Y,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs(C,{gap:"8px",children:[t.jsx(Y,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(Y,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs(C,{gap:"8px",children:[t.jsx(Y,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(Y,{shape:"rect",size:{width:"160px",height:"18px"}})]})]})},G_=le.memo(V_),q_=()=>{const{isOpen:e}=He.useMenu(),{width:i,height:n}=un(),{data:{user:s}}=_e.useUser(),{visibleRoutes:o}=He.useMenu(),a=Vt();return t.jsxs(M_,{isOpen:e,height:n,children:[t.jsxs("div",{className:"top-wrapper",children:[t.jsx(Z,{to:ys,children:t.jsx(dn,{width:"165px"})}),t.jsx(R_,{notifications:o==null?void 0:o.profile.notifications,avatar:s==null?void 0:s.avatar,name:(s==null?void 0:s.fullName)??"",loading:!s,selected:a.pathname==="/profile"}),t.jsx(Xl,{size:"small"}),t.jsx(G_,{})]}),t.jsx(Kl,{type:"toggle"}),i<1e3&&t.jsx(U_,{})]})},Y_=p.div`
    width: 300px;
    position: absolute;
...
`,J_=()=>{const{isOpen:e,message:i,type:n,time:s,onClick:o}=Sa.usePopUpMessage();l.useEffect(()=>{e&&setTimeout(()=>{B.openPopUpMessage({isOpen:!e})},s)},[e]);const a=l.useCallback(()=>{o&&(o(),B.openPopUpMessage({isOpen:!e}))},[o]);return t.jsx(Y_,{isOpen:e,isClickable:!!o,color:Tt[n].color,onClick:a,children:t.jsx(Q,{type:n,fontSize:"1em",lineHeight:"1.4rem",onClose:()=>B.openPopUpMessage({isOpen:!1}),children:i})})},vn=p.div`
    display: flex;
    justify-content: center;
    align-items: center;
    position: absolute;
...
`,i1=()=>{const{isOpen:e,message:i,onConfirm:n,onReject:s}=Ca.useConfirm(),o=l.useRef(null);Jt(o,()=>ot.closeConfirm());const a=()=>{n(),ot.closeConfirm()},r=()=>{ot.closeConfirm()};return t.jsx(vn,{isOpen:e,children:t.jsxs(t1,{isOpen:e,ref:o,children:[t.jsx(U,{size:3,align:"left",children:i??"Хотите продолжить?"}),t.jsxs(Ee,{width:"100%",scroll:!1,direction:"horizontal",gap:5,padding:"10px 0 0 0",horizontalAlign:"right",children:[t.jsx(_,{text:"Да",onClick:a,width:"90px",textColor:w.red.main,background:"transparent",hoverBackground:w.red.transparent3}),t.jsx(_,{text:"Нет",onClick:s??r,width:"90px",textColor:w.blue.main,background:"transparent",hoverBackground:w.blue.transparent3})]})]})})},n1=p.div`
    display: flex;
...
`,M1=e=>{const{timeInterval:i,name:n,place:s,teachers:o,dateInterval:a,link:r,rooms:c,groups:d,color:u,weekday:h,isNextEvent:f,isCurrentEvent:g,noPadding:m=!1}=e,x=(d==null?void 0:d.split(","))??[],{open:b}=te(),v=()=>{x.length===1?b(t.jsx(Ul,{group:x[0]})):b(t.jsx($1,{groups:x}),"Группы")},T=()=>{b(t.jsx(B1,{place:s,link:r,name:n}))},I=ac(n);return t.jsxs(L1,{children:[t.jsx(O1,{subjectName:n,color:u,noPadding:m}),t.jsxs(z1,{noPadding:m,d:"column",gap:"20px",ai:"flex-start",children:[t.jsxs(C,{jc:"space-between",ai:"flex-start",d:"column",gap:"6px",children:[t.jsxs(C,{gap:"8px",children:[t.jsx(rc,{isCurrentEvent:g,color:u,timeInterval:i}),t.jsx(lc,{timeLeft:yn(i.split(" - ")[0],"minutes"),isNext:f,color:u,isCurrentEvent:g})]}),t.jsx(U,{size:3,align:"left",width:"fit-content",children:I.name})]}),t.jsx(xe,{margin:"0",width:"100%"}),t.jsx(Pe,{icon:t.jsx(ns,{}),text:t.jsx(Ne,{words:[h??"",a]})}),((r==null?void 0:r.length)||I.link)&&t.jsx("a",{href:r??I.link,target:"_blank",rel:"noreferrer",children:t.jsx(Pe,{icon:t.jsx(Gi,{}),text:r?s:"Ссылка"})}),!(r!=null&&r.length)&&t.jsx(Pe,{icon:t.jsx(oa,{}),text:s}),!!c.length&&t.jsx(Pe,{icon:t.jsx(In,{}),text:t.jsx(Ne,{words:c})}),!!x.length&&t.jsx(Pe,{onClick:v,icon:t.jsx(os,{}),text:t.jsx(Ne,{words:x}),rightIcon:t.jsx(ht,{})}),t.jsx(C,{d:"column",ai:"flex-start",children:!!o[0].length&&t.jsxs(t.Fragment,{children:[t.jsx(U,{size:4,align:"left",bottomGap:!0,children:"Преподаватели"}),o.map(j=>t.jsx(Ts,{type:"staff",name:j},j))]})}),!r&&t.jsx(xe,{margin:"0",width:"100%"}),!r&&t.jsx(_,{text:"Посмотреть на карте",width:"100%",onClick:T})]})]})};p.span`
    padding: 3px 10px;
    height: 21px;
    display: flex;
    align-items: center;
...
`,Bi=({title:e,link:i,image:n})=>i?t.jsxs(F1,{href:i,children:[t.jsx("img",{src:n,alt:"",loading:"lazy"}),t.jsx(U,{size:3,children:e})]}):null,fo=p.div`
    ${ee.isNotMobile} {
        width: 500px;
    }
...
`;const aw=p.div`
    ...
    border-radius: var(--brLight);
    row-gap: 10px;
`,tE=()=>t.jsxs(aw,{children:[t.jsx(Ua,{size:"38px"}),t.jsx(U,{size:4,children:"Учебный день завершился"}),t.jsx(Tc,{})]});p.div`
    display: flex;
    align-items: center;
    column-gap: 5px;
...
`,uw=p(C)`
    ...
    margin-left: 0px;
    margin-right: 0px;
`,hw=e=>{const{title:i,duration:n,icon:s,startTime:o,place:a,people:r,shift:c,color:d,scale:u,onClick:h,link:f,rooms:g,dateInterval:m,leftShift:x,quantity:b,groups:v,isCurrentEvent:T=!1,nameInOneRow:I=!0,isNextEvent:j=!1,listView:S=!1,shortInfo:O=!1}=e,{theme:L}=xt(),{isMobile:N}=Oi(),K=L==="light"?d.dark3:d.light3,M=L==="light"?d.transparent1:d.transparent2,ie=()=>h(e),ce=(N||b>1)&&O,$e=N&&b>=2&&O,ke=r==null?void 0:r.map(ze=>{var Ri,Li;const ei=ze.split(" ");return`${ei[0]??""} ${((Ri=ei[1])==null?void 0:Ri[0])??""}.${((Li=ei[2])==null?void 0:Li[0])??""}.`}),Ge=Ec(o,c,u),ge=ac(i),Ce=$e?i.split(" ").map(ze=>ze[0].toUpperCase()):qn(ge.name,O?ce?43:35:I?300:64),Ii=(v==null?void 0:v.split(","))??[];return t.jsxs(lw,{background:M,textColor:K,listView:S,leftShift:100*x,quantity:100/b,duration:n,scale:u,top:Ge,onClick:ie,shortInfo:O,children:[t.jsx(pw,{children:s}),t.jsx(C,{className:"event-body",gap:"0px",ai:"flex-start",children:t.jsxs(cw,{scale:u,d:"column",ai:"flex-start",shortInfo:O,children:[t.jsxs(C,{d:"column",gap:"2px",children:[!O&&t.jsxs(C,{gap:"8px",children:[t.jsx(rc,{timeInterval:kc(o,n),color:d,isCurrentEvent:T}),t.jsx(lc,{timeLeft:yn(o,"minutes"),isNext:j,color:d,isCurrentEvent:T}),!!(g!=null&&g.length)&&t.jsx(Pe,{shortInfo:O,icon:N&&b>1?void 0:t.jsx(In,{}),text:t.jsx(Ne,{words:g})}),(!!f||ge.link)&&t.jsx("a",{href:f??ge.link,target:"_blank",rel:"noreferrer",children:t.jsx(Pe,{shortInfo:O,icon:t.jsx(Gi,{}),text:f?a:"Cсылка"})}),!!Ii.length&&t.jsx(Pe,{icon:t.jsx(os,{}),text:t.jsx(Ne,{words:Ii})})]}),t.jsx(dw,{listView:S,nameInOneRow:I,scale:u,shortInfo:O,children:Ce})]}),!!r.length&&!ce&&t.jsx(Pe,{shortInfo:O,text:t.jsx(Ne,{words:O?[ke[0]]:ke}),icon:t.jsx($u,{})}),!!(g!=null&&g.length)&&O&&!ce&&t.jsx(Pe,{shortInfo:O,icon:t.jsx(In,{}),text:t.jsx(Ne,{words:g})}),!!f&&O&&!ce&&t.jsx("a",{href:f,target:"_blank",rel:"noreferrer",children:t.jsx(Pe,{shortInfo:O,icon:t.jsx(Gi,{}),text:a})}),!!m&&!ce&&t.jsx(C,{gap:"5px",children:t.jsx(Pe,{shortInfo:O,icon:t.jsx(ns,{}),text:m})})]})})]})},gw=e=>{const i={};if(!e)return i;for(let n=0;n<e.length;n++){const s=e[n];i[s.startTime]||(i[s.startTime]=[]),s.startTime==="18:20"?(i["17:50"]||(i["17:50"]=[]),i["17:50"].push(s)):s.startTime==="19:50"&&i["19:30"]?(i["19:30"]||(i["19:30"]=[]),i["19:30"].push(s)):s.startTime==="19:30"&&i["19:50"]?(i["19:50"]||(i["19:50"]=[]),i["19:50"].push(s)):i[s.startTime].push(s)}return i},fw=({events:e,shift:i,scale:n,shortInfo:s,weekDay:o,interval:a,showTime:r,onClick:c,currentDay:d,isCurrentDay:u})=>{const h=gw(e),f=u??new Date().getDay()===o,g=d!==void 0?d+1===o:void 0;return t.jsxs(uw,{h:"100%",d:"column",children:[f&&t.jsx(S1,{isVisible:g,showTime:r,scale:n,shift:i,interval:a}),Object.keys(h).map((m,x)=>h[m].map((b,v)=>l.createElement(hw,{leftShift:v,quantity:h[m].length,scale:n,isCurrentEvent:$s(b,f),isNextEvent:oc(e,b,f),...b,onClick:c,shift:i,key:b.startTime+b.title+x+v,shortInfo:s})))]})},xw=p(C)`
    position: absolute;
    left: 0;
    z-index: 0;
...
`,Tw=p(oe)`
    margin-bottom: 20px;
`,Ew=({image:e,list:i,text:n})=>{const{isMobile:s}=Oi();return t.jsxs(kw,{children:[!!e&&t.jsxs(t.Fragment,{children:[t.jsx(U,{size:3,align:"center",bottomGap:!0,children:e.title}),t.jsx("div",{className:"image",children:e.component??t.jsx("img",{src:s&&e.mobile?e.mobile:e.desktop,alt:""})})]}),t.jsx(Tw,{lineHeight:"1.6rem",width:"100%",align:"center",fontSize:"1rem",visible:!!n,children:n}),!!i&&t.jsx(Sw,{children:i==null?void 0:i.map(o=>l.createElement(jw,{...o,key:o.title}))})]})},$w=p.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: center;
...
`,Dc=(e,i)=>i.reduce((n,s)=>{const o=s.links.filter(a=>ye(a.title).includes(ye(e)));return o.length&&n.push({title:s.title,links:o}),n},[]),Vw=()=>{const e=A?" (Сервис временно недоступен)":"";return[{title:"Многофункциональный центр",links:[{link:Yc,title:"Справка о прослушанных дисциплинах за период обучения (справка об обучении)"},{link:fd,title:"Справка о прохождении обучения в университете (о статусе обучающегося) по месту требования"},{link:Jc,title:"Справка в социальные учреждения (Пенсионный фонд, УСЗН и пр.)"},{link:Xc,title:"Справка-вызов"},{link:ld,title:"Заявление на пересдачу для получения диплома с отличием"},{link:gd,title:"Запрос на изменение персональных данных"},{link:rd,title:"Запрос на восстановление магнитного пропуска"},{link:Wc,title:"Уточнение паспортных данных"},{link:xd,title:"Выдача лицензий и свидетельств о государственной аккредитации"},{link:md,title:"Предоставление каникул в связи с окончанием университета"},{link:bd,title:"Предоставление академического отпуска"},{link:vd,title:"Выход из академического отпуска"},{link:yd,title:"Отчисление по инициативе обучающегося"},{link:_d,title:"Продление промежуточной аттестации или ГИА"}]},{title:"Управление студенческим городком",links:[{link:Kc,title:"Предоставление права проживания (очная форма)",exceptionalFormEducationList:["Очно-заочная","Заочная"]},{link:Qc,title:"Предоставление права проживания (очно-заочная форма)",exceptionalFormEducationList:["Очная","Заочная"]},{link:Zc,title:"Предоставление права проживания (заочная форма)",exceptionalFormEducationList:["Очная","Очно-заочная"]},{link:td,title:"Предоставление права проживания льготной категории граждан"},{link:ed,title:"Предоставление права проживания в период академического отпуска",exceptionalFormEducationList:["Очно-заочная","Заочная"]},{link:id,title:"Предоставление права проживания в семейной комнате",exceptionalFormEducationList:["Очно-заочная","Заочная"]},{link:sd,title:"Переселение внутри общежития",exceptionalFormEducationList:["Заочная"]},{link:od,title:"Переселение в другое общежитие",exceptionalFormEducationList:["Заочная"]},{link:nd,title:"Расторжение договора найма"},{link:ad,title:"Предоставление права проживания в период каникул"}]},{title:"Профсоюзная организация",links:[{link:da,title:"Вступить в Профсоюз",isExternalLink:!0,isOpenInNewWindow:!0},{link:pd,title:"Оформить материальную поддержку остронуждающимся студентам (Дотацию)"},{link:ud,title:"Заявка на материальную помощь"},{link:qc,title:"Оформить социальную стипендию"},{link:hd,title:"Отправить характеристику-рекомендацию на получение повышенной государственной академической стипендии"}]},{title:"Мобилизационный отдел"+e,disabled:A,links:[{link:cd,title:"Отправить документы воинского учета"},{link:dd,title:"Воинский учет"},{link:"",title:"Заполнить личную карточку обучающегося по воинскому учету для получения отсрочки от призывана военную службу"}]},{title:"Отдел платных образовательных услуг"+e,disabled:A,links:[{link:Qn,title:"Оформить дополнительное соглашение к договору об обучении"},{link:Qn,title:"Отправить квитанцию об оплате обучения или пени"}]},{title:"Приемная комиссия",links:[{link:Gu,isExternalLink:!0,title:"Изменение условий обучения (направление подготовки (специальность), форма), в том числе перевод с платного обучения на бесплатное"}]},{title:"Прочее",links:[{link:Vc,title:"Произвольный запрос"}]},{title:"Прочее (в разработке)",disabled:A,links:[{link:Gc,title:"Трудоустройство студентов"}]}]},Gw=()=>[{title:"Цифровые сервисы",links:[{link:Zr,title:"Справка с места работы"},{link:el,title:"Справка с места работы для предоставления в визовый центр"},{link:il,title:"Справка о количестве неиспользованных дней отпуска"}]},...qw()],qw=()=>[{title:"Цифровые сервисы (в разработке)",disabled:A,links:[{link:tl,title:"Справка о стаже работы"},{link:nl,title:"Копия трудовой книжки"},{link:sl,title:"Копии документов из личного дела"},{link:ol,title:"Справка о работе на условиях внешнего совместительства для внесения стажа в трудовую книжку"}]},{disabled:A,title:"Общее",links:[{link:Hr,title:"Актуализация контактных данных"}]},{title:"Общее (в разработке)",disabled:A,links:[{link:Ur,title:"Актуализация контактных данных (тест)"}]},{title:"ИТ-обслуживание",links:[{link:qr,title:"Получение нового компьютерного оборудования"},{link:Yr,title:"Подключение компьютера, МФУ, телефона, WiFi"},{link:Jr,title:"Обслуживание принтеров, МФУ"},{link:Xr,title:"Вопрос по СЭД Directum и 1С"},{link:Kr,title:"Вопрос по Личному кабинету"},{link:Qr,title:"Прочее ИТ-обслуживание"}]},{title:"Бухгалтерия",disabled:A,links:[{link:cl,title:"Справка по форме 2-НДФЛ"},{link:dl,title:"Справка о выплате (не выплате) единовременного пособия на рождение ребенка"},{link:al,title:"Справка об отпуске по уходу за ребенком до 1,5 и 3 лет"},{link:pl,title:"Справка о ежемесячных выплатах сотрудника, находящегося в отпуске по уходу за ребенком (декрет)"}]},{title:"Управление студенческого городка",disabled:A,links:[{link:hl,title:"Предоставление права проживания в жилом помещении"},{link:gl,title:"Временное размещение гостей в студгородке"},{link:fl,title:"Проход гостей на территорию студенческого городка"},{link:xl,title:"Переселение"},{link:ml,title:"Расторжение договора найма жилого помещения"}]},{title:"Бюро пропусков",disabled:A,links:[{link:bl,title:"Выдача пропуска (повторная)"},{link:vl,title:"Заказ гостевого пропуска"}]},{title:"Отдел контроля и делопроизводства",disabled:A,links:[{link:yl,title:"Заверение и выдача копий внутренних документов"}]},{title:"Многофункциональный центр",disabled:A,links:[{link:Gr,title:"Выдача лицензий и свидетельств о государственной аккредитации"}]},{title:"Экспедиция отдела контроля и делопроизводства",disabled:A,links:[{link:ll,title:"Курьер"}]},{title:"Мобилизационный отдел",disabled:A,links:[{link:_l,title:"Заполнить личную карточку по воинскому учету для получения отсрочки от призыва на военную службу"},{link:wl,title:"Заверенные копии документов по воинскому учету из личного дела"}]},{title:"Прочее",disabled:A,links:[{link:rl,title:"Произвольный запрос"},{link:da,title:"Вступить в Профсоюз",isExternalLink:!0}]}],Yw=()=>[{title:"",links:[{link:ul,title:"Заявление на трудоустройство по совместительству"},{link:Hn,title:"Заявление на увольнение"},{link:Vn,title:"Заявление о привлечении к работе в выходной день"},{link:Un,title:"Заявление о предоставлении отпуска"},{link:Wn,title:"Заявление о переносе отпуска"},{link:Gn,title:"Заявление о диспансеризации"},{link:Vi,title:"Заявление на перевод"}]}],Jw=(e,i)=>!(i!=null&&i.length)||!e?!0:!(i!=null&&i.includes(e)),Xw=p.div`
    @media (min-width: 1001px) {
        width: 100%;
        max-width: 900px;
        min-width: 900px;
...
`,mj=({value:e,setValue:i,leftIcon:n,title:s,required:o,width:a,minWidth:r,placeholder:c="Начните ввод...",danger:d,isActive:u=!0,inputAppearance:h=!0,suggestions:f})=>{const[g,m]=l.useState([]),[x,b]=l.useState(!0);return l.useEffect(()=>{if(e){const v=f.filter(T=>T.toLowerCase().includes(e.toLowerCase()));m(v)}else m([])},[e,f]),t.jsxs(gj,{leftIcon:!!n,isActive:u,inputAppearance:h,width:a,danger:d,minWidth:r,children:[t.jsx(U,{size:5,align:"left",visible:!!s,bottomGap:"5px",required:o,children:s}),t.jsxs("div",{children:[t.jsx("input",{type:"text",value:e,onChange:v=>{i(v.target.value),b(!0)},placeholder:c}),g.length>0&&t.jsx(fj,{width:"100%",isOpen:x,className:x?"open":"close",itemsAmount:g.length,title:s,children:g.map((v,T)=>t.jsx(xj,{isSelected:!1,onClick:()=>{i(v),m([]),b(!1)},children:v},T))})]})]})},bj=p.div`
    width: 100%;
    text-align: start;
    margin-top: -20px;
    margin-bottom: -10px;
...
`,vj=({title:e,visible:i})=>i?t.jsx(bj,{children:t.jsx("span",{className:"title",children:e})}):null,jo=e=>{const{value:i,required:n,width:s,indexI:o,indexJ:a,type:r,suggestions:c,items:d,title:u,documents:h,changeInputArea:f,setData:g,mask:m,editable:x,placeholder:b,autocomplete:v,isSpecificRadio:T,specialType:I,specialFieldsNameConfig:j,minValueInput:S,maxValueInput:O,maxValueLength:L,diff:N,visible:K=!0,onChange:M,onKeyPress:ie,onBlur:ce,onKeyDown:$e,onKeyUp:ke,onFocus:Ge}=e,ge=x??(f&&!h),[Ce,Ii]=l.useState(!0),ze=(V,pe,It)=>{M==null||M(V),g(we=>(Array.isArray(we.data[0])?we.data[pe][It??0].value=V:we.data[pe].type==="checkbox-docs"?we.data[pe].items[It??0].value=!!V:we.data[pe].value=V,{...we}))},ei=(V,pe,It)=>{M==null||M(V),g(we=>(Array.isArray(we.data[0])?we.data[pe][It??0].value=V:we.data[pe].value=V,{...we}))},Ds=(V,pe,It)=>{g(we=>(we.data[pe].items[It??0].files=V,{...we}))},Ri=V=>{M==null||M(V),g(pe=>(pe.data[o].value=V,{...pe}))},Li=V=>{M==null||M(V),ie==null||ie(V),ce==null||ce(V),$e==null||$e(V),ke==null||ke(V),Ge==null||Ge(V),g(pe=>(pe.data[o].value=V,{...pe}))};return j&&I&&!Object.values(j).includes(I)?null:r!=="select"&&r!=="multiselect"||!d?r==="checkbox"?t.jsx(Be,{text:u,isActive:ge,checked:i,setChecked:V=>ze(V,o,a)}):r==="hr-checkbox"?t.jsx(pj,{text:u,isActive:ge,checked:i,setChecked:V=>ze(V,o,a)}):r==="auto-complete-input"?t.jsx(mj,{title:u,suggestions:c??[],required:n,value:i,placeholder:b??u,setValue:V=>ze(V,o,a)}):r==="textarea"?t.jsx(Jg,{value:i,title:u,setValue:V=>ze(V,o,a),isActive:ge,textAreaAppearance:ge,placeholder:b??u,required:n,width:s}):r==="checkbox-docs"?t.jsx(aj,{title:u,items:d,setChecked:(V,pe)=>ze(!V,o,pe),setFiles:(V,pe)=>Ds(V,o,pe)}):r==="date-interval"?K?t.jsx(or,{title:u,required:n,dates:i,setDates:V=>Li(V),valid:Ce,setValid:Ii,minValue:S,diff:N}):null:r==="simple-text"?t.jsx(cj,{title:u,value:i,visible:K}):r==="text-warning"?t.jsx(vj,{title:u,visible:K}):r==="text-header"?t.jsx(hj,{title:u,visible:K}):r==="radio"?t.jsx(rj,{buttons:d,title:u,required:n,current:i,setCurrent:Ri,isSpecificRadio:T}):K?t.jsx(pt,{value:i,title:u,minValue:S,maxValue:O,maxLength:L,setValue:V=>ze(V,o,a),type:r,isActive:ge,inputAppearance:ge,placeholder:b??u,required:n,mask:m,width:s,autocomplete:v}):null:K?t.jsx(pr,{items:d,setSelected:V=>ei(V,o,a),selected:i,isActive:ge,title:u,width:s,multiple:r==="multiselect",required:n}):null},yj=p.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    user-select: none;
...
`,yT=()=>{const{data:{user:e}}=_e.useUser(),i=l.useRef(null),{allRoutes:n}=He.useMenu(),{currentPage:s}=xT(),[o,a]=l.useState(!1),r=c=>{a(c.currentTarget.scrollTop>0)};return np(i.current),t.jsxs(mT,{children:[t.jsx(nT,{loading:!e||!n}),t.jsx(hT,{}),t.jsx(q_,{}),t.jsxs(bT,{children:[t.jsx(D_,{headerVisible:o,currentPage:s}),t.jsx(vT,{ref:i,onScroll:r,withHeader:!(s!=null&&s.withoutHeader),children:t.jsx(Kd,{children:t.jsx(l.Suspense,{fallback:null,children:t.jsx(JS,{})})})}),t.jsx(Dw,{})]}),t.jsx(e1,{}),t.jsx(J_,{}),t.jsx(i1,{}),t.jsx(KS,{}),t.jsx(Fw,{}),t.jsx(iT,{})]})},_T=le.memo(yT),wT=()=>{const{data:{isAuthenticated:e,user:i}}=_e.useUser(),{data:n}=Ye.selectors.useData(),{settings:s}=Yt.useSettings();return np(window),l.useEffect(()=>{window.location.href==="https://e.mospolytech.ru/?p=children#/home"&&window.location.replace("https://e.mospolytech.ru/old/index.php?p=children")},[window.location.href]),l.useEffect(()=>{e&&(Re.getUserDataApplicationsFx(),(i==null?void 0:i.user_status)==="staff"&&(Ye.effects.getFx(),Re.getWorkerPosts(),ep()),qS.load())},[e,i]),l.useEffect(()=>{i&&(s?tt.defineMenu({user:i,adminLinks:n,homeRoutes:s["settings-home-page"].property.pages}):jg.getLocalSettingsFx(i.id))},[i,n,s]),e?t.jsx(_T,{}):t.jsx(l.Suspense,{fallback:null,children:t.jsxs(ra,{children:[py.map(({path:o,Component:a},r)=>t.jsx(la,{path:o,component:a,exact:!0},r)),t.jsx(qe,{exact:!0,to:jl})]})})},jT=p.div`
    ...
    display: flex;
    width: 100%;
`;zS();const kT=()=>(xt(),t.jsx(Vy,{children:t.jsx(Hu,{basename:"/",children:t.jsx(jT,{children:t.jsx(Kd,{children:t.jsx(wT,{})})})})}));Uu.render(t.jsxs(le.StrictMode,{children:[t.jsx(A1,{}),t.jsx(kT,{})]}),document.getElementById("root"));export{H as $,Oj as A,wn as B,Be as C,g_ as D,qS as E,pn as F,Xd as G,ee as H,_t as I,C as J,vt as K,xe as L,Q as M,Lv as N,w as O,Xt as P,Wm as Q,Qe as R,dt as S,U as T,oe as U,ot as V,We as W,Cs as X,ds as Y,rE as Z,Jg as _,cg as a,_j as a$,fe as a0,C_ as a1,Zw as a2,RT as a3,Ee as a4,Ua as a5,PT as a6,ki as a7,_e as a8,c1 as a9,He as aA,Ry as aB,Nl as aC,cy as aD,aE,ft as aF,he as aG,qt as aH,Ke as aI,LT as aJ,lE as aK,Jh as aL,Us as aM,_n as aN,j0 as aO,pb as aP,FT as aQ,ub as aR,zT as aS,L0 as aT,MT as aU,fs as aV,vb as aW,ip as aX,BT as aY,wy as aZ,sj as a_,sr as aa,$T as ab,Ct as ac,$m as ad,vi as ae,Si as af,mS as ag,Pt as ah,xS as ai,Ss as aj,nE as ak,sE as al,NT as am,oE as an,rn as ao,Ze as ap,qn as aq,Bl as ar,Dh as as,Nh as at,Za as au,iE as av,Ts as aw,er as ax,Ly as ay,My as az,ue as b,bn as b$,re as b0,Vc as b1,Ki as b2,dy as b3,WT as b4,Sy as b5,ky as b6,Lh as b7,Ve as b8,ye as b9,De as bA,Es as bB,Bn as bC,K1 as bD,Xl as bE,k_ as bF,R as bG,An as bH,VT as bI,r1 as bJ,JT as bK,XT as bL,KT as bM,YT as bN,qT as bO,GT as bP,ve as bQ,u_ as bR,Kl as bS,ey as bT,Uw as bU,uy as bV,ly as bW,ry as bX,ay as bY,dc as bZ,X1 as b_,HT as ba,ws as bb,Di as bc,Y as bd,Ie as be,un as bf,Jt as bg,Ra as bh,Ln as bi,qh as bj,Ne as bk,mt as bl,at as bm,hv as bn,uv as bo,Aw as bp,eE as bq,QT as br,hw as bs,oc as bt,$s as bu,tE as bv,Yt as bw,Oi as bx,Al as by,m_ as bz,dg as c,Ai as c0,as as c1,ZT as c2,U1 as c3,Il as c4,W1 as c5,V1 as c6,gc as c7,Lt as c8,ew as c9,it as cA,sy as cB,v_ as cC,AT as cD,jS as cE,kS as cF,DT as cG,Wh as cH,ET as cI,TT as cJ,Zi as cK,O1 as cL,cs as cM,Vh as cN,df as cO,IT as cP,Aj as cQ,zi as cR,$j as cS,Pj as cT,Ej as cU,zc as cV,yS as cW,Sc as ca,Z1 as cb,$c as cc,M1 as cd,x1 as ce,_w as cf,fw as cg,xt as ch,rc as ci,hc as cj,Fr as ck,iw as cl,Hl as cm,ao as cn,ca as co,an as cp,gy as cq,hy as cr,OT as cs,CT as ct,Ml as cu,zl as cv,UT as cw,cn as cx,x_ as cy,LS as cz,Re as d,rg as e,Wr as f,W as g,ag as h,OS as i,B as j,PS as k,CS as l,se as m,Ni as n,A as o,lo as p,US as q,pt as r,me as s,_ as t,Ka as u,pr as v,te as w,et as x,Zg as y,zh as z};
