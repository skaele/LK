import{y as p,s as g,b$ as x,o as d,j as n}from"./vendor-561dac3a.js";import{as as m,a8 as P,W as j,P as v,at as y}from"./index-d124093a.js";import{c as $,L as F}from"./index-2da65ff7.js";import"./index-ade1c0ef.js";const L=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,s=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",s,o,c);return{results:r.items}}),h=$({getFx:L,limit:50}),b=g.div`
    width: 100%;
    display: flex;
