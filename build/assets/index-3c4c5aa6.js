import{s as l,L as j,j as e,R as E,M as $,F as L,c as T,r as p}from"./vendor-831b4923.js";import{o as g,x as c,b4 as A,V as M,X as W,a6 as R,D as y,b5 as b,aY as u,O as D,b6 as B,aN as F,B as I,b7 as Y,M as _,b8 as H,b9 as O,ba as U,bb as Z,bc as q,bd as X,be as G,bf as N,Y as V,b2 as k,_ as v,bg as K,p as h,T as P,bh as Q,bi as m,bj as f,bk as J,bl as ee,bm as te,W as se,bn as ie,r as ae,aT as ne,bo as re}from"./index-774d803f.js";import{E as oe}from"./index-4213fb0b.js";import{A as le}from"./alert-item-17572479.js";import"./is-valid-url-08a91344.js";const ce=l(j)`
    width: 100%;
    height: 100%;
...
`,C=({item:t,amount:s})=>{const{icon:a,color:i,path:n,title:r,notifications:o,menuPath:x}=t;return e.jsxs(ce,{amount:s,to:x??n,color:c[i].transparent3,children:[e.jsx(A,{badge:o==null?void 0:o.toString(),color:i,size:35,children:a}),e.jsx(M,{className:"subtext",align:"center",children:W(r,10)})]})},de=l.div`
    width: 100%;
    display: flex;
    align-items: center;
    max-width: 750px;
...
`,xe=({links:t})=>{const s=Object.keys(t),a=s.length<8?8:Object.keys(t).length,{allRoutes:i}=R.useMenu();return i?e.jsxs(de,{children:[s.map((n,r)=>e.jsxs(E.Fragment,{children:[e.jsx(C,{item:t[n],amount:a}),r!==s.length-1&&e.jsx(y,{direction:"vertical",margin:"10px 0",width:"70%"})]},n)),e.jsx(y,{direction:"vertical",margin:"10px 0",width:"70%"}),e.jsx(C,{item:i.all,amount:a})]}):null},w=l.div`
    max-width: 400px;
...
`,Re=()=>{const{data:{user:t},error:s}=v.useUser(),a=$(b.$paymentsStore),{data:{schedule:i}}=J.useSchedule(),{homeRoutes:n}=R.useMenu();if(!t||!n)return null;p.useEffect(()=>{a||ee.getPayments()},[a]),p.useEffect(()=>{i||te.getScheduleFx(t)},[i]);const{news:r}=N.useSettings().settings["settings-home-page"].property;return e.jsxs(se,{loading:!t,load:()=>null,error:s,data:t,children:[e.jsx(ye,{}),e.jsxs(ke,{children:[e.jsx(ie,{}),e.jsx(xe,{links:n}),e.jsx(ae,{children:e.jsxs(ne,{noAppearanceInMobile:!0,maxWidth:"750px",minHeight:"100%",height:"100%",orientation:"vertical",gap:"20px",children:[e.jsxs(h,{children:[e.jsx(P,{size:2,align:"left",width:"100%",children:"Главная"}),e.jsx(re,{})]}),e.jsx(be,{}),!!r&&e.jsx(je,{})]})})]})]})};export{Re as default};
