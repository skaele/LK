import{s as j,r,j as t,F as f,R as m,aQ as D}from"./vendor-9cc634b6.js";import{l,d as n,T as x,D as v,M as A,L,f as T,g as P,h as S,P as w,i as y,j as C,k as F}from"./index-3fee83b2.js";const R=e=>{if(!e[0].length&&e[1].length)return`За весь период до ${l(e[1])} включительно`;if(e[0].length&&!e[1].length)return`За весь период начиная с ${l(e[0])} включительно`;if(!e[0].length&&!e[1].length)return"За все время";if(e[0].length&&e[1].length)return`За период с ${l(e[0])} по ${l(e[1])}`},E=j.div`
    .content {
        display: flex;
