...
const RETAKE_LINKS: Record<string, RetakeLink> = {
    ...
    fuigh: {
        ...
        href: 'https://e.mospolytech.ru/old/storage/files/arrears/FUiGH.zip?3',
        links: [],
    },
    fbk: {
        fullTitle: 'Факультет базовых компетенций',
        href: 'https://e.mospolytech.ru/old/storage/files/arrears/FBK.zip?2',
        links: [],
    },
    fhtib: {
        fullTitle: 'Факультет химической технологии и биотехнологии',
        href: 'https://e.mospolytech.ru/old/storage/files/arrears/FHTiB.zip?4',
        links: [],
    },
    tf: {
    ...
    fm: {
        ...
        href: 'https://e.mospolytech.ru/old/storage/files/arrears/FM.zip?3',
        links: [],
    },
    fit: {
        ...
        links: [
            {
                ...
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2022_2023_leto_kafedra_IB.pdf',
            },
            {
                title: 'ФИТ 2022-2023-лето, кафедра ИКТ',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2022_2023_leto_kafedra_IKT.pdf',
            },
            {
                title: 'ФИТ 2022-2023-лето, кафедра ПИ',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2022_2023_leto_kafedra_PI.pdf',
            },
            {
                title: 'ФИТ 2022-2023-лето, кафедра ИиИТ',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2022_2023_leto_kafedra_IiIT.pdf?1',
            },
            {
                title: 'ФИТ 2022-2023-лето, кафедра СМАРТ',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2022_2023_leto_kafedra_SMART_tehnologii.pdf',
            },
        ],
        href: '',
    },
    ...
    cpd: {
        ...
        href: 'https://e.mospolytech.ru/old/storage/files/arrears/TsPD.zip?4',
        links: [],
    },
    nid: {
        fullTitle: 'График приема задолженностей по НИД (аспиранты)',
        href: 'https://e.mospolytech.ru/old/storage/files/arrears/Grafik_priema_zadolzhennostej_po_NID_(aspiranty).pdf',
        links: [],
    },
}
