import{s as a,j as t,cm as L,cn as P,r as h,R as T,co as G}from"./vendor-561dac3a.js";import{cH as M,b9 as l,m as z,cI as $,cJ as f,w as R,J as c,bl as W,cK as q,U as u,bk as H,cL as J,T as y,K as x,aw as K,L as U,bd as S,bz as B,O as p,cM as O,cN as C,a8 as V,W as X,P as Q,v as Y,a0 as D,ax as Z}from"./index-da3e5de5.js";const w=(e,i)=>{const n=new Date(e).getMonth();return n>1&&n<8?+i*2:+i*2-1},ee=e=>{const i=w(new Date().toISOString(),e),n=[];for(let s=1;s<=i;s++)n.push({id:s,title:`${s} семестр`});return n.push({id:-1,title:"Все семестры"}),n},te=(e,i)=>M(i.filter(n=>l(n.name).includes(l(e))||l(n.teacher).includes(l(e))||l(z(n.exam_date)).includes(l(e))||l(n.bill_num).includes(l(e))));function ne(e){const i={5:0,4:0,3:0,2:0},n=e.filter(s=>!!s.grade&&s.exam_type!=="Зачет").length;return e.forEach(({grade:s,exam_type:r})=>{r!=="Зачет"&&s!==void 0&&i[$[s]]++}),n===0?i:Object.keys(i).reduce((s,r)=>(s[+r]=i[+r]/n,s),{})}const ie=2.7;a.div`
    display: flex;
...
`,ae=({grade:e})=>t.jsx(re,{grade:e,children:e&&($[e]>2?t.jsx(L,{}):t.jsx(P,{}))}),oe=a.div`
    width: 100%;
    display: flex;
    min-height: 60px;
    align-items: center;
