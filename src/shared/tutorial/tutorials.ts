import { Module, TutorialId, TutorialRoles, TutorialStep } from '../api/tutorial/types'
...
export const createTutorials = (roles: TutorialRoles): ModuleData => {
    return {
        ...
        //             description: 'Нажмите на логотип, чтобы мгновенно перейти на главную страницу',
        //         },
        //     ],
        // },
        home: {
        ...
        'stud-project-activity': {
            ...
            steps: [
                ...
                },
                {
                    ...
                    description:
                        'Если за предыдущий семестр стоит "не зачтено", то нужно донабрать баллы в текущем семестре',
                },
                {
                    title: 'Итого',
