import{s as r,j as e,O as x}from"./vendor-831b4923.js";import{V as s,b3 as c,l as d,D as h,x as p,u as g,X as m}from"./index-911082d8.js";import{i as v}from"./is-valid-url-08a91344.js";const f=({alert:t})=>{const{content:i,time:n,date:o}=t;return e.jsxs(u,{children:[e.jsx(s,{fontSize:"0.9rem",children:e.jsx(c,{words:[d(o),n]})}),e.jsx(h,{width:"100%",margin:"12px 0"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:i}})]})},u=r.div`
    display: flex;
...
`,b=t=>{const i=t.indexOf('src="')+5;let n=0;if(i===-1)return null;for(let a=i;a<t.length;a++)if(t[a]==='"'){n=a;break}const o=t.slice(i,n);return v(o)?o:null},w=r.div`
...
`;const I=r(w)`
    ...
    top: 6px;
    right: -4px;
`,z=({news:t,orientation:i="vertical",isNew:n=!1})=>{const o=b(t.content),{open:a}=g(),l=()=>a(e.jsx(f,{alert:t}),t.title);return e.jsxs(j,{onClick:l,orientation:i,children:[e.jsx($,{orientation:i,children:o?e.jsx("img",{src:o,alt:""}):e.jsx(x,{})}),e.jsxs(y,{orientation:i,children:[e.jsx(k,{orientation:i,children:i==="vertical"?m(t.title,38):t.title}),e.jsx(s,{children:e.jsx(c,{words:[d(t.date),t.time]})})]}),e.jsx(I,{visible:n,children:"New"})]})};export{z as A};
