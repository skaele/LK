...
`,V=({rooms:e,color:n,isCurrent:r=!1,inModal:t=!1})=>e.length?i.jsx(Ie,{isCurrent:r,inModal:t,color:n,children:e.map(o=>i.jsx("span",{className:"room",children:o},o))}):null,Pe=h.div`
    color: var(--text);
    display: flex;
    flex-direction: column;
    align-items: center;
...
`,Re=({filter:e,isGroup:n,visible:r})=>{const t=Y();return r?i.jsxs(Pe,{children:[i.jsxs("div",{children:["Расписание:"," ",n?i.jsx(Fe,{to:`${pe}/${e}`,children:e}):i.jsx(ce,{fio:e})]}),i.jsx(S,{onClick:()=>t.push(B),text:"Вернуться к своему расписанию",textColor:"var(--blue)",width:"100%",background:"transparent"})]}):null},F=e=>{const n=e.reduce((r,t)=>{const o=k(t.timeInterval);return o>0&&r.push(o),r},[]);return Math.min(...n)},E=e=>{if(e&&e[e.length-1]){const[n,r]=e[e.length-1].timeInterval.split(" - ")[1].split(":");return new Date().getHours()>+n?!0:new Date().getHours()===+n&&new Date().getMinutes()>+r}},U=e=>{const n=new Date,r=n.getTimezoneOffset()/60+3,[t,o]=e.split(" - ");let s=t.split(":");const a=parseInt(s[0]),p=parseInt(s[1],10);s=o.split(":");const c=parseInt(s[0],10),l=parseInt(s[1],10);return(n.getHours()+r)*60+n.getMinutes()>=a*60+p&&(n.getHours()+r)*60+n.getMinutes()<=c*60+l},K=({lessons:e,weekDay:n,isCurrent:r,view:t,width:o,height:s,topInfo:a,error:p})=>{var y;const c=ne(),l=x.useRef(null),d=he(l),{height:m}=N(),u=x.useMemo(()=>F(e??[]),[e]);return x.useEffect(()=>{if(l!=null&&l.current&&e){const g=E(e)?e.length:(e==null?void 0:e.findIndex(b=>U(b.timeInterval)||F(e)===k(b.timeInterval)))??-1;(r&&!E(e)?g!==-1:(e==null?void 0:e.length)+1)&&(l.current.scrollTop=g*150)}},[e]),i.jsxs(Be,{isCurrent:r??!1,isFull:t==="full",isVisible:d,width:o,height:s,children:[!!n&&!!e&&i.jsxs("div",{className:"day-title",children:[i.jsx(j,{size:4,align:"left",children:n}),i.jsx("span",{children:a})]}),i.jsxs(Me,{isFull:t==="full",ref:l,height:m,isTeacherSchedule:!!((y=c.params.fio)!=null&&y.length),children:[!e&&!p&&i.jsx(De,{}),p&&i.jsx(H,{text:"Ошибка",size:"70px"}),!!e&&e.map((g,b)=>x.createElement(xe,{...g,key:b,view:t,isCurrent:(r&&U(g.timeInterval))??!1,isNext:r&&u===k(g.timeInterval)})),!!e&&!e.length&&i.jsx(ze,{}),!!e&&!!e.length&&!a&&E(e)&&i.jsx(Ae,{})]})]})},Ue=h.div`
    display: flex;
    align-items: center;
    justify-content: center;
    border-radius: 10px;
...
`,et=({view:e,setView:n})=>i.jsxs(Ue,{children:[i.jsx(S,{icon:i.jsx(re,{}),onClick:()=>n("full"),isChosen:e==="full"}),i.jsx(S,{icon:i.jsx(ie,{}),onClick:()=>n("big"),isChosen:e==="big"})]}),Oe=h.div`
    &::-webkit-scrollbar {
        display: none;
    }
...
`,Je=({weekSchedule:e,view:n,wrapperRef:r})=>{const{data:{currentDay:t}}=W.useSchedule(),{width:o}=N();x.useEffect(()=>{setTimeout(()=>{r!=null&&r.current&&(n==="big"||o<1e3)&&(r.current.scrollLeft=t*400-360)},200)},[n]);const s=()=>{r!=null&&r.current&&o<=1e3&&X.changeCurrentChosenDay({day:Math.floor(r.current.scrollLeft*1.2/o)+1})};return e?i.jsx(qe,{isFull:n==="full",innerRef:r,onScroll:s,children:Object.keys(e).map((a,p)=>i.jsx(K,{isCurrent:t===p+1,weekDay:$[a].full,lessons:e[a].lessons,view:n,topInfo:J(e,a)},p))}):i.jsx(H,{text:"Пока нет расписания",image:de})},nt=x.memo(Je);export{K as D,Re as F,et as S,nt as W,tt as a,Qe as p};
