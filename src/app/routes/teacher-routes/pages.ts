...
export const AdminCompetenceCenter = lazy(() => import('@pages/competence-center/admin-comeptence-center'))
export const CompetenceCenterList = lazy(() => import('@pages/competence-center/list'))
