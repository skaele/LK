...
`,Yn={message:"",type:"success",isOpen:!1,time:2e3},_p=()=>M(wp),yo=T(),jo=T(),_o=T(),wp=ee(Yn).on(yo,(e,{message:i,type:n,time:s=2e3,onClick:o})=>({isOpen:!0,message:i,type:n,time:s,onClick:o})).on(jo,(e,{isOpen:i})=>({...e,isOpen:i})).on(_o,()=>({...Yn})),wo={usePopUpMessage:_p},J={evokePopUpMessage:yo,openPopUpMessage:jo,clearStore:_o},kp=Object.freeze(Object.defineProperty({__proto__:null,events:J,selectors:wo},Symbol.toStringTag,{value:"Module"}));function y(e){const{icon:i,text:n,onClick:s,width:o,minWidth:a,background:r,textColor:d,hoverBackground:c,align:p,isChosen:h,padding:x,shrinkTextInMobile:g,fixedInMobile:m,direction:f="horizontal",isActive:b=!0,height:v,notActiveClickMessage:P,flipped:_,...S}=e,k=X=>{b?s==null||s(X):P&&J.evokePopUpMessage({type:"failure",message:P,time:1e4})};return t.jsxs(jp,{text:!!n,onClick:k,isChosen:h,width:o,minWidth:a,background:r,padding:x,textColor:d,shrinkTextInMobile:g,hoverBackground:c,align:p,direction:f,isActive:b,fixedInMobile:m,height:v,flipped:_,...S,children:[!!i&&t.jsx("div",{className:"icon",children:i}),t.jsx("span",{className:"text",children:n})]})}const Zi=e=>{switch(e){case"center":return"center";case"right":return"flex-end";case"evenly":return"space-evenly"}return"flex-start"},qn=e=>{switch(e){case"center":return"center";case"bottom":return"flex-end";case"space-between":return"space-between"}return"flex-start"},Tp=u.div`
...
`,Np=()=>t.jsx(Pp,{shapes:[{shape:"rect",size:{width:"200px",height:"13px"},margin:"0"},{shape:"rect",size:{width:"100px",height:"12px"},margin:"5px 0"},{shape:"rect",size:{width:"120px",height:"12px"},margin:"0"}],direction:"vertical",horizontalAlign:"left"});function q({type:e,children:i,icon:n,width:s,maxWidth:o,title:a,onClose:r,padding:d,fontSize:c,gap:p,lineHeight:h,solidBackground:x=!1,align:g="left",visible:m=!0,loading:f=!1}){if(!m)return null;const{theme:b}=Ci();return t.jsxs(Dp,{isLightTheme:b==="light",className:"message",closable:!!r,type:e,align:g,width:s,maxWidth:o,padding:d,fontSize:c,gap:p,lineHeight:h,solidBackground:x,children:[t.jsx(W,{size:4,align:g,icon:n===null?null:n??ct[e].icon({}),children:a??ct[e].title}),r&&t.jsx(y,{onClick:r,icon:t.jsx(We,{}),className:"close-button"}),i&&t.jsx("div",{className:"info-text",children:i}),f&&t.jsx(Np,{})]})}u.div`
    display: flex;
...
`;function Ii({width:e,className:i,short:n=!1}){return t.jsx(Vp,{width:e,className:i??"logo",children:t.jsx("img",{src:n?Wp:Up,alt:"Logo"})})}const Gp=u.img``;function xn({loading:e,src:i,height:n,width:s,alt:o=""}){return e?t.jsx(U,{shape:"rect",size:{width:s,height:n},margin:"0"}):t.jsx(Gp,{src:i,alt:o,height:n,width:s})}const Yp=u.div`
    .wrapper {
        position: relative;
        width: ${({size:e})=>e};
        height: ${({size:e})=>e};
...
`,kt=({text:e,action:i,width:n,height:s,setCompleted:o,background:a,buttonSuccessText:r="Готово",popUpSuccessMessage:d="Успешно",popUpFailureMessage:c="Nope",pulsing:p,isDone:h=!1,isActive:x=!0,isLoading:g=!1,completed:m=!1,repeatable:f=!0,alerts:b=!0})=>{l.useEffect(()=>{m&&b&&(J.evokePopUpMessage({message:d,type:"success"}),f&&setTimeout(()=>{o(!1)},2e3))},[m,o]);const v=()=>{if(x&&!h&&!g)return i();b&&J.evokePopUpMessage({message:c,type:"failure"})};return t.jsx(Kp,{isLoading:g,background:a,className:"submit-button",completed:m,isActive:x&&!h&&!m,onClick:v,isDone:h,width:n,height:s,repeatable:f,tabIndex:x&&!h?0:-1,pulsing:p&&!h,children:t.jsx("div",{className:"inner-button",children:m?t.jsxs("div",{className:"inner-button-success",children:[t.jsx(tc,{})," ",r]}):g?t.jsx(ut,{}):t.jsx("div",{className:"inner-button-text",children:e})})})},Qp=(e,i)=>e.length>8?e.substring(0,8):e.length===3&&(i==null?void 0:i.length)===2?e+"-":e.length===3&&(i==null?void 0:i.length)===4?e.substring(0,2):e,Zp=e=>{const i=["7","8","9"],n=e.target.selectionStart;let s=e.target.value.replace(/\D/g,""),o="";return s.length?e.target.value.length!==n?/\D/g.test(e.nativeEvent.data??"")?s:e.target.value:(i.indexOf(s[0])>-1?(s[0]==="9"&&(s="7"+s),o=(s[0]==="8"?"8":"+7")+" ",s.length&&(o+="("+s.substring(1,4)),s.length>=5&&(o+=") "+s.substring(4,7)),s.length>=8&&(o+="-"+s.substring(7,9)),s.length>=10&&(o+="-"+s.substring(9,11))):o=`+${s.substring(0,16)}`,o):""},eu={groupMask:Qp,phoneMask:Zp},tu=(e,i,n,s,o,a,r,d)=>{const[c,p]=l.useState(n),[h,x]=l.useState(s??!1);l.useEffect(()=>{p(n)},[n]);const g=l.useCallback(v=>v.replace(/@\.*/,"@mospolytech.ru").replace(/mospolytech.ru?/,""),[n]);return{inputType:c,danger:h,phoneMaskKeyDown:v=>{v.key==="Backspace"&&(e[1]==="7"&&e.length<=4||e[0]==="8"&&e.length<=3)&&i("")},buttonOnClick:()=>p(v=>v==="password"?"text":"password"),handleOnChange:v=>{if(i(d?r?r(v.target.value,e):n==="tel"?eu.phoneMask(v):n==="email"?g(v.target.value):v.target.value:v.target.value),n==="date"&&(o||a)){const P=new Date(v.target.value);let _=!1;if(o){const S=new Date(o);_=P<S}if(a&&!_){const S=new Date(a);_=P>S}x(_)}}}},iu=u.div`
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    position: relative;
...
`,Xe=l.forwardRef(function(i,n){const{value:s,setValue:o,leftIcon:a,title:r,required:d,width:c,minWidth:p,customMask:h,placeholder:x="Введите сюда",type:g="text",danger:m,alertMessage:f,loading:b=!1,isActive:v=!0,inputAppearance:P=!0,mask:_=!1,autocomplete:S=!1,minValue:k=void 0,maxValue:X=void 0,maxLength:O=void 0}=i,{inputType:N,buttonOnClick:se,danger:R,handleOnChange:ae,phoneMaskKeyDown:Ne}=tu(s,o,g,m,k,X,h,_);return t.jsxs(iu,{leftIcon:!!a,isActive:v,inputAppearance:P,width:c,danger:R,minWidth:p,children:[t.jsx(W,{size:5,align:"left",visible:!!r,bottomGap:"5px",required:d,children:r}),t.jsx(q,{type:"alert",visible:!!f,icon:t.jsx(ic,{}),title:f??""}),a&&t.jsx("span",{className:"left-icon",children:a}),t.jsx("input",{id:x,min:k,max:X,maxLength:O,step:X?.1:void 0,type:N,placeholder:x,value:s??"",autoComplete:S?"on":"off",onKeyDown:Se=>g==="tel"&&Ne(Se),onChange:ae,required:d,readOnly:!v,ref:n}),g!=="password"?!!(s!=null&&s.length)&&P&&(b?t.jsx(ut,{}):t.jsx(y,{icon:t.jsx(We,{}),onClick:()=>o(""),tabIndex:-1})):t.jsx(y,{icon:N==="password"?t.jsx(nc,{}):t.jsx(Ds,{}),tabIndex:-1,onClick:se})]})}),nu=u.div`
    user-select: none;
    min-width: 56px;
    height: 30px;
...
`,lu=({icon:e,text:i,onClick:n,width:s,background:o,textColor:a,align:r,href:d,height:c,minHeight:p,padding:h,isActive:x=!0,isChosen:g=!1})=>t.jsxs(ru,{text:!!i,onClick:m=>x&&n&&n(m),isChosen:g,width:s,background:o,textColor:a,href:d,align:r,isActive:x,height:c,padding:h,minHeight:p,children:[!!e&&e,i&&t.jsx("span",{children:i})]}),tt=l.memo(lu),cu=u.div`
    width: 100%;
    height: fit-content;
...
`,pu=({title:e,link:i,type:n})=>t.jsxs(du,{href:i,target:"_blank",children:[t.jsx("div",{className:"icon",children:n==="document"?t.jsx(C,{}):t.jsx(sc,{})}),t.jsx("div",{className:"title",children:e})]}),uu=(e,i=265,n=200)=>(e.preventDefault(),{x:e.clientX<window.innerWidth/2?e.clientX:e.clientX-i,y:e.clientY<window.innerHeight/2?e.clientY:e.clientY-n}),hu={open:!1,content:null,type:"left-click",position:{x:0,y:0}},gu=()=>we(xu),ko=T(),To=T(),So=T(),xu=ee(hu).on(ko,(e,{content:i,e:n,height:s,type:o="left-click"})=>({position:uu(n,220,s),open:!0,content:i,type:o})).on(To,e=>({...e,open:!1})).on(So,(e,{position:i})=>({...e,position:i})),Ae={open:ko,close:To,changePosition:So},fu={useContextMenu:gu},mu=()=>{const e=navigator.userAgent;return e.search("Mac")!==-1?"MacOS":e.search("X11")!==-1&&e.search("Linux")===-1?"UNIX":e.search("Linux")!==-1&&e.search("X11")!==-1?"Linux":"Windows"},Vi=new Set,Eo=(e,i)=>{l.useEffect(()=>{window.addEventListener("keydown",n=>{Vi.add(n.key),!e.slice(0,e.length-1).find(o=>!Vi.has(o))&&e[e.length-1]===n.key&&i()}),window.addEventListener("keyup",n=>{Vi.delete(n.key)})},[])},Ve=u.div`
    display: flex;
...
`,Ao=({value:e,width:i,placeholder:n,inputAppearance:s,loading:o,hints:a,leftIcon:r,focusOn:d,setValue:c,customMask:p,onHintClick:h,validationCheck:x=!1})=>{const[g,m]=l.useState(0),[f,b]=l.useState(!1),v=l.useRef(null),P=l.useRef(null),_=l.useRef(null);Pt(v,()=>b(!1)),l.useEffect(()=>{d&&setTimeout(()=>{var O;return(O=_.current)==null?void 0:O.focus()},50)},[d]);const S=O=>{var N,se;(((a==null?void 0:a.length)??0)>0||o)&&b(!0),O.key==="ArrowDown"?((N=P.current)==null||N.scrollIntoView({block:"start",behavior:"smooth"}),typeof g=="number"&&m(Ke(g+1,((a==null?void 0:a.length)??1)-1,0))):O.key==="ArrowUp"?((se=P.current)==null||se.scrollIntoView({block:"end",behavior:"smooth"}),typeof g=="number"&&m(Ke(g-1,((a==null?void 0:a.length)??1)-1,0))):O.key==="Enter"?(c((a==null?void 0:a[g??0].title)??""),b(!1),h==null||h(a==null?void 0:a[g??0])):m(0)},k=O=>()=>{m(O),c((a==null?void 0:a[O].title)??""),b(!1),h==null||h(a==null?void 0:a[O])},X=()=>{a!=null&&a.length&&b(!0)};return t.jsxs(vu,{width:i,onKeyDown:S,onMouseDown:X,ref:v,children:[t.jsx(Xe,{value:e,placeholder:n,leftIcon:r??t.jsx(rt,{}),inputAppearance:s,setValue:c,loading:o,width:i,mask:!0,customMask:p,ref:_}),t.jsx(Oo,{setValue:c,value:e,visible:x}),f&&t.jsx(yu,{height:"fit-content",maxWidth:"100%",maxHeight:"250px",width:"100%",onKeyDown:S,padding:"0",orientation:"vertical",children:a==null?void 0:a.map(({title:O,icon:N},se)=>{const R=g===se;return t.jsxs(ju,{onClick:k(se),ref:R?P:null,selected:R,children:[N&&t.jsx("div",{className:"icon",children:N}),t.jsx("span",{children:O})]},O+se)})})]})},Ri=()=>{const[e,i]=l.useState({width:0,height:0}),n=()=>{i({width:window.innerWidth,height:window.innerHeight})};return l.useEffect(()=>(n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}),[]),e},_u=u.div`
    width: 100%;
    height: 100%;
...
`,Pu=({pages:e,currentPage:i,setCurrentPage:n,sliderWidth:s,appearance:o=!0})=>{const[a,r]=l.useState(5),d=l.useRef(null),{width:c}=Ri();return l.useEffect(()=>{var h;const p=((h=d==null?void 0:d.current)==null?void 0:h.offsetWidth)??c;p>800?r(5):p>600&&p<=800||p>400&&p<=600?r(4):p<=400&&r(3)},[c,d.current]),t.jsx($u,{ref:d,size:a,sliderWidth:s,appearance:o,children:t.jsxs("div",{className:"slider-body",children:[t.jsx(Eu,{appearance:o,pages:e,currentPage:i,size:a}),e.map((p,h)=>t.jsx(ku,{id:h,currentPage:i,setCurrentPage:n,pageTitle:p.title,condition:p.condition,size:a},h))]})})},fn=l.memo(Pu),Ou=300,Co=({defaultValue:e,onDebounce:i,onClear:n,triggerOn:s,triggerDelay:o,deps:a=[],delay:r=Ou})=>{const[d,c]=l.useState(e??""),[p,h]=l.useState(""),[x,g]=l.useState(!1);return l.useEffect(()=>{if(d!==null)if(d.length){g(!0);const m=setTimeout(async()=>{await i(d),h(d),g(!1)},r);return()=>clearTimeout(m)}else p.length!==0&&(n==null||n(d),c(""),g(!1))},[d]),l.useEffect(()=>{if(a.length&&((s==null?void 0:s(d))??!0)){g(!0);const m=setTimeout(async()=>{await i(d),g(!1)},o??r);return()=>clearTimeout(m)}},[...a]),[d,c,x]},dt=u.span`
    color: #fff;
...
`,Ot=({words:e})=>{const i=e.filter(n=>n.length!==0);return t.jsx(t.Fragment,{children:i.map((n,s)=>n+(s===i.length-1?"":" • "))})},Mu=({files:e,maxFiles:i,setFiles:n,isActive:s,formats:o,maxFileSizeInMegaBytes:a})=>{const r=l.useRef(null),[d,c]=l.useState(!1),p=f=>{const b=f.target.files;b!=null&&b.length&&n(Jn(b,e,i,o,a))},h=f=>{f.preventDefault()},x=f=>{f.preventDefault(),c(!1);const b=f.dataTransfer.files;b.length&&n(Jn(b,e,i,o,a))},g=f=>{f.preventDefault(),c(!0)},m=f=>{f.preventDefault(),c(!1)};return t.jsxs(zu,{isActive:s,showPulse:d,onDragOver:f=>s&&h(f),onDragEnter:f=>s&&g(f),onDragLeave:f=>s&&m(f),onDrop:f=>s&&x(f),topPadding:!!i,children:[t.jsx("input",{type:"file",name:"",id:"",ref:r,onChange:p}),t.jsxs("div",{className:"message",children:[t.jsx(Wi,{className:"front-icon"}),t.jsxs("div",{className:"icons-behind",children:[t.jsx(Wi,{className:"icon-1"}),t.jsx(Wi,{className:"icon-2"})]}),t.jsx("b",{children:"Нажмите сюда или перетащите файл"}),t.jsx(te,{align:"center",children:t.jsx(Ot,{words:[`Форматы: ${o?o.map(f=>No(f)).join(", "):"jpg, png, pdf"}`,`Макс. файлов: ${i}`]})})]})]})},Fu=e=>{if(e===0)return"0 Bytes";const i=1024,n=["Bytes","KB","MB","GB","TB"],s=Math.floor(Math.log(e)/Math.log(i));return parseFloat((e/Math.pow(i,s)).toFixed(2))+" "+n[s]},Hu=(e,i,n)=>(e.preventDefault(),e.stopPropagation(),[...n.filter(o=>o.name!==i)]),Bu=u.div`
    width: 100%;
    padding: 6px;
    display: flex;
    justify-content: space-between;
...
`,zo=({title:e,required:i,dates:n,setDates:s,valid:o,setValid:a,diff:r,minValue:d})=>{if(l.useEffect(()=>{a(new Date(n[0])<=new Date(n[1])||!n[0].length||!n[1].length)},[n]),r!=null){const c=new Date(n[0]),p=new Date(c);p.setDate(c.getDate()+r),n[1]=ie(p,"extraWeird")}return t.jsxs(Yu,{children:[t.jsx(W,{size:5,align:"left",visible:!!e,required:i,children:e}),t.jsx(q,{title:"Внимание",type:"alert",icon:t.jsx(qt,{}),visible:!o,children:"Дата начала не может быть больше даты конца"}),t.jsxs("div",{className:"date-interval-inputs",children:[t.jsx(Xe,{value:n[0],danger:!o,setValue:c=>s([c,n[1]]),type:"date",minValue:d}),t.jsx(Xe,{value:n[1],setValue:c=>s([n[0],c]),type:"date",danger:!o})]})]})},qu=e=>{var f,b,v;const{width:i}=Ri(),n=l.useRef(null),[s,o]=l.useState(!1),[a,r]=l.useState(!1),[d,c]=l.useState(0),[p,h]=l.useState(0),x=((f=n.current)==null?void 0:f.clientWidth)??1,g=Math.ceil((((b=n.current)==null?void 0:b.scrollWidth)??0)/(x+(e??0)));return l.useEffect(()=>{n.current&&(n.current.scrollLeft=d,n.current.clientWidth<n.current.scrollWidth?(o(!0),r(!0)):(r(!1),o(!1)))},[d,(v=n.current)==null?void 0:v.clientWidth,i]),{listRef:n,leftArrow:s,rightArrow:a,setScrollLeft:c,pageOffset:x,amountOfPages:g,currentPage:p,setCurrentPage:h,handleScroll:P=>{h(Math.ceil(P.currentTarget.scrollLeft/(x+(e??0))))}}},Ju=e=>{const{title:i,children:n,gap:s,width:o,height:a,padding:r,fontSize:d,wrap:c,onAdd:p,onWatchMore:h,onDelete:x,showPages:g,innerPadding:m,minWidth:f,wrapOnMobile:b,position:v,direction:P="vertical",verticalAlign:_="top",horizontalAlign:S="left",scroll:k=!0,visible:X=!0,...O}=e;if(!X)return null;const{listRef:N,leftArrow:se,rightArrow:R,handleScroll:ae,setScrollLeft:Ne,pageOffset:Se,amountOfPages:Rt,currentPage:Dt}=qu(s);return t.jsxs(Tp,{padding:r,position:v,width:o,minWidth:f,height:a,children:[t.jsxs(W,{size:4,align:"left",bottomGap:!0,visible:!!i,width:"calc(fit-content + 50px)",children:[i,p&&t.jsx(y,{icon:t.jsx(Jt,{}),width:"35px",height:"15px",background:w.grey.transparent3,textColor:"var(--reallyBlue)",onClick:p}),h&&t.jsx(y,{width:"50px",height:"15px",background:w.blue.transparent2,textColor:w.blue.light1,onClick:h,text:"Ещё"}),x&&t.jsx(y,{width:"fit-content",height:"15px",background:w.grey.transparent3,textColor:"var(--reallyBlue)",onClick:x,text:"Удалить"})]}),t.jsx(ai,{verticalAlign:_,horizontalAlign:S,direction:P,ref:N,gap:s,width:o,height:a,fontSize:d,wrap:c,innerPadding:m,scroll:k,wrapOnMobile:b,onScroll:ae,...O,children:n}),(R||se)&&t.jsxs("div",{className:"bottom-wrapper",children:[se&&t.jsx(y,{background:"transparent",minWidth:"40px",height:"25px",icon:t.jsx(ti,{}),className:"left-button",textColor:w.grey.main,onClick:()=>{Ne(Ee=>{var it;return Ke(Ee-Se-(s??0),((it=N.current)==null?void 0:it.scrollWidth)??0)})}}),g&&t.jsx(Do,{direction:"horizontal",current:Dt,amount:Rt}),R&&t.jsx(y,{background:"transparent",minWidth:"40px",height:"25px",icon:t.jsx(St,{}),className:"right-button",textColor:w.grey.main,onClick:()=>{Ne(Ee=>{var it;return Ke(Ee+Se+(s??0),((it=N.current)==null?void 0:it.scrollWidth)??0)})}})]})]})},be=le.memo(Ju),Xu=()=>t.jsx("div",{className:"left",children:t.jsxs(be,{scroll:!1,height:"100%",verticalAlign:"space-between",position:"static",children:[t.jsx(Ii,{width:"50px",short:!0,className:"logo first"}),t.jsxs(be,{gap:12,scroll:!1,height:"100%",verticalAlign:"center",children:[t.jsx(Z,{to:Cn,tabIndex:-1,children:t.jsx(y,{padding:"0",icon:t.jsx(Xt,{}),text:"Обратная связь",height:"25px",background:"transparent",textColor:"var(--theme-mild-opposite)"})}),t.jsx(Z,{to:ar,tabIndex:-1,children:t.jsx(y,{padding:"0",icon:t.jsx(rc,{}),text:"Узнать свой логин ЕУЗ",height:"25px",background:"transparent",textColor:"var(--theme-mild-opposite)"})}),t.jsx(Z,{to:or,tabIndex:-1,children:t.jsx(y,{padding:"0",icon:t.jsx(qt,{}),text:"Вниманию студентов 1 курса!",height:"25px",background:"transparent",textColor:"var(--theme-mild-opposite)"})}),t.jsx(Z,{to:rr,tabIndex:-1,children:t.jsx(y,{padding:"0",icon:t.jsx(qt,{}),text:"Вниманию сотрудников!",height:"25px",background:"transparent",textColor:"var(--theme-mild-opposite)"})}),t.jsx(he,{}),t.jsx(Z,{to:sr,tabIndex:-1,children:t.jsx(y,{padding:"0",icon:t.jsx(lc,{}),text:"Не получается войти",height:"25px",align:"left",background:"transparent",textColor:"var(--red)"})})]}),t.jsx(tt,{text:"Перейти к старому дизайну",onClick:()=>{localStorage.setItem("useOldVersion","true")},background:"transparent",textColor:"var(--reallyBlue)",icon:t.jsx(Ms,{}),align:"left",padding:"0",width:"100%",href:`${A}/index.php`})]})}),Ku=()=>{const{search:e}=Fs();return le.useMemo(()=>new URLSearchParams(e),[e])},Qu=()=>{const e=Ku(),i=e.get("login"),n=e.get("password"),[s,o]=l.useState(i??""),[a,r]=l.useState(n??""),[d,c]=l.useState(!1),p=!!a&&!!s,h=Zt.login,x=f=>{c(f.getModifierState("CapsLock")),f.key==="Enter"&&h({login:s,password:a})},g=f=>{Zt.changeSavePassword({savePassword:f})},m=()=>h({login:s,password:a});return l.useEffect(()=>{i&&n&&h({login:i,password:n})},[i,n]),{isSubmitActive:p,handleSavePassword:g,handleKeyPress:x,handleLogin:m,password:a,setPassword:r,capsLock:d,login:s,setLogin:o}},Zu=()=>{const{loading:e,error:i,data:n}=ce.useUser(),{isSubmitActive:s,handleKeyPress:o,handleSavePassword:a,handleLogin:r,password:d,setPassword:c,capsLock:p,login:h,setLogin:x}=Qu();return t.jsx("div",{className:"right",onKeyDown:o,children:t.jsxs(be,{gap:16,horizontalAlign:"center",position:"static",verticalAlign:"space-between",height:"100%",scroll:!1,children:[t.jsx(Ii,{width:"50px",short:!0,className:"logo second"}),t.jsx($,{jc:"space-between",children:t.jsx(W,{size:3,align:"left",children:"Личный кабинет"})}),t.jsxs(q,{type:"info",title:"Уважаемые абитуриенты!",children:["Личный кабинет абитуриента находится по ссылке",t.jsx("a",{href:"https://lk.mospolytech.ru/",target:"_blank",rel:"noreferrer",children:t.jsx("strong",{children:" lk.mospolytech.ru"})})]}),t.jsxs(be,{gap:16,scroll:!1,children:[t.jsx(W,{size:4,align:"left",children:"Вход"}),t.jsx(te,{children:"Вход в личный кабинет происходит через единую учетную запись (ЕУЗ)"}),t.jsx(q,{type:"failure",visible:!!i,children:i}),t.jsx(q,{type:"success",visible:(n==null?void 0:n.isAuthenticated)??!1,children:"Вы вошли в аккаунт"}),t.jsx(Xe,{value:h,setValue:x,title:"Логин",placeholder:"Введите логин"}),t.jsx(Xe,{value:d,setValue:c,title:"Пароль",placeholder:"Введите пароль",type:"password",alertMessage:p?"Включен Capslock":void 0}),t.jsx(Qe,{text:"Оставаться в системе",checked:n.savePassword,setChecked:a})]}),t.jsx(kt,{text:"Вход",action:r,isLoading:e,completed:!1,setCompleted:()=>null,isActive:s})]})})},eh=u(Ve)`
    overflow: hidden;
...
`,nh=()=>t.jsx(ih,{children:t.jsx(th,{})}),fe=({oldVersionUrl:e,errorText:i="Страница еще находится в разработке. Если вам она нужна, вернитесь к старому дизайну",buttonText:n="Перейти к старому дизайну",forceForward:s=!1,isRedirectButtonVisible:o=!0})=>(l.useEffect(()=>{s&&(window.location.href=`/old/?p=${e==null?void 0:e.slice(1,e.length)}`)},[]),t.jsx(ge,{text:i,children:o&&t.jsx(tt,{text:n,onClick:()=>{localStorage.setItem("useOldVersion","true")},background:"var(--purple)",width:"300px",href:`${A}/?p=${e==null?void 0:e.slice(1,e.length)}`})})),sh="modulepreload",oh=function(e){return"/"+e},Xn={},j=function(i,n,s){if(!n||n.length===0)return i();const o=document.getElementsByTagName("link");return Promise.all(n.map(a=>{if(a=oh(a),a in Xn)return;Xn[a]=!0;const r=a.endsWith(".css"),d=r?'[rel="stylesheet"]':"";if(!!s)for(let h=o.length-1;h>=0;h--){const x=o[h];if(x.href===a&&(!r||x.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${d}`))return;const p=document.createElement("link");if(p.rel=r?"stylesheet":sh,r||(p.as="script",p.crossOrigin=""),p.href=a,document.head.appendChild(p),r)return new Promise((h,x)=>{p.addEventListener("load",h),p.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>i())},ah=l.lazy(()=>j(()=>import("./index-7ecb162a.js"),["assets/index-7ecb162a.js","assets/vendor-e9654bfa.js","assets/get-default-subdivision-ee1a988f.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js"])),rh=l.lazy(()=>j(()=>import("./index-ecceb01e.js"),["assets/index-ecceb01e.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-teacher-subdivisions-500dfe3f.js"])),lh=l.lazy(()=>j(()=>import("./index-cd4d1ddd.js"),["assets/index-cd4d1ddd.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js"])),ch=l.lazy(()=>j(()=>import("./index-85e7dc8e.js"),["assets/index-85e7dc8e.js","assets/vendor-e9654bfa.js","assets/find-current-in-select-ba4611d5.js"]));l.lazy(()=>j(()=>Promise.resolve().then(()=>Rf),void 0));const dh=l.lazy(()=>j(()=>import("./index-9b91b853.js"),["assets/index-9b91b853.js","assets/vendor-e9654bfa.js","assets/index-afdfeb94.js"])),ph=l.lazy(()=>j(()=>import("./index-188714d2.js"),["assets/index-188714d2.js","assets/vendor-e9654bfa.js","assets/index-eacb01ee.js"])),uh=l.lazy(()=>j(()=>import("./index-28e43655.js"),["assets/index-28e43655.js","assets/vendor-e9654bfa.js","assets/get-default-subdivision-ee1a988f.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js"])),hh=l.lazy(()=>j(()=>import("./index-bfa16b45.js"),["assets/index-bfa16b45.js","assets/vendor-e9654bfa.js","assets/get-default-subdivision-ee1a988f.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-teacher-subdivisions-500dfe3f.js"])),gh=l.lazy(()=>j(()=>import("./index-dd1645c2.js"),["assets/index-dd1645c2.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-teacher-subdivisions-500dfe3f.js"])),xh=l.lazy(()=>j(()=>import("./index-10fd7085.js"),["assets/index-10fd7085.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js"])),fh=l.lazy(()=>j(()=>import("./index-4290273f.js"),["assets/index-4290273f.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-teacher-subdivisions-500dfe3f.js"])),mh=l.lazy(()=>j(()=>import("./index-0c746fdd.js"),["assets/index-0c746fdd.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js"])),bh=l.lazy(()=>j(()=>import("./index-9b7c250f.js"),["assets/index-9b7c250f.js","assets/vendor-e9654bfa.js","assets/ui-0713c01a.js"])),vh=l.lazy(()=>j(()=>import("./index-b1215924.js"),["assets/index-b1215924.js","assets/vendor-e9654bfa.js","assets/ui-0713c01a.js"])),yh=l.lazy(()=>j(()=>import("./index-d1ab1656.js"),["assets/index-d1ab1656.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js"])),jh=l.lazy(()=>j(()=>import("./index-6c4bb826.js"),["assets/index-6c4bb826.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-teacher-subdivisions-500dfe3f.js"])),_h=l.lazy(()=>j(()=>import("./index-cc39dc5e.js"),["assets/index-cc39dc5e.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-ee1a988f.js"])),wh=l.lazy(()=>j(()=>import("./index-55a18018.js"),["assets/index-55a18018.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js"])),kh=l.lazy(()=>j(()=>import("./index-3ca6a426.js"),["assets/index-3ca6a426.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-teacher-subdivisions-500dfe3f.js","assets/get-last-year-for-period-e1de6b16.js"])),Th=l.lazy(()=>j(()=>import("./index-fb0a603e.js"),["assets/index-fb0a603e.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-teacher-subdivisions-500dfe3f.js"])),Sh=l.lazy(()=>j(()=>import("./index-400db550.js"),["assets/index-400db550.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-teacher-subdivisions-500dfe3f.js","assets/get-last-year-for-period-e1de6b16.js"])),Eh=l.lazy(()=>j(()=>import("./index-8e20183a.js"),["assets/index-8e20183a.js","assets/vendor-e9654bfa.js","assets/get-default-subdivision-ee1a988f.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js"])),$h=l.lazy(()=>j(()=>import("./index-6230f9e4.js"),["assets/index-6230f9e4.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js"])),Ph=l.lazy(()=>j(()=>import("./index-333ee001.js"),["assets/index-333ee001.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js"])),Oh=l.lazy(()=>j(()=>import("./index-c5e00a8c.js"),["assets/index-c5e00a8c.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-ee1a988f.js"])),Ah=l.lazy(()=>j(()=>import("./index-cdeb485f.js"),["assets/index-cdeb485f.js","assets/vendor-e9654bfa.js","assets/index-facc3ca2.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-5af9e295.js","assets/get-default-subdivision-ee1a988f.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-teacher-subdivisions-500dfe3f.js"])),Ch=l.lazy(()=>j(()=>import("./index-90b4e4ba.js"),["assets/index-90b4e4ba.js","assets/vendor-e9654bfa.js"]));l.lazy(()=>j(()=>import("./index-3e08c5cd.js"),["assets/index-3e08c5cd.js","assets/vendor-e9654bfa.js","assets/index-edccbc1f.js","assets/index-ce7d98dc.js"]));const mn=l.lazy(()=>j(()=>import("./index-50f5e169.js"),["assets/index-50f5e169.js","assets/vendor-e9654bfa.js"])),Ih=l.lazy(()=>j(()=>import("./index-666ad563.js"),["assets/index-666ad563.js","assets/vendor-e9654bfa.js"])),Rh=l.lazy(()=>j(()=>import("./index-46f0da5e.js"),["assets/index-46f0da5e.js","assets/vendor-e9654bfa.js","assets/send-hr-form-holiday-work-22f40a8f.js"])),Dh=l.lazy(()=>j(()=>import("./index-0a263244.js"),["assets/index-0a263244.js","assets/vendor-e9654bfa.js"])),Nh=l.lazy(()=>j(()=>import("./index-4d129bfb.js"),["assets/index-4d129bfb.js","assets/vendor-e9654bfa.js"])),Lh=l.lazy(()=>j(()=>import("./index-3c34a4b2.js"),["assets/index-3c34a4b2.js","assets/vendor-e9654bfa.js","assets/send-hr-form-holiday-work-22f40a8f.js"])),zh=l.lazy(()=>j(()=>import("./index-6f187a5b.js"),["assets/index-6f187a5b.js","assets/vendor-e9654bfa.js"])),Mh=l.lazy(()=>j(()=>import("./index-44f5d7af.js"),["assets/index-44f5d7af.js","assets/vendor-e9654bfa.js"])),Fh=l.lazy(()=>j(()=>import("./index-b45d87b2.js"),["assets/index-b45d87b2.js","assets/vendor-e9654bfa.js"])),Hh=l.lazy(()=>j(()=>import("./index-49ba60a7.js"),["assets/index-49ba60a7.js","assets/vendor-e9654bfa.js","assets/send-hr-form-work-transfer-eb6f34a8.js"])),Bh=l.lazy(()=>j(()=>import("./index-8e9e724c.js"),["assets/index-8e9e724c.js","assets/vendor-e9654bfa.js","assets/send-hr-form-work-transfer-eb6f34a8.js"]));l.lazy(()=>j(()=>Promise.resolve().then(()=>ox),void 0));l.lazy(()=>j(()=>import("./index-710fffd2.js"),["assets/index-710fffd2.js","assets/vendor-e9654bfa.js","assets/help-links-3514c34d.js"]));const Uh=l.lazy(()=>j(()=>import("./index-5f0c8e79.js"),["assets/index-5f0c8e79.js","assets/vendor-e9654bfa.js"])),Mo=l.lazy(()=>j(()=>import("./index-25c5bb9b.js"),["assets/index-25c5bb9b.js","assets/vendor-e9654bfa.js","assets/index-edccbc1f.js","assets/index-ce7d98dc.js"])),Fo=l.lazy(()=>j(()=>import("./index-3e08c5cd.js"),["assets/index-3e08c5cd.js","assets/vendor-e9654bfa.js","assets/index-edccbc1f.js","assets/index-ce7d98dc.js"])),Wh=l.lazy(()=>j(()=>import("./index-2f29efdd.js"),["assets/index-2f29efdd.js","assets/vendor-e9654bfa.js"]));l.lazy(()=>j(()=>import("./index-f967e293.js"),["assets/index-f967e293.js","assets/vendor-e9654bfa.js","assets/index.esm-6c739436.js"]));const Vh=l.lazy(()=>j(()=>import("./index-fcf4bec4.js"),["assets/index-fcf4bec4.js","assets/vendor-e9654bfa.js"])),Ho=l.lazy(()=>j(()=>import("./index-85744373.js"),["assets/index-85744373.js","assets/vendor-e9654bfa.js","assets/help-links-3514c34d.js"])),Gh=l.lazy(()=>j(()=>import("./index-0ed2335d.js"),["assets/index-0ed2335d.js","assets/vendor-e9654bfa.js"])),Yh=l.lazy(()=>j(()=>import("./index-5b6db623.js"),["assets/index-5b6db623.js","assets/vendor-e9654bfa.js"])),qh=l.lazy(()=>j(()=>import("./index-fcd71291.js"),["assets/index-fcd71291.js","assets/vendor-e9654bfa.js","assets/week-schedule-681ad059.js"])),Jh=l.lazy(()=>j(()=>import("./index-d9ff4a5d.js"),["assets/index-d9ff4a5d.js","assets/vendor-e9654bfa.js"]));l.lazy(()=>j(()=>Promise.resolve().then(()=>jm),void 0));const Xh=l.lazy(()=>j(()=>import("./index-bc377524.js"),["assets/index-bc377524.js","assets/vendor-e9654bfa.js"])),Kh=l.lazy(()=>j(()=>import("./index-54a342a9.js"),["assets/index-54a342a9.js","assets/vendor-e9654bfa.js","assets/index-6587b994.js","assets/week-schedule-681ad059.js","assets/index-ce7d98dc.js"])),Qh=l.lazy(()=>j(()=>import("./index-a5ffbcde.js"),["assets/index-a5ffbcde.js","assets/vendor-e9654bfa.js","assets/customize-leftside-bar-item-851e8f5d.js","assets/index.esm-6c739436.js"])),Zh=l.lazy(()=>j(()=>import("./index-7028ab7c.js"),["assets/index-7028ab7c.js","assets/vendor-e9654bfa.js"])),eg=l.lazy(()=>j(()=>import("./index-b50c4f31.js"),["assets/index-b50c4f31.js","assets/vendor-e9654bfa.js"])),tg=l.lazy(()=>j(()=>import("./index-777b3c31.js"),["assets/index-777b3c31.js","assets/vendor-e9654bfa.js","assets/customize-leftside-bar-item-851e8f5d.js","assets/index.esm-6c739436.js"])),ig=l.lazy(()=>j(()=>import("./index-da309640.js"),["assets/index-da309640.js","assets/vendor-e9654bfa.js"])),ng=l.lazy(()=>j(()=>import("./index-0b9d686a.js"),["assets/index-0b9d686a.js","assets/vendor-e9654bfa.js","assets/index-6587b994.js","assets/week-schedule-681ad059.js","assets/index-ce7d98dc.js"])),sg=l.lazy(()=>j(()=>import("./index-d37fa089.js"),["assets/index-d37fa089.js","assets/vendor-e9654bfa.js","assets/index-afdfeb94.js"])),og=l.lazy(()=>j(()=>import("./index-e4b77a54.js"),["assets/index-e4b77a54.js","assets/vendor-e9654bfa.js"])),ag=l.lazy(()=>j(()=>import("./index-eac0a091.js"),["assets/index-eac0a091.js","assets/vendor-e9654bfa.js","assets/help-links-3514c34d.js"])),rg=l.lazy(()=>j(()=>import("./index-220c8f48.js"),["assets/index-220c8f48.js","assets/vendor-e9654bfa.js","assets/help-links-3514c34d.js"])),lg=l.lazy(()=>j(()=>import("./index-eb9e215d.js"),["assets/index-eb9e215d.js","assets/vendor-e9654bfa.js"])),cg=l.lazy(()=>j(()=>import("./index-710fffd2.js"),["assets/index-710fffd2.js","assets/vendor-e9654bfa.js","assets/help-links-3514c34d.js"])),dg=u.div`
    width: 100%;
...
`,gg=({list:e,onAddElement:i,onRemoveAll:n,onRemoveOne:s,padding:o,height:a,setList:r})=>{const d=Object.keys(e??{}),{removeAll:c,removeOne:p,setRemoveAll:h,setRemoveOne:x}=ug(d,r);return d.length?t.jsxs(hg,{removeAll:c||closed,padding:o,height:a,children:[!!i&&t.jsxs(Gi,{onClick:i,background:"var(--reallyBlue)",color:"#fff",children:[t.jsx(Jt,{}),"Добавить"]}),Object.values(e??{}).map(g=>{if(g!=null&&g.id)return t.jsxs(Gi,{background:g.background,remove:p===g.id,children:[t.jsx("div",{className:"element-text",children:g.title}),t.jsx("div",{className:"remove",onClick:()=>{d.length===1?(h(!0),n==null||n()):(x(g.id),s(g.id))},children:t.jsx(We,{})})]},g.id)}),d.length&&!!n&&t.jsx(Gi,{background:"var(--reallyBlue)",color:"#fff",onClick:()=>{n(),h(!0)},children:t.jsx("div",{className:"element-text",children:"Убрать все"})})]}):null},Tt=(e,i)=>{switch(i){case"date":return ie(e,"numeric");case"rub":return e+" руб.";default:return e===void 0?"-":e}},xg=(e,i)=>e?Object.keys(e).find(n=>e[n].title===i):null,fg=e=>{const[i,n]=l.useState(null),[s,o]=l.useState(null),[a,r]=l.useState(null),[d,c]=l.useState(null),[p,h]=l.useState(e),x=l.useCallback(m=>{var f,b;o(v=>(v&&v[m]&&delete v[m],{...v})),m===((f=i==null?void 0:i.column)==null?void 0:f.field)&&n(null),m===((b=a==null?void 0:a.column)==null?void 0:b.field)&&r(null)},[i,s,a]),g=l.useCallback(()=>{o(null),n(null),r(null)},[]);return l.useEffect(()=>{if(s)if(!d)c(m=>{const f=Object.values(s)[0].column;return m={[(f==null?void 0:f.field)??""]:{id:(f==null?void 0:f.field)??"",title:"Фильтр: "+(f==null?void 0:f.title)}},{...m}});else{const m=Object.values(s).find(f=>{var b;return!d[((b=f.column)==null?void 0:b.field)??""]});m&&c(f=>{var P,_;const b=((P=m.column)==null?void 0:P.field)??"",v="Фильтр: "+((_=m.column)==null?void 0:_.title);return f&&(f[b]={id:b,title:v}),{...f}})}i&&c(m=>{var v;const f=((v=i.column)==null?void 0:v.field)??"",b="Поиск";return m?m[f]={id:f,title:b}:m={[f]:{id:f,title:b}},{...m}}),a&&c(m=>{var v;const f=((v=a.column)==null?void 0:v.field)??"",b="Сортировка";return m?m[f]={id:f,title:b}:m={[f]:{id:f,title:b}},{...m}})},[i,s,a]),l.useEffect(()=>{var b;const m=i==null?void 0:i.column,f=(b=i==null?void 0:i.column)==null?void 0:b.field;if(i&&f){const v=e==null?void 0:e.filter(P=>me(Tt(P[f],m==null?void 0:m.type)).includes(me(Tt(i.value,m==null?void 0:m.type))));h(v)}else h(e)},[i]),l.useEffect(()=>{if(s){const m=e==null?void 0:e.filter(f=>!Object.values(s).find(b=>{var v;return f[((v=b.column)==null?void 0:v.field)??""]!==b.value.title}));h(m)}else c(m=>({...m})),h(e)},[s]),l.useEffect(()=>{var f;const m=((f=a==null?void 0:a.column)==null?void 0:f.field)??"";a?h(b=>{const v=[...b??[]];return v==null||v.sort((P,_)=>_[m]<P[m]?a.value==="asc"?1:-1:_[m]>P[m]?a.value==="asc"?-1:1:0),v}):(c(b=>{const v=xg(b,"Сортировка");return b&&v&&delete b[v],{...b}}),h(e))},[a==null?void 0:a.value]),l.useEffect(()=>{h(e)},[e]),{sort:a,setSort:r,search:i,setSearch:n,resultData:p,filter:s,setFilter:o,filterList:d,setFilterList:c,onRemoveOne:x,onRemoveAll:g}},en=(e,i)=>{const n=e.find(s=>s.id.toString()===i[0]);return i.length&&(n!=null&&n.children)?(i.shift(),en(n.children,i)):n?n.children:e},mg=e=>{const{items:i,setSelected:n,onClick:s,selected:o,appearance:a=!0,multiple:r=!1}=e,[d,c]=l.useState(!1),p=l.useRef(null),h=l.useRef(null),[x,g]=l.useState([]),[m,f]=l.useState(i),[b,v]=l.useState("");l.useEffect(()=>{f(i)});const P=l.useCallback(()=>{c(k=>!k)},[c]),_=l.useCallback(k=>{if(k.children)x.push(k.id.toString()),f(en(i,[...x])??[]),g([...x]);else{if(r)if(o)if(o.find(X=>X.id===k.id)){const X=o.filter(O=>O.id!==k.id);X.length?n(X):n(null)}else n([...o,k]);else n([k]);else n(k);!r&&P(),v(x.join("/"))}s==null||s(k)},[n,x]),S=l.useCallback(()=>{x.pop(),g([...x]),x.length===0?f(i):f(en(i,x)??[])},[x,f]);return Pt(p,()=>{d&&P()}),{handleOpen:P,refElement:p,isOpen:d,multiple:r,handleSelect:_,selectedRoute:b,currentItems:m,route:x,goBack:S,refItems:h,appearance:a}},bg=u.div`
    display: flex;
    justify-content: space-between;
    align-items: center;
    min-height: 36px;
...
`,kg=e=>{const{handleOpen:i,refElement:n,isOpen:s,multiple:o,handleSelect:a,selectedRoute:r,currentItems:d,route:c,goBack:p,refItems:h,appearance:x}=mg(e),{isActive:g,width:m,title:f,required:b,selected:v,placeholder:P}=e;return t.jsxs(vg,{onClick:i,appearance:x,ref:n,isOpen:s,isActive:g??!0,width:m,children:[t.jsx(W,{size:4,align:"left",bottomGap:"5px",visible:!!f,required:b,children:f}),t.jsxs(bg,{multiple:o,appearance:x,children:[t.jsx(yg,{appearance:x,children:o?v?v.map(_=>t.jsxs("div",{className:"header-item",children:[!!_.icon&&t.jsx("span",{className:"icon",children:_.icon}),t.jsx("span",{className:"header-title",children:_.title})]},_.id)):t.jsx("span",{className:"not-chosen multi",children:P??"Не выбрано"}):t.jsx("div",{className:"single-header",children:v?t.jsxs(t.Fragment,{children:[!!v.icon&&t.jsx("span",{className:"icon",children:v.icon}),t.jsx("span",{className:"header-title",children:v.title})]}):t.jsx("span",{className:"not-chosen",children:P??"Не выбрано"})})}),t.jsx(wg,{isOpen:s})]}),t.jsxs(jg,{width:m,ref:h,isOpen:s,className:s?"open":"close",itemsAmount:d.length+(c.length?1:0),title:f,children:[!!c.length&&t.jsx(Kn,{isSelected:!1,onClick:_=>{_.stopPropagation(),p()},children:t.jsxs("span",{className:"back-button",children:[t.jsx(ti,{}),"Назад"]})},-1),d.map(({id:_,icon:S,title:k,children:X,data:O})=>t.jsxs(Kn,{onClick:N=>{N.stopPropagation(),a({id:_,icon:S,title:k,children:X,data:O})},isSelected:!o&&!!v&&v.title.includes(k),leadingToSelected:r.includes(_.toString()),children:[!!S&&t.jsx("span",{className:"icon",children:S}),t.jsx("span",{className:"select-item-title",children:k}),!!X&&t.jsx("span",{className:"right-icon",children:t.jsx(St,{})}),o&&!!v&&!!v.find(N=>N.title.includes(k))&&t.jsx("span",{className:"right-icon",children:t.jsx(Ei,{})})]},k))]})]})},Bo=l.memo(kg),Tg=e=>{switch(e){case"desc":return J.evokePopUpMessage({message:"Таблица отсортирована по убыванию",type:"info",time:5e3});case"asc":return J.evokePopUpMessage({message:"Таблица отсортирована по возрастанию",type:"info",time:5e3});default:return J.evokePopUpMessage({message:"Сортировка отключена",type:"info",time:5e3})}},Sg=u.div`
    display: flex;
    align-items: center;
    width: 100%;
    font-size: 0.9em;
...
`,$g=u.div`
    display: flex;
    align-items: center;
`,Pg=({columns:e,search:i,setSearch:n,filter:s,setFilter:o,sort:a,setSort:r})=>{const d=c=>()=>{c.search&&n({value:"",column:c}),c.sort&&r(p=>{const h=p!=null&&p.value?p.value==="desc"?"asc":null:"desc";return Tg(h),h?{column:c,value:h}:null})};return t.jsx(Eg,{children:e.map(c=>{var p,h,x,g;return t.jsxs(Uo,{overflow:c.catalogs?"visible":"hidden",width:c.width,title:c.title,clickable:c.search,align:c.search?"space-between":c.align,showFull:c.showFull,className:((p=c.priority)==null?void 0:p.toString())??"one",onClick:d(c),children:[!c.catalogs&&c.title,!c.catalogs&&!c.sort&&c.search&&t.jsx(rt,{className:"icon",style:{color:c.field===((h=i==null?void 0:i.column)==null?void 0:h.field)?"var(--reallyBlue)":"var(--text)"}}),c.sort&&t.jsx(dc,{className:"icon",style:{color:c.field===((x=a==null?void 0:a.column)==null?void 0:x.field)?"var(--reallyBlue)":"var(--text)"}}),c.catalogs&&t.jsx($g,{children:t.jsx(Bo,{appearance:!1,items:c.catalogs??[],setSelected:m=>o(f=>(m&&(f={...f,[c.field]:{column:c,value:m}}),f)),selected:(g=s==null?void 0:s[c.field])==null?void 0:g.value,placeholder:c.title})})]},c.title)})})},Og=({pages:e,condition:i,currentPage:n,setCurrentPage:s,align:o="center"})=>{const[a,r]=l.useState(n.toString());l.useEffect(()=>{a.length&&s(+a)},[a]),l.useEffect(()=>{r(n.toString())},[n]);const d=c=>{c.length?+c>=1&&+c<=e+1&&r((+c-1).toString()):r("")};return t.jsxs(be,{horizontalAlign:o,visible:i,direction:"horizontal",width:"100%",padding:"10px",children:[t.jsx(y,{minWidth:"42px",height:"42px",background:"var(--mild-theme)",icon:t.jsx(ti,{}),onClick:()=>r(Ke(n-1,e).toString())}),t.jsxs("div",{className:"page-indicator",children:[t.jsx(Xe,{width:"12px",placeholder:"",value:a.length?(+a+1).toString():"",setValue:d,inputAppearance:!1}),"/ ",e+1]}),t.jsx(y,{minWidth:"42px",height:"42px",background:"var(--mild-theme)",icon:t.jsx(St,{}),onClick:()=>r(Ke(n+1,e).toString())})]})},Ag=u.div`
    display: flex;
    flex-wrap: wrap;
    flex-direction: ${({direction:e})=>e==="vertical"&&"column"};
    justify-content: flex-start;
...
`,Ig=({obj:e,columns:i})=>t.jsx(Cg,{children:i.map(n=>t.jsx(st,{keyStr:n.title,value:n.render?n.render(e[n.field],e):Tt(e[n.field],n.type)},n.title))}),Wo=({columns:e,el:i,index:n,onRowClick:s})=>{const{open:o}=K(),a=()=>o(t.jsx(Ig,{obj:i,columns:e}),"Информация");return t.jsx(Sg,{even:n%2===0,onClick:()=>s?s(i):a(),children:e.map(r=>{var d;return t.jsx(t.Fragment,{children:t.jsx(Uo,{showFull:r.showFull,width:r.width,className:((d=r.priority)==null?void 0:d.toString())??"one",align:r.align,children:r.render?r.render(Tt(i[r.field],r.type),i):Tt(i[r.field],r.type)},r.field)})})})},Rg=u.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`,Vf=({payments:e})=>{const i=e==null?void 0:e.reduce((n,s)=>n+Uf(s.value),0).toFixed(1);return t.jsxs(Wf,{children:[t.jsxs($,{jc:"space-between",children:[t.jsx(W,{icon:t.jsx(Hs,{}),size:4,align:"left",width:"fit-content",children:"Поступившие платежи"}),t.jsx(te,{fontSize:"1rem",width:"fit-content",children:t.jsx(ua,{size:"small",children:i})})]}),t.jsxs("div",{className:"payment-list",children:[!e.length&&t.jsx(ge,{size:"50px",text:"Нет платежей",image:t.jsx(pc,{})}),e.map((n,s)=>l.createElement(Hf,{...n,key:s}))]})]})},ha=()=>t.jsx(q,{type:"tip",lineHeight:"1.7rem",maxWidth:"700px",fontSize:"0.83rem",children:t.jsxs("p",{children:["По возникновении технических проблем при подписании договоров и дополнительных соглашений обращайтесь на почту ",t.jsx("a",{href:"mailto:info@mospolytech.ru",children:"info@mospolytech.ru"})]})}),Gf=e=>e.replace(/\B(?=(\d{3})+(?!\d))/g," "),Yf=u.div`
    display: flex;
    width: 100%;
    flex-direction: column;
    align-items: flex-start;
...
`,qf=({contract:e})=>{if(!e)return null;const{number:i,startDate:n,endDatePlan:s,contragent:o,sum:a,can_sign:r,file:d,student:c,signed_user:p}=e,{open:h}=K(),[x,g]=l.useState(!1),[m,f]=l.useState(!1),[b,v]=l.useState(!1),{error:P}=Sn.usePayments(),_=[{text:"Номер договора",info:i??""},{text:"Начало действия",info:ie(n)},{text:"Действует до",info:ie(s)},{text:"Заказчик",info:o||"Московский политех"},{text:"Обучающийся",info:c??""},{text:"Сумма к оплате",info:Gf(a)??""},{text:"Статус",info:p?"Подписан":"Не подписан"}],S=()=>{navigator.clipboard.writeText((e==null?void 0:e.number)??""),g(!0)},k=()=>{e&&(f(!0),En.signContractFx(e.id),f(!1),v(!0))},X=()=>{h(t.jsx(ha,{}),"Не получается подписать")};return t.jsxs(Yf,{children:[t.jsx("div",{className:"contract-info",children:_.map(({info:O,text:N})=>t.jsx(st,{keyStr:N,value:O},O))}),r&&t.jsxs($,{d:"column",gap:"8px",children:[t.jsx(kt,{text:"Подписать договор",buttonSuccessText:"Подписан",action:k,isLoading:m,completed:b,repeatable:!1,popUpFailureMessage:P??"Не удалось подписать договор",setCompleted:v,popUpSuccessMessage:"Договор подписан",isActive:!0,pulsing:!0}),t.jsx(y,{onClick:X,text:"Не получается подписать?",background:"transparent",textColor:w.grey.main})]}),!r&&t.jsxs($,{gap:"8px",children:[t.jsx(kt,{text:"Скопировать номер договора",action:S,isLoading:!1,completed:x,setCompleted:g,popUpSuccessMessage:"Номер договора скопирован в буфер",isActive:!0}),t.jsx(tt,{onClick:()=>null,href:d??"",icon:t.jsx($i,{}),width:"45px"})]})]})},Jf=u.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    user-select: none;
...
`,Xf=({title:e,confirmed:i,setOpenArea:n})=>t.jsxs(Jf,{onClick:()=>n(s=>!s),children:[t.jsxs("div",{className:"title-and-icon",children:[i?t.jsx(Bs,{style:{color:"var(--green)"}}):t.jsx(Us,{style:{color:"var(--red)"}}),t.jsx("b",{children:e})]}),t.jsx(y,{icon:t.jsx(ve,{}),onClick:()=>null,background:"transparent"})]}),Kf=u.div`
    display: flex;
    flex-direction: column;
    transition: 0.2s;
    width: 100%;
...
`,Qf=e=>{const{children:i,title:n,height:s,confirmed:o=!1,show:a=!1}=e,[r,d]=l.useState(a);return t.jsxs(Kf,{height:s,open:r,children:[t.jsx(Xf,{title:n,confirmed:o,setOpenArea:d}),t.jsx("div",{className:"inputs",children:i})]})};function ga({isDone:e,submit:i,setData:n}){const[s,o]=l.useState(!1),[a,r]=l.useState(!1),[d,c]=l.useState(e??!1),p=async()=>{try{o(!0),await i(),o(!1),r(!0),c(!0)}catch{o(!1),J.evokePopUpMessage({message:"Не удалось подписать",type:"failure"})}};return l.useEffect(()=>{n&&io().then(h=>n(h[0]))},[]),{done:d,open,loading:s,completed:a,setCompleted:r,handleSubmit:p}}const Zf=u.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`,v_=({children:e,data:i,setData:n,submit:s,isDone:o=!1})=>{const{open:a}=K(),{handleSubmit:r,loading:d,done:c,completed:p,setCompleted:h}=ga({isDone:o,submit:s,setData:n});return i?t.jsxs(tm,{children:[t.jsxs($,{gap:"8px",children:[t.jsx(tt,{href:i.file,onClick:()=>null,text:"Скачать согласие",width:"100%",minHeight:"38px",height:"38px",icon:t.jsx($i,{})}),t.jsx(q,{type:"success",icon:t.jsx(Ei,{}),title:"Успешно подписано",visible:i.status||c,align:"center"})]}),t.jsx("div",{className:"info-text",children:e}),!i.status&&!c&&t.jsx(kt,{text:!i.status&&!c?"Подписать":"Подписано",action:r,isLoading:d,completed:p,isDone:c||i.status,setCompleted:h,isActive:!i.status&&!c,popUpFailureMessage:"Согласие уже подписано",popUpSuccessMessage:"Согласие успешно подписано"}),(i.status||c)&&t.jsxs(t.Fragment,{children:[t.jsx(he,{margin:"16px 0",width:"100%"}),t.jsxs(te,{fontSize:"0.9rem",lineHeight:"1.4rem",children:["Дата подписания: ",ie(i.date||new Date),","," ",i.time||`${new Date().getHours()}:${new Date().getMinutes()}`,t.jsx("br",{}),i.fio]})]}),!i.status&&!c&&t.jsx($,{jc:"center",children:t.jsx(y,{onClick:()=>a(t.jsx(em,{}),"Ошибка в данных"),text:"Заметили ошибку в личных данных?",background:"transparent",textColor:w.grey.main})})]}):null},im=u.div`
    display: flex;
    align-items: center;
...
`,nm=({data:e})=>{const{id:i,signed_user:n,name:s,can_sign:o,date:a}=e,{handleSubmit:r,loading:d,done:c,completed:p,setCompleted:h}=ga({isDone:n,submit:()=>vd(i)}),x=n||c?140:100;return t.jsxs(Qf,{height:x,title:s,confirmed:n||c,children:[t.jsxs(im,{children:[t.jsxs($,{d:"column",ai:"flex-start",gap:"4px",children:[t.jsx(W,{size:5,align:"left",children:s}),t.jsx(te,{children:ie(a)})]}),t.jsxs($,{gap:"8px",w:"100%",jc:"flex-end",children:[t.jsx(tt,{href:e.file,onClick:()=>null,width:"40px",icon:t.jsx($i,{}),isActive:!!e.file}),!c&&t.jsx(kt,{text:c?"Подписано":"Подписать",action:r,isLoading:d,completed:p,isDone:c,width:"160px",setCompleted:h,isActive:!c&&o,popUpFailureMessage:o?"Согласие уже подписано":"Необходимо сначала подписать соглашение об электронном взаимодейтсвии",popUpSuccessMessage:"Согласие успешно подписано"}),t.jsx(q,{type:"success",title:"Подписано",icon:t.jsx(Ei,{}),align:"center",width:"130px",visible:c})]})]}),(c||n)&&t.jsx(he,{width:"100%"}),(c||n)&&t.jsxs(te,{children:["Дата подписания: ",ie(e.signed_user_date||new Date),","," ",e.signed_user_time||`${new Date().getHours()}:${new Date().getMinutes()}`]})]})},sm=({isDormitory:e,electronicAgreements:i=[]})=>t.jsxs(be,{width:"100%",children:[t.jsx(W,{size:4,align:"left",icon:t.jsx(uc,{}),bottomGap:!0,children:"Доп. соглашения"}),t.jsx(ha,{}),t.jsx(q,{type:"info",title:"Информация",visible:!e,children:"Подписание дополнительных соглашений к 3-сторонним договорам в Личном кабинете не предусмотрено"}),i.map((n,s)=>t.jsx(nm,{data:n},s))]}),om=u.div`
    display: flex;
    justify-content: center;
    align-items: center;
...
`,rm=({qr_current:e,qr_total:i,currentPage:n})=>n===0?t.jsx(hi,{qrCode:e}):n===1?t.jsx(hi,{qrCode:i}):t.jsx(am,{children:t.jsx(In,{pages:[{title:"Текущая залолженность",content:t.jsx(hi,{qrCode:e})},{title:"Общая залолженность",content:t.jsx(hi,{qrCode:i})}],appearance:!1,currentPage:n})}),lm=({type:e="horizontal",...i})=>{const{open:n}=K(),s="Оплатить через QR-code",o=`linear-gradient(45deg, ${w.green.main}, ${w.green.dark1})`,a=()=>{n(t.jsx(rm,{...i}),s)};return e==="vertical"?t.jsx(y,{onClick:a,width:"68px",height:"60px",direction:"vertical",text:"QR",icon:t.jsx(hc,{}),textColor:"#fff",background:o}):t.jsx(y,{text:s,onClick:a,width:"100%",textColor:"#fff",background:o})},cm=({debt:e,size:i="big"})=>{const n=e>0?w.red.main:w.green.main;return t.jsx(ua,{size:i,color:n,fontWeight:"600",children:e>=0?e:`+${-e}`})},dm=[{query:"(max-width: 766px)",title:"isMobile"},{query:"(min-width: 767px) and (max-width: 1199px)",title:"isTablet"},{query:"(min-width: 1200px)",title:"isDesktop"}],Yi=e=>e.reduce((i,n)=>(i[n.title]=n.mql.matches,i),{}),Ni=()=>{const e=dm.map(({query:s,title:o})=>({mql:matchMedia(s),title:o})),[i,n]=l.useState(Yi(e));return l.useLayoutEffect(()=>(e.forEach(({mql:s})=>s.addEventListener("change",()=>{n(Yi(e))})),()=>e.forEach(({mql:s})=>s.removeEventListener("change",()=>{n(Yi(e))}))),[]),i},pm=u.div`
    width: 100%;
`,um=u.div`
    width: 100%;
    padding: 16px;
...
`,xm=u.div`
    position: relative;
`,fm=e=>{const{data:i,isDormitory:n}=e,{balance_currdate:s,balance:o,endDatePlan:a,can_sign:r,bill:d,qr_current:c,qr_total:p}=i,{isMobile:h}=Ni(),{open:x}=K(),[g,m]=l.useState(0),f=g===0?+s:+o,b=f>0,v=n?"общежитию":"обучению",P=b?g===0?`Долг по ${v}`:`Остаток по ${v}`:f<0?`Переплата по ${v}`:"У вас нет долга",_=g===0?`На ${ie(new Date)}`:`До ${ie(a)}`,S=()=>{x(t.jsx(qf,{contract:i}),"Реквизиты договора")};return t.jsxs(pm,{children:[t.jsx(W,{icon:t.jsx(gc,{}),size:4,align:"left",bottomGap:!0,children:"Задолженность"}),t.jsxs(um,{children:[t.jsx(fn,{pages:[{title:"Текущая"},{title:"Общая"}],currentPage:g,setCurrentPage:m,appearance:!1}),t.jsxs(hm,{children:[t.jsxs($,{d:"column",gap:"12px",ai:"flex-start",children:[t.jsx(cm,{debt:f}),t.jsxs($,{d:"column",gap:"4px",ai:"flex-start",children:[t.jsx(W,{size:3,align:"left",children:P}),t.jsx(te,{children:_})]})]}),b?t.jsx(lm,{currentPage:g,type:h?"horizontal":"vertical",qr_current:c,qr_total:p}):t.jsx(qp,{color:"green",size:"40px"})]}),t.jsxs(gm,{children:[d&&t.jsx(tt,{text:"Квитанция на оплату",background:"transparent",textColor:w.grey.main,align:"left",width:"fit-content",href:d,padding:"0"}),t.jsxs(xm,{children:[t.jsx(y,{onClick:S,text:"Реквизиты договора",background:"transparent",textColor:w.grey.main,width:"fit-content",padding:"0",align:"left"}),t.jsx(dt,{right:"-25px",top:"10px",visible:r,pulsing:!0,children:"1"})]})]})]})]})},mm=e=>`${e.charAt(0).toUpperCase()}${e.slice(1)}`,bm=(e,i)=>{const n=Number(i==null?void 0:i.sum)||Number(i==null?void 0:i.sum_price),s=Number(i==null?void 0:i.sum_pay);if(!n&&n!==0||!s&&s!==0)return"-";const o=n-s;return o<=0?"Оплачено":`Ожидает оплаты (${Tt(String(o),"rub")})`},vm=()=>[{title:"Год",field:"year",width:"25%",render:(e,i)=>{const n=i==null?void 0:i.date_start;return n?new Date(n).toLocaleDateString("ru",{year:"numeric"}):"-"}},{title:"Месяц",field:"month",width:"25%",render:(e,i)=>{const n=i==null?void 0:i.date_start;if(!n)return"-";const s=new Date(n).toLocaleDateString("ru",{month:"long"});return mm(s)}},{title:"Оплатить до",field:"date_plan",type:"date",width:"25%",sort:!0},{title:"Статус",field:"sum_pay",width:"25%",render:bm}],ym=({paygraph:e})=>t.jsxs($,{d:"column",children:[t.jsx(W,{icon:t.jsx(xc,{}),size:4,align:"left",bottomGap:!0,children:"График платежей"}),t.jsx(Re,{columns:vm(),data:e??[],maxOnPage:3})]}),gi=({contracts:e})=>e?t.jsx(Mf,{children:e.map((i,n)=>{const{agreements:s,number:o,type:a,paygraph:r,payments:d}=i,c=a==="Общежитие",p=s.filter(h=>new Date(h==null?void 0:h.date)>new Date("2022-02-1"));return t.jsxs(le.Fragment,{children:[e.length!==1&&t.jsxs($,{gap:"8px",children:[t.jsx($,{w:"fit-content",children:t.jsxs(W,{size:3,align:"left",children:["Договор:"," "]})}),t.jsxs(te,{fontSize:"1rem",children:[a,", ",o]})]}),t.jsx(fm,{data:i,isDormitory:c}),t.jsx(Vf,{payments:d??[]}),t.jsx(ym,{paygraph:r}),t.jsx(sm,{isDormitory:c,electronicAgreements:p}),n!==e.length-1&&t.jsx(he,{margin:"0",width:"100%"})]},o)})}):null,$n=()=>{const{data:e,loading:i,error:n}=Sn.usePayments(),s=e!=null&&e.dormitory.length&&(e!=null&&e.education.length)?"both":e!=null&&e.dormitory.length?"dormitory":e!=null&&e.education.length?"education":"none";return l.useEffect(()=>{J.evokePopUpMessage({type:"alert",time:1e4,message:"В связи с техническими работами отображение данных по произведенным оплатам может быть не полным"})},[]),t.jsx(et,{loading:i,load:En.getPaymentsFx,error:n,data:e,noDataCheck:!(e!=null&&e.dormitory.length),children:t.jsxs(Li,{children:[t.jsx(q,{type:"alert",title:"Внимание!",children:"Ведутся доработки по информации о долге по оплате и суммам оплат"}),s==="none"&&t.jsx(ge,{text:"Нет данных"}),s==="both"&&t.jsx(In,{pages:[{title:"Общежитие",content:t.jsx(gi,{contracts:e==null?void 0:e.dormitory})},{title:"Обучение",content:t.jsx(gi,{contracts:e==null?void 0:e.education})}],appearance:!1}),s==="dormitory"&&t.jsx(gi,{contracts:e==null?void 0:e.dormitory}),s==="education"&&t.jsx(gi,{contracts:e==null?void 0:e.education})]})})},jm=Object.freeze(Object.defineProperty({__proto__:null,default:$n},Symbol.toStringTag,{value:"Module"})),L="/applications",oe="/hr-applications",is="/staff_orders",ns="/staff_blanks",_m="/ad_logins",Pn="/doclist",ss="/pps_vote2020",xa="/pps_contest",wm="/electronic-statements",pe="/onboarding",km="/structure-of-the-university",Tm="/addresses-and-contacts",Sm="/brandbook",Em="/wifi-at-the-university",$m="/health-care",Pm="/psychological-help",Om="/social-environment",Am="/vacation",Nt="/kpi_pps",Lt="/kpi_admin",os="/sc_news",as="/oop",rs="/centers",Cm="/helpful-information",Im="/download-agreements",Rm="/physical-education",Dm="/physical-education/student/:studentId",fa=L+"/contact-info-actualization",ma=L+"/data-verification",ba=L+"/issuance-of-licenses",va=L+"/getting-computer-equipment",ya=L+"/connecting-computer",ja=L+"/printer-maintenance",_a=L+"/question-sed",wa=L+"/question-personal-account",ka=L+"/other-it-services",Ta=L+"/certificate-from-the-place-of-work",Sa=L+"/visa-certificate",Ea=L+"/certificate-of-work-experience",$a=L+"/number-of-unused-vacation-days",Pa=L+"/copy-of-the-employment-record",Oa=L+"/copies-of-documents-from-the-personal-file",Aa=L+"/work-on-the-terms-of-external-concurrency",Ca=L+"/certificate-time-parental-leave",Ia=L+"/arbitrary-request",Ra=L+"/courier",Da=L+"/persona-income-tax-reference",Na=L+"/payment-of-child-birth-allowance",La=L+"/payment-for-child-care",za=oe+"/part-time-employment/",Nm=oe+"/dismissal/:id",Lm=oe+"/work-transfer/:id",zm=oe+"/extra-holiday-coll",Mm=oe+"/holiday-planning/:id",Fm=oe+"/holiday-transfer/:id",Hm=oe+"/holiday-work/:id",Bm=oe+"/work-transfer-change-rate/:id",Um=oe+"/medical-examination/:id",Ma=oe+"/buffer-dismissal",Fa=oe+"/buffer-holiday-planning",Ha=oe+"/buffer-holiday-transfer",Ba=oe+"/buffer-holiday-work",Ua=oe+"/buffer-medical-examination",Wa=oe+"/buffer-work-transfer",V=()=>fe({oldVersionUrl:"/sprav"}),tn=()=>({onboarding:{id:"onboarding",title:"Новому работнику",icon:t.jsx(Y,{}),path:pe,Component:cg,color:"orange",isTemplate:!1,group:"FINANCES_DOCS"},...hr,"download-agreements":{id:"download-agreements",title:"Административная панель",icon:t.jsx(Hs,{}),path:Im,Component:da,color:"blue",isTemplate:!1,group:"GENERAL",isAdmin:!0},"electronic-statements":{id:"electronic-statements",title:"Электронные ведомости",icon:t.jsx(Y,{}),path:wm,Component:()=>(le.useEffect(()=>{window.location.replace(" https://e.mospolytech.ru/old/stats.php?m=items&act=st_list")},[]),null),color:"blue",isTemplate:!1,group:"LEARNING_ACTIVITIES"},"project-activity":{id:"project-activity",title:"Проектная деятельность",icon:t.jsx(Ws,{}),path:cr,Component:()=>(le.useEffect(()=>{window.location.replace(`${A}/?p=proj_main`)},[]),null),color:"orange",isTemplate:!1,group:"LEARNING_ACTIVITIES"},payments:{id:"payments",title:"Оплата общежития",icon:t.jsx(lt,{}),path:ki,Component:$n,color:"green",isTemplate:!1,group:"FINANCES_DOCS",keywords:["оплата"]},"pps-contest":{id:"pps-contest",title:"Конкурс ППС",icon:t.jsx(Y,{}),path:xa,Component:()=>(le.useEffect(()=>{window.location.replace("https://mospolytech.ru/contest-pps/")},[]),null),color:"blue",isTemplate:!1,group:"FINANCES_DOCS"},"kpi-pps":{id:"kpi-pps",title:"Рейтинговая система ППС",icon:t.jsx(Vs,{}),path:Nt,Component:()=>(le.useEffect(()=>{window.location.replace(`${A}/?p=${Nt==null?void 0:Nt.slice(1,Nt.length)}`)},[]),null),color:"pink",isTemplate:!1,group:"LEARNING_ACTIVITIES"},"kpi-admin":{id:"kpi-admin",title:"Экспертиза рейтинго...",icon:t.jsx(_c,{}),path:Lt,Component:()=>(le.useEffect(()=>{window.location.replace(`${A}/?p=${Lt==null?void 0:Lt.slice(1,Lt.length)}`)},[]),null),color:"lightBlue",isTemplate:!1,group:"LEARNING_ACTIVITIES"},"sc-news":{id:"sc-news",title:"Анонсы научных мероприятий",icon:t.jsx(wc,{}),path:os,Component:()=>fe({oldVersionUrl:os}),color:"orange",isTemplate:!1,group:"OTHER",show:!1},orders:{id:"orders",title:"Приказы",icon:t.jsx(C,{}),path:is,Component:()=>fe({oldVersionUrl:is}),color:"blue",isTemplate:!1,group:"OTHER",show:!1},"document-blanks":{id:"document-blanks",title:"Бланки документов",icon:t.jsx(Kt,{}),path:ns,Component:()=>fe({oldVersionUrl:ns}),color:"blue",isTemplate:!1,show:!1,group:"OTHER"},doclist:{id:"doclist",title:"Ознакомление с документами",shortTitle:"Ознакомление с док...",icon:t.jsx(C,{}),path:Pn,Component:dh,color:"blue",isTemplate:!1,group:"FINANCES_DOCS"},calendar:{id:"calendar",title:"График отпусков",icon:t.jsx(kc,{}),path:Am,Component:Ch,color:"purple",isTemplate:!1,group:"FINANCES_DOCS"},"physical-education":{id:"physical-education",title:"Физическая культура",icon:t.jsx(C,{}),color:"lightGreen",path:Rm,show:!I,Component:bh,isTemplate:!1,group:"OTHER"},"physical-education-student":{id:"physical-education-student",title:"Физическая культура",icon:t.jsx(C,{}),color:"pink",path:Dm,Component:vh,isTemplate:!1,group:"OTHER",show:!1},oop:{id:"oop",title:"Образовательные программы",icon:t.jsx(Xt,{}),path:as,Component:()=>fe({oldVersionUrl:as}),color:"blue",isTemplate:!1,group:"OTHER",show:!1},centers:{id:"centers",title:"Многофункциональный центр",icon:t.jsx(Xt,{}),path:rs,Component:()=>fe({oldVersionUrl:rs}),color:"blue",isTemplate:!1,group:"OTHER",show:!1},info:{id:"info",title:"Полезная информация",icon:t.jsx(C,{}),path:Cm,Component:mn,color:"blue",isTemplate:!1,group:"GENERAL"},"pps-vote":{id:"pps-vote",title:"Опрос для проверки уровня цифровой грамотности",icon:t.jsx(Gs,{}),path:ss,Component:()=>fe({oldVersionUrl:ss}),color:"blue",isTemplate:!1,group:"OTHER",show:!1},applications:{id:"applications",title:"Цифровые сервисы",icon:t.jsx(C,{}),path:L,Component:I?V:ph,color:"red",isTemplate:!1,group:"FINANCES_DOCS",keywords:["заявления","справки","заявление","справка"]},"hr-applications":{id:"hr-applications",title:"Кадровые заявления",icon:t.jsx(C,{}),path:oe,Component:I?()=>fe({errorText:"Страница еще находится в разработке.",isRedirectButtonVisible:!1}):Ih,color:"green",isTemplate:!1,group:"FINANCES_DOCS"}}),nn=()=>({...gr,"issuance-of-licenses-page":{id:"issuance-of-licenses-page",title:"Выдача лицензий",path:ba,icon:t.jsx(C,{}),color:"blue",Component:I?V:jh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},dismissal:{id:"dismissal2",title:"Заявление на увольнение",path:Ma,icon:t.jsx(C,{}),color:"blue",Component:I?V:Vo,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к кадровым заявлениям",subPageHeaderTitle:"",fallbackPrevPage:oe},"holiday-work":{id:"part-time-employment",title:"Заявление о привлечении к работе в выходной день",path:Ba,icon:t.jsx(C,{}),color:"blue",Component:I?V:bx,isTemplate:!1,group:"OTHER"},"medical-examination":{id:"part-time-employment",title:"Заявление о диспансеризации",path:Ua,icon:t.jsx(C,{}),color:"blue",Component:I?V:pf,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к кадровым заявлениям",subPageHeaderTitle:"",fallbackPrevPage:oe},"holiday-planning":{id:"holiday-postponed",title:"Заявление о предоставлении отпуска",path:Fa,icon:t.jsx(C,{}),color:"blue",Component:I?V:Cx,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к кадровым заявлениям",subPageHeaderTitle:"",fallbackPrevPage:oe},"holiday-transfer":{id:"holiday-transfer",title:"Заявление о переносе отпуска",path:Ha,icon:t.jsx(C,{}),color:"blue",Component:I?V:Yx,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к кадровым заявлениям",subPageHeaderTitle:"",fallbackPrevPage:oe},"work-transfer":{id:"dismissal",title:"Заявление на перевод",path:Wa,icon:t.jsx(C,{}),color:"blue",Component:I?V:Sf,isTemplate:!1,group:"OTHER"},"part-time-employment":{id:"part-time-employment",title:"Заявление на трудоустройство по совместительству",path:za,icon:t.jsx(C,{}),color:"blue",Component:I?V:Rh,isTemplate:!1,group:"OTHER"},"holiday-work-form":{id:"part-time-employment",title:"Заявление о привлечении к работе в выходной день",path:Hm,icon:t.jsx(C,{}),color:"blue",Component:I?V:Lh,isTemplate:!1,group:"OTHER"},"medical-examination-form":{id:"part-time-employment",title:"Заявление о диспансеризации",path:Um,icon:t.jsx(C,{}),color:"blue",Component:I?V:zh,isTemplate:!1,group:"OTHER"},"holiday-planning-form":{id:"holiday-postponed",title:"Заявление о предоставлении отпуска",path:Mm,icon:t.jsx(C,{}),color:"blue",Component:I?V:Mh,isTemplate:!1,group:"OTHER"},"holiday-transfer-form":{id:"holiday-transfer",title:"Заявление о переносе отпуска",path:Fm,icon:t.jsx(C,{}),color:"blue",Component:I?V:Fh,isTemplate:!1,group:"OTHER"},"work-transfer-form":{id:"work-transfer-form",title:"Заявление на перевод",path:Lm,icon:t.jsx(C,{}),color:"blue",Component:I?V:Hh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к кадровым заявлениям",subPageHeaderTitle:"",fallbackPrevPage:oe},"work-transfer-change-rate-form":{id:"work-transfer-form",title:"Заявление на перевод",path:Bm,icon:t.jsx(C,{}),color:"blue",Component:I?V:Bh,isTemplate:!1,group:"OTHER"},"extra-holiday-coll":{id:"dismissal",title:"Заявление о предоставлении дополнительного отпуска по коллективному договору",path:zm,icon:t.jsx(C,{}),color:"blue",Component:I?V:Nh,isTemplate:!1,group:"OTHER"},dismissal_form:{id:"dismissal",title:"Заявление на увольнение",path:Nm,icon:t.jsx(C,{}),color:"blue",Component:I?V:Dh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к кадровым заявлениям",subPageHeaderTitle:"",fallbackPrevPage:oe},"getting-computer-equipment":{id:"getting-computer-equipment",title:"Получение нового компьютерного оборудования",icon:t.jsx(C,{}),color:"blue",path:va,Component:I?V:yh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"connecting-computer":{id:"connecting-computer",title:"Подключение компьютера, МФУ, телефона, WiFi",icon:t.jsx(C,{}),color:"blue",path:ya,Component:I?V:xh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"printer-maintenance":{id:"printer-maintenance",title:"Обслуживание принтеров, МФУ",icon:t.jsx(C,{}),color:"blue",path:ja,Component:I?V:Eh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"question-sed":{id:"question-sed",title:"Вопрос по СЭД Directum и 1С",icon:t.jsx(C,{}),color:"blue",path:_a,Component:I?V:Ph,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"question-personal-account":{id:"question-personal-account",title:"Вопрос по Личному кабинету",icon:t.jsx(C,{}),color:"blue",path:wa,Component:I?V:$h,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"other-it-services":{id:"other-it-services",title:"Прочее ИТ-обслуживание",icon:t.jsx(C,{}),color:"blue",path:ka,Component:I?V:wh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"certificate-form-place-of-work":{id:"certificate-form-place-of-work",title:"Справка с места работы",icon:t.jsx(C,{}),color:"blue",path:Ta,Component:I?V:ah,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"visa-certificate":{id:"visa-certificate",title:"Справка на визу",icon:t.jsx(C,{}),color:"blue",path:Sa,Component:I?V:Oh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"certificate-of-work-experience":{id:"certificate-of-work-experience",title:"Справка о стаже работы",icon:t.jsx(C,{}),color:"blue",path:Ea,Component:I?V:hh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"number-of-unused-vacation-days":{id:"number-of-unused-vacation-days",title:"Справка о количестве неиспользованных дней отпуска",icon:t.jsx(C,{}),color:"blue",path:$a,Component:I?V:_h,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"copy-of-employment-record":{id:"copy-of-employment-record",title:"Копия трудовой книжки",icon:t.jsx(C,{}),color:"blue",path:Pa,Component:I?V:fh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"copies-of-documents-from-personal-file":{id:"copies-of-documents-from-personal-file",title:"Копии документов из личного дела",icon:t.jsx(C,{}),color:"blue",path:Oa,Component:I?V:rh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"work-on-terms-of-external-concurrency":{id:"work-on-terms-of-external-concurrency",title:"Справка о работе на условиях внешнего совместительства для внесения стажа в трудовую книжку",icon:t.jsx(C,{}),color:"blue",path:Aa,Component:I?V:Ah,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"certificate-time-parental-leave":{id:"certificate-time-parental-leave",title:"Справка об отпуске по уходу за ребенком до 1,5 и 3 лет",icon:t.jsx(C,{}),color:"blue",path:Ca,Component:I?V:gh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"arbitrary-request":{id:"arbitrary-request",title:"Произвольный запрос",icon:t.jsx(C,{}),color:"blue",path:Ia,Component:I?V:uh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},courier:{id:"courier",title:"Курьер",icon:t.jsx(C,{}),color:"blue",path:Ra,Component:I?V:mh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"personal-income-tax-reference":{id:"personal-income-tax-reference",title:"Справка по форме 2-НДФЛ",icon:t.jsx(C,{}),color:"blue",path:Da,Component:I?V:Sh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"payment-of-child-birth-allowance":{id:"payment-of-child-birth-allowance",title:"Справка о выплате (не выплате) единовременного пособия на рождение ребенка",icon:t.jsx(C,{}),color:"blue",path:Na,Component:I?V:Th,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"payment-for-child-care":{id:"payment-for-child-care",title:"Справка о ежемесячных выплатах сотрудника, находящегося в отпуске по уходу за ребенком (декрет)",icon:t.jsx(C,{}),color:"blue",path:La,Component:I?V:kh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"contact-info-actualization":{id:"contact-info-actualization",title:"Актуализация контактных данных",icon:t.jsx(C,{}),color:"blue",path:fa,Component:lh,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"data-verification":{id:"data-verification",title:"Анкета для сверки данных",icon:t.jsx(C,{}),color:"blue",path:ma,Component:ch,isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:L},"social-environment":{id:"Социальная среда",title:"Социальная среда",color:"pink",Component:()=>(window.location.href="https://profkommospolytech.ru/",t.jsx(Me,{to:pe})),icon:t.jsx(Kt,{}),isTemplate:!1,path:Om,backButtonText:"Новому работнику",isSubPage:!0,fallbackPrevPage:pe},"psychological-help":{id:"Психологическая помощь",title:"Психологическая помощь",color:"green",Component:()=>(window.location.href="https://mospolytech.ru/studencheskaya-zhizn/medical-help/slujba-psihologicheskoy-pomoschi/",t.jsx(Me,{to:pe})),icon:t.jsx(fc,{}),isTemplate:!1,path:Pm,backButtonText:"Новому работнику",isSubPage:!0,fallbackPrevPage:pe},"health-care":{id:"Медицинская помощь",title:"Медицинская помощь",color:"red",Component:()=>(window.location.href="https://mospolytech.ru/studencheskaya-zhizn/medical-help/medicinskaya-slujba/",t.jsx(Me,{to:pe})),icon:t.jsx(mc,{}),isTemplate:!1,path:$m,backButtonText:"Новому работнику",isSubPage:!0,fallbackPrevPage:pe},"wifi-at-the-university":{id:"WI-FI  в университете",title:"WI-FI  в университете",color:"purple",Component:()=>(window.location.href="https://e.mospolytech.ru/old/storage/files/Instruktsiya_dostupa_k_internetu_v_auditoriyah.pdf",t.jsx(Me,{to:pe})),icon:t.jsx(bc,{}),isTemplate:!1,path:Em,backButtonText:"Новому работнику",isSubPage:!0,fallbackPrevPage:pe},brandbook:{id:"Брендбук",title:"Брендбук",color:"orange",Component:()=>(window.location.href="https://mospolytech.ru/ob-universitete/brandbook/",t.jsx(Me,{to:pe})),icon:t.jsx(vc,{}),isTemplate:!1,path:Sm,backButtonText:"Новому работнику",isSubPage:!0,fallbackPrevPage:pe},"addresses-and-contacts":{id:"addresses-and-contacts",title:"Адреса и контакты",icon:t.jsx(yc,{}),path:Tm,Component:()=>(window.location.href="https://mospolytech.ru/ob-universitete/adresa-i-kontakty/",t.jsx(Me,{to:pe})),color:"darkBlue",isTemplate:!1,group:"FINANCES_DOCS",backButtonText:"Новому работнику",isSubPage:!0,fallbackPrevPage:pe},"structure-of-the-university":{id:"structure-of-the-university",title:"Структура университета",icon:t.jsx(jc,{}),path:km,Component:()=>(window.location.href="https://mospolytech.ru/ob-universitete/rukovodstvo-i-struktura/strukturnye-podrazdeleniya/",t.jsx(Me,{to:pe})),color:"lightGreen",isTemplate:!1,group:"FINANCES_DOCS",backButtonText:"Новому работнику",isSubPage:!0,fallbackPrevPage:pe}}),Va=()=>{var r,d;const e=ii(),{data:i}=ce.useUser(),n=(r=i.user)!=null&&r.subdivisions?{...tn(),...nn()}:{...vt(),...rn(i.user)},[{exactCurrentPage:s,currentPage:o},a]=l.useState({currentPage:Object.values(n).find(c=>e.location.pathname.includes(c.path))??n[0],exactCurrentPage:Object.values(n).find(c=>e.location.pathname.includes(c.path))??null});return l.useEffect(()=>{a({currentPage:Object.values(n).find(c=>e.location.pathname.includes(c.path))??n[0],exactCurrentPage:Object.values(n).find(c=>c.path.includes(e.location.pathname))??null})},[(d=i.user)==null?void 0:d.subdivisions]),l.useEffect(()=>e.listen(c=>{a({currentPage:Object.values(n).find(p=>c.pathname.includes(p.path))??n[0],exactCurrentPage:Object.values(n).find(p=>p.path.includes(c.pathname))??null})}),[e,n]),{currentPage:o,exactCurrentPage:s}},Ga=e=>(e==null?void 0:e.pageSize)==="big"?"1000px":(e==null?void 0:e.pageSize)==="small"?"700px":"963px",Wm=u(Ve)`
    position: relative;
...
`,Km=({title:e,children:i,bottomMargin:n,forceState:s=!1})=>{const[o,a]=l.useState(s);l.useEffect(()=>{a(s)},[s]);const r=()=>a(d=>!d);return t.jsxs(qm,{isOpen:o,bottomMargin:n,onClick:r,children:[e&&t.jsx(Jm,{children:e}),t.jsx(Xm,{isOpen:o,children:i})]})},Ya=T(),qa=T(),Qm=ee(!1).on(qa,()=>!0).on(Ya,()=>!1),ls={close:Ya,open:qa},Zm={$isModalOpen:Qm},On=l.createContext({isOpen:!1,component:void 0,back:()=>{},close:()=>{},open:()=>{},title:void 0,canBack:!1}),e0=({children:e})=>{const[i,n]=l.useState(!1),[s,o]=l.useState([]),[a,r]=l.useState([]),d=Tc(Zm.$isModalOpen),c=a.length>1,p=l.useCallback(()=>{c&&(a.pop(),s.pop(),r([...a]),o([...s]))},[a,r]),h=l.useCallback((b,v)=>{b&&(i?(r(()=>[...a,b]),o(()=>[...s,v??""])):(r(()=>[b]),o(v?[v]:[])),n(()=>!0),ls.open())},[r,n,a,i]),x=l.useCallback(()=>{n(()=>!1),ls.close()},[r,n]),g=l.useMemo(()=>a[a.length-1],[a]),m=l.useMemo(()=>s[s.length-1],[s]),f=l.useCallback(b=>{b&&r([...a,b])},[]);return l.useEffect(()=>{d!==i&&n(d)},[d]),t.jsx(On.Provider,{value:{back:p,open:h,close:x,isOpen:i,canBack:c,component:g,title:m,setComponent:f},children:e})},K=()=>{const{open:e,isOpen:i,...n}=l.useContext(On);return{open:e,isOpen:i,...n}},t0="2.2.0",Ja=()=>t.jsx(q,{icon:null,type:"info",title:t0,width:"38px",fontSize:"0.65rem",padding:"7px 0px",align:"center"}),$e=({color:e,children:i})=>t.jsx(Ce,{color:e,children:i}),i0=()=>({info:t.jsx($e,{color:"grey",children:t.jsx(Ie,{})}),message:t.jsx($e,{color:"red",children:t.jsx(pn,{})}),alert:t.jsx($e,{color:"purple",children:t.jsx(un,{})}),"payment-dorm":t.jsx($e,{color:"green",children:t.jsx(lt,{})}),"payment-ed":t.jsx($e,{color:"green",children:t.jsx(lt,{})}),"digital-services":t.jsx($e,{color:"red",children:t.jsx(C,{})}),"doc-for-review":t.jsx($e,{color:"blue",children:t.jsx(C,{})}),"hr-applications":t.jsx($e,{color:"green",children:t.jsx(C,{})}),"kpi-pps":t.jsx($e,{color:"pink",children:t.jsx(Vs,{})}),schedule:t.jsx($e,{color:"pink",children:t.jsx(ni,{})}),"version-update":t.jsx(Ja,{}),"electronic-interaction":t.jsx($e,{color:"blue",children:t.jsx(Ys,{})})}),n0=u(Z)`
    width: 100%;
    display: flex;
    align-items: center;
    padding: 4px;
...
`,s0=u.div`
    font-size: ${({fontSize:e})=>e};
    font-weight: 500;
`,o0={small:"0.8rem",middle:"0.83rem",big:"0.86rem"},a0={small:"0.75rem",middle:"0.78rem",big:"0.80rem"},r0={small:"0px",middle:"1px",big:"3px"},Xa=({id:e,title:i,text:n,time:s,date:o,onClick:a,type:r,pageId:d,goTo:c,onClose:p,bottomMargin:h,closeAnimation:x=!0,loadingRemove:g=!1,canClose:m=!0,fullText:f=!0,maxLetters:b=200,size:v="middle"})=>{const P=ie(o,"short"),{close:_}=K(),[S,k]=l.useState(!1),X=N=>{N.stopPropagation(),N.preventDefault(),x?(k(!0),setTimeout(()=>{p==null||p()},300)):p==null||p()},O=()=>{a==null||a(),m&&ht.clearById({id:e,pageId:d}),_()};return t.jsx(Km,{forceState:!S,bottomMargin:h,children:t.jsxs(n0,{to:c??"",onClick:O,children:[t.jsx("span",{className:"left-icon",children:i0()[r]}),t.jsxs("div",{className:"content",children:[t.jsx(te,{fontSize:"0.7rem",children:t.jsx(Ot,{words:[P??"",s??""]})}),t.jsxs($,{d:"column",gap:r0[v],ai:"flex-start",children:[t.jsx(s0,{fontSize:o0[v],children:f?i:Qt(i,b)}),t.jsx(te,{fontSize:a0[v],children:f?n:Qt(n,b)})]})]}),p&&t.jsx(y,{isActive:!(g&&S),icon:t.jsx(We,{}),background:"transparent",onClick:X})]})})},Ka=({notifications:e,loadingRemove:i})=>{if(!e||e.length===0)return null;const n=(o,a,r)=>()=>{ht.clearById({id:o,pageId:a}),r==null||r()},s=o=>o.canClose!==!1?n(o.id,o.pageId,o.onClose):void 0;return t.jsx($,{d:"column",children:e.map((o,a)=>l.createElement(Xa,{size:"big",loadingRemove:i,bottomMargin:a!==e.length-1,...o,key:o.id,onClose:s(o)}))})},l0=u.div`
    display: flex;
    flex-direction: column;
    gap: 8px;
    width: 100%;
...
`,cs=e=>{var P;const{color:i,shadow:n,notifications:s,maxWordLength:o,title:a,isNew:r,icon:d,mode:c,id:p,background:h,orientation:x="vertical"}=e,g=x==="vertical",{settings:m}=Et.useSettings(),f=!!((P=m["settings-home-page"].property.pages)!=null&&P.find(_=>_===p)),b=11,v=l.useMemo(()=>(_,S)=>{const k=_.split(" ")[0];return k.length>S&&k.length!==S+1&&g?`${_.substr(0,S)}-${_.substr(S,_.length)}`:_},[]);return t.jsxs(vr,{padding:"0",width:"100%",maxWidth:"100%",height:g?"135px":"60px",isVertical:g,justifyContent:"center",shadow:n,color:i.length?i:"blue",hasNotifications:!!s,background:h,children:[t.jsxs("div",{className:"outside",children:[t.jsx(Ce,{badge:s==null?void 0:s.toString(),color:i.length?i:"blue",children:d??t.jsx(Lc,{})}),t.jsx("b",{children:Qt(v(a,b),o)}),!!s&&t.jsxs("span",{className:"notifications-title",children:[s," ",br(s,{one:"уведомление",zero:"уведомлений",twoToFour:"уведомления",fiveToNine:"уведомлений"})]})]}),c==="use"&&t.jsx(mr,{route:e}),c==="add"?f?t.jsx(y,{icon:t.jsx(We,{}),width:"80px",align:"center",textColor:"var(--red)",background:"var(--schedule)",onClick:()=>fr(p,m)}):t.jsx(y,{icon:t.jsx(Jt,{}),width:"80px",textColor:"var(--green)",align:"center",background:"var(--schedule)",onClick:()=>xr(p,m)}):null,r&&t.jsx("span",{className:"new",children:"New"})]})},P0=u(vr)`
    box-shadow: none;
    color: var(--blue);
    background: transparent;
`,__=()=>t.jsx(Z,{to:Ut,onClick:()=>{De.changeOpen({isOpen:!1,currentPage:Ut.slice(1,Ut.length)})},children:t.jsx(P0,{padding:"0",width:"125px",height:"135px",isVertical:!0,justifyContent:"center",color:"blue",hasNotifications:!1,children:t.jsxs("div",{className:"outside",children:[t.jsx(Ce,{color:"blue",children:t.jsx(zc,{})}),t.jsx("b",{children:"Все разделы"})]})})}),O0=u(Z)`
...
`,C0=e=>{const{close:i}=K(),{path:n,orientation:s="vertical",mode:o="use"}=e,a=s==="vertical"?17:50,r=1;if(o==="add")return t.jsx(A0,{width:s==="vertical"?r:"100%",children:t.jsx(cs,{...e,mode:o,maxWordLength:a})});const d=()=>{i(),De.changeOpen({isOpen:!1,currentPage:n.slice(1,n.length)})};return t.jsx(O0,{to:n,onClick:d,width:s==="vertical"?r:"100%",children:t.jsx(cs,{...e,maxWordLength:a,mode:o})})},I0=u.div`
    width: 100%;
    display: flex;
    flex-direction: column;
    gap: 5px;
`,R0=({pages:e,showNotFound:i=!0})=>!e||!i&&Object.keys(e).length===0?null:!Object.keys(e).length&&i?t.jsx(ge,{text:"Ничего не было найдено"}):t.jsx(I0,{children:Object.values(e).map(n=>(n==null?void 0:n.show)!==!1&&l.createElement(C0,{...n,orientation:"horizontal",shadow:!1,key:n.id}))}),D0=(e,i)=>Object.values(i).reduce((n,s)=>{var o;return(me(s.title).includes(me(e))||(o=s==null?void 0:s.keywords)!=null&&o.find(a=>me(a).includes(me(e))))&&(n[s.id]=s),n},{}),N0=u.div`
    display: flex;
    flex-direction: column;
    height: 300px;
...
`,L0=u(Z)`
    width: 100%;
`,z0=({division:e})=>{const{close:i}=K();return t.jsxs(N0,{children:[t.jsxs($,{d:"column",gap:"12px",jc:"center",h:"100%",children:[t.jsx(Ce,{size:120,color:"purple",children:t.jsx(vi,{})}),t.jsx(te,{fontSize:"1.2rem",align:"center",children:e})]}),t.jsx(L0,{to:`${nr}/${e}`,onClick:i,children:t.jsx(y,{icon:t.jsx(Xs,{}),width:"100%",text:"Список"})})]})},M0=u.div`
    width: 100%;
    color: var(--text);
    padding: 0px 16px;
    background: var(--theme-mild-xxl);
...
`,ds=u(Z)`
    width: 100%;
`,U0=({group:e})=>{const{close:i}=K();return t.jsxs(B0,{children:[t.jsxs($,{d:"column",gap:"12px",jc:"center",h:"100%",children:[t.jsx(Ce,{size:120,color:"lightBlue",children:t.jsx(Ks,{})}),t.jsx(te,{fontSize:"1.2rem",children:e})]}),t.jsxs($,{gap:"8px",onClick:i,children:[t.jsx(ds,{to:`${It}/${e}`,children:t.jsx(y,{icon:t.jsx(ni,{}),width:"100%",text:"Расписание"})}),t.jsx(ds,{to:`${ir}/${e}`,children:t.jsx(y,{icon:t.jsx(Xs,{}),width:"100%",text:"Список"})})]})]})},W0=u.div`
    width: 100%;
    color: var(--text);
    padding: 0px 16px;
    background: var(--theme-mild-xxl);
...
`,X0=({blocks:e,isStaff:i})=>e?t.jsx(t.Fragment,{children:e.map(({title:n,links:s},o)=>t.jsxs(J0,{children:[t.jsx(W,{size:4,align:"left",bottomGap:"16px",children:n}),t.jsx(be,{gap:16,children:s.map(({title:a,href:r,visible:d},c)=>d==="staff"&&!i||d==="student"&&i?null:t.jsx("a",{href:r,target:"_blank",rel:"noreferrer",children:a},a+c))})]},n+o))}):null,Ti=e=>Array.isArray(e)?e==null?void 0:e.length:Object.keys(e??{}).length,ps=({people:e,type:i})=>!e||e.length===0?null:t.jsx($,{d:"column",children:e.map(n=>l.createElement(Pr,{name:n.fio,type:i,...n,key:n.id}))}),K0=()=>{const{allRoutes:e}=Be.useMenu(),{notifications:i,removeNotificationLoading:n}=ze.useLkNotifications(),{data:{user:s}}=ce.useUser(),o=(s==null?void 0:s.user_status)==="staff",a=l.useMemo(()=>Y0.flatMap(({visible:O,content:N})=>O==="staff"&&o||O==="student"&&!o||O==="all"?N:[]),[o]),[r,d]=l.useState(null),[c,p]=l.useState(null),[h,x]=l.useState(null),[g,m]=l.useState(null),[f,b]=l.useState(null),[v,P]=l.useState(null),[_,S]=l.useState(null),k=[{title:"Разделы",content:t.jsx(R0,{pages:f,showNotFound:!1}),clear:()=>{b(null)},search:O=>{if(e){const N=D0(O,e);b(N)}},data:f},{title:"Студенты",content:t.jsx(ps,{people:g,type:"stud"}),data:g,clear:()=>{m(null)},search:async O=>{const{data:N}=await Vd(O,"",1,20);m(N.items)}},{title:"Сотрудники",content:t.jsx(ps,{people:h,type:"staff"}),data:h,clear:()=>{x(null)},search:async O=>{const{data:N}=await Hd(O,"",1,20);x(N.items)}},{title:"Группы",content:t.jsx(G0,{groups:r}),data:r,clear:()=>{d(null)},search:async O=>{const{data:N}=await Gd(O);d(N.items)}},{title:"Подразделения",content:t.jsx(H0,{divisions:c}),data:c,clear:()=>{p(null)},search:async O=>{const{data:N}=await Bd(O);p(N.items)}},{title:"Уведомления",content:t.jsx(Ka,{notifications:v,loadingRemove:n}),clear:()=>{P(null)},search:O=>{const N=i.filter(se=>me(se.title).includes(O));P(N)},data:v},{title:"Полезная информация",content:t.jsx(X0,{blocks:_,isStaff:o}),clear:()=>{S(null)},search:O=>{const N=q0(O,a);S(N)},data:_}];return[(()=>{const{content:O,clear:N,data:se}=k.reduce((R,ae)=>(Ti(ae.data)&&(R.data.push(ae.data),R.content.push(t.jsxs(t.Fragment,{children:[t.jsx(W,{size:4,align:"left",children:ae.title}),ae.content,t.jsx(he,{})]}))),R.clear.push(ae.clear),R),{content:[],clear:[],data:[]});return{title:"Все",content:O,clear:()=>N.map(R=>R()),search:async R=>{R.length<=8&&/\d|[-]/g.test(R)?await k[3].search(R):(k[0].search(R),k[5].search(R),k[6].search(R),Ti(k[0].data)===0&&(await k[1].search(R),await k[2].search(R),await k[4].search(R)))},data:se}})(),...k]},Q0=()=>JSON.parse(localStorage.getItem(G.SearchHistory)??"[]"),Z0=()=>{const e=K0(),[i,n]=l.useState(0),[s,o]=l.useState(""),a=l.useMemo(()=>Q0(),[]),r=async g=>{e[i].clear();const m=Po(g)?$o(g):g;await e[i].search(m),m.length>0&&!a.includes(m)&&(a.unshift(m),a.length>8&&a.pop(),localStorage.setItem(G.SearchHistory,JSON.stringify(a)))},[d,c,p]=Co({onDebounce:r,delay:400,defaultValue:"",deps:[i.toString()],triggerDelay:200,triggerOn:g=>(o(g),g.length>0&&(s!==g||!e[i].data))}),h=!p&&!d.length,x=!!d.length&&!p&&!!Ti(e[i].data);return{showMessage:h,showSearchResult:x,searchValue:d,setSearchValue:c,currentPage:i,setCurrentPage:n,config:e,loading:p,searchHistory:a}},eb=(e,i,n)=>i.length===0?n.map(s=>({id:s,title:s,value:s,icon:t.jsx(Ln,{})})):e?n.filter(s=>me(s).includes(me(i))).map(s=>({id:s,title:s,value:s,icon:t.jsx(Ln,{})})):[],tb=()=>t.jsxs($,{gap:"8px",ai:"flex-start",children:[t.jsx(U,{shape:"circle",size:{width:"40px",height:"40px"},margin:"0"}),t.jsxs($,{gap:"6px",d:"column",ai:"flex-start",jc:"center",h:"100%",children:[t.jsx(U,{shape:"rect",size:{width:"300px",height:"13px"},margin:"0"}),t.jsx(U,{shape:"rect",size:{width:"220px",height:"10px"},margin:"0"})]})]}),ib=u.div`
    @media (max-width: 1000px) {
        height: 600px;
    }
...
`,nb=()=>{const{showMessage:e,showSearchResult:i,searchValue:n,setSearchValue:s,currentPage:o,setCurrentPage:a,loading:r,config:d,searchHistory:c}=Z0(),p=eb(r,n,c),{isOpen:h}=K();return t.jsx(ib,{children:t.jsxs($,{d:"column",gap:"8px",h:"100%",children:[t.jsx(Ao,{value:n,setValue:s,loading:r,focusOn:h,hints:p}),t.jsx(fn,{pages:d.map(({title:x})=>({title:x})),currentPage:o,setCurrentPage:a}),t.jsx(Oo,{value:n,setValue:s}),e&&t.jsx($,{h:"100%",children:t.jsx(ge,{size:"60px",text:'Введите что-нибудь. Например, "Цифровые сервисы"',image:t.jsx(rt,{})})}),!r&&n.length!==0&&!e&&!Ti(d[o].data)&&t.jsx($,{h:"100%",children:t.jsx(ge,{size:"60px",text:"Ничего не было найдено",image:t.jsx(Ds,{})})}),r&&Array(10).fill(0).map((x,g)=>t.jsx(tb,{},g)),i&&t.jsx(t.Fragment,{children:d[o].content})]})})},sb=u(Ve)`
    cursor: pointer;
    &:hover {
...
`,rb=()=>{const e=mu();return{Windows:[{title:"CTRL",key:"Control"},{key:"k"}],Linux:[{title:"CTRL",key:"Control"},{key:"k"}],UNIX:[{title:"CTRL",key:"Control"},{key:"k"}],MacOS:[{title:"CMD",key:"Meta",icon:t.jsx(Mc,{})},{key:"k"}]}[e]},yr=({size:e="large"})=>{const i=rb(),{open:n}=K(),s=e==="large"?"16px":"8px",o=e==="large"?"100%":"92%",a=()=>n(t.jsx(nb,{}),"Глобальный поиск");return Eo(i.map(({key:r})=>r),a),e==="icon"?t.jsx(y,{direction:"vertical",icon:t.jsx(rt,{}),width:"40px",minWidth:"40px",background:"transparent",onClick:a}):t.jsxs(sb,{maxWidth:"750px",width:o,height:"fit-content",padding:s,justifyContent:"space-between",onClick:a,children:[t.jsx(te,{align:"left",fontSize:"0.9rem",children:t.jsxs($,{gap:"8px",children:[t.jsx(rt,{}),"Поиск"]})}),t.jsx(ab,{w:"fit-content",gap:"4px",children:i.map(r=>t.jsx(ob,{children:(r==null?void 0:r.icon)??(r.title??r.key).toUpperCase()},r.key))})]})},sn=e=>e.split(" ").map(i=>i[0]),Oe=(e,i)=>{const n=sn(e),s=w[od[n[0]]];return s==null?void 0:s[i??"main"]},lb=u.div`
...
`;function di({selected:e,name:i,avatar:n,width:s,height:o,marginRight:a,notifications:r,checked:d,boxShadow:c,border:p,icon:h,avatarModal:x,onClick:g,borderRadius:m,background:f}){const[b,v]=l.useState(!0),P=sn(i)[0]+(sn(i)[1]??""),{open:_}=K(),S=k=>{x?_(t.jsx(di,{name:i,width:"400px",height:"400px",marginRight:"0",avatar:n})):g==null||g(k)};return t.jsxs(lb,{selected:e,width:s,height:o,marginRight:a,background:f??Oe(i),boxShadow:c,border:p,onClick:S,borderRadius:m,children:[n&&b?t.jsx(cb,{loading:"lazy",round:!0,onLoadedData:()=>v(!0),onError:()=>v(!1),src:n}):t.jsx("div",{className:"name",children:P}),h&&t.jsx("span",{className:"icon",children:h}),t.jsx(Qe,{invisibleOnFalse:!0,checked:d??!1,visible:d!==void 0,setChecked:()=>null}),t.jsx(dt,{left:"80%",top:"90%",outline:"4px solid var(--schedule)",visible:!!r,children:r})]})}const db=u.div`
    position: relative;
    min-width: 40px;
    height: 40px;
    display: flex;
...
`,gb=({title:e,state:i,action:n,icon:s,disabled:o})=>{const a=()=>{n(!i)};return t.jsxs(hb,{disabled:o,children:[s&&t.jsx("div",{className:"icon",children:s}),t.jsxs("label",{children:[t.jsx("b",{children:e}),t.jsx(Cu,{id:e,isToggled:i,setIsToggled:a},e)]})]},e)},xb=u.div`
    width: 100%;
    h2 {
        margin-top: 10px;
    }
`,fb=({title:e,toggles:i,setToggles:n,disabled:s})=>{const o=l.useCallback((a,r)=>{i[a].state=!i[a].state,n([...i]),r&&(r==null||r(i[a].state))},[i,n]);return t.jsxs(xb,{children:[!!e.length&&t.jsx("h2",{children:e}),i.map(({title:a,state:r,action:d},c)=>t.jsx(gb,{disabled:s,title:a,state:r,action:()=>o(c,d)},a))]})},_r=({type:e,onClick:i})=>{const{theme:n,switchTheme:s}=Ci(),{settings:o}=Et.useSettings(),a=o==null?void 0:o["settings-appearance"].property,[r,d]=l.useState(n==="light"),c=r?t.jsx(Fc,{}):t.jsx(Hc,{}),h=`Тема: ${r?"Светлая":"Темная"}`,[x,g]=l.useState([{title:"Темная тема",state:n!=="light",action:f=>s(f)}]);l.useEffect(()=>{g([{title:"Темная тема",state:n!=="light",action:f=>s(f)}])},[n]),l.useEffect(()=>{d(n==="light")},[n]);const m=()=>{s(r),d(f=>!f),i==null||i()};return e==="toggle"?t.jsx(fb,{disabled:!!(a!=null&&a.scheduledLightTheme),title:"",toggles:x,setToggles:g}):e==="h-button"?t.jsx(y,{notActiveClickMessage:"У вас включена тема по расписанию. Если хотите управлять темой вручную, перейдите в настройки -> внешний вид",isActive:!a.scheduledLightTheme,text:h,background:"var(--schedule)",icon:c,width:"100%",align:"left",onClick:m}):t.jsx(y,{notActiveClickMessage:"У вас включена тема по расписанию. Если хотите управлять темой вручную, перейдите в настройки -> внешний вид",isActive:!a.scheduledLightTheme,padding:"0",background:w.white.transparent2,icon:t.jsx(ub,{width:"30px",background:w.green.main,children:c}),onClick:m,text:h,width:"calc(50% - 5px)",height:"73px",direction:"vertical",shrinkTextInMobile:!0})},mb=u.div`
    position: relative;
`,wr=()=>{const{open:e}=K(),{notifications:i}=ze.useLkNotifications(),n=()=>Ae.close(),s=()=>{Fe.evokeConfirm({message:"Вы точно хотите выйти из аккаунта?",onConfirm:Zt.logout}),n()},o=()=>{Ae.close(),e(t.jsx(Or,{}),"Что нового")},a=()=>{e(t.jsx(jr,{}),"Уведомления"),Ae.close()};return t.jsxs(t.Fragment,{children:[t.jsx(Hv,{padding:"8px",size:"small"}),t.jsx(he,{}),t.jsx(_r,{type:"h-button"}),t.jsx(he,{}),t.jsxs(mb,{children:[t.jsx(y,{onClick:a,icon:t.jsx(gn,{}),text:"Уведомления",width:"100%",background:"var(--schedule)",align:"left"}),t.jsx(dt,{visible:i.length>0,top:"50%",right:"0px",pulsing:!0,shadow:!0,children:i.length})]}),t.jsx(Z,{to:ue,children:t.jsx(y,{text:"Настройки",background:"var(--schedule)",icon:t.jsx(hn,{}),width:"100%",align:"left",onClick:n})}),t.jsx("a",{href:`${A}/index.php`,children:t.jsx(y,{text:"Старый дизайн",icon:t.jsx(Ms,{}),width:"100%",background:"var(--schedule)",align:"left"})}),t.jsx(he,{}),t.jsx(y,{align:"left",icon:t.jsx(Bc,{}),onClick:s,text:"Выйти",width:"100%",background:"var(--schedule)"}),t.jsx(he,{}),t.jsx(y,{align:"left",icon:t.jsx(Ja,{}),onClick:o,text:"Что нового",width:"100%",background:"var(--schedule)"})]})},bb=u.div`
    padding: 4px;
    border-radius: var(--brLight);
    display: flex;
    align-items: center;
...
`,Db=e=>{const{path:i,icon:n,title:s,isCurrent:o,isAdmin:a,color:r,notifications:d}=e;return t.jsxs(Ab,{to:i,className:"leftside-bar-item",color:r,isCurrent:o,onClick:()=>{De.changeOpen({isOpen:!1,currentPage:i.slice(1,i.length)})},title:s,children:[t.jsx(dt,{className:"notification",top:"50%",visible:a,right:"-20px",color:"pink",children:"A"}),t.jsx(dt,{className:"notification",top:"50%",visible:!!d,right:a?"0px":"-20px",color:"red",children:d}),n,t.jsx("span",{className:"title",children:s}),t.jsx(mr,{route:e})]})},kr=le.memo(Db),Nb=()=>{const{isOpen:e}=Be.useMenu();return t.jsx(t.Fragment,{children:t.jsx(y,{icon:t.jsx(We,{}),onClick:()=>De.changeOpen({isOpen:!e}),text:"Закрыть меню",width:"100%"})})},Lb=({icon:e,title:i})=>{const n=()=>{const s=e;return t.jsx(s,{})};return t.jsxs(Rb,{className:"leftside-bar-item",children:[n(),t.jsx("strong",{children:i})]})};le.memo(Lb);u.section`
    width: 100%;
    max-width: 270px;
    color: #383634;
...
`;const zb=()=>{const{leftsideBarRoutes:e,currentPage:i}=Be.useMenu(),n=l.useMemo(()=>{const s=window.location.hash.split("/");return s.length>2&&s[1]?s[1]:i==null?void 0:i.id},[i]);return e?t.jsx(Ib,{children:Object.values(e).filter(s=>s!==void 0).map(s=>l.createElement(kr,{...s,key:s==null?void 0:s.id,isCurrent:n===(s==null?void 0:s.id)}))}):t.jsxs($,{d:"column",children:[t.jsxs($,{gap:"8px",children:[t.jsx(U,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(U,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs($,{gap:"8px",children:[t.jsx(U,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(U,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs($,{gap:"8px",children:[t.jsx(U,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(U,{shape:"rect",size:{width:"160px",height:"18px"}})]}),t.jsxs($,{gap:"8px",children:[t.jsx(U,{shape:"rect",size:{width:"30px",height:"30px"}}),t.jsx(U,{shape:"rect",size:{width:"160px",height:"18px"}})]})]})},Mb=le.memo(zb),Fb=()=>{const{isOpen:e}=Be.useMenu(),{width:i,height:n}=Ri(),{data:{user:s}}=ce.useUser(),{visibleRoutes:o,currentPage:a}=Be.useMenu();return t.jsxs(Cb,{isOpen:e,height:n,children:[t.jsxs("div",{className:"top-wrapper",children:[t.jsx(Z,{to:An,children:t.jsx(Ii,{width:"165px"})}),t.jsx(Pb,{notifications:o==null?void 0:o.profile.notifications,avatar:s==null?void 0:s.avatar,name:(s==null?void 0:s.fullName)??"",loading:!s,selected:(a==null?void 0:a.id)==="profile"}),t.jsx(yr,{size:"small"}),t.jsx(Mb,{})]}),t.jsx(_r,{type:"toggle"}),i<1e3&&t.jsx(Nb,{})]})},Hb=u.div`
    width: 300px;
    position: absolute;
...
`,Bb=()=>{const{isOpen:e,message:i,type:n,time:s,onClick:o}=wo.usePopUpMessage();l.useEffect(()=>{e&&setTimeout(()=>{J.openPopUpMessage({isOpen:!e})},s)},[e]);const a=l.useCallback(()=>{o&&(o(),J.openPopUpMessage({isOpen:!e}))},[o]);return t.jsx(Hb,{isOpen:e,isClickable:!!o,color:ct[n].color,onClick:a,children:t.jsx(q,{type:n,fontSize:"1em",lineHeight:"1.4rem",onClose:()=>J.openPopUpMessage({isOpen:!1}),children:i})})},zi=u.div`
    display: flex;
    justify-content: center;
    align-items: center;
    position: absolute;
...
`,Kb=({pages:e,currentPage:i=0,width:n,className:s,maxWidth:o,sliderWidth:a,onChangePage:r,align:d="center",appearance:c=!0})=>{const[p,h]=l.useState(i),{width:x}=Ri(),g=l.useRef(null),m=()=>{var b;g!=null&&g.current&&x<=1e3&&h(Math.round(((b=g.current)==null?void 0:b.scrollLeft)/x))},f=b=>{var v;h(b),r==null||r((v=e[b])==null?void 0:v.id),g!=null&&g.current&&(g.current.scrollLeft=g.current.clientWidth*b)};return l.useEffect(()=>{f(p)},[i,x]),t.jsxs(Xb,{width:n,align:d,maxWidth:o,children:[t.jsx(fn,{pages:e.map(({title:b,condition:v})=>({title:b,condition:v})),currentPage:p,setCurrentPage:f,sliderWidth:a,appearance:c}),t.jsx("div",{className:s??"slider-content",ref:g,onScroll:m,children:e.map(b=>b.condition!==void 0&&b.condition||b.condition===void 0?t.jsx("div",{className:"slider-page",children:b.content},b.title):t.jsx("div",{className:"slider-page",children:t.jsx(ge,{text:"Нет данных"})},b.title))})]})},In=Kb,us=e=>{switch(e){case"small":return"0.65em";case"middle":return"0.77em";default:return"1em"}},hs=(e,i)=>e==="horizontal"?i==="small"?"15px":i==="middle"?"30px":"45px":i==="small"?"30px":i==="middle"?"35px":"45px",Tr=(e,i,n,s)=>{const o=[e?"Я":i==="staff"?"Сотрудник":"Студент"];return e||(n&&o.push(n),s&&o.push(`${s}`)),o},Qb=e=>{switch(e){case"small":return"82px";case"middle":return"90px";default:return"100px"}},Zb=u.div`
    width: ${({width:e})=>e??"100%"};
...
`,iv=({avatar:e,name:i,type:n,division:s,group:o,finance:a,educationForm:r,faculty:d,degreeLevel:c,course:p,isMe:h=!1,noInfo:x=!1})=>{const g=x?"140px":"110px",m=Tr(h,n,s,o);return t.jsxs(tv,{children:[t.jsx(ev,{fullName:i,height:"136px",width:"calc(100% + 16px)",baseScale:1,baseScaleDelta:.5}),t.jsx(di,{avatarModal:!0,border:!0,name:i,avatar:e,width:g,height:g,marginRight:"0"}),!x&&t.jsxs("div",{className:"info",children:[t.jsx("b",{children:i}),t.jsx(te,{fontSize:"0.9rem",children:t.jsx(Ot,{words:m})}),t.jsx(st,{fontSize:"0.9rem",visible:!!a,keyStr:"Уровень финансирование",value:a}),t.jsx(st,{fontSize:"0.9rem",visible:!!d,keyStr:"Факультет",value:d}),t.jsx(st,{fontSize:"0.9rem",visible:!!c,keyStr:"Уровень образования",value:c}),t.jsx(st,{fontSize:"0.9rem",visible:!!p,keyStr:"Курс",value:p}),t.jsx(st,{fontSize:"0.9rem",visible:!!r,keyStr:"Форма образования",value:r})]})]})},nv=u.div`
    @media (min-width: 1001px) {
        width: 330px;
        height: fit-content;
        min-height: 120px;
...
`,Pr=e=>{const{open:i}=K(),{type:n,avatar:s,name:o,checked:a,onClick:r,indexNumber:d,division:c,group:p,isMe:h=!1,loading:x=!1,orientation:g="horizontal",size:m="middle"}=e,f=Tr(h,n,c,p);if(x)return t.jsx(ov,{});const b=v=>{r?r(v):h||(Ae.close(),i(n==="staff"?t.jsx($r,{...e}):t.jsx(av,{...e})))};return t.jsxs(rv,{orientation:g,size:m,onClick:b,children:[d&&t.jsx("div",{className:"index",children:d}),t.jsx(di,{name:o,avatar:s,width:hs(g,m),height:hs(g,m),marginRight:g==="horizontal"?"7px":"0px",checked:a}),t.jsxs("div",{className:"name-and-status",children:[t.jsx("span",{className:"name",children:o}),t.jsx("span",{className:"status",children:t.jsx(Ot,{words:f})})]})]})},lv=u.div`
    display: flex;
    align-items: center;
    flex-direction: column;
    padding: 15px 20px;
...
`,uv=u(te)`
    margin-bottom: 20px;
`,xi=({image:e,list:i,text:n})=>{const{isMobile:s}=Ni();return t.jsxs(dv,{children:[!!e&&t.jsxs(t.Fragment,{children:[t.jsx(W,{size:3,align:"center",bottomGap:!0,children:e.title}),t.jsx("div",{className:"image",children:e.component??t.jsx("img",{src:s&&e.mobile?e.mobile:e.desktop,alt:""})})]}),t.jsx(uv,{lineHeight:"1.6rem",width:"100%",align:"center",fontSize:"1rem",visible:!!n,children:n}),!!i&&t.jsx(pv,{children:i==null?void 0:i.map(o=>l.createElement(cv,{...o,key:o.title}))})]})},hv=({alert:e})=>{const{content:i,time:n,date:s}=e;return t.jsxs(gv,{children:[t.jsx(te,{fontSize:"0.9rem",children:t.jsx(Ot,{words:[ie(s),n]})}),t.jsx(he,{width:"100%",margin:"12px 0"}),t.jsx("div",{dangerouslySetInnerHTML:{__html:i}})]})},gv=u.div`
    display: flex;
    flex-direction: column;
    gap: 5px;
    max-width: 600px;
...
`,Av=()=>{const{allRoutes:e,currentPage:i}=Be.useMenu(),{data:{user:n}}=ce.useUser();if(!e||!n)return t.jsxs(gs,{direction:"horizontal",horizontalAlign:"evenly",verticalAlign:"center",children:[t.jsx(U,{shape:"rect",size:{width:"55px",height:"40px"},margin:"0"}),t.jsx(U,{shape:"rect",size:{width:"55px",height:"40px"},margin:"0"}),t.jsx(U,{shape:"rect",size:{width:"55px",height:"40px"},margin:"0"}),t.jsx(U,{shape:"rect",size:{width:"55px",height:"40px"},margin:"0"}),t.jsx(U,{shape:"rect",size:{width:"55px",height:"40px"},margin:"0"})]});const s=(n==null?void 0:n.user_status)==="stud"?wj:kj;return t.jsx(gs,{direction:"horizontal",horizontalAlign:"evenly",children:s.map(o=>t.jsx(kr,{...e[o],isCurrent:(i==null?void 0:i.id)===o},o))})},Cv=(e,i,n)=>({isOpen:i,message:e,position:n}),xs={hints:[]},Iv=()=>M(Rv),Ar=T(),Cr=T(),Ir=T(),Rv=ee(xs).on(Ar,(e,{message:i,position:n})=>({hints:[...e.hints,Cv(i,e.hints.length===0,n)]})).on(Cr,e=>({hints:e.hints.splice(1,e.hints.length)})).on(Ir,()=>({...xs})),Dv={useHint:Iv},Nv={evoke:Ar,close:Cr,clearStore:Ir},Lv=u.div`
    left: ${({left:e})=>e+"px"};
    top: ${({top:e})=>e+"px"};
    /* padding: 10px; */
    background: var(--reallyBlue);
...
`,zv=()=>{const{hints:e}=Dv.useHint(),i=e[0];return i?t.jsx(Lv,{open:i.isOpen,left:i.position.x,top:i.position.y,children:t.jsx(q,{type:"hint",title:i.message,onClose:()=>Nv.close(),width:"100%",icon:null})}):null},Mv=u.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    overflow: auto;
...
`,Fv=50;function O_({items:e,renderItem:i,hasNext:n,isPending:s,handleNext:o,filter:a,showAlphabetLetters:r,noResultContent:d,offset:c=Fv}){const{data:{user:p}}=ce.useUser();let h="";const x=l.useCallback(g=>{const m=g.currentTarget.clientHeight,f=g.currentTarget.scrollHeight,b=g.currentTarget.scrollTop;f-c<b+m&&n&&!s&&(o==null||o(a??null))},[o,n,s,a]);return!s&&(!e||(e==null?void 0:e.length)===0)?t.jsx(ge,{text:"Нет результатов",children:d}):t.jsxs(Mv,{onScroll:x,children:[t.jsx("div",{className:"scrolable-content",children:(e||[]).map((g,m)=>{var b,v;const f=r?h!==((b=g.fio)==null?void 0:b.charAt(0)):!1;return f&&(h=((v=g.fio)==null?void 0:v.charAt(0))??"-"),t.jsxs(t.Fragment,{children:[f&&t.jsxs("div",{className:"alpabet-letter",children:[t.jsx(W,{size:4,align:"left",children:h}),t.jsx(he,{})]}),i(g,(p==null?void 0:p.id.toString())===g.id,m)]})})}),n&&s&&t.jsx(ut,{width:"40px",height:"40px"}),n&&!s&&t.jsx(y,{onClick:()=>o==null?void 0:o(a??null),text:"Загрузить еще"})]})}u.div`
    display: flex;
    flex-direction: column;
    height: 100%;
...
`,A_=({isTeachers:e=!1,currentFormEducation:i})=>{const{close:n}=K(),s=e?Uv():Bv(),[o,a]=l.useState(""),[r,d]=l.useState(s);return t.jsxs(Gv,{children:[t.jsx(Io,{whereToSearch:s,searchEngine:Rr,setResult:d,placeholder:"Поиск заявок",setExternalValue:a}),t.jsx("div",{className:"list",children:t.jsxs("div",{className:"links-wrapper",children:[(r??s).map(c=>t.jsxs("div",{className:"link-list",children:[t.jsx(W,{size:4,align:"left",bottomGap:!0,children:c.title}),!c.disabled&&t.jsx("div",{className:"links",children:c.links.map((p,h)=>{if(!(p.disabled||!Vv(i,p.exceptionalFormEducationList)))return p.isExternalLink?t.jsx("a",{href:p.link,target:p.isOpenInNewWindow?"_blank":"_self",rel:"noreferrer",children:p.title},p.link+h):t.jsx(Z,{to:p.link,onClick:n,children:p.title},p.link+h)})})]},c.title)),!(r!=null&&r.length)&&!!o.length&&t.jsx(ge,{text:`По запросу ${o} ничего не найдено`})]})})]})},Yv=u.div`
    display: flex;
    flex-direction: column;
    height: 100%;
    width: 100%;
...
`;u(ai)`
    ...
    height: 100%;
    padding: 20px;
`;const fs={isOpen:!1,pages:[],currentPage:0},Xv=()=>M(Kv),Dr=T(),Nr=T(),Lr=T(),zr=T(),Kv=ee(fs).on(Dr,(e,{pages:i})=>({isOpen:!0,pages:i,currentPage:0})).on(Nr,e=>({pages:e.pages,currentPage:e.currentPage,isOpen:!1})).on(Lr,(e,{value:i})=>({...e,currentPage:i})).on(zr,()=>({...fs})),Rn={useStory:Xv},ot={open:Dr,close:Nr,clearStore:zr,changeCurrentPage:Lr};u(Ve)`
    overflow: hidden;
    position: relative;
    background: ${({background:e})=>e??"var(--schedule)"};
    cursor: pointer;
...
`,I_=({fio:e})=>{const{open:i}=K();return t.jsx(Qv,{onClick:()=>i(t.jsx($r,{name:e,isMe:!1})),children:e})},Zv=u.div`
    display: flex;
    align-items: ${({alignItems:e})=>e??"center"};
    justify-content: center;
...
`,Mi=Zv,ey=({documents:e,optionalCheckbox:i,data:n,setData:s,optional:o,collapsed:a,confirmed:r})=>{const[d,c]=l.useState(r===void 0),[p,h]=l.useState(!a),[x,g]=l.useState(!1),m=()=>{if(n[0]===void 0&&!(i!=null&&i.value)&&(i!=null&&i.required))return J.evokePopUpMessage({message:"Не все необходимые поля заполнены",type:"failure",time:5e3});Array.isArray(n[0])?e?i!=null&&i.required?e.files.length&&e.required||i.value?(s(_=>(_.confirmed=!0,{..._})),c(!1),h(!1)):J.evokePopUpMessage({message:"Необходимо загрузить файл. Если у вас нет соответствующего документа, отметье это галочкой",type:"failure",time:5e3}):!d&&!n.find(_=>!!_.find(S=>!S.value&&S.required))||i!=null&&i.value&&!e.required||e.files.length||!e.required?(s(_=>(_.confirmed=!0,{..._})),c(!1),h(!1)):J.evokePopUpMessage({message:"Необходимо загрузить файл",type:"failure",time:5e3}):i!=null&&i.value&&i.required||!n.length||!n.find(_=>!!_.find(S=>!S.value&&S.required))&&!n.find(_=>!!_.find(S=>{var k;return S.value.id==="not-chosen"&&!!((k=S.items)!=null&&k.length)}))?(s(_=>(_.confirmed=!0,{..._})),c(!1),h(!1)):J.evokePopUpMessage({message:"Не все необходимые поля заполнены",type:"failure",time:5e3}):e?i!=null&&i.required?e.files.length&&e.required||i.value?(s(_=>(_.confirmed=!0,{..._})),c(!1),h(!1)):J.evokePopUpMessage({message:"Необходимо загрузить файл. Если у вас нет соответствующего документа, отметьте это галочкой",type:"failure",time:5e3}):!d&&!n.find(_=>!_.value&&_.required)||i!=null&&i.value&&!e.required||e.files.length||!e.required?(s(_=>(_.confirmed=!0,{..._})),c(!1),h(!1)):J.evokePopUpMessage({message:"Необходимо загрузить файл",type:"failure",time:5e3}):i!=null&&i.value&&i.required||!n.find(_=>!_.value&&_.required)&&!n.find(_=>{var S;return _.value===null&&!!((S=_.items)!=null&&S.length)})?(s(_=>(_.confirmed=!0,{..._})),c(!1),h(!1)):J.evokePopUpMessage({message:"Не все необходимые поля заполнены",type:"failure",time:5e3})},f=()=>{s(_=>{const S=_.default[0].map(k=>({fieldName:k.fieldName??"",title:k.title,value:k.type==="select"&&(k!=null&&k.items)?null:"",type:k.type,items:k.items,width:k.width,required:k.required}));return{..._,data:[..._.data,S]}})},b=_=>{s(S=>{const k=S.data.filter((X,O)=>_!==O);return{...S,data:k}})},v=_=>{s(S=>(S.documents&&(S.documents.files=[..._]),{...S}))},P=()=>{i&&(i.value=!i.value),s(_=>({..._,optionalCheckbox:i}))};return l.useEffect(()=>{h(!x&&o?!1:!a)},[x,a]),{openArea:p,changeInputArea:d,included:x,setOpenArea:h,setIncluded:g,setChangeInputArea:c,handleRemove:b,handleAddNew:f,handleLoadFiles:v,handleConfirm:m,handleCheckbox:P}},ty=u.div`
    width: 100%;
    display: flex;
    flex-direction: column;
...
`,gy=({value:e,setValue:i,leftIcon:n,title:s,required:o,width:a,minWidth:r,placeholder:d="Начните ввод...",danger:c,isActive:p=!0,inputAppearance:h=!0,suggestions:x})=>{const[g,m]=l.useState([]),[f,b]=l.useState(!0);return l.useEffect(()=>{if(e){const v=x.filter(P=>P.toLowerCase().includes(e.toLowerCase()));m(v)}else m([])},[e,x]),t.jsxs(py,{leftIcon:!!n,isActive:p,inputAppearance:h,width:a,danger:c,minWidth:r,children:[t.jsx(W,{size:5,align:"left",visible:!!s,bottomGap:"5px",required:o,children:s}),t.jsxs("div",{children:[t.jsx("input",{type:"text",value:e,onChange:v=>{i(v.target.value),b(!0)},placeholder:d}),g.length>0&&t.jsx(uy,{width:"100%",isOpen:f,className:f?"open":"close",itemsAmount:g.length,title:s,children:g.map((v,P)=>t.jsx(hy,{isSelected:!1,onClick:()=>{i(v),m([]),b(!1)},children:v},P))})]})]})},xy=u.div`
    width: 100%;
    text-align: start;
    margin-top: -20px;
    margin-bottom: -10px;
...
`,fy=({title:e,visible:i})=>i?t.jsx(xy,{children:t.jsx("span",{className:"title",children:e})}):null,ms=e=>{const{value:i,required:n,width:s,indexI:o,indexJ:a,type:r,suggestions:d,items:c,title:p,documents:h,changeInputArea:x,setData:g,mask:m,editable:f,placeholder:b,autocomplete:v,isSpecificRadio:P,specialType:_,specialFieldsNameConfig:S,minValueInput:k,maxValueInput:X,maxValueLength:O,diff:N,visible:se,onChange:R,onKeyPress:ae,onBlur:Ne,onKeyDown:Se,onKeyUp:Rt,onFocus:Dt}=e,Ee=f??(x&&!h),[it,Xl]=l.useState(!0),gt=(B,re,xt)=>{R==null||R(B),g(xe=>(Array.isArray(xe.data[0])?xe.data[re][xt??0].value=B:xe.data[re].type==="checkbox-docs"?xe.data[re].items[xt??0].value=!!B:xe.data[re].value=B,{...xe}))},Kl=(B,re,xt)=>{R==null||R(B),g(xe=>(Array.isArray(xe.data[0])?xe.data[re][xt??0].value=B:xe.data[re].value=B,{...xe}))},Ql=(B,re,xt)=>{g(xe=>(xe.data[re].items[xt??0].files=B,{...xe}))},Zl=B=>{R==null||R(B),g(re=>(re.data[o].value=B,{...re}))},ec=B=>{R==null||R(B),ae==null||ae(B),Ne==null||Ne(B),Se==null||Se(B),Rt==null||Rt(B),Dt==null||Dt(B),g(re=>(re.data[o].value=B,{...re}))};return S&&_&&!Object.values(S).includes(_)?null:r!=="select"&&r!=="multiselect"||!c?r==="checkbox"?t.jsx(Qe,{text:p,isActive:Ee,checked:i,setChecked:B=>gt(B,o,a)}):r==="hr-checkbox"?t.jsx(ly,{text:p,isActive:Ee,checked:i,setChecked:B=>gt(B,o,a)}):r==="auto-complete-input"?t.jsx(gy,{title:p,suggestions:d??[],required:n,value:i,placeholder:b??p,setValue:B=>gt(B,o,a)}):r==="textarea"?t.jsx(Xp,{value:i,title:p,setValue:B=>gt(B,o,a),isActive:Ee,textAreaAppearance:Ee,placeholder:b??p,required:n,width:s}):r==="checkbox-docs"?t.jsx(ny,{title:p,items:c,setChecked:(B,re)=>gt(!B,o,re),setFiles:(B,re)=>Ql(B,o,re)}):r==="date-interval"?t.jsx(zo,{title:p,required:n,dates:i,setDates:B=>ec(B),valid:it,setValid:Xl,minValue:k,diff:N}):r==="simple-text"?t.jsx(ay,{title:p,value:i,visible:se}):r==="text-warning"?t.jsx(fy,{title:p,visible:se}):r==="text-header"?t.jsx(dy,{title:p,visible:se}):r==="radio"?t.jsx(sy,{buttons:c,title:p,required:n,current:i,setCurrent:Zl,isSpecificRadio:P}):t.jsx(Xe,{value:i,title:p,minValue:k,maxValue:X,maxLength:O,setValue:B=>gt(B,o,a),type:r,isActive:Ee,inputAppearance:Ee,placeholder:b??p,required:n,mask:m,width:s,autocomplete:v}):t.jsx(Bo,{items:c,setSelected:B=>Kl(B,o,a),selected:i,isActive:Ee,title:p,width:s,multiple:r==="multiselect",required:n})},my=u.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    user-select: none;
...
`,ky=u.div`
    ...
    display: flex;
    align-items: center;
`,Ty=({stagesConfig:e})=>{const[i,n]=l.useState(0),[s,o]=l.useState({});l.useEffect(()=>{a(0)},[]);const a=r=>{o(d=>({...d,[i]:bt(e[i][0].dataForm)})),n(r)};return t.jsxs(t.Fragment,{children:[t.jsx(wy,{children:e.map((r,d)=>t.jsxs(ky,{lastElement:d===e.length-1,children:[t.jsx(_y,{current:d===i,onClick:()=>a(d),reached:s[d],children:d+1}),d!==e.length-1&&t.jsx(zp,{direction:"horizontal",reached:s[d],filled:100,distance:40})]},d))}),t.jsx(t.Fragment,{children:e[i].map((r,d)=>l.createElement(jy,{...r.dataForm,setData:r.setDataForm,key:d}))})]})},Sy=()=>({title:"Дополнительно",data:[{title:"Комментарий",type:"textarea",fieldName:"comment",value:"",editable:!0}]}),Ey=()=>({title:"Период предоставления льготы",hint:"Период предоставления льготы по плате за пользование жилым помещением соответствует дате подачи заявки и дате окончания действия документа",data:[{title:"Начало периода соответствия льготной категории",type:"date",value:"",fieldName:"beginning_of_benefit_period",editable:!0,required:!0},{title:"Окончание периода соответствия льготной категории",type:"date",value:"",fieldName:"end_of_benefit_period",editable:!0,required:!0},{title:"Отсутствует срок действия документа (бессрочный)",type:"checkbox",value:"",fieldName:"is_indefinite",editable:!0,required:!1}],documents:{files:[],required:!0,checkboxCondition:"reverse",fieldName:"invalidFiles",maxFiles:1,allowedTypes:["application/pdf"]}}),$y=()=>({title:"Адрес регистрации",data:[],hint:"Необходимо приложить скан-копию 2-3 страниц паспорта, а также страниц с регистрацией. Для иностранных студентов обязательно приложить перевод паспорта.",documents:{files:[],required:!0,fieldName:"registrationFiles",maxFiles:1,allowedTypes:["application/pdf"]}}),Py=async(e,i,n,s,o=!1)=>{n(!0);const a=i.map(p=>{if(o)return Jv(p);if(Array.isArray(p.data[0])){const h=p.data.map(g=>Object.assign({},...g==null?void 0:g.map(m=>bs(m)))),x={};return x[e]=JSON.stringify(h),x}else return p.data.map(h=>bs(h))}).flat(),r=i.map(p=>{var x,g;const h={};if((x=p.documents)!=null&&x.fieldName)for(let m=0;m<p.documents.files.length;m++)h[((g=p.documents)==null?void 0:g.fieldName)+`[${m}]`]=p.documents.files[m];return h}),d=i.map(p=>{var x,g;const h={};return(x=p.optionalCheckbox)!=null&&x.fieldName&&(h[(g=p.optionalCheckbox)==null?void 0:g.fieldName]=p.optionalCheckbox.value),h}),c=Object.assign({},...a,...r,...d);try{await He.postApplicationFx({formId:e,args:c}),n(!1),s(!0)}catch(p){n(!1),J.evokePopUpMessage({message:`Не удалось отправить форму. Ошибка: ${p}`,type:"failure",time:3e4})}},bs=e=>{var n;const i={};return i[(e==null?void 0:e.fieldName)??""]=Oy(e),e.type==="multiselect"&&(i[(e==null?void 0:e.fieldName)??""]=JSON.stringify((e==null?void 0:e.value).map(s=>s.title))),e.type==="checkbox-docs"?(n=e.items)==null?void 0:n.reduce((s,o)=>{for(let a=0;a<o.files.length;a++)s[(o==null?void 0:o.fieldName)+`[${a}]`]=o.files[a];return s},{}):i},Oy=e=>!e.value||typeof e.value!="object"?e==null?void 0:e.value:e.value.title,Ay=u.div`
    display: flex;
...
`;var Mr=(e=>(e.USG_GETHOSTEL_O="usg_gethostel_o",e.USG_GETHOSTEL_OOZ="usg_gethostel_ooz",e.USG_GETHOSTEL_Z="usg_gethostel_z",e.USG_GETHOSTEL_AO="usg_gethostel_ao",e.USG_GETHOSTEL_BENEFIT="usg_gethostel_benefit",e.USG_GETHOSTEL_FAMILY="usg_gethostel_family",e.USG_CONTR_TERMINATION="usg_contr_termination",e.USG_RELOCATION_INNER="usg_relocation_inner",e.USG_RELOCATION="usg_relocation",e.ACCOMMODATION_FOR_GRADUATES="accommodation_for_graduates",e.OBUCH="obuch",e.STATUS_SOBES="status_sobes",e.SPRVIZOV="sprvizov",e.PERS_DATA="pers_data",e.PROPUSK_RESTORE="propusk_restore",e.PASSPORT_DATA="passport_data",e.DIPL_OTL="dipl_otl",e.STATUS_REGULAR="status_regular",e.OKID_LICAKKRED="okid_licakkred",e.MILDOCS="mildocs",e.VOEN_UCH="voen_uch",e.PR_DONATE="pr_donate",e.PR_MATPOM="pr_matpom",e.PR_SOCSTIP="pr_socstip",e.HIGH_SCHOLARSHIP="high_scholarship",e.DOP_SOGL="dop_sogl",e.SEND_PAYMENT_EDU="send_payment_edu",e.FREE_REQUEST="free_request",e.CRS_VACATIONS="crs_vacations",e.CRS_ACADEMVAC="crs_academvac",e.CRS_EXPULSION="crs_expulsion",e.CRS_ATTESTAT="crs_attestat",e.MEDICAL_CERT="postRequestMedicalCertificate",e.WORK_TRANSFER="",e.EXTRA_HOLIDAY_COLL="",e.HOLIDAY_PLANNING="",e.HOLIDAY_WORK="",e.DISMISSAL="",e.HOLIDAY_POSTPONED="",e.PART_TIME_EMPLOYMENT="",e))(Mr||{}),Cy=(e=>(e.CONTACT_INFO_ACTUALIZATION="contact-info-actualization",e.DATA_VERIFICATION_ROUTE="data-verification",e.ISSUANCE_OF_LICENSES="issuance-of-licenses",e.GETTING_COMPUTER_EQUIPMENT="getting-computer-equipment",e.CONNECTING_COMPUTER="connecting-computer",e.PRINTER_MAINTENANCE="printer-maintenance",e.QUESTION_SED="question-sed",e.QUESTION_PERSONAL_ACCOUNT="question-personal-account",e.OTHER_IT_SERVICES="other-it-services",e.CERTIFICATE_FROM_PLACE_OF_WORK="certificate-from-the-place-of-work",e.VISA_CERTIFICATE="visa-certificate",e.CERTIFICATE_OF_WORK_EXPERIENCE="certificate-of-work-experience",e.NUMBER_OF_UNUSED_VACATION_DAYS="number-of-unused-vacation-days",e.COPY_OF_EMPLOYMENT_RECORD="copy-of-the-employment-record",e.COPIES_OF_DOCUMENTS_FROM_PERSONAL_FILE="copies-of-documents-from-the-personal-file",e.WORK_ON_TERMS_OF_EXTERNAL_CONCURRENCY="work-on-the-terms-of-external-concurrency",e.CERTIFICATE_TIME_PARENTAL_LEAVE="certificate-time-parental-leave",e.COURIER="courier",e.PERSONA_INCOME_TAX_REFERENCE="persona-income-tax-reference",e.PAYMENT_OF_CHILD_BIRTH_ALLOWANCE="payment-of-child-birth-allowance",e.PAYMENT_FOR_CHILD_CARE="payment-for-child-care",e))(Cy||{});const Iy=[{id:0,title:"1 общежитие"},{id:1,title:"2 общежитие"},{id:2,title:"3 общежитие"},{id:3,title:"4 общежитие"},{id:4,title:"5 общежитие"},{id:5,title:"6 общежитие"},{id:6,title:"7 общежитие"},{id:7,title:"8 общежитие"},{id:8,title:"9 общежитие"},{id:9,title:"10 общежитие"}],Ry=[{id:0,title:"имею постоянную регистрацию за пределами А-107 или не имею постоянную регистрацию"},{id:1,title:"имею постоянную регистрацию в пределах А-107"}],Dy=e=>{const{surname:i,name:n,patronymic:s,group:o,email:a,phone:r}=e;return{title:"Контактная информация",data:[{title:"ФИО",fieldName:"fio",value:i+" "+n+" "+s,editable:!1},{title:"Учебная группа",fieldName:"group",type:"tel",value:o,editable:!1},{title:"Электронная почта",fieldName:"email",type:"email",value:a,editable:!0,required:!0},{title:"Телефон",fieldName:"phone",type:"tel",value:r,editable:!0,required:!0},{title:"Причина предоставления (в связи с)",type:"select",width:"100%",value:null,fieldName:"reason",placeholder:"укажите причину",editable:!0,required:!0,items:Ry},{title:"Приоритетное общежитие",fieldName:"priority_hostel",value:null,type:"select",width:"100%",editable:!0,required:!0,items:Iy}]}},Ny=()=>{var R;const[e,i]=l.useState(null),[n,s]=l.useState(ui.kvdCert),[o,a]=l.useState(ui.fluorographyCert),[r,d]=l.useState(ui.vichRwCert),[c,p]=l.useState(ui.graftCert),{data:{dataUserApplication:h}}=je.useApplications(),{data:{user:x}}=ce.useUser(),[g,m]=l.useState(!1),[f,b]=l.useState(!1),[v,P]=l.useState(null),[_,S]=l.useState(null),[k,X]=l.useState(null),O=g??!1;if((x==null?void 0:x.educationForm)!=="Недоступен")return t.jsx(ge,{text:"Сервис временно недоступен в связи с отсутствием свободных мест"});const N=!!e&&!!_&&!!v&&!!k;if(l.useEffect(()=>{h&&(i(Dy(h)),P(Ey()),S($y()),X(Sy()))},[h]),!N)return null;const se=[[{dataForm:e,setDataForm:i}],[{dataForm:_,setDataForm:S}],[{dataForm:n,setDataForm:s}],[{dataForm:o,setDataForm:a}],[{dataForm:r,setDataForm:d}],[{dataForm:c,setDataForm:p}]];return t.jsx(Ay,{isDone:O,children:t.jsxs(cu,{children:[t.jsx(W,{size:4,align:"left",children:"Предоставление права проживания (очно-заочная форма)"}),t.jsx(Ty,{stagesConfig:se}),t.jsx(kt,{text:"Отправить",action:()=>Py(Mr.USG_GETHOSTEL_OOZ,[e,_,v,k,n,o,r,c],b,m),isLoading:f,completed:g,setCompleted:m,repeatable:!1,buttonSuccessText:"Отправлено",isDone:O,isActive:(((R=e.optionalCheckbox)==null?void 0:R.value)??!0)&&bt(e)&&bt(o)&&bt(r)&&bt(c)&&bt(n),popUpFailureMessage:"Для отправки формы необходимо, чтобы все поля были заполнены",popUpSuccessMessage:"Данные формы успешно отправлены"})]})})},Ly=l.lazy(()=>j(()=>import("./index-74de17fc.js"),["assets/index-74de17fc.js","assets/vendor-e9654bfa.js"])),zy=l.lazy(()=>j(()=>import("./index-da32cb31.js"),["assets/index-da32cb31.js","assets/vendor-e9654bfa.js"])),My=l.lazy(()=>j(()=>import("./index-f7c050f4.js"),["assets/index-f7c050f4.js","assets/vendor-e9654bfa.js"])),Fy=l.lazy(()=>j(()=>import("./index-039cc434.js"),["assets/index-039cc434.js","assets/vendor-e9654bfa.js"])),Hy=l.lazy(()=>j(()=>import("./index-d4468bc9.js"),["assets/index-d4468bc9.js","assets/vendor-e9654bfa.js"])),By=l.lazy(()=>j(()=>import("./index-5ee61a31.js"),["assets/index-5ee61a31.js","assets/vendor-e9654bfa.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/find-current-in-select-ba4611d5.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),Uy=l.lazy(()=>j(()=>import("./index-542e39d7.js"),["assets/index-542e39d7.js","assets/vendor-e9654bfa.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),Wy=l.lazy(()=>j(()=>import("./index-a12ff761.js"),["assets/index-a12ff761.js","assets/vendor-e9654bfa.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),Vy=l.lazy(()=>j(()=>import("./index-b5bbe43c.js"),["assets/index-b5bbe43c.js","assets/vendor-e9654bfa.js"])),Gy=l.lazy(()=>j(()=>import("./index-3d2a16bb.js"),["assets/index-3d2a16bb.js","assets/vendor-e9654bfa.js","assets/index-eacb01ee.js"])),Yy=l.lazy(()=>j(()=>import("./index-dcd1fd05.js"),["assets/index-dcd1fd05.js","assets/vendor-e9654bfa.js"])),qy=l.lazy(()=>j(()=>import("./index-9f02254c.js"),["assets/index-9f02254c.js","assets/vendor-e9654bfa.js"])),Jy=l.lazy(()=>j(()=>import("./index-dcd6e74b.js"),["assets/index-dcd6e74b.js","assets/vendor-e9654bfa.js"])),Xy=l.lazy(()=>j(()=>import("./index-bcd8cc0e.js"),["assets/index-bcd8cc0e.js","assets/vendor-e9654bfa.js"])),Ky=l.lazy(()=>j(()=>import("./index-5ee29a0b.js"),["assets/index-5ee29a0b.js","assets/vendor-e9654bfa.js"])),Qy=l.lazy(()=>j(()=>import("./index-d5102644.js"),["assets/index-d5102644.js","assets/vendor-e9654bfa.js"])),Zy=l.lazy(()=>j(()=>import("./index-546b762f.js"),["assets/index-546b762f.js","assets/vendor-e9654bfa.js"])),ej=l.lazy(()=>j(()=>import("./index-52107921.js"),["assets/index-52107921.js","assets/vendor-e9654bfa.js"])),tj=l.lazy(()=>j(()=>import("./index-24f3fe82.js"),["assets/index-24f3fe82.js","assets/vendor-e9654bfa.js"])),ij=l.lazy(()=>j(()=>import("./index-45a4f8a5.js"),["assets/index-45a4f8a5.js","assets/vendor-e9654bfa.js"])),nj=l.lazy(()=>j(()=>import("./index-13a11b85.js"),["assets/index-13a11b85.js","assets/vendor-e9654bfa.js"])),sj=l.lazy(()=>j(()=>import("./index-33b22fa0.js"),["assets/index-33b22fa0.js","assets/vendor-e9654bfa.js"])),oj=l.lazy(()=>j(()=>import("./index-e3f871e4.js"),["assets/index-e3f871e4.js","assets/vendor-e9654bfa.js"])),aj=l.lazy(()=>j(()=>import("./index-18dca383.js"),["assets/index-18dca383.js","assets/vendor-e9654bfa.js"])),rj=l.lazy(()=>j(()=>import("./index-3979eb5b.js"),["assets/index-3979eb5b.js","assets/vendor-e9654bfa.js"])),lj=l.lazy(()=>j(()=>import("./index-d710359a.js"),["assets/index-d710359a.js","assets/vendor-e9654bfa.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),cj=l.lazy(()=>j(()=>import("./index-c4e6c7b6.js"),["assets/index-c4e6c7b6.js","assets/vendor-e9654bfa.js","assets/get-method-obtaining-fields-0c9569f9.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),dj=l.lazy(()=>j(()=>import("./index-6537179b.js"),["assets/index-6537179b.js","assets/vendor-e9654bfa.js"])),pj=l.lazy(()=>j(()=>import("./index-0c9e1811.js"),["assets/index-0c9e1811.js","assets/vendor-e9654bfa.js"])),uj=l.lazy(()=>j(()=>import("./index-16a14a6c.js"),["assets/index-16a14a6c.js","assets/vendor-e9654bfa.js"])),hj=l.lazy(()=>j(()=>import("./index-6881ce02.js"),["assets/index-6881ce02.js","assets/vendor-e9654bfa.js"])),gj=l.lazy(()=>j(()=>import("./index-b0e90c68.js"),["assets/index-b0e90c68.js","assets/vendor-e9654bfa.js"])),xj=l.lazy(()=>j(()=>import("./index-f1206677.js"),["assets/index-f1206677.js","assets/vendor-e9654bfa.js"])),fj=l.lazy(()=>j(()=>import("./index-b35ec6d0.js"),["assets/index-b35ec6d0.js","assets/vendor-e9654bfa.js"])),mj=l.lazy(()=>j(()=>import("./index-92b00bad.js"),["assets/index-92b00bad.js","assets/vendor-e9654bfa.js","assets/get-divisions-96cfa1b1.js"])),E="/applications",bj="/application-for-superior-room",vj="/acad-performance",yj="/dormitory",Fr=E+"/clarification-of-passport-data",Hr=E+"/arbitrary-request",Br=E+"/social-scollarship",Ur=E+"/certificate-of-attendance",Wr=E+"/social-agencies",Vr=E+"/paper-call",Gr=E+"/regular-accommodation",Yr=E+"/full-time-part-time-form",qr=E+"/accommodation-correspondence-form",Jr=E+"/academic-leave-accommodation",Xr=E+"/preferential-accommodation",Kr=E+"/family-room",Qr=E+"/termination-of-employment-contract",Zr=E+"/relocation-inside-hostel",el=E+"/relocation-to-another-hostel",tl=E+"/accommodation-for-graduates",an=E+"/payment-recipient",il=E+"/restoring-the-magnetic-pass",nl=E+"/retake-for-diploma",sl=E+"/military-registration-documents",ol=E+"/financial-support",al=E+"/financial-assistance",rl=E+"/increased-state-academic-scholarship",ll=E+"/changing-personal-data",cl=E+"/student-status",dl=E+"/state-accreditation",jj=E+"/military-registration-card",pl=E+"/holidays-after-training",ul=E+"/provision-academic-leave",hl=E+"/independently-deducted",gl=E+"/extension-attestation",mt=()=>fe({oldVersionUrl:"/sprav"}),vt=()=>({applications:{id:"applications",title:"Цифровые сервисы",icon:t.jsx(C,{}),path:E,Component:Gy,color:"red",isTemplate:!1,group:"OTHER",pageSize:"big",keywords:["справки","справка","заявления","заявление"]},...hr,payments:{id:"payments",title:"Договоры и оплаты",icon:t.jsx(lt,{}),path:ki,Component:$n,color:"green",isTemplate:!1,group:"FINANCES_DOCS",keywords:["оплата"]},dormitory:{id:"dormitory",title:"Список ожидания на заселение в общежитие",icon:t.jsx(zn,{}),path:yj,Component:My,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",show:!0},"acad-performance":{id:"acad-performance",title:"Успеваемость",icon:t.jsx(qc,{}),path:vj,Component:zy,color:"green",isTemplate:!1,group:"LEARNING_ACTIVITIES",keywords:["оценки","экзамены","зачеты"]},"project-activity":{id:"project-activity",title:"Проектная деятельность",icon:t.jsx(Ws,{}),path:cr,Component:Yy,color:"orange",isTemplate:!1,group:"LEARNING_ACTIVITIES",keywords:["пд"]},"helpful-information":{id:"helpful-information",title:"Полезная информация",icon:t.jsx(Jc,{}),path:ur,Component:mn,color:"blue",isTemplate:!0,group:"GENERAL"},"application-for-superior-room":{id:"application-for-superior-room",title:"Заявка на комнату повышенной комфортности",icon:t.jsx(zn,{}),path:bj,Component:Ly,color:"blue",isTemplate:!1,group:"GENERAL",show:!(new Date>new Date("Aug 19 2023 12:00:00 GMT+0300"))}}),rn=e=>{var i,n,s;return{...gr,"clarification-of-passport-data":{id:"clarification-of-passport-data",title:"Уточнение паспортных данных",icon:t.jsx(vi,{}),path:Fr,Component:Fy,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"arbitrary-request":{id:"arbitrary-request",title:"Произвольный запрос",icon:t.jsx(vi,{}),path:Hr,Component:mj,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"social-scollarship":{id:"social-scollarship",title:"Социальная стипендия",icon:t.jsx(Y,{}),path:Br,Component:I?mt:Hy,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"certificate-of-attendance":{id:"certificate-of-attendance",title:"Сертификат об обучении",icon:t.jsx(Y,{}),path:Ur,Component:By,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"social-agencies":{id:"social-agencies",title:"Справка в социальные учреждения",icon:t.jsx(Y,{}),path:Wr,Component:Uy,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"paper-call":{id:"paper-call",title:"Справка-вызов",icon:t.jsx(Y,{}),path:Vr,Component:Wy,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"regular-accommodation":{id:"regular-accommodation",title:"Предоставление права проживания (очная форма)",icon:t.jsx(Y,{}),path:Gr,Component:Vy,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"full-time-part-time-form":{id:"full-time-part-time-form",title:"Предоставление права проживания (очно-заочная форма)",icon:t.jsx(Y,{}),path:Yr,Component:Ny,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"accommodation-correspondence-form":{id:"accommodation-correspondence-form",title:"Предоставление права проживания (заочная форма)",icon:t.jsx(Y,{}),path:qr,Component:xj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"academic-leave-accommodation":{id:"academic-leave-accommodation",title:"Предоставление права проживания в период академического отпуска",icon:t.jsx(Y,{}),path:Jr,Component:qy,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"preferential-accommodation":{id:"preferential-accommodation",title:"Предоставление права проживания льготной категории граждан",icon:t.jsx(Y,{}),path:Xr,Component:Jy,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"family-room":{id:"family-room",title:"Предоставление права проживания в семейной комнате",icon:t.jsx(Y,{}),path:Kr,Component:fj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"termination-of-employment-contract":{id:"termination-of-employment-contract",title:"Расторжение договора найма",icon:t.jsx(Y,{}),path:Qr,Component:Xy,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"relocation-inside-hostel":{id:"relocation-inside-hostel",title:"Переселение внутри общежития",icon:t.jsx(Y,{}),path:Zr,Component:I?()=>t.jsx(fe,{isRedirectButtonVisible:!1,errorText:"Прием заявок на переселение внутри общежития будет осуществляться с 01.10.2023"}):Ky,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"relocation-to-another-hostel":{id:"relocation-to-another-hostel",title:"Переселение в другое общежитие",icon:t.jsx(Y,{}),path:el,Component:I?()=>t.jsx(fe,{isRedirectButtonVisible:!1,errorText:"Прием заявок на переселение в другое общежитие завершен 15.06.2023"}):Zy,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"accommodation-for-graduates":{id:"accommodation-for-graduates",title:"Предоставление права проживания в каникулярный период",icon:Y,path:tl,Component:["4","5","6"].includes((e==null?void 0:e.course)??"")||(n=(i=e==null?void 0:e.status)==null?void 0:i.toLocaleLowerCase())!=null&&n.includes("окончил")||((s=e==null?void 0:e.degreeLevel)==null?void 0:s.toLocaleLowerCase())==="магистратура"&&(e==null?void 0:e.course)==="2"?Qy:()=>t.jsx(fe,{isRedirectButtonVisible:!1,errorText:"Сервис доступен только выпускникам университета, проживающих в общежитии"}),color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"payment-recipient":{id:"payment-recipient",title:"Отправка квитанции об оплате",icon:t.jsx(Y,{}),path:an,Component:ej,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"restoring-the-magnetic-pass":{id:"restoring-the-magnetic-pass",title:"Запрос на восстановление магнитного пропуска",icon:t.jsx(Y,{}),path:il,Component:tj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"military-registration-documents":{id:"military-registration-documents",title:"Отправить документы воинского учета",icon:t.jsx(Y,{}),path:sl,Component:I?mt:sj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"retake-for-diploma":{id:"retake-for-diploma",title:"Заявление на пересдачу для получения диплома с отличием",icon:t.jsx(Y,{}),path:nl,Component:nj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"increased-state-academic-scholarship":{id:"increased-state-academic-scholarship",title:"Получение повышенной государственной академической стипендии",icon:t.jsx(Y,{}),path:rl,Component:I?mt:ij,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"financial-support":{id:"financial-support",title:"Оформить материальную поддержку остронуждающимся студентам (Дотацию)",icon:t.jsx(Y,{}),path:ol,Component:I?mt:oj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"financial-assistance":{id:"financial-assistance",title:"Финансовая поддержка",icon:t.jsx(Y,{}),path:al,Component:I?mt:aj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"changing-personal-data":{id:"changing-personal-data",title:"Запрос на изменение персональных данных",icon:t.jsx(Y,{}),path:ll,Component:rj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"student-status":{id:"student-status",title:"Справка о прохождении обучения в университете (о статусе обучающегося) по месту требования",icon:t.jsx(Y,{}),path:cl,Component:lj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"state-accreditation":{id:"state-accreditation",title:"Выдача лицензий и свидетельств о государственной аккредитации",icon:t.jsx(Y,{}),path:dl,Component:cj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E},"holidays-after-training":{id:"holidays-after-training",title:"Предоставление каникул",icon:t.jsx(Y,{}),path:pl,Component:dj,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"provision-academic-leave":{id:"provision-academic-leave",title:"Предоставление академического отпуска",icon:t.jsx(Y,{}),path:ul,Component:pj,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"independently-deducted":{id:"independently-deducted",title:"Отчисление по инициативе обучающегося",icon:t.jsx(Y,{}),path:hl,Component:uj,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"extension-attestation":{id:"extension-attestation",title:"Продление промежуточной аттестации ",icon:t.jsx(Y,{}),path:gl,Component:hj,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:E},"military-registration-card":{id:"military-registration-card",title:"Заполнить личную карточку обучающегося по воинскому учету для получения отсрочки от призыва на военную службу",icon:t.jsx(Y,{}),path:jj,Component:I?mt:gj,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:E}}},vs=(e,i)=>e.reduce((n,s)=>(n[s]=i[s],n),{}),_j=["settings","profile","chat","schedule","payments","project-activity","all-students"],wj=["home","schedule","acad-performance","all","profile"],kj=["home","schedule","hr-applications","all","profile"],Tj=e=>{var a,r;if(!e)return[];const n=((r=(a=JSON.parse(localStorage.getItem(G.NewSettings)||"{}")[e.id])==null?void 0:a["settings-customize-menu"])==null?void 0:r.property.pages)??Pi,s=eo.filter(d=>!n.includes(d));return(e==null?void 0:e.user_status)==="staff"&&n.some(d=>!s.includes(d))?[...n,...s]:n},ys={allRoutes:null,visibleRoutes:null,leftsideBarRoutes:null,homeRoutes:null,currentPage:null,isOpen:!1},Sj=()=>M($j),xl=T(),fl=T(),ml=T(),bl=T(),Ej=(e,i,n)=>{const s={...n};if(s[e])s[e].notifications=i;else return null;return s},zt=e=>{if(!e)return tn();const{accepts:i,agreements:n,checkdata:s,studLogins:o}=e,a=!!i.length||!!n.length||!!s.length||!!(o!=null&&o.length),r="download-agreements",d=Object.entries(tn()).filter(([c])=>c!==r||c===r&&a);return Object.fromEntries(d)},$j=ee(ys).on(xl,(e,{isOpen:i,currentPage:n})=>{var s;return{...e,currentPage:e.allRoutes&&n?(s=e.allRoutes)==null?void 0:s[n]:e.currentPage,isOpen:i}}).on(fl,()=>({...ys})).on(ml,(e,{user:i,adminLinks:n,homeRoutes:s})=>({...e,currentPage:(i==null?void 0:i.user_status)==="staff"?zt(n)[window.location.hash.slice(2,window.location.hash.length)]:vt()[window.location.hash.slice(2,window.location.hash.length)],allRoutes:(i==null?void 0:i.user_status)==="staff"?{...zt(n),...nn()}:{...vt(),...rn(i)},visibleRoutes:(i==null?void 0:i.user_status)==="staff"?zt(n):vt(),leftsideBarRoutes:vs(Tj(i),(i==null?void 0:i.user_status)==="staff"?zt(n):vt()),homeRoutes:vs(s??JSON.parse(localStorage.getItem(G.HomeRoutes)??JSON.stringify(_j)),(i==null?void 0:i.user_status)==="staff"?{...zt(n),...nn()}:{...vt(),...rn(i)})})).on(bl,(e,{page:i,notifications:n})=>{var s;return{...e,visibleRoutes:Ej(i,typeof n=="number"?n:n(((s=e.visibleRoutes)==null?void 0:s[i].notifications)??0),e.visibleRoutes)}}),Be={useMenu:Sj},De={changeOpen:xl,clearStore:fl,defineMenu:ml,changeNotifications:bl},Pj=(e,i,n,s)=>{const o={alert:{id:i,title:n??"Новости",text:"Вам пришло оповещение!",type:"alert",goTo:dr,duration:1e4,pageId:"alerts"},schedule:{id:i,type:"schedule",title:n??"Скоро начнется пара",text:s??"",goTo:It,pageId:"schedule"},info:{id:i,title:n??"Важная информация!",text:s??"",type:"info"},"payment-dorm":{id:i,title:n??"Долг по общежитию",text:s??"Вам необходимо внести платеж ",type:"payment-dorm",goTo:ki,canClose:!1,pageId:"payments"},"payment-ed":{id:i,title:n??"Долг по образованию",text:s??"Вам необходимо внести платеж",type:"payment-ed",goTo:ki,canClose:!1,pageId:"payments"},message:{id:i,title:n??"Сообщения",text:s??"Посмотрите сообщения",type:"message",goTo:wi,pageId:"chat",canClose:!1},"hr-applications":{id:i,title:n??"",text:s??"У вашей заявки изменился статус",type:"hr-applications",goTo:oe,pageId:"hr-applications"},"kpi-pps":{id:i,title:n??"",text:s??"У вашей заявки изменился статус",type:"kpi-pps",goTo:xa,pageId:"kpi-pps"},"doc-for-review":{id:i,title:n??"Документ для ознакомления",text:s??"",type:"doc-for-review",goTo:Pn,pageId:"doclist"},"digital-services":{id:i,title:n??"Статус заявки изменен",text:s??"",type:"digital-services",goTo:E,pageId:"applications"},"version-update":{id:i,title:n??"Вышла новая версия",text:"Посмотрите изменения",type:"version-update"},"electronic-interaction":{id:i,title:n??"Документ для подписания",text:"Об электронном взаимодействии",type:"electronic-interaction",goTo:tr,pageId:"electronic-interaction-agreement"}};return o[e]??o.info},Oj={notifications:[],visibleNotifications:[],loading:!1,error:null,removeNotificationError:null,removeNotificationLoading:!1,clearAllLoading:!1,clearAllError:null,loaded:!1},Fi=z(async({settings:e})=>{try{const{data:i}=await qd(),n={message:"messages","doc-for-review":"doclist","version-update":"newVersion","digital-services":"applications",alert:"news",schedule:"schedule"};return i.filter(({type:s})=>e[n[s]]).map(({id:s,type:o,title:a,text:r})=>Pj(o,s,a,r))}catch(i){throw new Error(`Не удалось загрузить уведомления. Ошибка: ${i}`)}}),Aj=z(({notifications:e})=>{e.forEach(({pageId:i})=>{i&&De.changeNotifications({page:i,notifications:1})})}),Cj=z(({notifications:e})=>{const{pageId:i}=e[0];i&&De.changeNotifications({page:i,notifications:1})}),Hi=z(async({id:e,pageId:i})=>{try{return await Jd(e),{id:e,pageId:i}}catch{throw new Error("Не удалось скрыть уведомление")}}),Bi=z(async()=>{try{await Xd()}catch{throw new Error("Не удалось скрыть все уведомления")}}),Ij=e=>{e&&De.changeNotifications({page:e,notifications:0})},vl=T(),yl=T(),jl=T(),_l=T(),wl=T(),kl=T(),Tl=T(),ne=ee(Oj).reset(Tl);Ue({from:yl,to:Fi});D({clock:Fi.pending,source:ne,fn:(e,i)=>({...e,loading:i}),target:ne});D({clock:Fi.failData,source:ne,fn:(e,i)=>({...e,error:i.message}),target:ne});D({clock:Fi.doneData,source:ne,fn:(e,i)=>({...e,notifications:[...i,...e.notifications],visibleNotifications:[...e.visibleNotifications,...i].slice(0,2),error:null,loaded:!0}),target:[ne,Aj]});D({clock:vl,source:ne,fn:(e,i)=>({notifications:[...e.notifications,i],visibleNotifications:[...e.visibleNotifications,i]}),target:[ne,Cj]});Ue({from:_l,to:Hi});D({clock:Hi.doneData,source:ne,fn:({notifications:e,visibleNotifications:i,...n},{id:s,pageId:o})=>(Ij(o),{...n,notifications:e.filter(a=>a.id!==s),visibleNotifications:i.filter(a=>a.id!==s)}),target:ne});D({clock:Hi.failData,source:ne,fn:(e,i)=>({...e,removeNotificationError:i.message}),target:ne});D({clock:Hi.pending,source:ne,fn:(e,i)=>({...e,removeNotificationLoading:i}),target:ne});Ue({from:wl,to:Bi});D({clock:Bi.pending,source:ne,fn:(e,i)=>({...e,clearAllLoading:i,clearAllError:null}),target:ne});D({clock:Bi.failData,source:ne,fn:(e,i)=>({...e,clearAllError:i.message}),target:ne});D({clock:Bi.doneData,source:ne,fn:e=>({...e,notifications:[],visibleNotifications:[]}),target:ne});D({clock:jl,source:ne,fn:({notifications:e,visibleNotifications:i,...n},s)=>({...n,notifications:e,visibleNotifications:i.filter(o=>o.id!==s)}),target:ne});D({clock:kl,source:ne,fn:({notifications:e,...i})=>({...i,notifications:e,visibleNotifications:[]}),target:ne});const Rj=()=>we(ne),ht={initialize:yl,add:vl,clearById:_l,clearVisibleById:jl,clearAll:wl,clearAllVisible:kl,clearStore:Tl},ze={useLkNotifications:Rj},Dj=Object.freeze(Object.defineProperty({__proto__:null,events:ht,selectors:ze},Symbol.toStringTag,{value:"Module"})),js={messages:null,error:null},Nj=()=>({data:M(_s).messages,loading:M(Wt.pending),error:M(_s).error}),Wt=z(async()=>{try{return(await _d("1")).data}catch(e){throw new Error(e)}}),Sl=T(),_s=ee(js).on(Wt,e=>({...e,error:null})).on(Wt.doneData,(e,i)=>({...e,messages:i})).on(Wt.failData,(e,i)=>({...e,error:i.message})).on(Sl,()=>({...js})),Lj={useMessages:Nj},zj={getMessagesFx:Wt},Mj={clearStore:Sl},Fj=Object.freeze(Object.defineProperty({__proto__:null,effects:zj,events:Mj,selectors:Lj},Symbol.toStringTag,{value:"Module"})),ws={type:null,personalNotifications:null,error:null,completed:!1},Hj=()=>({data:M(wt).personalNotifications,loading:M(_t.pending),error:M(wt).error,completed:M(wt).completed}),Bj=()=>M(wt).type,El=T(),$l=z(e=>e),_t=z(async()=>{const{type:e}=wt.getState();if(e==="notifications")try{return(await no()).data}catch(i){throw new Error(i)}try{return{docs:(await so()).data}}catch(i){throw new Error(i)}}),Si=z(async e=>{const{type:i}=wt.getState(),n=i==="notifications"?zd:Fd;try{return await n.view(e),"ok"}catch{throw new Error("Ошибка загрузки данных")}}),Pl=T(),wt=ee(ws).on($l,(e,i)=>({...e,type:i})).on(_t,e=>({...e,error:null})).on(_t.doneData,(e,i)=>({...e,personalNotifications:i})).on(_t.failData,(e,i)=>({...e,error:i.message})).on(Si.doneData,e=>({...e})).on(Si.failData,(e,i)=>({...e,error:i.message})).on(El,(e,i)=>({...e,completed:i.completed})).on(Pl,()=>({...ws}));Si.doneData.watch(()=>_t());const Uj={usePersonalNotifications:Hj,useType:Bj},Wj={setNotificationsType:$l,getPersonalNotificationsFx:_t,viewPersonalNotificationsFx:Si},Vj={changeCompleted:El,clearStore:Pl},Gj=Object.freeze(Object.defineProperty({__proto__:null,effects:Wj,events:Vj,selectors:Uj},Symbol.toStringTag,{value:"Module"})),Yj=si({api:{get:Nd}}),qj=(e,i="minutes")=>{switch(i){case"minutes":const n=new Date,[s]=e.split(" - "),[o,a]=s.split(":");return+o*60+ +a-(n.getHours()*60+n.getMinutes());case"days":const r=new Date(e);return Math.ceil(Math.floor((r.getTime()-new Date().getTime())/1e3/60/60)/24)}},ks=e=>e&&Object.keys(e).length?Object.keys(e).findIndex(n=>{const s=qj(n,"days");return s>=0&&s<30})+1:0,Jj=(e,i)=>e&&e[0]?Object.keys(e[0]).find((n,s)=>s+1===i)||"sunday":e&&e[2]?"":"sunday";var ln=(e=>(e[e.Янв=1]="Янв",e[e.Фев=2]="Фев",e[e.Мар=3]="Мар",e[e.Апр=4]="Апр",e[e.Май=5]="Май",e[e.Июн=6]="Июн",e[e.Июл=7]="Июл",e[e.Авг=8]="Авг",e[e.Сен=9]="Сен",e[e.Окт=10]="Окт",e[e.Ноя=11]="Ноя",e[e.Дек=12]="Дек",e))(ln||{});const Ol=e=>new Date(e.setHours(0,0,0,0)),yt=new Date,Ts=1,Ss=yt.getDay(),cn=Ol(new Date(yt.valueOf()-(Ss<=0?7-Ts:Ss-Ts)*864e5)),Xj=Ol(new Date(cn.valueOf()+6*864e5)),Kj=e=>{const[i,n]=e.dateInterval.split("-").map(x=>x.trim()),[s,o]=i.split(" "),[a,r]=(n==null?void 0:n.split(" "))??[null,null],d=ln[o],c=ln[r]||d,p=new Date(`${d}/${s}/${c>=d?yt.getFullYear():yt.getFullYear()-1}`),h=a&&c?new Date(`${c}/${a}/${c>=d?yt.getFullYear():yt.getFullYear()+1}`):null;return!!(p<=Xj&&(!h&&cn<=p||h&&h>=cn))},Qj=e=>e.filter(i=>Kj(i)),Zj=async(e,i)=>{const n=typeof e=="string",s=!n&&!(e!=null&&e.subdivisions)||!!(i!=null&&i.length),o=s?await fd(i??e.group??""):n?await Mn(e):await Mn(Ki({name:e.name,surname:e.surname,patronymic:e.patronymic})),a=s?await md():n?await Fn(e):await Fn(Ki({name:(e==null?void 0:e.name)??"",surname:(e==null?void 0:e.surname)??"",patronymic:(e==null?void 0:e.patronymic)??""})),r={},d={},c={monday:{lessons:[]},tuesday:{lessons:[]},wednesday:{lessons:[]},thursday:{lessons:[]},friday:{lessons:[]},saturday:{lessons:[]}};if(o.data.status!=="error"){for(const p in o.data)if(p!=="Sunday"){const h=p.charAt(0).toLowerCase()+p.slice(1);d[h]=s?o.data[p]:{lessons:o.data[p]}}for(const[p,h]of Object.entries(d))c[p].lessons=Qj(h.lessons)}if(a.data.status!=="error")for(const p in a.data)s?r[p]=a.data[p]:a.data[p].length&&(r[p]={lessons:a.data[p]});return{0:Object.keys(o.data).length&&o.data.status!=="error"?c:null,1:Object.keys(o.data).length&&o.data.status!=="error"?d:null,2:Object.keys(a.data).length&&Object.values(r).find(p=>!!p.lessons.length)&&a.data.status!=="error"?r:null,3:null}},Es={schedule:null,currentModule:"0",currentDay:new Date().getDay(),currentDayString:"",currentChosenDay:new Date().getDay(),view:"full",error:null},e1=()=>({data:M($s),loading:M(Vt.pending),error:M($s).error}),Vt=z(async({user:e,group:i})=>{try{return Zj(e,i)}catch{throw new Error("Не удалось загрузить расписание")}}),Al=T(),Cl=T(),Il=T(),Rl=T(),$s=ee(Es).on(Vt,e=>({...e,schedule:null,error:null})).on(Vt.doneData,(e,i)=>({...e,schedule:i,currentModule:i[0]?"0":i[1]?"1":i[2]?"2":i[3]?"3":"0",currentDayString:Jj(i,e.currentDay),currentChosenDay:ks(i[2]),currentDay:i[0]?new Date().getDay():ks(i[2])})).on(Vt.failData,e=>({...e,error:"Не удалось загрузить расписание"})).on(Al,(e,i)=>({...e,currentModule:i.currentModule.toString()})).on(Cl,(e,i)=>({...e,view:i.view})).on(Il,(e,i)=>({...e,currentChosenDay:i.day})).on(Rl,()=>({...Es})),t1={useSchedule:e1},i1={changeCurrentModule:Al,changeView:Cl,changeCurrentChosenDay:Il,clearStore:Rl},n1={getScheduleFx:Vt},s1=Object.freeze(Object.defineProperty({__proto__:null,effects:n1,events:i1,selectors:t1},Symbol.toStringTag,{value:"Module"})),Ps={superiorRoom:null,error:null},o1=()=>({data:M(Os).superiorRoom,loading:M(Gt.pending),error:M(Os).error}),Dl=T(),a1=z(async e=>{});Ue({from:Dl,to:a1});const Gt=z(async()=>{try{return(await Sd()).data}catch{throw new Error("Не удалось загрузить раздел")}}),Nl=T(),Os=ee(Ps).on(Gt,e=>({...e,error:null})).on(Gt.doneData,(e,i)=>({...e,superiorRoom:i})).on(Gt.failData,(e,i)=>({...e,error:i.message})).on(Nl,()=>({...Ps})),r1={useSuperiorRoom:o1},l1={getSuperiorRoomFx:Gt},c1={postSuperiorRoom:Dl,clearStore:Nl},d1=Object.freeze(Object.defineProperty({__proto__:null,effects:l1,events:c1,selectors:r1},Symbol.toStringTag,{value:"Module"})),As={teacherDataVerification:null,error:null,completed:!1},p1=()=>({data:M(Ji).teacherDataVerification,loading:M(Yt.pending),error:M(Ji).error,completed:M(Ji).completed}),Ll=T(),zl=T(),u1=z(async e=>{try{return(await Wd(e)).data}catch{throw new Error("Не удалось загрузить раздел")}});Ue({from:Ll,to:u1});const Yt=z(async()=>{try{return(await Ud()).data}catch{throw new Error("Не удалось войти")}}),Ml=T(),Ji=ee(As).on(Yt,e=>({...e,error:null})).on(Yt.doneData,(e,i)=>({...e,teacherDataVerification:i})).on(Yt.failData,(e,i)=>({...e,error:i.message})).on(zl,(e,i)=>({...e,completed:i.completed})).on(Ml,()=>({...As})),h1={useTeacherDataVerification:p1},g1={getTeacherDataVerificationFx:Yt},x1={postTeacherDataVerification:Ll,changeCompleted:zl,clearStore:Ml},f1=Object.freeze(Object.defineProperty({__proto__:null,effects:g1,events:x1,selectors:h1},Symbol.toStringTag,{value:"Module"})),m1=[Qd,Je,ap,cp,xp,Fj,Gj,zf,kp,Yj,s1,d1,f1,gp,ep,Dj],b1=()=>{m1.forEach(e=>{e.events.clearStore()})},Ge=localStorage.getItem(G.Token)??"",Ye=()=>JSON.parse(localStorage.getItem(G.SavePassword)??"true"),Ui=z(async e=>{try{const{data:i}=await ud(e),n=new FormData;n.set("ulogin",e.login),n.set("upassword",e.password),n.set("auth_action","userlogin");try{await ei.post("/old",n)}catch{}return Ye()?(localStorage.setItem(G.Token,i.token),localStorage.setItem(G.JWT,(i==null?void 0:i.jwt)??""),localStorage.setItem(G.JWTRefresh,i.jwt_refresh??"")):(sessionStorage.setItem(G.Token,i.token),sessionStorage.setItem(G.JWT,(i==null?void 0:i.jwt)??"")),i}catch{throw new Error(navigator.onLine?"Неверный логин или пароль":"Потеряно соединение с интернетом")}}),at=z(async e=>{try{const n=(await hd(e.token)).data.user,{name:s,surname:o,patronymic:a}=n;return{currentUser:{...n,guid:e.jwt?pt(e.jwt).IndividualGuid:"",fullName:Ki({name:s,surname:o,patronymic:a})},isAuthenticated:!!e,error:null,savePassword:Ye()}}catch(i){throw console.log(i),new Error("Возникла какая-то ошибка")}}),dn=z(async e=>{try{return(await gd(e)).data}catch(i){throw console.log(i),new Error("Возникла какая-то ошибка")}}),Fl=z(()=>{Ye()?(localStorage.removeItem(G.Token),localStorage.removeItem(G.JWT),localStorage.removeItem(G.JWTRefresh)):(sessionStorage.removeItem(G.Token),sessionStorage.removeItem(G.JWT),sessionStorage.removeItem(G.JWTRefresh)),b1()}),Hl=e=>{const i=localStorage.getItem(G.SavePassword),n=e??JSON.parse(i??"true");return localStorage.setItem(G.SavePassword,n.toString()),n},Bl=T(),Dn=T(),Ul=T(),Wl=T(),Vl=T();Ue({from:Bl,to:Ui});D({clock:Ui.doneData,target:at});Ue({from:Dn,to:Fl});Ge&&Ye()?at({token:Ge,jwt:localStorage.getItem(G.JWT)}):Fl();const v1={currentUser:null,error:null,isAuthenticated:!!(Ge!=null&&Ge.length),savePassword:Ye(),loginEuz:""};Hl();const y1=ee(v1).on(at,e=>({...e,error:null})).on(at.doneData,(e,i)=>i).on(at.failData,(e,i)=>({error:i.message,currentUser:null,isAuthenticated:!!(Ge!=null&&Ge.length),savePassword:Ye()})).on(Ui.failData,(e,i)=>({error:i.message,isAuthenticated:null,currentUser:null,savePassword:Ye()})).on(Dn,()=>({error:"",isAuthenticated:null,currentUser:null,savePassword:Ye()})).on(Vl,(e,{savePassword:i})=>({...e,savePassword:Hl(i)})).on(dn,e=>({...e,error:null})).on(dn.doneData,(e,i)=>({...e,loginEuz:i})).on(at.failData,(e,i)=>({...e,error:i.message})).on(Wl,(e,{key:i,value:n})=>({...e,currentUser:e.currentUser?{...e.currentUser,[i]:n}:null})).on(Ul,e=>({...e,currentUser:null})),ce={useUser:()=>{const{currentUser:e,error:i,isAuthenticated:n,savePassword:s,loginEuz:o}=M(y1);return{data:{user:e,isAuthenticated:n,savePassword:s,loginEuz:o},loading:M(Ui.pending),error:i}}},Zt={login:Bl,logout:Dn,changeSavePassword:Vl,clear:Ul,update:Wl},j1={getUserFx:at,getLoginEuzFx:dn},_1=()=>{const e="0.0.1";localStorage.getItem(G.Version)!==e&&(localStorage.clear(),localStorage.setItem(G.Version,e),Zt.logout())},Gl=T(),Yl=z(Od);D({clock:Gl,target:Yl});const ql=ee([]),R_=Rs(ql,e=>e.map(i=>i.divisionName));D({clock:Yl.doneData,target:ql});const w1=()=>{const{allRoutes:e}=Be.useMenu();return e?t.jsxs(Qs,{children:[Object.values(e).map(({path:i,Component:n,isTemplate:s})=>t.jsx(Zs,{path:i,component:n,exact:!s},i)),t.jsx(Me,{exact:!0,to:An})]}):null},k1=le.memo(w1),T1=u.div`
    height: fit-content;
...
`,S1=()=>{const{open:e,content:i,position:n}=fu.useContextMenu(),s=l.useRef(null);return Pt(s,()=>Ae.close()),t.jsx(zi,{isOpen:e,children:t.jsx(T1,{isVisible:e,ref:s,left:n.x,top:n.y,onClick:o=>{o.stopPropagation()},children:i})})},Jl=200,E1=5e3,$1=()=>{const{visibleNotifications:e}=ze.useLkNotifications(),[i,n]=l.useState(null),s=l.useRef(),o=a=>(s.current=void 0,()=>{n(a),setTimeout(()=>{ht.clearVisibleById(a)},Jl)});return l.useEffect(()=>{var a,r;e.length&&s.current===void 0&&(s.current=setTimeout(o((a=e[0])==null?void 0:a.id),((r=e[0])==null?void 0:r.duration)??E1))},[e]),{handleClose:o,closing:i}},P1=u.div`
    position: absolute;
    width: 320px;
    max-width: 500px;
    bottom: 10px;
...
`;const A1=()=>{const{visibleNotifications:e}=ze.useLkNotifications(),{closing:i,handleClose:n}=$1();return t.jsx(P1,{children:e.map(s=>t.jsx(O1,{onClick:n(s.id),open:i!==s.id,children:t.jsx(Xa,{...s,fullText:!1,maxLetters:19,closeAnimation:!1,onClose:n(s.id)})},s.id))})},Cs=u.div`
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
`,C1=({loading:e})=>{const{data:{user:i},error:n}=ce.useUser(),s=i?Oe(i==null?void 0:i.fullName):w.blue.main,o=()=>j1.getUserFx(JSON.parse(localStorage.getItem(G.Token)??""));return n?t.jsx(Cs,{$loading:!0,color:s,children:t.jsx(ge,{text:"Нет подключения к интернету",children:t.jsx(y,{onClick:o,text:"Попробовать снова",icon:t.jsx(Ns,{})})})}):t.jsxs(Cs,{color:s,$loading:e,children:[t.jsx(Ii,{short:!0,width:"100px"}),e&&t.jsx(ut,{})]})},I1=u.div`
    width: 100%;
    height: 5px;
    background: var(--almostTransparentOpposite);
    border-radius: 10px;
...
`,R1=({filled:e,playing:i,isLast:n,onClose:s})=>{const{currentPage:o}=Rn.useStory();return t.jsx(I1,{filled:e,playing:i,children:t.jsx("div",{className:"inner-line",onAnimationEnd:()=>n?s():ot.changeCurrentPage({value:o+1})})})},D1=u(ai)`
    position: absolute;
    top: 30px;
    left: 0;
    padding: 0px 30px;
...
`,N1=({playing:e,pages:i,onClose:n})=>{const{currentPage:s}=Rn.useStory();return t.jsxs(D1,{height:"10px",verticalAlign:"center",direction:"horizontal",width:"100%",children:[Array(i).fill(0).map((o,a)=>t.jsx(R1,{onClose:n,isLast:a+1===i,playing:s===a?e:null,filled:s>a?100:s===a?void 0:0},a)),e?t.jsx(Kc,{}):t.jsx(Xc,{}),t.jsx(y,{minWidth:"25px",width:"25px",height:"25px",icon:t.jsx(We,{}),onClick:n})]})},L1=e=>`translate(${e.horizontal==="center"?"-50%":"0px"}, ${e.vertical==="center"?"-50%":"0px"})})`,z1=u(Ve)`
    overflow: hidden;
    position: relative;
    background: ${({background:e})=>e};
    display: flex;
...
`,M1=u.div`
    ...
    gap: 7px;
    color: ${({color:e})=>e??"var(--text)"};
    transform: ${({align:e})=>L1(e)};
    text-align: ${({textAlign:e})=>e??"left"};
`,F1=({background:e,align:i,image:n,color:s,title:o,text:a,children:r,setPlaying:d,link:c,imageAlign:p,imageSize:h={width:"auto",height:"100%"},textAlign:x="left"})=>{const g=ii();return t.jsxs(z1,{imageAlign:p,onClick:()=>d(m=>!m),background:e,align:i,padding:"0",height:"100%",color:s,children:[n&&t.jsx(xn,{src:n,loading:!1,width:h.width,height:h.height}),t.jsxs(M1,{imageAlign:p,onClick:()=>d(m=>!m),background:e,align:i,color:s,children:[t.jsx(W,{size:2,align:x,children:o}),t.jsx(te,{fontSize:"1.1em",align:x,children:a}),!!(c!=null&&c.text)&&t.jsx(y,{onClick:()=>{g.push(c.to),ot.close()},text:c.text}),r&&t.jsx("div",{className:"content-children",children:r})]})]})},H1=u.div`
    padding: 15px;
    width: 100%;
    max-width: 400px;
    height: 100%;
...
`,B1=()=>{const{pages:e,isOpen:i,currentPage:n}=Rn.useStory(),s=l.useRef(null);Pt(s,()=>ot.close());const[o,a]=l.useState(!0),r=e[n];return t.jsx(zi,{isOpen:i,children:t.jsx(H1,{isOpen:i,ref:s,children:e.length!==0&&t.jsxs(t.Fragment,{children:[t.jsx(N1,{pages:e.length,onClose:()=>ot.close(),playing:o}),t.jsx(Is,{left:"15px",onClick:()=>{n!==0&&ot.changeCurrentPage({value:n-1}),a(!0)},children:t.jsx(ti,{})}),t.jsx(F1,{setPlaying:a,currentPage:n,...r}),t.jsx(Is,{right:"15px",onClick:()=>{n!==e.length-1?ot.changeCurrentPage({value:n+1}):ot.close(),a(!0)},children:t.jsx(St,{})})]})})})},U1=()=>{const{data:{user:e}}=ce.useUser(),{notifications:i,loading:n,loaded:s}=ze.useLkNotifications(),{settings:o}=Et.useSettings(),a=l.useMemo(()=>o==null?void 0:o["settings-notifications"].property,[o==null?void 0:o["settings-notifications"]]);l.useEffect(()=>{e&&a&&a.all!==!1&&!s&&!n&&ht.initialize({settings:a})},[e,a,n,s]),l.useEffect(()=>{De.changeNotifications({page:"lk-notifications",notifications:i.length})},[i])},W1=()=>{const{data:{user:e}}=ce.useUser(),[i,n]=l.useState(!1),s=o=>{const a=localStorage.getItem("lastLocalAccess")||o,r=new Date(sd);new Date(o)<r&&new Date(a)<r&&(localStorage.setItem("lastLocalAccess",new Date().toISOString()),n(!0))};return l.useEffect(()=>{e&&s(e.lastaccess)},[e]),i},V1=()=>{const{data:{user:e}}=ce.useUser(),{currentPage:i,exactCurrentPage:n}=Va(),{open:s}=K(),o=W1();return l.useEffect(()=>{e&&yp.getLocalSettingsFx(e.id)},[e]),U1(),Ci(),l.useEffect(()=>{o&&o&&s(t.jsx(Or,{}),"Что нового")},[o]),{currentPage:i,exactCurrentPage:n}},G1=u.div`
    display: flex;
    background: var(--theme);
    height: 100dvh;
`,Y1=u.div`
...
`,J1=()=>{var d;const{data:{user:e}}=ce.useUser(),{currentPage:i,exactCurrentPage:n}=V1(),[s,o]=l.useState(!1),a=l.useRef(null),r=c=>{o(c.currentTarget.scrollTop>0)};return t.jsxs(G1,{children:[t.jsx(C1,{loading:!e}),t.jsx(B1,{}),t.jsx(Fb,{}),t.jsxs(Y1,{children:[t.jsx(Sb,{headerVisible:s,currentPagePair:{currentPage:i,exactCurrentPage:n}}),t.jsx(q1,{ref:a,onScroll:r,withHeader:!((d=n??i)!=null&&d.withoutHeader),children:t.jsx(l.Suspense,{fallback:null,children:t.jsx(k1,{})})}),t.jsx(Av,{})]}),t.jsx(Yb,{}),t.jsx(Bb,{}),t.jsx(Jb,{}),t.jsx(S1,{}),t.jsx(zv,{}),t.jsx(A1,{})]})},X1=()=>{const{data:{isAuthenticated:e,user:i}}=ce.useUser(),{data:n}=Je.selectors.useData(),{settings:s}=Et.useSettings();return l.useEffect(()=>{e&&(He.getUserDataApplicationsFx(),(i==null?void 0:i.user_status)==="staff"&&(Je.effects.getFx(),He.getWorkerPosts(),Gl()))},[e,i]),l.useEffect(()=>{i&&s&&De.defineMenu({user:i,adminLinks:n,homeRoutes:s["settings-home-page"].property.pages})},[i,n,s]),e?t.jsx(J1,{}):t.jsx(l.Suspense,{fallback:null,children:t.jsxs(Qs,{children:[w0.map(({path:o,Component:a},r)=>t.jsx(Zs,{path:o,component:a,exact:!0},r)),t.jsx(Me,{exact:!0,to:Za})]})})},K1=u.div`
    background: var(--theme);
    overflow-y: auto;
    height: 100vh;
`;_1();const Q1=()=>(Ci(),t.jsx(e0,{children:t.jsx(Qc,{basename:"/",children:t.jsx(K1,{children:t.jsx(X1,{})})})})),Z1=Zc`
	* {
		margin: 0;
		padding: 0;
		box-sizing: border-box;
...
`;ed.render(t.jsxs(le.StrictMode,{children:[t.jsx(Z1,{}),t.jsx(Q1,{})]}),document.getElementById("root"));export{F as $,Cy as A,y as B,Qe as C,te as D,ge as E,cu as F,wb as G,Qt as H,jy as I,be as J,st as K,ut as L,q as M,br as N,ce as O,Dm as P,Li as Q,tt as R,kt as S,W as T,he as U,Hd as V,et as W,Bd as X,Io as Y,q0 as Z,X0 as _,J as a,v_ as a$,Be as a0,Y0 as a1,ur as a2,j0 as a3,C_ as a4,u_ as a5,w as a6,Wj as a7,ht as a8,Uj as a9,wn as aA,ff as aB,ql as aC,b_ as aD,C0 as aE,nn as aF,ty as aG,by as aH,Hr as aI,ki as aJ,_0 as aK,__ as aL,D0 as aM,R0 as aN,Vd as aO,Gd as aP,eu as aQ,_e as aR,me as aS,y_ as aT,wi as aU,di as aV,U as aW,Ae as aX,Ri as aY,Pt as aZ,xp as a_,$ as aa,d_ as ab,je as ac,He as ad,A_ as ae,Co as af,O_ as ag,Pr as ah,Te as ai,de as aj,pt as ak,Ze as al,Ay as am,R_ as an,h_ as ao,ip as ap,Gn as aq,oe as ar,Py as as,lx as at,m_ as au,f_ as av,kn as aw,g_ as ax,jn as ay,x_ as az,g1 as b,Zj as b$,kv as b0,ep as b1,Ce as b2,Sn as b3,cm as b4,lm as b5,t1 as b6,Et as b7,Ni as b8,dr as b9,ue as bA,ub as bB,_r as bC,x0 as bD,Fe as bE,Zt as bF,Hv as bG,vr as bH,Ci as bI,eo as bJ,Pi as bK,T0 as bL,k0 as bM,l_ as bN,r_ as bO,fr as bP,xr as bQ,oi as bR,iv as bS,Lo as bT,o_ as bU,gg as bV,a_ as bW,j_ as bX,ai as bY,cs as bZ,fb as b_,Ym as ba,Oe as bb,yr as bc,vb as bd,n1 as be,En as bf,qj as bg,It as bh,qp as bi,t_ as bj,I_ as bk,ir as bl,i1 as bm,su as bn,A as bo,qi as bp,w_ as bq,ev as br,E_ as bs,$_ as bt,P_ as bu,S_ as bv,T_ as bw,Ot as bx,fn as by,k_ as bz,gp as c,j1 as c0,pi as c1,c_ as c2,r1 as c3,l1 as c4,Kd as c5,n_ as c6,i_ as c7,xn as c8,Qd as c9,pu as ca,p_ as cb,Iy as cc,ui as cd,Ey as ce,$y as cf,Sy as cg,Ty as ch,xv as ci,Yj as cj,Mr as d,x1 as e,Xe as f,Bo as g,gb as h,Ao as i,Re as j,Og as k,ie as l,Xp as m,In as n,cd as o,s_ as p,ls as q,H as r,h1 as s,dp as t,K as u,Jv as v,bt as w,Mi as x,si as y,Ve as z};
