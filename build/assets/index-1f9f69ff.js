import{j as s,q as P,aG as N,bw as W,s as k,L as G,K as F,aP as z,r as j,T as q,aq as A,c4 as B,bM as K,bN as Y,a4 as J}from"./vendor-3b6459b9.js";import{a8 as _,y as Q,z as X,as as Z,O as ee,U as $,J as b,bB as L,t as H,L as se,bV as C,bx as te,bW as ae,bX as ne,bY as re,w as ie,bZ as V,b_ as x,bD as O,b$ as T,c0 as U,j as le,c1 as oe,H as ce,aA as de,W as ue,P as he,Y as pe,c2 as xe,c3 as fe,c4 as Se}from"./index-b517f30d.js";import{E as ge}from"./index-d1c7b682.js";import{S as me}from"./index-4617b6d0.js";const Ee=({value:e,setValue:c,onHintClick:o,onValueEmpty:d})=>{const t=/\d/.test(e),{data:{user:a}}=_.useUser(),u=async r=>t?await X(r):await Z(r,"",1,20);return s.jsx(me,{value:e,width:"100%",setValue:c,onHintClick:o(t),placeholder:"Поиск",customMask:t?Q.groupMask:void 0,transformRequest:t?void 0:r=>r.fio,request:u,leftIcon:e.length===0?s.jsx(P,{}):t?s.jsx(N,{}):s.jsx(W,{}),onValueEmpty:(a==null?void 0:a.user_status)==="staff"?d:void 0})},je=k(G)`
    color: var(--text);
    padding: 15px 15px;
    max-width: 140px;
    width: 100%;
