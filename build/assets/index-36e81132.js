import{y as p,s as g,b_ as x,o as d,j as n}from"./vendor-4a800e6d.js";import{ae as m,Y as P,W as j,z as v,af as y}from"./index-7ab5fc9f.js";import{c as F,L}from"./index-5c59454e.js";import"./index-0cdb9df0.js";const $=p(async a=>{const{search:i,page:o,limit:c,filter:t}=a,e=(t==null?void 0:t.title)==="Все"?"":(t==null?void 0:t.title)??"",{data:r}=await m(i??"",e,o,c);return{results:r.items}}),h=F({getFx:$,limit:50}),b=g.div`
    width: 100%;
    display: flex;
