import{s as r,j as e,ax as x}from"./vendor-cbee1f3c.js";import{V as s,bn as c,l as d,N as h,Q as p,w as g,aw as m}from"./index-f356c1dd.js";import{i as v}from"./is-valid-url-08a91344.js";const f=({alert:t})=>{const{content:i,time:a,date:o}=t;return e.jsxs(u,{children:[e.jsx(s,{fontSize:"0.9rem",children:e.jsx(c,{words:[d(o),a]})}),e.jsx(h,{width:"100%",margin:"12px 0"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:i}})]})},u=r.div`
    display: flex;
